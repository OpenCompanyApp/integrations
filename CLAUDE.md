...
- Keep Ruby script namespaces, package ids, metadata, and docs aligned
...
- Ruby script docs should reflect actual tool behavior, including normalized output and self-hosted caveats
