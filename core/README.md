...
| `ToolProvider` interface | Contract every integration package implements — declares tools, metadata, factory, and script docs |
| `HasIntegrationCapabilities` interface | Optional capability metadata for catalog, CLI, Ruby script, MCP gateway, and SEO generators |
