...
class GmailRemoveLabels implements Tool
{
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success("{$count} message(s) labels removed successfully.");
        } catch (\Throwable $e) {
    ...
    {
        return [
            'message_id' => ['type' => 'string', 'description' => 'Single message ID to remove labels from.'],
            'message_ids' => ['type' => 'string', 'description' => 'Comma-separated message IDs for batch operations.'],
            'label_ids' => ['type' => 'string', 'required' => true, 'description' => 'Comma-separated label IDs to remove.'],
        ];
    }
}
