...
class GoogleSheetsDeleteColumns implements Tool
{
    ...
    {
        return 'google_sheets_delete_columns';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success("{$count} column(s) deleted at index {$startIndex} in '{$sheetName}'.");
        } catch (\Throwable $e) {
    ...
    public function parameters(): array
    {
        return [
            ...
            'start_index' => ['type' => 'integer', 'required' => true, 'description' => '0-based column index to start deleting from.'],
