...
class GoogleSheetsInsertRows implements Tool
{
    ...
    {
        return 'google_sheets_insert_rows';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success("{$count} row(s) inserted at index {$startIndex} in '{$sheetName}'.");
        } catch (\Throwable $e) {
    ...
    public function parameters(): array
    {
        return [
            ...
            'start_index' => ['type' => 'integer', 'required' => true, 'description' => '0-based row index to insert at.'],
