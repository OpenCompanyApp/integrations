# Abyssale JavaScript API Reference
...
```js
var designs = app.integrations.abyssale.list_designs({})

var design = app.integrations.abyssale.get_design({
  design_id: "38cb7df3-1160-4824-8531-2bacde2b6517",
})

var format = app.integrations.abyssale.get_design_format({
  design_id: "38cb7df3-1160-4824-8531-2bacde2b6517",
...
```js
var image = app.integrations.abyssale.generate_image({
  design_id: "38cb7df3-1160-4824-8531-2bacde2b6517",
...
```js
var request = app.integrations.abyssale.generate_multi_format_media({
  design_id: "38cb7df3-1160-4824-8531-2bacde2b6517",
...
console.log(request.generation_request_id)
```
...
```js
var fonts = app.integrations.abyssale.list_fonts({})

var file = app.integrations.abyssale.get_file({
  banner_id: "64238d01-d402-474b-8c2d-fbc957e9d290",
})

var exportResult = app.integrations.abyssale.create_banner_export({
...
```js
var projects = app.integrations.abyssale.list_projects({})

var project = app.integrations.abyssale.create_project({
  name: "Summer Campaign",
})

var duplicate = app.integrations.abyssale.duplicate_workspace_template({
  company_template_id: "0c967bd0-4137-4690-ad70-249aa021c68b",
  project_id: project.id,
  name: "Localized banner",
})

var status = app.integrations.abyssale.get_duplication_request({
...
```js
var dynamic = app.integrations.abyssale.create_dynamic_image_url({
  design_id: "38cb7df3-1160-4824-8531-2bacde2b6517",
  enable_rate_limit: true,
  enable_production_mode: true,
})

var pdf = app.integrations.abyssale.generate_multi_page_pdf({
  design_id: "38cb7df3-1160-4824-8531-2bacde2b6517",
...
```js
var raw = app.integrations.abyssale.api_get({
  path: "/designs",
})

var posted = app.integrations.abyssale.api_post({
  path: "/projects",
