 ...
 */
class ActivelyToolProvider implements ToolProvider, ConfigurableIntegration, HasIntegrationCapabilities
{
...
/**
    ...
    /**
     * Get the path to the Ruby script docs file for agent-side documentation.
     */
