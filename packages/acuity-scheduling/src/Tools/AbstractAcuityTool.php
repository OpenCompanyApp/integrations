...
/**
 * Base class for Acuity Scheduling tools that delegate to AcuitySchedulingService.
 */
abstract class AbstractAcuityTool implements Tool
{
    /**
     * @param  AcuitySchedulingService  $service  Acuity Scheduling API client.
     */
    public function __construct(protected AcuitySchedulingService $service) {}

    /**
     * Execute the Acuity Scheduling tool.
     *
