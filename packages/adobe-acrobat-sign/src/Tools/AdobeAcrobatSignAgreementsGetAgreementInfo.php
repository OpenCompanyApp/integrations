 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /agreements/{agreementId}.
 */
class AdobeAcrobatSignAgreementsGetAgreementInfo extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_agreements_get_agreement_info';
    protected const DESCRIPTION = 'Retrieves the current status of an agreement.

Official Adobe Acrobat Sign endpoint: GET /agreements/{agreementId}
