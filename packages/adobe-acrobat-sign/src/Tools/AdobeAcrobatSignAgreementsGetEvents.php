 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /agreements/{agreementId}/events.
 */
class AdobeAcrobatSignAgreementsGetEvents extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_agreements_get_events';
    protected const DESCRIPTION = 'Retrieves the events information for an agreement.

Official Adobe Acrobat Sign endpoint: GET /agreements/{agreementId}/events
...
Retrieves the events information for an agreement.';
  ...
  array (
    ...
    protected const PATH = '/agreements/{agreementId}/events';
