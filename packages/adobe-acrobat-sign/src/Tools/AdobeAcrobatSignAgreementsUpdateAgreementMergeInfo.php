 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint put /agreements/{agreementId}/formFields/mergeInfo.
 */
class AdobeAcrobatSignAgreementsUpdateAgreementMergeInfo extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_agreements_update_agreement_merge_info';
    protected const DESCRIPTION = 'Set the merge info for an agreement.

Official Adobe Acrobat Sign endpoint: PUT /agreements/{agreementId}/formFields/mergeInfo
