 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /libraryDocuments/{libraryDocumentId}/documents.
 */
class AdobeAcrobatSignLibraryDocumentsGetDocuments extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_library_documents_get_documents';
    protected const DESCRIPTION = 'Retrieves the IDs of the documents associated with library document.

Official Adobe Acrobat Sign endpoint: GET /libraryDocuments/{libraryDocumentId}/documents
...
Retrieves the IDs of the documents associated with library document.';
  ...
  array (
    ...
    protected const PATH = '/libraryDocuments/{libraryDocumentId}/documents';
