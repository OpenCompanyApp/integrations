 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /libraryDocuments/{libraryDocumentId}/events.
 */
class AdobeAcrobatSignLibraryDocumentsGetEvents extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_library_documents_get_events';
    protected const DESCRIPTION = 'Retrieves the events information for a library document.

Official Adobe Acrobat Sign endpoint: GET /libraryDocuments/{libraryDocumentId}/events
...
Retrieves the events information for a library document.';
  ...
  array (
    ...
    protected const PATH = '/libraryDocuments/{libraryDocumentId}/events';
