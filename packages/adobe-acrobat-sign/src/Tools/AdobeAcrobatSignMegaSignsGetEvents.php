 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /megaSigns/{megaSignId}/events.
 */
class AdobeAcrobatSignMegaSignsGetEvents extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_mega_signs_get_events';
    protected const DESCRIPTION = 'Retrieves the events information for the MegaSign parent agreement.

Official Adobe Acrobat Sign endpoint: GET /megaSigns/{megaSignId}/events
...
Retrieves the events information for the MegaSign parent agreement.';
  ...
  array (
    ...
    protected const PATH = '/megaSigns/{megaSignId}/events';
