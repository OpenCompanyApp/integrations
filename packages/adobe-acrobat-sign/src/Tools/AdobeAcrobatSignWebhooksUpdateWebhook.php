 ...
 * Updates a webhook.
 *
 * Maps to the official Adobe Acrobat Sign endpoint put /webhooks/{webhookId}.
 */
class AdobeAcrobatSignWebhooksUpdateWebhook extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_webhooks_update_webhook';
    protected const DESCRIPTION = 'Updates a webhook.

Official Adobe Acrobat Sign endpoint: PUT /webhooks/{webhookId}
