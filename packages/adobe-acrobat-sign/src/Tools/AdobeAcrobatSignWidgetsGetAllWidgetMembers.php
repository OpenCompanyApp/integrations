 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /widgets/{widgetId}/members.
 */
class AdobeAcrobatSignWidgetsGetAllWidgetMembers extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_widgets_get_all_widget_members';
    protected const DESCRIPTION = 'Retrieves detailed member info along with IDs for different types of participants.

Official Adobe Acrobat Sign endpoint: GET /widgets/{widgetId}/members
...
Retrieves detailed member info along with IDs for different types of participants.';
  ...
  array (
    ...
    protected const PATH = '/widgets/{widgetId}/members';
