 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /widgets/{widgetId}/events.
 */
class AdobeAcrobatSignWidgetsGetEvents extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_widgets_get_events';
    protected const DESCRIPTION = 'Retrieves the events information for a widget.

Official Adobe Acrobat Sign endpoint: GET /widgets/{widgetId}/events
...
Retrieves the events information for a widget.';
  ...
  array (
    ...
    protected const PATH = '/widgets/{widgetId}/events';
