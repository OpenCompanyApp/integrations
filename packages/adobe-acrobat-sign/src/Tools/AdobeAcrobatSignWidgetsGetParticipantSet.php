 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /widgets/{widgetId}/members/participantSets/{participantSetId}.
 */
class AdobeAcrobatSignWidgetsGetParticipantSet extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_widgets_get_participant_set';
    protected const DESCRIPTION = 'Retrieves the participant set of a widget identified by widgetId in the path.

Official Adobe Acrobat Sign endpoint: GET /widgets/{widgetId}/members/participantSets/{participantSetId}
...
Retrieves the participant set of a widget identified by widgetId in the path.';
  ...
  array (
    ...
    protected const PATH = '/widgets/{widgetId}/members/participantSets/{participantSetId}';
