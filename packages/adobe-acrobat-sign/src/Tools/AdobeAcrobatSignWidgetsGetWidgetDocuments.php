 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /widgets/{widgetId}/documents.
 */
class AdobeAcrobatSignWidgetsGetWidgetDocuments extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_widgets_get_widget_documents';
    protected const DESCRIPTION = 'Retrieves the IDs of the documents associated with widget.

Official Adobe Acrobat Sign endpoint: GET /widgets/{widgetId}/documents
...
Retrieves the IDs of the documents associated with widget.';
  ...
  array (
    ...
    protected const PATH = '/widgets/{widgetId}/documents';
