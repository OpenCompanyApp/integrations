 ...
 *
 * Maps to the official Adobe Acrobat Sign endpoint get /widgets/{widgetId}.
 */
class AdobeAcrobatSignWidgetsGetWidgetInfo extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_widgets_get_widget_info';
    protected const DESCRIPTION = 'Retrieves the details of a widget.

Official Adobe Acrobat Sign endpoint: GET /widgets/{widgetId}
...
Retrieves the details of a widget.';
  ...
  array (
    ...
    protected const PATH = '/widgets/{widgetId}';
