 ...
 * Updates a widget.
 *
 * Maps to the official Adobe Acrobat Sign endpoint put /widgets/{widgetId}.
 */
class AdobeAcrobatSignWidgetsUpdateWidget extends AbstractAdobeAcrobatSignTool
{
    protected const NAME = 'adobe_acrobat_sign_widgets_update_widget';
    protected const DESCRIPTION = 'Updates a widget.

Official Adobe Acrobat Sign endpoint: PUT /widgets/{widgetId}
