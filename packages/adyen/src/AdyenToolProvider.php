 ...
 * Adyen tool provider.
 *
 * Registers all Adyen integration tools and provides configuration
 * schema for API key, merchant account, and base URL.
 */
class AdyenToolProvider implements ToolProvider, ConfigurableIntegration
{
    /**
     * {@inheritDoc}
     */
