...
/**
 * Shared implementation for Affinity endpoint tools.
 */
abstract class AbstractAffinityEndpointTool implements Tool
{
    ...
    /**
     * @param  AffinityService  $service  Affinity API client.
     */
    public function __construct(
        protected AffinityService $service,
    ) {}
    ...
    /**
     * Execute the mapped Affinity endpoint.
     *
