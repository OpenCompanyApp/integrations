 ...
 */
class AffinityApiDelete extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_api_delete';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Affinity API path with DELETE.';
