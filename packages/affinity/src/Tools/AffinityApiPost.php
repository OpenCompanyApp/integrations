 ...
 */
class AffinityApiPost extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_api_post';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Affinity API path with POST.';
