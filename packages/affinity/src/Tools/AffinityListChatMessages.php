 ...
 */
class AffinityListChatMessages extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_list_chat_messages';
    protected const TOOL_DESCRIPTION = 'List chat message interactions.';
    protected const METHOD = 'GET';
    protected const PATH = '/chat-messages';
