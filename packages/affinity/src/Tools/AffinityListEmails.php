 ...
 */
class AffinityListEmails extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_list_emails';
    protected const TOOL_DESCRIPTION = 'List email interactions.';
    protected const METHOD = 'GET';
    protected const PATH = '/emails';
