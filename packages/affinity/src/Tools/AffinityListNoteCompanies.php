 ...
 */
class AffinityListNoteCompanies extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_list_note_companies';
    protected const TOOL_DESCRIPTION = 'List companies attached to a note.';
    protected const METHOD = 'GET';
    protected const PATH = '/notes/{note_id}/companies';
