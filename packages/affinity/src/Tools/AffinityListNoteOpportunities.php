 ...
 */
class AffinityListNoteOpportunities extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_list_note_opportunities';
    protected const TOOL_DESCRIPTION = 'List opportunities attached to a note.';
    protected const METHOD = 'GET';
    protected const PATH = '/notes/{note_id}/opportunities';
