 ...
 */
class AffinityListSavedViews extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_list_saved_views';
    protected const TOOL_DESCRIPTION = 'List saved views for a list.';
    protected const METHOD = 'GET';
    protected const PATH = '/lists/{list_id}/saved-views';
