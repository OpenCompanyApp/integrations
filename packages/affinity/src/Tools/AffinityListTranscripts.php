 ...
 * List transcripts.
 */
class AffinityListTranscripts extends AbstractAffinityEndpointTool
{
    protected const TOOL_NAME = 'affinity_list_transcripts';
    protected const TOOL_DESCRIPTION = 'List transcripts.';
    protected const METHOD = 'GET';
    protected const PATH = '/transcripts';
