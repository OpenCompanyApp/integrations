...
```ruby
created = app.integrations.aftership.create_tracking(tracking_number: "TEST123456789", slug: "usps", title: "Order TEST-1001", destination_country_region: "USA")
couriers = app.integrations.aftership.detect_courier(tracking_number: "TEST123456789", destination_country_region: "USA")
active = app.integrations.aftership.list_trackings(delivery_status: "InTransit", limit: 20)
```