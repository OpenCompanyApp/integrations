 ...
 */
class AircallApiDelete extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_api_delete';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Aircall API path with DELETE.';
