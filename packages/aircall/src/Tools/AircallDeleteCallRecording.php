 ...
 */
class AircallDeleteCallRecording extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_delete_call_recording';
    protected const TOOL_DESCRIPTION = 'Delete a call recording.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/v1/calls/{call_id}/recording';
