 ...
 */
class AircallDeleteDialerCampaign extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_delete_dialer_campaign';
    protected const TOOL_DESCRIPTION = 'Delete a user dialer campaign.';
