 ...
 */
class AircallGetCallSentiments extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_get_call_sentiments';
    protected const TOOL_DESCRIPTION = 'Retrieve call sentiments.';
    protected const METHOD = 'GET';
    protected const PATH = '/v1/calls/{call_id}/sentiments';
