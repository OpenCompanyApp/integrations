 ...
 */
class AircallGetCallSummary extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_get_call_summary';
    protected const TOOL_DESCRIPTION = 'Retrieve a call summary.';
    protected const METHOD = 'GET';
    protected const PATH = '/v1/calls/{call_id}/summary';
