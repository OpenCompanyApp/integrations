 ...
 */
class AircallListUsers extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_list_users';
    protected const TOOL_DESCRIPTION = 'List users in the Aircall account.';
