 ...
 */
class AircallListUsersV2 extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_list_users_v2';
    protected const TOOL_DESCRIPTION = 'List users using the v2 user API.';
