 ...
 */
class AircallPauseCallRecording extends AbstractAircallEndpointTool
{
    protected const TOOL_NAME = 'aircall_pause_call_recording';
    protected const TOOL_DESCRIPTION = 'Pause live recording on a call.';
    protected const METHOD = 'POST';
    protected const PATH = '/v1/calls/{call_id}/pause_recording';
