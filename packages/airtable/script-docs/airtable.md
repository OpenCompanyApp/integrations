...
```ruby
result = app.integrations.airtable.list_records(base_id: "appXXXXXXXXXXXX", table: "Contacts", view: "Active", page_size: 100)
```
...
```ruby
created = app.integrations.airtable.create_record(base_id: "appXXXXXXXXXXXX", table: "Contacts", fields: {Name: "Ada Lovelace", Email: "ada@example.test"})
updated = app.integrations.airtable.update_record(base_id: "appXXXXXXXXXXXX", table: "Contacts", record_id: "recXXXXXXXXXXXX", fields: {Status: "Active"})
```
...
```ruby
schema = app.integrations.airtable.get_base_schema(base_id: "appXXXXXXXXXXXX")
```
...
```ruby
comment = app.integrations.airtable.create_comment(base_id: "appXXXXXXXXXXXX", table: "Contacts", record_id: "recXXXXXXXXXXXX", text: "Follow up next week.")
```
...
```ruby
webhook = app.integrations.airtable.create_webhook(base_id: "appXXXXXXXXXXXX", payload: {notificationUrl: "https://example.test/airtable", specification: {options: {filters: {dataTypes: ["tableData"]}}}})
```
