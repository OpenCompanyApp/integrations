...
abstract class AbstractAirtableTool implements Tool
{
    ...
    /**
     * @param  AirtableService  $service  The Airtable Web API client.
     */
    ...
    /**
     * Execute one Airtable API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('Airtable integration is not configured. Access token is required.');
            }
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported Airtable tool method: {$this->method}"),
            };
