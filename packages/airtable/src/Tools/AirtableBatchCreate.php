 ...
 */
class AirtableBatchCreate implements Tool
{
    /**
    ...
    {
        return 'airtable_batch_create';
    }

    public function description(): string
    {
        return 'Create up to 10 records in a single Airtable API request.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'records' => ['type' => 'string', 'required' => true, 'description' => 'JSON array of record objects, each with a "fields" key (e.g., [{"fields":{"Name":"Alice"}}, {"fields":{"Name":"Bob"}}]). Max 10 records.'],
        ];
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            if (count($recordsArray) > 10) {
                return ToolResult::error('A maximum of 10 records can be created in a single batch request.');
            }

            $result = $this->service->batchCreate($baseId, $table, $recordsArray);
