...
```ruby
quote = app.call("integrations.alpha-vantage.global_quote", symbol: "IBM")
bars = app.call("integrations.alpha-vantage.time_series_intraday", symbol: "IBM", interval: "5min", outputsize: "compact")
news = app.call("integrations.alpha-vantage.news_sentiment", tickers: "IBM", topics: "technology", limit: 10)
rsi = app.call("integrations.alpha-vantage.rsi", symbol: "IBM", interval: "daily", time_period: 14, series_type: "close")
```