 ...
 */
class AlphaVantageAd extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ad';
    protected const FUNCTION = 'AD';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for AD.

Official Alpha Vantage function: AD.';
