 ...
 */
class AlphaVantageAdosc extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_adosc';
    protected const FUNCTION = 'ADOSC';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ADOSC.

Official Alpha Vantage function: ADOSC.';
