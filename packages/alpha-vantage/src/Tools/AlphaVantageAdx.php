 ...
 */
class AlphaVantageAdx extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_adx';
    protected const FUNCTION = 'ADX';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ADX.

Official Alpha Vantage function: ADX.';
