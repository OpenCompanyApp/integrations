 ...
 */
class AlphaVantageAdxr extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_adxr';
    protected const FUNCTION = 'ADXR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ADXR.

Official Alpha Vantage function: ADXR.';
