 ...
 */
class AlphaVantageAnalyticsSlidingWindow extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_analytics_sliding_window';
    protected const FUNCTION = 'ANALYTICS_SLIDING_WINDOW';
    protected const DESCRIPTION = 'Fetch Alpha Vantage intelligence data for ANALYTICS_SLIDING_WINDOW.

Official Alpha Vantage function: ANALYTICS_SLIDING_WINDOW.';
