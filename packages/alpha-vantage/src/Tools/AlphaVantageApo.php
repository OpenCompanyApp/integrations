 ...
 */
class AlphaVantageApo extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_apo';
    protected const FUNCTION = 'APO';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for APO.

Official Alpha Vantage function: APO.';
