 ...
 */
class AlphaVantageAroon extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_aroon';
    protected const FUNCTION = 'AROON';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for AROON.

Official Alpha Vantage function: AROON.';
