 ...
 */
class AlphaVantageAroonosc extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_aroonosc';
    protected const FUNCTION = 'AROONOSC';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for AROONOSC.

Official Alpha Vantage function: AROONOSC.';
