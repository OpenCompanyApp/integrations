 ...
 */
class AlphaVantageAtr extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_atr';
    protected const FUNCTION = 'ATR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ATR.

Official Alpha Vantage function: ATR.';
