 ...
 */
class AlphaVantageBbands extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_bbands';
    protected const FUNCTION = 'BBANDS';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for BBANDS.

Official Alpha Vantage function: BBANDS.';
