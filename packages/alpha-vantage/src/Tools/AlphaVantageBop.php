 ...
 */
class AlphaVantageBop extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_bop';
    protected const FUNCTION = 'BOP';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for BOP.

Official Alpha Vantage function: BOP.';
