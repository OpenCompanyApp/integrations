 ...
 */
class AlphaVantageCci extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_cci';
    protected const FUNCTION = 'CCI';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for CCI.

Official Alpha Vantage function: CCI.';
