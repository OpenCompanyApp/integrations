 ...
 */
class AlphaVantageCmo extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_cmo';
    protected const FUNCTION = 'CMO';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for CMO.

Official Alpha Vantage function: CMO.';
