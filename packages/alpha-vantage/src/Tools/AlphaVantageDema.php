 ...
 */
class AlphaVantageDema extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_dema';
    protected const FUNCTION = 'DEMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for DEMA.

Official Alpha Vantage function: DEMA.';
