 ...
 */
class AlphaVantageDx extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_dx';
    protected const FUNCTION = 'DX';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for DX.

Official Alpha Vantage function: DX.';
