 ...
 */
class AlphaVantageEma extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ema';
    protected const FUNCTION = 'EMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for EMA.

Official Alpha Vantage function: EMA.';
