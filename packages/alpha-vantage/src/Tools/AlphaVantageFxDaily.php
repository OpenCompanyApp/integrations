 ...
 */
class AlphaVantageFxDaily extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_fx_daily';
    protected const FUNCTION = 'FX_DAILY';
    protected const DESCRIPTION = 'Fetch Alpha Vantage foreign exchange data for FX_DAILY.

Official Alpha Vantage function: FX_DAILY.';
