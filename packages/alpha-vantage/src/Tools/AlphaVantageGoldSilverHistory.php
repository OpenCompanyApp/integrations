 ...
 */
class AlphaVantageGoldSilverHistory extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_gold_silver_history';
    protected const FUNCTION = 'GOLD_SILVER_HISTORY';
    protected const DESCRIPTION = 'Fetch Alpha Vantage commodity data for GOLD_SILVER_HISTORY.

Official Alpha Vantage function: GOLD_SILVER_HISTORY.';
