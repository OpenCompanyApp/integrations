 ...
 */
class AlphaVantageHistoricalOptions extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_historical_options';
    protected const FUNCTION = 'HISTORICAL_OPTIONS';
    protected const DESCRIPTION = 'Fetch Alpha Vantage US options data for HISTORICAL_OPTIONS.

Official Alpha Vantage function: HISTORICAL_OPTIONS.';
