 ...
 */
class AlphaVantageHtDcperiod extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ht_dcperiod';
    protected const FUNCTION = 'HT_DCPERIOD';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for HT_DCPERIOD.

Official Alpha Vantage function: HT_DCPERIOD.';
