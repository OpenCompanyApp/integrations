 ...
 */
class AlphaVantageHtPhasor extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ht_phasor';
    protected const FUNCTION = 'HT_PHASOR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for HT_PHASOR.

Official Alpha Vantage function: HT_PHASOR.';
