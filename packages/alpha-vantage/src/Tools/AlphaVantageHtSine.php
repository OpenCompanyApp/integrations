 ...
 */
class AlphaVantageHtSine extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ht_sine';
    protected const FUNCTION = 'HT_SINE';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for HT_SINE.

Official Alpha Vantage function: HT_SINE.';
