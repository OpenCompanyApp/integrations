 ...
 */
class AlphaVantageHtTrendline extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ht_trendline';
    protected const FUNCTION = 'HT_TRENDLINE';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for HT_TRENDLINE.

Official Alpha Vantage function: HT_TRENDLINE.';
