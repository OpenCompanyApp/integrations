 ...
 */
class AlphaVantageHtTrendmode extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ht_trendmode';
    protected const FUNCTION = 'HT_TRENDMODE';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for HT_TRENDMODE.

Official Alpha Vantage function: HT_TRENDMODE.';
