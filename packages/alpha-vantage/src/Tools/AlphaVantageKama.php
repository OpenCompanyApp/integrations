 ...
 */
class AlphaVantageKama extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_kama';
    protected const FUNCTION = 'KAMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for KAMA.

Official Alpha Vantage function: KAMA.';
