 ...
 */
class AlphaVantageMacd extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_macd';
    protected const FUNCTION = 'MACD';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MACD.

Official Alpha Vantage function: MACD.';
