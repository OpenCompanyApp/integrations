 ...
 */
class AlphaVantageMacdext extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_macdext';
    protected const FUNCTION = 'MACDEXT';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MACDEXT.

Official Alpha Vantage function: MACDEXT.';
