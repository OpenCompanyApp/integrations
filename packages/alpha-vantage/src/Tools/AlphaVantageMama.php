 ...
 */
class AlphaVantageMama extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_mama';
    protected const FUNCTION = 'MAMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MAMA.

Official Alpha Vantage function: MAMA.';
