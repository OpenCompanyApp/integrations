 ...
 */
class AlphaVantageMfi extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_mfi';
    protected const FUNCTION = 'MFI';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MFI.

Official Alpha Vantage function: MFI.';
