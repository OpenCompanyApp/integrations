 ...
 */
class AlphaVantageMidpoint extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_midpoint';
    protected const FUNCTION = 'MIDPOINT';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MIDPOINT.

Official Alpha Vantage function: MIDPOINT.';
