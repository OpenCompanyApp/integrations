 ...
 */
class AlphaVantageMidprice extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_midprice';
    protected const FUNCTION = 'MIDPRICE';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MIDPRICE.

Official Alpha Vantage function: MIDPRICE.';
