 ...
 */
class AlphaVantageMinusDi extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_minus_di';
    protected const FUNCTION = 'MINUS_DI';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MINUS_DI.

Official Alpha Vantage function: MINUS_DI.';
