 ...
 */
class AlphaVantageMinusDm extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_minus_dm';
    protected const FUNCTION = 'MINUS_DM';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MINUS_DM.

Official Alpha Vantage function: MINUS_DM.';
