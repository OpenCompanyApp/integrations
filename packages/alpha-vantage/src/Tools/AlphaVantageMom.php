 ...
 */
class AlphaVantageMom extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_mom';
    protected const FUNCTION = 'MOM';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for MOM.

Official Alpha Vantage function: MOM.';
