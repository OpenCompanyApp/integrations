 ...
 */
class AlphaVantageNatr extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_natr';
    protected const FUNCTION = 'NATR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for NATR.

Official Alpha Vantage function: NATR.';
