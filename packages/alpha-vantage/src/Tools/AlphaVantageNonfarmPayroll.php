 ...
 */
class AlphaVantageNonfarmPayroll extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_nonfarm_payroll';
    protected const FUNCTION = 'NONFARM_PAYROLL';
    protected const DESCRIPTION = 'Fetch Alpha Vantage economic indicator data for NONFARM_PAYROLL.

Official Alpha Vantage function: NONFARM_PAYROLL.';
