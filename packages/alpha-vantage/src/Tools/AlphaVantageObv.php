 ...
 */
class AlphaVantageObv extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_obv';
    protected const FUNCTION = 'OBV';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for OBV.

Official Alpha Vantage function: OBV.';
