 ...
 */
class AlphaVantagePlusDi extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_plus_di';
    protected const FUNCTION = 'PLUS_DI';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for PLUS_DI.

Official Alpha Vantage function: PLUS_DI.';
