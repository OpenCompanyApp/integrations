 ...
 */
class AlphaVantagePlusDm extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_plus_dm';
    protected const FUNCTION = 'PLUS_DM';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for PLUS_DM.

Official Alpha Vantage function: PLUS_DM.';
