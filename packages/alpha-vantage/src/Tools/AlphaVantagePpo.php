 ...
 */
class AlphaVantagePpo extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ppo';
    protected const FUNCTION = 'PPO';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for PPO.

Official Alpha Vantage function: PPO.';
