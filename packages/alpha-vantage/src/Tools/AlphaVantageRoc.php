 ...
 */
class AlphaVantageRoc extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_roc';
    protected const FUNCTION = 'ROC';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ROC.

Official Alpha Vantage function: ROC.';
