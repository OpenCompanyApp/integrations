 ...
 */
class AlphaVantageRocr extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_rocr';
    protected const FUNCTION = 'ROCR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ROCR.

Official Alpha Vantage function: ROCR.';
