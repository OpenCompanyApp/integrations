 ...
 */
class AlphaVantageRsi extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_rsi';
    protected const FUNCTION = 'RSI';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for RSI.

Official Alpha Vantage function: RSI.';
