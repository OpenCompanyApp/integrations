 ...
 */
class AlphaVantageSar extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_sar';
    protected const FUNCTION = 'SAR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for SAR.

Official Alpha Vantage function: SAR.';
