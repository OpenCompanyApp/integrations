 ...
 */
class AlphaVantageSma extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_sma';
    protected const FUNCTION = 'SMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for SMA.

Official Alpha Vantage function: SMA.';
