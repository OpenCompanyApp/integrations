 ...
 */
class AlphaVantageStoch extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_stoch';
    protected const FUNCTION = 'STOCH';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for STOCH.

Official Alpha Vantage function: STOCH.';
