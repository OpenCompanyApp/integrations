 ...
 */
class AlphaVantageStochf extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_stochf';
    protected const FUNCTION = 'STOCHF';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for STOCHF.

Official Alpha Vantage function: STOCHF.';
