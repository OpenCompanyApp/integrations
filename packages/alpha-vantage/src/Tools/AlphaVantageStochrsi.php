 ...
 */
class AlphaVantageStochrsi extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_stochrsi';
    protected const FUNCTION = 'STOCHRSI';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for STOCHRSI.

Official Alpha Vantage function: STOCHRSI.';
