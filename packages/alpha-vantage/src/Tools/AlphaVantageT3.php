 ...
 */
class AlphaVantageT3 extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_t3';
    protected const FUNCTION = 'T3';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for T3.

Official Alpha Vantage function: T3.';
