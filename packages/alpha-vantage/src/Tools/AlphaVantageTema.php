 ...
 */
class AlphaVantageTema extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_tema';
    protected const FUNCTION = 'TEMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for TEMA.

Official Alpha Vantage function: TEMA.';
