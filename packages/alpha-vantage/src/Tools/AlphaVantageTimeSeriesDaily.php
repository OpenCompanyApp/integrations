 ...
 */
class AlphaVantageTimeSeriesDaily extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_time_series_daily';
    protected const FUNCTION = 'TIME_SERIES_DAILY';
    protected const DESCRIPTION = 'Fetch Alpha Vantage equity market data for TIME_SERIES_DAILY.

Official Alpha Vantage function: TIME_SERIES_DAILY.';
