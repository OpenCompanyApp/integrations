 ...
 */
class AlphaVantageTimeSeriesMonthly extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_time_series_monthly';
    protected const FUNCTION = 'TIME_SERIES_MONTHLY';
    protected const DESCRIPTION = 'Fetch Alpha Vantage equity market data for TIME_SERIES_MONTHLY.

Official Alpha Vantage function: TIME_SERIES_MONTHLY.';
