 ...
 */
class AlphaVantageTrange extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_trange';
    protected const FUNCTION = 'TRANGE';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for TRANGE.

Official Alpha Vantage function: TRANGE.';
