 ...
 */
class AlphaVantageTrima extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_trima';
    protected const FUNCTION = 'TRIMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for TRIMA.

Official Alpha Vantage function: TRIMA.';
