 ...
 */
class AlphaVantageTrix extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_trix';
    protected const FUNCTION = 'TRIX';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for TRIX.

Official Alpha Vantage function: TRIX.';
