 ...
 */
class AlphaVantageUltosc extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_ultosc';
    protected const FUNCTION = 'ULTOSC';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for ULTOSC.

Official Alpha Vantage function: ULTOSC.';
