 ...
 */
class AlphaVantageVwap extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_vwap';
    protected const FUNCTION = 'VWAP';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for VWAP.

Official Alpha Vantage function: VWAP.';
