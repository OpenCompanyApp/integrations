 ...
 */
class AlphaVantageWillr extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_willr';
    protected const FUNCTION = 'WILLR';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for WILLR.

Official Alpha Vantage function: WILLR.';
