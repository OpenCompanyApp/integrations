 ...
 */
class AlphaVantageWma extends AbstractAlphaVantageTool
{
    protected const NAME = 'alpha_vantage_wma';
    protected const FUNCTION = 'WMA';
    protected const DESCRIPTION = 'Fetch Alpha Vantage technical indicator data for WMA.

Official Alpha Vantage function: WMA.';
