...
/**
 * Shared executor for Appetize tools.
 *
 ...
 */
abstract class AbstractAppetizeTool implements Tool
{
    ...
    /**
     * @param  AppetizeService  $service  Appetize API client.
     */
    public function __construct(protected AppetizeService $service) {}
    ...
    /**
     * Execute the Appetize operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('Appetize integration is not configured.');
            }
