...
/**
 * Base class for Appwrite REST endpoint tools.
 *
 * Handles common credential checks, required parameter validation, path
 * interpolation, and query/body shaping for one Appwrite API operation.
 */
abstract class AbstractAppwriteEndpointTool implements Tool
{
    ...
    /**
     * @param  AppwriteService  $service  The Appwrite API client.
     */
    public function __construct(
        protected AppwriteService $service,
    ) {}
    ...
    /**
     * Execute one Appwrite REST API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match ($this->method) {
                ...
                default => throw new \RuntimeException("Unsupported Appwrite tool method: {$this->method}"),
            };
    ...
    /**
     * Replace {param} placeholders in the configured endpoint path.
     *
     * @param  array<string, mixed>  $args  Tool arguments.
     */
