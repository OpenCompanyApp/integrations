...
```ruby
apps = app.integrations.argocd.list_returns_list_applications(project: "default")
app = app.integrations.argocd.get_returns_application_by_name(name: "guestbook", project: "default")
user = app.integrations.argocd.get_current_user_info()
```
