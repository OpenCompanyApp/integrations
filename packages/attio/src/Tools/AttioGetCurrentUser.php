...
{
    /**
     * Create a new AttioGetCurrentUser tool instance.
     */
    ...
    {
        return 'Get the currently authenticated Attio user profile. Useful for verifying API connectivity and identifying which workspace the integration is connected to.';
    }
