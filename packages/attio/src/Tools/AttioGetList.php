...
class AttioGetList implements Tool
{
    /**
     * Create a new AttioGetList tool instance.
     */
    ...
    {
        return 'Get details for a specific list in Attio, including its name, parent object, and configuration.';
    }
