...
```js
var ping = app.integrations.avalara.ping({})
console.log(ping.version)

var companies = app.integrations.avalara.query_companies({
  top: 25,
  filter: "isActive eq true",
})

var tax = app.integrations.avalara.create_transaction({
