...
```ruby
ping = app.integrations.avalara.tests_connectivity_and_version_service()
puts(ping.version)
companies = app.integrations.avalara.retrieve_all_companies(top: 25, filter: "isActive eq true")
tax = app.integrations.avalara.create_new_transaction(include: "Summary,Addresses", body: {companyCode: "DEFAULT", type: "SalesOrder", customerCode: "CUST-100", lines: [{number: "1", quantity: 1, amount: 100, taxCode: "P0000000"}], addresses: {shipFrom: {line1: "100 Main St", city: "Seattle", region: "WA", country: "US", postalCode: "98101"}, shipTo: {line1: "200 Market St", city: "Portland", region: "OR", country: "US", postalCode: "97201"}}})
```
## Common Tools
