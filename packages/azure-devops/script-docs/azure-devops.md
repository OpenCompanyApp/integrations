...
```ruby
projects = app.call("integrations.azure-devops.get_all_projects_organization_that_authenticated_user_has_access", organization: "contoso")
repos = app.call("integrations.azure-devops.retrieve_git_repositories", organization: "contoso", project: "Website")
work_items = app.call("integrations.azure-devops.gets_work_items_list_work_item_ids_maximum_200", organization: "contoso", project: "Website", body: {ids: [1, 2, 3], fields: ["System.Title", "System.State"]})
```