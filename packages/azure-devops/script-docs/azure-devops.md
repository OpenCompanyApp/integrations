...
```js
var projects = azure_devops_core_projects_list({ organization: "contoso" })
var repos = azure_devops_git_repositories_list({ organization: "contoso", project: "Website" })
var work_items = azure_devops_wit_work_items_get_work_items_batch({
