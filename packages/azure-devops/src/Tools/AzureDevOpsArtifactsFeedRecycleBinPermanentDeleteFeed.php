 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint DELETE https://feeds.dev.azure.com/{organization}/{project}/_apis/packaging/feedrecyclebin/{feedId}.
 */
class AzureDevOpsArtifactsFeedRecycleBinPermanentDeleteFeed extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_artifacts_feed_recycle_bin_permanent_delete_feed';
    protected const DESCRIPTION = 'Permanently delete a feed and all of its packages. The action is irreversible and the package content will be deleted immediately. The project parameter must be supplied if the feed was created in a project. If the feed is not associated with any project, omit the project parameter from the request.

Official Azure DevOps REST API 7.2 endpoint: DELETE https://feeds.dev.azure.com/{organization}/{project}/_apis/packaging/feedrecyclebin/{feedId} (spec: artifacts/7.2/feed.json).';
