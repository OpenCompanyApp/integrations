 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://pkgs.dev.azure.com/{organization}/{project}/_packaging/packaging/feeds/{feedId}/cargo/packagesbatch.
 */
class AzureDevOpsArtifactsPackageTypesCargoUpdatePackageVersions extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_artifacts_package_types_cargo_update_package_versions';
...
Official Azure DevOps REST API 7.2 endpoint: POST https://pkgs.dev.azure.com/{organization}/{project}/_packaging/packaging/feeds/{feedId}/cargo/packagesbatch (spec: artifactsPackageTypes/7.2/cargoApi-AzureArtifacts.json).';
    ...
    protected const PATH = '/{organization}/{project}/_packaging/packaging/feeds/{feedId}/cargo/packagesbatch';
