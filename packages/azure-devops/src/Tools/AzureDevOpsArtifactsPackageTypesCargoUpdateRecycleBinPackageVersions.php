 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://pkgs.dev.azure.com/{organization}/{project}/_apis/packaging/feeds/{feedId}/cargo/RecycleBin/packagesBatch.
 */
class AzureDevOpsArtifactsPackageTypesCargoUpdateRecycleBinPackageVersions extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_artifacts_package_types_cargo_update_recycle_bin_package_versions';
...
Official Azure DevOps REST API 7.2 endpoint: POST https://pkgs.dev.azure.com/{organization}/{project}/_apis/packaging/feeds/{feedId}/cargo/RecycleBin/packagesBatch (spec: artifactsPackageTypes/7.2/cargoApi-AzureArtifacts.json).';
    ...
    protected const PATH = '/{organization}/{project}/_apis/packaging/feeds/{feedId}/cargo/RecycleBin/packagesBatch';
