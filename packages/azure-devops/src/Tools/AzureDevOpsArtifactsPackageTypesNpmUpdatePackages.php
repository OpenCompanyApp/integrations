 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://pkgs.dev.azure.com/{organization}/{project}/_apis/packaging/feeds/{feedId}/npm/packagesbatch.
 */
class AzureDevOpsArtifactsPackageTypesNpmUpdatePackages extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_artifacts_package_types_npm_update_packages';
...
Official Azure DevOps REST API 7.2 endpoint: POST https://pkgs.dev.azure.com/{organization}/{project}/_apis/packaging/feeds/{feedId}/npm/packagesbatch (spec: artifactsPackageTypes/7.2/npm.json).';
    ...
    protected const PATH = '/{organization}/{project}/_apis/packaging/feeds/{feedId}/npm/packagesbatch';
