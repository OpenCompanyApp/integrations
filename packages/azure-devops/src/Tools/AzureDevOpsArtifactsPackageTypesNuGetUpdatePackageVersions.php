 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://pkgs.dev.azure.com/{organization}/{project}/_apis/packaging/feeds/{feedId}/nuget/packagesbatch.
 */
class AzureDevOpsArtifactsPackageTypesNuGetUpdatePackageVersions extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_artifacts_package_types_nu_get_update_package_versions';
...
Official Azure DevOps REST API 7.2 endpoint: POST https://pkgs.dev.azure.com/{organization}/{project}/_apis/packaging/feeds/{feedId}/nuget/packagesbatch (spec: artifactsPackageTypes/7.2/nuGet.json).';
    ...
    protected const PATH = '/{organization}/{project}/_apis/packaging/feeds/{feedId}/nuget/packagesbatch';
