 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/build/definitions/{definitionId}.
 */
class AzureDevOpsBuildDefinitionsGet extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_build_definitions_get';
    protected const DESCRIPTION = 'Gets a definition, optionally at a specific revision.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/build/definitions/{definitionId} (spec: build/7.2/build.json).';
