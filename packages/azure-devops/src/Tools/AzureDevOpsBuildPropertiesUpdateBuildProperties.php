 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint PATCH https://dev.azure.com/{organization}/{project}/_apis/build/builds/{buildId}/properties.
 */
class AzureDevOpsBuildPropertiesUpdateBuildProperties extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_build_properties_update_build_properties';
    protected const DESCRIPTION = 'Updates properties for a build.

Official Azure DevOps REST API 7.2 endpoint: PATCH https://dev.azure.com/{organization}/{project}/_apis/build/builds/{buildId}/properties (spec: build/7.2/build.json).';
