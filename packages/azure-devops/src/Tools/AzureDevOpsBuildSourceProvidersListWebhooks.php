 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/sourceProviders/{providerName}/webhooks.
 */
class AzureDevOpsBuildSourceProvidersListWebhooks extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_build_source_providers_list_webhooks';
    protected const DESCRIPTION = 'Gets a list of webhooks installed in the given source code repository.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/sourceProviders/{providerName}/webhooks (spec: build/7.2/build.json).';
