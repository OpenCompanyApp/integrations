 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint DELETE https://dev.azure.com/{organization}/{project}/{team}/_apis/dashboard/dashboards/{dashboardId}/widgets/{widgetId}.
 */
class AzureDevOpsDashboardWidgetsDelete extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_dashboard_widgets_delete';
    protected const DESCRIPTION = 'Delete the specified widget.

Official Azure DevOps REST API 7.2 endpoint: DELETE https://dev.azure.com/{organization}/{project}/{team}/_apis/dashboard/dashboards/{dashboardId}/widgets/{widgetId} (spec: dashboard/7.2/dashboard.json).';
