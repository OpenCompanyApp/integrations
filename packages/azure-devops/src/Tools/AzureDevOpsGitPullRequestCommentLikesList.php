 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/threads/{threadId}/comments/{commentId}/likes.
 */
class AzureDevOpsGitPullRequestCommentLikesList extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_git_pull_request_comment_likes_list';
    protected const DESCRIPTION = 'Get likes for a comment.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/threads/{threadId}/comments/{commentId}/likes (spec: git/7.2/git.json).';
