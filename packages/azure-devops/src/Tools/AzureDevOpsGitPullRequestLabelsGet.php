 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/labels/{labelIdOrName}.
 */
class AzureDevOpsGitPullRequestLabelsGet extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_git_pull_request_labels_get';
    protected const DESCRIPTION = 'Retrieves a single label (tag) that has been assigned to a pull request.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/labels/{labelIdOrName} (spec: git/7.2/git.json).';
