 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/properties.
 */
class AzureDevOpsGitPullRequestPropertiesList extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_git_pull_request_properties_list';
    protected const DESCRIPTION = 'Get external properties of the pull request.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/properties (spec: git/7.2/git.json).';
