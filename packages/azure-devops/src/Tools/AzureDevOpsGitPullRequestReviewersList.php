 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/reviewers.
 */
class AzureDevOpsGitPullRequestReviewersList extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_git_pull_request_reviewers_list';
    protected const DESCRIPTION = 'Retrieve the reviewers for a pull request

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/reviewers (spec: git/7.2/git.json).';
