 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint DELETE https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/statuses/{statusId}.
 */
class AzureDevOpsGitPullRequestStatusesDelete extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_git_pull_request_statuses_delete';
    protected const DESCRIPTION = 'Delete pull request status. You can remove multiple statuses in one call by using Update operation.

Official Azure DevOps REST API 7.2 endpoint: DELETE https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/statuses/{statusId} (spec: git/7.2/git.json).';
