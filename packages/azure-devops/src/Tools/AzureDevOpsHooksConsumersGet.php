 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/_apis/hooks/consumers/{consumerId}.
 */
class AzureDevOpsHooksConsumersGet extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_hooks_consumers_get';
    protected const DESCRIPTION = 'Get a specific consumer service. Optionally filter out consumer actions that do not support any event types for the specified publisher.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/_apis/hooks/consumers/{consumerId} (spec: hooks/7.2/serviceHooks.json).';
    ...
    protected const PATH = '/{organization}/_apis/hooks/consumers/{consumerId}';
