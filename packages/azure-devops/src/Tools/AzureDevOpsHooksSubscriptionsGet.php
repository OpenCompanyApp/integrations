 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/_apis/hooks/subscriptions/{subscriptionId}.
 */
class AzureDevOpsHooksSubscriptionsGet extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_hooks_subscriptions_get';
    protected const DESCRIPTION = 'Get a specific service hooks subscription.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/_apis/hooks/subscriptions/{subscriptionId} (spec: hooks/7.2/serviceHooks.json).';
