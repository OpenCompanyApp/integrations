 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://dev.azure.com/{organization}/{project}/_apis/pipelines/{pipelineId}/preview.
 */
class AzureDevOpsPipelinesPreviewPreview extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_pipelines_preview_preview';
    protected const DESCRIPTION = 'Queues a dry run of the pipeline and returns an object containing the final yaml.

Official Azure DevOps REST API 7.2 endpoint: POST https://dev.azure.com/{organization}/{project}/_apis/pipelines/{pipelineId}/preview (spec: pipelines/7.2/pipelines.json).';
    ...
    protected const PATH = '/{organization}/{project}/_apis/pipelines/{pipelineId}/preview';
