 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint PATCH https://dev.azure.com/{organization}/_apis/work/processes/{processId}/workItemTypes/{witRefName}/layout/pages.
 */
class AzureDevOpsProcessesPagesUpdate extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_processes_pages_update';
    protected const DESCRIPTION = 'Updates a page on the work item form

Official Azure DevOps REST API 7.2 endpoint: PATCH https://dev.azure.com/{organization}/_apis/work/processes/{processId}/workItemTypes/{witRefName}/layout/pages (spec: processes/7.2/workItemTrackingProcess.json).';
