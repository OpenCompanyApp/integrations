 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://dev.azure.com/{organization}/_apis/work/processes/{processId}/workitemtypesbehaviors/{witRefNameForBehaviors}/behaviors.
 */
class AzureDevOpsProcessesWorkItemTypesBehaviorsAdd extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_processes_work_item_types_behaviors_add';
    protected const DESCRIPTION = 'Adds a behavior to the work item type of the process.

Official Azure DevOps REST API 7.2 endpoint: POST https://dev.azure.com/{organization}/_apis/work/processes/{processId}/workitemtypesbehaviors/{witRefNameForBehaviors}/behaviors (spec: processes/7.2/workItemTrackingProcess.json).';
