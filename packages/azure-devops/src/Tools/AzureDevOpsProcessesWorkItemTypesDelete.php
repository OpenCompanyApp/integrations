 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint DELETE https://dev.azure.com/{organization}/_apis/work/processes/{processId}/workitemtypes/{witRefName}.
 */
class AzureDevOpsProcessesWorkItemTypesDelete extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_processes_work_item_types_delete';
    protected const DESCRIPTION = 'Removes a work item type in the process.

Official Azure DevOps REST API 7.2 endpoint: DELETE https://dev.azure.com/{organization}/_apis/work/processes/{processId}/workitemtypes/{witRefName} (spec: processes/7.2/workItemTrackingProcess.json).';
