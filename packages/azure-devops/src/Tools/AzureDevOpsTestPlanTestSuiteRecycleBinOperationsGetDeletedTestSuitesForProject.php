 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/testplan/recycleBin/testsuite.
 */
class AzureDevOpsTestPlanTestSuiteRecycleBinOperationsGetDeletedTestSuitesForProject extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_test_plan_test_suite_recycle_bin_operations_get_deleted_test_suites_for_project';
    protected const DESCRIPTION = 'Get Deleted Test Suites within a Project.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/testplan/recycleBin/testsuite (spec: testPlan/7.2/testPlan.json).';
    ...
    protected const PATH = '/{organization}/{project}/_apis/testplan/recycleBin/testsuite';
