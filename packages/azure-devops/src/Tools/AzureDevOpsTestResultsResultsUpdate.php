...
/**
 * PATCH /{organization}/{project}/_apis/testresults/runs/{runId}/results.
 *
 * Maps to Azure DevOps REST API 7.2 endpoint PATCH https://vstmr.dev.azure.com/{organization}/{project}/_apis/testresults/runs/{runId}/results.
 */
class AzureDevOpsTestResultsResultsUpdate extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_test_results_results_update';
    protected const DESCRIPTION = 'PATCH /{organization}/{project}/_apis/testresults/runs/{runId}/results

Official Azure DevOps REST API 7.2 endpoint: PATCH https://vstmr.dev.azure.com/{organization}/{project}/_apis/testresults/runs/{runId}/results (spec: testResults/7.2/testResults.json).';
