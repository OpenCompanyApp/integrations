...
/**
 * PATCH /{organization}/{project}/_apis/testresults/runs/{runId}.
 *
 * Maps to Azure DevOps REST API 7.2 endpoint PATCH https://vstmr.dev.azure.com/{organization}/{project}/_apis/testresults/runs/{runId}.
 */
class AzureDevOpsTestResultsRunsUpdate extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_test_results_runs_update';
    protected const DESCRIPTION = 'PATCH /{organization}/{project}/_apis/testresults/runs/{runId}

Official Azure DevOps REST API 7.2 endpoint: PATCH https://vstmr.dev.azure.com/{organization}/{project}/_apis/testresults/runs/{runId} (spec: testResults/7.2/testResults.json).';
