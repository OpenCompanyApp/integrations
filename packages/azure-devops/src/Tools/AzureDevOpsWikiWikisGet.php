 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/_apis/wiki/wikis/{wikiIdentifier}.
 */
class AzureDevOpsWikiWikisGet extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_wiki_wikis_get';
    protected const DESCRIPTION = 'Gets the wiki corresponding to the wiki ID or wiki name provided.

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/_apis/wiki/wikis/{wikiIdentifier} (spec: wiki/7.2/wiki.json).';
