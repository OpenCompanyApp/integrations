 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint POST https://dev.azure.com/{organization}/{project}/_apis/wit/classificationnodes/{structureGroup}/{path}.
 */
class AzureDevOpsWitClassificationNodesCreateOrUpdate extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_wit_classification_nodes_create_or_update';
    protected const DESCRIPTION = 'Create new or update an existing classification node.

Official Azure DevOps REST API 7.2 endpoint: POST https://dev.azure.com/{organization}/{project}/_apis/wit/classificationnodes/{structureGroup}/{path} (spec: wit/7.2/workItemTracking.json).';
