 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint DELETE https://dev.azure.com/{organization}/{project}/_apis/wit/workItems/{workItemId}/comments/{commentId}/reactions/{reactionType}.
 */
class AzureDevOpsWitCommentsReactionsDelete extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_wit_comments_reactions_delete';
    protected const DESCRIPTION = 'Deletes an existing reaction on a comment.

Official Azure DevOps REST API 7.2 endpoint: DELETE https://dev.azure.com/{organization}/{project}/_apis/wit/workItems/{workItemId}/comments/{commentId}/reactions/{reactionType} (spec: wit/7.2/workItemTracking.json).';
