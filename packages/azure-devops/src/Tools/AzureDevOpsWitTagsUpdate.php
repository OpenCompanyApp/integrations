 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint PATCH https://dev.azure.com/{organization}/{project}/_apis/wit/tags/{tagIdOrName}.
 */
class AzureDevOpsWitTagsUpdate extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_wit_tags_update';
    protected const DESCRIPTION = 'Update the tag for the project.

Official Azure DevOps REST API 7.2 endpoint: PATCH https://dev.azure.com/{organization}/{project}/_apis/wit/tags/{tagIdOrName} (spec: wit/7.2/workItemTracking.json).';
