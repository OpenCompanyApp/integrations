 ...
 *
 * Maps to Azure DevOps REST API 7.2 endpoint PATCH https://dev.azure.com/{organization}/{project}/{team}/_apis/work/boards/{board}/boardusersettings.
 */
class AzureDevOpsWorkBoardusersettingsUpdate extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_work_boardusersettings_update';
    protected const DESCRIPTION = 'Update board user settings for the board id We don\'t want stakeholders to update board settings (currently just autorefresh). The BacklogManagement feature check validates this.

Official Azure DevOps REST API 7.2 endpoint: PATCH https://dev.azure.com/{organization}/{project}/{team}/_apis/work/boards/{board}/boardusersettings (spec: work/7.2/work.json).';
