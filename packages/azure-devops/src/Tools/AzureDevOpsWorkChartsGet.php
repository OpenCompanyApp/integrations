 ...
 * Get a board chart.
 *
 * Maps to Azure DevOps REST API 7.2 endpoint GET https://dev.azure.com/{organization}/{project}/{team}/_apis/work/boards/{board}/charts/{name}.
 */
class AzureDevOpsWorkChartsGet extends AbstractAzureDevOpsTool
{
    protected const NAME = 'azure_devops_work_charts_get';
    protected const DESCRIPTION = 'Get a board chart

Official Azure DevOps REST API 7.2 endpoint: GET https://dev.azure.com/{organization}/{project}/{team}/_apis/work/boards/{board}/charts/{name} (spec: work/7.2/work.json).';
