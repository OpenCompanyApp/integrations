...
```lua
local publications = app.integrations.beehiiv.publications_index({})

local posts = app.integrations.beehiiv.posts_index({
  publication_id = "pub_00000000-0000-0000-0000-000000000000",
  limit = 10
})

local subscription = app.integrations.beehiiv.subscriptions_create({
  body = {
