...
```ruby
publications = app.integrations.beehiiv.list_publications_oauth_scope_publications_read()
posts = app.integrations.beehiiv.list_posts_oauth_scope_posts_read(publication_id: "pub_00000000-0000-0000-0000-000000000000", limit: 10)
subscription = app.integrations.beehiiv.create_subscription_oauth_scope_subscriptions_write(body: {email: "reader@example.test", reactivate_existing: false, send_welcome_email: false})
```
## Common Tools
