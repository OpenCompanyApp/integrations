...
/**
 * Base class for focused BigCommerce Admin REST endpoint tools.
 *
 ...
 */
abstract class AbstractBigCommerceEndpointTool implements Tool
{
    ...
    /**
     * @param  BigCommerceService  $service  The BigCommerce API client.
     */
    public function __construct(
        protected BigCommerceService $service,
    ) {}
    ...
    /**
     * Execute one BigCommerce Admin REST API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('BigCommerce integration is not configured. Access token and store hash or base URL are required.');
            }
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported BigCommerce tool method: {$this->method}"),
            };
