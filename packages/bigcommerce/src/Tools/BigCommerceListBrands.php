 ...
 */
class BigCommerceListBrands extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_brands';

    protected string $toolDescription = 'List BigCommerce Brands.';
