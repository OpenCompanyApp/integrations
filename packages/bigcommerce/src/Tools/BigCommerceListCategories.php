 ...
 */
class BigCommerceListCategories extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_categories';

    protected string $toolDescription = 'List BigCommerce Categorys.';
