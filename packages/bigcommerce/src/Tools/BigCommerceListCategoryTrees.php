 ...
 */
class BigCommerceListCategoryTrees extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_category_trees';

    protected string $toolDescription = 'List BigCommerce Category Trees.';
