 ...
 */
class BigCommerceListChannels extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_channels';

    protected string $toolDescription = 'List BigCommerce Channels.';
