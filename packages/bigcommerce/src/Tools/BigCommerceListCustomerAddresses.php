 ...
 */
class BigCommerceListCustomerAddresses extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_customer_addresses';

    protected string $toolDescription = 'List Customer Addresses.';
