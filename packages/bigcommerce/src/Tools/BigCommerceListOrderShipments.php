 ...
 */
class BigCommerceListOrderShipments extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_order_shipments';

    protected string $toolDescription = 'List shipments for an order.';
