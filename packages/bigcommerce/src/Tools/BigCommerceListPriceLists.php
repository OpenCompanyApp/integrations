 ...
 */
class BigCommerceListPriceLists extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_price_lists';

    protected string $toolDescription = 'List BigCommerce Price Lists.';
