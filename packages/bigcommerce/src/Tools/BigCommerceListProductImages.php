 ...
 */
class BigCommerceListProductImages extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_product_images';

    protected string $toolDescription = 'List images for a catalog product.';
