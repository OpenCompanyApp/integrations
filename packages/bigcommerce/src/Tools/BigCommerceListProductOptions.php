 ...
 */
class BigCommerceListProductOptions extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_product_options';

    protected string $toolDescription = 'List options for a catalog product.';
