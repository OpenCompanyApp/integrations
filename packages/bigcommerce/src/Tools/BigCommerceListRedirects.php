 ...
 */
class BigCommerceListRedirects extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_redirects';

    protected string $toolDescription = 'List BigCommerce Redirects.';
