 ...
 */
class BigCommerceListSites extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_sites';

    protected string $toolDescription = 'List BigCommerce Sites.';
