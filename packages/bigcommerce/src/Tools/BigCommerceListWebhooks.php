 ...
 */
class BigCommerceListWebhooks extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_webhooks';

    protected string $toolDescription = 'List BigCommerce Webhooks.';
