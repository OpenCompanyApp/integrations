 ...
 */
class BigCommerceListWidgetTemplates extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_widget_templates';

    protected string $toolDescription = 'List BigCommerce Widget Templates.';
