 ...
 */
class BigCommerceListWidgets extends AbstractBigCommerceEndpointTool
{
    protected string $toolName = 'bigcommerce_list_widgets';

    protected string $toolDescription = 'List BigCommerce Widgets.';
