 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/eth-staking/eth/history/rateHistory.
 */
class BinanceGetSapiV1EthStakingEthHistoryRatehistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_eth_staking_eth_history_ratehistory';
    protected const DESCRIPTION = 'Get WBETH Rate History (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/eth-staking/eth/history/rateHistory.';
    ...
    protected const PATH = '/sapi/v1/eth-staking/eth/history/rateHistory';
