 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/eth-staking/eth/history/redemptionHistory.
 */
class BinanceGetSapiV1EthStakingEthHistoryRedemptionhistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_eth_staking_eth_history_redemptionhistory';
    protected const DESCRIPTION = 'Get ETH redemption history (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/eth-staking/eth/history/redemptionHistory.';
    ...
    protected const PATH = '/sapi/v1/eth-staking/eth/history/redemptionHistory';
