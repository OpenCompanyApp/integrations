 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/eth-staking/eth/history/rewardsHistory.
 */
class BinanceGetSapiV1EthStakingEthHistoryRewardshistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_eth_staking_eth_history_rewardshistory';
    protected const DESCRIPTION = 'Get BETH rewards distribution history(USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/eth-staking/eth/history/rewardsHistory.';
    ...
    protected const PATH = '/sapi/v1/eth-staking/eth/history/rewardsHistory';
