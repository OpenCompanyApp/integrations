 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/eth-staking/eth/history/wbethRewardsHistory.
 */
class BinanceGetSapiV1EthStakingEthHistoryWbethrewardshistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_eth_staking_eth_history_wbethrewardshistory';
    protected const DESCRIPTION = 'Get WBETH rewards history(USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/eth-staking/eth/history/wbethRewardsHistory.';
    ...
    protected const PATH = '/sapi/v1/eth-staking/eth/history/wbethRewardsHistory';
