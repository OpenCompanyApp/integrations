 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/eth-staking/wbeth/history/unwrapHistory.
 */
class BinanceGetSapiV1EthStakingWbethHistoryUnwraphistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_eth_staking_wbeth_history_unwraphistory';
    protected const DESCRIPTION = 'Get WBETH unwrap history (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/eth-staking/wbeth/history/unwrapHistory.';
    ...
    protected const PATH = '/sapi/v1/eth-staking/wbeth/history/unwrapHistory';
