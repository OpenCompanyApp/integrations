 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/loan/borrow/history.
 */
class BinanceGetSapiV1LoanBorrowHistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_loan_borrow_history';
    protected const DESCRIPTION = 'Get Crypto Loans Borrow History (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/loan/borrow/history.';
    ...
    protected const PATH = '/sapi/v1/loan/borrow/history';
