 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/loan/repay/history.
 */
class BinanceGetSapiV1LoanRepayHistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_loan_repay_history';
    protected const DESCRIPTION = 'Get Loan Repayment History (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/loan/repay/history.';
    ...
    protected const PATH = '/sapi/v1/loan/repay/history';
