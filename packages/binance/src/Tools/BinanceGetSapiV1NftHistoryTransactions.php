 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v1/nft/history/transactions.
 */
class BinanceGetSapiV1NftHistoryTransactions extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v1_nft_history_transactions';
    protected const DESCRIPTION = 'Get NFT Transaction History (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v1/nft/history/transactions.';
    ...
    protected const PATH = '/sapi/v1/nft/history/transactions';
