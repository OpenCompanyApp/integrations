 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v2/loan/flexible/ltv/adjustment/history.
 */
class BinanceGetSapiV2LoanFlexibleLtvAdjustmentHistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v2_loan_flexible_ltv_adjustment_history';
    protected const DESCRIPTION = 'Adjust LTV - Get Flexible Loan LTV Adjustment History (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v2/loan/flexible/ltv/adjustment/history.';
    ...
    protected const PATH = '/sapi/v2/loan/flexible/ltv/adjustment/history';
