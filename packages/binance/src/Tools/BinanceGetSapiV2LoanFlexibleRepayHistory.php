 ...
 *
 * Maps to the official Binance Spot endpoint GET /sapi/v2/loan/flexible/repay/history.
 */
class BinanceGetSapiV2LoanFlexibleRepayHistory extends AbstractBinanceTool
{
    protected const NAME = 'binance_get_sapi_v2_loan_flexible_repay_history';
    protected const DESCRIPTION = 'Repay - Get Flexible Loan Repayment History (USER_DATA)
...
Official Binance Spot endpoint: GET /sapi/v2/loan/flexible/repay/history.';
    ...
    protected const PATH = '/sapi/v2/loan/flexible/repay/history';
