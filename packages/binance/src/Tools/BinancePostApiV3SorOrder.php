 ...
 *
 * Maps to the official Binance Spot endpoint POST /api/v3/sor/order.
 */
class BinancePostApiV3SorOrder extends AbstractBinanceTool
{
    protected const NAME = 'binance_post_api_v3_sor_order';
    protected const DESCRIPTION = 'New order using SOR (TRADE)
...
Official Binance Spot endpoint: POST /api/v3/sor/order.';
    ...
    protected const PATH = '/api/v3/sor/order';
