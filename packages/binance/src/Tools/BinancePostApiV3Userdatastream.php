 ...
 *
 * Maps to the official Binance Spot endpoint POST /api/v3/userDataStream.
 */
class BinancePostApiV3Userdatastream extends AbstractBinanceTool
{
    protected const NAME = 'binance_post_api_v3_userdatastream';
