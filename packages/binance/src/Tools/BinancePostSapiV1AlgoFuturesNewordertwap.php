 ...
 *
 * Maps to the official Binance Spot endpoint POST /sapi/v1/algo/futures/newOrderTwap.
 */
class BinancePostSapiV1AlgoFuturesNewordertwap extends AbstractBinanceTool
{
    protected const NAME = 'binance_post_sapi_v1_algo_futures_newordertwap';
    protected const DESCRIPTION = 'Time-Weighted Average Price(Twap) New Order (TRADE)
...
Official Binance Spot endpoint: POST /sapi/v1/algo/futures/newOrderTwap.';
    ...
    protected const PATH = '/sapi/v1/algo/futures/newOrderTwap';
