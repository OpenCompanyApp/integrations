# HTTP client for the Bitbucket REST API (v2) — JavaScript API Reference
...
```js
var result = app.integrations.bitbucket.bitbucket_create_branch({
  workspace: "",
  repo_slug: "",
  name: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_create_issue({
  workspace: "",
  repo_slug: "",
  title: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_create_pull_request({
  workspace: "",
  repo_slug: "",
  title: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_create_repo({
  workspace: "",
  repo_slug: "",
  description: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_get_file({
  workspace: "",
  repo_slug: "",
  revision: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_get_issue({
  workspace: "",
  repo_slug: "",
  issue_id: 0,
})
...
```js
var result = app.integrations.bitbucket.bitbucket_get_pull_request({
  workspace: "",
  repo_slug: "",
  pr_id: 0,
})
...
```js
var result = app.integrations.bitbucket.bitbucket_get_repo({
  workspace: "",
  repo_slug: "",
})
```
...
```js
var result = app.integrations.bitbucket.bitbucket_list_branches({
  workspace: "",
  repo_slug: "",
  pagelen: 0,
})
...
```js
var result = app.integrations.bitbucket.bitbucket_list_commits({
  workspace: "",
  repo_slug: "",
  revision: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_list_issues({
  workspace: "",
  repo_slug: "",
  state: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_list_pull_requests({
  workspace: "",
  repo_slug: "",
  state: "",
})
...
```js
var result = app.integrations.bitbucket.bitbucket_list_repos({
  workspace: "",
  sort: "",
  pagelen: 0,
})
...
```js
var result = app.integrations.bitbucket.bitbucket_merge_pull_request({
  workspace: "",
  repo_slug: "",
  pr_id: 0,
})
...
```js
var result = app.integrations.bitbucket.bitbucket_update_issue({
  workspace: "",
  repo_slug: "",
  issue_id: 0,
})
...
app.integrations.bitbucket.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.bitbucket.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.bitbucket.work.function_name({ /* parameters */ })
app.integrations.bitbucket.personal.function_name({ /* parameters */ })
```
