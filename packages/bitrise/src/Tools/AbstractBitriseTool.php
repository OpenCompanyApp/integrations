...
/**
 * Shared executor for Bitrise tools.
 *
 ...
 */
abstract class AbstractBitriseTool implements Tool
{
    ...
    /**
     * @param  BitriseService  $service  Bitrise API client.
     */
    public function __construct(protected BitriseService $service) {}
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('Bitrise integration is not configured.');
            }
