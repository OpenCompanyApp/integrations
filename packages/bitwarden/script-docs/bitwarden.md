...
```ruby
members = app.integrations.bitwarden.list_all_members()
events = app.integrations.bitwarden.list_all_events(start: "2026-01-01T00:00:00Z", end: "2026-01-31T23:59:59Z")
```