...
/**
 * Tool: bluesky_list_followers
 *
 * List the followers of a Bluesky account via the
 * {@link GET /xrpc/app.bsky.graph.getFollowers} endpoint.
 *
 ...
 */
class BlueskyListFollowers implements Tool
{
    /**
    ...
    {
        return 'List the followers of a Bluesky account. Returns follower profiles with handles, display names, and avatars.';
    }
    ...
    {
        return [
            'actor' => ['type' => 'string', 'required' => true, 'description' => 'Handle or DID of the user whose followers to list.'],
    ...
    /**
     * Execute the tool — list followers.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listFollowers($args['actor'], $limit, $cursor);
