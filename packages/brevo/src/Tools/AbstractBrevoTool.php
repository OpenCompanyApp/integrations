...
abstract class AbstractBrevoTool implements Tool
{
    ...
    /**
     * @param  BrevoService  $service  The Brevo API client.
     */
    public function __construct(
        protected BrevoService $service,
    ) {}
    ...
    /**
     * Execute one Brevo API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('Brevo integration is not configured. API key is required.');
            }
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported Brevo tool method: {$this->method}"),
            };
