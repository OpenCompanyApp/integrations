 ...
 */
class BrevoApiPost extends AbstractBrevoTool
{
    protected string $toolName = 'brevo_api_post';

    protected string $toolDescription = 'Call any Brevo API POST endpoint path.';
    ...
    'path' => [
        'type' => 'string',
        'required' => true,
        'description' => 'Endpoint path, such as /smtp/email.',
    ],
    'payload' => [
        'type' => 'object',
        'required' => false,
