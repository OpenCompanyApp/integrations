 ...
 */
class BrevoApiPut extends AbstractBrevoTool
{
    protected string $toolName = 'brevo_api_put';

    protected string $toolDescription = 'Call any Brevo API PUT endpoint path.';
