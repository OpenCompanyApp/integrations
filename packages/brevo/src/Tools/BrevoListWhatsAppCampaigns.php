 ...
 */
class BrevoListWhatsAppCampaigns extends AbstractBrevoTool
{
    protected string $toolName = 'brevo_list_whatsapp_campaigns';

    protected string $toolDescription = 'List WhatsApp campaigns.';
