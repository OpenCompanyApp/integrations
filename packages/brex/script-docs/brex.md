...
```ruby
cards = app.integrations.brex.list_cards(user_id: "user_123", limit: 20)
created = app.integrations.brex.create_card(idempotency_key: "example-key", body: {user_id: "user_123"})
```
## Coverage Notes
