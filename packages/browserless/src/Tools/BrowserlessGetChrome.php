 ...
 * /chrome.
 *
 * Maps to the official Browserless endpoint GET /chrome.
 */
class BrowserlessGetChrome extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chrome';
    protected const DESCRIPTION = '/chrome
