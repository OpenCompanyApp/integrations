 ...
 * /chrome/playwright.
 *
 * Maps to the official Browserless endpoint GET /chrome/playwright.
 */
class BrowserlessGetChromePlaywright extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chrome_playwright';
    protected const DESCRIPTION = '/chrome/playwright
...
Official Browserless endpoint: GET /chrome/playwright.';
    ...
    protected const PATH = '/chrome/playwright';
