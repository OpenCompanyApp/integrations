 ...
 * /chrome/stealth.
 *
 * Maps to the official Browserless endpoint GET /chrome/stealth.
 */
class BrowserlessGetChromeStealth extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chrome_stealth';
    protected const DESCRIPTION = '/chrome/stealth
...
Official Browserless endpoint: GET /chrome/stealth.';
    ...
    protected const PATH = '/chrome/stealth';
