 ...
 * /chromium/agent.
 *
 * Maps to the official Browserless endpoint GET /chromium/agent.
 */
class BrowserlessGetChromiumAgent extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chromium_agent';
    protected const DESCRIPTION = '/chromium/agent
...
Official Browserless endpoint: GET /chromium/agent.';
    ...
    protected const PATH = '/chromium/agent';
