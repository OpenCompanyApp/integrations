 ...
 * /chromium/bql?(/*).
 *
 * Maps to the official Browserless endpoint GET /chromium/bql?(/*).
 */
class BrowserlessGetChromiumBqloptionalPath extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chromium_bqloptional_path';
