 ...
 * /chromium/playwright.
 *
 * Maps to the official Browserless endpoint GET /chromium/playwright.
 */
class BrowserlessGetChromiumPlaywright extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chromium_playwright';
    protected const DESCRIPTION = '/chromium/playwright
...
Official Browserless endpoint: GET /chromium/playwright.';
    ...
    protected const PATH = '/chromium/playwright';
