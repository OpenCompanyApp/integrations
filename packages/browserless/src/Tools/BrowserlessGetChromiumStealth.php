 ...
 * /chromium/stealth.
 *
 * Maps to the official Browserless endpoint GET /chromium/stealth.
 */
class BrowserlessGetChromiumStealth extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_chromium_stealth';
    protected const DESCRIPTION = '/chromium/stealth
...
Official Browserless endpoint: GET /chromium/stealth.';
    ...
    protected const PATH = '/chromium/stealth';
