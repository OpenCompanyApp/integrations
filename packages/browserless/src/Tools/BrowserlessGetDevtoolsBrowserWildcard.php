 ...
 * /devtools/browser/*.
 *
 * Maps to the official Browserless endpoint GET /devtools/browser/*.
 */
class BrowserlessGetDevtoolsBrowserWildcard extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_devtools_browser_wildcard';
    protected const DESCRIPTION = '/devtools/browser/*
...
Official Browserless endpoint: GET /devtools/browser/*.';
    ...
    protected const PATH = '/devtools/browser/{path_suffix}';
