 ...
 * /devtools/page/*.
 *
 * Maps to the official Browserless endpoint GET /devtools/page/*.
 */
class BrowserlessGetDevtoolsPageWildcard extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_devtools_page_wildcard';
    protected const DESCRIPTION = '/devtools/page/*
...
Official Browserless endpoint: GET /devtools/page/*.';
    ...
    protected const PATH = '/devtools/page/{path_suffix}';
