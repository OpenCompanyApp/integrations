 ...
 * /edge.
 *
 * Maps to the official Browserless endpoint GET /edge.
 */
class BrowserlessGetEdge extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_edge';
    protected const DESCRIPTION = '/edge
