 ...
 * /edge/playwright.
 *
 * Maps to the official Browserless endpoint GET /edge/playwright.
 */
class BrowserlessGetEdgePlaywright extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_edge_playwright';
    protected const DESCRIPTION = '/edge/playwright
...
Official Browserless endpoint: GET /edge/playwright.';
    ...
    protected const PATH = '/edge/playwright';
