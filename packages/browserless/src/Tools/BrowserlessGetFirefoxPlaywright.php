 ...
 * /firefox/playwright.
 *
 * Maps to the official Browserless endpoint GET /firefox/playwright.
 */
class BrowserlessGetFirefoxPlaywright extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_firefox_playwright';
    protected const DESCRIPTION = '/firefox/playwright
...
Official Browserless endpoint: GET /firefox/playwright.';
    ...
    protected const PATH = '/firefox/playwright';
