 ...
 * /function/connect/*.
 *
 * Maps to the official Browserless endpoint GET /function/connect/*.
 */
class BrowserlessGetFunctionConnectWildcard extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_function_connect_wildcard';
    protected const DESCRIPTION = '/function/connect/*
...
Official Browserless endpoint: GET /function/connect/*.';
    ...
    protected const PATH = '/function/connect/{path_suffix}';
