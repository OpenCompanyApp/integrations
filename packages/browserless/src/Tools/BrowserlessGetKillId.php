 ...
 * /kill/+([0-9a-zA-Z-_]).
 *
 * Maps to the official Browserless endpoint GET /kill/+([0-9a-zA-Z-_]).
 */
class BrowserlessGetKillId extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_kill_id';
    protected const DESCRIPTION = '/kill/+([0-9a-zA-Z-_])
...
Official Browserless endpoint: GET /kill/+([0-9a-zA-Z-_]).';
    ...
    protected const PATH = '/kill/{path_suffix}';
