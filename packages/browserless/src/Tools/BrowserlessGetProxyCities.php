 ...
 * /proxy/cities.
 *
 * Maps to the official Browserless endpoint GET /proxy/cities.
 */
class BrowserlessGetProxyCities extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_proxy_cities';
    protected const DESCRIPTION = '/proxy/cities
...
Official Browserless endpoint: GET /proxy/cities.';
    ...
    protected const PATH = '/proxy/cities';
