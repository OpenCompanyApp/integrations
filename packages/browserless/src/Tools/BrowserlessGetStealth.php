 ...
 * /stealth.
 *
 * Maps to the official Browserless endpoint GET /stealth.
 */
class BrowserlessGetStealth extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_stealth';
    protected const DESCRIPTION = '/stealth
