 ...
 * /stealth/bql?(/*).
 *
 * Maps to the official Browserless endpoint GET /stealth/bql?(/*).
 */
class BrowserlessGetStealthBqloptionalPath extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_stealth_bqloptional_path';
