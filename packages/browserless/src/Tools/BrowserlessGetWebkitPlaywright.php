 ...
 * /webkit/playwright.
 *
 * Maps to the official Browserless endpoint GET /webkit/playwright.
 */
class BrowserlessGetWebkitPlaywright extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_get_webkit_playwright';
    protected const DESCRIPTION = '/webkit/playwright
...
Official Browserless endpoint: GET /webkit/playwright.';
    ...
    protected const PATH = '/webkit/playwright';
