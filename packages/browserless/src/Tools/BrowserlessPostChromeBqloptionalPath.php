 ...
 * /chrome/bql?(/*).
 *
 * Maps to the official Browserless endpoint POST /chrome/bql?(/*).
 */
class BrowserlessPostChromeBqloptionalPath extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_bqloptional_path';
