 ...
 * /chrome/content.
 *
 * Maps to the official Browserless endpoint POST /chrome/content.
 */
class BrowserlessPostChromeContent extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_content';
    protected const DESCRIPTION = '/chrome/content
...
Official Browserless endpoint: POST /chrome/content.';
    ...
    protected const PATH = '/chrome/content';
