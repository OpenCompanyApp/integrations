 ...
 * /chrome/download.
 *
 * Maps to the official Browserless endpoint POST /chrome/download.
 */
class BrowserlessPostChromeDownload extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_download';
    protected const DESCRIPTION = '/chrome/download
...
Official Browserless endpoint: POST /chrome/download.';
    ...
    protected const PATH = '/chrome/download';
