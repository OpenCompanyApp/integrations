 ...
 * /chrome/export.
 *
 * Maps to the official Browserless endpoint POST /chrome/export.
 */
class BrowserlessPostChromeExport extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_export';
    protected const DESCRIPTION = '/chrome/export
...
Official Browserless endpoint: POST /chrome/export.';
    ...
    protected const PATH = '/chrome/export';
