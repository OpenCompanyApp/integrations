 ...
 * /chrome/pdf.
 *
 * Maps to the official Browserless endpoint POST /chrome/pdf.
 */
class BrowserlessPostChromePdf extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_pdf';
    protected const DESCRIPTION = '/chrome/pdf
...
Official Browserless endpoint: POST /chrome/pdf.';
    ...
    protected const PATH = '/chrome/pdf';
