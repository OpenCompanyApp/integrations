 ...
 * /chrome/performance.
 *
 * Maps to the official Browserless endpoint POST /chrome/performance.
 */
class BrowserlessPostChromePerformance extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_performance';
    protected const DESCRIPTION = '/chrome/performance
...
Official Browserless endpoint: POST /chrome/performance.';
    ...
    protected const PATH = '/chrome/performance';
