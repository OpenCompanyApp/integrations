 ...
 * /chrome/scrape.
 *
 * Maps to the official Browserless endpoint POST /chrome/scrape.
 */
class BrowserlessPostChromeScrape extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_scrape';
    protected const DESCRIPTION = '/chrome/scrape
...
Official Browserless endpoint: POST /chrome/scrape.';
    ...
    protected const PATH = '/chrome/scrape';
