 ...
 * /chrome/unblock.
 *
 * Maps to the official Browserless endpoint POST /chrome/unblock.
 */
class BrowserlessPostChromeUnblock extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chrome_unblock';
    protected const DESCRIPTION = '/chrome/unblock
...
Official Browserless endpoint: POST /chrome/unblock.';
    ...
    protected const PATH = '/chrome/unblock';
