 ...
 * /chromium/bql?(/*).
 *
 * Maps to the official Browserless endpoint POST /chromium/bql?(/*).
 */
class BrowserlessPostChromiumBqloptionalPath extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_bqloptional_path';
    protected const DESCRIPTION = '/chromium/bql?(/*)
...
Official Browserless endpoint: POST /chromium/bql?(/*).';
    ...
    protected const PATH = '/chromium/bql/{path_suffix}';
