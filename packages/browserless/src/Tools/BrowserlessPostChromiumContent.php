 ...
 * /chromium/content.
 *
 * Maps to the official Browserless endpoint POST /chromium/content.
 */
class BrowserlessPostChromiumContent extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_content';
    protected const DESCRIPTION = '/chromium/content
...
Official Browserless endpoint: POST /chromium/content.';
    ...
    protected const PATH = '/chromium/content';
