 ...
 * /chromium/download.
 *
 * Maps to the official Browserless endpoint POST /chromium/download.
 */
class BrowserlessPostChromiumDownload extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_download';
    protected const DESCRIPTION = '/chromium/download
...
Official Browserless endpoint: POST /chromium/download.';
    ...
    protected const PATH = '/chromium/download';
