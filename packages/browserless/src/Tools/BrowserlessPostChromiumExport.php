 ...
 * /chromium/export.
 *
 * Maps to the official Browserless endpoint POST /chromium/export.
 */
class BrowserlessPostChromiumExport extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_export';
    protected const DESCRIPTION = '/chromium/export
...
Official Browserless endpoint: POST /chromium/export.';
    ...
    protected const PATH = '/chromium/export';
