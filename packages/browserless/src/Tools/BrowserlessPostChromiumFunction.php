 ...
 * /chromium/function.
 *
 * Maps to the official Browserless endpoint POST /chromium/function.
 */
class BrowserlessPostChromiumFunction extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_function';
    protected const DESCRIPTION = '/chromium/function
...
Official Browserless endpoint: POST /chromium/function.';
    ...
    protected const PATH = '/chromium/function';
