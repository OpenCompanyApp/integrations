 ...
 *
 * Maps to the official Browserless endpoint POST /chromium/performance.
 */
class BrowserlessPostChromiumPerformance extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_performance';
    protected const DESCRIPTION = '/chromium/performance
...
Official Browserless endpoint: POST /chromium/performance.';
    ...
    protected const PATH = '/chromium/performance';
