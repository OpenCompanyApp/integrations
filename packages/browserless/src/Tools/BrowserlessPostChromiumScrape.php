 ...
 * /chromium/scrape.
 *
 * Maps to the official Browserless endpoint POST /chromium/scrape.
 */
class BrowserlessPostChromiumScrape extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_chromium_scrape';
    protected const DESCRIPTION = '/chromium/scrape
...
Official Browserless endpoint: POST /chromium/scrape.';
    ...
    protected const PATH = '/chromium/scrape';
