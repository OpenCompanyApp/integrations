 ...
 * /edge/download.
 *
 * Maps to the official Browserless endpoint POST /edge/download.
 */
class BrowserlessPostEdgeDownload extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_edge_download';
    protected const DESCRIPTION = '/edge/download
...
Official Browserless endpoint: POST /edge/download.';
    ...
    protected const PATH = '/edge/download';
