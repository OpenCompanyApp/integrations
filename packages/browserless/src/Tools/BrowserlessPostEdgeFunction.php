 ...
 * /edge/function.
 *
 * Maps to the official Browserless endpoint POST /edge/function.
 */
class BrowserlessPostEdgeFunction extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_edge_function';
    protected const DESCRIPTION = '/edge/function
...
Official Browserless endpoint: POST /edge/function.';
    ...
    protected const PATH = '/edge/function';
