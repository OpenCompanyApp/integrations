 ...
 * /edge/pdf.
 *
 * Maps to the official Browserless endpoint POST /edge/pdf.
 */
class BrowserlessPostEdgePdf extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_edge_pdf';
    protected const DESCRIPTION = '/edge/pdf
