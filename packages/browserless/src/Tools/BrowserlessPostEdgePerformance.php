 ...
 * /edge/performance.
 *
 * Maps to the official Browserless endpoint POST /edge/performance.
 */
class BrowserlessPostEdgePerformance extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_edge_performance';
    protected const DESCRIPTION = '/edge/performance
...
Official Browserless endpoint: POST /edge/performance.';
    ...
    protected const PATH = '/edge/performance';
