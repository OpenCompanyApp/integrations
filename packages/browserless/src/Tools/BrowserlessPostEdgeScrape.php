 ...
 * /edge/scrape.
 *
 * Maps to the official Browserless endpoint POST /edge/scrape.
 */
class BrowserlessPostEdgeScrape extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_edge_scrape';
    protected const DESCRIPTION = '/edge/scrape
...
Official Browserless endpoint: POST /edge/scrape.';
    ...
    protected const PATH = '/edge/scrape';
