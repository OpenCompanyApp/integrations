 ...
 * /edge/screenshot.
 *
 * Maps to the official Browserless endpoint POST /edge/screenshot.
 */
class BrowserlessPostEdgeScreenshot extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_edge_screenshot';
    protected const DESCRIPTION = '/edge/screenshot
...
Official Browserless endpoint: POST /edge/screenshot.';
    ...
    protected const PATH = '/edge/screenshot';
