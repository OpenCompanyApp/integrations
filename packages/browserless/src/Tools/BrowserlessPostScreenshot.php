 ...
 * /screenshot.
 *
 * Maps to the official Browserless endpoint POST /screenshot.
 */
class BrowserlessPostScreenshot extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_screenshot';
...
Official Browserless endpoint: POST /screenshot.';
    ...
    protected const PATH = '/screenshot';
