 ...
 * /stealth/bql?(/*).
 *
 * Maps to the official Browserless endpoint POST /stealth/bql?(/*).
 */
class BrowserlessPostStealthBqloptionalPath extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_stealth_bqloptional_path';
    protected const DESCRIPTION = '/stealth/bql?(/*)
...
Official Browserless endpoint: POST /stealth/bql?(/*).';
    ...
    protected const PATH = '/stealth/bql/{path_suffix}';
