 ...
 * /unblock.
 *
 * Maps to the official Browserless endpoint POST /unblock.
 */
class BrowserlessPostUnblock extends AbstractBrowserlessTool
{
    protected const NAME = 'browserless_post_unblock';
    protected const DESCRIPTION = '/unblock
