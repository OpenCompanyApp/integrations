...
/**
 * Shared executor for BrowserStack tools.
 *
 ...
 */
abstract class AbstractBrowserStackTool implements Tool
{
    ...
    /**
     * @param  BrowserStackService  $service  BrowserStack API client.
     */
    public function __construct(protected BrowserStackService $service) {}
    ...
    /**
     * Execute the BrowserStack operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('BrowserStack integration is not configured.');
            }
