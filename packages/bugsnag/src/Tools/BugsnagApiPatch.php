 ...
 */
class BugsnagApiPatch extends AbstractBugsnagTool
{
  ...
  0 => 'payload',
    ...
    protected string $toolName = 'bugsnag_api_patch';

    protected string $toolDescription = 'Call any Bugsnag Data Access API PATCH endpoint with a JSON payload.';
}
