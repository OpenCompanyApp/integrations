...
```js
var event_types = app.integrations.cal.list_event_types({ limit: 20 })
var event_type = app.integrations.cal.get_event_type({ id: 123 })
var bookings = app.integrations.cal.list_bookings({ status: "upcoming" })
var booking = app.integrations.cal.get_booking({ id: "booking_uid_or_id" })
var me = app.integrations.cal.get_current_user({})
```
Booking writes:

```js
var created = app.integrations.cal.create_booking({
  event_type_id: 123,
...
var cancelled = app.integrations.cal.cancel_booking({
  booking_uid: "booking_uid",
  body: { cancellationReason: "No longer needed" },
})

var rescheduled = app.integrations.cal.reschedule_booking({
  booking_uid: "booking_uid",
...
```js
var slots = app.integrations.cal.api_get({
  path: "/slots",
  params: {
    eventTypeId: 123,
...
var result = app.integrations.cal.api_post({
  path: "/bookings",
  body: {
    eventTypeId: 123,
    start: "2026-05-07T10:00:00Z",
