...
/**
 * Shared implementation for Campaign Monitor endpoint tools.
 *
 * Dedicated tool classes declare endpoint metadata while this base class handles
 * argument mapping, configuration checks, and error conversion.
 */
abstract class AbstractCampaignMonitorEndpointTool implements Tool
{
    ...
    /**
     * @param  CampaignMonitorService  $service  Campaign Monitor API client.
     */
    public function __construct(
        protected CampaignMonitorService $service,
    ) {}
    ...
    /**
     * Execute the mapped API endpoint.
     *
    ...
    /**
     * Build query parameters from params and selected top-level keys.
     *
     * @param  array<string, mixed>  $args  Tool arguments.
    ...
    /**
     * Build a request body from payload or selected top-level keys.
     *
     * @param  array<string, mixed>  $args  Tool arguments.
     * @return array<string, mixed>
     */
