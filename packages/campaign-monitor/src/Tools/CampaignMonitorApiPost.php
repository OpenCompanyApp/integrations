 ...
 */
class CampaignMonitorApiPost extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_api_post';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Campaign Monitor API path with POST.';
