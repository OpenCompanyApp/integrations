 ...
 * Get client details.
 */
class CampaignMonitorGetClient extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_get_client';
    protected const TOOL_DESCRIPTION = 'Get client details.';
