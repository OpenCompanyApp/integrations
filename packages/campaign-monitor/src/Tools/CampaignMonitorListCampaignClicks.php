 ...
 */
class CampaignMonitorListCampaignClicks extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_campaign_clicks';
    protected const TOOL_DESCRIPTION = 'List campaign clicks.';
    protected const METHOD = 'GET';
    protected const PATH = '/campaigns/{campaign_id}/clicks.json';
