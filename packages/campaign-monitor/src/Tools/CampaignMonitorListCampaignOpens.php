 ...
 * List campaign opens.
 */
class CampaignMonitorListCampaignOpens extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_campaign_opens';
    protected const TOOL_DESCRIPTION = 'List campaign opens.';
    protected const METHOD = 'GET';
    protected const PATH = '/campaigns/{campaign_id}/opens.json';
