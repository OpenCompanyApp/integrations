 ...
 */
class CampaignMonitorListCampaignSpamComplaints extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_campaign_spam_complaints';
    protected const TOOL_DESCRIPTION = 'List campaign spam complaints.';
    protected const METHOD = 'GET';
    protected const PATH = '/campaigns/{campaign_id}/spam.json';
