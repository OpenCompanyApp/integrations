 ...
 */
class CampaignMonitorListCampaignUnsubscribes extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_campaign_unsubscribes';
    protected const TOOL_DESCRIPTION = 'List campaign unsubscribes.';
    protected const METHOD = 'GET';
    protected const PATH = '/campaigns/{campaign_id}/unsubscribes.json';
