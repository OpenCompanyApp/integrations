 ...
 */
class CampaignMonitorListDeletedSubscribers extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_deleted_subscribers';
    protected const TOOL_DESCRIPTION = 'List deleted subscribers on a list.';
    protected const METHOD = 'GET';
    protected const PATH = '/lists/{list_id}/deleted.json';
