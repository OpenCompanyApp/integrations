 ...
 */
class CampaignMonitorListUnconfirmedSubscribers extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_unconfirmed_subscribers';
    protected const TOOL_DESCRIPTION = 'List unconfirmed subscribers on a list.';
    protected const METHOD = 'GET';
    protected const PATH = '/lists/{list_id}/unconfirmed.json';
