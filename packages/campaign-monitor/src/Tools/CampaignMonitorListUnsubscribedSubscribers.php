 ...
 */
class CampaignMonitorListUnsubscribedSubscribers extends AbstractCampaignMonitorEndpointTool
{
    protected const TOOL_NAME = 'campaignmonitor_list_unsubscribed_subscribers';
    protected const TOOL_DESCRIPTION = 'List unsubscribed subscribers on a list.';
    protected const METHOD = 'GET';
    protected const PATH = '/lists/{list_id}/unsubscribed.json';
