# Moon phase report — Ruby API Reference
...
```ruby
result = app.integrations.celestial.lunar_eclipse(date: "")
```
## celestial_moon_info
...
```ruby
result = app.integrations.celestial.moon_info(latitude: 0, longitude: 0, date: "")
```
...
```ruby
result = app.integrations.celestial.moon_phase(date: "", timezone: "")
```
## celestial_night_sky
...
```ruby
result = app.integrations.celestial.night_sky(latitude: 0, longitude: 0, timezone: "")
```
...
```ruby
result = app.integrations.celestial.planet_position(latitude: 0, longitude: 0, planet: "")
```
...
```ruby
result = app.integrations.celestial.solar_eclipse(date: "", latitude: 0, longitude: 0)
```
## celestial_sun_info
...
```ruby
result = app.integrations.celestial.sun_info(latitude: 0, longitude: 0, date: "")
```
## celestial_time_info
...
```ruby
result = app.integrations.celestial.astronomical_time(date: "")
```
...
```ruby
result = app.integrations.celestial.zodiac_report(date: "")
```