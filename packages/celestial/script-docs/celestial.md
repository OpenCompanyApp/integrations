# Moon phase report — JavaScript API Reference
...
```js
var result = app.integrations.celestial.celestial_lunar_eclipse({
  date: "",
})
```
## celestial_moon_info
...
```js
var result = app.integrations.celestial.celestial_moon_info({
  latitude: 0,
  longitude: 0,
  date: "",
})
...
```js
var result = app.integrations.celestial.celestial_moon_phase({
  date: "",
  timezone: "",
})
```
...
```js
var result = app.integrations.celestial.celestial_night_sky({
  latitude: 0,
  longitude: 0,
  timezone: "",
})
...
```js
var result = app.integrations.celestial.celestial_planet_position({
  latitude: 0,
  longitude: 0,
  planet: "",
})
...
```js
var result = app.integrations.celestial.celestial_solar_eclipse({
  date: "",
  latitude: 0,
  longitude: 0,
})
...
```js
var result = app.integrations.celestial.celestial_sun_info({
  latitude: 0,
  longitude: 0,
  date: "",
})
...
```js
var result = app.integrations.celestial.celestial_time_info({
  date: "",
})
```
...
```js
var result = app.integrations.celestial.celestial_zodiac_report({
  date: "",
})
```