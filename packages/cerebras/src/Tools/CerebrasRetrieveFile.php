...
/**
 * Retrieve Cerebras file metadata.
 */
class CerebrasRetrieveFile extends AbstractCerebrasTool
{
    protected const NAME = 'cerebras_retrieve_file';
    protected const DESCRIPTION = 'Retrieve Cerebras file metadata.';
