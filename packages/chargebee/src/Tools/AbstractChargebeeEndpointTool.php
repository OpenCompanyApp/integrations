...
/**
 * Base class for focused Chargebee API v2 endpoint tools.
 *
 ...
 */
abstract class AbstractChargebeeEndpointTool implements Tool
{
    ...
    /**
     * @param  ChargebeeService  $service  The Chargebee API client.
     */
    public function __construct(
        protected ChargebeeService $service,
    ) {}
    ...
    /**
     * Execute one Chargebee API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported Chargebee tool method: {$this->method}"),
            };
