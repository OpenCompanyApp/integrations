 ...
 */
class ChargebeeCloseInvoice extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/invoices/{id}/close';

    protected string $toolName = 'chargebee_close_invoice';

    protected string $toolDescription = 'Close a pending Chargebee invoice.';
}
