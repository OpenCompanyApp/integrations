 ...
 */
class ChargebeeCollectNowHostedPage extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/hosted_pages/collect_now';

    protected string $toolName = 'chargebee_collect_now_hosted_page';

    protected string $toolDescription = 'Create a hosted page to collect unpaid invoices.';
}
