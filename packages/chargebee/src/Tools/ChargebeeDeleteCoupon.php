 ...
 */
class ChargebeeDeleteCoupon extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/coupons/{id}/delete';

    protected string $toolName = 'chargebee_delete_coupon';

    protected string $toolDescription = 'Delete or archive a Chargebee coupon by ID.';
}
