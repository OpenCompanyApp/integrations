 ...
 */
class ChargebeeListBusinessEntities extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/business_entities';

    protected string $toolName = 'chargebee_list_business_entities';

    protected string $toolDescription = 'List Chargebee business entitys with filters and pagination.';
}
