 ...
 */
class ChargebeeListCoupons extends AbstractChargebeeEndpointTool
{
    ...
    protected string $toolName = 'chargebee_list_coupons';

    protected string $toolDescription = 'List Chargebee coupons with filters and pagination.';
}
