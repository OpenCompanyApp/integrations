 ...
 */
class ChargebeeListCreditNotes extends AbstractChargebeeEndpointTool
{
    ...
    protected string $toolName = 'chargebee_list_credit_notes';

    protected string $toolDescription = 'List Chargebee credit notes with filters and pagination.';
}
