 ...
 */
class ChargebeeListHostedPages extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/hosted_pages';

    protected string $toolName = 'chargebee_list_hosted_pages';

    protected string $toolDescription = 'List Chargebee hosted pages with filters and pagination.';
}
