 ...
 */
class ChargebeeListItems extends AbstractChargebeeEndpointTool
{
    ...
    protected string $toolName = 'chargebee_list_items';

    protected string $toolDescription = 'List Chargebee items with filters and pagination.';
}
