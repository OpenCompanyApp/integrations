 ...
 */
class ChargebeeListOrders extends AbstractChargebeeEndpointTool
{
    ...
    protected string $toolName = 'chargebee_list_orders';

    protected string $toolDescription = 'List Chargebee orders with filters and pagination.';
}
