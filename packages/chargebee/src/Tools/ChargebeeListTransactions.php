 ...
 */
class ChargebeeListTransactions extends AbstractChargebeeEndpointTool
{
    ...
    protected string $toolName = 'chargebee_list_transactions';

    protected string $toolDescription = 'List Chargebee transactions with filters and pagination.';
}
