 ...
 */
class ChargebeeRecordRefundForTransaction extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/transactions/{id}/record_refund';

    protected string $toolName = 'chargebee_record_refund_for_transaction';

    protected string $toolDescription = 'Record an offline refund for a transaction.';
}
