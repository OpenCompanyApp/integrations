 ...
 */
class ChargebeeUpdateCustomer extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/customers/{id}';

    protected string $toolName = 'chargebee_update_customer';

    protected string $toolDescription = 'Update a Chargebee customer by ID.';
}
