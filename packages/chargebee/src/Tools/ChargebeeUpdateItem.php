 ...
 */
class ChargebeeUpdateItem extends AbstractChargebeeEndpointTool
{
    ...
    protected string $toolName = 'chargebee_update_item';

    protected string $toolDescription = 'Update a Chargebee item by ID.';
}
