 ...
 */
class ChargebeeVoidCreditNote extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/credit_notes/{id}/void';

    protected string $toolName = 'chargebee_void_credit_note';

    protected string $toolDescription = 'Void a Chargebee credit note.';
}
