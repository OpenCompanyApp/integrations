 ...
 */
class ChargebeeVoidInvoice extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/invoices/{id}/void';

    protected string $toolName = 'chargebee_void_invoice';

    protected string $toolDescription = 'Void a Chargebee invoice.';
}
