 ...
 */
class ChargebeeVoidTransaction extends AbstractChargebeeEndpointTool
{
    ...
    protected string $path = '/transactions/{id}/void';

    protected string $toolName = 'chargebee_void_transaction';

    protected string $toolDescription = 'Void a Chargebee transaction.';
}
