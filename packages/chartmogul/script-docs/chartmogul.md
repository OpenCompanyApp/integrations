...
```ruby
customers = app.integrations.chartmogul.list_customers(per_page: 50, status: "Active", system: "Stripe")
```
```ruby
subscriptions = app.integrations.chartmogul.list_customer_subscriptions(customer_uuid: "cus_de305d54-75b4-431b-adb2-eb6b9e546012", per_page: 100)
```
```ruby
invoices = app.integrations.chartmogul.list_invoices(customer_uuid: "cus_de305d54-75b4-431b-adb2-eb6b9e546012", external_id: "inv_0001")
```
```ruby
metrics = app.integrations.chartmogul.get_metrics(start_date: "2026-01-01", end_date: "2026-03-31", interval: "month", geo: "US,GB", plans: "Gold Monthly")
```
