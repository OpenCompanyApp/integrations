 ...
 *
 * Maps to the official Checkly endpoint GET /v1/analytics/multistep-checks/{id}.
 */
class ChecklyGetV1AnalyticsMultistepchecksId extends AbstractChecklyTool
{
    protected const NAME = 'checkly_get_v1_analytics_multistepchecks_id';
    protected const DESCRIPTION = 'Fetch detailed availability metrics and aggregated or non-aggregated Multistep Check metrics across custom time ranges. Rate-limiting is applied to this endpoint, you can send 30 requests / 60 seconds at most.

Official Checkly endpoint: GET /v1/analytics/multistep-checks/{id}.';
    ...
    protected const PATH = '/v1/analytics/multistep-checks/{id}';
