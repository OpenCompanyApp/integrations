 ...
 *
 * Maps to the official Checkly endpoint GET /v1/analytics/playwright-checks/{id}.
 */
class ChecklyGetV1AnalyticsPlaywrightchecksId extends AbstractChecklyTool
{
    protected const NAME = 'checkly_get_v1_analytics_playwrightchecks_id';
    protected const DESCRIPTION = 'Fetch detailed availability metrics and aggregated or non-aggregated Playwright Check metrics across custom time ranges. Rate-limiting is applied to this endpoint, you can send 30 requests / 60 seconds at most.

Official Checkly endpoint: GET /v1/analytics/playwright-checks/{id}.';
    ...
    protected const PATH = '/v1/analytics/playwright-checks/{id}';
