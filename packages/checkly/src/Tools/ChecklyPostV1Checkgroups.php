 ...
 *
 * Maps to the official Checkly endpoint POST /v1/check-groups.
 */
class ChecklyPostV1Checkgroups extends AbstractChecklyTool
{
    protected const NAME = 'checkly_post_v1_checkgroups';
...
Official Checkly endpoint: POST /v1/check-groups.';
