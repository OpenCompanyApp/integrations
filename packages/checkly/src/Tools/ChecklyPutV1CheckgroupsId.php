 ...
 *
 * Maps to the official Checkly endpoint PUT /v1/check-groups/{id}.
 */
class ChecklyPutV1CheckgroupsId extends AbstractChecklyTool
{
    protected const NAME = 'checkly_put_v1_checkgroups_id';
    protected const DESCRIPTION = 'Updates a check group.

Official Checkly endpoint: PUT /v1/check-groups/{id}.';
