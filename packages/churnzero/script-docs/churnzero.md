# ChurnZero JavaScript API Reference
...
```js
app.integrations.churnzero.set_attributes({ /* parameters */ })
app.integrations.churnzero.default.set_attributes({ /* parameters */ })
app.integrations.churnzero.eu_team.track_event({ /* parameters */ })
```