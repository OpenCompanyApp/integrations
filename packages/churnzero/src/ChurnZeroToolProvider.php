...
/**
 * Tool provider for ChurnZero customer success integration.
 *
 * Implements ConfigurableIntegration for multi-account support, config schema,
 * connection testing, and credential field definitions. Registers all ChurnZero
 * tools (accounts, contacts, alerts, usage, user).
 */
class ChurnZeroToolProvider implements ToolProvider, ConfigurableIntegration
{
    /**
