...
```js
var pipeline = app.integrations.circleci.trigger_pipeline({
...
```js
var workflows = app.integrations.circleci.list_pipeline_workflows({
  pipeline_id: pipeline.id,
})

var jobs = app.integrations.circleci.list_workflow_jobs({
