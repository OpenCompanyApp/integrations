 ...
 */
class CircleCIGetProjectEnvVar extends AbstractCircleCITool
{
    protected string $toolName = 'circleci_get_project_env_var';

    protected string $toolDescription = 'Get a masked project environment variable.';
