...
```ruby
recent = app.call("integrations.cisa-kev.recent", since: "2026-05-01", limit: 10)
microsoft = app.call("integrations.cisa-kev.search", vendor: "Microsoft", known_ransomware_campaign_use: "Known", limit: 25)
entry = app.call("integrations.cisa-kev.get_vulnerability", cve_id: "CVE-2026-0300")
```
