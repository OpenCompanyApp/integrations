...
```ruby
organizations = app.call("integrations.clickhouse-cloud.get_list_available_organizations")
service = app.call("integrations.clickhouse-cloud.get_service_details", organization_id: "00000000-0000-0000-0000-000000000000", service_id: "11111111-1111-1111-1111-111111111111")
```
## Request Bodies
