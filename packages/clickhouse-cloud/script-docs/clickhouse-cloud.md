# ClickHouse Cloud JavaScript API
...
```js
var organizations = app.integrations["clickhouse-cloud"].organization_get_list({})

var service = app.integrations["clickhouse-cloud"].instance_get({
