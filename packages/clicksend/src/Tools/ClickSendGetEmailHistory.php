...
/**
 * Retrieve email message history from ClickSend.
 *
 * Supports page-based pagination to browse previously sent emails.
 */
class ClickSendGetEmailHistory implements Tool
{
    /**
    ...
    {
        return 'clicksend_get_email_history';
    }

    public function description(): string
    {
        return 'Get email message history from ClickSend with pagination.';
    }
    ...
    /**
     * Get email history from ClickSend.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->getEmailHistory($params);
