...
/**
 * Triggered when a task is updated in ClickUp.
 *
 * Enriches the event payload with full task data.
 */
class ClickUpTaskUpdatedTrigger extends ClickUpWebhookTrigger
{
    ...
    {
        return 'Triggered when a task is updated in ClickUp. Returns the full task data and change history.';
    }
