...
/**
 * Base class for Close REST endpoint tools.
 *
 * Handles common credential checks, required parameter validation, endpoint
 * path interpolation, and query/body shaping for one Close API operation.
 */
abstract class AbstractCloseEndpointTool implements Tool
{
    ...
    /**
     * @param  CloseService  $service  The Close API client.
     */
    public function __construct(
        protected CloseService $service,
    ) {}
    ...
    /**
     * Execute one Close REST API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported Close tool method: {$this->method}"),
            };
