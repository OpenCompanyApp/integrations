...
/**
 * Shared executor for Cloudflare endpoint-mapped tools.
 *
 ...
 */
abstract class AbstractCloudflareTool implements Tool
{
    ...
    /**
     * Execute the mapped Cloudflare API endpoint.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match (static::METHOD) {
                ...
                default => throw new \RuntimeException('Unsupported Cloudflare tool method: '.static::METHOD),
            };
