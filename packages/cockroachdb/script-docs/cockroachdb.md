# CockroachDB Cloud Ruby API Reference
...
```ruby
clusters = app.integrations.cockroachdb.list_clusters_organization(pagination_limit: 25)
```
```ruby
cluster = app.integrations.cockroachdb.get_extended_information_about_cluster(cluster_id: "00000000-0000-0000-0000-000000000000")
```
```ruby
databases = app.integrations.cockroachdb.list_databases_cluster(cluster_id: "00000000-0000-0000-0000-000000000000", pagination_limit: 50)
```
```ruby
created = app.integrations.cockroachdb.create_and_initialize_new_cluster(body: {name: "agent-demo", provider: "AWS", spec: {}})
```
## Return Shapes
