...
/**
 * Shared executor for Codemagic tools.
 *
 ...
 */
abstract class AbstractCodemagicTool implements Tool
{
    ...
    /**
     * @param  CodemagicService  $service  Codemagic API client.
     */
    public function __construct(protected CodemagicService $service) {}
    ...
    public function parameters(): array
    {
        ...
        foreach (static::ARGUMENTS as $argument) {
            $parameters[$argument] = ['type' => 'string', 'required' => true, 'description' => str_replace('_', ' ', ucfirst((string) $argument)).'.'];
        }
    ...
    /**
     * Execute the Codemagic operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('Codemagic integration is not configured.');
            }

            $required = static::REQUIRED === [] ? static::ARGUMENTS : static::REQUIRED;
