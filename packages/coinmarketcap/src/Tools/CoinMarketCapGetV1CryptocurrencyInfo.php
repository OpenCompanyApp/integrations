 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v1/cryptocurrency/info.
 */
class CoinMarketCapGetV1CryptocurrencyInfo extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v1_cryptocurrency_info';
...
Official CoinMarketCap endpoint: GET /v1/cryptocurrency/info.';
    ...
    protected const PATH = '/v1/cryptocurrency/info';
