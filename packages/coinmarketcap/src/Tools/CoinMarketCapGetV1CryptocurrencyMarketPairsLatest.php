 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v1/cryptocurrency/market-pairs/latest.
 */
class CoinMarketCapGetV1CryptocurrencyMarketPairsLatest extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v1_cryptocurrency_market_pairs_latest';
...
Official CoinMarketCap endpoint: GET /v1/cryptocurrency/market-pairs/latest.';
    ...
    protected const PATH = '/v1/cryptocurrency/market-pairs/latest';
