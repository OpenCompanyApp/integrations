 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v1/cryptocurrency/ohlcv/latest.
 */
class CoinMarketCapGetV1CryptocurrencyOhlcvLatest extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v1_cryptocurrency_ohlcv_latest';
...
Official CoinMarketCap endpoint: GET /v1/cryptocurrency/ohlcv/latest.';
    ...
    protected const PATH = '/v1/cryptocurrency/ohlcv/latest';
