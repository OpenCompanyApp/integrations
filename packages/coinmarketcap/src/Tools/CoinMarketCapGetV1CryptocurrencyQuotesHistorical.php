 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v1/cryptocurrency/quotes/historical.
 */
class CoinMarketCapGetV1CryptocurrencyQuotesHistorical extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v1_cryptocurrency_quotes_historical';
...
Official CoinMarketCap endpoint: GET /v1/cryptocurrency/quotes/historical.';
    ...
    protected const PATH = '/v1/cryptocurrency/quotes/historical';
