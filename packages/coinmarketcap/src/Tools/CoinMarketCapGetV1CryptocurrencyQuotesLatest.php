 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v1/cryptocurrency/quotes/latest.
 */
class CoinMarketCapGetV1CryptocurrencyQuotesLatest extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v1_cryptocurrency_quotes_latest';
...
Official CoinMarketCap endpoint: GET /v1/cryptocurrency/quotes/latest.';
    ...
    protected const PATH = '/v1/cryptocurrency/quotes/latest';
