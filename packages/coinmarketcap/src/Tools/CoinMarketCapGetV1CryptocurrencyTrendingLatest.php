 ...
 * Trending Latest.
 *
 * Maps to the official CoinMarketCap endpoint GET /v1/cryptocurrency/trending/latest.
 */
class CoinMarketCapGetV1CryptocurrencyTrendingLatest extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v1_cryptocurrency_trending_latest';
...
Official CoinMarketCap endpoint: GET /v1/cryptocurrency/trending/latest.';
    ...
    protected const PATH = '/v1/cryptocurrency/trending/latest';
