 ...
 * OHLCV Historical.
 *
 * Maps to the official CoinMarketCap endpoint GET /v2/cryptocurrency/ohlcv/historical.
 */
class CoinMarketCapGetV2CryptocurrencyOhlcvHistorical extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v2_cryptocurrency_ohlcv_historical';
...
Official CoinMarketCap endpoint: GET /v2/cryptocurrency/ohlcv/historical.';
    ...
    protected const PATH = '/v2/cryptocurrency/ohlcv/historical';
