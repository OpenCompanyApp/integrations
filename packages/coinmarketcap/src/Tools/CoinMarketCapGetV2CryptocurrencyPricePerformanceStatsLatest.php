 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v2/cryptocurrency/price-performance-stats/latest.
 */
class CoinMarketCapGetV2CryptocurrencyPricePerformanceStatsLatest extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v2_cryptocurrency_price_performance_stats_latest';
...
Official CoinMarketCap endpoint: GET /v2/cryptocurrency/price-performance-stats/latest.';
    ...
    protected const PATH = '/v2/cryptocurrency/price-performance-stats/latest';
