 ...
 * Price Conversion v2.
 *
 * Maps to the official CoinMarketCap endpoint GET /v2/tools/price-conversion.
 */
class CoinMarketCapGetV2ToolsPriceConversion extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v2_tools_price_conversion';
...
Official CoinMarketCap endpoint: GET /v2/tools/price-conversion.';
    ...
    protected const PATH = '/v2/tools/price-conversion';
