 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v3/cryptocurrency/quotes/historical.
 */
class CoinMarketCapGetV3CryptocurrencyQuotesHistorical extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v3_cryptocurrency_quotes_historical';
...
Official CoinMarketCap endpoint: GET /v3/cryptocurrency/quotes/historical.';
    ...
    protected const PATH = '/v3/cryptocurrency/quotes/historical';
