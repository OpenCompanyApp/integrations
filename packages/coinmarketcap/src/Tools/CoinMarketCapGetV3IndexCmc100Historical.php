 ...
 *
 * Maps to the official CoinMarketCap endpoint GET /v3/index/cmc100-historical.
 */
class CoinMarketCapGetV3IndexCmc100Historical extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v3_index_cmc100_historical';
...
Official CoinMarketCap endpoint: GET /v3/index/cmc100-historical.';
    ...
    protected const PATH = '/v3/index/cmc100-historical';
