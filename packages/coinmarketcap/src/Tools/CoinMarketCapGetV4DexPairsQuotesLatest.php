 ...
 * Quotes Latest.
 *
 * Maps to the official CoinMarketCap endpoint GET /v4/dex/pairs/quotes/latest.
 */
class CoinMarketCapGetV4DexPairsQuotesLatest extends AbstractCoinMarketCapTool
{
    protected const NAME = 'coinmarketcap_get_v4_dex_pairs_quotes_latest';
...
Optionally specify a comma-separated list of supplemental data fields to return.',
    ...
    protected const PATH = '/v4/dex/pairs/quotes/latest';
