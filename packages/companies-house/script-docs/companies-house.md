...
```ruby
matches = app.call("integrations.companies-house.search", q: "example holdings", items_per_page: 5)
profile = app.call("integrations.companies-house.company_profile", company_number: "00000006")
filings = app.call("integrations.companies-house.filing_history", company_number: "00000006", category: "accounts", items_per_page: 10)
pscs = app.call("integrations.companies-house.psc_list", company_number: "00000006", items_per_page: 10)
```
