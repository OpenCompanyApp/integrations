...
```js
var matches = companies_house.search_companies({
  q: "example holdings",
  items_per_page: 5,
})

var profile = companies_house.company_profile({
  company_number: "00000006",
})

var filings = companies_house.filing_history({
  company_number: "00000006",
  category: "accounts",
  items_per_page: 10,
})

var pscs = companies_house.psc_list({
  company_number: "00000006",
  items_per_page: 10,
})
```
