# HTTP client for the Confluence Cloud REST API — JavaScript API Reference
...
```js
var result = app.integrations.confluence.confluence_add_comment({
  page_id: "",
  body: "",
})
```
...
```js
var result = app.integrations.confluence.confluence_add_labels({
  page_id: "",
  labels: {},
})
```
...
```js
var result = app.integrations.confluence.confluence_create_page({
  space_key: "",
  title: "",
  body: "",
})
...
```js
var result = app.integrations.confluence.confluence_delete_page({
  page_id: "",
})
```
...
```js
var result = app.integrations.confluence.confluence_get_labels({
  page_id: "",
})
```
## confluence_get_page
...
```js
var result = app.integrations.confluence.confluence_get_page({
  page_id: "",
  expand: "",
})
```
...
```js
var result = app.integrations.confluence.confluence_get_page_ancestors({
  page_id: "",
})
```
...
```js
var result = app.integrations.confluence.confluence_get_page_children({
  page_id: "",
  limit: 0,
  start: 0,
})
...
```js
var result = app.integrations.confluence.confluence_get_space({
  space_key: "",
})
```
...
```js
var result = app.integrations.confluence.confluence_get_spaces({
  limit: 0,
  start: 0,
  type: "",
})
...
```js
var result = app.integrations.confluence.confluence_search_pages({
  cql: "",
  limit: 0,
  start: 0,
})
...
```js
var result = app.integrations.confluence.confluence_update_page({
  page_id: "",
  title: "",
  body: "",
})
...
app.integrations.confluence.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.confluence.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.confluence.work.function_name({ /* parameters */ })
app.integrations.confluence.personal.function_name({ /* parameters */ })
```
