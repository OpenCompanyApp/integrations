...
/**
 * Base class for generated Confluent Cloud OpenAPI operation tools.
 *
 * Handles parameter declarations, configured-state checks, and execution
 * through the shared Confluent Cloud API client.
 */
abstract class AbstractConfluentOperationTool implements Tool
{
    protected const TOOL_NAME = '';

    /**
     * @param  ConfluentService  $service  Confluent Cloud HTTP API client.
     */
    public function __construct(protected ConfluentService $service) {}
    ...
    public function parameters(): array
    {
        ...
        if (($this->operation()['request_body'] ?? null) !== null) {
            $parameters['body'] = [
                ...
                'description' => $this->operation()['request_body']['description'] ?: 'Request body for the Confluent Cloud API operation.',
            ];
        }
    ...
    /**
     * Execute the Confluent Cloud API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            if (!$this->service->isConfigured()) {
                return ToolResult::error('Confluent Cloud integration is not configured.');
            }
    ...
    {
        $operations = ConfluentOperations::all();
