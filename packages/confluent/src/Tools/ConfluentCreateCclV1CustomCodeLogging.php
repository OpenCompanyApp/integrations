 ...
 */
class ConfluentCreateCclV1CustomCodeLogging extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_ccl_v1_custom_code_logging';
}
