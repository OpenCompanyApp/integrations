 ...
 */
class ConfluentCreateCcpmV1CustomConnectPluginVersion extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_ccpm_v1_custom_connect_plugin_version';
}
