 ...
 */
class ConfluentCreateConnectV1CustomConnectorPlugin extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_connect_v1_custom_connector_plugin';
}
