 ...
 */
class ConfluentCreateIAMV2CertificateAuthority extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_iam_v2_certificate_authority';
}
