 ...
 */
class ConfluentCreateNetworkingV1NetworkLinkEndpoint extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_networking_v1_network_link_endpoint';
}
