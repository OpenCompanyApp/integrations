 ...
 */
class ConfluentCreateNetworkingV1NetworkLinkService extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_networking_v1_network_link_service';
}
