 ...
 */
class ConfluentCreateNetworkingV1PrivateLinkAccess extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_networking_v1_private_link_access';
}
