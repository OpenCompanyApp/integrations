 ...
 */
class ConfluentCreateNetworkingV1TransitGatewayAttachment extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_networking_v1_transit_gateway_attachment';
}
