 ...
 */
class ConfluentCreateNotificationsV1Integration extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_notifications_v1_integration';
}
