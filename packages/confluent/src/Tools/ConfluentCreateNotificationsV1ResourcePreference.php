 ...
 */
class ConfluentCreateNotificationsV1ResourcePreference extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_create_notifications_v1_resource_preference';
}
