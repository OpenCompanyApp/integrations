 ...
 */
class ConfluentDeleteCclV1CustomCodeLogging extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_ccl_v1_custom_code_logging';
}
