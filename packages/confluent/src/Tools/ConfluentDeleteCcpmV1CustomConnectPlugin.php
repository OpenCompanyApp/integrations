 ...
 */
class ConfluentDeleteCcpmV1CustomConnectPlugin extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_ccpm_v1_custom_connect_plugin';
}
