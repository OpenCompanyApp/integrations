 ...
 */
class ConfluentDeleteIAMV2CertificateAuthority extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_iam_v2_certificate_authority';
}
