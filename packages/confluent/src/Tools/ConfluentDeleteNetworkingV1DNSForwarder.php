 ...
 */
class ConfluentDeleteNetworkingV1DNSForwarder extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_networking_v1_dns_forwarder';
}
