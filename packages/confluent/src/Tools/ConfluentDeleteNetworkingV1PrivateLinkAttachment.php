 ...
 */
class ConfluentDeleteNetworkingV1PrivateLinkAttachment extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_networking_v1_private_link_attachment';
}
