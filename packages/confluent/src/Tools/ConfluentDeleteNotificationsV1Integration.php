 ...
 */
class ConfluentDeleteNotificationsV1Integration extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_notifications_v1_integration';
}
