 ...
 */
class ConfluentDeleteNotificationsV1ResourceSubscription extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_delete_notifications_v1_resource_subscription';
}
