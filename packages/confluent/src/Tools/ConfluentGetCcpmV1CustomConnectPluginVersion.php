 ...
 */
class ConfluentGetCcpmV1CustomConnectPluginVersion extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_ccpm_v1_custom_connect_plugin_version';
}
