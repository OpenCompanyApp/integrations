 ...
 */
class ConfluentGetCdxV1ProviderSharedResource extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_cdx_v1_provider_shared_resource';
}
