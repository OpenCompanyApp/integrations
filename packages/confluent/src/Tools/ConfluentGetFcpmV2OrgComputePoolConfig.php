 ...
 */
class ConfluentGetFcpmV2OrgComputePoolConfig extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_fcpm_v2_org_compute_pool_config';
}
