 ...
 */
class ConfluentGetKafkaStreamsGroupMemberAssignmentTaskPartitions extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_kafka_streams_group_member_assignment_task_partitions';
}
