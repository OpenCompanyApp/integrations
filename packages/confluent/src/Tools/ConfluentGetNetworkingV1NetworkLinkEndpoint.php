 ...
 */
class ConfluentGetNetworkingV1NetworkLinkEndpoint extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_networking_v1_network_link_endpoint';
}
