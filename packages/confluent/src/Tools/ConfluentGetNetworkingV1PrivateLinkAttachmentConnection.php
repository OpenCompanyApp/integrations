 ...
 */
class ConfluentGetNetworkingV1PrivateLinkAttachmentConnection extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_networking_v1_private_link_attachment_connection';
}
