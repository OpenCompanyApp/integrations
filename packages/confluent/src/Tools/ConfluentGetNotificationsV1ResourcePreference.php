 ...
 */
class ConfluentGetNotificationsV1ResourcePreference extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_notifications_v1_resource_preference';
}
