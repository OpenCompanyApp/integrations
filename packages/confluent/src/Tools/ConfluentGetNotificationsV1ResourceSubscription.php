 ...
 */
class ConfluentGetNotificationsV1ResourceSubscription extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_notifications_v1_resource_subscription';
}
