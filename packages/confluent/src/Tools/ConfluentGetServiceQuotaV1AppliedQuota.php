 ...
 */
class ConfluentGetServiceQuotaV1AppliedQuota extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_get_service_quota_v1_applied_quota';
}
