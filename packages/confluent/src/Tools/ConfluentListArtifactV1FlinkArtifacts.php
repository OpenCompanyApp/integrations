 ...
 */
class ConfluentListArtifactV1FlinkArtifacts extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_artifact_v1_flink_artifacts';
}
