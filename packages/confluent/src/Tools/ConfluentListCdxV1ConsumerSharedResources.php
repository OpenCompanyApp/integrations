 ...
 */
class ConfluentListCdxV1ConsumerSharedResources extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_cdx_v1_consumer_shared_resources';
}
