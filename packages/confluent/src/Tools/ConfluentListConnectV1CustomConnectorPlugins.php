 ...
 */
class ConfluentListConnectV1CustomConnectorPlugins extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_connect_v1_custom_connector_plugins';
}
