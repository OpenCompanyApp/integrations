 ...
 */
class ConfluentListIAMV2CertificateIdentityPools extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_iam_v2_certificate_identity_pools';
}
