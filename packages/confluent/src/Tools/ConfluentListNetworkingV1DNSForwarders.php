 ...
 */
class ConfluentListNetworkingV1DNSForwarders extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_networking_v1_dns_forwarders';
}
