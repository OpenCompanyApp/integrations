 ...
 */
class ConfluentListNetworkingV1NetworkLinkServices extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_networking_v1_network_link_services';
}
