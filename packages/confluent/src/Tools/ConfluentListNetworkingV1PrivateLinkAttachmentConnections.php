 ...
 */
class ConfluentListNetworkingV1PrivateLinkAttachmentConnections extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_networking_v1_private_link_attachment_connections';
}
