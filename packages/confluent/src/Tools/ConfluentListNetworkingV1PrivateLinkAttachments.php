 ...
 */
class ConfluentListNetworkingV1PrivateLinkAttachments extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_networking_v1_private_link_attachments';
}
