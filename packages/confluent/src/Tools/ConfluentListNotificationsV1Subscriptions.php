 ...
 */
class ConfluentListNotificationsV1Subscriptions extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_notifications_v1_subscriptions';
}
