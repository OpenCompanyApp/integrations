 ...
 */
class ConfluentListTableflowV1TableflowTopics extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_list_tableflow_v1_tableflow_topics';
}
