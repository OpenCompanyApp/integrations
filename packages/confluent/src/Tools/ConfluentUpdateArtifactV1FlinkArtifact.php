 ...
 */
class ConfluentUpdateArtifactV1FlinkArtifact extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_artifact_v1_flink_artifact';
}
