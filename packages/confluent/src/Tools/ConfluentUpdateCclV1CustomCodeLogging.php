 ...
 */
class ConfluentUpdateCclV1CustomCodeLogging extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_ccl_v1_custom_code_logging';
}
