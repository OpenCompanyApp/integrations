 ...
 */
class ConfluentUpdateConnectV1CustomConnectorPlugin extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_connect_v1_custom_connector_plugin';
}
