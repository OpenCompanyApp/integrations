 ...
 */
class ConfluentUpdateIAMV2CertificateIdentityPool extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_iam_v2_certificate_identity_pool';
}
