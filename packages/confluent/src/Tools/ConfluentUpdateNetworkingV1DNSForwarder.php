 ...
 */
class ConfluentUpdateNetworkingV1DNSForwarder extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_networking_v1_dns_forwarder';
}
