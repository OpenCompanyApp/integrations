 ...
 */
class ConfluentUpdateNetworkingV1NetworkLinkService extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_networking_v1_network_link_service';
}
