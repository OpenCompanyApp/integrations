 ...
 */
class ConfluentUpdateNotificationsV1Integration extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_notifications_v1_integration';
}
