 ...
 */
class ConfluentUpdateNotificationsV1ResourcePreference extends AbstractConfluentOperationTool
{
    protected const TOOL_NAME = 'confluent_update_notifications_v1_resource_preference';
}
