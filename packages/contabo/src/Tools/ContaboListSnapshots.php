...
class ContaboListSnapshots implements Tool
{
    ...
    {
        return 'contabo_list_snapshots';
    }

    public function description(): string
    {
        return 'List all snapshots in the Contabo account. Returns snapshot IDs, names, instance IDs, and creation dates.';
    }
