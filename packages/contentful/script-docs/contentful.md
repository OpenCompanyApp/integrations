# Client for the Contentful Content Management API covering content types, entries, assets, and space info — JavaScript API Reference
...
```js
var result = app.integrations.contentful.contentful_create_content_type({
  name: "",
  display_name: "",
  description: "",
})
...
```js
var result = app.integrations.contentful.contentful_create_entry({
  content_type_id: "",
  fields: "",
})
```
...
```js
var result = app.integrations.contentful.contentful_delete_entry({
  entry_id: "",
})
```
...
```js
var result = app.integrations.contentful.contentful_get_content_type({
  content_type_id: "",
})
```
...
```js
var result = app.integrations.contentful.contentful_get_entry({
  entry_id: "",
})
```
...
```js
var result = app.integrations.contentful.contentful_get_space({
})
```
...
```js
var result = app.integrations.contentful.contentful_list_assets({
  limit: 0,
  skip: 0,
})
```
...
```js
var result = app.integrations.contentful.contentful_list_content_types({
  limit: 0,
})
```
...
```js
var result = app.integrations.contentful.contentful_list_entries({
  content_type: "",
  limit: 0,
  skip: 0,
})
...
```js
var result = app.integrations.contentful.contentful_publish_entry({
  entry_id: "",
  version: 0,
})
```
...
```js
var result = app.integrations.contentful.contentful_unpublish_entry({
  entry_id: "",
  version: 0,
})
```
...
```js
var result = app.integrations.contentful.contentful_update_entry({
  entry_id: "",
  fields: "",
  version: 0,
})
...
app.integrations.contentful.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.contentful.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.contentful.work.function_name({ /* parameters */ })
app.integrations.contentful.personal.function_name({ /* parameters */ })
```
