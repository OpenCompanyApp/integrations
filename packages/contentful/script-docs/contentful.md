# Client for the Contentful Content Management API covering content types, entries, assets, and space info — Ruby API Reference
...
```ruby
result = app.integrations.contentful.create_type(name: "", display_name: "", description: "")
```
...
```ruby
result = app.integrations.contentful.create_entry(content_type_id: "", fields: "")
```
...
```ruby
result = app.integrations.contentful.delete_entry(entry_id: "")
```
...
```ruby
result = app.integrations.contentful.get_type(content_type_id: "")
```
...
```ruby
result = app.integrations.contentful.get_entry(entry_id: "")
```
...
```ruby
result = app.integrations.contentful.get_space()
```
...
```ruby
result = app.integrations.contentful.list_assets(limit: 0, skip: 0)
```
...
```ruby
result = app.integrations.contentful.list_types(limit: 0)
```
...
```ruby
result = app.integrations.contentful.list_entries(content_type: "", limit: 0, skip: 0)
```
...
```ruby
result = app.integrations.contentful.publish_entry(entry_id: "", version: 0)
```
...
```ruby
result = app.integrations.contentful.unpublish_entry(entry_id: "", version: 0)
```
...
```ruby
result = app.integrations.contentful.update_entry(entry_id: "", fields: "", version: 0)
```
---
