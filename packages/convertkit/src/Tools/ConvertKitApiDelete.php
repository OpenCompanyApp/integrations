...
/**
 * Call a safe relative Kit API path with DELETE.
 */
class ConvertKitApiDelete extends AbstractConvertKitEndpointTool
{
    protected const TOOL_NAME = 'convertkit_api_delete';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Kit API path with DELETE.';
