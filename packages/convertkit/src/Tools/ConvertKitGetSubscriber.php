 ...
 */
class ConvertKitGetSubscriber extends AbstractConvertKitEndpointTool
{
    protected const TOOL_NAME = 'convertkit_get_subscriber';
    protected const TOOL_DESCRIPTION = 'Get a subscriber by ID.';
