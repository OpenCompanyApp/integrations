...
/**
 * Base class for Copper REST endpoint tools.
 *
 * Handles credential checks, required parameter validation, endpoint path
 * interpolation, and request body/query shaping for one Copper API operation.
 */
abstract class AbstractCopperEndpointTool implements Tool
{
    ...
    public function __construct(
        protected CopperService $service,
    ) {}
    ...
    /**
     * Execute one Copper REST API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported Copper tool method: {$this->method}"),
            };
