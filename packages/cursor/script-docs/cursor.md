# Cursor - JavaScript API Reference
...
```js
var result = app.integrations.cursor.list_team_members({})
...
```js
var usage = app.integrations.cursor.get_daily_usage_data({
...
```js
var spend = app.integrations.cursor.get_spend({
...
```js
var blocklists = app.integrations.cursor.list_repo_blocklists({})
```
...
```js
var result = app.integrations.cursor.upsert_repo_blocklists({
  repos: [
    {
