...
```ruby
person = app.integrations.customerio.add_or_update(identifier: "user_123", payload: {email: "ada@example.test", plan: "pro"})
campaigns = app.integrations.customerio.list_campaigns(limit: 20)
```