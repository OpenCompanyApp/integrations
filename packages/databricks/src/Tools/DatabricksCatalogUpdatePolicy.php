 ...
 *
 * Maps to the official Databricks SDK endpoint patch /api/2.1/unity-catalog/policies/{on_securable_type}/{on_securable_fullname}/{name}.
 */
class DatabricksCatalogUpdatePolicy extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_catalog_update_policy';
    protected const DESCRIPTION = 'Catalog Update Policy

Official Databricks SDK endpoint: PATCH /api/2.1/unity-catalog/policies/{on_securable_type}/{on_securable_fullname}/{name}
