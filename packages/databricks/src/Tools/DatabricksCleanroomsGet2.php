 ...
 * Cleanrooms Get.
 *
 * Maps to the official Databricks SDK endpoint get /api/2.0/clean-rooms/{clean_room_name}/assets/{asset_type}/{name}.
 */
class DatabricksCleanroomsGet2 extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_cleanrooms_get_2';
    protected const DESCRIPTION = 'Cleanrooms Get

Official Databricks SDK endpoint: GET /api/2.0/clean-rooms/{clean_room_name}/assets/{asset_type}/{name}
