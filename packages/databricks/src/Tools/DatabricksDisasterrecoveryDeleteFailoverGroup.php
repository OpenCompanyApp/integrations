...
/**
 * Disasterrecovery Delete Failover Group.
 *
 * Maps to the official Databricks SDK endpoint delete /api/disaster-recovery/v1/{name}.
 */
class DatabricksDisasterrecoveryDeleteFailoverGroup extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_disasterrecovery_delete_failover_group';
    protected const DESCRIPTION = 'Disasterrecovery Delete Failover Group
