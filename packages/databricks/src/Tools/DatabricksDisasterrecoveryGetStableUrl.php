...
/**
 * Disasterrecovery Get Stable Url.
 *
 * Maps to the official Databricks SDK endpoint get /api/disaster-recovery/v1/{name}.
 */
class DatabricksDisasterrecoveryGetStableUrl extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_disasterrecovery_get_stable_url';
    protected const DESCRIPTION = 'Disasterrecovery Get Stable Url
