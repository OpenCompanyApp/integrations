 ...
 * Iam Get.
 *
 * Maps to the official Databricks SDK endpoint get /api/2.0/permissions/{request_object_type}/{request_object_id}.
 */
class DatabricksIamGet5 extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_iam_get_5';
    protected const DESCRIPTION = 'Iam Get

Official Databricks SDK endpoint: GET /api/2.0/permissions/{request_object_type}/{request_object_id}
