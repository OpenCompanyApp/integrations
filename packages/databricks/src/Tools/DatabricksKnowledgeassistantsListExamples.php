...
/**
 * Knowledgeassistants List Examples.
 *
 * Maps to the official Databricks SDK endpoint get /api/2.1/{parent}/examples.
 */
class DatabricksKnowledgeassistantsListExamples extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_knowledgeassistants_list_examples';
    protected const DESCRIPTION = 'Knowledgeassistants List Examples
