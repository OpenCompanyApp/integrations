...
/**
 * Postgres Delete Branch.
 *
 * Maps to the official Databricks SDK endpoint delete /api/2.0/postgres/{name}.
 */
class DatabricksPostgresDeleteBranch extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_delete_branch';
    protected const DESCRIPTION = 'Postgres Delete Branch
