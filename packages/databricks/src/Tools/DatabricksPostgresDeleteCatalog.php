...
/**
 * Postgres Delete Catalog.
 *
 * Maps to the official Databricks SDK endpoint delete /api/2.0/postgres/{name}.
 */
class DatabricksPostgresDeleteCatalog extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_delete_catalog';
    protected const DESCRIPTION = 'Postgres Delete Catalog
