 ...
 */
class DatabricksPostgresDeleteDatabase extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_delete_database';
    protected const DESCRIPTION = 'Postgres Delete Database
