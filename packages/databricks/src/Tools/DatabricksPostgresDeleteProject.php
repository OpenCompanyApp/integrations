...
/**
 * Postgres Delete Project.
 *
 * Maps to the official Databricks SDK endpoint delete /api/2.0/postgres/{name}.
 */
class DatabricksPostgresDeleteProject extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_delete_project';
    protected const DESCRIPTION = 'Postgres Delete Project
