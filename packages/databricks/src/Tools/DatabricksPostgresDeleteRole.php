 ...
 */
class DatabricksPostgresDeleteRole extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_delete_role';
    protected const DESCRIPTION = 'Postgres Delete Role
