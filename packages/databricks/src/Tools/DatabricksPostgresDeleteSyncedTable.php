 ...
 */
class DatabricksPostgresDeleteSyncedTable extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_delete_synced_table';
    protected const DESCRIPTION = 'Postgres Delete Synced Table
