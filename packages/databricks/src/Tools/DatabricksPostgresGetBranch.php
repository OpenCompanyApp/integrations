 ...
 */
class DatabricksPostgresGetBranch extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_branch';
    protected const DESCRIPTION = 'Postgres Get Branch
