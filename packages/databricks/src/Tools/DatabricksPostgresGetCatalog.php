...
/**
 * Postgres Get Catalog.
 *
 * Maps to the official Databricks SDK endpoint get /api/2.0/postgres/{name}.
 */
class DatabricksPostgresGetCatalog extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_catalog';
    protected const DESCRIPTION = 'Postgres Get Catalog
