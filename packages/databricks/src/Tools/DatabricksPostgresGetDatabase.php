 ...
 */
class DatabricksPostgresGetDatabase extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_database';
    protected const DESCRIPTION = 'Postgres Get Database
