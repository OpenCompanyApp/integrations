 ...
 */
class DatabricksPostgresGetEndpoint extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_endpoint';
    protected const DESCRIPTION = 'Postgres Get Endpoint
