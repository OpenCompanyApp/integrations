...
/**
 * Postgres Get Operation.
 *
 * Maps to the official Databricks SDK endpoint get /api/2.0/postgres/{name}.
 */
class DatabricksPostgresGetOperation extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_operation';
    protected const DESCRIPTION = 'Postgres Get Operation
