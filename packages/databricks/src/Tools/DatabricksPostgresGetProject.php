 ...
 */
class DatabricksPostgresGetProject extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_project';
    protected const DESCRIPTION = 'Postgres Get Project
