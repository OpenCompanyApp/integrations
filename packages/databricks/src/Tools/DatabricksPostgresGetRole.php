 ...
 */
class DatabricksPostgresGetRole extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_get_role';
    protected const DESCRIPTION = 'Postgres Get Role
