...
/**
 * Postgres Update Branch.
 *
 * Maps to the official Databricks SDK endpoint patch /api/2.0/postgres/{name}.
 */
class DatabricksPostgresUpdateBranch extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_update_branch';
    protected const DESCRIPTION = 'Postgres Update Branch
