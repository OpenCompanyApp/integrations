...
/**
 * Postgres Update Database.
 *
 * Maps to the official Databricks SDK endpoint patch /api/2.0/postgres/{name}.
 */
class DatabricksPostgresUpdateDatabase extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_update_database';
    protected const DESCRIPTION = 'Postgres Update Database
