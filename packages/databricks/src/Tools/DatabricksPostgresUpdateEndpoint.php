...
/**
 * Postgres Update Endpoint.
 *
 * Maps to the official Databricks SDK endpoint patch /api/2.0/postgres/{name}.
 */
class DatabricksPostgresUpdateEndpoint extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_update_endpoint';
    protected const DESCRIPTION = 'Postgres Update Endpoint
