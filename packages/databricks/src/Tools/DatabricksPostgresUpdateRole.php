...
/**
 * Postgres Update Role.
 *
 * Maps to the official Databricks SDK endpoint patch /api/2.0/postgres/{name}.
 */
class DatabricksPostgresUpdateRole extends AbstractDatabricksTool
{
    protected const NAME = 'databricks_postgres_update_role';
    protected const DESCRIPTION = 'Postgres Update Role
