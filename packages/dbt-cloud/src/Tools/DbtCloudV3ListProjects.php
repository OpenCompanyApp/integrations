 ...
 * List Projects.
 *
 * Maps to the official dbt Cloud v3 endpoint get /api/v3/accounts/{account_id}/projects/.
 */
class DbtCloudV3ListProjects extends AbstractDbtCloudTool
{
    protected const NAME = 'dbt_cloud_v3_list_projects';
    protected const DESCRIPTION = 'List Projects

Official dbt Cloud v3 endpoint: GET /api/v3/accounts/{account_id}/projects/
