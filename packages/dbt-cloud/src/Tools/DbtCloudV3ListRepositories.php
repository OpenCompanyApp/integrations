 ...
 * List Repositories.
 *
 * Maps to the official dbt Cloud v3 endpoint get /api/v3/accounts/{account_id}/projects/{project_id}/repositories/.
 */
class DbtCloudV3ListRepositories extends AbstractDbtCloudTool
{
    protected const NAME = 'dbt_cloud_v3_list_repositories';
    protected const DESCRIPTION = 'List Repositories

Official dbt Cloud v3 endpoint: GET /api/v3/accounts/{account_id}/projects/{project_id}/repositories/
