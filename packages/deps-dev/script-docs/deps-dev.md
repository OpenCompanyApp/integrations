...
```ruby
packageInfo = app.call("integrations.deps-dev.package", system: "NPM", name: "react")
version = app.call("integrations.deps-dev.version", system: "MAVEN", name: "org.apache.logging.log4j:log4j-core", version: "2.15.0")
graph = app.call("integrations.deps-dev.dependencies", system: "NPM", name: "react", version: "18.2.0")
```
