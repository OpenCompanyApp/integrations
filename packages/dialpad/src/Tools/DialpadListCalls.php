 ...
 */
class DialpadListCalls implements Tool
{
    ...
    {
        return 'dialpad_list_calls';
    }

    public function description(): string
    {
        return 'List call history records from Dialpad. Returns call details including participants, duration, and direction. Supports date range filtering and pagination.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'limit' => ['type' => 'integer', 'description' => 'Maximum number of call records to return (default: 50).'],
