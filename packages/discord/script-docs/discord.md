...
```js
var roles = app.integrations.discord.discord_api_get({
...
```js
var me = app.integrations.discord.discord_get_current_user({})

var guilds = app.integrations.discord.discord_list_guilds({
  limit: 50,
})

var channels = app.integrations.discord.discord_list_channels({
  guild_id: "1234567890",
})
```
...
```js
var sent = app.integrations.discord.discord_send_message({
  channel_id: "2222222222",
  content: "Deployment finished.",
})

var messages = app.integrations.discord.discord_list_messages({
  channel_id: "2222222222",
  limit: 25,
})
```
...
```js
var members = app.integrations.discord.discord_list_guild_members({
  guild_id: "1234567890",
  limit: 100,
})
