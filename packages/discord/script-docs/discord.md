...
```ruby
roles = app.integrations.discord.api_get(path: "/guilds/1234567890/roles")
```
## Guild And Channel Discovery

```ruby
me = app.integrations.discord.get_current_user()
guilds = app.integrations.discord.list_guilds(limit: 50)
channels = app.integrations.discord.list_channels(guild_id: "1234567890")
```
...
```ruby
sent = app.integrations.discord.send_message(channel_id: "2222222222", content: "Deployment finished.")
messages = app.integrations.discord.list_messages(channel_id: "2222222222", limit: 25)
```
...
```ruby
members = app.integrations.discord.list_guild_members(guild_id: "1234567890", limit: 100)
app.integrations.discord.add_member_role(guild_id: "1234567890", user_id: "3333333333", role_id: "4444444444")
```
Available tools:
