...
abstract class AbstractDiscordTool implements Tool
{
    ...
    /**
     * @param  DiscordService  $service  Discord API client.
     */
    ...
    /**
     * Execute the mapped Discord API endpoint.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match (static::METHOD) {
                ...
                default => throw new \RuntimeException('Unsupported Discord tool method: '.static::METHOD),
            };
