 ...
 */
class DiscordListGuildChannels implements Tool
{
    /**
    ...
    {
        return 'discord_list_guild_channels';
    }

    public function description(): string
    {
        return 'List all channels in a Discord guild.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listGuildChannels($guildId);
