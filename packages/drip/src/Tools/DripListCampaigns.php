...
class DripListCampaigns implements Tool
{
    ...
    {
        return 'drip_list_campaigns';
    }

    public function description(): string
    {
        return 'List email campaigns in your Drip account. Returns campaign details including name, status, and configuration. Paginated — use page and per_page parameters to navigate results.';
    }
