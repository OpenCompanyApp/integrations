...
class DripListOrders implements Tool
{
    ...
    {
        return 'drip_list_orders';
    }

    public function description(): string
    {
        return 'List orders recorded in your Drip account. Returns order details including amount, items, and associated subscriber. Paginated — use page and per_page parameters to navigate results.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listOrders($page, $perPage);
