...
```js
var user = tools.drone_ci_get_current_user({})

var builds = tools.drone_ci_list_builds({
  owner: "acme",
  repo: "web",
  query: { branch: "main" },
})

var promoted = tools.drone_ci_promote_build({
  owner: "acme",
  repo: "web",
  build: 42,
...
var secret = tools.drone_ci_create_secret({
  owner: "acme",
  repo: "web",
  payload: {
    name: "DEPLOY_TOKEN",
