# HTTP client for the Dropbox API v2 — JavaScript API Reference
...
```js
var result = app.integrations.dropbox.dropbox_copy({
  from_path: "",
  to_path: "",
  autorename: true,
})
...
```js
var result = app.integrations.dropbox.dropbox_create_folder({
  path: "",
  autorename: true,
})
```
...
```js
var result = app.integrations.dropbox.dropbox_create_shared_link({
  path: "",
  settings: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_delete({
  path: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_download_file({
  path: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_get_current_account({
})
```
...
```js
var result = app.integrations.dropbox.dropbox_get_metadata({
  path: "",
...
```js
var result = app.integrations.dropbox.dropbox_get_temporary_link({
  path: "",
})
```
## dropbox_list_folder
...
```js
var result = app.integrations.dropbox.dropbox_list_folder({
  path: "",
  recursive: true,
  limit: 0,
})
...
```js
var result = app.integrations.dropbox.dropbox_list_folder_continue({
  cursor: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_list_revisions({
  path: "",
  limit: 0,
})
```
...
```js
var result = app.integrations.dropbox.dropbox_list_shared_links({
  path: "",
  cursor: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_move({
  from_path: "",
  to_path: "",
  autorename: true,
})
...
```js
var result = app.integrations.dropbox.dropbox_restore({
  path: "",
  rev: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_search_continue({
  cursor: "",
})
```
...
```js
var result = app.integrations.dropbox.dropbox_search_files({
  query: "",
  path: "",
  file_categories: {},
})
...
```js
var result = app.integrations.dropbox.dropbox_upload_file({
  path: "",
  content: "",
  mode: "",
})
...
app.integrations.dropbox.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.dropbox.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.dropbox.work.function_name({ /* parameters */ })
app.integrations.dropbox.personal.function_name({ /* parameters */ })
```
