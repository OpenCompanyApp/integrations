 ...
 */
class DropboxMove implements Tool
{
    ...
    {
        return 'Move a file or folder to a new location in Dropbox. Both from_path and to_path are required. Set allow_shared_folder to true to move shared folders.';
    }

    public function parameters(): array
    {
        return [
            'from_path' => ['type' => 'string', 'required' => true, 'description' => 'Current path of the file or folder, e.g. "/Documents/report.txt".'],
            'to_path' => ['type' => 'string', 'required' => true, 'description' => 'Destination path, e.g. "/Archive/report.txt".'],
            'autorename' => ['type' => 'boolean', 'description' => 'If true and a file exists at to_path, auto-rename. Default: false.'],
            'allow_shared_folder' => ['type' => 'boolean', 'description' => 'If true, allows moving shared folders. Default: false.'],
        ];
    }
