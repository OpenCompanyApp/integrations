...
class ElasticGetDocument implements Tool
{
    /**
    ...
    {
        return 'Retrieve a single document from an Elasticsearch index by its ID.';
    }
    ...
    {
        return [
            'index' => ['type' => 'string', 'required' => true, 'description' => 'The index containing the document.'],
            'id' => ['type' => 'string', 'required' => true, 'description' => 'The document ID to retrieve.'],
        ];
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->getDocument($index, $id);
