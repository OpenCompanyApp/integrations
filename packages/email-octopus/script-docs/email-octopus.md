# EmailOctopus - JavaScript API Reference
...
```js
var lists = app.integrations["email-octopus"].emailoctopus_list_lists({
  limit: 25,
  page: 1,
})

var list = app.integrations["email-octopus"].emailoctopus_get_list({
  list_id: "list_123",
})
...
var contact = app.integrations["email-octopus"].emailoctopus_get_contact({
  list_id: "list_123",
...
```js
var campaigns = app.integrations["email-octopus"].emailoctopus_list_campaigns({
  limit: 50,
  page: 1,
})

var summary = app.integrations["email-octopus"].emailoctopus_get_campaign_report_summary({
  campaign_id: "campaign_123",
})

var opened = app.integrations["email-octopus"].emailoctopus_get_campaign_report_opened({
  campaign_id: "campaign_123",
  limit: 100,
  page: 1,
})
