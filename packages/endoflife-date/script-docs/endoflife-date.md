...
```ruby
ubuntu = app.call("integrations.endoflife-date.product", product: "ubuntu")
noble = app.call("integrations.endoflife-date.product_release", product: "ubuntu", release: "24.04")
latest_php = app.call("integrations.endoflife-date.latest_release", product: "php")
purls = app.call("integrations.endoflife-date.identifiers", identifier_type: "purl")
```
