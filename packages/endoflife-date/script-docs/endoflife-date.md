...
```js
var ubuntu = tools.endoflife_date_product({
  product: "ubuntu",
})

var noble = tools.endoflife_date_product_release({
  product: "ubuntu",
  release: "24.04",
})

var latest_php = tools.endoflife_date_latest_release({
  product: "php",
})

var purls = tools.endoflife_date_identifiers({
