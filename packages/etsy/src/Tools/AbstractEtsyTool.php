...
/**
 * Shared execution and validation helpers for Etsy tool wrappers.
 */
abstract class AbstractEtsyTool implements Tool
{
    /**
     * @param  EtsyService  $service  The Etsy Open API client.
     */
    public function __construct(
        protected EtsyService $service,
    ) {}
    ...
    /**
     * Execute the Etsy operation with standard error handling.
     *
