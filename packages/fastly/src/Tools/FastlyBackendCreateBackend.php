 ...
 * Create a backend
 *
 * Maps to Fastly generated client operation BackendApi::createBackend (POST /service/{service_id}/version/{version_id}/backend).
 */
class FastlyBackendCreateBackend extends AbstractFastlyTool
{
    protected const NAME = 'fastly_backend_create_backend';
    protected const DESCRIPTION = 'Create a backend

Official Fastly client operation: BackendApi::createBackend
Endpoint: POST /service/{service_id}/version/{version_id}/backend
...
Create a backend';
  ...
  'slug' => 'fastly_backend_create_backend',
  'class' => 'FastlyBackendCreateBackend',
  'api_class' => 'BackendApi',
  'method_name' => 'createBackend',
  'method' => 'POST',
