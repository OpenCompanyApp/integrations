 ...
 *
 * Maps to Fastly generated client operation LoggingAzureblobApi::createLogAzure (POST /service/{service_id}/version/{version_id}/logging/azureblob).
 */
class FastlyLoggingAzureblobCreateLogAzure extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_azureblob_create_log_azure';
    protected const DESCRIPTION = 'Create an Azure Blob Storage log endpoint

Official Fastly client operation: LoggingAzureblobApi::createLogAzure
Endpoint: POST /service/{service_id}/version/{version_id}/logging/azureblob
...
Create an Azure Blob Storage log endpoint';
  ...
  'slug' => 'fastly_logging_azureblob_create_log_azure',
  'class' => 'FastlyLoggingAzureblobCreateLogAzure',
  'api_class' => 'LoggingAzureblobApi',
  'method_name' => 'createLogAzure',
  'method' => 'POST',
