 ...
 *
 * Maps to Fastly generated client operation LoggingElasticsearchApi::createLogElasticsearch (POST /service/{service_id}/version/{version_id}/logging/elasticsearch).
 */
class FastlyLoggingElasticsearchCreateLogElasticsearch extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_elasticsearch_create_log_elasticsearch';
    protected const DESCRIPTION = 'Create an Elasticsearch log endpoint

Official Fastly client operation: LoggingElasticsearchApi::createLogElasticsearch
Endpoint: POST /service/{service_id}/version/{version_id}/logging/elasticsearch
...
Create an Elasticsearch log endpoint';
  ...
  'slug' => 'fastly_logging_elasticsearch_create_log_elasticsearch',
  'class' => 'FastlyLoggingElasticsearchCreateLogElasticsearch',
  'api_class' => 'LoggingElasticsearchApi',
  'method_name' => 'createLogElasticsearch',
  'method' => 'POST',
