 ...
 *
 * Maps to Fastly generated client operation LoggingFtpApi::updateLogFtp (PUT /service/{service_id}/version/{version_id}/logging/ftp/{logging_ftp_name}).
 */
class FastlyLoggingFtpUpdateLogFtp extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_ftp_update_log_ftp';
    protected const DESCRIPTION = 'Update an FTP log endpoint

Official Fastly client operation: LoggingFtpApi::updateLogFtp
Endpoint: PUT /service/{service_id}/version/{version_id}/logging/ftp/{logging_ftp_name}
...
Update an FTP log endpoint';
  ...
  'slug' => 'fastly_logging_ftp_update_log_ftp',
  'class' => 'FastlyLoggingFtpUpdateLogFtp',
  'api_class' => 'LoggingFtpApi',
  'method_name' => 'updateLogFtp',
  'method' => 'PUT',
