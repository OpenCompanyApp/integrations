 ...
 *
 * Maps to Fastly generated client operation LoggingGcsApi::updateLogGcs (PUT /service/{service_id}/version/{version_id}/logging/gcs/{logging_gcs_name}).
 */
class FastlyLoggingGcsUpdateLogGcs extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_gcs_update_log_gcs';
    protected const DESCRIPTION = 'Update a GCS log endpoint

Official Fastly client operation: LoggingGcsApi::updateLogGcs
Endpoint: PUT /service/{service_id}/version/{version_id}/logging/gcs/{logging_gcs_name}
...
Update a GCS log endpoint';
  ...
  'slug' => 'fastly_logging_gcs_update_log_gcs',
  'class' => 'FastlyLoggingGcsUpdateLogGcs',
  'api_class' => 'LoggingGcsApi',
  'method_name' => 'updateLogGcs',
  'method' => 'PUT',
