 ...
 *
 * Maps to Fastly generated client operation LoggingHttpsApi::createLogHttps (POST /service/{service_id}/version/{version_id}/logging/https).
 */
class FastlyLoggingHttpsCreateLogHttps extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_https_create_log_https';
    protected const DESCRIPTION = 'Create an HTTPS log endpoint

Official Fastly client operation: LoggingHttpsApi::createLogHttps
Endpoint: POST /service/{service_id}/version/{version_id}/logging/https
...
Create an HTTPS log endpoint';
  ...
  'slug' => 'fastly_logging_https_create_log_https',
  'class' => 'FastlyLoggingHttpsCreateLogHttps',
  'api_class' => 'LoggingHttpsApi',
  'method_name' => 'createLogHttps',
  'method' => 'POST',
