 ...
 *
 * Maps to Fastly generated client operation LoggingNewrelicApi::updateLogNewrelic (PUT /service/{service_id}/version/{version_id}/logging/newrelic/{logging_newrelic_name}).
 */
class FastlyLoggingNewrelicUpdateLogNewrelic extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_newrelic_update_log_newrelic';
    protected const DESCRIPTION = 'Update a New Relic log endpoint

Official Fastly client operation: LoggingNewrelicApi::updateLogNewrelic
Endpoint: PUT /service/{service_id}/version/{version_id}/logging/newrelic/{logging_newrelic_name}
...
Update a New Relic log endpoint';
  ...
  'slug' => 'fastly_logging_newrelic_update_log_newrelic',
  'class' => 'FastlyLoggingNewrelicUpdateLogNewrelic',
  'api_class' => 'LoggingNewrelicApi',
  'method_name' => 'updateLogNewrelic',
  'method' => 'PUT',
