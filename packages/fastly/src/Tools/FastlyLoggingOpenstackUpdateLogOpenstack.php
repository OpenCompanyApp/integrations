 ...
 *
 * Maps to Fastly generated client operation LoggingOpenstackApi::updateLogOpenstack (PUT /service/{service_id}/version/{version_id}/logging/openstack/{logging_openstack_name}).
 */
class FastlyLoggingOpenstackUpdateLogOpenstack extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_openstack_update_log_openstack';
    protected const DESCRIPTION = 'Update an OpenStack log endpoint

Official Fastly client operation: LoggingOpenstackApi::updateLogOpenstack
Endpoint: PUT /service/{service_id}/version/{version_id}/logging/openstack/{logging_openstack_name}
...
Update an OpenStack log endpoint';
  ...
  'slug' => 'fastly_logging_openstack_update_log_openstack',
  'class' => 'FastlyLoggingOpenstackUpdateLogOpenstack',
  'api_class' => 'LoggingOpenstackApi',
  'method_name' => 'updateLogOpenstack',
  'method' => 'PUT',
