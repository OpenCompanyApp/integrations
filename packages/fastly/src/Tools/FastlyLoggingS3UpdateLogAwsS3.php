 ...
 *
 * Maps to Fastly generated client operation LoggingS3Api::updateLogAwsS3 (PUT /service/{service_id}/version/{version_id}/logging/s3/{logging_s3_name}).
 */
class FastlyLoggingS3UpdateLogAwsS3 extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_s3_update_log_aws_s3';
    protected const DESCRIPTION = 'Update an AWS S3 log endpoint

Official Fastly client operation: LoggingS3Api::updateLogAwsS3
Endpoint: PUT /service/{service_id}/version/{version_id}/logging/s3/{logging_s3_name}
...
Update an AWS S3 log endpoint';
  ...
  'slug' => 'fastly_logging_s3_update_log_aws_s3',
  'class' => 'FastlyLoggingS3UpdateLogAwsS3',
  'api_class' => 'LoggingS3Api',
  'method_name' => 'updateLogAwsS3',
  'method' => 'PUT',
