 ...
 *
 * Maps to Fastly generated client operation LoggingSftpApi::updateLogSftp (PUT /service/{service_id}/version/{version_id}/logging/sftp/{logging_sftp_name}).
 */
class FastlyLoggingSftpUpdateLogSftp extends AbstractFastlyTool
{
    protected const NAME = 'fastly_logging_sftp_update_log_sftp';
    protected const DESCRIPTION = 'Update an SFTP log endpoint

Official Fastly client operation: LoggingSftpApi::updateLogSftp
Endpoint: PUT /service/{service_id}/version/{version_id}/logging/sftp/{logging_sftp_name}
...
Update an SFTP log endpoint';
  ...
  'slug' => 'fastly_logging_sftp_update_log_sftp',
  'class' => 'FastlyLoggingSftpUpdateLogSftp',
  'api_class' => 'LoggingSftpApi',
  'method_name' => 'updateLogSftp',
  'method' => 'PUT',
