 ...
 *
 * Maps to Fastly generated client operation PoolApi::createServerPool (POST /service/{service_id}/version/{version_id}/pool).
 */
class FastlyPoolCreateServerPool extends AbstractFastlyTool
{
    protected const NAME = 'fastly_pool_create_server_pool';
    protected const DESCRIPTION = 'Create a server pool

Official Fastly client operation: PoolApi::createServerPool
Endpoint: POST /service/{service_id}/version/{version_id}/pool
...
Create a server pool';
  ...
  'slug' => 'fastly_pool_create_server_pool',
  'class' => 'FastlyPoolCreateServerPool',
  'api_class' => 'PoolApi',
  'method_name' => 'createServerPool',
  'method' => 'POST',
