...
/**
 * Tool provider for the Fathom Analytics integration.
 *
 * Implements ConfigurableIntegration for credential management and multi-account support.
 * Registers 6 tools for querying Fathom Analytics data: sites, pageviews, aggregates,
 * events, and user profile.
 */
class FathomToolProvider implements ToolProvider, ConfigurableIntegration
{
    /**
