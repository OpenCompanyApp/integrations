 ...
 */
class FathomDeleteSite implements Tool
{
    /**
    ...
    {
        return 'fathom_delete_site';
    }

    public function description(): string
    {
        return 'Delete a Fathom site. This is destructive and cannot be undone.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->deleteSite((string) $args['site_id']));
        } catch (\Throwable $e) {
