...
```ruby
app.integrations.featurebase.create_post(payload: {boardId: "board_123", title: "Add invoice exports", content: "<p>Customers need CSV && PDF exports.</p>", tags: ["billing", "export"]})
```
```ruby
app.integrations.featurebase.get_contact_by_user_id(user_id: "external-user-123")
```
```ruby
app.integrations.featurebase.reply_conversation(id: "conv_123", payload: {body: "Thanks for the extra context.", author: {type: "admin", id: "admin_123"}})
```
