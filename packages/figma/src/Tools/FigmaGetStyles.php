...
/**
 * List styles in a Figma file.
 *
 * Returns all styles (colors, typography, effects, grid)
 * defined in the file.
 */
class FigmaGetStyles implements Tool
{
    /**
    ...
    {
        return 'List all styles in a Figma file.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->getStyles($fileKey);
