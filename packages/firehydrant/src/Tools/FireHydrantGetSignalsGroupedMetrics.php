 ...
 *
 * Maps to the official FireHydrant endpoint get /v1/signals/analytics/grouped_metrics.
 */
class FireHydrantGetSignalsGroupedMetrics extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_get_signals_grouped_metrics';
    protected const DESCRIPTION = 'Generate grouped alert metrics

Official FireHydrant endpoint: GET /v1/signals/analytics/grouped_metrics
...
Generate a report of grouped metrics for Signals alerts';
  ...
  array (
    ...
    protected const PATH = '/v1/signals/analytics/grouped_metrics';
