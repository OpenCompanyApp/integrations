 ...
 *
 * Maps to the official FireHydrant endpoint get /v1/signals/analytics/noise/metrics.
 */
class FireHydrantGetSignalsNoiseAnalytics extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_get_signals_noise_analytics';
    protected const DESCRIPTION = 'Get noise analytics for signals

Official FireHydrant endpoint: GET /v1/signals/analytics/noise/metrics
...
Get noise metrics for Signals alerts';
  ...
  array (
    ...
    protected const PATH = '/v1/signals/analytics/noise/metrics';
