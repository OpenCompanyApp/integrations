 ...
 *
 * Maps to the official FireHydrant endpoint get /v1/signals/analytics/timeseries.
 */
class FireHydrantGetSignalsTimeseriesAnalytics extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_get_signals_timeseries_analytics';
    protected const DESCRIPTION = 'Generate timeseries alert metrics

Official FireHydrant endpoint: GET /v1/signals/analytics/timeseries
...
Generate a timeseries-based report of metrics for Signals alerts';
  ...
  array (
    ...
    protected const PATH = '/v1/signals/analytics/timeseries';
