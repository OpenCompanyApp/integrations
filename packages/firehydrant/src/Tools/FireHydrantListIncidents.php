 ...
 * List incidents.
 *
 * Maps to the official FireHydrant endpoint get /v1/incidents.
 */
class FireHydrantListIncidents extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_list_incidents';
    protected const DESCRIPTION = 'List incidents

Official FireHydrant endpoint: GET /v1/incidents
