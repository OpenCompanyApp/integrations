 ...
 *
 * Maps to the official FireHydrant endpoint get /v1/metrics/milestone_funnel.
 */
class FireHydrantListMilestoneFunnelMetrics extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_list_milestone_funnel_metrics';
    protected const DESCRIPTION = 'List milestone funnel metrics

Official FireHydrant endpoint: GET /v1/metrics/milestone_funnel
...
Returns a report with time bucketed milestone data';
  ...
  array (
    ...
    protected const PATH = '/v1/metrics/milestone_funnel';
