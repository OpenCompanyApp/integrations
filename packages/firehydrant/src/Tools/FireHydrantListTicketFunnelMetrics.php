 ...
 *
 * Maps to the official FireHydrant endpoint get /v1/metrics/ticket_funnel.
 */
class FireHydrantListTicketFunnelMetrics extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_list_ticket_funnel_metrics';
    protected const DESCRIPTION = 'List ticket task and follow up creation and completion metrics

Official FireHydrant endpoint: GET /v1/metrics/ticket_funnel
...
Returns a report with task and follow up creation and completion data';
  ...
  array (
    ...
    protected const PATH = '/v1/metrics/ticket_funnel';
