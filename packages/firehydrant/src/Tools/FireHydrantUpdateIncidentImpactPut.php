 ...
 *
 * Maps to the official FireHydrant endpoint put /v1/incidents/{incident_id}/impact.
 */
class FireHydrantUpdateIncidentImpactPut extends AbstractFireHydrantTool
{
    protected const NAME = 'firehydrant_update_incident_impact_put';
    protected const DESCRIPTION = 'Update impacts for an incident

Official FireHydrant endpoint: PUT /v1/incidents/{incident_id}/impact
