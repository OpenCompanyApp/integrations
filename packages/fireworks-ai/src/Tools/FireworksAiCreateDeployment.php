 ...
 * Create Deployment.
 */
class FireworksAiCreateDeployment extends AbstractFireworksAiTool
{
    protected const NAME = 'fireworks_ai_create_deployment';
    protected const DESCRIPTION = 'Create Deployment.';
