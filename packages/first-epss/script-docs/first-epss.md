...
```ruby
score = app.call("integrations.first-epss.cve", cve: "CVE-2022-27225")
batch = app.call("integrations.first-epss.batch", cves: ["CVE-2022-27225", "CVE-2022-27223"], date: "2022-03-05")
urgent = app.call("integrations.first-epss.threshold", epss_gt: 0.95, limit: 100)
```
