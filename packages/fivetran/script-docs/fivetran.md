...
```js
var account = app.integrations.fivetran.fivetran_get_account_info({})
var connections = app.integrations.fivetran.fivetran_list_connections({ limit: 25 })
```
## Coverage Notes
