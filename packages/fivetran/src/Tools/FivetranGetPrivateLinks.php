 ...
 *
 * Maps to the official Fivetran endpoint get /v1/private-links.
 */
class FivetranGetPrivateLinks extends AbstractFivetranTool
{
    protected const NAME = 'fivetran_get_private_links';
    protected const DESCRIPTION = 'List All Private Links

Official Fivetran endpoint: GET /v1/private-links
