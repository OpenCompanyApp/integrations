 ...
 *
 * Maps to the official Fivetran endpoint get /v1/teams/{teamId}/groups/{groupId}.
 */
class FivetranGetTeamMembershipInGroup extends AbstractFivetranTool
{
    protected const NAME = 'fivetran_get_team_membership_in_group';
    protected const DESCRIPTION = 'Retrieve Group Membership Details

Official Fivetran endpoint: GET /v1/teams/{teamId}/groups/{groupId}
