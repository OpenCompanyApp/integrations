 ...
 *
 * Maps to the official Fivetran endpoint get /v1/groups.
 */
class FivetranListAllGroups extends AbstractFivetranTool
{
    protected const NAME = 'fivetran_list_all_groups';
    protected const DESCRIPTION = 'List All Destinations within Account

Official Fivetran endpoint: GET /v1/groups
