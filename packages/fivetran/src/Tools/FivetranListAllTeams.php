 ...
 * List All Teams.
 *
 * Maps to the official Fivetran endpoint get /v1/teams.
 */
class FivetranListAllTeams extends AbstractFivetranTool
{
    protected const NAME = 'fivetran_list_all_teams';
    protected const DESCRIPTION = 'List All Teams

Official Fivetran endpoint: GET /v1/teams
