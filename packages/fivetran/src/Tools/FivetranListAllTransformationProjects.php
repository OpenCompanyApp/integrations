 ...
 *
 * Maps to the official Fivetran endpoint get /v1/transformation-projects.
 */
class FivetranListAllTransformationProjects extends AbstractFivetranTool
{
    protected const NAME = 'fivetran_list_all_transformation_projects';
    protected const DESCRIPTION = 'List all Transformation Projects

Official Fivetran endpoint: GET /v1/transformation-projects
