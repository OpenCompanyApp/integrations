 ...
 *
 * Maps to the official Fivetran endpoint patch /v1/users/{userId}/groups/{groupId}.
 */
class FivetranUpdateUserMembershipInGroup extends AbstractFivetranTool
{
    protected const NAME = 'fivetran_update_user_membership_in_group';
    protected const DESCRIPTION = 'Update Group Membership

Official Fivetran endpoint: PATCH /v1/users/{userId}/groups/{groupId}
