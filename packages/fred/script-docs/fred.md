...
```ruby
matches = app.integrations.fred.series_search(search_text: "unemployment rate", limit: 5, order_by: "popularity", sort_order: "desc")
observations = app.integrations.fred.series_observations(series_id: "UNRATE", observation_start: "2020-01-01", observation_end: "2026-01-01", units: "lin")
categorySeries = app.integrations.fred.category_series(category_id: 125, tag_names: "usa;monthly", limit: 10)
```