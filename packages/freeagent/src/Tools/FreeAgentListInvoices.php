 ...
 *
 * Supports filtering by status, date range, contact, and project.
 */
class FreeAgentListInvoices implements Tool
{
    /**
     * Create a new FreeAgentListInvoices tool instance.
     *
    ...
    {
        return 'freeagent_list_invoices';
    }
    ...
    {
        return 'List invoices from FreeAgent. Returns a paginated list of invoices with their details. Supports filtering by status (Draft, Sent, Cancelled, Late Paid, Paid), date range, contact, and project.';
    }
    ...
    {
        return [
            'status' => ['type' => 'string', 'description' => 'Filter by status: Draft, Sent, Cancelled, Late, Paid.'],
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $params = [];
            $filters = ['status', 'from_date', 'to_date', 'contact', 'project', 'page', 'per_page'];
