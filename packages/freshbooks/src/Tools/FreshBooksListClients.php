...
class FreshBooksListClients implements Tool
{
    ...
    {
        return 'freshbooks_list_clients';
    }

    public function description(): string
    {
        return 'List clients from FreshBooks. Returns client details including name, email, company, and balance. Supports filtering and pagination.';
    }

    public function parameters(): array
    {
        return [
            'search' => ['type' => 'object', 'description' => 'Search filters. Keys: email, fname, lname, organization, state (active/archived). Pass as an object.'],
