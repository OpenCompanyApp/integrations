...
class FreshBooksListProjects implements Tool
{
    ...
    {
        return 'freshbooks_list_projects';
    }

    public function description(): string
    {
        return 'List projects from FreshBooks. Returns project details including title, description, billing method, budget, and active status. Supports filtering and pagination.';
    }

    public function parameters(): array
    {
        return [
            'search' => ['type' => 'object', 'description' => 'Search filters. Keys: title, active (true/false), clientid. Pass as an object.'],
