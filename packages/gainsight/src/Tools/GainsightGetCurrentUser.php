...
/**
 * Tool for retrieving the currently authenticated Gainsight user.
 *
 * Fetches the profile of the user associated with the configured
 * API credentials via the GET /users/me endpoint.
 */
class GainsightGetCurrentUser implements Tool
{
    /**
     * Create a new GainsightGetCurrentUser tool instance.
     */
    ...
    {
        return 'gainsight_get_current_user';
    }
    ...
    {
        return 'Get the currently authenticated Gainsight user profile. Useful for verifying credentials and understanding whose data is being accessed.';
    }
