...
class GetResponseGetCurrentUser implements Tool
{
    ...
    {
        return 'getresponse_get_current_user';
    }

    public function description(): string
    {
        return 'Get the authenticated user\'s account information from GetResponse, including email, name, and account details.';
    }
