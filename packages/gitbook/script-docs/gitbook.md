...
```js
var orgs = tools.gitbook_list_organizations({})

var spaces = tools.gitbook_list_spaces({
  organization_id: "org_abc",
  limit: 20,
})

var results = tools.gitbook_search_space({
  space_id: "space_abc",
  query: "authentication",
  limit: 10,
})

var page = tools.gitbook_get_page_by_path({
  space_id: "space_abc",
