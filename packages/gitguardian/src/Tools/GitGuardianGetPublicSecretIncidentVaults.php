 ...
 *
 * Maps to the official GitGuardian endpoint GET /v1/public-incidents/secrets/{incident_id}/vaults.
 */
class GitGuardianGetPublicSecretIncidentVaults extends AbstractGitGuardianTool
{
    protected const NAME = 'gitguardian_get_public_secret_incident_vaults';
...
Official GitGuardian endpoint: GET /v1/public-incidents/secrets/{incident_id}/vaults.';
    ...
    protected const PATH = '/v1/public-incidents/secrets/{incident_id}/vaults';
