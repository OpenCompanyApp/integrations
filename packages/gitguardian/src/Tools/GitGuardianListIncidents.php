 ...
 *
 * Maps to the official GitGuardian endpoint GET /v1/incidents/secrets.
 */
class GitGuardianListIncidents extends AbstractGitGuardianTool
{
    protected const NAME = 'gitguardian_list_incidents';
    protected const DESCRIPTION = 'List secret incidents detected by the GitGuardian dashboard. Occurrences are not returned in this route.
...
Official GitGuardian endpoint: GET /v1/incidents/secrets.';
    ...
    protected const PATH = '/v1/incidents/secrets';
