 ...
 *
 * Maps to the official GitGuardian endpoint GET /v1/invitations/{invitation_id}/secret-incidents.
 */
class GitGuardianListInvitationSecretIncidentAccess extends AbstractGitGuardianTool
{
    protected const NAME = 'gitguardian_list_invitation_secret_incident_access';
    protected const DESCRIPTION = 'List secret incidents that an invitation has access to.
...
Official GitGuardian endpoint: GET /v1/invitations/{invitation_id}/secret-incidents.';
    ...
    protected const PATH = '/v1/invitations/{invitation_id}/secret-incidents';
