 ...
 *
 * Maps to the official GitGuardian endpoint GET /v1/teams/{team_id}/incidents/secrets.
 */
class GitGuardianListTeamIncidents extends AbstractGitGuardianTool
{
    protected const NAME = 'gitguardian_list_team_incidents';
    protected const DESCRIPTION = 'List secret incidents of a particular team. Occurrences are not returned in this route. DEPRECATED: THis endpoint has been replaced by [/v1/teams/{team_id}/secret-incidents](#tag/Teams/operation/list-team-secret-incident-access)
...
Official GitGuardian endpoint: GET /v1/teams/{team_id}/incidents/secrets.';
    ...
    protected const PATH = '/v1/teams/{team_id}/incidents/secrets';
