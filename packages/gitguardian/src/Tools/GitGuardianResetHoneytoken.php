 ...
 *
 * Maps to the official GitGuardian endpoint POST /v1/honeytokens/{honeytoken_id}/reset.
 */
class GitGuardianResetHoneytoken extends AbstractGitGuardianTool
{
    protected const NAME = 'gitguardian_reset_honeytoken';
    protected const DESCRIPTION = 'Resets a triggered honeytoken. All the associated events will be closed.
...
Official GitGuardian endpoint: POST /v1/honeytokens/{honeytoken_id}/reset.';
    ...
    protected const PATH = '/v1/honeytokens/{honeytoken_id}/reset';
