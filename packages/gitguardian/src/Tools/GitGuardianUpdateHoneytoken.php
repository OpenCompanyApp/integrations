 ...
 * Update a honeytoken.
 *
 * Maps to the official GitGuardian endpoint PATCH /v1/honeytokens/{honeytoken_id}.
 */
class GitGuardianUpdateHoneytoken extends AbstractGitGuardianTool
{
    protected const NAME = 'gitguardian_update_honeytoken';
    protected const DESCRIPTION = 'Update a name or descriptions of an existing honeytoken.
