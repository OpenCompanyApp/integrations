 ...
 */
class GitHubListPullRequests implements Tool
{
    ...
    {
        return 'List pull requests in a GitHub repository. Supports filtering by state (open, closed, all) and sorting.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'state' => ['type' => 'string', 'description' => 'Pull request state filter: open, closed, all. Default: open.'],
            'sort' => ['type' => 'string', 'description' => 'Sort field: created, updated, popularity, long-running. Default: created.'],
    ...
    /**
     * Retrieve pull requests with optional filtering by state and sort order.
     *
     * @param  array<string, mixed>  $args  Tool arguments (owner, repo, state, sort, direction, per_page)
     */
    public function execute(array $args): ToolResult
    {
        ...
        try {
            ...
            $result = $this->service->listPullRequests($owner, $repo, $params);
