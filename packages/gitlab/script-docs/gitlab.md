# HTTP client for the GitLab REST API (v4) — Ruby API Reference
...
```ruby
result = app.integrations.gitlab.accept_merge_request(project_id: "", mr_iid: 0, merge_commit_message: "")
```
...
```ruby
result = app.integrations.gitlab.create_branch(project_id: "", branch: "", ref: "")
```
## gitlab_create_issue
...
```ruby
result = app.integrations.gitlab.create_issue(project_id: "", title: "", description: "")
```
...
```ruby
result = app.integrations.gitlab.create_issue_comment(project_id: "", issue_iid: 0, body: "")
```
...
```ruby
result = app.integrations.gitlab.create_merge_request(project_id: "", source_branch: "", target_branch: "")
```
## gitlab_get_file
...
```ruby
result = app.integrations.gitlab.get_file(project_id: "", file_path: "", ref: "")
```
## gitlab_get_issue
...
```ruby
result = app.integrations.gitlab.get_issue(project_id: "", issue_iid: 0)
```
...
```ruby
result = app.integrations.gitlab.get_merge_request(project_id: "", mr_iid: 0)
```
## gitlab_get_project
...
```ruby
result = app.integrations.gitlab.get_project(project_id: "")
```
...
```ruby
result = app.integrations.gitlab.list_branches(project_id: "", search: "", page: 0)
```
## gitlab_list_commits
...
```ruby
result = app.integrations.gitlab.list_commits(project_id: "", ref_name: "", page: 0)
```
## gitlab_list_groups
...
```ruby
result = app.integrations.gitlab.list_groups(page: 0, per_page: 0)
```
## gitlab_list_issues
...
```ruby
result = app.integrations.gitlab.list_issues(project_id: "", state: "", labels: "")
```
## gitlab_list_labels
...
```ruby
result = app.integrations.gitlab.list_labels(project_id: "")
```
...
```ruby
result = app.integrations.gitlab.list_merge_requests(project_id: "", state: "", page: 0)
```
...
```ruby
result = app.integrations.gitlab.list_project_members(project_id: "", page: 0)
```
...
```ruby
result = app.integrations.gitlab.list_projects(membership: true, search: "", page: 0)
```
...
```ruby
result = app.integrations.gitlab.search_issues(project_id: "", search: "", state: "")
```
## gitlab_update_issue
...
```ruby
result = app.integrations.gitlab.update_issue(project_id: "", issue_iid: 0, title: "")
```
...
```ruby
result = app.integrations.gitlab.update_merge_request(project_id: "", mr_iid: 0, title: "")
```
---
