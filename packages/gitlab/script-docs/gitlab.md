# HTTP client for the GitLab REST API (v4) — JavaScript API Reference
...
```js
var result = app.integrations.gitlab.gitlab_accept_merge_request({
  project_id: "",
  mr_iid: 0,
...
```js
var result = app.integrations.gitlab.gitlab_create_branch({
  project_id: "",
  branch: "",
  ref: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_create_issue({
  project_id: "",
  title: "",
  description: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_create_issue_comment({
  project_id: "",
  issue_iid: 0,
  body: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_create_merge_request({
  project_id: "",
  source_branch: "",
  target_branch: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_get_file({
  project_id: "",
  file_path: "",
  ref: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_get_issue({
  project_id: "",
  issue_iid: 0,
})
```
...
```js
var result = app.integrations.gitlab.gitlab_get_merge_request({
  project_id: "",
  mr_iid: 0,
})
```
...
```js
var result = app.integrations.gitlab.gitlab_get_project({
  project_id: "",
})
```
...
```js
var result = app.integrations.gitlab.gitlab_list_branches({
  project_id: "",
  search: "",
  page: 0,
})
...
```js
var result = app.integrations.gitlab.gitlab_list_commits({
  project_id: "",
  ref_name: "",
  page: 0,
})
...
```js
var result = app.integrations.gitlab.gitlab_list_groups({
  page: 0,
  per_page: 0,
})
```
...
```js
var result = app.integrations.gitlab.gitlab_list_issues({
  project_id: "",
  state: "",
  labels: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_list_labels({
  project_id: "",
})
```
...
```js
var result = app.integrations.gitlab.gitlab_list_merge_requests({
  project_id: "",
  state: "",
  page: 0,
})
...
```js
var result = app.integrations.gitlab.gitlab_list_project_members({
  project_id: "",
  page: 0,
})
```
...
```js
var result = app.integrations.gitlab.gitlab_list_projects({
  membership: true,
  search: "",
  page: 0,
})
...
```js
var result = app.integrations.gitlab.gitlab_search_issues({
  project_id: "",
  search: "",
  state: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_update_issue({
  project_id: "",
  issue_iid: 0,
  title: "",
})
...
```js
var result = app.integrations.gitlab.gitlab_update_merge_request({
  project_id: "",
  mr_iid: 0,
  title: "",
})
...
app.integrations.gitlab.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.gitlab.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.gitlab.work.function_name({ /* parameters */ })
app.integrations.gitlab.personal.function_name({ /* parameters */ })
```
