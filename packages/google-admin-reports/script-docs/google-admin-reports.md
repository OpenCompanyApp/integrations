...
```js
var activity = app.integrations.google_admin_reports.google_admin_reports_activities_list({
  userKey: "all",
  applicationName: "login",
  maxResults: 10,
})

var usage = app.integrations.google_admin_reports.google_admin_reports_customer_usage_reports_get({
  date: "2026-05-01",
})
```
