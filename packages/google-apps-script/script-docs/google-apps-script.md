...
```ruby
project = app.call("integrations.google-apps-script.projects_get", script_id: "script-id")
content = app.call("integrations.google-apps-script.projects_get_content", script_id: "script-id")
execution = app.call("integrations.google-apps-script.run", script_id: "script-id", body: {function: "main", parameters: ["argument"]})
```
