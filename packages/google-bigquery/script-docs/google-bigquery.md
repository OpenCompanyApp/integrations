# Google BigQuery - JavaScript API Reference
...
```js
var datasets = app.integrations.google_bigquery.google_bigquery_datasets_list({
  projectId: "example-project",
  maxResults: 50,
})

var query = app.integrations.google_bigquery.google_bigquery_jobs_query({
  projectId: "example-project",
  body: {
...
var rows = app.integrations.google_bigquery.google_bigquery_tabledata_list({
  projectId: "example-project",
  datasetId: "analytics",
  tableId: "events",
  maxResults: 100,
