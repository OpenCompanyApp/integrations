# Google BigQuery - Ruby API Reference
...
```ruby
datasets = app.call("integrations.google-bigquery.datasets_list", project_id: "example-project", max_results: 50)
query = app.call("integrations.google-bigquery.jobs", project_id: "example-project", body: {query: "select 1 as ok", useLegacySql: false})
rows = app.call("integrations.google-bigquery.tabledata_list", project_id: "example-project", dataset_id: "analytics", table_id: "events", max_results: 100)
```
## Multi-Account Usage

```ruby
app.call("integrations.google-bigquery.projects_list")
app.call("integrations.google-bigquery.default.projects_list")
app.call("integrations.google-bigquery.production.projects_list")
```
## Datasets
