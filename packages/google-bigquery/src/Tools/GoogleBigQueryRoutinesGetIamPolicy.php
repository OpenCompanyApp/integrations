...
/**
 * Routines Get Iam Policy.
 *
 * Maps to the official BigQuery endpoint POST /{+resource}:getIamPolicy.
 */
class GoogleBigQueryRoutinesGetIamPolicy extends AbstractGoogleBigQueryTool
{
    protected const NAME = 'google_bigquery_routines_get_iam_policy';
    protected const DESCRIPTION = 'Routines Get Iam Policy
