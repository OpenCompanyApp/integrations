...
/**
 * Tables Get Iam Policy.
 *
 * Maps to the official BigQuery endpoint POST /{+resource}:getIamPolicy.
 */
class GoogleBigQueryTablesGetIamPolicy extends AbstractGoogleBigQueryTool
{
    protected const NAME = 'google_bigquery_tables_get_iam_policy';
    protected const DESCRIPTION = 'Tables Get Iam Policy
