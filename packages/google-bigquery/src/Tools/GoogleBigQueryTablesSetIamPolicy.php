...
/**
 * Tables Set Iam Policy.
 *
 * Maps to the official BigQuery endpoint POST /{+resource}:setIamPolicy.
 */
class GoogleBigQueryTablesSetIamPolicy extends AbstractGoogleBigQueryTool
{
    protected const NAME = 'google_bigquery_tables_set_iam_policy';
    protected const DESCRIPTION = 'Tables Set Iam Policy
