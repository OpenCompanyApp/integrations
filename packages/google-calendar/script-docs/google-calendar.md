...
```ruby
events = app.call("integrations.google-calendar.events_list", calendar_id: "primary", time_min: "2026-05-01T00:00:00Z", single_events: true, order_by: "startTime")
created = app.call("integrations.google-calendar.events_insert", calendar_id: "primary", body: {summary: "Planning session", start: {dateTime: "2026-05-06T14:00:00Z"}, end: {dateTime: "2026-05-06T14:30:00Z"}})
```
