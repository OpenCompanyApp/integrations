 ...
 * Events Watch.
 *
 * Maps to the official Calendar endpoint POST /calendars/{calendarId}/events/watch.
 */
class GoogleCalendarEventsWatch extends AbstractGoogleCalendarTool
{
    protected const NAME = 'google_calendar_events_watch';
    protected const DESCRIPTION = 'Events Watch

Official Calendar endpoint: POST /calendars/{calendarId}/events/watch
Watch for changes to Events resources.';
  ...
  array (
    'type' => 'object',
    'required' => false,
    'description' => 'Query string parameters accepted by the official Calendar method. Known keys: updatedMin, sharedExtendedProperty, eventTypes, alwaysIncludeEmail, timeMax, orderBy, q, timeZone, privateExtendedProperty, syncToken, maxAttendees, showDeleted, timeMin, showHiddenInvitations, singleEvents, maxResults, pageToken, iCalUID.',
  ),
  'updatedMin' =>
  array (
    'type' => 'string',
  ...
  array (
    ...
    protected const PATH = '/calendars/{calendarId}/events/watch';
  ...
  6 => 'q',
  7 => 'timeZone',
  8 => 'privateExtendedProperty',
  9 => 'syncToken',
  10 => 'maxAttendees',
  11 => 'showDeleted',
  12 => 'timeMin',
  13 => 'showHiddenInvitations',
  14 => 'singleEvents',
  15 => 'maxResults',
  16 => 'pageToken',
  17 => 'iCalUID',
