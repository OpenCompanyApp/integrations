...
```ruby
spaces = app.call("integrations.google-chat.spaces_list", page_size: 10)
message = app.call("integrations.google-chat.spaces_messages_create", parent: "spaces/AAAAexample", body: {text: "Deployment complete"})
```
