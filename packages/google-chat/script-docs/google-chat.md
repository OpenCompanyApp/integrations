...
```js
var spaces = app.integrations.google_chat.google_chat_spaces_list({ pageSize: 10 })

var message = app.integrations.google_chat.google_chat_spaces_messages_create({
