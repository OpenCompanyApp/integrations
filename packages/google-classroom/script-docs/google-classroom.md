...
```ruby
courses = app.call("integrations.google-classroom.courses_list", page_size: 10, course_states: ["ACTIVE"])
course = app.call("integrations.google-classroom.courses_create", body: {name: "Agent Operations", section: "Spring", ownerId: "me", courseState: "PROVISIONED"})
submissions = app.call("integrations.google-classroom.courses_course_work_student_submissions_list", course_id: "course-123", course_work_id: "work-456", page_size: 20)
```
