...
/**
 * Courses Announcements Add On Attachments Create.
 *
 * Maps to the official Google Classroom endpoint POST /v1/courses/{courseId}/announcements/{itemId}/addOnAttachments.
 */
class GoogleClassroomCoursesAnnouncementsAddOnAttachmentsCreate extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_announcements_add_on_attachments_create';
    protected const DESCRIPTION = 'Courses Announcements Add On Attachments Create

Official Google Classroom endpoint: POST /v1/courses/{courseId}/announcements/{itemId}/addOnAttachments
