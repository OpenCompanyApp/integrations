...
/**
 * Courses Announcements Add On Attachments Delete.
 *
 * Maps to the official Google Classroom endpoint DELETE /v1/courses/{courseId}/announcements/{itemId}/addOnAttachments/{attachmentId}.
 */
class GoogleClassroomCoursesAnnouncementsAddOnAttachmentsDelete extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_announcements_add_on_attachments_delete';
    protected const DESCRIPTION = 'Courses Announcements Add On Attachments Delete

Official Google Classroom endpoint: DELETE /v1/courses/{courseId}/announcements/{itemId}/addOnAttachments/{attachmentId}
