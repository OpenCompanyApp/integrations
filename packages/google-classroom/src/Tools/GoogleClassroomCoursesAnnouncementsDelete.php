 ...
 *
 * Maps to the official Google Classroom endpoint DELETE /v1/courses/{courseId}/announcements/{id}.
 */
class GoogleClassroomCoursesAnnouncementsDelete extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_announcements_delete';
    protected const DESCRIPTION = 'Courses Announcements Delete

Official Google Classroom endpoint: DELETE /v1/courses/{courseId}/announcements/{id}
