...
/**
 * Courses Announcements Get Add On Context.
 *
 * Maps to the official Google Classroom endpoint GET /v1/courses/{courseId}/announcements/{itemId}/addOnContext.
 */
class GoogleClassroomCoursesAnnouncementsGetAddOnContext extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_announcements_get_add_on_context';
    protected const DESCRIPTION = 'Courses Announcements Get Add On Context

Official Google Classroom endpoint: GET /v1/courses/{courseId}/announcements/{itemId}/addOnContext
Gets metadata for Classroom add-ons in the context of a specific post.';
  ...
  array (
    ...
    protected const PATH = '/v1/courses/{courseId}/announcements/{itemId}/addOnContext';
