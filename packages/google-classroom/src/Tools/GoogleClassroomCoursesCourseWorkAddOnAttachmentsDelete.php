...
/**
 * Courses Course Work Add On Attachments Delete.
 *
 * Maps to the official Google Classroom endpoint DELETE /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}.
 */
class GoogleClassroomCoursesCourseWorkAddOnAttachmentsDelete extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_course_work_add_on_attachments_delete';
    protected const DESCRIPTION = 'Courses Course Work Add On Attachments Delete

Official Google Classroom endpoint: DELETE /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}
Deletes an add-on attachment.';
  ...
  array (
    ...
    protected const PATH = '/v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}';
