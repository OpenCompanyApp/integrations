...
/**
 * Courses Course Work Add On Attachments Get.
 *
 * Maps to the official Google Classroom endpoint GET /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}.
 */
class GoogleClassroomCoursesCourseWorkAddOnAttachmentsGet extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_course_work_add_on_attachments_get';
    protected const DESCRIPTION = 'Courses Course Work Add On Attachments Get

Official Google Classroom endpoint: GET /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}
