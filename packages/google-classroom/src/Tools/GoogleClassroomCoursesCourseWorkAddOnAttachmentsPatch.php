...
/**
 * Courses Course Work Add On Attachments Patch.
 *
 * Maps to the official Google Classroom endpoint PATCH /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}.
 */
class GoogleClassroomCoursesCourseWorkAddOnAttachmentsPatch extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_course_work_add_on_attachments_patch';
    protected const DESCRIPTION = 'Courses Course Work Add On Attachments Patch

Official Google Classroom endpoint: PATCH /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}
