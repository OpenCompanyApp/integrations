...
/**
 * Courses Course Work Add On Attachments Student Submissions Patch.
 *
 * Maps to the official Google Classroom endpoint PATCH /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}/studentSubmissions/{submissionId}.
 */
class GoogleClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_course_work_add_on_attachments_student_submissions_patch';
    protected const DESCRIPTION = 'Courses Course Work Add On Attachments Student Submissions Patch

Official Google Classroom endpoint: PATCH /v1/courses/{courseId}/courseWork/{itemId}/addOnAttachments/{attachmentId}/studentSubmissions/{submissionId}
