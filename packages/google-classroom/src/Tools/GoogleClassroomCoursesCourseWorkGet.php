...
/**
 * Courses Course Work Get.
 *
 * Maps to the official Google Classroom endpoint GET /v1/courses/{courseId}/courseWork/{id}.
 */
class GoogleClassroomCoursesCourseWorkGet extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_course_work_get';
    protected const DESCRIPTION = 'Courses Course Work Get

Official Google Classroom endpoint: GET /v1/courses/{courseId}/courseWork/{id}
Returns course work.';
