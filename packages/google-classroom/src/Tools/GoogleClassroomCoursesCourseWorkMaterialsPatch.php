...
/**
 * Courses Course Work Materials Patch.
 *
 * Maps to the official Google Classroom endpoint PATCH /v1/courses/{courseId}/courseWorkMaterials/{id}.
 */
class GoogleClassroomCoursesCourseWorkMaterialsPatch extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_course_work_materials_patch';
    protected const DESCRIPTION = 'Courses Course Work Materials Patch

Official Google Classroom endpoint: PATCH /v1/courses/{courseId}/courseWorkMaterials/{id}
