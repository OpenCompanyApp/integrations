...
/**
 * Courses Posts Add On Attachments Delete.
 *
 * Maps to the official Google Classroom endpoint DELETE /v1/courses/{courseId}/posts/{postId}/addOnAttachments/{attachmentId}.
 */
class GoogleClassroomCoursesPostsAddOnAttachmentsDelete extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_posts_add_on_attachments_delete';
    protected const DESCRIPTION = 'Courses Posts Add On Attachments Delete

Official Google Classroom endpoint: DELETE /v1/courses/{courseId}/posts/{postId}/addOnAttachments/{attachmentId}
