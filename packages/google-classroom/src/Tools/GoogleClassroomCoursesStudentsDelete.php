 ...
 *
 * Maps to the official Google Classroom endpoint DELETE /v1/courses/{courseId}/students/{userId}.
 */
class GoogleClassroomCoursesStudentsDelete extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_students_delete';
    protected const DESCRIPTION = 'Courses Students Delete

Official Google Classroom endpoint: DELETE /v1/courses/{courseId}/students/{userId}
