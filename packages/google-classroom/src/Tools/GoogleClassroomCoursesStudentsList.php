 ...
 *
 * Maps to the official Google Classroom endpoint GET /v1/courses/{courseId}/students.
 */
class GoogleClassroomCoursesStudentsList extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_students_list';
    protected const DESCRIPTION = 'Courses Students List

Official Google Classroom endpoint: GET /v1/courses/{courseId}/students
