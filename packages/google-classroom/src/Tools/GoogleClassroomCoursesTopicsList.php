 ...
 * Courses Topics List.
 *
 * Maps to the official Google Classroom endpoint GET /v1/courses/{courseId}/topics.
 */
class GoogleClassroomCoursesTopicsList extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_topics_list';
    protected const DESCRIPTION = 'Courses Topics List

Official Google Classroom endpoint: GET /v1/courses/{courseId}/topics
