 ...
 *
 * Maps to the official Google Classroom endpoint PATCH /v1/courses/{courseId}/topics/{id}.
 */
class GoogleClassroomCoursesTopicsPatch extends AbstractGoogleClassroomTool
{
    protected const NAME = 'google_classroom_courses_topics_patch';
    protected const DESCRIPTION = 'Courses Topics Patch

Official Google Classroom endpoint: PATCH /v1/courses/{courseId}/topics/{id}
