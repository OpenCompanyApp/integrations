# Google Cloud Run - Ruby API Reference
...
```ruby
services = app.call("integrations.google-cloud-run.projects_locations_services_list", parent: "projects/example-project/locations/us-central1", page_size: 20)
service = app.call("integrations.google-cloud-run.projects_locations_services_get", name: "projects/example-project/locations/us-central1/services/api")
run = app.call("integrations.google-cloud-run.projects_locations_jobs", name: "projects/example-project/locations/us-central1/jobs/importer", body: {})
```
## Multi-Account Usage

```ruby
app.call("integrations.google-cloud-run.projects_locations_services_list", parent: "projects/example/locations/us-central1")
app.call("integrations.google-cloud-run.default.projects_locations_services_list", parent: "projects/example/locations/us-central1")
app.call("integrations.google-cloud-run.production.projects_locations_services_list", parent: "projects/example/locations/us-central1")
```
## Builds
