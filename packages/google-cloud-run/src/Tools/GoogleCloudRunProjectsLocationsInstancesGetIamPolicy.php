...
/**
 * Projects Locations Instances Get Iam Policy.
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+resource}:getIamPolicy.
 */
class GoogleCloudRunProjectsLocationsInstancesGetIamPolicy extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_instances_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Instances Get Iam Policy
