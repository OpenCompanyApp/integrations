 ...
 */
class GoogleCloudRunProjectsLocationsInstancesPatch extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_instances_patch';
    protected const DESCRIPTION = 'Projects Locations Instances Patch
...
Updates an Instance.';
  ...
  array (
    'type' => 'object',
    'required' => false,
    'description' => 'Query string parameters accepted by the official Cloud Run method. Known keys: validateOnly, allowMissing, updateMask.',
  ),
  'validateOnly' =>
  array (
    'type' => 'string',
