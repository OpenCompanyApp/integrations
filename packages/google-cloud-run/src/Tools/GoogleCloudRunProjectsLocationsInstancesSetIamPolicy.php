...
/**
 * Projects Locations Instances Set Iam Policy.
 *
 * Maps to the official Cloud Run endpoint POST /v2/{+resource}:setIamPolicy.
 */
class GoogleCloudRunProjectsLocationsInstancesSetIamPolicy extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_instances_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Instances Set Iam Policy
