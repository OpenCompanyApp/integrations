 ...
 */
class GoogleCloudRunProjectsLocationsJobsExecutionsDelete extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_jobs_executions_delete';
    protected const DESCRIPTION = 'Projects Locations Jobs Executions Delete
