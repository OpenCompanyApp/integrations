 ...
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+parent}/executions.
 */
class GoogleCloudRunProjectsLocationsJobsExecutionsList extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_jobs_executions_list';
    protected const DESCRIPTION = 'Projects Locations Jobs Executions List

Official Cloud Run endpoint: GET /v2/{+parent}/executions
Lists Executions from a Job. Results are sorted by creation time, descending.';
  ...
  array (
    ...
    protected const PATH = '/v2/{+parent}/executions';
