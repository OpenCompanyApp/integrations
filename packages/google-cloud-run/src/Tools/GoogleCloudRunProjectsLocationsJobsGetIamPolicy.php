...
/**
 * Projects Locations Jobs Get Iam Policy.
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+resource}:getIamPolicy.
 */
class GoogleCloudRunProjectsLocationsJobsGetIamPolicy extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_jobs_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Jobs Get Iam Policy
