...
/**
 * Projects Locations Jobs Set Iam Policy.
 *
 * Maps to the official Cloud Run endpoint POST /v2/{+resource}:setIamPolicy.
 */
class GoogleCloudRunProjectsLocationsJobsSetIamPolicy extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_jobs_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Jobs Set Iam Policy
