 ...
 */
class GoogleCloudRunProjectsLocationsOperationsGet extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_operations_get';
