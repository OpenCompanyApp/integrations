...
/**
 * Projects Locations Services Get Iam Policy.
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+resource}:getIamPolicy.
 */
class GoogleCloudRunProjectsLocationsServicesGetIamPolicy extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_services_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Services Get Iam Policy
