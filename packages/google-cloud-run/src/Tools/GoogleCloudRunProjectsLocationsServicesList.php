 ...
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+parent}/services.
 */
class GoogleCloudRunProjectsLocationsServicesList extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_services_list';
    protected const DESCRIPTION = 'Projects Locations Services List

Official Cloud Run endpoint: GET /v2/{+parent}/services
