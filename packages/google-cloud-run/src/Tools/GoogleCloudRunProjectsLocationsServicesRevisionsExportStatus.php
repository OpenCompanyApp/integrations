...
/**
 * Projects Locations Services Revisions Export Status.
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+name}/{+operationId}:exportStatus.
 */
class GoogleCloudRunProjectsLocationsServicesRevisionsExportStatus extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_services_revisions_export_status';
    protected const DESCRIPTION = 'Projects Locations Services Revisions Export Status
