 ...
 */
class GoogleCloudRunProjectsLocationsServicesRevisionsGet extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_services_revisions_get';
    protected const DESCRIPTION = 'Projects Locations Services Revisions Get
