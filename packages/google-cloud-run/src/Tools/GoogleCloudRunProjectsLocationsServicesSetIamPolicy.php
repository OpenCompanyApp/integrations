...
/**
 * Projects Locations Services Set Iam Policy.
 *
 * Maps to the official Cloud Run endpoint POST /v2/{+resource}:setIamPolicy.
 */
class GoogleCloudRunProjectsLocationsServicesSetIamPolicy extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_services_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Services Set Iam Policy
