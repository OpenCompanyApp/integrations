...
/**
 * Projects Locations Services Test Iam Permissions.
 *
 * Maps to the official Cloud Run endpoint POST /v2/{+resource}:testIamPermissions.
 */
class GoogleCloudRunProjectsLocationsServicesTestIamPermissions extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_services_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Services Test Iam Permissions
