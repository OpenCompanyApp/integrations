...
/**
 * Projects Locations Worker Pools Get.
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+name}.
 */
class GoogleCloudRunProjectsLocationsWorkerPoolsGet extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_worker_pools_get';
    protected const DESCRIPTION = 'Projects Locations Worker Pools Get
