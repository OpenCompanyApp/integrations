...
/**
 * Projects Locations Worker Pools Revisions List.
 *
 * Maps to the official Cloud Run endpoint GET /v2/{+parent}/revisions.
 */
class GoogleCloudRunProjectsLocationsWorkerPoolsRevisionsList extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_worker_pools_revisions_list';
    protected const DESCRIPTION = 'Projects Locations Worker Pools Revisions List
