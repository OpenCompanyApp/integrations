...
/**
 * Projects Locations Worker Pools Test Iam Permissions.
 *
 * Maps to the official Cloud Run endpoint POST /v2/{+resource}:testIamPermissions.
 */
class GoogleCloudRunProjectsLocationsWorkerPoolsTestIamPermissions extends AbstractGoogleCloudRunTool
{
    protected const NAME = 'google_cloud_run_projects_locations_worker_pools_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Worker Pools Test Iam Permissions
