...
```js
var results = app.integrations.google_cloud_search.google_cloud_search_query_search({
  body: {
...
var sources = app.integrations.google_cloud_search.google_cloud_search_query_sources_list({})

var item = app.integrations.google_cloud_search.google_cloud_search_indexing_datasources_items_get({
