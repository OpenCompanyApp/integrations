...
```ruby
results = app.call("integrations.google-cloud-search.query", body: {query: "quarterly report", pageSize: 10})
sources = app.call("integrations.google-cloud-search.query_sources_list")
item = app.call("integrations.google-cloud-search.indexing_datasources_items_get", name: "datasources/source/items/item-id")
```
