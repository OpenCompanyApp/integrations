 ...
 */
class GoogleCloudSearchSettingsDatasourcesDelete extends AbstractGoogleCloudSearchTool
{
    protected const NAME = 'google_cloud_search_settings_datasources_delete';
    protected const DESCRIPTION = 'Settings Datasources Delete
