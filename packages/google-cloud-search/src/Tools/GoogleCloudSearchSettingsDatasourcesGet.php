 ...
 */
class GoogleCloudSearchSettingsDatasourcesGet extends AbstractGoogleCloudSearchTool
{
    protected const NAME = 'google_cloud_search_settings_datasources_get';
    protected const DESCRIPTION = 'Settings Datasources Get
