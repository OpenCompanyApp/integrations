 ...
 *
 * Maps to the official Google Cloud Search endpoint GET /v1/settings/{+name}.
 */
class GoogleCloudSearchSettingsSearchapplicationsGet extends AbstractGoogleCloudSearchTool
{
    protected const NAME = 'google_cloud_search_settings_searchapplications_get';
    protected const DESCRIPTION = 'Settings Searchapplications Get

Official Google Cloud Search endpoint: GET /v1/settings/{+name}
