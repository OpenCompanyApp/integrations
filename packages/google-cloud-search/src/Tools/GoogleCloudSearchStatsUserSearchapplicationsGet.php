 ...
 *
 * Maps to the official Google Cloud Search endpoint GET /v1/stats/user/{+name}.
 */
class GoogleCloudSearchStatsUserSearchapplicationsGet extends AbstractGoogleCloudSearchTool
{
    protected const NAME = 'google_cloud_search_stats_user_searchapplications_get';
    protected const DESCRIPTION = 'Stats User Searchapplications Get

Official Google Cloud Search endpoint: GET /v1/stats/user/{+name}
Get the users statistics for search application.';
  ...
  array (
    ...
    protected const PATH = '/v1/stats/user/{+name}';
