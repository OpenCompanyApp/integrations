# Google Cloud Storage - Lua API Reference
...
```lua
local buckets = app.integrations.google_cloud_storage.google_cloud_storage_buckets_list({
  project = "example-project",
  maxResults = 50
})

local objects = app.integrations.google_cloud_storage.google_cloud_storage_objects_list({
  bucket = "example-bucket",
  prefix = "logs/"
})

local uploaded = app.integrations.google_cloud_storage.google_cloud_storage_objects_insert({
  bucket = "example-bucket",
  name = "hello.txt",
