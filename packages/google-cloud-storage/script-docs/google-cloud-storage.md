# Google Cloud Storage - Ruby API Reference
...
```ruby
buckets = app.call("integrations.google-cloud-storage.buckets_list", project: "example-project", max_results: 50)
objects = app.call("integrations.google-cloud-storage.objects_list", bucket: "example-bucket", prefix: "logs/")
uploaded = app.call("integrations.google-cloud-storage.objects_insert", bucket: "example-bucket", name: "hello.txt", body: {content: "hello", content_type: "text/plain"})
```
## Multi-Account Usage

```ruby
app.call("integrations.google-cloud-storage.buckets_list", project: "example-project")
app.call("integrations.google-cloud-storage.default.buckets_list", project: "example-project")
app.call("integrations.google-cloud-storage.production.buckets_list", project: "example-project")
```
## Anywhere Caches
