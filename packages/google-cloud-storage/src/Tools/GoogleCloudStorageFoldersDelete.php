 ...
 * Folders Delete.
 *
 * Maps to the official Cloud Storage endpoint DELETE /b/{bucket}/folders/{folder}.
 */
class GoogleCloudStorageFoldersDelete extends AbstractGoogleCloudStorageTool
{
    protected const NAME = 'google_cloud_storage_folders_delete';
    protected const DESCRIPTION = 'Folders Delete

Official Cloud Storage endpoint: DELETE /b/{bucket}/folders/{folder}
