...
/**
 * Managed Folders Get Iam Policy.
 *
 * Maps to the official Cloud Storage endpoint GET /b/{bucket}/managedFolders/{managedFolder}/iam.
 */
class GoogleCloudStorageManagedFoldersGetIamPolicy extends AbstractGoogleCloudStorageTool
{
    protected const NAME = 'google_cloud_storage_managed_folders_get_iam_policy';
    protected const DESCRIPTION = 'Managed Folders Get Iam Policy

Official Cloud Storage endpoint: GET /b/{bucket}/managedFolders/{managedFolder}/iam
