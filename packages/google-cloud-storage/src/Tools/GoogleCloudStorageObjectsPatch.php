 ...
 * Objects Patch.
 *
 * Maps to the official Cloud Storage endpoint PATCH /b/{bucket}/o/{object}.
 */
class GoogleCloudStorageObjectsPatch extends AbstractGoogleCloudStorageTool
{
    protected const NAME = 'google_cloud_storage_objects_patch';
    protected const DESCRIPTION = 'Objects Patch

Official Cloud Storage endpoint: PATCH /b/{bucket}/o/{object}
