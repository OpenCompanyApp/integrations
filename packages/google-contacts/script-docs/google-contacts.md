...
```ruby
groups = app.call("integrations.google-contacts.groups_list", page_size: 10)
contacts = app.call("integrations.google-contacts.people_connections_list", resource_name: "people/me", person_fields: "names,emailAddresses,phoneNumbers")
```
