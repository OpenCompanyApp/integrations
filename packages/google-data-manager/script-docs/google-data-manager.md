...
```ruby
app.call("integrations.google-data-manager.ingest_events", confirm_execute: true, destinations: [{operatingAccount: {product: "GOOGLE_ADS", accountId: "1234567890"}}], consent: {adUserData: "GRANTED", adPersonalization: "GRANTED"}, events: [{eventTimestamp: "2026-06-01T10:00:00Z", transactionId: "order-example-1", currencyCode: "USD", conversionValue: 125.5}])
```
