...
```js
var doc = app.integrations.google_docs.google_docs_documents_get({ documentId: "1AbC..." })

var result = app.integrations.google_docs.google_docs_documents_batch_update({
  documentId: "1AbC...",
