...
```ruby
doc = app.call("integrations.google-docs.documents_get", document_id: "1AbC...")
result = app.call("integrations.google-docs.documents_batch_update", document_id: "1AbC...", body: {requests: [{insertText: {location: {index: 1}, text: "Hello"}}]})
```
