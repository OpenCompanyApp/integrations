...
```ruby
activity = app.call("integrations.google-drive-activity.query", item_name: "items/file-id", page_size: 10, filter: "time >= \"2026-01-01T00:00:00Z\"", consolidation_strategy: {legacy: {}})
```
