...
```js
var form = app.integrations.google_forms.google_forms_forms_get({ formId: "1FAIpQL..." })

var responses = app.integrations.google_forms.google_forms_forms_responses_list({ formId: "1FAIpQL...", pageSize: 10 })
```
