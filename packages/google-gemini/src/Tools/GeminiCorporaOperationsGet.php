...
/**
 * Corpora Operations Get.
 *
 * Maps to the official Gemini endpoint GET /v1beta/{+name}.
 */
class GeminiCorporaOperationsGet extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_corpora_operations_get';
    protected const DESCRIPTION = 'Corpora Operations Get
