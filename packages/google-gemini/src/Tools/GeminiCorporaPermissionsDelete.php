...
/**
 * Corpora Permissions Delete.
 *
 * Maps to the official Gemini endpoint DELETE /v1beta/{+name}.
 */
class GeminiCorporaPermissionsDelete extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_corpora_permissions_delete';
    protected const DESCRIPTION = 'Corpora Permissions Delete
