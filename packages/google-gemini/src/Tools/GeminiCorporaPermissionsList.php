...
/**
 * Corpora Permissions List.
 *
 * Maps to the official Gemini endpoint GET /v1beta/{+parent}/permissions.
 */
class GeminiCorporaPermissionsList extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_corpora_permissions_list';
    protected const DESCRIPTION = 'Corpora Permissions List
