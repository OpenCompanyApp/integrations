...
/**
 * Corpora Permissions Patch.
 *
 * Maps to the official Gemini endpoint PATCH /v1beta/{+name}.
 */
class GeminiCorporaPermissionsPatch extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_corpora_permissions_patch';
    protected const DESCRIPTION = 'Corpora Permissions Patch
