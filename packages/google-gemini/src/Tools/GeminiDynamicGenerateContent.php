 ...
 */
class GeminiDynamicGenerateContent extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_dynamic_generate_content';
    protected const DESCRIPTION = 'Dynamic Generate Content
