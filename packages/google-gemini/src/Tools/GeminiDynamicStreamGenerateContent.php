 ...
 */
class GeminiDynamicStreamGenerateContent extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_dynamic_stream_generate_content';
    protected const DESCRIPTION = 'Dynamic Stream Generate Content
