...
/**
 * File Search Stores Documents Get.
 *
 * Maps to the official Gemini endpoint GET /v1beta/{+name}.
 */
class GeminiFileSearchStoresDocumentsGet extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_file_search_stores_documents_get';
    protected const DESCRIPTION = 'File Search Stores Documents Get
