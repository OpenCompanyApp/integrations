...
class GeminiListModels implements Tool
{
    ...
    {
        return 'gemini_list_models';
    }

    public function description(): string
    {
        return 'List available Gemini AI models. Returns model names, display names, supported generation methods, and other metadata.';
    }

    public function parameters(): array
    {
        return [
            'pageSize' => ['type' => 'integer', 'description' => 'Maximum number of models to return per page (default: 50, max: 100).'],
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listModels($pageSize, $pageToken);
