 ...
 */
class GeminiModelsGenerateContent extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_models_generate_content';
    protected const DESCRIPTION = 'Models Generate Content
