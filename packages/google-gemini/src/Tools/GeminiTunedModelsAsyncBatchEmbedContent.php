 ...
 */
class GeminiTunedModelsAsyncBatchEmbedContent extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_async_batch_embed_content';
    protected const DESCRIPTION = 'Tuned Models Async Batch Embed Content
