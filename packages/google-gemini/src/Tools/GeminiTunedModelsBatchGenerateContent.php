 ...
 */
class GeminiTunedModelsBatchGenerateContent extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_batch_generate_content';
    protected const DESCRIPTION = 'Tuned Models Batch Generate Content
