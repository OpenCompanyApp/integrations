...
/**
 * Tuned Models Operations Get.
 *
 * Maps to the official Gemini endpoint GET /v1beta/{+name}.
 */
class GeminiTunedModelsOperationsGet extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_operations_get';
    protected const DESCRIPTION = 'Tuned Models Operations Get
