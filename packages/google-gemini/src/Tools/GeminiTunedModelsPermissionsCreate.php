...
/**
 * Tuned Models Permissions Create.
 *
 * Maps to the official Gemini endpoint POST /v1beta/{+parent}/permissions.
 */
class GeminiTunedModelsPermissionsCreate extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_permissions_create';
    protected const DESCRIPTION = 'Tuned Models Permissions Create
