...
/**
 * Tuned Models Permissions Delete.
 *
 * Maps to the official Gemini endpoint DELETE /v1beta/{+name}.
 */
class GeminiTunedModelsPermissionsDelete extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_permissions_delete';
    protected const DESCRIPTION = 'Tuned Models Permissions Delete
