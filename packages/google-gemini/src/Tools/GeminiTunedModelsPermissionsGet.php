...
/**
 * Tuned Models Permissions Get.
 *
 * Maps to the official Gemini endpoint GET /v1beta/{+name}.
 */
class GeminiTunedModelsPermissionsGet extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_permissions_get';
    protected const DESCRIPTION = 'Tuned Models Permissions Get
