 ...
 */
class GeminiTunedModelsStreamGenerateContent extends AbstractGeminiTool
{
    protected const NAME = 'google_gemini_tuned_models_stream_generate_content';
    protected const DESCRIPTION = 'Tuned Models Stream Generate Content
