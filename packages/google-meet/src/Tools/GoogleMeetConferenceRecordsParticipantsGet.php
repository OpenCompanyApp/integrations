...
/**
 * Conference Records Participants Get.
 *
 * Maps to the official Google Meet endpoint GET /v2/{+name}.
 */
class GoogleMeetConferenceRecordsParticipantsGet extends AbstractGoogleMeetTool
{
    protected const NAME = 'google_meet_conference_records_participants_get';
    protected const DESCRIPTION = 'Conference Records Participants Get
