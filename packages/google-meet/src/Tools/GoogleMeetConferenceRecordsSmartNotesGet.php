...
/**
 * Conference Records Smart Notes Get.
 *
 * Maps to the official Google Meet endpoint GET /v2/{+name}.
 */
class GoogleMeetConferenceRecordsSmartNotesGet extends AbstractGoogleMeetTool
{
    protected const NAME = 'google_meet_conference_records_smart_notes_get';
    protected const DESCRIPTION = 'Conference Records Smart Notes Get
