...
/**
 * Conference Records Smart Notes List.
 *
 * Maps to the official Google Meet endpoint GET /v2/{+parent}/smartNotes.
 */
class GoogleMeetConferenceRecordsSmartNotesList extends AbstractGoogleMeetTool
{
    protected const NAME = 'google_meet_conference_records_smart_notes_list';
    protected const DESCRIPTION = 'Conference Records Smart Notes List

Official Google Meet endpoint: GET /v2/{+parent}/smartNotes
Lists the set of smart notes from the conference record.';
  ...
  array (
    ...
    protected const PATH = '/v2/{+parent}/smartNotes';
