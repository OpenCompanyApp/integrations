...
/**
 * Conference Records Transcripts Get.
 *
 * Maps to the official Google Meet endpoint GET /v2/{+name}.
 */
class GoogleMeetConferenceRecordsTranscriptsGet extends AbstractGoogleMeetTool
{
    protected const NAME = 'google_meet_conference_records_transcripts_get';
    protected const DESCRIPTION = 'Conference Records Transcripts Get
