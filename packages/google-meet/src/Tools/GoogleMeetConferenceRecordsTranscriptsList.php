...
/**
 * Conference Records Transcripts List.
 *
 * Maps to the official Google Meet endpoint GET /v2/{+parent}/transcripts.
 */
class GoogleMeetConferenceRecordsTranscriptsList extends AbstractGoogleMeetTool
{
    protected const NAME = 'google_meet_conference_records_transcripts_list';
    protected const DESCRIPTION = 'Conference Records Transcripts List

Official Google Meet endpoint: GET /v2/{+parent}/transcripts
Lists the set of transcripts from the conference record.';
  ...
  array (
    ...
    protected const PATH = '/v2/{+parent}/transcripts';
