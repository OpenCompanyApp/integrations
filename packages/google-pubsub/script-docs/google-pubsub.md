# Google Pub/Sub - Ruby API Reference
...
```ruby
topics = app.call("integrations.google-pubsub.projects_topics_list", project: "projects/example-project", page_size: 50)
published = app.call("integrations.google-pubsub.projects_topics_publish", topic: "projects/example-project/topics/events", body: {messages: [{data: "aGVsbG8="}]})
pulled = app.call("integrations.google-pubsub.projects_subscriptions_pull", subscription: "projects/example-project/subscriptions/worker", body: {maxMessages: 10})
```
## Multi-Account Usage

```ruby
app.call("integrations.google-pubsub.projects_topics_list", project: "projects/example-project")
app.call("integrations.google-pubsub.default.projects_topics_list", project: "projects/example-project")
app.call("integrations.google-pubsub.production.projects_topics_list", project: "projects/example-project")
```
## Schemas
