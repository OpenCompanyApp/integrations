# Google Pub/Sub - JavaScript API Reference
...
```js
var topics = app.integrations.google_pubsub.google_pubsub_projects_topics_list({
  project: "projects/example-project",
  pageSize: 50,
})

var published = app.integrations.google_pubsub.google_pubsub_projects_topics_publish({
  topic: "projects/example-project/topics/events",
  body: { messages: [ { data: "aGVsbG8=" } ] },
})

var pulled = app.integrations.google_pubsub.google_pubsub_projects_subscriptions_pull({
