...
/**
 * Projects Schemas Get Iam Policy.
 *
 * Maps to the official Pub/Sub endpoint GET /v1/{+resource}:getIamPolicy.
 */
class GooglePubSubProjectsSchemasGetIamPolicy extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_schemas_get_iam_policy';
    protected const DESCRIPTION = 'Projects Schemas Get Iam Policy
