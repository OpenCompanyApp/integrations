...
/**
 * Projects Schemas Set Iam Policy.
 *
 * Maps to the official Pub/Sub endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GooglePubSubProjectsSchemasSetIamPolicy extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_schemas_set_iam_policy';
    protected const DESCRIPTION = 'Projects Schemas Set Iam Policy
