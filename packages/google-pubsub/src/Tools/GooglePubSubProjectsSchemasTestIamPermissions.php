...
/**
 * Projects Schemas Test Iam Permissions.
 *
 * Maps to the official Pub/Sub endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GooglePubSubProjectsSchemasTestIamPermissions extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_schemas_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Schemas Test Iam Permissions
