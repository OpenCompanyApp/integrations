...
/**
 * Projects Snapshots Get Iam Policy.
 *
 * Maps to the official Pub/Sub endpoint GET /v1/{+resource}:getIamPolicy.
 */
class GooglePubSubProjectsSnapshotsGetIamPolicy extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_snapshots_get_iam_policy';
    protected const DESCRIPTION = 'Projects Snapshots Get Iam Policy
