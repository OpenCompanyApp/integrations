...
/**
 * Projects Snapshots Set Iam Policy.
 *
 * Maps to the official Pub/Sub endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GooglePubSubProjectsSnapshotsSetIamPolicy extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_snapshots_set_iam_policy';
    protected const DESCRIPTION = 'Projects Snapshots Set Iam Policy
