...
/**
 * Projects Snapshots Test Iam Permissions.
 *
 * Maps to the official Pub/Sub endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GooglePubSubProjectsSnapshotsTestIamPermissions extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_snapshots_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Snapshots Test Iam Permissions
