...
/**
 * Projects Subscriptions Set Iam Policy.
 *
 * Maps to the official Pub/Sub endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GooglePubSubProjectsSubscriptionsSetIamPolicy extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_subscriptions_set_iam_policy';
    protected const DESCRIPTION = 'Projects Subscriptions Set Iam Policy
