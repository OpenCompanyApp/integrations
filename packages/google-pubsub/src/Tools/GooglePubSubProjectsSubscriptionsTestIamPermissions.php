...
/**
 * Projects Subscriptions Test Iam Permissions.
 *
 * Maps to the official Pub/Sub endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GooglePubSubProjectsSubscriptionsTestIamPermissions extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_subscriptions_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Subscriptions Test Iam Permissions
