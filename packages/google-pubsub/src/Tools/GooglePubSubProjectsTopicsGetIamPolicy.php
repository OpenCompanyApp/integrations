...
/**
 * Projects Topics Get Iam Policy.
 *
 * Maps to the official Pub/Sub endpoint GET /v1/{+resource}:getIamPolicy.
 */
class GooglePubSubProjectsTopicsGetIamPolicy extends AbstractGooglePubSubTool
{
    protected const NAME = 'google_pubsub_projects_topics_get_iam_policy';
    protected const DESCRIPTION = 'Projects Topics Get Iam Policy
