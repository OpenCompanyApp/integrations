...
```ruby
sites = app.call("integrations.google-search-console.sites_list")
rows = app.call("integrations.google-search-console.searchanalytics_query", site_url: "https://example.com/", body: {startDate: "2026-05-01", endDate: "2026-05-06", dimensions: ["query"]})
```
