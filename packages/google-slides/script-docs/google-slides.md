...
```ruby
deck = app.call("integrations.google-slides.presentations_get", presentation_id: "1AbC...")
result = app.call("integrations.google-slides.presentations_batch_update", presentation_id: "1AbC...", body: {requests: [{createSlide: {}}]})
```
