...
```ruby
lists = app.call("integrations.google-tasks.tasklists_list", max_results: 10)
task = app.call("integrations.google-tasks.insert", tasklist: "MDM4NzA1...", body: {title: "Follow up", notes: "Send recap email"})
```
