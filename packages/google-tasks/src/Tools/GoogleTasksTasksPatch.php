 ...
 * Tasks Patch.
 *
 * Maps to the official Google Tasks endpoint PATCH /tasks/v1/lists/{tasklist}/tasks/{task}.
 */
class GoogleTasksTasksPatch extends AbstractGoogleTasksTool
{
    protected const NAME = 'google_tasks_tasks_patch';
    protected const DESCRIPTION = 'Tasks Patch

Official Google Tasks endpoint: PATCH /tasks/v1/lists/{tasklist}/tasks/{task}
