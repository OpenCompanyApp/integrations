...
```ruby
translated = app.call("integrations.google-translate.projects_text", parent: "projects/example-project", body: {contents: ["Hello"], targetLanguageCode: "es"})
languages = app.call("integrations.google-translate.projects_locations_get_supported_languages", parent: "projects/example-project/locations/global")
```
