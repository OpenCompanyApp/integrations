...
```js
var translated = app.integrations.google_translate.google_translate_projects_translate_text({
  parent: "projects/example-project",
  body: { contents: [ "Hello" ], targetLanguageCode: "es" },
})

var languages = app.integrations.google_translate.google_translate_projects_locations_get_supported_languages({
