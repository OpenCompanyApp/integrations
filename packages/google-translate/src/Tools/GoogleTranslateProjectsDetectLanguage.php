...
/**
 * Projects Detect Language.
 *
 * Maps to the official Cloud Translation endpoint POST /v3/{+parent}:detectLanguage.
 */
class GoogleTranslateProjectsDetectLanguage extends AbstractGoogleTranslateTool
{
    protected const NAME = 'google_translate_projects_detect_language';
    protected const DESCRIPTION = 'Projects Detect Language
