...
/**
 * Projects Locations Adaptive Mt Datasets Adaptive Mt Files Adaptive Mt Sentences List.
 *
 * Maps to the official Cloud Translation endpoint GET /v3/{+parent}/adaptiveMtSentences.
 */
class GoogleTranslateProjectsLocationsAdaptiveMtDatasetsAdaptiveMtFilesAdaptiveMtSentencesList extends AbstractGoogleTranslateTool
{
    protected const NAME = 'google_translate_projects_locations_adaptive_mt_datasets_adaptive_mt_files_adaptive_mt_sentences_list';
    protected const DESCRIPTION = 'Projects Locations Adaptive Mt Datasets Adaptive Mt Files Adaptive Mt Sentences List
