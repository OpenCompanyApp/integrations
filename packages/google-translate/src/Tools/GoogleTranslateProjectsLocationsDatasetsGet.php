 ...
 */
class GoogleTranslateProjectsLocationsDatasetsGet extends AbstractGoogleTranslateTool
{
    protected const NAME = 'google_translate_projects_locations_datasets_get';
    protected const DESCRIPTION = 'Projects Locations Datasets Get
