...
/**
 * Projects Locations Get Supported Languages.
 *
 * Maps to the official Cloud Translation endpoint GET /v3/{+parent}/supportedLanguages.
 */
class GoogleTranslateProjectsLocationsGetSupportedLanguages extends AbstractGoogleTranslateTool
{
    protected const NAME = 'google_translate_projects_locations_get_supported_languages';
    protected const DESCRIPTION = 'Projects Locations Get Supported Languages
...
Returns a list of supported languages for translation.';
  ...
  array (
    'type' => 'object',
    'required' => false,
    'description' => 'Query string parameters accepted by the official Cloud Translation method. Known keys: displayLanguageCode, model.',
  ),
  'displayLanguageCode' =>
  array (
    'type' => 'string',
