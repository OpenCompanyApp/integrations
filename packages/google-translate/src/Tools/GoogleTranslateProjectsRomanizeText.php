...
/**
 * Projects Romanize Text.
 *
 * Maps to the official Cloud Translation endpoint POST /v3/{+parent}:romanizeText.
 */
class GoogleTranslateProjectsRomanizeText extends AbstractGoogleTranslateTool
{
    protected const NAME = 'google_translate_projects_romanize_text';
    protected const DESCRIPTION = 'Projects Romanize Text
