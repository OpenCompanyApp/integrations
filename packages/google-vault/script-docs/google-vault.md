...
```js
var matters = app.integrations.google_vault.google_vault_matters_list({
  pageSize: 10,
  view: "BASIC",
})

var matter = app.integrations.google_vault.google_vault_matters_create({
  body: {
    name: "Example matter",
...
var exports = app.integrations.google_vault.google_vault_matters_exports_list({
  matterId: "matter-123",
  pageSize: 10,
})
```
