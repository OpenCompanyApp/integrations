...
```ruby
matters = app.call("integrations.google-vault.matters_list", page_size: 10, view: "BASIC")
matter = app.call("integrations.google-vault.matters_create", body: {name: "Example matter", description: "Created by an agent"})
exports = app.call("integrations.google-vault.matters_exports_list", matter_id: "matter-123", page_size: 10)
```
