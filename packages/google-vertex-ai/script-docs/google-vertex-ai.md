# Google Vertex AI - Ruby API Reference
...
```ruby
models = app.call("integrations.google-vertex-ai.projects_locations_models_list", parent: "projects/example-project/locations/us-central1", page_size: 20)
prediction = app.call("integrations.google-vertex-ai.projects_locations_endpoints_predict", endpoint: "projects/example-project/locations/us-central1/endpoints/123", body: {instances: [{text: "hello"}]})
generated = app.call("integrations.google-vertex-ai.projects_locations_publishers_models_generate_content", model: "projects/example-project/locations/us-central1/publishers/google/models/gemini-1.5-pro", body: {contents: [{role: "user", parts: [{text: "hello"}]}]})
```
## Multi-Account Usage

```ruby
app.call("integrations.google-vertex-ai.projects_locations_models_list", parent: "projects/example/locations/us-central1")
app.call("integrations.google-vertex-ai.default.projects_locations_models_list", parent: "projects/example/locations/us-central1")
app.call("integrations.google-vertex-ai.production.projects_locations_models_list", parent: "projects/example/locations/us-central1")
```
## Annotations
