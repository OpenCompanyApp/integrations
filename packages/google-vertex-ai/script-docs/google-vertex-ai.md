# Google Vertex AI - JavaScript API Reference
...
```js
var models = app.integrations.google_vertex_ai.google_vertex_ai_projects_locations_models_list({
  parent: "projects/example-project/locations/us-central1",
  pageSize: 20,
})

var prediction = app.integrations.google_vertex_ai.google_vertex_ai_projects_locations_endpoints_predict({
  endpoint: "projects/example-project/locations/us-central1/endpoints/123",
  body: { instances: [ { text: "hello" } ] },
})

var generated = app.integrations.google_vertex_ai.google_vertex_ai_projects_locations_publishers_models_generate_content({
