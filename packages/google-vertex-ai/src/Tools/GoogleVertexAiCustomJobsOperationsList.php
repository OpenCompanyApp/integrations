...
/**
 * Custom Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiCustomJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_custom_jobs_operations_list';
    protected const DESCRIPTION = 'Custom Jobs Operations List
