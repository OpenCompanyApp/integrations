...
/**
 * Custom Jobs Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiCustomJobsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_custom_jobs_operations_wait';
    protected const DESCRIPTION = 'Custom Jobs Operations Wait
