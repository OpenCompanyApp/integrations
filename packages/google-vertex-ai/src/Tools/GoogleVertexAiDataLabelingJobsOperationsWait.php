...
/**
 * Data Labeling Jobs Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiDataLabelingJobsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_data_labeling_jobs_operations_wait';
    protected const DESCRIPTION = 'Data Labeling Jobs Operations Wait
