...
/**
 * Datasets Data Items Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiDatasetsDataItemsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_data_items_operations_list';
    protected const DESCRIPTION = 'Datasets Data Items Operations List
