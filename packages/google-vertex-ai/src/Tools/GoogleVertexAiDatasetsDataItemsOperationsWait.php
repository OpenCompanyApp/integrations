...
/**
 * Datasets Data Items Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiDatasetsDataItemsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_data_items_operations_wait';
    protected const DESCRIPTION = 'Datasets Data Items Operations Wait
