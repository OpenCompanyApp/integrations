...
/**
 * Datasets Dataset Versions Get.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}.
 */
class GoogleVertexAiDatasetsDatasetVersionsGet extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_dataset_versions_get';
    protected const DESCRIPTION = 'Datasets Dataset Versions Get
