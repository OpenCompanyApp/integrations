...
/**
 * Datasets Dataset Versions Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiDatasetsDatasetVersionsPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_dataset_versions_patch';
    protected const DESCRIPTION = 'Datasets Dataset Versions Patch
