...
/**
 * Datasets Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiDatasetsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_operations_wait';
    protected const DESCRIPTION = 'Datasets Operations Wait
