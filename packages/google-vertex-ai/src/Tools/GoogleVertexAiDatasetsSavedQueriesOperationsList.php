...
/**
 * Datasets Saved Queries Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiDatasetsSavedQueriesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_saved_queries_operations_list';
    protected const DESCRIPTION = 'Datasets Saved Queries Operations List
