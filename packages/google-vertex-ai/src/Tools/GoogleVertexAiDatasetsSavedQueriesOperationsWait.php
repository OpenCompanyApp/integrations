...
/**
 * Datasets Saved Queries Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiDatasetsSavedQueriesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_datasets_saved_queries_operations_wait';
    protected const DESCRIPTION = 'Datasets Saved Queries Operations Wait
