...
/**
 * Deployment Resource Pools Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiDeploymentResourcePoolsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_deployment_resource_pools_operations_list';
    protected const DESCRIPTION = 'Deployment Resource Pools Operations List
