...
/**
 * Endpoints Compute Tokens.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:computeTokens.
 */
class GoogleVertexAiEndpointsComputeTokens extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_compute_tokens';
    protected const DESCRIPTION = 'Endpoints Compute Tokens
