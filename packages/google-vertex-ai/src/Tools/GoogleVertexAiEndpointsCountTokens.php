...
/**
 * Endpoints Count Tokens.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:countTokens.
 */
class GoogleVertexAiEndpointsCountTokens extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_count_tokens';
    protected const DESCRIPTION = 'Endpoints Count Tokens
