...
/**
 * Endpoints Fetch Predict Operation.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:fetchPredictOperation.
 */
class GoogleVertexAiEndpointsFetchPredictOperation extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_fetch_predict_operation';
    protected const DESCRIPTION = 'Endpoints Fetch Predict Operation
