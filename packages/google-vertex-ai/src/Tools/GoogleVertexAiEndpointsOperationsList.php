 ...
 */
class GoogleVertexAiEndpointsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_operations_list';
    protected const DESCRIPTION = 'Endpoints Operations List
