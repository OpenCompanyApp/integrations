 ...
 */
class GoogleVertexAiEndpointsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_operations_wait';
    protected const DESCRIPTION = 'Endpoints Operations Wait
