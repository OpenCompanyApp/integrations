 ...
 */
class GoogleVertexAiEndpointsPredict extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_predict';
    protected const DESCRIPTION = 'Endpoints Predict
