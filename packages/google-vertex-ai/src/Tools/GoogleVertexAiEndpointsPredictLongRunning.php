...
/**
 * Endpoints Predict Long Running.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:predictLongRunning.
 */
class GoogleVertexAiEndpointsPredictLongRunning extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_predict_long_running';
    protected const DESCRIPTION = 'Endpoints Predict Long Running
