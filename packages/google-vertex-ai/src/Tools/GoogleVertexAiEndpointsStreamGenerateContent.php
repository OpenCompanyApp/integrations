...
/**
 * Endpoints Stream Generate Content.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+model}:streamGenerateContent.
 */
class GoogleVertexAiEndpointsStreamGenerateContent extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_endpoints_stream_generate_content';
    protected const DESCRIPTION = 'Endpoints Stream Generate Content
