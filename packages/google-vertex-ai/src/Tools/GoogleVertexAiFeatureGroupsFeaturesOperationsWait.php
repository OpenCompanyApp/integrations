...
/**
 * Feature Groups Features Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiFeatureGroupsFeaturesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_feature_groups_features_operations_wait';
    protected const DESCRIPTION = 'Feature Groups Features Operations Wait
