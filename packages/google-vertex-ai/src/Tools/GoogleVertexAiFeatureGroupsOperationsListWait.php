...
/**
 * Feature Groups Operations List Wait.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}:wait.
 */
class GoogleVertexAiFeatureGroupsOperationsListWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_feature_groups_operations_list_wait';
    protected const DESCRIPTION = 'Feature Groups Operations List Wait
