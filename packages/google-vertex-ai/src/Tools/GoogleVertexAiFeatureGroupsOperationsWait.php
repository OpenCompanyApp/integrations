...
/**
 * Feature Groups Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiFeatureGroupsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_feature_groups_operations_wait';
    protected const DESCRIPTION = 'Feature Groups Operations Wait
