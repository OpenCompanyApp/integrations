...
/**
 * Feature Online Stores Feature Views Operations List Wait.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}:wait.
 */
class GoogleVertexAiFeatureOnlineStoresFeatureViewsOperationsListWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_feature_online_stores_feature_views_operations_list_wait';
    protected const DESCRIPTION = 'Feature Online Stores Feature Views Operations List Wait
