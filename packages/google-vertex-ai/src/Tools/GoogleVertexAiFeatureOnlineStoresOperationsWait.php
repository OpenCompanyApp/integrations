...
/**
 * Feature Online Stores Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiFeatureOnlineStoresOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_feature_online_stores_operations_wait';
    protected const DESCRIPTION = 'Feature Online Stores Operations Wait
