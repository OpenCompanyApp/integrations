...
/**
 * Featurestores Entity Types Features Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiFeaturestoresEntityTypesFeaturesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_featurestores_entity_types_features_operations_list';
    protected const DESCRIPTION = 'Featurestores Entity Types Features Operations List
