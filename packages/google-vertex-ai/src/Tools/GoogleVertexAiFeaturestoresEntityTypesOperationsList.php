...
/**
 * Featurestores Entity Types Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiFeaturestoresEntityTypesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_featurestores_entity_types_operations_list';
    protected const DESCRIPTION = 'Featurestores Entity Types Operations List
