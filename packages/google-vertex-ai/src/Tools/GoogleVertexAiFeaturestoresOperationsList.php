...
/**
 * Featurestores Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiFeaturestoresOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_featurestores_operations_list';
    protected const DESCRIPTION = 'Featurestores Operations List
