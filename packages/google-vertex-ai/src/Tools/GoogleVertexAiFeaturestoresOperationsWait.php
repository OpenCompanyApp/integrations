...
/**
 * Featurestores Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiFeaturestoresOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_featurestores_operations_wait';
    protected const DESCRIPTION = 'Featurestores Operations Wait
