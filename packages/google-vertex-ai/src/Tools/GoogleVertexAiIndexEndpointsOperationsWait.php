...
/**
 * Index Endpoints Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiIndexEndpointsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_index_endpoints_operations_wait';
    protected const DESCRIPTION = 'Index Endpoints Operations Wait
