...
/**
 * Indexes Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiIndexesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_indexes_operations_list';
    protected const DESCRIPTION = 'Indexes Operations List
