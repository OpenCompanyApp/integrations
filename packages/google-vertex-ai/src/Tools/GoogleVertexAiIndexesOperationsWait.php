...
/**
 * Indexes Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiIndexesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_indexes_operations_wait';
    protected const DESCRIPTION = 'Indexes Operations Wait
