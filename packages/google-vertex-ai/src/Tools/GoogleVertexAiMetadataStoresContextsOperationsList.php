...
/**
 * Metadata Stores Contexts Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiMetadataStoresContextsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_metadata_stores_contexts_operations_list';
    protected const DESCRIPTION = 'Metadata Stores Contexts Operations List
