...
/**
 * Metadata Stores Contexts Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiMetadataStoresContextsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_metadata_stores_contexts_operations_wait';
    protected const DESCRIPTION = 'Metadata Stores Contexts Operations Wait
