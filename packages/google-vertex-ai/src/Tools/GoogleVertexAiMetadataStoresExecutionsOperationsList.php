...
/**
 * Metadata Stores Executions Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiMetadataStoresExecutionsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_metadata_stores_executions_operations_list';
    protected const DESCRIPTION = 'Metadata Stores Executions Operations List
