...
/**
 * Metadata Stores Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiMetadataStoresOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_metadata_stores_operations_wait';
    protected const DESCRIPTION = 'Metadata Stores Operations Wait
