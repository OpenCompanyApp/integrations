...
/**
 * Migratable Resources Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiMigratableResourcesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_migratable_resources_operations_list';
    protected const DESCRIPTION = 'Migratable Resources Operations List
