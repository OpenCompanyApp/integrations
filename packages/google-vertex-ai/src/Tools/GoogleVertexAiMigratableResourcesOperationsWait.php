...
/**
 * Migratable Resources Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiMigratableResourcesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_migratable_resources_operations_wait';
    protected const DESCRIPTION = 'Migratable Resources Operations Wait
