...
/**
 * Model Deployment Monitoring Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiModelDeploymentMonitoringJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_model_deployment_monitoring_jobs_operations_list';
    protected const DESCRIPTION = 'Model Deployment Monitoring Jobs Operations List
