...
/**
 * Models Evaluations Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiModelsEvaluationsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_models_evaluations_operations_list';
    protected const DESCRIPTION = 'Models Evaluations Operations List
