...
/**
 * Models Evaluations Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiModelsEvaluationsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_models_evaluations_operations_wait';
    protected const DESCRIPTION = 'Models Evaluations Operations Wait
