 ...
 */
class GoogleVertexAiModelsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_models_operations_wait';
    protected const DESCRIPTION = 'Models Operations Wait
