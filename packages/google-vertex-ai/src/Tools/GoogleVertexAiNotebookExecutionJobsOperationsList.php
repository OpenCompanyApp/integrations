...
/**
 * Notebook Execution Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiNotebookExecutionJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_notebook_execution_jobs_operations_list';
    protected const DESCRIPTION = 'Notebook Execution Jobs Operations List
