...
/**
 * Notebook Execution Jobs Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiNotebookExecutionJobsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_notebook_execution_jobs_operations_wait';
    protected const DESCRIPTION = 'Notebook Execution Jobs Operations Wait
