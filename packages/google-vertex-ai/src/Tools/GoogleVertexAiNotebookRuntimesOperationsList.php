...
/**
 * Notebook Runtimes Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiNotebookRuntimesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_notebook_runtimes_operations_list';
    protected const DESCRIPTION = 'Notebook Runtimes Operations List
