...
/**
 * Notebook Runtimes Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiNotebookRuntimesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_notebook_runtimes_operations_wait';
    protected const DESCRIPTION = 'Notebook Runtimes Operations Wait
