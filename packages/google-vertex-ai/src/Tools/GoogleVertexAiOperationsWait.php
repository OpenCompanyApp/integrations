 ...
 */
class GoogleVertexAiOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_operations_wait';
    protected const DESCRIPTION = 'Operations Wait
