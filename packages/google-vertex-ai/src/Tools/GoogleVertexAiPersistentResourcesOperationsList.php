...
/**
 * Persistent Resources Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiPersistentResourcesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_persistent_resources_operations_list';
    protected const DESCRIPTION = 'Persistent Resources Operations List
