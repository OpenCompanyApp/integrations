...
/**
 * Persistent Resources Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiPersistentResourcesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_persistent_resources_operations_wait';
    protected const DESCRIPTION = 'Persistent Resources Operations Wait
