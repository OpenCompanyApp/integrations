...
/**
 * Pipeline Jobs Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiPipelineJobsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_pipeline_jobs_operations_wait';
    protected const DESCRIPTION = 'Pipeline Jobs Operations Wait
