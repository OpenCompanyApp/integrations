...
/**
 * Projects Locations Cached Contents Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsCachedContentsPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_cached_contents_patch';
    protected const DESCRIPTION = 'Projects Locations Cached Contents Patch
