...
/**
 * Projects Locations Custom Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsCustomJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_custom_jobs_operations_list';
    protected const DESCRIPTION = 'Projects Locations Custom Jobs Operations List
