...
/**
 * Projects Locations Data Labeling Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsDataLabelingJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_data_labeling_jobs_operations_list';
    protected const DESCRIPTION = 'Projects Locations Data Labeling Jobs Operations List
