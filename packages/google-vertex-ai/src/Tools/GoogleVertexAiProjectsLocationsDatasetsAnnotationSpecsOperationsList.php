...
/**
 * Projects Locations Datasets Annotation Specs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsDatasetsAnnotationSpecsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_annotation_specs_operations_list';
    protected const DESCRIPTION = 'Projects Locations Datasets Annotation Specs Operations List
