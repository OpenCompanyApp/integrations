...
/**
 * Projects Locations Datasets Data Items Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsDatasetsDataItemsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_data_items_operations_list';
    protected const DESCRIPTION = 'Projects Locations Datasets Data Items Operations List
