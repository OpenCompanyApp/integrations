...
/**
 * Projects Locations Datasets Dataset Versions Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsDatasetsDatasetVersionsPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_dataset_versions_patch';
    protected const DESCRIPTION = 'Projects Locations Datasets Dataset Versions Patch
