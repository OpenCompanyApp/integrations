 ...
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+parent}/datasets.
 */
class GoogleVertexAiProjectsLocationsDatasetsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_list';
    protected const DESCRIPTION = 'Projects Locations Datasets List

Official Vertex AI endpoint: GET /v1/{+parent}/datasets
