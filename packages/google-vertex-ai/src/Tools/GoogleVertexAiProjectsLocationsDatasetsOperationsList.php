 ...
 */
class GoogleVertexAiProjectsLocationsDatasetsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_operations_list';
    protected const DESCRIPTION = 'Projects Locations Datasets Operations List
