 ...
 */
class GoogleVertexAiProjectsLocationsDatasetsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Datasets Operations Wait
