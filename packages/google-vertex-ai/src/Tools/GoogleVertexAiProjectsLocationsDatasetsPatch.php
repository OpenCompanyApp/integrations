 ...
 */
class GoogleVertexAiProjectsLocationsDatasetsPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_patch';
    protected const DESCRIPTION = 'Projects Locations Datasets Patch
