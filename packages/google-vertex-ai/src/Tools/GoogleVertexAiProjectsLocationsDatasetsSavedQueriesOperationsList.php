...
/**
 * Projects Locations Datasets Saved Queries Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsDatasetsSavedQueriesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_saved_queries_operations_list';
    protected const DESCRIPTION = 'Projects Locations Datasets Saved Queries Operations List
