...
/**
 * Projects Locations Datasets Set Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GoogleVertexAiProjectsLocationsDatasetsSetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_datasets_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Datasets Set Iam Policy
