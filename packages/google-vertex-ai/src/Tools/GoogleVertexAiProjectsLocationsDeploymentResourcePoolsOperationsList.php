...
/**
 * Projects Locations Deployment Resource Pools Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsDeploymentResourcePoolsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_deployment_resource_pools_operations_list';
    protected const DESCRIPTION = 'Projects Locations Deployment Resource Pools Operations List
