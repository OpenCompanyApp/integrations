...
/**
 * Projects Locations Endpoints Compute Tokens.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:computeTokens.
 */
class GoogleVertexAiProjectsLocationsEndpointsComputeTokens extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_compute_tokens';
    protected const DESCRIPTION = 'Projects Locations Endpoints Compute Tokens
