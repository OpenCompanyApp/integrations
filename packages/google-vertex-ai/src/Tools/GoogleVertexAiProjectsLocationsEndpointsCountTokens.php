...
/**
 * Projects Locations Endpoints Count Tokens.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:countTokens.
 */
class GoogleVertexAiProjectsLocationsEndpointsCountTokens extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_count_tokens';
    protected const DESCRIPTION = 'Projects Locations Endpoints Count Tokens
