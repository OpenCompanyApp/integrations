...
/**
 * Projects Locations Endpoints Fetch Predict Operation.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:fetchPredictOperation.
 */
class GoogleVertexAiProjectsLocationsEndpointsFetchPredictOperation extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_fetch_predict_operation';
    protected const DESCRIPTION = 'Projects Locations Endpoints Fetch Predict Operation
