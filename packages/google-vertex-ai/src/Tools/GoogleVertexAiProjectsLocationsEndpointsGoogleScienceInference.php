...
/**
 * Projects Locations Endpoints Google Science Inference.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}/science/inference.
 */
class GoogleVertexAiProjectsLocationsEndpointsGoogleScienceInference extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_google_science_inference';
    protected const DESCRIPTION = 'Projects Locations Endpoints Google Science Inference

Official Vertex AI endpoint: POST /v1/{+endpoint}/science/inference
Forwards arbitrary HTTP requests for both streaming and non-streaming cases. To use this method, invoke_route_prefix must be set to allow the paths that will be specified in the request.';
  ...
  array (
    ...
    protected const PATH = '/v1/{+endpoint}/science/inference';
