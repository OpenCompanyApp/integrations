 ...
 */
class GoogleVertexAiProjectsLocationsEndpointsInvokeInvoke extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_invoke_invoke';
    protected const DESCRIPTION = 'Projects Locations Endpoints Invoke Invoke
