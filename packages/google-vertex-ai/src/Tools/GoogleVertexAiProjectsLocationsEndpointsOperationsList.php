 ...
 */
class GoogleVertexAiProjectsLocationsEndpointsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_operations_list';
    protected const DESCRIPTION = 'Projects Locations Endpoints Operations List
