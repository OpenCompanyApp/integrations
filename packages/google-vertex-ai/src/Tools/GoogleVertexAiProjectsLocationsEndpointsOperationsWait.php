 ...
 */
class GoogleVertexAiProjectsLocationsEndpointsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Endpoints Operations Wait
