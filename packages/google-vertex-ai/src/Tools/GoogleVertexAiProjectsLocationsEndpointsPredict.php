 ...
 */
class GoogleVertexAiProjectsLocationsEndpointsPredict extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_predict';
    protected const DESCRIPTION = 'Projects Locations Endpoints Predict
