...
/**
 * Projects Locations Endpoints Raw Predict.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:rawPredict.
 */
class GoogleVertexAiProjectsLocationsEndpointsRawPredict extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_raw_predict';
    protected const DESCRIPTION = 'Projects Locations Endpoints Raw Predict
