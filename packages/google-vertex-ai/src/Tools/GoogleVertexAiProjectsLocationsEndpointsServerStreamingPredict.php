...
/**
 * Projects Locations Endpoints Server Streaming Predict.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:serverStreamingPredict.
 */
class GoogleVertexAiProjectsLocationsEndpointsServerStreamingPredict extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_server_streaming_predict';
    protected const DESCRIPTION = 'Projects Locations Endpoints Server Streaming Predict
