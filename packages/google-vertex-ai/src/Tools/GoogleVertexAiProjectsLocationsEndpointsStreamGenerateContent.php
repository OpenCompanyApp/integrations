...
/**
 * Projects Locations Endpoints Stream Generate Content.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+model}:streamGenerateContent.
 */
class GoogleVertexAiProjectsLocationsEndpointsStreamGenerateContent extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_endpoints_stream_generate_content';
    protected const DESCRIPTION = 'Projects Locations Endpoints Stream Generate Content
