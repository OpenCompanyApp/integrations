...
/**
 * Projects Locations Feature Groups Features Create.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+parent}/features.
 */
class GoogleVertexAiProjectsLocationsFeatureGroupsFeaturesCreate extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_groups_features_create';
    protected const DESCRIPTION = 'Projects Locations Feature Groups Features Create
