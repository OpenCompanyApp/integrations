...
/**
 * Projects Locations Feature Groups Features Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsFeatureGroupsFeaturesPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_groups_features_patch';
    protected const DESCRIPTION = 'Projects Locations Feature Groups Features Patch
