...
/**
 * Projects Locations Feature Groups Operations List Wait.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}:wait.
 */
class GoogleVertexAiProjectsLocationsFeatureGroupsOperationsListWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_groups_operations_list_wait';
    protected const DESCRIPTION = 'Projects Locations Feature Groups Operations List Wait
