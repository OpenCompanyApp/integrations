...
/**
 * Projects Locations Feature Groups Set Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GoogleVertexAiProjectsLocationsFeatureGroupsSetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_groups_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Feature Groups Set Iam Policy
