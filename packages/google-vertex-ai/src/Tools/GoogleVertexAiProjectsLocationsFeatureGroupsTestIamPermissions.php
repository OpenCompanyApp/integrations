...
/**
 * Projects Locations Feature Groups Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsFeatureGroupsTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_groups_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Feature Groups Test Iam Permissions
