...
/**
 * Projects Locations Feature Online Stores Feature Views Get Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:getIamPolicy.
 */
class GoogleVertexAiProjectsLocationsFeatureOnlineStoresFeatureViewsGetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_online_stores_feature_views_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Feature Online Stores Feature Views Get Iam Policy
