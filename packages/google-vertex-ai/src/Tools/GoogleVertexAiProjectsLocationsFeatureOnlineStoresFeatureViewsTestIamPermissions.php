...
/**
 * Projects Locations Feature Online Stores Feature Views Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsFeatureOnlineStoresFeatureViewsTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_online_stores_feature_views_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Feature Online Stores Feature Views Test Iam Permissions
