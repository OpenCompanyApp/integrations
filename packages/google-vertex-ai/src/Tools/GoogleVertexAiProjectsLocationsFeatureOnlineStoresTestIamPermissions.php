...
/**
 * Projects Locations Feature Online Stores Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsFeatureOnlineStoresTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_feature_online_stores_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Feature Online Stores Test Iam Permissions
