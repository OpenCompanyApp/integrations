 ...
 */
class GoogleVertexAiProjectsLocationsFeaturestoresDelete extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_delete';
    protected const DESCRIPTION = 'Projects Locations Featurestores Delete
