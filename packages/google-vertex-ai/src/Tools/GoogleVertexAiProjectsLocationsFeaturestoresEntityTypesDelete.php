...
/**
 * Projects Locations Featurestores Entity Types Delete.
 *
 * Maps to the official Vertex AI endpoint DELETE /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresEntityTypesDelete extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_entity_types_delete';
    protected const DESCRIPTION = 'Projects Locations Featurestores Entity Types Delete
