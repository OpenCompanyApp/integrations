...
/**
 * Projects Locations Featurestores Entity Types Get Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:getIamPolicy.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresEntityTypesGetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_entity_types_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Featurestores Entity Types Get Iam Policy
