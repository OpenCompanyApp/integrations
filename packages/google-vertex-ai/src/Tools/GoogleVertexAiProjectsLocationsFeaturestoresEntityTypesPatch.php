...
/**
 * Projects Locations Featurestores Entity Types Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresEntityTypesPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_entity_types_patch';
    protected const DESCRIPTION = 'Projects Locations Featurestores Entity Types Patch
