...
/**
 * Projects Locations Featurestores Entity Types Set Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresEntityTypesSetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_entity_types_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Featurestores Entity Types Set Iam Policy
