...
/**
 * Projects Locations Featurestores Entity Types Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresEntityTypesTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_entity_types_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Featurestores Entity Types Test Iam Permissions
