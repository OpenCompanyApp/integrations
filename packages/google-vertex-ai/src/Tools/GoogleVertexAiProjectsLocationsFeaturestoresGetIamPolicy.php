...
/**
 * Projects Locations Featurestores Get Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:getIamPolicy.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresGetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Featurestores Get Iam Policy
