 ...
 */
class GoogleVertexAiProjectsLocationsFeaturestoresOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_operations_list';
    protected const DESCRIPTION = 'Projects Locations Featurestores Operations List
