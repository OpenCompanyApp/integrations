 ...
 */
class GoogleVertexAiProjectsLocationsFeaturestoresOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Featurestores Operations Wait
