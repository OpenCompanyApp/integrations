 ...
 */
class GoogleVertexAiProjectsLocationsFeaturestoresPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_patch';
    protected const DESCRIPTION = 'Projects Locations Featurestores Patch
