...
/**
 * Projects Locations Featurestores Set Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GoogleVertexAiProjectsLocationsFeaturestoresSetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_featurestores_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Featurestores Set Iam Policy
