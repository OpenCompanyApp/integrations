...
/**
 * Projects Locations Hyperparameter Tuning Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsHyperparameterTuningJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_hyperparameter_tuning_jobs_operations_list';
    protected const DESCRIPTION = 'Projects Locations Hyperparameter Tuning Jobs Operations List
