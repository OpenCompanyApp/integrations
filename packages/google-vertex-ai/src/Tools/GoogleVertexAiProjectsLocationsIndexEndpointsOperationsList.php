...
/**
 * Projects Locations Index Endpoints Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsIndexEndpointsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_index_endpoints_operations_list';
    protected const DESCRIPTION = 'Projects Locations Index Endpoints Operations List
