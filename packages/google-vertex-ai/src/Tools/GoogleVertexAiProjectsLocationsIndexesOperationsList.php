 ...
 */
class GoogleVertexAiProjectsLocationsIndexesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_indexes_operations_list';
    protected const DESCRIPTION = 'Projects Locations Indexes Operations List
