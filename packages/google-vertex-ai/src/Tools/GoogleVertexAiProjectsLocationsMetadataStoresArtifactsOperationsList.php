...
/**
 * Projects Locations Metadata Stores Artifacts Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsMetadataStoresArtifactsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_metadata_stores_artifacts_operations_list';
    protected const DESCRIPTION = 'Projects Locations Metadata Stores Artifacts Operations List
