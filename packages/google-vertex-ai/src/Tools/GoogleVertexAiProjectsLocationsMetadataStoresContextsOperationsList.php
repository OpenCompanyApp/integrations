...
/**
 * Projects Locations Metadata Stores Contexts Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsMetadataStoresContextsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_metadata_stores_contexts_operations_list';
    protected const DESCRIPTION = 'Projects Locations Metadata Stores Contexts Operations List
