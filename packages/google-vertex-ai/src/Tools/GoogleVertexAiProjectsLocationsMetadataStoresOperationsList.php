...
/**
 * Projects Locations Metadata Stores Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsMetadataStoresOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_metadata_stores_operations_list';
    protected const DESCRIPTION = 'Projects Locations Metadata Stores Operations List
