...
/**
 * Projects Locations Migratable Resources Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsMigratableResourcesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_migratable_resources_operations_list';
    protected const DESCRIPTION = 'Projects Locations Migratable Resources Operations List
