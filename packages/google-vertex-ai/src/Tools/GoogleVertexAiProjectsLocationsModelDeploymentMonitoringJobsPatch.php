...
/**
 * Projects Locations Model Deployment Monitoring Jobs Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsModelDeploymentMonitoringJobsPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_model_deployment_monitoring_jobs_patch';
    protected const DESCRIPTION = 'Projects Locations Model Deployment Monitoring Jobs Patch
