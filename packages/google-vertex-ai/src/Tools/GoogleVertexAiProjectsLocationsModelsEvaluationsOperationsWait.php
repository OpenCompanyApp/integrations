 ...
 */
class GoogleVertexAiProjectsLocationsModelsEvaluationsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_models_evaluations_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Models Evaluations Operations Wait
