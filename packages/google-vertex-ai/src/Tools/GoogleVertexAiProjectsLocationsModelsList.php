 ...
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+parent}/models.
 */
class GoogleVertexAiProjectsLocationsModelsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_models_list';
    protected const DESCRIPTION = 'Projects Locations Models List

Official Vertex AI endpoint: GET /v1/{+parent}/models
Lists Models in a Location.';
  ...
  array (
    ...
    protected const PATH = '/v1/{+parent}/models';
