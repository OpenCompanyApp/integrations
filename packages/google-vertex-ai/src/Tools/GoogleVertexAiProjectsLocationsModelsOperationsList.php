 ...
 */
class GoogleVertexAiProjectsLocationsModelsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_models_operations_list';
    protected const DESCRIPTION = 'Projects Locations Models Operations List
