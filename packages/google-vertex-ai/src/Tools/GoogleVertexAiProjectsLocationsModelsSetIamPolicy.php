...
/**
 * Projects Locations Models Set Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GoogleVertexAiProjectsLocationsModelsSetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_models_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Models Set Iam Policy
