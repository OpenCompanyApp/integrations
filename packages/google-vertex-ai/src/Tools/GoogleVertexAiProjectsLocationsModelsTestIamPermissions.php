...
/**
 * Projects Locations Models Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsModelsTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_models_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Models Test Iam Permissions
