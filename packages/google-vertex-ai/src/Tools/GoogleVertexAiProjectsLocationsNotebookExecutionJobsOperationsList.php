...
/**
 * Projects Locations Notebook Execution Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsNotebookExecutionJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_notebook_execution_jobs_operations_list';
    protected const DESCRIPTION = 'Projects Locations Notebook Execution Jobs Operations List
