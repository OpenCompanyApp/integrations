...
/**
 * Projects Locations Notebook Runtime Templates Get Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:getIamPolicy.
 */
class GoogleVertexAiProjectsLocationsNotebookRuntimeTemplatesGetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_notebook_runtime_templates_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Notebook Runtime Templates Get Iam Policy
