...
/**
 * Projects Locations Notebook Runtime Templates Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsNotebookRuntimeTemplatesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_notebook_runtime_templates_operations_list';
    protected const DESCRIPTION = 'Projects Locations Notebook Runtime Templates Operations List
