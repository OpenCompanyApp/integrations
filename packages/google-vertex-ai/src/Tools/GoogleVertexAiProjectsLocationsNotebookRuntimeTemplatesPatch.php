...
/**
 * Projects Locations Notebook Runtime Templates Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsNotebookRuntimeTemplatesPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_notebook_runtime_templates_patch';
    protected const DESCRIPTION = 'Projects Locations Notebook Runtime Templates Patch
