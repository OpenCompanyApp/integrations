...
/**
 * Projects Locations Notebook Runtime Templates Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsNotebookRuntimeTemplatesTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_notebook_runtime_templates_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Notebook Runtime Templates Test Iam Permissions
