...
/**
 * Projects Locations Notebook Runtimes Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsNotebookRuntimesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_notebook_runtimes_operations_list';
    protected const DESCRIPTION = 'Projects Locations Notebook Runtimes Operations List
