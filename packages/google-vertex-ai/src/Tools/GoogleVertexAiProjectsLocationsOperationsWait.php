 ...
 */
class GoogleVertexAiProjectsLocationsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_operations_wait';
