...
/**
 * Projects Locations Persistent Resources Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsPersistentResourcesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_persistent_resources_operations_list';
    protected const DESCRIPTION = 'Projects Locations Persistent Resources Operations List
