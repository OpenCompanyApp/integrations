...
/**
 * Projects Locations Persistent Resources Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsPersistentResourcesPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_persistent_resources_patch';
    protected const DESCRIPTION = 'Projects Locations Persistent Resources Patch
