...
/**
 * Projects Locations Publishers Models Count Tokens.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:countTokens.
 */
class GoogleVertexAiProjectsLocationsPublishersModelsCountTokens extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_publishers_models_count_tokens';
    protected const DESCRIPTION = 'Projects Locations Publishers Models Count Tokens
