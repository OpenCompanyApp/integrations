...
/**
 * Projects Locations Publishers Models Fetch Predict Operation.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:fetchPredictOperation.
 */
class GoogleVertexAiProjectsLocationsPublishersModelsFetchPredictOperation extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_publishers_models_fetch_predict_operation';
    protected const DESCRIPTION = 'Projects Locations Publishers Models Fetch Predict Operation
