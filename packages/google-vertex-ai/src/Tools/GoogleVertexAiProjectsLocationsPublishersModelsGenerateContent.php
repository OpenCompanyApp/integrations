...
/**
 * Projects Locations Publishers Models Generate Content.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+model}:generateContent.
 */
class GoogleVertexAiProjectsLocationsPublishersModelsGenerateContent extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_publishers_models_generate_content';
    protected const DESCRIPTION = 'Projects Locations Publishers Models Generate Content
