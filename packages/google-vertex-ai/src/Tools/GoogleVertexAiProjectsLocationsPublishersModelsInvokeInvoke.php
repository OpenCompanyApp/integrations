...
/**
 * Projects Locations Publishers Models Invoke Invoke.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}/invoke/{+invokeId}.
 */
class GoogleVertexAiProjectsLocationsPublishersModelsInvokeInvoke extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_publishers_models_invoke_invoke';
    protected const DESCRIPTION = 'Projects Locations Publishers Models Invoke Invoke

Official Vertex AI endpoint: POST /v1/{+endpoint}/invoke/{+invokeId}
Forwards arbitrary HTTP requests for both streaming and non-streaming cases. To use this method, invoke_route_prefix must be set to allow the paths that will be specified in the request.';
  ...
  array (
    ...
    protected const PATH = '/v1/{+endpoint}/invoke/{+invokeId}';
