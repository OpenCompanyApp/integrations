...
/**
 * Projects Locations Publishers Models Predict Long Running.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:predictLongRunning.
 */
class GoogleVertexAiProjectsLocationsPublishersModelsPredictLongRunning extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_publishers_models_predict_long_running';
    protected const DESCRIPTION = 'Projects Locations Publishers Models Predict Long Running
