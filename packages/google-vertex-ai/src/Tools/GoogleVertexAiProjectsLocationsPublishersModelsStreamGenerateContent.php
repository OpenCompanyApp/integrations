...
/**
 * Projects Locations Publishers Models Stream Generate Content.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+model}:streamGenerateContent.
 */
class GoogleVertexAiProjectsLocationsPublishersModelsStreamGenerateContent extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_publishers_models_stream_generate_content';
    protected const DESCRIPTION = 'Projects Locations Publishers Models Stream Generate Content
