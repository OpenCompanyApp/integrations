...
/**
 * Projects Locations Rag Corpora Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsRagCorporaOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_rag_corpora_operations_list';
    protected const DESCRIPTION = 'Projects Locations Rag Corpora Operations List
