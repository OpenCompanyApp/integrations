...
/**
 * Projects Locations Rag Corpora Rag Files Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsRagCorporaRagFilesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_rag_corpora_rag_files_operations_list';
    protected const DESCRIPTION = 'Projects Locations Rag Corpora Rag Files Operations List
