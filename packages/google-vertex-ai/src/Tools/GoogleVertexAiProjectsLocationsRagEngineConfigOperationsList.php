...
/**
 * Projects Locations Rag Engine Config Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsRagEngineConfigOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_rag_engine_config_operations_list';
    protected const DESCRIPTION = 'Projects Locations Rag Engine Config Operations List
