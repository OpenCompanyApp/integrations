...
/**
 * Projects Locations Reasoning Engines Get Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:getIamPolicy.
 */
class GoogleVertexAiProjectsLocationsReasoningEnginesGetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_reasoning_engines_get_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Reasoning Engines Get Iam Policy
