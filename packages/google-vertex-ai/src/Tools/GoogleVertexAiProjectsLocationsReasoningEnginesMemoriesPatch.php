...
/**
 * Projects Locations Reasoning Engines Memories Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsReasoningEnginesMemoriesPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_reasoning_engines_memories_patch';
    protected const DESCRIPTION = 'Projects Locations Reasoning Engines Memories Patch
