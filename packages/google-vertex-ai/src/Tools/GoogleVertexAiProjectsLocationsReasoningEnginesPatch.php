...
/**
 * Projects Locations Reasoning Engines Patch.
 *
 * Maps to the official Vertex AI endpoint PATCH /v1/{+name}.
 */
class GoogleVertexAiProjectsLocationsReasoningEnginesPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_reasoning_engines_patch';
    protected const DESCRIPTION = 'Projects Locations Reasoning Engines Patch
