...
/**
 * Projects Locations Reasoning Engines Sessions Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsReasoningEnginesSessionsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_reasoning_engines_sessions_operations_list';
    protected const DESCRIPTION = 'Projects Locations Reasoning Engines Sessions Operations List
