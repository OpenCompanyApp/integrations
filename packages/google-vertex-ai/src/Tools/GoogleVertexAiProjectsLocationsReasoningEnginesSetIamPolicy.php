...
/**
 * Projects Locations Reasoning Engines Set Iam Policy.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:setIamPolicy.
 */
class GoogleVertexAiProjectsLocationsReasoningEnginesSetIamPolicy extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_reasoning_engines_set_iam_policy';
    protected const DESCRIPTION = 'Projects Locations Reasoning Engines Set Iam Policy
