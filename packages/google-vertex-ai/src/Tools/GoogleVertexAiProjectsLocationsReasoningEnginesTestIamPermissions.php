...
/**
 * Projects Locations Reasoning Engines Test Iam Permissions.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+resource}:testIamPermissions.
 */
class GoogleVertexAiProjectsLocationsReasoningEnginesTestIamPermissions extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_reasoning_engines_test_iam_permissions';
    protected const DESCRIPTION = 'Projects Locations Reasoning Engines Test Iam Permissions
