 ...
 */
class GoogleVertexAiProjectsLocationsSchedulesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_schedules_operations_list';
    protected const DESCRIPTION = 'Projects Locations Schedules Operations List
