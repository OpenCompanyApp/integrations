 ...
 */
class GoogleVertexAiProjectsLocationsSchedulesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_schedules_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Schedules Operations Wait
