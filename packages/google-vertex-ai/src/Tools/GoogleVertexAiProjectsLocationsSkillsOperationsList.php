...
/**
 * Projects Locations Skills Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsSkillsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_skills_operations_list';
    protected const DESCRIPTION = 'Projects Locations Skills Operations List
