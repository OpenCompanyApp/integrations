...
/**
 * Projects Locations Specialist Pools Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsSpecialistPoolsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_specialist_pools_operations_list';
    protected const DESCRIPTION = 'Projects Locations Specialist Pools Operations List
