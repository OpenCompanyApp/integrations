 ...
 */
class GoogleVertexAiProjectsLocationsStudiesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_studies_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Studies Operations Wait
