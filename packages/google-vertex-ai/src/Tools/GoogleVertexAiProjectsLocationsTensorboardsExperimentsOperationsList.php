 ...
 */
class GoogleVertexAiProjectsLocationsTensorboardsExperimentsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_tensorboards_experiments_operations_list';
    protected const DESCRIPTION = 'Projects Locations Tensorboards Experiments Operations List
