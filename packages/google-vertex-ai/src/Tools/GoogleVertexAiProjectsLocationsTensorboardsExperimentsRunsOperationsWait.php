 ...
 */
class GoogleVertexAiProjectsLocationsTensorboardsExperimentsRunsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_tensorboards_experiments_runs_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Tensorboards Experiments Runs Operations Wait
