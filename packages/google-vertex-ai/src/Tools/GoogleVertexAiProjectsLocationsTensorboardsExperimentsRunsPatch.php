 ...
 */
class GoogleVertexAiProjectsLocationsTensorboardsExperimentsRunsPatch extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_tensorboards_experiments_runs_patch';
    protected const DESCRIPTION = 'Projects Locations Tensorboards Experiments Runs Patch
