 ...
 */
class GoogleVertexAiProjectsLocationsTensorboardsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_tensorboards_operations_list';
    protected const DESCRIPTION = 'Projects Locations Tensorboards Operations List
