 ...
 */
class GoogleVertexAiProjectsLocationsTensorboardsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_tensorboards_operations_wait';
    protected const DESCRIPTION = 'Projects Locations Tensorboards Operations Wait
