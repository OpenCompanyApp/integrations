...
/**
 * Projects Locations Training Pipelines Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiProjectsLocationsTrainingPipelinesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_projects_locations_training_pipelines_operations_list';
    protected const DESCRIPTION = 'Projects Locations Training Pipelines Operations List
