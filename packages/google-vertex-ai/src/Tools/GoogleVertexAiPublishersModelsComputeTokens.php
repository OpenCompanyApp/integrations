...
/**
 * Publishers Models Compute Tokens.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+endpoint}:computeTokens.
 */
class GoogleVertexAiPublishersModelsComputeTokens extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_publishers_models_compute_tokens';
    protected const DESCRIPTION = 'Publishers Models Compute Tokens
