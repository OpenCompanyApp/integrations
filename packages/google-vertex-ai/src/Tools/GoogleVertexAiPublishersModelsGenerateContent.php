...
/**
 * Publishers Models Generate Content.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+model}:generateContent.
 */
class GoogleVertexAiPublishersModelsGenerateContent extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_publishers_models_generate_content';
    protected const DESCRIPTION = 'Publishers Models Generate Content
