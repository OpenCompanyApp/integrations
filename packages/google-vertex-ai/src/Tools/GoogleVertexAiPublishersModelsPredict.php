 ...
 */
class GoogleVertexAiPublishersModelsPredict extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_publishers_models_predict';
    protected const DESCRIPTION = 'Publishers Models Predict
