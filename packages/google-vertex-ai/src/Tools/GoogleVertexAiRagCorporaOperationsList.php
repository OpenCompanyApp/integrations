...
/**
 * Rag Corpora Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiRagCorporaOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_rag_corpora_operations_list';
    protected const DESCRIPTION = 'Rag Corpora Operations List
