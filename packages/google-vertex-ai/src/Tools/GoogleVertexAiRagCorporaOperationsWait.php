...
/**
 * Rag Corpora Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiRagCorporaOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_rag_corpora_operations_wait';
    protected const DESCRIPTION = 'Rag Corpora Operations Wait
