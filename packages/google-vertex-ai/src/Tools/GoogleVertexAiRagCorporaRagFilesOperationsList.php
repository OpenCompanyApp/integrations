...
/**
 * Rag Corpora Rag Files Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiRagCorporaRagFilesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_rag_corpora_rag_files_operations_list';
    protected const DESCRIPTION = 'Rag Corpora Rag Files Operations List
