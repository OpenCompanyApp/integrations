...
/**
 * Rag Corpora Rag Files Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiRagCorporaRagFilesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_rag_corpora_rag_files_operations_wait';
    protected const DESCRIPTION = 'Rag Corpora Rag Files Operations Wait
