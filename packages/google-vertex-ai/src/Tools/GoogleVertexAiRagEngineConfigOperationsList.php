...
/**
 * Rag Engine Config Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiRagEngineConfigOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_rag_engine_config_operations_list';
    protected const DESCRIPTION = 'Rag Engine Config Operations List
