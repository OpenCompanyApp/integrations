...
/**
 * Rag Engine Config Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiRagEngineConfigOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_rag_engine_config_operations_wait';
    protected const DESCRIPTION = 'Rag Engine Config Operations Wait
