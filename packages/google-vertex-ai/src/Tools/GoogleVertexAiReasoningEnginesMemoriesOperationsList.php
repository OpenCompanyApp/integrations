...
/**
 * Reasoning Engines Memories Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiReasoningEnginesMemoriesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_reasoning_engines_memories_operations_list';
    protected const DESCRIPTION = 'Reasoning Engines Memories Operations List
