...
/**
 * Reasoning Engines Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiReasoningEnginesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_reasoning_engines_operations_wait';
    protected const DESCRIPTION = 'Reasoning Engines Operations Wait
