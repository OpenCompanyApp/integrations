...
/**
 * Reasoning Engines Query.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:query.
 */
class GoogleVertexAiReasoningEnginesQuery extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_reasoning_engines_query';
    protected const DESCRIPTION = 'Reasoning Engines Query
