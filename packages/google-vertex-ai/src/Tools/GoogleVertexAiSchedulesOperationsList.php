...
/**
 * Schedules Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiSchedulesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_schedules_operations_list';
    protected const DESCRIPTION = 'Schedules Operations List
