...
/**
 * Schedules Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiSchedulesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_schedules_operations_wait';
    protected const DESCRIPTION = 'Schedules Operations Wait
