...
/**
 * Skills Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiSkillsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_skills_operations_list';
    protected const DESCRIPTION = 'Skills Operations List
