...
/**
 * Skills Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiSkillsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_skills_operations_wait';
    protected const DESCRIPTION = 'Skills Operations Wait
