...
/**
 * Specialist Pools Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiSpecialistPoolsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_specialist_pools_operations_list';
    protected const DESCRIPTION = 'Specialist Pools Operations List
