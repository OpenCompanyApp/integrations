...
/**
 * Specialist Pools Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiSpecialistPoolsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_specialist_pools_operations_wait';
    protected const DESCRIPTION = 'Specialist Pools Operations Wait
