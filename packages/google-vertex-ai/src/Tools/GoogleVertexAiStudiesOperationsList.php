...
/**
 * Studies Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiStudiesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_studies_operations_list';
    protected const DESCRIPTION = 'Studies Operations List
