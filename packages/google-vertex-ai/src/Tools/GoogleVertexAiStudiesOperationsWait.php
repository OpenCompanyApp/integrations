...
/**
 * Studies Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiStudiesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_studies_operations_wait';
    protected const DESCRIPTION = 'Studies Operations Wait
