...
/**
 * Studies Trials Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiStudiesTrialsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_studies_trials_operations_list';
    protected const DESCRIPTION = 'Studies Trials Operations List
