...
/**
 * Studies Trials Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiStudiesTrialsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_studies_trials_operations_wait';
    protected const DESCRIPTION = 'Studies Trials Operations Wait
