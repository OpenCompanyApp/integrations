...
/**
 * Tensorboards Experiments Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiTensorboardsExperimentsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tensorboards_experiments_operations_list';
    protected const DESCRIPTION = 'Tensorboards Experiments Operations List
