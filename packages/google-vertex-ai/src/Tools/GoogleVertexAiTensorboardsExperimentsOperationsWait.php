...
/**
 * Tensorboards Experiments Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiTensorboardsExperimentsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tensorboards_experiments_operations_wait';
    protected const DESCRIPTION = 'Tensorboards Experiments Operations Wait
