...
/**
 * Tensorboards Experiments Runs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiTensorboardsExperimentsRunsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tensorboards_experiments_runs_operations_list';
    protected const DESCRIPTION = 'Tensorboards Experiments Runs Operations List
