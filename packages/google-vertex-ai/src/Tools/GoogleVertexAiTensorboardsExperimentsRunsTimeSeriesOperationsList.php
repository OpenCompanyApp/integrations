...
/**
 * Tensorboards Experiments Runs Time Series Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiTensorboardsExperimentsRunsTimeSeriesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tensorboards_experiments_runs_time_series_operations_list';
    protected const DESCRIPTION = 'Tensorboards Experiments Runs Time Series Operations List
