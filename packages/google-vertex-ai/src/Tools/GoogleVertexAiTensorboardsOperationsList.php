...
/**
 * Tensorboards Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiTensorboardsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tensorboards_operations_list';
    protected const DESCRIPTION = 'Tensorboards Operations List
