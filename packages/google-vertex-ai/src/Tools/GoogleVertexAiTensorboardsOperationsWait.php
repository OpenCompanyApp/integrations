...
/**
 * Tensorboards Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiTensorboardsOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tensorboards_operations_wait';
    protected const DESCRIPTION = 'Tensorboards Operations Wait
