...
/**
 * Training Pipelines Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiTrainingPipelinesOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_training_pipelines_operations_list';
    protected const DESCRIPTION = 'Training Pipelines Operations List
