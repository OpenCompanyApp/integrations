...
/**
 * Training Pipelines Operations Wait.
 *
 * Maps to the official Vertex AI endpoint POST /v1/{+name}:wait.
 */
class GoogleVertexAiTrainingPipelinesOperationsWait extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_training_pipelines_operations_wait';
    protected const DESCRIPTION = 'Training Pipelines Operations Wait
