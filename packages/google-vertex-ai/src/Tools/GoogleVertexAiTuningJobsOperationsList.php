...
/**
 * Tuning Jobs Operations List.
 *
 * Maps to the official Vertex AI endpoint GET /v1/{+name}/operations.
 */
class GoogleVertexAiTuningJobsOperationsList extends AbstractGoogleVertexAiTool
{
    protected const NAME = 'google_vertex_ai_tuning_jobs_operations_list';
    protected const DESCRIPTION = 'Tuning Jobs Operations List
