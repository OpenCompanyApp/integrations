...
```ruby
users = app.call("integrations.google-workspace-admin.users_list", customer: "my_customer", max_results: 10, projection: "basic")
group = app.call("integrations.google-workspace-admin.groups_insert", body: {email: "agents@example.test", name: "Agents"})
aliases = app.call("integrations.google-workspace-admin.users_aliases_list", user_key: "person@example.test")
```
