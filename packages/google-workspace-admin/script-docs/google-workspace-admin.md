...
```js
var users = app.integrations.google_workspace_admin.google_workspace_admin_users_list({
  customer: "my_customer",
  maxResults: 10,
  projection: "basic",
})

var group = app.integrations.google_workspace_admin.google_workspace_admin_groups_insert({
  body: {
...
var aliases = app.integrations.google_workspace_admin.google_workspace_admin_users_aliases_list({
