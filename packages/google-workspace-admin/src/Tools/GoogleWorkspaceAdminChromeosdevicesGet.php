 ...
 * Chromeosdevices Get.
 *
 * Maps to the official Workspace Admin endpoint GET /admin/directory/v1/customer/{customerId}/devices/chromeos/{deviceId}.
 */
class GoogleWorkspaceAdminChromeosdevicesGet extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_chromeosdevices_get';
    protected const DESCRIPTION = 'Chromeosdevices Get

Official Workspace Admin endpoint: GET /admin/directory/v1/customer/{customerId}/devices/chromeos/{deviceId}
