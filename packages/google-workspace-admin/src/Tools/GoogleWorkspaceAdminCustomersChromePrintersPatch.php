 ...
 */
class GoogleWorkspaceAdminCustomersChromePrintersPatch extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_customers_chrome_printers_patch';
    protected const DESCRIPTION = 'Customers Chrome Printers Patch
...
Updates a `Printer` resource.';
  ...
  array (
    'type' => 'object',
    'required' => false,
    'description' => 'Query string parameters accepted by the official Workspace Admin method. Known keys: updateMask, clearMask.',
  ),
  'updateMask' =>
  array (
    'type' => 'string',
  ...
  array (
    'type' => 'string',
    'required' => false,
    'description' => 'Shortcut for query parameter `clearMask`.',
  ),
  'body' =>
  array (
    'type' => 'object',
