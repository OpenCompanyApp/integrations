 ...
 * Domains Get.
 *
 * Maps to the official Workspace Admin endpoint GET /admin/directory/v1/customer/{customer}/domains/{domainName}.
 */
class GoogleWorkspaceAdminDomainsGet extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_domains_get';
    protected const DESCRIPTION = 'Domains Get

Official Workspace Admin endpoint: GET /admin/directory/v1/customer/{customer}/domains/{domainName}
