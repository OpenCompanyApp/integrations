 ...
 * Orgunits Get.
 *
 * Maps to the official Workspace Admin endpoint GET /admin/directory/v1/customer/{customerId}/orgunits/{+orgUnitPath}.
 */
class GoogleWorkspaceAdminOrgunitsGet extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_orgunits_get';
    protected const DESCRIPTION = 'Orgunits Get

Official Workspace Admin endpoint: GET /admin/directory/v1/customer/{customerId}/orgunits/{+orgUnitPath}
