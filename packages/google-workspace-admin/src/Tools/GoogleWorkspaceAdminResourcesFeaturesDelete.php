 ...
 *
 * Maps to the official Workspace Admin endpoint DELETE /admin/directory/v1/customer/{customer}/resources/features/{featureKey}.
 */
class GoogleWorkspaceAdminResourcesFeaturesDelete extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_resources_features_delete';
    protected const DESCRIPTION = 'Resources Features Delete

Official Workspace Admin endpoint: DELETE /admin/directory/v1/customer/{customer}/resources/features/{featureKey}
Deletes a feature.';
