 ...
 * Roles Patch.
 *
 * Maps to the official Workspace Admin endpoint PATCH /admin/directory/v1/customer/{customer}/roles/{roleId}.
 */
class GoogleWorkspaceAdminRolesPatch extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_roles_patch';
    protected const DESCRIPTION = 'Roles Patch

Official Workspace Admin endpoint: PATCH /admin/directory/v1/customer/{customer}/roles/{roleId}
Patches a role.';
