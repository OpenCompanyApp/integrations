 ...
 * Schemas Patch.
 *
 * Maps to the official Workspace Admin endpoint PATCH /admin/directory/v1/customer/{customerId}/schemas/{schemaKey}.
 */
class GoogleWorkspaceAdminSchemasPatch extends AbstractGoogleWorkspaceAdminTool
{
    protected const NAME = 'google_workspace_admin_schemas_patch';
    protected const DESCRIPTION = 'Schemas Patch

Official Workspace Admin endpoint: PATCH /admin/directory/v1/customer/{customerId}/schemas/{schemaKey}
Patches a schema.';
