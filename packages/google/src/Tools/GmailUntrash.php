...
class GmailUntrash implements Tool
{
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success("{$count} message(s) removed from trash.");
        } catch (\Throwable $e) {
    ...
    {
        return [
            'message_id' => ['type' => 'string', 'description' => 'Single message ID to restore from trash.'],
