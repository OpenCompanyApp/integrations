...
class GoToWebinarListPanelists implements Tool
{
    ...
    {
        return 'gotowebinar_list_panelists';
    }

    public function description(): string
    {
        return 'List all panelists for a specific webinar. Panelists are featured speakers who have enhanced permissions during the webinar.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listPanelists($args['webinar_id'], $page, $size);
