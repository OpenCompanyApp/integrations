 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/candidate_employments.
 */
class GreenhouseGetV3CandidateEmployments extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_candidate_employments';
    protected const DESCRIPTION = 'List candidate employments
