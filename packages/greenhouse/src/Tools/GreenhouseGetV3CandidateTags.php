 ...
 * List candidate tags.
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/candidate_tags.
 */
class GreenhouseGetV3CandidateTags extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_candidate_tags';
    protected const DESCRIPTION = 'List candidate tags
