 ...
 * List close reasons.
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/close_reasons.
 */
class GreenhouseGetV3CloseReasons extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_close_reasons';
    protected const DESCRIPTION = 'List close reasons
...
Official Greenhouse Harvest v3 endpoint: GET /v3/close_reasons.';
    ...
    protected const PATH = '/v3/close_reasons';
