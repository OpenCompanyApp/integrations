 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/custom_field_departments.
 */
class GreenhouseGetV3CustomFieldDepartments extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_custom_field_departments';
    protected const DESCRIPTION = 'List custom field departments
