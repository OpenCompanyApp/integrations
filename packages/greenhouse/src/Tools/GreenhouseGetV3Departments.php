 ...
 * List departments.
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/departments.
 */
class GreenhouseGetV3Departments extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_departments';
