 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/interviewer_tags.
 */
class GreenhouseGetV3InterviewerTags extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_interviewer_tags';
    protected const DESCRIPTION = 'List interviewer tags
...
Official Greenhouse Harvest v3 endpoint: GET /v3/interviewer_tags.';
    ...
    protected const PATH = '/v3/interviewer_tags';
