 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/job_hiring_managers.
 */
class GreenhouseGetV3JobHiringManagers extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_job_hiring_managers';
    protected const DESCRIPTION = 'List job hiring managers
