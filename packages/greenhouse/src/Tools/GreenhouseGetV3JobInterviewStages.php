 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/job_interview_stages.
 */
class GreenhouseGetV3JobInterviewStages extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_job_interview_stages';
    protected const DESCRIPTION = 'List job interview stages
...
Official Greenhouse Harvest v3 endpoint: GET /v3/job_interview_stages.';
    ...
    protected const PATH = '/v3/job_interview_stages';
