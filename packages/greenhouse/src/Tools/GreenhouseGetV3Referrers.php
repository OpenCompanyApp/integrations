 ...
 * List referrers.
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/referrers.
 */
class GreenhouseGetV3Referrers extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_referrers';
    protected const DESCRIPTION = 'List referrers
...
Official Greenhouse Harvest v3 endpoint: GET /v3/referrers.';
    ...
    protected const PATH = '/v3/referrers';
