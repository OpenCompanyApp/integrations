 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/rejection_reasons.
 */
class GreenhouseGetV3RejectionReasons extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_rejection_reasons';
    protected const DESCRIPTION = 'List rejection reasons
...
Official Greenhouse Harvest v3 endpoint: GET /v3/rejection_reasons.';
    ...
    protected const PATH = '/v3/rejection_reasons';
