 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/scorecard_candidate_attributes.
 */
class GreenhouseGetV3ScorecardCandidateAttributes extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_scorecard_candidate_attributes';
    protected const DESCRIPTION = 'List scorecard candidate attributes
