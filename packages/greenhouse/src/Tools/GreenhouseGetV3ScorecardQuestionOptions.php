 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/scorecard_question_options.
 */
class GreenhouseGetV3ScorecardQuestionOptions extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_scorecard_question_options';
    protected const DESCRIPTION = 'List scorecard question options
...
Official Greenhouse Harvest v3 endpoint: GET /v3/scorecard_question_options.';
    ...
    protected const PATH = '/v3/scorecard_question_options';
