 ...
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/scorecard_questions.
 */
class GreenhouseGetV3ScorecardQuestions extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_scorecard_questions';
    protected const DESCRIPTION = 'List scorecard questions
...
Official Greenhouse Harvest v3 endpoint: GET /v3/scorecard_questions.';
    ...
    protected const PATH = '/v3/scorecard_questions';
