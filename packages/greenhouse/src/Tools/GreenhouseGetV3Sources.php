 ...
 * List sources.
 *
 * Maps to the official Greenhouse Harvest v3 endpoint GET /v3/sources.
 */
class GreenhouseGetV3Sources extends AbstractGreenhouseTool
{
    protected const NAME = 'greenhouse_get_v3_sources';
...
Official Greenhouse Harvest v3 endpoint: GET /v3/sources.';
    ...
    protected const PATH = '/v3/sources';
