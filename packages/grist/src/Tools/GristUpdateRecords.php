 ...
 */
class GristUpdateRecords implements Tool
{
    /**
    ...
    {
        return 'grist_update_records';
    }

    public function description(): string
    {
        return 'Update one or more existing records in a Grist table.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'records'  => ['type' => 'string', 'required' => true, 'description' => 'JSON array of record updates, each with "id" and "fields" keys (e.g., [{"id":1,"fields":{"Col1":"new"}}]).'],
        ];
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->updateRecords($docId, $tableId, $recordsArray);
