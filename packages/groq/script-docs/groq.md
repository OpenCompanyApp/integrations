...
```js
var result = app.integrations["groq"].create_completion({
...
```js
var response = app.integrations["groq"].create_response({
  payload: {
...
var transcription = app.integrations["groq"].create_transcription({
  payload: {
