...
```ruby
products = app.integrations.gumroad.list_products()
sales = app.integrations.gumroad.list_sales(product_id: "prod_123", after: "2026-01-01T00:00:00Z")
verified = app.integrations.gumroad.verify_license(product_permalink: "my-product", license_key: "AAAA-BBBB-CCCC", increment_uses_count: true)
webhook = app.integrations.gumroad.create_resource_subscription(resource_name: "sale", post_url: "https://example.test/gumroad/webhook")
```
## Coverage Notes
