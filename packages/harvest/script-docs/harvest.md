# Client for the Harvest REST API v2 — JavaScript API Reference
...
```js
var result = app.integrations.harvest.harvest_create_time_entry({
  project_id: 0,
  task_id: 0,
  spent_date: "",
})
...
```js
var result = app.integrations.harvest.harvest_delete_time_entry({
  id: 0,
})
```
...
```js
var result = app.integrations.harvest.harvest_get_current_user({
})
```
## harvest_get_project
...
```js
var result = app.integrations.harvest.harvest_get_project({
  id: 0,
})
```
...
```js
var result = app.integrations.harvest.harvest_get_time_entry({
  id: 0,
})
```
## harvest_get_user
...
```js
var result = app.integrations.harvest.harvest_get_user({
  id: 0,
})
```
...
```js
var result = app.integrations.harvest.harvest_list_clients({
  is_active: true,
  page: 0,
})
```
...
```js
var result = app.integrations.harvest.harvest_list_projects({
  client_id: 0,
  is_active: true,
  page: 0,
})
...
```js
var result = app.integrations.harvest.harvest_list_tasks({
  is_active: true,
  page: 0,
})
```
...
```js
var result = app.integrations.harvest.harvest_list_time_entries({
  user_id: 0,
  client_id: 0,
  project_id: 0,
})
...
```js
var result = app.integrations.harvest.harvest_list_users({
  is_active: true,
  page: 0,
  per_page: 0,
})
...
```js
var result = app.integrations.harvest.harvest_update_time_entry({
  id: 0,
  hours: 0,
  notes: "",
})
...
app.integrations.harvest.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.harvest.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.harvest.work.function_name({ /* parameters */ })
app.integrations.harvest.personal.function_name({ /* parameters */ })
```
