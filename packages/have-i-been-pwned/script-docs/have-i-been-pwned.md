...
```ruby
recent = app.call("integrations.have-i-been-pwned.latest_breach")
breaches = app.call("integrations.have-i-been-pwned.breached_account", account: "person@example.test", truncate_response: false)
range = app.call("integrations.have-i-been-pwned.password_range", prefix: "21BD1", mode: "sha1")
```
