...
/**
 * Send a fail slug ping signal.
 *
 * Maps to the official Healthchecks.io endpoint POST /{ping_key}/{slug}/fail.
 */
class HealthchecksIoPingFailSlug extends AbstractHealthchecksIoTool
{
    protected const NAME = 'healthchecks_io_ping_fail_slug';
    protected const DESCRIPTION = 'Send a fail slug ping signal
...
Official Healthchecks.io endpoint: POST https://hc-ping.com/{ping_key}/{slug}/fail.';
    ...
    protected const PATH = '/{ping_key}/{slug}/fail';
