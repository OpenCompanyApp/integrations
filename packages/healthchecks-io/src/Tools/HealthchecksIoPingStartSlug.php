...
/**
 * Send a start slug ping signal.
 *
 * Maps to the official Healthchecks.io endpoint POST /{ping_key}/{slug}/start.
 */
class HealthchecksIoPingStartSlug extends AbstractHealthchecksIoTool
{
    protected const NAME = 'healthchecks_io_ping_start_slug';
    protected const DESCRIPTION = 'Send a start slug ping signal
...
Official Healthchecks.io endpoint: POST https://hc-ping.com/{ping_key}/{slug}/start.';
    ...
    protected const PATH = '/{ping_key}/{slug}/start';
