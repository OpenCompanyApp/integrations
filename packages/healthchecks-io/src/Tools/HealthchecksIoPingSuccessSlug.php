...
/**
 * Send a success slug ping signal.
 *
 * Maps to the official Healthchecks.io endpoint POST /{ping_key}/{slug}.
 */
class HealthchecksIoPingSuccessSlug extends AbstractHealthchecksIoTool
{
    protected const NAME = 'healthchecks_io_ping_success_slug';
    protected const DESCRIPTION = 'Send a success slug ping signal
...
Official Healthchecks.io endpoint: POST https://hc-ping.com/{ping_key}/{slug}.';
    ...
    protected const PATH = '/{ping_key}/{slug}';
