...
/**
 * Base class for generated Hetzner Cloud OpenAPI operation tools.
 *
 * Handles parameter declarations, configured-state checks, and execution
 * through the shared Hetzner API client.
 */
abstract class AbstractHetznerOperationTool implements Tool
{
    protected const TOOL_NAME = '';

    /**
     * @param  HetznerService  $service  Hetzner Cloud HTTP API client.
     */
    public function __construct(protected HetznerService $service) {}
    ...
    public function parameters(): array
    {
        ...
        if (($this->operation()['request_body'] ?? null) !== null) {
            $parameters['body'] = [
                ...
                'description' => 'Request body for the Hetzner Cloud API operation.',
            ];
        }
    ...
    /**
     * Execute the Hetzner Cloud API operation.
     *
    ...
    {
        $operations = HetznerOperations::all();
