 ...
 *
 * Returns the ticket's ID and all requested properties.
 */
class HubSpotGetTicket implements Tool
{
    /**
    ...
    {
        return 'hubspot_get_ticket';
    }

    public function description(): string
    {
        return <<<'MD'
        Retrieve a HubSpot ticket by its ID.
        Returns the ticket's ID, properties, and associated data.
    ...
    {
        return [
            'id' => ['type' => 'string', 'required' => true, 'description' => 'HubSpot ticket ID.'],
            'properties' => ['type' => 'array', 'description' => 'List of property names to include.'],
        ];
    }

    /**
     * Retrieve a HubSpot ticket by ID with optional property selection.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->getTicket($id, is_array($properties) ? $properties : null);
