 ...
 */
class HubSpotListContacts implements Tool
{
    /**
    ...
    {
        return 'hubspot_list_contacts';
    }

    public function description(): string
    {
        return 'List contacts in HubSpot CRM with cursor-based pagination and optional property selection.';
    }

    public function parameters(): array
    {
        return [
            'limit' => ['type' => 'integer', 'description' => 'Maximum number of contacts to return (default 10, max 100).'],
            'after' => ['type' => 'string', 'description' => 'Pagination cursor from a previous response.'],
            'properties' => ['type' => 'array', 'description' => 'List of contact property names to include.'],
        ];
    }

    /**
     * List HubSpot contacts with optional property selection.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $output = ['results' => $contacts, 'total' => count($contacts)];
