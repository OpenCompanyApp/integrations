 ...
 *
 * Accepts a properties map of fields to update on the company.
 */
class HubSpotUpdateCompany implements Tool
{
    /**
    ...
    {
        return [
            'id' => ['type' => 'string', 'required' => true, 'description' => 'HubSpot company ID to update.'],
            'properties' => ['type' => 'object', 'required' => true, 'description' => 'Key-value map of properties to update.'],
        ];
    }

    /**
     * Update a HubSpot company with new property values.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->updateCompany($id, $properties);
