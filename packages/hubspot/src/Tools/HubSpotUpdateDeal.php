 ...
 *
 * Accepts a properties map of fields to update on the deal.
 */
class HubSpotUpdateDeal implements Tool
{
    /**
    ...
    {
        return [
            'id' => ['type' => 'string', 'required' => true, 'description' => 'HubSpot deal ID to update.'],
            'properties' => ['type' => 'object', 'required' => true, 'description' => 'Key-value map of properties to update.'],
        ];
    }

    /**
     * Update a HubSpot deal with new property values.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->updateDeal($id, $properties);
