# Hugging Face Ruby API Reference
...
```ruby
models = app.call("integrations.hugging-face.list_models", task: "text-generation", sort: "downloads", limit: 10)
```
...
```ruby
model = app.call("integrations.hugging-face.get_model", model_id: "meta-llama/Llama-3.3-70B-Instruct")
dataset = app.call("integrations.hugging-face.get_dataset", dataset_id: "mozilla-foundation/common_voice_17_0")
```
...
```ruby
refs = app.call("integrations.hugging-face.list_refs", repo_type: "models", repo_id: "bert-base-uncased")
commits = app.call("integrations.hugging-face.list_commits", repo_type: "datasets", repo_id: "mozilla-foundation/common_voice_17_0", revision: "main")
files = app.call("integrations.hugging-face.list_tree", repo_type: "spaces", repo_id: "organization/demo-space", revision: "main", path: "src")
```
...
```ruby
repo = app.call("integrations.hugging-face.create_repository", name: "demo-space", type: "space", private: true, sdk: "gradio")
```
## Inference
...
```ruby
result = app.call("integrations.hugging-face.run_inference", model_id: "facebook/bart-large-cnn", inputs: "Long text to summarize...", parameters: {max_new_tokens: 128})
```
...
```ruby
tags = app.call("integrations.hugging-face.api_get", path: "/models-tags-by-type")
```
## Account
