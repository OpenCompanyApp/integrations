# Hugging Face JavaScript API Reference
...
```js
var models = app.integrations["hugging-face"].list_models({
...
```js
var model = app.integrations["hugging-face"].get_model({
  model_id: "meta-llama/Llama-3.3-70B-Instruct",
})

var dataset = app.integrations["hugging-face"].get_dataset({
...
```js
var refs = app.integrations["hugging-face"].list_refs({
  repo_type: "models",
  repo_id: "bert-base-uncased",
})

var commits = app.integrations["hugging-face"].list_commits({
  repo_type: "datasets",
  repo_id: "mozilla-foundation/common_voice_17_0",
  revision: "main",
})

var files = app.integrations["hugging-face"].list_tree({
  repo_type: "spaces",
...
```js
var repo = app.integrations["hugging-face"].create_repo({
  name: "demo-space",
  type: "space",
  private: true,
  sdk: "gradio",
...
```js
var result = app.integrations["hugging-face"].inference({
...
```js
var tags = app.integrations["hugging-face"].api_get({
