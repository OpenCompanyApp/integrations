...
/**
 * Call a relative Hugging Face Hub API PUT endpoint.
 *
 * Intended for official Hub endpoints that are not yet wrapped as first-class tools.
 */
class HuggingFaceApiPut implements Tool
{
    /**
    ...
    {
        return 'huggingface_api_put';
    }

    public function description(): string
    {
        return 'Call a relative Hugging Face Hub API PUT path with a JSON body. Absolute URLs are rejected.';
    }
    ...
    /**
     * Execute a relative PUT request against the Hub API.
     *
