# Immigrant — JavaScript API Reference
...
var result = app.integrations.immigrant.list_applications({
  status: "pending",
  limit: 10,
})

for (const app of (result)) {
  console.log(app.id + ": " + app.applicant_name + " [" + app.status + "]")
}
```
```js
// Paginate through all applications
var page1 = app.integrations.immigrant.list_applications({ limit: 50, page: 1 })
var page2 = app.integrations.immigrant.list_applications({ limit: 50, page: 2 })
```
---
...
```js
var application = app.integrations.immigrant.get_application({ id: "app_abc123" })
console.log(application.applicant_name)
...
var application = app.integrations.immigrant.create_application({
  type: "visa",
...
var docs = app.integrations.immigrant.list_documents({
...
```js
var doc = app.integrations.immigrant.get_document({ id: "doc_xyz789" })
...
```js
var statuses = app.integrations.immigrant.list_statuses({})
...
```js
var user = app.integrations.immigrant.get_current_user({})
