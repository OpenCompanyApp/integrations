 ...
 *
 * Maps to the official incident.io endpoint post /v2/catalog_types/{id}/actions/update_schema.
 */
class IncidentIoCatalogV2UpdateTypeSchema extends AbstractIncidentIoTool
{
    protected const NAME = 'incident_io_catalog_v2_update_type_schema';
    protected const DESCRIPTION = 'UpdateTypeSchema Catalog V2

Official incident.io endpoint: POST /v2/catalog_types/{id}/actions/update_schema
...
means that you need to make a separate call to this endpoint to update the schema.';
  ...
  array (
    ...
    protected const PATH = '/v2/catalog_types/{id}/actions/update_schema';
