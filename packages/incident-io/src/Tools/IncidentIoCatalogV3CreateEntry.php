 ...
 *
 * Maps to the official incident.io endpoint post /v3/catalog_entries.
 */
class IncidentIoCatalogV3CreateEntry extends AbstractIncidentIoTool
{
    protected const NAME = 'incident_io_catalog_v3_create_entry';
    protected const DESCRIPTION = 'CreateEntry Catalog V3

Official incident.io endpoint: POST /v3/catalog_entries
