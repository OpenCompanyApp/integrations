 ...
 * Ping Heartbeat V2.
 *
 * Maps to the official incident.io endpoint post /v2/heartbeat/{alert_source_config_id}/ping.
 */
class IncidentIoHeartbeatV2Ping extends AbstractIncidentIoTool
{
    protected const NAME = 'incident_io_heartbeat_v2_ping';
    protected const DESCRIPTION = 'Ping Heartbeat V2

Official incident.io endpoint: POST /v2/heartbeat/{alert_source_config_id}/ping
