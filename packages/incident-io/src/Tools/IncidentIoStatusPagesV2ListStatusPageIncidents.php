 ...
 *
 * Maps to the official incident.io endpoint get /v2/status_page_incidents.
 */
class IncidentIoStatusPagesV2ListStatusPageIncidents extends AbstractIncidentIoTool
{
    protected const NAME = 'incident_io_status_pages_v2_list_status_page_incidents';
    protected const DESCRIPTION = 'ListStatusPageIncidents Status Pages V2

Official incident.io endpoint: GET /v2/status_page_incidents
