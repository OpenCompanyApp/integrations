# Insightly CRM JavaScript Reference
...
```js
var contact = app.integrations.insightly.create_contact({
  first_name: "Ada",
  last_name: "Example",
...
var contacts = app.integrations.insightly.search_contacts({
  field_name: "EMAIL_ADDRESS",
  field_value: "ada@example.test",
})

var opportunity = app.integrations.insightly.update_opportunity({
  id: 12345,
...
```js
var task = app.integrations.insightly.create_task({
...
var event = app.integrations.insightly.create_event({
...
```js
var fields = app.integrations.insightly.list_custom_fields({
  objectName: "Contacts",
})

var stages = app.integrations.insightly.list_pipeline_stages({})
```
## Return Shape
