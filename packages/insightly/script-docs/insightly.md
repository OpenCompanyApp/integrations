...
```ruby
contact = app.integrations.insightly.create_contact(first_name: "Ada", last_name: "Example", email: "ada@example.test", phone: "+1-555-0100")
contacts = app.integrations.insightly.search_contacts(field_name: "EMAIL_ADDRESS", field_value: "ada@example.test")
opportunity = app.integrations.insightly.update_opportunity(id: 12345, opportunity_name: "Renewal", bid_amount: 25000, opportunity_state: "OPEN")
```
## Activities
...
```ruby
task = app.integrations.insightly.create_task(title: "Send renewal proposal", due_date: "2026-05-20T12:00:00Z", opportunity_id: 12345, responsible_user_id: 678)
event = app.integrations.insightly.create_event(title: "Implementation call", start_date_utc: "2026-05-21T15:00:00Z", end_date_utc: "2026-05-21T15:30:00Z")
```
## Metadata
...
```ruby
fields = app.integrations.insightly.list_custom_fields(object_name: "Contacts")
stages = app.integrations.insightly.list_pipeline_stages()
```
## Return Shape
