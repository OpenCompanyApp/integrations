 ...
 */
class InstantlyGetAccount implements Tool
{
    /**
    ...
    {
        return 'instantly_get_account';
    }

    public function description(): string
    {
        return 'Get an email account by ID with full details including warmup status, sending limits, and vitals.';
    }
