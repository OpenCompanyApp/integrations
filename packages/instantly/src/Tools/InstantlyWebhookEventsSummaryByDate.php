 ...
 */
class InstantlyWebhookEventsSummaryByDate implements Tool
{
    /**
    ...
    {
        return 'instantly_webhook_events_summary_by_date';
    }

    public function description(): string
    {
        return 'Get webhook event aggregates grouped by date.';
    }
