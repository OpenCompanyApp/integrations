...
/**
 * Shared executor for first-class Instapaper tools.
 *
 * Concrete tools define operation metadata while this class validates required
 * arguments, merges payload fields, and delegates API calls to the service.
 */
abstract class AbstractInstapaperTool implements Tool
{
    ...
    public function parameters(): array
    {
        ...
        $parameters['payload'] = ['type' => 'object', 'description' => 'Additional query or form fields for the endpoint.'];

        return $parameters;
    }

    /**
     * Execute the Instapaper operation.
     *
