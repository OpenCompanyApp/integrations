# Invoice Ninja JavaScript API Reference
...
```js
var clients = app.integrations.invoiceninja.list_clients({
  per_page: 25,
  sort: "name|desc",
})

var quote = app.integrations.invoiceninja.create_quote({
  payload: {
...
var task = app.integrations.invoiceninja.update_task({
  id: "task_123",
  payload: {
...
```js
var result = app.integrations.invoiceninja.refund_payment({
  id: "payment_123",
  payload: {
    amount: 25.00,
