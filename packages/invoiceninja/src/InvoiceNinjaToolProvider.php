...
/**
 * Tool provider for the Invoice Ninja integration.
 *
 * Implements ConfigurableIntegration for dynamic configuration and
 * multi-account support via the createTool() method.
 */
class InvoiceNinjaToolProvider implements ToolProvider, ConfigurableIntegration
{
    /**
