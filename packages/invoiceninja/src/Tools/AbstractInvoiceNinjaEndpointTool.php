...
/**
 * Base class for focused Invoice Ninja REST endpoint tools.
 *
 * Handles configuration checks, required parameter validation, endpoint path
 * interpolation, and query/body shaping for one API operation.
 */
abstract class AbstractInvoiceNinjaEndpointTool implements Tool
{
    ...
    /**
     * @param  InvoiceNinjaService  $service  The Invoice Ninja API client.
     */
    public function __construct(
        protected InvoiceNinjaService $service,
    ) {}
    ...
    /**
     * Execute one Invoice Ninja REST API operation.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = match ($this->method) {
                ...
                default => throw new RuntimeException("Unsupported Invoice Ninja tool method: {$this->method}"),
            };
