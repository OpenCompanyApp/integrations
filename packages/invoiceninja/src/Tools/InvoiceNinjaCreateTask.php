 ...
 */
class InvoiceNinjaCreateTask extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_create_task';

    protected string $toolDescription = 'Create an Invoice Ninja task.';
}
