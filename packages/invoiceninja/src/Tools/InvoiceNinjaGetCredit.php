 ...
 */
class InvoiceNinjaGetCredit extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_get_credit';

    protected string $toolDescription = 'Get a single Invoice Ninja credit by ID.';
}
