 ...
 */
class InvoiceNinjaGetProduct extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_get_product';

    protected string $toolDescription = 'Get a single Invoice Ninja product by ID.';
}
