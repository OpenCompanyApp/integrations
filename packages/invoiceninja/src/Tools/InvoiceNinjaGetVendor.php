 ...
 */
class InvoiceNinjaGetVendor extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_get_vendor';

    protected string $toolDescription = 'Get a single Invoice Ninja vendor by ID.';
}
