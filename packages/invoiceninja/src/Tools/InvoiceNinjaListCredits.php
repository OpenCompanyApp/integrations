 ...
 */
class InvoiceNinjaListCredits extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_credits';

    protected string $toolDescription = 'List Invoice Ninja credits with optional filters and pagination.';
}
