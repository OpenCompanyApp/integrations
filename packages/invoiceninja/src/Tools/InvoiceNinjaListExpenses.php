 ...
 */
class InvoiceNinjaListExpenses extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_expenses';

    protected string $toolDescription = 'List Invoice Ninja expenses with optional filters and pagination.';
}
