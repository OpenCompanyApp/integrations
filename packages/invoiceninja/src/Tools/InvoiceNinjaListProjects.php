 ...
 */
class InvoiceNinjaListProjects extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_projects';

    protected string $toolDescription = 'List Invoice Ninja projects with optional filters and pagination.';
}
