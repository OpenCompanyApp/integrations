 ...
 */
class InvoiceNinjaListQuotes extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_quotes';

    protected string $toolDescription = 'List Invoice Ninja quotes with optional filters and pagination.';
}
