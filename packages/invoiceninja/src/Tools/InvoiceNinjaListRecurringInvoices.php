 ...
 */
class InvoiceNinjaListRecurringInvoices extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_recurring_invoices';

    protected string $toolDescription = 'List Invoice Ninja recurring invoices with optional filters and pagination.';
}
