 ...
 */
class InvoiceNinjaListTasks extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_tasks';

    protected string $toolDescription = 'List Invoice Ninja tasks with optional filters and pagination.';
}
