 ...
 */
class InvoiceNinjaListTaxRates extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_tax_rates';

    protected string $toolDescription = 'List Invoice Ninja tax rates with optional filters and pagination.';
}
