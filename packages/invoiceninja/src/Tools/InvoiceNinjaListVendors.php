 ...
 */
class InvoiceNinjaListVendors extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_list_vendors';

    protected string $toolDescription = 'List Invoice Ninja vendors with optional filters and pagination.';
}
