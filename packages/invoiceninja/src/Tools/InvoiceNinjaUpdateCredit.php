 ...
 */
class InvoiceNinjaUpdateCredit extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_update_credit';

    protected string $toolDescription = 'Update an Invoice Ninja credit by ID.';
}
