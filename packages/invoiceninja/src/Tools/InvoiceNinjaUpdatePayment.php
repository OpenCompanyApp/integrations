 ...
 */
class InvoiceNinjaUpdatePayment extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_update_payment';

    protected string $toolDescription = 'Update an Invoice Ninja payment by ID.';
}
