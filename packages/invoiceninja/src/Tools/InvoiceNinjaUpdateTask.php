 ...
 */
class InvoiceNinjaUpdateTask extends AbstractInvoiceNinjaEndpointTool
{
    ...
    protected string $toolName = 'invoiceninja_update_task';

    protected string $toolDescription = 'Update an Invoice Ninja task by ID.';
}
