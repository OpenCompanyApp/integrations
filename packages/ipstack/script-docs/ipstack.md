...
```js
var result = app.integrations.ipstack.lookup_ip({
  ip: "134.201.250.155",
...
```js
var result = app.integrations.ipstack.lookup_bulk({
...
```js
var result = app.integrations.ipstack.lookup_requester({
