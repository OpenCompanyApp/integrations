 ...
 *
 * Accepts a statement and context, then verifies whether the statement is
 * supported by the context using Jina AI's Grounding endpoint.
 *
...
class JinaAIGround implements Tool
{
    ...
    public function parameters(): array
    {
        return [
            ...
            'context' => ['type' => 'string', 'required' => true, 'description' => 'The reference context text to ground the statement against.'],
        ];
    }
     ...
     *
     * @param  array<string, mixed>  $args  Tool arguments (must contain 'statement' and 'context')
