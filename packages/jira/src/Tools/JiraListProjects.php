 ...
 */
class JiraListProjects implements Tool
{
    ...
    {
        return 'List Jira projects accessible to the authenticated user. Supports pagination with start_at and max_results.';
    }
    ...
    /**
     * Retrieve a paginated list of Jira projects.
     *
