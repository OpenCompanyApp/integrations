...
/**
 * Tool to create a new Kafka topic.
 *
 * Supports specifying topic name, partition count, replication factor, and configuration.
 */
class KafkaCreateTopic implements Tool
{
    /**
     * Create a new KafkaCreateTopic tool instance.
     *
    ...
    {
        return 'Create a new Kafka topic in a cluster. Specify the topic name, partition count, and optional replication factor and configs.';
    }
