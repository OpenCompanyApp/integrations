 ...
 * Delete the mapper.
 *
 * Maps to DELETE /admin/realms/{realm}/client-scopes/{client-scope-id}/protocol-mappers/models/{id} in the official Keycloak Admin REST API.
 */
class KeycloakDeleteAdminRealmsRealmClientScopesClientScopeIdProtocolMappersModelsId extends AbstractKeycloakTool
{
