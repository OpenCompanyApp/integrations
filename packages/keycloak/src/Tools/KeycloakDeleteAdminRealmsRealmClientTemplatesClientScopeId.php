 ...
 *
 * Maps to DELETE /admin/realms/{realm}/client-templates/{client-scope-id} in the official Keycloak Admin REST API.
 */
class KeycloakDeleteAdminRealmsRealmClientTemplatesClientScopeId extends AbstractKeycloakTool
{
