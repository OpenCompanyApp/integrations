 ...
 *
 * Maps to DELETE /admin/realms/{realm}/client-templates/{client-scope-id}/scope-mappings/clients/{client} in the official Keycloak Admin REST API.
 */
class KeycloakDeleteAdminRealmsRealmClientTemplatesClientScopeIdScopeMappingsClientsClient extends AbstractKeycloakTool
{
