 ...
 *
 * Maps to DELETE /admin/realms/{realm}/client-templates/{client-scope-id}/scope-mappings/realm in the official Keycloak Admin REST API.
 */
class KeycloakDeleteAdminRealmsRealmClientTemplatesClientScopeIdScopeMappingsRealm extends AbstractKeycloakTool
{
