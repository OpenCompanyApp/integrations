 ...
 * Get mappers.
 *
 * Maps to GET /admin/realms/{realm}/client-scopes/{client-scope-id}/protocol-mappers/models in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientScopesClientScopeIdProtocolMappersModels extends AbstractKeycloakTool
{
