 ...
 *
 * Maps to GET /admin/realms/{realm}/client-scopes/{client-scope-id}/scope-mappings/realm/available in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientScopesClientScopeIdScopeMappingsRealmAvailable extends AbstractKeycloakTool
{
