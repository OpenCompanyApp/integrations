 ...
 * Get mapper by id.
 *
 * Maps to GET /admin/realms/{realm}/client-templates/{client-scope-id}/protocol-mappers/models/{id} in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientTemplatesClientScopeIdProtocolMappersModelsId extends AbstractKeycloakTool
{
