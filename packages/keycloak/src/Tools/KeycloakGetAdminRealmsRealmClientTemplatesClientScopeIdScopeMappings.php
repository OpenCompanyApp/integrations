 ...
 *
 * Maps to GET /admin/realms/{realm}/client-templates/{client-scope-id}/scope-mappings in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientTemplatesClientScopeIdScopeMappings extends AbstractKeycloakTool
{
