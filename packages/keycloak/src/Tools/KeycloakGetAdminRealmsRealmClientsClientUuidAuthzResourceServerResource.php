 ...
 *
 * Maps to GET /admin/realms/{realm}/clients/{client-uuid}/authz/resource-server/resource in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientsClientUuidAuthzResourceServerResource extends AbstractKeycloakTool
{
