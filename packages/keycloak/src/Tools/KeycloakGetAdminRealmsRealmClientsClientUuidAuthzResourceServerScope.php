 ...
 *
 * Maps to GET /admin/realms/{realm}/clients/{client-uuid}/authz/resource-server/scope in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientsClientUuidAuthzResourceServerScope extends AbstractKeycloakTool
{
