 ...
 *
 * Maps to GET /admin/realms/{realm}/clients/{client-uuid}/roles/{role-name}/groups in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmClientsClientUuidRolesRoleNameGroups extends AbstractKeycloakTool
{
