 ...
 *
 * Maps to GET /admin/realms/{realm}/groups/{group-id}/role-mappings/clients/{client-id}/composite in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmGroupsGroupIdRoleMappingsClientsClientIdComposite extends AbstractKeycloakTool
{
