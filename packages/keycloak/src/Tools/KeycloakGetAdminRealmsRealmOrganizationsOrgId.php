 ...
 *
 * Maps to GET /admin/realms/{realm}/organizations/{org-id} in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmOrganizationsOrgId extends AbstractKeycloakTool
{
