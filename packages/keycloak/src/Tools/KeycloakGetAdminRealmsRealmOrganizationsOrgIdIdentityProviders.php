 ...
 *
 * Maps to GET /admin/realms/{realm}/organizations/{org-id}/identity-providers in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmOrganizationsOrgIdIdentityProviders extends AbstractKeycloakTool
{
