 ...
 *
 * Maps to GET /admin/realms/{realm}/roles-by-id/{role-id}/composites/clients/{clientUuid} in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmRolesByIdRoleIdCompositesClientsClientUuid extends AbstractKeycloakTool
{
