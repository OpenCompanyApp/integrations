 ...
 *
 * Maps to GET /admin/realms/{realm}/roles/{role-name}/users in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmRolesRoleNameUsers extends AbstractKeycloakTool
{
