 ...
 *
 * Maps to GET /admin/realms/{realm}/users/{user-id}/consents in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmUsersUserIdConsents extends AbstractKeycloakTool
{
