 ...
 * Get role mappings.
 *
 * Maps to GET /admin/realms/{realm}/users/{user-id}/role-mappings in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmUsersUserIdRoleMappings extends AbstractKeycloakTool
{
