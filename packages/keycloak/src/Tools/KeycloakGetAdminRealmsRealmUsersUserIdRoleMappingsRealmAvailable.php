 ...
 *
 * Maps to GET /admin/realms/{realm}/users/{user-id}/role-mappings/realm/available in the official Keycloak Admin REST API.
 */
class KeycloakGetAdminRealmsRealmUsersUserIdRoleMappingsRealmAvailable extends AbstractKeycloakTool
{
