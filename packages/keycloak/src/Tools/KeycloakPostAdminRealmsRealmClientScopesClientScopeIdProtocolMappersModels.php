 ...
 * Create a mapper.
 *
 * Maps to POST /admin/realms/{realm}/client-scopes/{client-scope-id}/protocol-mappers/models in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientScopesClientScopeIdProtocolMappersModels extends AbstractKeycloakTool
{
