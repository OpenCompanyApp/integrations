 ...
 *
 * Maps to POST /admin/realms/{realm}/client-scopes/{client-scope-id}/scope-mappings/clients/{client} in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientScopesClientScopeIdScopeMappingsClientsClient extends AbstractKeycloakTool
{
