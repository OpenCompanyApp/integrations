 ...
 *
 * Maps to POST /admin/realms/{realm}/client-templates in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientTemplates extends AbstractKeycloakTool
{
