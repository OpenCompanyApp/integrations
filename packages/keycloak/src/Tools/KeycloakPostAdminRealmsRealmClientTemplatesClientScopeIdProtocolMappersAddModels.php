 ...
 *
 * Maps to POST /admin/realms/{realm}/client-templates/{client-scope-id}/protocol-mappers/add-models in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientTemplatesClientScopeIdProtocolMappersAddModels extends AbstractKeycloakTool
{
