 ...
 *
 * Maps to POST /admin/realms/{realm}/client-templates/{client-scope-id}/scope-mappings/realm in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientTemplatesClientScopeIdScopeMappingsRealm extends AbstractKeycloakTool
{
