 ...
 * Create a mapper.
 *
 * Maps to POST /admin/realms/{realm}/clients/{client-uuid}/protocol-mappers/models in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientsClientUuidProtocolMappersModels extends AbstractKeycloakTool
{
