 ...
 *
 * Maps to POST /admin/realms/{realm}/clients/{client-uuid}/roles in the official Keycloak Admin REST API.
 */
class KeycloakPostAdminRealmsRealmClientsClientUuidRoles extends AbstractKeycloakTool
{
