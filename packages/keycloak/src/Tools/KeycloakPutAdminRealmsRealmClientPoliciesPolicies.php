 ...
 *
 * Maps to PUT /admin/realms/{realm}/client-policies/policies in the official Keycloak Admin REST API.
 */
class KeycloakPutAdminRealmsRealmClientPoliciesPolicies extends AbstractKeycloakTool
{
