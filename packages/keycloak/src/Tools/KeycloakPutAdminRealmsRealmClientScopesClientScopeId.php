 ...
 *
 * Maps to PUT /admin/realms/{realm}/client-scopes/{client-scope-id} in the official Keycloak Admin REST API.
 */
class KeycloakPutAdminRealmsRealmClientScopesClientScopeId extends AbstractKeycloakTool
{
