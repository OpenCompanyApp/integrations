 ...
 * Update the mapper.
 *
 * Maps to PUT /admin/realms/{realm}/client-scopes/{client-scope-id}/protocol-mappers/models/{id} in the official Keycloak Admin REST API.
 */
class KeycloakPutAdminRealmsRealmClientScopesClientScopeIdProtocolMappersModelsId extends AbstractKeycloakTool
{
