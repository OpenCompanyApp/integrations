 ...
 *
 * Maps to PUT /admin/realms/{realm}/clients/{client-uuid}/authz/resource-server in the official Keycloak Admin REST API.
 */
class KeycloakPutAdminRealmsRealmClientsClientUuidAuthzResourceServer extends AbstractKeycloakTool
{
