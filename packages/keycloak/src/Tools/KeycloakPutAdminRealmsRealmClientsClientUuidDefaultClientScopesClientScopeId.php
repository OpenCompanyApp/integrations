 ...
 *
 * Maps to PUT /admin/realms/{realm}/clients/{client-uuid}/default-client-scopes/{clientScopeId} in the official Keycloak Admin REST API.
 */
class KeycloakPutAdminRealmsRealmClientsClientUuidDefaultClientScopesClientScopeId extends AbstractKeycloakTool
{
