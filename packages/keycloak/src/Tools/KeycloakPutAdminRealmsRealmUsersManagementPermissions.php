 ...
 *
 * Maps to PUT /admin/realms/{realm}/users-management-permissions in the official Keycloak Admin REST API.
 */
class KeycloakPutAdminRealmsRealmUsersManagementPermissions extends AbstractKeycloakTool
{
