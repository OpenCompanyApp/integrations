# Client for the Klaviyo v2 REST API covering profiles, events, lists, flows, and campaigns — JavaScript API Reference
...
```js
var result = app.integrations.klaviyo.klaviyo_create_event({
  profile_id: "",
  event_name: "",
  properties: "",
})
...
```js
var result = app.integrations.klaviyo.klaviyo_create_list({
  name: "",
})
```
...
```js
var result = app.integrations.klaviyo.klaviyo_create_profile({
  email: "",
  phone_number: "",
  first_name: "",
})
...
```js
var result = app.integrations.klaviyo.klaviyo_get_event({
  event_id: "",
})
```
## klaviyo_get_flow
...
```js
var result = app.integrations.klaviyo.klaviyo_get_flow({
  flow_id: "",
})
```
## klaviyo_get_list
...
```js
var result = app.integrations.klaviyo.klaviyo_get_list({
  list_id: "",
})
```
## klaviyo_get_profile
...
```js
var result = app.integrations.klaviyo.klaviyo_get_profile({
  profile_id: "",
})
```
...
```js
var result = app.integrations.klaviyo.klaviyo_list_campaigns({
  limit: 0,
  page_cursor: "",
})
```
...
```js
var result = app.integrations.klaviyo.klaviyo_list_events({
  filter: "",
  limit: 0,
  page_cursor: "",
})
...
```js
var result = app.integrations.klaviyo.klaviyo_list_flows({
  limit: 0,
  page_cursor: "",
})
```
...
```js
var result = app.integrations.klaviyo.klaviyo_list_list_profiles({
  list_id: "",
  limit: 0,
  page_cursor: "",
})
...
```js
var result = app.integrations.klaviyo.klaviyo_list_lists({
  limit: 0,
  page_cursor: "",
})
```
...
```js
var result = app.integrations.klaviyo.klaviyo_list_profiles({
  limit: 0,
  page_cursor: "",
})
```
...
```js
var result = app.integrations.klaviyo.klaviyo_subscribe_profile({
  list_id: "",
  email: "",
  phone_number: "",
})
...
```js
var result = app.integrations.klaviyo.klaviyo_update_profile({
  profile_id: "",
  email: "",
  phone_number: "",
})
...
app.integrations.klaviyo.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.klaviyo.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.klaviyo.work.function_name({ /* parameters */ })
app.integrations.klaviyo.personal.function_name({ /* parameters */ })
```
