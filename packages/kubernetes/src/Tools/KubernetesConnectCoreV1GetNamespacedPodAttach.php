...
/**
 * Connect core v 1 get namespaced pod attach.
 *
 * Maps to the official Kubernetes endpoint get /api/v1/namespaces/{namespace}/pods/{name}/attach.
 */
class KubernetesConnectCoreV1GetNamespacedPodAttach extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_connect_core_v1_get_namespaced_pod_attach';
    protected const DESCRIPTION = 'Connect core v 1 get namespaced pod attach

Official Kubernetes endpoint: GET /api/v1/namespaces/{namespace}/pods/{name}/attach
