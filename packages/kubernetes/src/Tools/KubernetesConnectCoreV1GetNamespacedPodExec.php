...
/**
 * Connect core v 1 get namespaced pod exec.
 *
 * Maps to the official Kubernetes endpoint get /api/v1/namespaces/{namespace}/pods/{name}/exec.
 */
class KubernetesConnectCoreV1GetNamespacedPodExec extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_connect_core_v1_get_namespaced_pod_exec';
    protected const DESCRIPTION = 'Connect core v 1 get namespaced pod exec

Official Kubernetes endpoint: GET /api/v1/namespaces/{namespace}/pods/{name}/exec
