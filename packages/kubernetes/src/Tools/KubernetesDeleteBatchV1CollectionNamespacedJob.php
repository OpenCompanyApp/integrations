...
/**
 * Delete batch v 1 collection namespaced job.
 *
 * Maps to the official Kubernetes endpoint delete /apis/batch/v1/namespaces/{namespace}/jobs.
 */
class KubernetesDeleteBatchV1CollectionNamespacedJob extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_batch_v1_collection_namespaced_job';
    protected const DESCRIPTION = 'Delete batch v 1 collection namespaced job

Official Kubernetes endpoint: DELETE /apis/batch/v1/namespaces/{namespace}/jobs
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/batch/v1/namespaces/{namespace}/jobs';
