...
/**
 * Delete core v 1 collection namespaced event.
 *
 * Maps to the official Kubernetes endpoint delete /api/v1/namespaces/{namespace}/events.
 */
class KubernetesDeleteCoreV1CollectionNamespacedEvent extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_core_v1_collection_namespaced_event';
    protected const DESCRIPTION = 'Delete core v 1 collection namespaced event

Official Kubernetes endpoint: DELETE /api/v1/namespaces/{namespace}/events
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/events';
