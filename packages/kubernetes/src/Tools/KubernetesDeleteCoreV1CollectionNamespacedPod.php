...
/**
 * Delete core v 1 collection namespaced pod.
 *
 * Maps to the official Kubernetes endpoint delete /api/v1/namespaces/{namespace}/pods.
 */
class KubernetesDeleteCoreV1CollectionNamespacedPod extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_core_v1_collection_namespaced_pod';
    protected const DESCRIPTION = 'Delete core v 1 collection namespaced pod

Official Kubernetes endpoint: DELETE /api/v1/namespaces/{namespace}/pods
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/pods';
