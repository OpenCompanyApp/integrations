...
/**
 * Delete core v 1 collection namespaced secret.
 *
 * Maps to the official Kubernetes endpoint delete /api/v1/namespaces/{namespace}/secrets.
 */
class KubernetesDeleteCoreV1CollectionNamespacedSecret extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_core_v1_collection_namespaced_secret';
    protected const DESCRIPTION = 'Delete core v 1 collection namespaced secret

Official Kubernetes endpoint: DELETE /api/v1/namespaces/{namespace}/secrets
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/secrets';
