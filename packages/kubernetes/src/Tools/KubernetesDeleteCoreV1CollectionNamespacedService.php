...
/**
 * Delete core v 1 collection namespaced service.
 *
 * Maps to the official Kubernetes endpoint delete /api/v1/namespaces/{namespace}/services.
 */
class KubernetesDeleteCoreV1CollectionNamespacedService extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_core_v1_collection_namespaced_service';
    protected const DESCRIPTION = 'Delete core v 1 collection namespaced service

Official Kubernetes endpoint: DELETE /api/v1/namespaces/{namespace}/services
