...
/**
 * Delete core v 1 collection node.
 *
 * Maps to the official Kubernetes endpoint delete /api/v1/nodes.
 */
class KubernetesDeleteCoreV1CollectionNode extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_core_v1_collection_node';
    protected const DESCRIPTION = 'Delete core v 1 collection node

Official Kubernetes endpoint: DELETE /api/v1/nodes
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/api/v1/nodes';
