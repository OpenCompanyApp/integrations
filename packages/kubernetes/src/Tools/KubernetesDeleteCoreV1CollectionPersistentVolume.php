...
/**
 * Delete core v 1 collection persistent volume.
 *
 * Maps to the official Kubernetes endpoint delete /api/v1/persistentvolumes.
 */
class KubernetesDeleteCoreV1CollectionPersistentVolume extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_core_v1_collection_persistent_volume';
    protected const DESCRIPTION = 'Delete core v 1 collection persistent volume

Official Kubernetes endpoint: DELETE /api/v1/persistentvolumes
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/api/v1/persistentvolumes';
