...
/**
 * Delete flowcontrol apiserver v 1 collection priority level configuration.
 *
 * Maps to the official Kubernetes endpoint delete /apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations.
 */
class KubernetesDeleteFlowcontrolApiserverV1CollectionPriorityLevelConfiguration extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_flowcontrol_apiserver_v1_collection_priority_level_configuration';
    protected const DESCRIPTION = 'Delete flowcontrol apiserver v 1 collection priority level configuration
