...
/**
 * Delete networking v 1 collection ipaddress.
 *
 * Maps to the official Kubernetes endpoint delete /apis/networking.k8s.io/v1/ipaddresses.
 */
class KubernetesDeleteNetworkingV1CollectionIpaddress extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_networking_v1_collection_ipaddress';
    protected const DESCRIPTION = 'Delete networking v 1 collection ipaddress

Official Kubernetes endpoint: DELETE /apis/networking.k8s.io/v1/ipaddresses
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/networking.k8s.io/v1/ipaddresses';
