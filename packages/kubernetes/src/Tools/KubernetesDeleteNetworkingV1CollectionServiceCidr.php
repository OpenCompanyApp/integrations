...
/**
 * Delete networking v 1 collection service cidr.
 *
 * Maps to the official Kubernetes endpoint delete /apis/networking.k8s.io/v1/servicecidrs.
 */
class KubernetesDeleteNetworkingV1CollectionServiceCidr extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_networking_v1_collection_service_cidr';
    protected const DESCRIPTION = 'Delete networking v 1 collection service cidr

Official Kubernetes endpoint: DELETE /apis/networking.k8s.io/v1/servicecidrs
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/networking.k8s.io/v1/servicecidrs';
