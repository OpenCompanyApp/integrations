...
/**
 * Delete node v 1 collection runtime class.
 *
 * Maps to the official Kubernetes endpoint delete /apis/node.k8s.io/v1/runtimeclasses.
 */
class KubernetesDeleteNodeV1CollectionRuntimeClass extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_node_v1_collection_runtime_class';
    protected const DESCRIPTION = 'Delete node v 1 collection runtime class

Official Kubernetes endpoint: DELETE /apis/node.k8s.io/v1/runtimeclasses
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/node.k8s.io/v1/runtimeclasses';
