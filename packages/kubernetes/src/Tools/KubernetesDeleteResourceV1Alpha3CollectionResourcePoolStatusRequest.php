...
/**
 * Delete resource v 1 alpha 3 collection resource pool status request.
 *
 * Maps to the official Kubernetes endpoint delete /apis/resource.k8s.io/v1alpha3/resourcepoolstatusrequests.
 */
class KubernetesDeleteResourceV1Alpha3CollectionResourcePoolStatusRequest extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_resource_v1_alpha3_collection_resource_pool_status_request';
    protected const DESCRIPTION = 'Delete resource v 1 alpha 3 collection resource pool status request
