...
/**
 * Delete resource v 1 beta 1 collection device class.
 *
 * Maps to the official Kubernetes endpoint delete /apis/resource.k8s.io/v1beta1/deviceclasses.
 */
class KubernetesDeleteResourceV1Beta1CollectionDeviceClass extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_resource_v1_beta1_collection_device_class';
    protected const DESCRIPTION = 'Delete resource v 1 beta 1 collection device class

Official Kubernetes endpoint: DELETE /apis/resource.k8s.io/v1beta1/deviceclasses
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/resource.k8s.io/v1beta1/deviceclasses';
