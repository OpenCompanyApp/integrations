...
/**
 * Delete storage v 1 collection csidriver.
 *
 * Maps to the official Kubernetes endpoint delete /apis/storage.k8s.io/v1/csidrivers.
 */
class KubernetesDeleteStorageV1CollectionCsidriver extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_storage_v1_collection_csidriver';
    protected const DESCRIPTION = 'Delete storage v 1 collection csidriver

Official Kubernetes endpoint: DELETE /apis/storage.k8s.io/v1/csidrivers
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/storage.k8s.io/v1/csidrivers';
