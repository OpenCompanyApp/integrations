...
/**
 * Delete storage v 1 collection csinode.
 *
 * Maps to the official Kubernetes endpoint delete /apis/storage.k8s.io/v1/csinodes.
 */
class KubernetesDeleteStorageV1CollectionCsinode extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_storage_v1_collection_csinode';
    protected const DESCRIPTION = 'Delete storage v 1 collection csinode

Official Kubernetes endpoint: DELETE /apis/storage.k8s.io/v1/csinodes
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/storage.k8s.io/v1/csinodes';
