...
/**
 * Delete storage v 1 collection storage class.
 *
 * Maps to the official Kubernetes endpoint delete /apis/storage.k8s.io/v1/storageclasses.
 */
class KubernetesDeleteStorageV1CollectionStorageClass extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_delete_storage_v1_collection_storage_class';
    protected const DESCRIPTION = 'Delete storage v 1 collection storage class

Official Kubernetes endpoint: DELETE /apis/storage.k8s.io/v1/storageclasses
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/storage.k8s.io/v1/storageclasses';
