...
/**
 * List core v 1 namespace.
 *
 * Maps to the official Kubernetes endpoint get /api/v1/namespaces.
 */
class KubernetesListCoreV1Namespace extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_list_core_v1_namespace';
    protected const DESCRIPTION = 'List core v 1 namespace

Official Kubernetes endpoint: GET /api/v1/namespaces
