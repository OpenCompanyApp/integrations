 ...
 *
 * Maps to the official Kubernetes endpoint get /api/v1/namespaces/{namespace}/services.
 */
class KubernetesListCoreV1NamespacedService extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_list_core_v1_namespaced_service';
    protected const DESCRIPTION = 'List core v 1 namespaced service

Official Kubernetes endpoint: GET /api/v1/namespaces/{namespace}/services
