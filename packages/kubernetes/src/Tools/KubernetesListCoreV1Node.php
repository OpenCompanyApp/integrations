 ...
 * List core v 1 node.
 *
 * Maps to the official Kubernetes endpoint get /api/v1/nodes.
 */
class KubernetesListCoreV1Node extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_list_core_v1_node';
    protected const DESCRIPTION = 'List core v 1 node

Official Kubernetes endpoint: GET /api/v1/nodes
