...
/**
 * Watch networking v 1 ipaddress.
 *
 * Maps to the official Kubernetes endpoint get /apis/networking.k8s.io/v1/watch/ipaddresses/{name}.
 */
class KubernetesWatchNetworkingV1Ipaddress extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_watch_networking_v1_ipaddress';
    protected const DESCRIPTION = 'Watch networking v 1 ipaddress

Official Kubernetes endpoint: GET /apis/networking.k8s.io/v1/watch/ipaddresses/{name}
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/networking.k8s.io/v1/watch/ipaddresses/{name}';
