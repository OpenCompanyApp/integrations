...
/**
 * Watch networking v 1 service cidr.
 *
 * Maps to the official Kubernetes endpoint get /apis/networking.k8s.io/v1/watch/servicecidrs/{name}.
 */
class KubernetesWatchNetworkingV1ServiceCidr extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_watch_networking_v1_service_cidr';
    protected const DESCRIPTION = 'Watch networking v 1 service cidr

Official Kubernetes endpoint: GET /apis/networking.k8s.io/v1/watch/servicecidrs/{name}
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/networking.k8s.io/v1/watch/servicecidrs/{name}';
