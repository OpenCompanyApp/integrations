...
/**
 * Watch node v 1 runtime class.
 *
 * Maps to the official Kubernetes endpoint get /apis/node.k8s.io/v1/watch/runtimeclasses/{name}.
 */
class KubernetesWatchNodeV1RuntimeClass extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_watch_node_v1_runtime_class';
    protected const DESCRIPTION = 'Watch node v 1 runtime class

Official Kubernetes endpoint: GET /apis/node.k8s.io/v1/watch/runtimeclasses/{name}
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/node.k8s.io/v1/watch/runtimeclasses/{name}';
