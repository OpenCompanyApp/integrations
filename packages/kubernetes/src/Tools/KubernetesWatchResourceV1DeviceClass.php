...
/**
 * Watch resource v 1 device class.
 *
 * Maps to the official Kubernetes endpoint get /apis/resource.k8s.io/v1/watch/deviceclasses/{name}.
 */
class KubernetesWatchResourceV1DeviceClass extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_watch_resource_v1_device_class';
    protected const DESCRIPTION = 'Watch resource v 1 device class

Official Kubernetes endpoint: GET /apis/resource.k8s.io/v1/watch/deviceclasses/{name}
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/resource.k8s.io/v1/watch/deviceclasses/{name}';
