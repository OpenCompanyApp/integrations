...
/**
 * Watch resource v 1 resource slice.
 *
 * Maps to the official Kubernetes endpoint get /apis/resource.k8s.io/v1/watch/resourceslices/{name}.
 */
class KubernetesWatchResourceV1ResourceSlice extends AbstractKubernetesTool
{
    protected const NAME = 'kubernetes_watch_resource_v1_resource_slice';
    protected const DESCRIPTION = 'Watch resource v 1 resource slice

Official Kubernetes endpoint: GET /apis/resource.k8s.io/v1/watch/resourceslices/{name}
...
This is an alpha field and requires enabling the ShardedListAndWatch feature gate.',
  ...
  array (
    ...
    protected const PATH = '/apis/resource.k8s.io/v1/watch/resourceslices/{name}';
