...
```ruby
app.integrations.langfuse.ingest_batch(body: {batch: [{id: "event-1", type: "trace-create", timestamp: "2026-01-01T00:00:00.000Z", body: {id: "trace-1", name: "support-agent", userId: "user-123"}}]})
```
