...
```ruby
sessions = app.call("integrations.langsmith.langsmith_read_tracer_sessions", limit: 10)

# POST /runs queues ingestion. Keep the ID you send; do not expect its response
# to contain a persisted run or an `id` field.
run_id = "00000000-0000-4000-8000-000000000001"
app.call("integrations.langsmith.langsmith_post_runs", body: {id: run_id, name: "support-agent", run_type: "chain", inputs: {question: "hello"}, start_time: "2026-05-06T10:00:00Z"})
feedback = app.call("integrations.langsmith.langsmith_create_feedback", body: {run_id: run_id, key: "quality", score: 1})
```
## Multi-Account Usage

```ruby
app.call("integrations.langsmith.langsmith_read_datasets")
app.call("integrations.langsmith.default.langsmith_read_datasets")
app.call("integrations.langsmith.production.langsmith_read_datasets")
```
## LangSmith
