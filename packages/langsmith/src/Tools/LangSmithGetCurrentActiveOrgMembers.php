 ...
 *
 * Maps to the official LangSmith endpoint GET /api/v1/orgs/current/members/active.
 */
class LangSmithGetCurrentActiveOrgMembers extends AbstractLangSmithTool
{
    protected const NAME = 'langsmith_get_current_active_org_members';
    protected const DESCRIPTION = 'Get Current Active Org Members

Official endpoint: GET /api/v1/orgs/current/members/active
Get Current Active Org Members.';
  ...
  array (
    ...
    protected const PATH = '/api/v1/orgs/current/members/active';
