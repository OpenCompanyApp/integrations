 ...
 *
 * Maps to the official LangSmith endpoint GET /api/v1/public/{share_token}/feedbacks.
 */
class LangSmithReadSharedFeedbacks extends AbstractLangSmithTool
{
    protected const NAME = 'langsmith_read_shared_feedbacks';
    protected const DESCRIPTION = 'Read Shared Feedbacks

Official endpoint: GET /api/v1/public/{share_token}/feedbacks
Read Shared Feedbacks.';
  ...
  array (
    ...
    protected const PATH = '/api/v1/public/{share_token}/feedbacks';
