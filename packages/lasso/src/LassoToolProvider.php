...
/**
 * Tool provider for Lasso CRM integration.
 *
 * Implements ConfigurableIntegration for multi-account support, config schema,
 * connection testing, and credential field definitions. Registers all Lasso
 * CRM tools (contacts, deals, inventory, user).
 */
class LassoToolProvider implements ToolProvider, ConfigurableIntegration
{
    /**
