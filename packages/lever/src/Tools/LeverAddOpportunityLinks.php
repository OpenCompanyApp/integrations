 ...
 */
class LeverAddOpportunityLinks extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_add_opportunity_links';
    protected const TOOL_DESCRIPTION = 'Add links to an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/addLinks.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/addLinks';
