 ...
 */
class LeverAddOpportunitySources extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_add_opportunity_sources';
    protected const TOOL_DESCRIPTION = 'Add sources to an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/addSources.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/addSources';
