 ...
 */
class LeverAddOpportunityTags extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_add_opportunity_tags';
    protected const TOOL_DESCRIPTION = 'Add tags to an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/addTags.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/addTags';
