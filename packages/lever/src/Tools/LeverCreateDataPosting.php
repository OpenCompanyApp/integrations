 ...
 */
class LeverCreateDataPosting extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_data_posting';
    protected const TOOL_DESCRIPTION = 'Create a Lever posting. Official Lever Data API endpoint: POST /postings.';
