 ...
 */
class LeverCreateFeedbackTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_feedback_template';
    protected const TOOL_DESCRIPTION = 'Create a feedback template. Official Lever Data API endpoint: POST /feedback_templates.';
