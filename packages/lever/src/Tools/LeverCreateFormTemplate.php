 ...
 */
class LeverCreateFormTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_form_template';
    protected const TOOL_DESCRIPTION = 'Create a form template. Official Lever Data API endpoint: POST /form_templates.';
    protected const METHOD = 'POST';
    protected const PATH = '/form_templates';
