 ...
 */
class LeverCreateOpportunity extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity';
    protected const TOOL_DESCRIPTION = 'Create a Lever opportunity. Official Lever Data API endpoint: POST /opportunities.';
