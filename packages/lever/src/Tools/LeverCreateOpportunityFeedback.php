 ...
 */
class LeverCreateOpportunityFeedback extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity_feedback';
    protected const TOOL_DESCRIPTION = 'Create feedback for an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/feedback.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/feedback';
