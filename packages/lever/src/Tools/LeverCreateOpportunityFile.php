 ...
 */
class LeverCreateOpportunityFile extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity_file';
    protected const TOOL_DESCRIPTION = 'Attach file metadata to an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/files.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/files';
