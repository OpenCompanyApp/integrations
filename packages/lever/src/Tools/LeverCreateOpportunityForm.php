 ...
 */
class LeverCreateOpportunityForm extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity_form';
    protected const TOOL_DESCRIPTION = 'Create an opportunity form. Official Lever Data API endpoint: POST /opportunities/{opportunity}/forms.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/forms';
