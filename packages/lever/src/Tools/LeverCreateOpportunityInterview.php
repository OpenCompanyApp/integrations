 ...
 */
class LeverCreateOpportunityInterview extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity_interview';
    protected const TOOL_DESCRIPTION = 'Create an opportunity interview. Official Lever Data API endpoint: POST /opportunities/{opportunity}/interviews.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/interviews';
