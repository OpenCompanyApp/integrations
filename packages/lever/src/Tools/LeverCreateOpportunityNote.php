 ...
 */
class LeverCreateOpportunityNote extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity_note';
    protected const TOOL_DESCRIPTION = 'Create a note on an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/notes.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/notes';
