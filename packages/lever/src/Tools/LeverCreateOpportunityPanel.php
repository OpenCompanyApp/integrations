 ...
 */
class LeverCreateOpportunityPanel extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_opportunity_panel';
    protected const TOOL_DESCRIPTION = 'Create an interview panel. Official Lever Data API endpoint: POST /opportunities/{opportunity}/panels.';
