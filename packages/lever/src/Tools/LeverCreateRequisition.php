 ...
 */
class LeverCreateRequisition extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_requisition';
    protected const TOOL_DESCRIPTION = 'Create a requisition. Official Lever Data API endpoint: POST /requisitions.';
    protected const METHOD = 'POST';
    protected const PATH = '/requisitions';
