 ...
 */
class LeverCreateRequisitionField extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_requisition_field';
    protected const TOOL_DESCRIPTION = 'Create a requisition field. Official Lever Data API endpoint: POST /requisition_fields.';
    protected const METHOD = 'POST';
    protected const PATH = '/requisition_fields';
