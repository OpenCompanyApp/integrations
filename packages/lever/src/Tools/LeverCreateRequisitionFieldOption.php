 ...
 */
class LeverCreateRequisitionFieldOption extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_requisition_field_option';
    protected const TOOL_DESCRIPTION = 'Create a requisition field option. Official Lever Data API endpoint: POST /requisition_fields/{requisition_field}/options.';
