 ...
 */
class LeverCreateUpload extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_upload';
    protected const TOOL_DESCRIPTION = 'Create an upload for files used by Lever records. Official Lever Data API endpoint: POST /uploads.';
    protected const METHOD = 'POST';
    protected const PATH = '/uploads';
