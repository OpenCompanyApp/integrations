 ...
 * Create a Lever user.
 */
class LeverCreateUser extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_user';
    protected const TOOL_DESCRIPTION = 'Create a Lever user. Official Lever Data API endpoint: POST /users.';
