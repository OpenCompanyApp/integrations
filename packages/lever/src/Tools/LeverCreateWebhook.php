 ...
 * Create a webhook.
 */
class LeverCreateWebhook extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_create_webhook';
    protected const TOOL_DESCRIPTION = 'Create a webhook. Official Lever Data API endpoint: POST /webhooks.';
