 ...
 */
class LeverDataApiDelete extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_data_api_delete';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Lever Data API path with DELETE. Official Lever Data API endpoint: DELETE {path}.';
