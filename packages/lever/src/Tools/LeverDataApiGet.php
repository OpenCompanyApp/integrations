 ...
 */
class LeverDataApiGet extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_data_api_get';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Lever Data API path with GET. Official Lever Data API endpoint: GET {path}.';
