 ...
 */
class LeverDataApiPost extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_data_api_post';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Lever Data API path with POST. Official Lever Data API endpoint: POST {path}.';
