 ...
 */
class LeverDeactivateUser extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_deactivate_user';
    protected const TOOL_DESCRIPTION = 'Deactivate a Lever user. Official Lever Data API endpoint: POST /users/{user}/deactivate.';
    protected const METHOD = 'POST';
    protected const PATH = '/users/{user}/deactivate';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever user identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
