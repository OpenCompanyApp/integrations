 ...
 */
class LeverDeleteFeedbackTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_feedback_template';
    protected const TOOL_DESCRIPTION = 'Delete a feedback template. Official Lever Data API endpoint: DELETE /feedback_templates/{feedback_template}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/feedback_templates/{feedback_template}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever feedback_template identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
