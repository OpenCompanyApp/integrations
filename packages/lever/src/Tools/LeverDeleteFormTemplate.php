 ...
 */
class LeverDeleteFormTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_form_template';
    protected const TOOL_DESCRIPTION = 'Delete a form template. Official Lever Data API endpoint: DELETE /form_templates/{form_template}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/form_templates/{form_template}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever form_template identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
