 ...
 */
class LeverDeleteOpportunityFeedback extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_opportunity_feedback';
    protected const TOOL_DESCRIPTION = 'Delete opportunity feedback. Official Lever Data API endpoint: DELETE /opportunities/{opportunity}/feedback/{feedback}.';
