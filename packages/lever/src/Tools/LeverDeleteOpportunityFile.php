 ...
 */
class LeverDeleteOpportunityFile extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_opportunity_file';
    protected const TOOL_DESCRIPTION = 'Delete an opportunity file. Official Lever Data API endpoint: DELETE /opportunities/{opportunity}/files/{file}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/opportunities/{opportunity}/files/{file}';
