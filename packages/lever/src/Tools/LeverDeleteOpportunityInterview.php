 ...
 */
class LeverDeleteOpportunityInterview extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_opportunity_interview';
    protected const TOOL_DESCRIPTION = 'Delete an opportunity interview. Official Lever Data API endpoint: DELETE /opportunities/{opportunity}/interviews/{interview}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/opportunities/{opportunity}/interviews/{interview}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever interview identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
