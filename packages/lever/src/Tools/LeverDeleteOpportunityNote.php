 ...
 */
class LeverDeleteOpportunityNote extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_opportunity_note';
    protected const TOOL_DESCRIPTION = 'Delete an opportunity note. Official Lever Data API endpoint: DELETE /opportunities/{opportunity}/notes/{note}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/opportunities/{opportunity}/notes/{note}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever note identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
