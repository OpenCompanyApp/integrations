 ...
 */
class LeverDeleteOpportunityPanel extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_opportunity_panel';
    protected const TOOL_DESCRIPTION = 'Delete an interview panel. Official Lever Data API endpoint: DELETE /opportunities/{opportunity}/panels/{panel}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/opportunities/{opportunity}/panels/{panel}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever panel identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
