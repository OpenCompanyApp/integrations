 ...
 */
class LeverDeleteRequisition extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_requisition';
    protected const TOOL_DESCRIPTION = 'Delete a requisition. Official Lever Data API endpoint: DELETE /requisitions/{requisition}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/requisitions/{requisition}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever requisition identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
