 ...
 */
class LeverDeleteRequisitionField extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_requisition_field';
    protected const TOOL_DESCRIPTION = 'Delete a requisition field. Official Lever Data API endpoint: DELETE /requisition_fields/{requisition_field}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/requisition_fields/{requisition_field}';
