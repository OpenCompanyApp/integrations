 ...
 */
class LeverDeleteRequisitionFieldOptions extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_requisition_field_options';
    protected const TOOL_DESCRIPTION = 'Delete requisition field options. Official Lever Data API endpoint: DELETE /requisition_fields/{requisition_field}/options.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/requisition_fields/{requisition_field}/options';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever requisition_field identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
