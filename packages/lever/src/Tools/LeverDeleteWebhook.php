 ...
 * Delete a webhook.
 */
class LeverDeleteWebhook extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_delete_webhook';
    protected const TOOL_DESCRIPTION = 'Delete a webhook. Official Lever Data API endpoint: DELETE /webhooks/{webhookId}.';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever webhookId identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
