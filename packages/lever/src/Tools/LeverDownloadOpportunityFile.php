 ...
 */
class LeverDownloadOpportunityFile extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_download_opportunity_file';
    protected const TOOL_DESCRIPTION = 'Download an opportunity file. Official Lever Data API endpoint: GET /opportunities/{opportunity}/files/{file}/download.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/files/{file}/download';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever file identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
