 ...
 */
class LeverDownloadOpportunityOffer extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_download_opportunity_offer';
    protected const TOOL_DESCRIPTION = 'Download an opportunity offer file. Official Lever Data API endpoint: GET /opportunities/{opportunity}/offers/{offer}/download.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/offers/{offer}/download';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever offer identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
