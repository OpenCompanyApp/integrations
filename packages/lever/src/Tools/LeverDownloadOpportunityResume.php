 ...
 */
class LeverDownloadOpportunityResume extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_download_opportunity_resume';
    protected const TOOL_DESCRIPTION = 'Download an opportunity resume. Official Lever Data API endpoint: GET /opportunities/{opportunity}/resumes/{resume}/download.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/resumes/{resume}/download';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever resume identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
