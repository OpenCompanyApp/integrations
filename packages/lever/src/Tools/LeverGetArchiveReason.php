 ...
 */
class LeverGetArchiveReason extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_archive_reason';
    protected const TOOL_DESCRIPTION = 'Retrieve one archive reason. Official Lever Data API endpoint: GET /archive_reasons/{archive_reason}.';
    protected const METHOD = 'GET';
    protected const PATH = '/archive_reasons/{archive_reason}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever archive_reason identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
