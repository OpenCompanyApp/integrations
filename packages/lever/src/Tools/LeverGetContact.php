 ...
 */
class LeverGetContact extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_contact';
    protected const TOOL_DESCRIPTION = 'Retrieve one Lever contact. Official Lever Data API endpoint: GET /contacts/{contact}.';
