 ...
 */
class LeverGetDataOpportunity extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_data_opportunity';
    protected const TOOL_DESCRIPTION = 'Retrieve one authenticated Lever opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}';
