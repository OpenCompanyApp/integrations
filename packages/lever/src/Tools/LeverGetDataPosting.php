 ...
 */
class LeverGetDataPosting extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_data_posting';
    protected const TOOL_DESCRIPTION = 'Retrieve one authenticated Lever posting. Official Lever Data API endpoint: GET /postings/{posting}.';
    protected const METHOD = 'GET';
    protected const PATH = '/postings/{posting}';
