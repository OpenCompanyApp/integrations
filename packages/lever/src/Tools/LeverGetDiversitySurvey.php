 ...
 */
class LeverGetDiversitySurvey extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_diversity_survey';
    protected const TOOL_DESCRIPTION = 'Retrieve diversity survey questions for a posting. Official Lever Data API endpoint: GET /surveys/diversity/{posting}.';
    protected const METHOD = 'GET';
    protected const PATH = '/surveys/diversity/{posting}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever posting identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
