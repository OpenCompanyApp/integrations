 ...
 */
class LeverGetFeedbackTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_feedback_template';
    protected const TOOL_DESCRIPTION = 'Retrieve one feedback template. Official Lever Data API endpoint: GET /feedback_templates/{feedback_template}.';
