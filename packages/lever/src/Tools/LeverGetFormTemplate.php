 ...
 */
class LeverGetFormTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_form_template';
    protected const TOOL_DESCRIPTION = 'Retrieve one form template. Official Lever Data API endpoint: GET /form_templates/{form_template}.';
