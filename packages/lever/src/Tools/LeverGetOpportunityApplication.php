 ...
 */
class LeverGetOpportunityApplication extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_application';
    protected const TOOL_DESCRIPTION = 'Retrieve one opportunity application. Official Lever Data API endpoint: GET /opportunities/{opportunity}/applications/{application}.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/applications/{application}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever opportunity identifier.',
  ),
  'application' =>
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever application identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
