 ...
 */
class LeverGetOpportunityFeedback extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_feedback';
    protected const TOOL_DESCRIPTION = 'Retrieve one opportunity feedback form. Official Lever Data API endpoint: GET /opportunities/{opportunity}/feedback/{feedback}.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/feedback/{feedback}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever feedback identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
