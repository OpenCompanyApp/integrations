 ...
 */
class LeverGetOpportunityFile extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_file';
    protected const TOOL_DESCRIPTION = 'Retrieve opportunity file metadata. Official Lever Data API endpoint: GET /opportunities/{opportunity}/files/{file}.';
