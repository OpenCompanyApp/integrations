 ...
 */
class LeverGetOpportunityForm extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_form';
    protected const TOOL_DESCRIPTION = 'Retrieve one opportunity form. Official Lever Data API endpoint: GET /opportunities/{opportunity}/forms/{form}.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/forms/{form}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever form identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
