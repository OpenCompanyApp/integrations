 ...
 */
class LeverGetOpportunityInterview extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_interview';
    protected const TOOL_DESCRIPTION = 'Retrieve one opportunity interview. Official Lever Data API endpoint: GET /opportunities/{opportunity}/interviews/{interview}.';
