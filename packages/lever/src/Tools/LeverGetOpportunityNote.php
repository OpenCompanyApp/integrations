 ...
 */
class LeverGetOpportunityNote extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_note';
    protected const TOOL_DESCRIPTION = 'Retrieve one opportunity note. Official Lever Data API endpoint: GET /opportunities/{opportunity}/notes/{note}.';
