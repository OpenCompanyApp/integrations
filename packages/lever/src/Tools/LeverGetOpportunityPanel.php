 ...
 */
class LeverGetOpportunityPanel extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_panel';
    protected const TOOL_DESCRIPTION = 'Retrieve one interview panel. Official Lever Data API endpoint: GET /opportunities/{opportunity}/panels/{panel}.';
