 ...
 */
class LeverGetOpportunityReferral extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_referral';
    protected const TOOL_DESCRIPTION = 'Retrieve one opportunity referral. Official Lever Data API endpoint: GET /opportunities/{opportunity}/referrals/{referral}.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/referrals/{referral}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever referral identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
