 ...
 */
class LeverGetOpportunityResume extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_opportunity_resume';
    protected const TOOL_DESCRIPTION = 'Retrieve opportunity resume metadata. Official Lever Data API endpoint: GET /opportunities/{opportunity}/resumes/{resume}.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/resumes/{resume}';
