 ...
 */
class LeverGetPostingApplyForm extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_posting_apply_form';
    protected const TOOL_DESCRIPTION = 'Retrieve a posting application form. Official Lever Data API endpoint: GET /postings/{posting}/apply.';
