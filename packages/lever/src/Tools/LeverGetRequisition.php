 ...
 */
class LeverGetRequisition extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_requisition';
    protected const TOOL_DESCRIPTION = 'Retrieve one requisition. Official Lever Data API endpoint: GET /requisitions/{requisition}.';
