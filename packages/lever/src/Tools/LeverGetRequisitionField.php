 ...
 */
class LeverGetRequisitionField extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_requisition_field';
    protected const TOOL_DESCRIPTION = 'Retrieve one requisition field. Official Lever Data API endpoint: GET /requisition_fields/{requisition_field}.';
