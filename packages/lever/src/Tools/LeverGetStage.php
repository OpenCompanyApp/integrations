 ...
 */
class LeverGetStage extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_stage';
    protected const TOOL_DESCRIPTION = 'Retrieve one pipeline stage. Official Lever Data API endpoint: GET /stages/{stage}.';
    protected const METHOD = 'GET';
    protected const PATH = '/stages/{stage}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever stage identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
