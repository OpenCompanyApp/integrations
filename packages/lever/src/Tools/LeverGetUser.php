 ...
 */
class LeverGetUser extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_get_user';
    protected const TOOL_DESCRIPTION = 'Retrieve one Lever user. Official Lever Data API endpoint: GET /users/{user}.';
