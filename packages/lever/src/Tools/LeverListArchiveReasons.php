 ...
 */
class LeverListArchiveReasons extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_archive_reasons';
    protected const TOOL_DESCRIPTION = 'List archive reasons. Official Lever Data API endpoint: GET /archive_reasons.';
    protected const METHOD = 'GET';
    protected const PATH = '/archive_reasons';
