 ...
 * List audit events.
 */
class LeverListAuditEvents extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_audit_events';
    protected const TOOL_DESCRIPTION = 'List audit events. Official Lever Data API endpoint: GET /audit_events.';
    protected const METHOD = 'GET';
    protected const PATH = '/audit_events';
