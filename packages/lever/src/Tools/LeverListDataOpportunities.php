 ...
 */
class LeverListDataOpportunities extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_data_opportunities';
    protected const TOOL_DESCRIPTION = 'List authenticated Lever opportunities. Official Lever Data API endpoint: GET /opportunities.';
