 ...
 */
class LeverListDataPostings extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_data_postings';
    protected const TOOL_DESCRIPTION = 'List authenticated Lever postings. Official Lever Data API endpoint: GET /postings.';
    protected const METHOD = 'GET';
    protected const PATH = '/postings';
