 ...
 */
class LeverListDeletedApplications extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_deleted_applications';
    protected const TOOL_DESCRIPTION = 'List deleted applications. Official Lever Data API endpoint: GET /applications/deleted.';
    protected const METHOD = 'GET';
    protected const PATH = '/applications/deleted';
