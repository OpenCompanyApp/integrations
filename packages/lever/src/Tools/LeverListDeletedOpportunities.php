 ...
 */
class LeverListDeletedOpportunities extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_deleted_opportunities';
    protected const TOOL_DESCRIPTION = 'List deleted Lever opportunities. Official Lever Data API endpoint: GET /opportunities/deleted.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/deleted';
