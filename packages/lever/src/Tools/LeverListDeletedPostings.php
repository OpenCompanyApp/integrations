 ...
 */
class LeverListDeletedPostings extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_deleted_postings';
    protected const TOOL_DESCRIPTION = 'List deleted postings. Official Lever Data API endpoint: GET /postings/deleted.';
    protected const METHOD = 'GET';
    protected const PATH = '/postings/deleted';
