 ...
 */
class LeverListDispositionStages extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_disposition_stages';
    protected const TOOL_DESCRIPTION = 'List disposition stages. Official Lever Data API endpoint: GET /disposition_stages.';
    protected const METHOD = 'GET';
    protected const PATH = '/disposition_stages';
