 ...
 */
class LeverListEeoResponsesPii extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_eeo_responses_pii';
    protected const TOOL_DESCRIPTION = 'List EEO response PII records. Official Lever Data API endpoint: GET /eeo/responses/pii.';
    protected const METHOD = 'GET';
    protected const PATH = '/eeo/responses/pii';
