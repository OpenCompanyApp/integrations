 ...
 * List form templates.
 */
class LeverListFormTemplates extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_form_templates';
    protected const TOOL_DESCRIPTION = 'List form templates. Official Lever Data API endpoint: GET /form_templates.';
