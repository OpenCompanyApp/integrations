 ...
 */
class LeverListOpportunityApplications extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_applications';
    protected const TOOL_DESCRIPTION = 'List applications for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/applications.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/applications';
