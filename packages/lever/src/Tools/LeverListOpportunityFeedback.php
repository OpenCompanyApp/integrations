 ...
 */
class LeverListOpportunityFeedback extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_feedback';
    protected const TOOL_DESCRIPTION = 'List feedback forms for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/feedback.';
