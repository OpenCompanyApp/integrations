 ...
 */
class LeverListOpportunityFileActions extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_file_actions';
    protected const TOOL_DESCRIPTION = 'List file actions for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/file_actions.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/file_actions';
