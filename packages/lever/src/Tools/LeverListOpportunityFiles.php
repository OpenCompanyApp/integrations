 ...
 */
class LeverListOpportunityFiles extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_files';
    protected const TOOL_DESCRIPTION = 'List files on an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/files.';
