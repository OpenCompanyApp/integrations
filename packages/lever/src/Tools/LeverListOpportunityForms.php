 ...
 */
class LeverListOpportunityForms extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_forms';
    protected const TOOL_DESCRIPTION = 'List forms on an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/forms.';
