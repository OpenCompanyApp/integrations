 ...
 */
class LeverListOpportunityInterviews extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_interviews';
    protected const TOOL_DESCRIPTION = 'List interviews for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/interviews.';
