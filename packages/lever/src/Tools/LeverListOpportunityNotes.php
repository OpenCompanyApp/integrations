 ...
 */
class LeverListOpportunityNotes extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_notes';
    protected const TOOL_DESCRIPTION = 'List notes for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/notes.';
