 ...
 */
class LeverListOpportunityOffers extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_offers';
    protected const TOOL_DESCRIPTION = 'List offers for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/offers.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/offers';
