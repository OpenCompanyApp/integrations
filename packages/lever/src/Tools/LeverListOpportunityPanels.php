 ...
 */
class LeverListOpportunityPanels extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_panels';
    protected const TOOL_DESCRIPTION = 'List interview panels for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/panels.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/panels';
