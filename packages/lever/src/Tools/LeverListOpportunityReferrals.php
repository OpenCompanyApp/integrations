 ...
 */
class LeverListOpportunityReferrals extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_referrals';
    protected const TOOL_DESCRIPTION = 'List referrals for an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/referrals.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/referrals';
