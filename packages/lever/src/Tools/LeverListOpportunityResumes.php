 ...
 */
class LeverListOpportunityResumes extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_opportunity_resumes';
    protected const TOOL_DESCRIPTION = 'List resumes on an opportunity. Official Lever Data API endpoint: GET /opportunities/{opportunity}/resumes.';
    protected const METHOD = 'GET';
    protected const PATH = '/opportunities/{opportunity}/resumes';
