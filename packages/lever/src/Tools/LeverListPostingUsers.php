 ...
 */
class LeverListPostingUsers extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_posting_users';
    protected const TOOL_DESCRIPTION = 'List users associated with a posting. Official Lever Data API endpoint: GET /postings/{posting}/users.';
    protected const METHOD = 'GET';
    protected const PATH = '/postings/{posting}/users';
