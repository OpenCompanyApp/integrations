 ...
 * List profile forms.
 */
class LeverListProfileForms extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_profile_forms';
    protected const TOOL_DESCRIPTION = 'List profile forms. Official Lever Data API endpoint: GET /profile_forms.';
    protected const METHOD = 'GET';
    protected const PATH = '/profile_forms';
