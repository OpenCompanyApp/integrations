 ...
 */
class LeverListRequisitionFields extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_requisition_fields';
    protected const TOOL_DESCRIPTION = 'List requisition fields. Official Lever Data API endpoint: GET /requisition_fields.';
