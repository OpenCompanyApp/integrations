 ...
 * List requisitions.
 */
class LeverListRequisitions extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_requisitions';
    protected const TOOL_DESCRIPTION = 'List requisitions. Official Lever Data API endpoint: GET /requisitions.';
