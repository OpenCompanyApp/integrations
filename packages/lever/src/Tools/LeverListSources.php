 ...
 * List source values.
 */
class LeverListSources extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_sources';
    protected const TOOL_DESCRIPTION = 'List source values. Official Lever Data API endpoint: GET /sources.';
