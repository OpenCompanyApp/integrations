 ...
 */
class LeverListStages extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_stages';
    protected const TOOL_DESCRIPTION = 'List pipeline stages. Official Lever Data API endpoint: GET /stages.';
    protected const METHOD = 'GET';
    protected const PATH = '/stages';
