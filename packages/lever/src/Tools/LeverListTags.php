 ...
 * List tag values.
 */
class LeverListTags extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_tags';
    protected const TOOL_DESCRIPTION = 'List tag values. Official Lever Data API endpoint: GET /tags.';
