 ...
 * List Lever users.
 */
class LeverListUsers extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_users';
    protected const TOOL_DESCRIPTION = 'List Lever users. Official Lever Data API endpoint: GET /users.';
