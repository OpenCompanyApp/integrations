 ...
 * List webhooks.
 */
class LeverListWebhooks extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_list_webhooks';
    protected const TOOL_DESCRIPTION = 'List webhooks. Official Lever Data API endpoint: GET /webhooks.';
