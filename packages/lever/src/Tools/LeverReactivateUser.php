 ...
 */
class LeverReactivateUser extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_reactivate_user';
    protected const TOOL_DESCRIPTION = 'Reactivate a Lever user. Official Lever Data API endpoint: POST /users/{user}/reactivate.';
    protected const METHOD = 'POST';
    protected const PATH = '/users/{user}/reactivate';
