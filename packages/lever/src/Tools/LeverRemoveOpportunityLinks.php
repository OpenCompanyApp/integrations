 ...
 */
class LeverRemoveOpportunityLinks extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_remove_opportunity_links';
    protected const TOOL_DESCRIPTION = 'Remove links from an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/removeLinks.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/removeLinks';
