 ...
 */
class LeverRemoveOpportunitySources extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_remove_opportunity_sources';
    protected const TOOL_DESCRIPTION = 'Remove sources from an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/removeSources.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/removeSources';
