 ...
 */
class LeverRemoveOpportunityTags extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_remove_opportunity_tags';
    protected const TOOL_DESCRIPTION = 'Remove tags from an opportunity. Official Lever Data API endpoint: POST /opportunities/{opportunity}/removeTags.';
    protected const METHOD = 'POST';
    protected const PATH = '/opportunities/{opportunity}/removeTags';
