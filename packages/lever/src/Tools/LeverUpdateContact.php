 ...
 */
class LeverUpdateContact extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_contact';
    protected const TOOL_DESCRIPTION = 'Update a Lever contact. Official Lever Data API endpoint: PUT /contacts/{contact}.';
    protected const METHOD = 'PUT';
    protected const PATH = '/contacts/{contact}';
  ...
  array (
    'type' => 'string',
    'required' => true,
    'description' => 'Lever contact identifier.',
  ),
  'limit' =>
  array (
    'type' => 'string',
