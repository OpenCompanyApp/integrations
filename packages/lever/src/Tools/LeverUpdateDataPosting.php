 ...
 */
class LeverUpdateDataPosting extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_data_posting';
    protected const TOOL_DESCRIPTION = 'Update a Lever posting. Official Lever Data API endpoint: POST /postings/{posting}.';
