 ...
 */
class LeverUpdateFeedbackTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_feedback_template';
    protected const TOOL_DESCRIPTION = 'Update a feedback template. Official Lever Data API endpoint: PUT /feedback_templates/{feedback_template}.';
