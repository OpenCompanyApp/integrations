 ...
 */
class LeverUpdateFormTemplate extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_form_template';
    protected const TOOL_DESCRIPTION = 'Update a form template. Official Lever Data API endpoint: PUT /form_templates/{form_template}.';
