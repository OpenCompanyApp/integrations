 ...
 */
class LeverUpdateOpportunityArchive extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_opportunity_archive';
    protected const TOOL_DESCRIPTION = 'Archive or unarchive an opportunity. Official Lever Data API endpoint: PUT /opportunities/{opportunity}/archived.';
    protected const METHOD = 'PUT';
    protected const PATH = '/opportunities/{opportunity}/archived';
