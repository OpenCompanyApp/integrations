 ...
 */
class LeverUpdateOpportunityFeedback extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_opportunity_feedback';
    protected const TOOL_DESCRIPTION = 'Update opportunity feedback. Official Lever Data API endpoint: PUT /opportunities/{opportunity}/feedback/{feedback}.';
