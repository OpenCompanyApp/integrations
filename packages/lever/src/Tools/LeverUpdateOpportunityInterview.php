 ...
 */
class LeverUpdateOpportunityInterview extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_opportunity_interview';
    protected const TOOL_DESCRIPTION = 'Update an opportunity interview. Official Lever Data API endpoint: PUT /opportunities/{opportunity}/interviews/{interview}.';
