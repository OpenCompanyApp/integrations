 ...
 */
class LeverUpdateOpportunityNote extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_opportunity_note';
    protected const TOOL_DESCRIPTION = 'Update an opportunity note. Official Lever Data API endpoint: PUT /opportunities/{opportunity}/notes/{note}.';
