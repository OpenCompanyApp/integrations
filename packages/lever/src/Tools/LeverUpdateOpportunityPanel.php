 ...
 */
class LeverUpdateOpportunityPanel extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_opportunity_panel';
    protected const TOOL_DESCRIPTION = 'Update an interview panel. Official Lever Data API endpoint: PUT /opportunities/{opportunity}/panels/{panel}.';
