 ...
 */
class LeverUpdateOpportunityStage extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_opportunity_stage';
    protected const TOOL_DESCRIPTION = 'Move an opportunity to another stage. Official Lever Data API endpoint: PUT /opportunities/{opportunity}/stage.';
    protected const METHOD = 'PUT';
    protected const PATH = '/opportunities/{opportunity}/stage';
