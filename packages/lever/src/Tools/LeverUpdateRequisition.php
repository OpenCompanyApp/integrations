 ...
 */
class LeverUpdateRequisition extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_requisition';
    protected const TOOL_DESCRIPTION = 'Update a requisition. Official Lever Data API endpoint: PUT /requisitions/{requisition}.';
