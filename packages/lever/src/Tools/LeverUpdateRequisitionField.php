 ...
 */
class LeverUpdateRequisitionField extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_requisition_field';
    protected const TOOL_DESCRIPTION = 'Update a requisition field. Official Lever Data API endpoint: PUT /requisition_fields/{requisition_field}.';
