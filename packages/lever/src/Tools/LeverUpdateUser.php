 ...
 * Update a Lever user.
 */
class LeverUpdateUser extends AbstractLeverDataTool
{
    protected const TOOL_NAME = 'lever_update_user';
    protected const TOOL_DESCRIPTION = 'Update a Lever user. Official Lever Data API endpoint: PUT /users/{user}.';
    protected const METHOD = 'PUT';
    protected const PATH = '/users/{user}';
