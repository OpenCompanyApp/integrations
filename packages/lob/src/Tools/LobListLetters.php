...
class LobListLetters implements Tool
{
    ...
    {
        return 'lob_list_letters';
    }

    public function description(): string
    {
        return 'List letters with pagination. Returns a page of letter objects sorted by creation date (newest first).';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listLetters($limit, $offset);
