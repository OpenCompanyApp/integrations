...
class LobSendLetter implements Tool
{
    ...
    {
        return 'lob_send_letter';
    }

    public function description(): string
    {
        return 'Send a letter via Lob. Provide recipient and sender addresses (as address IDs or inline address objects), plus an HTML file or template ID for the letter content.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->sendLetter($to, $from, $file, $color, $doubleSided);
