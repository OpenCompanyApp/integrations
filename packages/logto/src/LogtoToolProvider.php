...
); } public function luaDocsPath(): ?string { return __DIR__.'/../lua-docs/logto.md'; } public function isIntegration(): bool { return true; } public function createTool(string $class, array $context = []): Tool { return new $class($this->resolveService($context)); }
