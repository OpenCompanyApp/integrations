 ...
 *
 * Maps to POST /api/applications/{id}/users/{userId}/consent-organizations in the official Logto OpenAPI source.
 */
class LogtoCreateApplicationUserConsentOrganization extends AbstractLogtoTool
{
