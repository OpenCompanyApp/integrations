 ...
 *
 * Retrieves a paginated list of videos accessible to the authenticated user.
 ...
 */
class LoomListVideos implements Tool
{
    ...
    {
        return 'List Loom videos. Returns video titles, IDs, durations, URLs, and creation dates. Use limit and page for pagination.';
    }
    ...
    {
        return [
            'limit' => ['type' => 'integer', 'description' => 'Maximum number of videos to return (default: 20, max: 50).'],
            'page' => ['type' => 'integer', 'description' => 'Page number for pagination (default: 1).'],
        ];
    }

    /**
     * Execute the list videos API call.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listVideos($limit, $page);
