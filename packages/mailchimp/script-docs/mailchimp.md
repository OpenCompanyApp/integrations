# Client for the Mailchimp Marketing API covering audiences, subscribers, campaigns, segments, and reports — JavaScript API Reference
...
```js
var result = app.integrations.mailchimp.mailchimp_add_subscriber({
  list_id: "",
  email: "",
  status: "",
})
...
```js
var result = app.integrations.mailchimp.mailchimp_add_to_segment({
  list_id: "",
  segment_id: "",
  email: "",
})
...
```js
var result = app.integrations.mailchimp.mailchimp_create_audience({
  name: "",
  contact: "",
  address1: "",
})
...
```js
var result = app.integrations.mailchimp.mailchimp_create_campaign({
  type: "",
  list_id: "",
  settings_subject: "",
})
...
```js
var result = app.integrations.mailchimp.mailchimp_get_audience({
  id: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_get_campaign({
  id: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_get_campaign_report({
  id: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_get_current_user({
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_get_subscriber({
  list_id: "",
  email: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_list_audiences({
  count: 0,
  offset: 0,
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_list_campaigns({
  count: 0,
  offset: 0,
  status: "",
})
...
```js
var result = app.integrations.mailchimp.mailchimp_list_segments({
  list_id: "",
  count: 0,
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_remove_subscriber({
  list_id: "",
  email: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_search_subscribers({
  query: "",
  list_id: "",
  count: 0,
})
...
```js
var result = app.integrations.mailchimp.mailchimp_send_campaign({
  id: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_tag_subscriber({
  list_id: "",
  email: "",
  tags: {},
})
...
```js
var result = app.integrations.mailchimp.mailchimp_update_campaign({
  id: "",
  settings: "",
})
```
...
```js
var result = app.integrations.mailchimp.mailchimp_update_subscriber({
  list_id: "",
  email: "",
  merge_fields: "",
})
...
app.integrations.mailchimp.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.mailchimp.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.mailchimp.work.function_name({ /* parameters */ })
app.integrations.mailchimp.personal.function_name({ /* parameters */ })
```
