# Client for the Mailchimp Marketing API covering audiences, subscribers, campaigns, segments, and reports — Ruby API Reference
...
```ruby
result = app.integrations.mailchimp.add_subscriber(list_id: "", email: "", status: "")
```
...
```ruby
result = app.integrations.mailchimp.add_segment(list_id: "", segment_id: "", email: "")
```
...
```ruby
result = app.integrations.mailchimp.create_audience(name: "", contact: "", address1: "")
```
...
```ruby
result = app.integrations.mailchimp.create_campaign(type: "", list_id: "", settings_subject: "")
```
...
```ruby
result = app.integrations.mailchimp.get_audience(id: "")
```
...
```ruby
result = app.integrations.mailchimp.get_campaign(id: "")
```
...
```ruby
result = app.integrations.mailchimp.get_campaign_report(id: "")
```
...
```ruby
result = app.integrations.mailchimp.get_current_user()
```
...
```ruby
result = app.integrations.mailchimp.get_subscriber(list_id: "", email: "")
```
...
```ruby
result = app.integrations.mailchimp.list_audiences(count: 0, offset: 0)
```
...
```ruby
result = app.integrations.mailchimp.list_campaigns(count: 0, offset: 0, status: "")
```
...
```ruby
result = app.integrations.mailchimp.list_segments(list_id: "", count: 0)
```
...
```ruby
result = app.integrations.mailchimp.remove_subscriber(list_id: "", email: "")
```
...
```ruby
result = app.integrations.mailchimp.search_subscribers(query: "", list_id: "", count: 0)
```
...
```ruby
result = app.integrations.mailchimp.send_campaign(id: "")
```
...
```ruby
result = app.integrations.mailchimp.tag_subscriber(list_id: "", email: "", tags: {})
```
...
```ruby
result = app.integrations.mailchimp.update_campaign(id: "", settings: "")
```
...
```ruby
result = app.integrations.mailchimp.update_subscriber(list_id: "", email: "", merge_fields: "")
```
---
