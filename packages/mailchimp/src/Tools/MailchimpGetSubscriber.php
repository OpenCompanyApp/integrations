...
/**
 * Get a subscriber's details from a Mailchimp audience.
 */
class MailchimpGetSubscriber implements Tool
{
    ...
    {
        return 'mailchimp_get_subscriber';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->getSubscriber($listId, $email);
