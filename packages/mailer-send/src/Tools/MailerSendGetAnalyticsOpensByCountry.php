...
/** Retrieve MailerSend open analytics by country. */
class MailerSendGetAnalyticsOpensByCountry extends AbstractMailerSendEndpointTool
{
    protected string $toolName = 'mailer_send_get_analytics_opens_by_country';
    protected string $toolDescription = 'Get MailerSend open analytics grouped by country.';
    protected string $path = '/analytics/country';
