...
```js
var created = app.integrations.mailerlite.mailerlite_create_subscriber({
...
```
```js
var activity = app.integrations.mailerlite.mailerlite_list_campaign_subscriber_activity({
  campaign_id: "66200823885989563",
  limit: 50,
})
```
```js
var webhook = app.integrations.mailerlite.mailerlite_create_webhook({
