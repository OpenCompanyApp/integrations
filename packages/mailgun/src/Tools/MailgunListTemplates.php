 ...
 */
class MailgunListTemplates extends AbstractMailgunEndpointTool
{
    protected string $toolName = 'mailgun_list_templates';

    protected string $toolDescription = 'List stored email templates for a domain.';
