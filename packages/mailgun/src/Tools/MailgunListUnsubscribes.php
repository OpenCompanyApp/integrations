 ...
 */
class MailgunListUnsubscribes extends AbstractMailgunEndpointTool
{
    protected string $toolName = 'mailgun_list_unsubscribes';

    protected string $toolDescription = 'List Mailgun Unsubscribes for a domain.';
