 ...
 */
class MailgunListWhitelists extends AbstractMailgunEndpointTool
{
    protected string $toolName = 'mailgun_list_whitelists';

    protected string $toolDescription = 'List Mailgun Allowlists for a domain.';
