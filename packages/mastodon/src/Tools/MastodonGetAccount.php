...
/**
 * MastodonGetAccount — retrieve a Mastodon account profile by ID.
 *
 * Returns the full account profile including display name, bio,
 * follower/following counts, and status count.
 */
class MastodonGetAccount implements Tool
{
    ...
    {
        return 'mastodon_get_account';
    }

    public function description(): string
    {
        return 'Retrieve a Mastodon account profile by ID. Returns display name, bio, follower counts, and other profile details.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $account = $this->service->getAccount($args['id']);
