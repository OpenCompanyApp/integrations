 ...
 */
class MessageBirdDeleteGroup implements Tool
{
    ...
    public function name(): string { return 'messagebird_delete_group'; }

    public function description(): string { return 'Delete a MessageBird contact group.'; }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->deleteGroup((string) ($args['id'] ?? '')));
        } catch (\Throwable $e) {
