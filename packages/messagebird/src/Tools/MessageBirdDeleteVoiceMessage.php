 ...
 *
 * Cancels a voice message that has not yet been sent.
 */
class MessageBirdDeleteVoiceMessage implements Tool
{
    /**
    ...
    {
        return 'messagebird_delete_voice_message';
    }

    public function description(): string
    {
        return 'Delete a scheduled MessageBird voice message.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->deleteVoiceMessage((string) ($args['id'] ?? '')));
        } catch (\Throwable $e) {
