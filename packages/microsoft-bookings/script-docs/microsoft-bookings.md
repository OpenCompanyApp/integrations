...
```ruby
businesses = app.call("integrations.microsoft-bookings.list_bookingbusinesses", top: 10)
appointments = app.call("integrations.microsoft-bookings.list_appointments", booking_business_id: "business-id", top: 25)
availability = app.call("integrations.microsoft-bookings.invoke_action_getstaffavailability", booking_business_id: "business-id", body: {staffIds: ["staff-id"]})
```