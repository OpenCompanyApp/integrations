...
```js
var businesses = microsoft_bookings_list_booking_businesses({ top: 10 })
var appointments = microsoft_bookings_booking_businesses_list_appointments({ booking_business_id: "business-id", top: 25 })
var availability = microsoft_bookings_booking_businesses_booking_business_get_staff_availability({ booking_business_id: "business-id", body: { staffIds: [ "staff-id" ] } })
```