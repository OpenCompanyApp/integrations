 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/appointments/$count.
 */
class MicrosoftBookingsBookingBusinessesAppointmentsGetCount205a extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_appointments_get_count_205a';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/appointments/$count';
