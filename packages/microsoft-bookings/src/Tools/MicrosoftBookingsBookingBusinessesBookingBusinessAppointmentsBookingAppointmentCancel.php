 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/appointments/{bookingAppointment-id}/cancel.
 */
class MicrosoftBookingsBookingBusinessesBookingBusinessAppointmentsBookingAppointmentCancel extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_booking_business_appointments_booking_appointment_cancel';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/appointments/{bookingAppointment-id}/cancel';
