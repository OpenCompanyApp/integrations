 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/getStaffAvailability.
 */
class MicrosoftBookingsBookingBusinessesBookingBusinessGetStaffAvailability extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_booking_business_get_staff_availability';
    protected const DESCRIPTION = 'Invoke action getStaffAvailability\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/getStaffAvailability.';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/getStaffAvailability';
