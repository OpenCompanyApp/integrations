 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/$count.
 */
class MicrosoftBookingsBookingBusinessesCalendarViewGetCountF3a3 extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_calendar_view_get_count_f3a3';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/$count';
