 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/appointments.
 */
class MicrosoftBookingsBookingBusinessesCreateAppointments extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_create_appointments';
    protected const DESCRIPTION = 'Create bookingAppointment\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/appointments.';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/appointments';
