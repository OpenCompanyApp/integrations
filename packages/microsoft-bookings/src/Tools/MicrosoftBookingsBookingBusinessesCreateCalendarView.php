 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView.
 */
class MicrosoftBookingsBookingBusinessesCreateCalendarView extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_create_calendar_view';
    protected const DESCRIPTION = 'Create new navigation property to calendarView for solutions\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView.';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/calendarView';
