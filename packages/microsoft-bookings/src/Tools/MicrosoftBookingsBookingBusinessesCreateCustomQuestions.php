 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/customQuestions.
 */
class MicrosoftBookingsBookingBusinessesCreateCustomQuestions extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_create_custom_questions';
    protected const DESCRIPTION = 'Create bookingCustomQuestion\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/customQuestions.';
