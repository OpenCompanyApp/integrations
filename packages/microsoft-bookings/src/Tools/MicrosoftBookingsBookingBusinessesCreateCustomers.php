 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/customers.
 */
class MicrosoftBookingsBookingBusinessesCreateCustomers extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_create_customers';
    protected const DESCRIPTION = 'Create bookingCustomer\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/customers.';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/customers';
