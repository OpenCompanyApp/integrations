 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/services.
 */
class MicrosoftBookingsBookingBusinessesCreateServices extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_create_services';
    protected const DESCRIPTION = 'Create bookingService\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/services.';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/services';
