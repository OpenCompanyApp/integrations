 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers.
 */
class MicrosoftBookingsBookingBusinessesCreateStaffMembers extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_create_staff_members';
    protected const DESCRIPTION = 'Create bookingStaffMember\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers.';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers';
