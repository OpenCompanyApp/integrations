 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/customQuestions/$count.
 */
class MicrosoftBookingsBookingBusinessesCustomQuestionsGetCount385a extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_custom_questions_get_count_385a';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/customQuestions/$count';
