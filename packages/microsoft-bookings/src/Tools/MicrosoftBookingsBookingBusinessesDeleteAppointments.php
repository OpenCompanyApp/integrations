 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /solutions/bookingBusinesses/{bookingBusiness-id}/appointments/{bookingAppointment-id}.
 */
class MicrosoftBookingsBookingBusinessesDeleteAppointments extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_delete_appointments';
    protected const DESCRIPTION = 'Delete bookingAppointment\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /solutions/bookingBusinesses/{bookingBusiness-id}/appointments/{bookingAppointment-id}.';
