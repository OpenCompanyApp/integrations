 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/{bookingAppointment-id}.
 */
class MicrosoftBookingsBookingBusinessesDeleteCalendarView extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_delete_calendar_view';
    protected const DESCRIPTION = 'Delete navigation property calendarView for solutions\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/{bookingAppointment-id}.';
