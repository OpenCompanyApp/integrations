 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/$count.
 */
class MicrosoftBookingsBookingBusinessesGetCountB75b extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_get_count_b75b';
    ...
    protected const PATH = '/solutions/bookingBusinesses/$count';
