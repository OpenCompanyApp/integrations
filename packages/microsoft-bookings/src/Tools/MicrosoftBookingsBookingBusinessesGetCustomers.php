 ...
 * Get bookingCustomer.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/customers/{bookingCustomerBase-id}.
 */
class MicrosoftBookingsBookingBusinessesGetCustomers extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_get_customers';
    protected const DESCRIPTION = 'Get bookingCustomer\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingBusinesses/{bookingBusiness-id}/customers/{bookingCustomerBase-id}.';
