 ...
 * List appointments.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/appointments.
 */
class MicrosoftBookingsBookingBusinessesListAppointments extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_list_appointments';
    protected const DESCRIPTION = 'List appointments\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingBusinesses/{bookingBusiness-id}/appointments.';
