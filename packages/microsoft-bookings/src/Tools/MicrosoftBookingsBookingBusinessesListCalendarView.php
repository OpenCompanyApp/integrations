 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView.
 */
class MicrosoftBookingsBookingBusinessesListCalendarView extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_list_calendar_view';
    protected const DESCRIPTION = 'List business calendarView\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView.';
