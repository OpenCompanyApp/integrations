 ...
 * List staffMembers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers.
 */
class MicrosoftBookingsBookingBusinessesListStaffMembers extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_list_staff_members';
    protected const DESCRIPTION = 'List staffMembers\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers.';
