 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/services/$count.
 */
class MicrosoftBookingsBookingBusinessesServicesGetCount35c3 extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_services_get_count_35c3';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/services/$count';
