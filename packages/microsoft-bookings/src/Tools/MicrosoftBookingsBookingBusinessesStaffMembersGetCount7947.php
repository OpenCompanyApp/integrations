 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers/$count.
 */
class MicrosoftBookingsBookingBusinessesStaffMembersGetCount7947 extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_staff_members_get_count_7947';
    ...
    protected const PATH = '/solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers/$count';
