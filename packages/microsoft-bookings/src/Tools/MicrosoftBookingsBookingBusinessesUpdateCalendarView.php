 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/{bookingAppointment-id}.
 */
class MicrosoftBookingsBookingBusinessesUpdateCalendarView extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_update_calendar_view';
    protected const DESCRIPTION = 'Update the navigation property calendarView in solutions\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /solutions/bookingBusinesses/{bookingBusiness-id}/calendarView/{bookingAppointment-id}.';
