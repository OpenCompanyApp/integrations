 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /solutions/bookingBusinesses/{bookingBusiness-id}/customers/{bookingCustomerBase-id}.
 */
class MicrosoftBookingsBookingBusinessesUpdateCustomers extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_update_customers';
    protected const DESCRIPTION = 'Update bookingCustomer\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /solutions/bookingBusinesses/{bookingBusiness-id}/customers/{bookingCustomerBase-id}.';
