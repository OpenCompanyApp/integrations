 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers/{bookingStaffMemberBase-id}.
 */
class MicrosoftBookingsBookingBusinessesUpdateStaffMembers extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_businesses_update_staff_members';
    protected const DESCRIPTION = 'Update bookingstaffmember\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /solutions/bookingBusinesses/{bookingBusiness-id}/staffMembers/{bookingStaffMemberBase-id}.';
