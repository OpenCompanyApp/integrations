 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingCurrencies/$count.
 */
class MicrosoftBookingsBookingCurrenciesGetCountF6c6 extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_booking_currencies_get_count_f6c6';
    ...
    protected const PATH = '/solutions/bookingCurrencies/$count';
