 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /solutions/bookingCurrencies.
 */
class MicrosoftBookingsCreateBookingCurrencies extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_create_booking_currencies';
    protected const DESCRIPTION = 'Create new navigation property to bookingCurrencies for solutions\n\nOfficial Microsoft Graph v1.0 endpoint: POST /solutions/bookingCurrencies.';
    ...
    protected const PATH = '/solutions/bookingCurrencies';
