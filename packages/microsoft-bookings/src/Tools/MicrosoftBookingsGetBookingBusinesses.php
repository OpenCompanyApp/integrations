 ...
 * Get bookingBusiness.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses/{bookingBusiness-id}.
 */
class MicrosoftBookingsGetBookingBusinesses extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_get_booking_businesses';
    protected const DESCRIPTION = 'Get bookingBusiness\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingBusinesses/{bookingBusiness-id}.';
