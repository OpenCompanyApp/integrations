 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingBusinesses.
 */
class MicrosoftBookingsListBookingBusinesses extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_list_booking_businesses';
    protected const DESCRIPTION = 'List bookingBusinesses\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingBusinesses.';
    ...
    protected const PATH = '/solutions/bookingBusinesses';
