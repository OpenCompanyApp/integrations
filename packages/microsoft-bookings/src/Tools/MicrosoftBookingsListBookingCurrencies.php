 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /solutions/bookingCurrencies.
 */
class MicrosoftBookingsListBookingCurrencies extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_list_booking_currencies';
    protected const DESCRIPTION = 'List bookingCurrencies\n\nOfficial Microsoft Graph v1.0 endpoint: GET /solutions/bookingCurrencies.';
