 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /solutions/bookingBusinesses/{bookingBusiness-id}.
 */
class MicrosoftBookingsUpdateBookingBusinesses extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_update_booking_businesses';
    protected const DESCRIPTION = 'Update bookingbusiness\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /solutions/bookingBusinesses/{bookingBusiness-id}.';
