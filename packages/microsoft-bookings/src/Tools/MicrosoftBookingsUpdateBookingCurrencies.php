 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /solutions/bookingCurrencies/{bookingCurrency-id}.
 */
class MicrosoftBookingsUpdateBookingCurrencies extends AbstractMicrosoftBookingsTool
{
    protected const NAME = 'microsoft_bookings_update_booking_currencies';
    protected const DESCRIPTION = 'Update the navigation property bookingCurrencies in solutions\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /solutions/bookingCurrencies/{bookingCurrency-id}.';
