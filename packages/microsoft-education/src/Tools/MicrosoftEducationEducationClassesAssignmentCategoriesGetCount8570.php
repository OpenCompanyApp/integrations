 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentCategories/$count.
 */
class MicrosoftEducationEducationClassesAssignmentCategoriesGetCount8570 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_categories_get_count_8570';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentCategories/$count';
