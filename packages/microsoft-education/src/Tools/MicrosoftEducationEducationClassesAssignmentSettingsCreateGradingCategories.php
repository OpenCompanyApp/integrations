 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes/{educationClass-id}/assignmentSettings/gradingCategories.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsCreateGradingCategories extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_create_grading_categories';
    protected const DESCRIPTION = 'Create new navigation property to gradingCategories for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/classes/{educationClass-id}/assignmentSettings/gradingCategories.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentSettings/gradingCategories';
