 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings/defaultGradingScheme.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsGetDefaultGradingScheme extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_get_default_grading_scheme';
    protected const DESCRIPTION = 'Get defaultGradingScheme from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/assignmentSettings/defaultGradingScheme.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentSettings/defaultGradingScheme';
