 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings/gradingCategories/{educationGradingCategory-id}.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsGetGradingCategories extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_get_grading_categories';
