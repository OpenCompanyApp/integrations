 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings/gradingCategories/$count.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsGradingCategoriesGetCountC354 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_grading_categories_get_count_c354';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentSettings/gradingCategories/$count';
