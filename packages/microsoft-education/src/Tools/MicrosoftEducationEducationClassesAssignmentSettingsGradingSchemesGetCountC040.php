 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings/gradingSchemes/$count.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsGradingSchemesGetCountC040 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_grading_schemes_get_count_c040';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentSettings/gradingSchemes/$count';
