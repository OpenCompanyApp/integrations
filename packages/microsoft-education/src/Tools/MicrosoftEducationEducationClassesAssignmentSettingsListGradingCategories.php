 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings/gradingCategories.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsListGradingCategories extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_list_grading_categories';
    protected const DESCRIPTION = 'Get gradingCategories from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/assignmentSettings/gradingCategories.';
