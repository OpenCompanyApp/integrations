 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings/gradingSchemes.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsListGradingSchemes extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_list_grading_schemes';
