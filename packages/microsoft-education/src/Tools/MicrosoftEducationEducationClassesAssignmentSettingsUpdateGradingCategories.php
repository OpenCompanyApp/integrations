 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/classes/{educationClass-id}/assignmentSettings/gradingCategories/{educationGradingCategory-id}.
 */
class MicrosoftEducationEducationClassesAssignmentSettingsUpdateGradingCategories extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignment_settings_update_grading_categories';
    protected const DESCRIPTION = 'Update gradingCategory\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/classes/{educationClass-id}/assignmentSettings/gradingCategories/{educationGradingCategory-id}.';
