 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}.
 */
class MicrosoftEducationEducationClassesAssignmentsDeleteSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignments_delete_submissions';
    protected const DESCRIPTION = 'Delete navigation property submissions for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}.';
