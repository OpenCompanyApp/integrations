 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignments/$count.
 */
class MicrosoftEducationEducationClassesAssignmentsGetCountA470 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignments_get_count_a470';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignments/$count';
