 ...
 * List outcomes.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/outcomes.
 */
class MicrosoftEducationEducationClassesAssignmentsSubmissionsListOutcomes extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignments_submissions_list_outcomes';
    protected const DESCRIPTION = 'List outcomes\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/outcomes.';
