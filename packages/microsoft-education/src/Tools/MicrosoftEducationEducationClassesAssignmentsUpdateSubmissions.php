 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}.
 */
class MicrosoftEducationEducationClassesAssignmentsUpdateSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_assignments_update_submissions';
    protected const DESCRIPTION = 'Update the navigation property submissions in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}';
