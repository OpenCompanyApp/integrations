 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes/{educationClass-id}/assignmentCategories.
 */
class MicrosoftEducationEducationClassesCreateAssignmentCategories extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_create_assignment_categories';
    protected const DESCRIPTION = 'Create educationCategory\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/classes/{educationClass-id}/assignmentCategories.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentCategories';
