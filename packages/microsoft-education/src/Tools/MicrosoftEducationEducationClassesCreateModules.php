 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes/{educationClass-id}/modules.
 */
class MicrosoftEducationEducationClassesCreateModules extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_create_modules';
    protected const DESCRIPTION = 'Create educationModule\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/classes/{educationClass-id}/modules.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/modules';
