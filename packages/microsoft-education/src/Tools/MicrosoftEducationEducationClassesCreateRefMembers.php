 ...
 * Add a student.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes/{educationClass-id}/members/$ref.
 */
class MicrosoftEducationEducationClassesCreateRefMembers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_create_ref_members';
    protected const DESCRIPTION = 'Add a student\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/classes/{educationClass-id}/members/$ref.';
