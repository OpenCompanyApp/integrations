 ...
 * Add teacher.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes/{educationClass-id}/teachers/$ref.
 */
class MicrosoftEducationEducationClassesCreateRefTeachers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_create_ref_teachers';
    protected const DESCRIPTION = 'Add teacher\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/classes/{educationClass-id}/teachers/$ref.';
