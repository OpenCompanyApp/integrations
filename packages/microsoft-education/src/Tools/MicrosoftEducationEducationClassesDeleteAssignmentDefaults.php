 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}/assignmentDefaults.
 */
class MicrosoftEducationEducationClassesDeleteAssignmentDefaults extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_delete_assignment_defaults';
    protected const DESCRIPTION = 'Delete navigation property assignmentDefaults for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/classes/{educationClass-id}/assignmentDefaults.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentDefaults';
