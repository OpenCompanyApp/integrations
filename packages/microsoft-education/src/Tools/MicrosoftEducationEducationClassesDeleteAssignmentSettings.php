 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}/assignmentSettings.
 */
class MicrosoftEducationEducationClassesDeleteAssignmentSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_delete_assignment_settings';
    protected const DESCRIPTION = 'Delete navigation property assignmentSettings for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/classes/{educationClass-id}/assignmentSettings.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentSettings';
