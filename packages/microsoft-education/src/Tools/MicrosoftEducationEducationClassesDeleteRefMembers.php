 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}/members/$ref.
 */
class MicrosoftEducationEducationClassesDeleteRefMembers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_delete_ref_members';
