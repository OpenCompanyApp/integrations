 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}/teachers/$ref.
 */
class MicrosoftEducationEducationClassesDeleteRefTeachers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_delete_ref_teachers';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/teachers/$ref';
