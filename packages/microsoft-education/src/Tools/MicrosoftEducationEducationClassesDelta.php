 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/delta().
 */
class MicrosoftEducationEducationClassesDelta extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_delta';
    ...
    protected const PATH = '/education/classes/delta()';
