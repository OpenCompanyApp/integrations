 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentCategories/delta().
 */
class MicrosoftEducationEducationClassesEducationClassAssignmentCategoriesDelta extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_education_class_assignment_categories_delta';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignmentCategories/delta()';
