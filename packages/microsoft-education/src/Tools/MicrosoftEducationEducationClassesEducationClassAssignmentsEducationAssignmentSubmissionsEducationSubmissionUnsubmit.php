 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/unsubmit.
 */
class MicrosoftEducationEducationClassesEducationClassAssignmentsEducationAssignmentSubmissionsEducationSubmissionUnsubmit extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_education_class_assignments_education_assignment_submissions_education_submission_unsubmit';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/unsubmit';
