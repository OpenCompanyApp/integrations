 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/getRecentlyModifiedSubmissions().
 */
class MicrosoftEducationEducationClassesEducationClassGetRecentlyModifiedSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_education_class_get_recently_modified_submissions';
    protected const DESCRIPTION = 'Invoke function getRecentlyModifiedSubmissions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/getRecentlyModifiedSubmissions().';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/getRecentlyModifiedSubmissions()';
