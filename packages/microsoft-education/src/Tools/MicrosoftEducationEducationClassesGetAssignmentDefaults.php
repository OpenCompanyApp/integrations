 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentDefaults.
 */
class MicrosoftEducationEducationClassesGetAssignmentDefaults extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_get_assignment_defaults';
    protected const DESCRIPTION = 'Get educationAssignmentDefaults\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/assignmentDefaults.';
