 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentSettings.
 */
class MicrosoftEducationEducationClassesGetAssignmentSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_get_assignment_settings';
    protected const DESCRIPTION = 'Get assignmentSettings from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/assignmentSettings.';
