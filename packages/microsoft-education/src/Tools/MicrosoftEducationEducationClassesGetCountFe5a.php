 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/$count.
 */
class MicrosoftEducationEducationClassesGetCountFe5a extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_get_count_fe5a';
    ...
    protected const PATH = '/education/classes/$count';
