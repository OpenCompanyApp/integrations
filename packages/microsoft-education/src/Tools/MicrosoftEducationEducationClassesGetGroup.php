 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/group.
 */
class MicrosoftEducationEducationClassesGetGroup extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_get_group';
    protected const DESCRIPTION = 'Get group from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/group.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/group';
