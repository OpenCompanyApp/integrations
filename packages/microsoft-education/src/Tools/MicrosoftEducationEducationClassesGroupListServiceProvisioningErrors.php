 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/group/serviceProvisioningErrors.
 */
class MicrosoftEducationEducationClassesGroupListServiceProvisioningErrors extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_group_list_service_provisioning_errors';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/group/serviceProvisioningErrors';
