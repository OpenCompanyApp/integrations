 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/group/serviceProvisioningErrors/$count.
 */
class MicrosoftEducationEducationClassesGroupServiceProvisioningErrorsGetCount5a91 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_group_service_provisioning_errors_get_count_5a91';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/group/serviceProvisioningErrors/$count';
