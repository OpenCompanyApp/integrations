 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/assignmentCategories.
 */
class MicrosoftEducationEducationClassesListAssignmentCategories extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_assignment_categories';
    protected const DESCRIPTION = 'List assignmentCategories\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/assignmentCategories.';
