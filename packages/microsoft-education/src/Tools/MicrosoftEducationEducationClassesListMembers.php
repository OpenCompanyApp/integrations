 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/members.
 */
class MicrosoftEducationEducationClassesListMembers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_members';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/members';
