 ...
 * List class modules.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/modules.
 */
class MicrosoftEducationEducationClassesListModules extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_modules';
    protected const DESCRIPTION = 'List class modules\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/modules.';
