 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/members/$ref.
 */
class MicrosoftEducationEducationClassesListRefMembers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_ref_members';
    protected const DESCRIPTION = 'List members of an educationClass\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/members/$ref.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/members/$ref';
