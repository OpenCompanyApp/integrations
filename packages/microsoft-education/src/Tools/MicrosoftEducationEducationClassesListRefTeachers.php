 ...
 * List teachers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/teachers/$ref.
 */
class MicrosoftEducationEducationClassesListRefTeachers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_ref_teachers';
    protected const DESCRIPTION = 'List teachers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/teachers/$ref.';
