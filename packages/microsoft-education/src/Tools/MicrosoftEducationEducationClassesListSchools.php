 ...
 * List schools.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/schools.
 */
class MicrosoftEducationEducationClassesListSchools extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_schools';
    protected const DESCRIPTION = 'List schools\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}/schools.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/schools';
