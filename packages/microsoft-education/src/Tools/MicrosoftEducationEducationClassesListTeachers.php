 ...
 * List teachers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/teachers.
 */
class MicrosoftEducationEducationClassesListTeachers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_list_teachers';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/teachers';
