 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/members/$count.
 */
class MicrosoftEducationEducationClassesMembersGetCount4459 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_members_get_count_4459';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/members/$count';
