 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/modules/$count.
 */
class MicrosoftEducationEducationClassesModulesGetCount7c88 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_modules_get_count_7c88';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/modules/$count';
