 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/schools/$count.
 */
class MicrosoftEducationEducationClassesSchoolsGetCountFef1 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_schools_get_count_fef1';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/schools/$count';
