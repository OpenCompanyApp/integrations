 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}/teachers/{educationUser-id}/$ref.
 */
class MicrosoftEducationEducationClassesTeachersDeleteRefEducationUser extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_teachers_delete_ref_education_user';
    protected const DESCRIPTION = 'Remove teacher from educationClass\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/classes/{educationClass-id}/teachers/{educationUser-id}/$ref.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/teachers/{educationUser-id}/$ref';
