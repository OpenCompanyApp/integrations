 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}/teachers/$count.
 */
class MicrosoftEducationEducationClassesTeachersGetCount4305 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_teachers_get_count_4305';
    ...
    protected const PATH = '/education/classes/{educationClass-id}/teachers/$count';
