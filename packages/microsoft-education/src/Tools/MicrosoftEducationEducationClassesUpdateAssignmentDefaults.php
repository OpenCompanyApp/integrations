 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/classes/{educationClass-id}/assignmentDefaults.
 */
class MicrosoftEducationEducationClassesUpdateAssignmentDefaults extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_update_assignment_defaults';
    protected const DESCRIPTION = 'Update educationAssignmentDefaults\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/classes/{educationClass-id}/assignmentDefaults.';
