 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/classes/{educationClass-id}/assignmentSettings.
 */
class MicrosoftEducationEducationClassesUpdateAssignmentSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_classes_update_assignment_settings';
    protected const DESCRIPTION = 'Update educationAssignmentSettings\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/classes/{educationClass-id}/assignmentSettings.';
