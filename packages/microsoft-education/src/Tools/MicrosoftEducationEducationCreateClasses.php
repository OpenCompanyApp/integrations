 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/classes.
 */
class MicrosoftEducationEducationCreateClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_create_classes';
    protected const DESCRIPTION = 'Create educationClass\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/classes.';
    ...
    protected const PATH = '/education/classes';
