 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/schools.
 */
class MicrosoftEducationEducationCreateSchools extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_create_schools';
    protected const DESCRIPTION = 'Create educationSchool\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/schools.';
    ...
    protected const PATH = '/education/schools';
