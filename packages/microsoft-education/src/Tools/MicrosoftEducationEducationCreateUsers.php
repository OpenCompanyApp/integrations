 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/users.
 */
class MicrosoftEducationEducationCreateUsers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_create_users';
    protected const DESCRIPTION = 'Create educationUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/users.';
    ...
    protected const PATH = '/education/users';
