 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/classes/{educationClass-id}.
 */
class MicrosoftEducationEducationDeleteClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_delete_classes';
    protected const DESCRIPTION = 'Delete educationClass\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/classes/{educationClass-id}.';
    ...
    protected const PATH = '/education/classes/{educationClass-id}';
