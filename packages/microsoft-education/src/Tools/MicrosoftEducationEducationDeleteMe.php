 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/me.
 */
class MicrosoftEducationEducationDeleteMe extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_delete_me';
    protected const DESCRIPTION = 'Delete navigation property me for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/me.';
