 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/reports.
 */
class MicrosoftEducationEducationDeleteReports extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_delete_reports';
    protected const DESCRIPTION = 'Delete navigation property reports for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/reports.';
