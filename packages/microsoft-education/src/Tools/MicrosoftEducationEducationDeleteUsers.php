 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/users/{educationUser-id}.
 */
class MicrosoftEducationEducationDeleteUsers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_delete_users';
    protected const DESCRIPTION = 'Delete educationUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/users/{educationUser-id}.';
    ...
    protected const PATH = '/education/users/{educationUser-id}';
