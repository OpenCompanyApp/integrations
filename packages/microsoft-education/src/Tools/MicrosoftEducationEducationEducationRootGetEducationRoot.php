 ...
 * Get education.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education.
 */
class MicrosoftEducationEducationEducationRootGetEducationRoot extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_education_root_get_education_root';
    protected const DESCRIPTION = 'Get education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education.';
