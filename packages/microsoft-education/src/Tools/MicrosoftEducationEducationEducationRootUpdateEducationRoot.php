 ...
 * Update education.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education.
 */
class MicrosoftEducationEducationEducationRootUpdateEducationRoot extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_education_root_update_education_root';
    protected const DESCRIPTION = 'Update education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education.';
    ...
    protected const PATH = '/education';
