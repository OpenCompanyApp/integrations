 ...
 * Get educationClass.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes/{educationClass-id}.
 */
class MicrosoftEducationEducationGetClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_get_classes';
    protected const DESCRIPTION = 'Get educationClass\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes/{educationClass-id}.';
