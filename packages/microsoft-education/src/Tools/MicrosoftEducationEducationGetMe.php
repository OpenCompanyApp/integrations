 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me.
 */
class MicrosoftEducationEducationGetMe extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_get_me';
    protected const DESCRIPTION = 'Get me from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/me.';
