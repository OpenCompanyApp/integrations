 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports.
 */
class MicrosoftEducationEducationGetReports extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_get_reports';
    protected const DESCRIPTION = 'Get reports from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports.';
