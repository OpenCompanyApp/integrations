 ...
 * Get educationUser.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}.
 */
class MicrosoftEducationEducationGetUsers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_get_users';
    protected const DESCRIPTION = 'Get educationUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/users/{educationUser-id}.';
