 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/classes.
 */
class MicrosoftEducationEducationListClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_list_classes';
    protected const DESCRIPTION = 'List educationClasses\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/classes.';
