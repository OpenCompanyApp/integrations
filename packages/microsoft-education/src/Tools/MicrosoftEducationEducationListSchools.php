 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/schools.
 */
class MicrosoftEducationEducationListSchools extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_list_schools';
    protected const DESCRIPTION = 'List educationSchools\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/schools.';
