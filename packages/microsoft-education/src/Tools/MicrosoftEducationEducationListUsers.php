 ...
 * List educationUsers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users.
 */
class MicrosoftEducationEducationListUsers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_list_users';
    protected const DESCRIPTION = 'List educationUsers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/users.';
