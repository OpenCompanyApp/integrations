 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/assignments/delta().
 */
class MicrosoftEducationEducationMeAssignmentsDelta extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_assignments_delta';
    ...
    protected const PATH = '/education/me/assignments/delta()';
