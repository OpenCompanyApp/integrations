 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/assignments/$count.
 */
class MicrosoftEducationEducationMeAssignmentsGetCountD634 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_assignments_get_count_d634';
    ...
    protected const PATH = '/education/me/assignments/$count';
