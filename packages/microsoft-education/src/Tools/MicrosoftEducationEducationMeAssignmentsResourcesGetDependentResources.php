 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}/dependentResources/{educationAssignmentResource-id1}.
 */
class MicrosoftEducationEducationMeAssignmentsResourcesGetDependentResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_assignments_resources_get_dependent_resources';
