 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/me/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}/dependentResources/{educationAssignmentResource-id1}.
 */
class MicrosoftEducationEducationMeAssignmentsResourcesUpdateDependentResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_assignments_resources_update_dependent_resources';
    protected const DESCRIPTION = 'Update the navigation property dependentResources in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/me/assignments/{educationAssignment-id}/resources/{educationAssignmentResource-id}/dependentResources/{educationAssignmentResource-id1}.';
