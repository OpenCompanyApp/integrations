 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/classes/$count.
 */
class MicrosoftEducationEducationMeClassesGetCount94ca extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_classes_get_count_94ca';
    ...
    protected const PATH = '/education/me/classes/$count';
