 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/me/assignments.
 */
class MicrosoftEducationEducationMeCreateAssignments extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_create_assignments';
    protected const DESCRIPTION = 'Create new navigation property to assignments for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/me/assignments.';
    ...
    protected const PATH = '/education/me/assignments';
