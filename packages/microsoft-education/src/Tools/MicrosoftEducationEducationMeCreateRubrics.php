 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/me/rubrics.
 */
class MicrosoftEducationEducationMeCreateRubrics extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_create_rubrics';
    protected const DESCRIPTION = 'Create educationRubric\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/me/rubrics.';
    ...
    protected const PATH = '/education/me/rubrics';
