 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/classes/{educationClass-id}.
 */
class MicrosoftEducationEducationMeGetClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_get_classes';
    ...
    protected const PATH = '/education/me/classes/{educationClass-id}';
