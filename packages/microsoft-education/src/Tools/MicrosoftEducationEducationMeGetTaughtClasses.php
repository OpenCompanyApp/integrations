 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/taughtClasses/{educationClass-id}.
 */
class MicrosoftEducationEducationMeGetTaughtClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_get_taught_classes';
    ...
    protected const PATH = '/education/me/taughtClasses/{educationClass-id}';
