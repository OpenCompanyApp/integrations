 ...
 * Get educationUser.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/user.
 */
class MicrosoftEducationEducationMeGetUser extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_get_user';
    ...
    protected const PATH = '/education/me/user';
