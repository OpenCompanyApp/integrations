 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/assignments.
 */
class MicrosoftEducationEducationMeListAssignments extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_list_assignments';
