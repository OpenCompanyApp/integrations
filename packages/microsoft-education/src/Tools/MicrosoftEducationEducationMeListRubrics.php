 ...
 * List rubrics.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/rubrics.
 */
class MicrosoftEducationEducationMeListRubrics extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_list_rubrics';
    protected const DESCRIPTION = 'List rubrics\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/me/rubrics.';
