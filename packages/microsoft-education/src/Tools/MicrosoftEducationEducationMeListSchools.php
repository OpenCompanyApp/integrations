 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/schools.
 */
class MicrosoftEducationEducationMeListSchools extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_list_schools';
    protected const DESCRIPTION = 'List schools of an educationUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/me/schools.';
    ...
    protected const PATH = '/education/me/schools';
