 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/rubrics/$count.
 */
class MicrosoftEducationEducationMeRubricsGetCount346e extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_rubrics_get_count_346e';
    ...
    protected const PATH = '/education/me/rubrics/$count';
