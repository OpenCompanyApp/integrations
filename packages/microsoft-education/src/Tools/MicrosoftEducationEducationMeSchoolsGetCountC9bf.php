 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/schools/$count.
 */
class MicrosoftEducationEducationMeSchoolsGetCountC9bf extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_schools_get_count_c9bf';
    ...
    protected const PATH = '/education/me/schools/$count';
