 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/taughtClasses/$count.
 */
class MicrosoftEducationEducationMeTaughtClassesGetCount94df extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_taught_classes_get_count_94df';
    ...
    protected const PATH = '/education/me/taughtClasses/$count';
