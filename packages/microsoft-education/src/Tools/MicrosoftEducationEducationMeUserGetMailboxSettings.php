 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/user/mailboxSettings.
 */
class MicrosoftEducationEducationMeUserGetMailboxSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_user_get_mailbox_settings';
    ...
    protected const PATH = '/education/me/user/mailboxSettings';
