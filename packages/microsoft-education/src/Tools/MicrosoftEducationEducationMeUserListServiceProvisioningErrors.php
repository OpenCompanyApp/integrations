 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/user/serviceProvisioningErrors.
 */
class MicrosoftEducationEducationMeUserListServiceProvisioningErrors extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_user_list_service_provisioning_errors';
    ...
    protected const PATH = '/education/me/user/serviceProvisioningErrors';
