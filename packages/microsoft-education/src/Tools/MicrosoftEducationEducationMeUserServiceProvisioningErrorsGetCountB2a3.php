 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/me/user/serviceProvisioningErrors/$count.
 */
class MicrosoftEducationEducationMeUserServiceProvisioningErrorsGetCountB2a3 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_user_service_provisioning_errors_get_count_b2a3';
    ...
    protected const PATH = '/education/me/user/serviceProvisioningErrors/$count';
