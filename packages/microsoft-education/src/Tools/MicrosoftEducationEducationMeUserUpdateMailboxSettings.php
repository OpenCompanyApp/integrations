 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/me/user/mailboxSettings.
 */
class MicrosoftEducationEducationMeUserUpdateMailboxSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_me_user_update_mailbox_settings';
