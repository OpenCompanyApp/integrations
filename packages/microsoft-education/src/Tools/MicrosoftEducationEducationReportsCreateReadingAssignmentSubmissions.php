 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/reports/readingAssignmentSubmissions.
 */
class MicrosoftEducationEducationReportsCreateReadingAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_create_reading_assignment_submissions';
    protected const DESCRIPTION = 'Create new navigation property to readingAssignmentSubmissions for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/reports/readingAssignmentSubmissions.';
    ...
    protected const PATH = '/education/reports/readingAssignmentSubmissions';
