 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/reports/readingCoachPassages.
 */
class MicrosoftEducationEducationReportsCreateReadingCoachPassages extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_create_reading_coach_passages';
    protected const DESCRIPTION = 'Create new navigation property to readingCoachPassages for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/reports/readingCoachPassages.';
    ...
    protected const PATH = '/education/reports/readingCoachPassages';
