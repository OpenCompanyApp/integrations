 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/reports/reflectCheckInResponses.
 */
class MicrosoftEducationEducationReportsCreateReflectCheckInResponses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_create_reflect_check_in_responses';
    protected const DESCRIPTION = 'Create new navigation property to reflectCheckInResponses for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/reports/reflectCheckInResponses.';
    ...
    protected const PATH = '/education/reports/reflectCheckInResponses';
