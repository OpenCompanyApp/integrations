 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/reports/speakerAssignmentSubmissions.
 */
class MicrosoftEducationEducationReportsCreateSpeakerAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_create_speaker_assignment_submissions';
    protected const DESCRIPTION = 'Create new navigation property to speakerAssignmentSubmissions for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/reports/speakerAssignmentSubmissions.';
    ...
    protected const PATH = '/education/reports/speakerAssignmentSubmissions';
