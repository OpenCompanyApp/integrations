 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/readingAssignmentSubmissions/{readingAssignmentSubmission-id}.
 */
class MicrosoftEducationEducationReportsGetReadingAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_get_reading_assignment_submissions';
    protected const DESCRIPTION = 'Get readingAssignmentSubmissions from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/readingAssignmentSubmissions/{readingAssignmentSubmission-id}.';
