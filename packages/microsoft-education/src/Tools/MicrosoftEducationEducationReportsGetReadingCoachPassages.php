 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/readingCoachPassages/{readingCoachPassage-id}.
 */
class MicrosoftEducationEducationReportsGetReadingCoachPassages extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_get_reading_coach_passages';
    protected const DESCRIPTION = 'Get readingCoachPassages from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/readingCoachPassages/{readingCoachPassage-id}.';
