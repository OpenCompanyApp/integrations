 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/reflectCheckInResponses/{reflectCheckInResponse-id}.
 */
class MicrosoftEducationEducationReportsGetReflectCheckInResponses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_get_reflect_check_in_responses';
    protected const DESCRIPTION = 'Get reflectCheckInResponses from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/reflectCheckInResponses/{reflectCheckInResponse-id}.';
