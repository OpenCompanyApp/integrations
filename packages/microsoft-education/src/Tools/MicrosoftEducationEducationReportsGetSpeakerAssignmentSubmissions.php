 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/speakerAssignmentSubmissions/{speakerAssignmentSubmission-id}.
 */
class MicrosoftEducationEducationReportsGetSpeakerAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_get_speaker_assignment_submissions';
    protected const DESCRIPTION = 'Get speakerAssignmentSubmissions from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/speakerAssignmentSubmissions/{speakerAssignmentSubmission-id}.';
