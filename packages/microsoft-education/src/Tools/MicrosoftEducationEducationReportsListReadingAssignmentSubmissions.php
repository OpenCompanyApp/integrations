 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/readingAssignmentSubmissions.
 */
class MicrosoftEducationEducationReportsListReadingAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_list_reading_assignment_submissions';
    protected const DESCRIPTION = 'List readingAssignmentSubmissions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/readingAssignmentSubmissions.';
