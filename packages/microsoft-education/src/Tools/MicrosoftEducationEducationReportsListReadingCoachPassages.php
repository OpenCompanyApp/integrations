 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/readingCoachPassages.
 */
class MicrosoftEducationEducationReportsListReadingCoachPassages extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_list_reading_coach_passages';
    protected const DESCRIPTION = 'List readingCoachPassages\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/readingCoachPassages.';
