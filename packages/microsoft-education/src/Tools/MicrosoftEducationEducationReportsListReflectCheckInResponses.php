 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/reflectCheckInResponses.
 */
class MicrosoftEducationEducationReportsListReflectCheckInResponses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_list_reflect_check_in_responses';
    protected const DESCRIPTION = 'List reflectCheckInResponses\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/reflectCheckInResponses.';
