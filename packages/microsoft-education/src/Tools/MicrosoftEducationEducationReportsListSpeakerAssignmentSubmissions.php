 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/speakerAssignmentSubmissions.
 */
class MicrosoftEducationEducationReportsListSpeakerAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_list_speaker_assignment_submissions';
    protected const DESCRIPTION = 'List speakerAssignmentSubmissions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/reports/speakerAssignmentSubmissions.';
