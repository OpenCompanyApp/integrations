 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/readingAssignmentSubmissions/$count.
 */
class MicrosoftEducationEducationReportsReadingAssignmentSubmissionsGetCount536e extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_reading_assignment_submissions_get_count_536e';
    ...
    protected const PATH = '/education/reports/readingAssignmentSubmissions/$count';
