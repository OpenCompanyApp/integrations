 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/readingCoachPassages/$count.
 */
class MicrosoftEducationEducationReportsReadingCoachPassagesGetCountCe63 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_reading_coach_passages_get_count_ce63';
    ...
    protected const PATH = '/education/reports/readingCoachPassages/$count';
