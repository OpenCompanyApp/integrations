 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/reflectCheckInResponses/$count.
 */
class MicrosoftEducationEducationReportsReflectCheckInResponsesGetCount1316 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_reflect_check_in_responses_get_count_1316';
    ...
    protected const PATH = '/education/reports/reflectCheckInResponses/$count';
