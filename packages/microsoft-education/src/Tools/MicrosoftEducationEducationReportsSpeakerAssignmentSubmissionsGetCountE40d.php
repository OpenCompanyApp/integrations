 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/reports/speakerAssignmentSubmissions/$count.
 */
class MicrosoftEducationEducationReportsSpeakerAssignmentSubmissionsGetCountE40d extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_speaker_assignment_submissions_get_count_e40d';
    ...
    protected const PATH = '/education/reports/speakerAssignmentSubmissions/$count';
