 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/reports/readingAssignmentSubmissions/{readingAssignmentSubmission-id}.
 */
class MicrosoftEducationEducationReportsUpdateReadingAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_update_reading_assignment_submissions';
    protected const DESCRIPTION = 'Update the navigation property readingAssignmentSubmissions in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/reports/readingAssignmentSubmissions/{readingAssignmentSubmission-id}.';
