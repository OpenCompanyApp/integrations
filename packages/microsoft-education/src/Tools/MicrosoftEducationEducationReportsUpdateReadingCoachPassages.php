 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/reports/readingCoachPassages/{readingCoachPassage-id}.
 */
class MicrosoftEducationEducationReportsUpdateReadingCoachPassages extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_update_reading_coach_passages';
    protected const DESCRIPTION = 'Update the navigation property readingCoachPassages in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/reports/readingCoachPassages/{readingCoachPassage-id}.';
