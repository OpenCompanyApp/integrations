 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/reports/reflectCheckInResponses/{reflectCheckInResponse-id}.
 */
class MicrosoftEducationEducationReportsUpdateReflectCheckInResponses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_update_reflect_check_in_responses';
    protected const DESCRIPTION = 'Update the navigation property reflectCheckInResponses in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/reports/reflectCheckInResponses/{reflectCheckInResponse-id}.';
