 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/reports/speakerAssignmentSubmissions/{speakerAssignmentSubmission-id}.
 */
class MicrosoftEducationEducationReportsUpdateSpeakerAssignmentSubmissions extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_reports_update_speaker_assignment_submissions';
    protected const DESCRIPTION = 'Update the navigation property speakerAssignmentSubmissions in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/reports/speakerAssignmentSubmissions/{speakerAssignmentSubmission-id}.';
