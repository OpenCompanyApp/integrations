 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/schools/delta().
 */
class MicrosoftEducationEducationSchoolsDelta extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_schools_delta';
    ...
    protected const PATH = '/education/schools/delta()';
