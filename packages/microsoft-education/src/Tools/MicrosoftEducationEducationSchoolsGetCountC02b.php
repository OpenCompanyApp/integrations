 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/schools/$count.
 */
class MicrosoftEducationEducationSchoolsGetCountC02b extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_schools_get_count_c02b';
    ...
    protected const PATH = '/education/schools/$count';
