 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/schools/{educationSchool-id}/users/{educationUser-id}/$ref.
 */
class MicrosoftEducationEducationSchoolsUsersDeleteRefEducationUser extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_schools_users_delete_ref_education_user';
