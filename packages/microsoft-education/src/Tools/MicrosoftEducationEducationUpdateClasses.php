 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/classes/{educationClass-id}.
 */
class MicrosoftEducationEducationUpdateClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_update_classes';
    protected const DESCRIPTION = 'Update educationClass\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/classes/{educationClass-id}.';
