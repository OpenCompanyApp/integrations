 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/me.
 */
class MicrosoftEducationEducationUpdateMe extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_update_me';
    protected const DESCRIPTION = 'Update the navigation property me in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/me.';
    ...
    protected const PATH = '/education/me';
