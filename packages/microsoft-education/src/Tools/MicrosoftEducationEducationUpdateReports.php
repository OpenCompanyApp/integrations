 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/reports.
 */
class MicrosoftEducationEducationUpdateReports extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_update_reports';
    protected const DESCRIPTION = 'Update the navigation property reports in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/reports.';
    ...
    protected const PATH = '/education/reports';
