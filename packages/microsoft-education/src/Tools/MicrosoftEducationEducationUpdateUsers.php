 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/users/{educationUser-id}.
 */
class MicrosoftEducationEducationUpdateUsers extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_update_users';
    protected const DESCRIPTION = 'Update educationUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/users/{educationUser-id}.';
