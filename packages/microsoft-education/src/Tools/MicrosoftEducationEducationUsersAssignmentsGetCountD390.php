 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/assignments/$count.
 */
class MicrosoftEducationEducationUsersAssignmentsGetCountD390 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_assignments_get_count_d390';
    ...
    protected const PATH = '/education/users/{educationUser-id}/assignments/$count';
