 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/resources/{educationSubmissionResource-id}.
 */
class MicrosoftEducationEducationUsersAssignmentsSubmissionsDeleteResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_assignments_submissions_delete_resources';
    protected const DESCRIPTION = 'Delete navigation property resources for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/resources/{educationSubmissionResource-id}.';
