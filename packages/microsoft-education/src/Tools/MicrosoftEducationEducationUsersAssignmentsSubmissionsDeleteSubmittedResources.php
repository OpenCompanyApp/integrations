 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}.
 */
class MicrosoftEducationEducationUsersAssignmentsSubmissionsDeleteSubmittedResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_assignments_submissions_delete_submitted_resources';
    protected const DESCRIPTION = 'Delete navigation property submittedResources for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}.';
