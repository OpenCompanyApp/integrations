 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}.
 */
class MicrosoftEducationEducationUsersAssignmentsSubmissionsGetSubmittedResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_assignments_submissions_get_submitted_resources';
