 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}/dependentResources.
 */
class MicrosoftEducationEducationUsersAssignmentsSubmissionsSubmittedResourcesCreateDependentResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_assignments_submissions_submitted_resources_create_dependent_resources';
    protected const DESCRIPTION = 'Create new navigation property to dependentResources for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}/dependentResources.';
    ...
    protected const PATH = '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}/dependentResources';
