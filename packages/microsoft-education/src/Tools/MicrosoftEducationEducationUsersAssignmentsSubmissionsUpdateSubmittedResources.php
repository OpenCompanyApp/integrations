 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}.
 */
class MicrosoftEducationEducationUsersAssignmentsSubmissionsUpdateSubmittedResources extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_assignments_submissions_update_submitted_resources';
    protected const DESCRIPTION = 'Update the navigation property submittedResources in education\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}.';
    ...
    protected const PATH = '/education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/submittedResources/{educationSubmissionResource-id}';
