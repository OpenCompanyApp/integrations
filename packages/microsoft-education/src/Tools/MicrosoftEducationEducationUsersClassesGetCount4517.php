 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/classes/$count.
 */
class MicrosoftEducationEducationUsersClassesGetCount4517 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_classes_get_count_4517';
    ...
    protected const PATH = '/education/users/{educationUser-id}/classes/$count';
