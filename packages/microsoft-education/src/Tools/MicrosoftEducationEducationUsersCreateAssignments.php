 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/users/{educationUser-id}/assignments.
 */
class MicrosoftEducationEducationUsersCreateAssignments extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_create_assignments';
    protected const DESCRIPTION = 'Create new navigation property to assignments for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/users/{educationUser-id}/assignments.';
    ...
    protected const PATH = '/education/users/{educationUser-id}/assignments';
