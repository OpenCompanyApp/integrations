 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /education/users/{educationUser-id}/rubrics.
 */
class MicrosoftEducationEducationUsersCreateRubrics extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_create_rubrics';
    protected const DESCRIPTION = 'Create new navigation property to rubrics for education\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /education/users/{educationUser-id}/rubrics.';
