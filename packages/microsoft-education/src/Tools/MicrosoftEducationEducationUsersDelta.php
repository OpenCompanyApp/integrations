 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/delta().
 */
class MicrosoftEducationEducationUsersDelta extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_delta';
    ...
    protected const PATH = '/education/users/delta()';
