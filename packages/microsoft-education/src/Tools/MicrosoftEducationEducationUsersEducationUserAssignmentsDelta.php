 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/assignments/delta().
 */
class MicrosoftEducationEducationUsersEducationUserAssignmentsDelta extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_education_user_assignments_delta';
    ...
    protected const PATH = '/education/users/{educationUser-id}/assignments/delta()';
