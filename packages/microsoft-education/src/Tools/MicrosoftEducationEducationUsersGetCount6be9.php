 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/$count.
 */
class MicrosoftEducationEducationUsersGetCount6be9 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_get_count_6be9';
    ...
    protected const PATH = '/education/users/$count';
