 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/user.
 */
class MicrosoftEducationEducationUsersGetUser extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_get_user';
    protected const DESCRIPTION = 'Get user from education\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/users/{educationUser-id}/user.';
    ...
    protected const PATH = '/education/users/{educationUser-id}/user';
