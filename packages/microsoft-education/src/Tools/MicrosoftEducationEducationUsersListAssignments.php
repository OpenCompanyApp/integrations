 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/assignments.
 */
class MicrosoftEducationEducationUsersListAssignments extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_list_assignments';
    protected const DESCRIPTION = 'List assignments of a user\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/users/{educationUser-id}/assignments.';
