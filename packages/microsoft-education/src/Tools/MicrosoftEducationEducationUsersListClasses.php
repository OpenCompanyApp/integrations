 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/classes.
 */
class MicrosoftEducationEducationUsersListClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_list_classes';
    ...
    protected const PATH = '/education/users/{educationUser-id}/classes';
