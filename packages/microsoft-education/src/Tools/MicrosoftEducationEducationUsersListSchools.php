 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/schools.
 */
class MicrosoftEducationEducationUsersListSchools extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_list_schools';
    ...
    protected const PATH = '/education/users/{educationUser-id}/schools';
