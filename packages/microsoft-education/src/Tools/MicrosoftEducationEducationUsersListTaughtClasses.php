 ...
 * List taughtClasses.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/taughtClasses.
 */
class MicrosoftEducationEducationUsersListTaughtClasses extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_list_taught_classes';
    protected const DESCRIPTION = 'List taughtClasses\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /education/users/{educationUser-id}/taughtClasses.';
    ...
    protected const PATH = '/education/users/{educationUser-id}/taughtClasses';
