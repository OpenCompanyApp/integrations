 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/rubrics/$count.
 */
class MicrosoftEducationEducationUsersRubricsGetCount7e40 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_rubrics_get_count_7e40';
    ...
    protected const PATH = '/education/users/{educationUser-id}/rubrics/$count';
