 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/schools/$count.
 */
class MicrosoftEducationEducationUsersSchoolsGetCountA99c extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_schools_get_count_a99c';
    ...
    protected const PATH = '/education/users/{educationUser-id}/schools/$count';
