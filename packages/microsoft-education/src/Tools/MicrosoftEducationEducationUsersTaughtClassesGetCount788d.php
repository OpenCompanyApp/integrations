 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/taughtClasses/$count.
 */
class MicrosoftEducationEducationUsersTaughtClassesGetCount788d extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_taught_classes_get_count_788d';
    ...
    protected const PATH = '/education/users/{educationUser-id}/taughtClasses/$count';
