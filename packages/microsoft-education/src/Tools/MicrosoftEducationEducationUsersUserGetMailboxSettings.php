 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/user/mailboxSettings.
 */
class MicrosoftEducationEducationUsersUserGetMailboxSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_user_get_mailbox_settings';
    ...
    protected const PATH = '/education/users/{educationUser-id}/user/mailboxSettings';
