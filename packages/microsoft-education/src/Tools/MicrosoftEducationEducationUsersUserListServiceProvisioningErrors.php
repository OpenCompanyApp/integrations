 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/user/serviceProvisioningErrors.
 */
class MicrosoftEducationEducationUsersUserListServiceProvisioningErrors extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_user_list_service_provisioning_errors';
    ...
    protected const PATH = '/education/users/{educationUser-id}/user/serviceProvisioningErrors';
