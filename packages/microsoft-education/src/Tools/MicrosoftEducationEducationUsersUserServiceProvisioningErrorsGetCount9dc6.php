 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /education/users/{educationUser-id}/user/serviceProvisioningErrors/$count.
 */
class MicrosoftEducationEducationUsersUserServiceProvisioningErrorsGetCount9dc6 extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_user_service_provisioning_errors_get_count_9dc6';
    ...
    protected const PATH = '/education/users/{educationUser-id}/user/serviceProvisioningErrors/$count';
