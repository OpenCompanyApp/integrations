 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /education/users/{educationUser-id}/user/mailboxSettings.
 */
class MicrosoftEducationEducationUsersUserUpdateMailboxSettings extends AbstractMicrosoftEducationTool
{
    protected const NAME = 'microsoft_education_education_users_user_update_mailbox_settings';
