 ...
 * Remove appliesTo.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /applications/{application-id}/appManagementPolicies/{appManagementPolicy-id}/$ref.
 */
class MicrosoftEntraIdApplicationsAppManagementPoliciesDeleteRefAppManagementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_app_management_policies_delete_ref_app_management_policy';
