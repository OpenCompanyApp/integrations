 ...
 * Create application.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /applications.
 */
class MicrosoftEntraIdApplicationsApplicationCreateApplication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_application_create_application';
    ...
    protected const PATH = '/applications';
