 ...
 * List applications.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications.
 */
class MicrosoftEntraIdApplicationsApplicationListApplication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_application_list_application';
