 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema/functions().
 */
class MicrosoftEntraIdApplicationsApplicationSynchronizationTemplatesSynchronizationTemplateSchemaFunctions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_application_synchronization_templates_synchronization_template_schema_functions';
    ...
    protected const PATH = '/applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema/functions()';
