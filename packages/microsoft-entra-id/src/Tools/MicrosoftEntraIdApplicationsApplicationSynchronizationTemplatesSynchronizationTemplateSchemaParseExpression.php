 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema/parseExpression.
 */
class MicrosoftEntraIdApplicationsApplicationSynchronizationTemplatesSynchronizationTemplateSchemaParseExpression extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_application_synchronization_templates_synchronization_template_schema_parse_expression';
    ...
    protected const PATH = '/applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema/parseExpression';
