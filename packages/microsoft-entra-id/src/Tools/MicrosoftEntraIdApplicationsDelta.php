 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications/delta().
 */
class MicrosoftEntraIdApplicationsDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_delta';
    ...
    protected const PATH = '/applications/delta()';
