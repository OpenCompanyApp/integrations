 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /applications/{application-id}/federatedIdentityCredentials(name='{name}').
 */
class MicrosoftEntraIdApplicationsFederatedIdentityCredentialsDeleteByName extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_federated_identity_credentials_delete_by_name';
