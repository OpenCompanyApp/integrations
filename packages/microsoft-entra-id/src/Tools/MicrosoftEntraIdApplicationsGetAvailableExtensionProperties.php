 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /applications/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdApplicationsGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_get_available_extension_properties';
    ...
    protected const PATH = '/applications/getAvailableExtensionProperties';
