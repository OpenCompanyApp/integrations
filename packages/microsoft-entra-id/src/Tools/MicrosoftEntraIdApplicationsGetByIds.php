 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /applications/getByIds.
 */
class MicrosoftEntraIdApplicationsGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_get_by_ids';
    ...
    protected const PATH = '/applications/getByIds';
