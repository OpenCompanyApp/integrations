 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications/$count.
 */
class MicrosoftEntraIdApplicationsGetCount8398 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_get_count_8398';
    ...
    protected const PATH = '/applications/$count';
