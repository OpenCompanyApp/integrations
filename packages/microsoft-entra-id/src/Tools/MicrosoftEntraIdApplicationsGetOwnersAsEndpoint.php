 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications/{application-id}/owners/{directoryObject-id}/graph.endpoint.
 */
class MicrosoftEntraIdApplicationsGetOwnersAsEndpoint extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_get_owners_as_endpoint';
    ...
    protected const PATH = '/applications/{application-id}/owners/{directoryObject-id}/graph.endpoint';
