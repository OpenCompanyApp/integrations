 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications/{application-id}/owners/{directoryObject-id}/graph.user.
 */
class MicrosoftEntraIdApplicationsGetOwnersAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_get_owners_as_user';
    ...
    protected const PATH = '/applications/{application-id}/owners/{directoryObject-id}/graph.user';
