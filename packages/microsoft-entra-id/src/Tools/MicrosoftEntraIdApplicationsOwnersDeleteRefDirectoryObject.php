 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /applications/{application-id}/owners/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdApplicationsOwnersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_owners_delete_ref_directory_object';
    ...
    protected const PATH = '/applications/{application-id}/owners/{directoryObject-id}/$ref';
