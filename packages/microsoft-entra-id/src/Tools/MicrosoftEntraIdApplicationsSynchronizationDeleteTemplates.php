 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}.
 */
class MicrosoftEntraIdApplicationsSynchronizationDeleteTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_synchronization_delete_templates';
    protected const DESCRIPTION = 'Delete navigation property templates for applications\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}.';
    ...
    protected const PATH = '/applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}';
