 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema.
 */
class MicrosoftEntraIdApplicationsSynchronizationTemplatesDeleteSchema extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_synchronization_templates_delete_schema';
