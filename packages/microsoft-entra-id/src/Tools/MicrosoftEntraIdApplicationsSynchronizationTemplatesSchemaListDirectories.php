 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema/directories.
 */
class MicrosoftEntraIdApplicationsSynchronizationTemplatesSchemaListDirectories extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_synchronization_templates_schema_list_directories';
