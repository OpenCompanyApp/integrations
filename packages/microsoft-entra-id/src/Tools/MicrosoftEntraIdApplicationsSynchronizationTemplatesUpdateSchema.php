 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema.
 */
class MicrosoftEntraIdApplicationsSynchronizationTemplatesUpdateSchema extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_synchronization_templates_update_schema';
    ...
    protected const PATH = '/applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema';
