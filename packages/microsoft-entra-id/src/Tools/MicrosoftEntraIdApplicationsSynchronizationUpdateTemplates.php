 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}.
 */
class MicrosoftEntraIdApplicationsSynchronizationUpdateTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_synchronization_update_templates';
    protected const DESCRIPTION = 'Update synchronizationTemplate\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}.';
