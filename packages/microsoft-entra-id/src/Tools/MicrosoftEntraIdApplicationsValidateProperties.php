 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /applications/validateProperties.
 */
class MicrosoftEntraIdApplicationsValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_applications_validate_properties';
    ...
    protected const PATH = '/applications/validateProperties';
