 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /contracts.
 */
class MicrosoftEntraIdContractsContractCreateContract extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_contract_create_contract';
    protected const DESCRIPTION = 'Add new entity to contracts\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /contracts.';
    ...
    protected const PATH = '/contracts';
