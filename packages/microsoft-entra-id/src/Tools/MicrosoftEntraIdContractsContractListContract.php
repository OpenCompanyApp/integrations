 ...
 * List contracts.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /contracts.
 */
class MicrosoftEntraIdContractsContractListContract extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_contract_list_contract';
    protected const DESCRIPTION = 'List contracts\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /contracts.';
