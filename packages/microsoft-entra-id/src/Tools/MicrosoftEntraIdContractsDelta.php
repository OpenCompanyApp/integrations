 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /contracts/delta().
 */
class MicrosoftEntraIdContractsDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_delta';
    ...
    protected const PATH = '/contracts/delta()';
