 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /contracts/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdContractsGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_get_available_extension_properties';
    ...
    protected const PATH = '/contracts/getAvailableExtensionProperties';
