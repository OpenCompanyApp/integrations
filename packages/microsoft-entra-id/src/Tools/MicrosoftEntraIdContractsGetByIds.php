 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /contracts/getByIds.
 */
class MicrosoftEntraIdContractsGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_get_by_ids';
    ...
    protected const PATH = '/contracts/getByIds';
