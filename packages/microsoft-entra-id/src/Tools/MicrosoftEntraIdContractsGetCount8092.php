 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /contracts/$count.
 */
class MicrosoftEntraIdContractsGetCount8092 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_get_count_8092';
    ...
    protected const PATH = '/contracts/$count';
