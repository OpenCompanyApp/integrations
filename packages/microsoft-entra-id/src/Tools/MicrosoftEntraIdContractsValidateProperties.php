 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /contracts/validateProperties.
 */
class MicrosoftEntraIdContractsValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_contracts_validate_properties';
    ...
    protected const PATH = '/contracts/validateProperties';
