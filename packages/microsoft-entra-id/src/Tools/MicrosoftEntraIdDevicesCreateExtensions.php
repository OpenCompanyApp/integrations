 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/{device-id}/extensions.
 */
class MicrosoftEntraIdDevicesCreateExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_create_extensions';
    protected const DESCRIPTION = 'Create new navigation property to extensions for devices\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /devices/{device-id}/extensions.';
    ...
    protected const PATH = '/devices/{device-id}/extensions';
