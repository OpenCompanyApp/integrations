 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/{device-id}/registeredOwners/$ref.
 */
class MicrosoftEntraIdDevicesCreateRefRegisteredOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_create_ref_registered_owners';
    protected const DESCRIPTION = 'Create registeredOwner\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /devices/{device-id}/registeredOwners/$ref.';
