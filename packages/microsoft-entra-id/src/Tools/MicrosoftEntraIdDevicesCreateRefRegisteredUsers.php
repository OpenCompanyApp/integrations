 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/{device-id}/registeredUsers/$ref.
 */
class MicrosoftEntraIdDevicesCreateRefRegisteredUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_create_ref_registered_users';
    protected const DESCRIPTION = 'Create registeredUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /devices/{device-id}/registeredUsers/$ref.';
