 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /devices/{device-id}/registeredOwners/$ref.
 */
class MicrosoftEntraIdDevicesDeleteRefRegisteredOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_delete_ref_registered_owners';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/$ref';
