 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /devices/{device-id}/registeredUsers/$ref.
 */
class MicrosoftEntraIdDevicesDeleteRefRegisteredUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_delete_ref_registered_users';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/$ref';
