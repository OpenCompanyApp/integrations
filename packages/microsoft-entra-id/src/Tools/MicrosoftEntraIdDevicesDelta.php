 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/delta().
 */
class MicrosoftEntraIdDevicesDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_delta';
    ...
    protected const PATH = '/devices/delta()';
