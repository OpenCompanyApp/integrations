 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/{device-id}/checkMemberGroups.
 */
class MicrosoftEntraIdDevicesDeviceCheckMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_check_member_groups';
    ...
    protected const PATH = '/devices/{device-id}/checkMemberGroups';
