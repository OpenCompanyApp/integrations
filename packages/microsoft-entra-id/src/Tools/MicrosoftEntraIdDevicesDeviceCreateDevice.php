 ...
 * Create device.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices.
 */
class MicrosoftEntraIdDevicesDeviceCreateDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_create_device';
    protected const DESCRIPTION = 'Create device\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /devices.';
