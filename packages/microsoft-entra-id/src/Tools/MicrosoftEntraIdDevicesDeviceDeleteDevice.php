 ...
 * Delete device.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /devices/{device-id}.
 */
class MicrosoftEntraIdDevicesDeviceDeleteDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_delete_device';
    ...
    protected const PATH = '/devices/{device-id}';
