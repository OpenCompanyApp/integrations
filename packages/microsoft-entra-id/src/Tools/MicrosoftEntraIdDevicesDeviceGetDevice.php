 ...
 * Get device.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}.
 */
class MicrosoftEntraIdDevicesDeviceGetDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_get_device';
