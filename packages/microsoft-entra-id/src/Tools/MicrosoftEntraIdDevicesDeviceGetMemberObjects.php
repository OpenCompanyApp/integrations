 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/{device-id}/getMemberObjects.
 */
class MicrosoftEntraIdDevicesDeviceGetMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_get_member_objects';
    ...
    protected const PATH = '/devices/{device-id}/getMemberObjects';
