 ...
 * List devices.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices.
 */
class MicrosoftEntraIdDevicesDeviceListDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_list_device';
    protected const DESCRIPTION = 'List devices\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices.';
