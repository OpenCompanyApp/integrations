 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/{device-id}/restore.
 */
class MicrosoftEntraIdDevicesDeviceRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_restore';
    ...
    protected const PATH = '/devices/{device-id}/restore';
