 ...
 * Update device.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /devices/{device-id}.
 */
class MicrosoftEntraIdDevicesDeviceUpdateDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_device_update_device';
