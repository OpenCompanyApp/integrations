 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/extensions/$count.
 */
class MicrosoftEntraIdDevicesExtensionsGetCount40b0 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_extensions_get_count_40b0';
    ...
    protected const PATH = '/devices/{device-id}/extensions/$count';
