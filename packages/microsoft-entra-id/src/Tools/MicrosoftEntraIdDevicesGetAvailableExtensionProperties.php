 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdDevicesGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_available_extension_properties';
    ...
    protected const PATH = '/devices/getAvailableExtensionProperties';
