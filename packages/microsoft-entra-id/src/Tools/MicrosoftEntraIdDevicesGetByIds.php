 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/getByIds.
 */
class MicrosoftEntraIdDevicesGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_by_ids';
    ...
    protected const PATH = '/devices/getByIds';
