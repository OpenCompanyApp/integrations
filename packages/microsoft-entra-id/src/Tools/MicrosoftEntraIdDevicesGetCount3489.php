 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/$count.
 */
class MicrosoftEntraIdDevicesGetCount3489 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_count_3489';
    ...
    protected const PATH = '/devices/$count';
