 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/extensions/{extension-id}.
 */
class MicrosoftEntraIdDevicesGetExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_extensions';
