 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/memberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdDevicesGetMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_member_of';
    protected const DESCRIPTION = 'Get memberOf from devices\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/memberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/devices/{device-id}/memberOf/{directoryObject-id}';
