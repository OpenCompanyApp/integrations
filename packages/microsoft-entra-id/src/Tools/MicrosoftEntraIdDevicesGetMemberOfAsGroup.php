 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/memberOf/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdDevicesGetMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_member_of_as_group';
    protected const DESCRIPTION = 'List device memberships\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/memberOf/{directoryObject-id}/graph.group.';
    ...
    protected const PATH = '/devices/{device-id}/memberOf/{directoryObject-id}/graph.group';
