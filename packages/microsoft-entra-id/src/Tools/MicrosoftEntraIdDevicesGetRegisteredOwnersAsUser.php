 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/{directoryObject-id}/graph.user.
 */
class MicrosoftEntraIdDevicesGetRegisteredOwnersAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_registered_owners_as_user';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/{directoryObject-id}/graph.user';
