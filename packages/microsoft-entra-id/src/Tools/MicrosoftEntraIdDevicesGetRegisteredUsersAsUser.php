 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/{directoryObject-id}/graph.user.
 */
class MicrosoftEntraIdDevicesGetRegisteredUsersAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_registered_users_as_user';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/{directoryObject-id}/graph.user';
