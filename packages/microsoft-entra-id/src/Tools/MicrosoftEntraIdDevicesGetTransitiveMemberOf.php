 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/transitiveMemberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdDevicesGetTransitiveMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_transitive_member_of';
    protected const DESCRIPTION = 'Get transitiveMemberOf from devices\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/transitiveMemberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/devices/{device-id}/transitiveMemberOf/{directoryObject-id}';
