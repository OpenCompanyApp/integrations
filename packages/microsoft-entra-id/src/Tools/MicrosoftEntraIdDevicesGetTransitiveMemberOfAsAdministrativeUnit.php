 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/transitiveMemberOf/{directoryObject-id}/graph.administrativeUnit.
 */
class MicrosoftEntraIdDevicesGetTransitiveMemberOfAsAdministrativeUnit extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_transitive_member_of_as_administrative_unit';
    ...
    protected const PATH = '/devices/{device-id}/transitiveMemberOf/{directoryObject-id}/graph.administrativeUnit';
