 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/transitiveMemberOf/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdDevicesGetTransitiveMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_get_transitive_member_of_as_group';
    protected const DESCRIPTION = 'List device transitive memberships\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/transitiveMemberOf/{directoryObject-id}/graph.group.';
    ...
    protected const PATH = '/devices/{device-id}/transitiveMemberOf/{directoryObject-id}/graph.group';
