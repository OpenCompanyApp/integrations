 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/extensions.
 */
class MicrosoftEntraIdDevicesListExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_extensions';
    protected const DESCRIPTION = 'Get extensions from devices\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/extensions.';
