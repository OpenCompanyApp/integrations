 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/memberOf.
 */
class MicrosoftEntraIdDevicesListMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_member_of';
    ...
    protected const PATH = '/devices/{device-id}/memberOf';
