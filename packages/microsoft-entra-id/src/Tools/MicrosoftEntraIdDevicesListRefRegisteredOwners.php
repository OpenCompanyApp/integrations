 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/$ref.
 */
class MicrosoftEntraIdDevicesListRefRegisteredOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_ref_registered_owners';
    protected const DESCRIPTION = 'List registeredOwners\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/registeredOwners/$ref.';
