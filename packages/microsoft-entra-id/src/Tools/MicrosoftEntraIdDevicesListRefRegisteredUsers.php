 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/$ref.
 */
class MicrosoftEntraIdDevicesListRefRegisteredUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_ref_registered_users';
    protected const DESCRIPTION = 'List registeredUsers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /devices/{device-id}/registeredUsers/$ref.';
