 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners.
 */
class MicrosoftEntraIdDevicesListRegisteredOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_registered_owners';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners';
