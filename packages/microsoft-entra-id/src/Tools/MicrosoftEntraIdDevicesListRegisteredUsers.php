 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers.
 */
class MicrosoftEntraIdDevicesListRegisteredUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_registered_users';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers';
