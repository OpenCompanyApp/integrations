 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/graph.appRoleAssignment.
 */
class MicrosoftEntraIdDevicesListRegisteredUsersAsAppRoleAssignment extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_registered_users_as_app_role_assignment';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/graph.appRoleAssignment';
