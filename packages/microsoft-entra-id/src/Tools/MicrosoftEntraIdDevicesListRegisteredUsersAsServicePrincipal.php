 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/graph.servicePrincipal.
 */
class MicrosoftEntraIdDevicesListRegisteredUsersAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_list_registered_users_as_service_principal';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/graph.servicePrincipal';
