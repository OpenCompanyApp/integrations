 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/memberOf/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdDevicesMemberOfGetCountAsAdministrativeUnitDd3f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_member_of_get_count_as_administrative_unit_dd3f';
    ...
    protected const PATH = '/devices/{device-id}/memberOf/graph.administrativeUnit/$count';
