 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/memberOf/graph.group/$count.
 */
class MicrosoftEntraIdDevicesMemberOfGetCountAsGroup3872 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_member_of_get_count_as_group_3872';
    ...
    protected const PATH = '/devices/{device-id}/memberOf/graph.group/$count';
