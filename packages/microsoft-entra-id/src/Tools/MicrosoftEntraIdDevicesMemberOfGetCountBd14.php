 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/memberOf/$count.
 */
class MicrosoftEntraIdDevicesMemberOfGetCountBd14 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_member_of_get_count_bd14';
    ...
    protected const PATH = '/devices/{device-id}/memberOf/$count';
