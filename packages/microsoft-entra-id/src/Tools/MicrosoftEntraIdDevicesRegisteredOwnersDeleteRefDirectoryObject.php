 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /devices/{device-id}/registeredOwners/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdDevicesRegisteredOwnersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_owners_delete_ref_directory_object';
    protected const DESCRIPTION = 'Delete registeredOwner\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /devices/{device-id}/registeredOwners/{directoryObject-id}/$ref.';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/{directoryObject-id}/$ref';
