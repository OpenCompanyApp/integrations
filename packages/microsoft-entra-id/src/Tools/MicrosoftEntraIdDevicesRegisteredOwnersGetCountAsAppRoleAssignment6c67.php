 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/graph.appRoleAssignment/$count.
 */
class MicrosoftEntraIdDevicesRegisteredOwnersGetCountAsAppRoleAssignment6c67 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_owners_get_count_as_app_role_assignment_6c67';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/graph.appRoleAssignment/$count';
