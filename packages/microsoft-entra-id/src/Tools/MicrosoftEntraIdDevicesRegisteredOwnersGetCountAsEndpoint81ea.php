 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/graph.endpoint/$count.
 */
class MicrosoftEntraIdDevicesRegisteredOwnersGetCountAsEndpoint81ea extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_owners_get_count_as_endpoint_81ea';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/graph.endpoint/$count';
