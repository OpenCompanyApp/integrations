 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdDevicesRegisteredOwnersGetCountAsServicePrincipalBf43 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_owners_get_count_as_service_principal_bf43';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/graph.servicePrincipal/$count';
