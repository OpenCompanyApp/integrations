 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/graph.user/$count.
 */
class MicrosoftEntraIdDevicesRegisteredOwnersGetCountAsUser8c65 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_owners_get_count_as_user_8c65';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/graph.user/$count';
