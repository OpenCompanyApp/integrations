 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredOwners/$count.
 */
class MicrosoftEntraIdDevicesRegisteredOwnersGetCountD4e7 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_owners_get_count_d4e7';
    ...
    protected const PATH = '/devices/{device-id}/registeredOwners/$count';
