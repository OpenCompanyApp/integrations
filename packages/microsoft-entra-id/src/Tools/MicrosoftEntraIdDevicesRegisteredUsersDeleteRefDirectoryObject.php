 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /devices/{device-id}/registeredUsers/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdDevicesRegisteredUsersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_users_delete_ref_directory_object';
    protected const DESCRIPTION = 'Delete registeredUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /devices/{device-id}/registeredUsers/{directoryObject-id}/$ref.';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/{directoryObject-id}/$ref';
