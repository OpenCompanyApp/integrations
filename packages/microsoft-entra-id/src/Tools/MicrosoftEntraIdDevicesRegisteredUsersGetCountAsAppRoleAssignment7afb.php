 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/graph.appRoleAssignment/$count.
 */
class MicrosoftEntraIdDevicesRegisteredUsersGetCountAsAppRoleAssignment7afb extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_users_get_count_as_app_role_assignment_7afb';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/graph.appRoleAssignment/$count';
