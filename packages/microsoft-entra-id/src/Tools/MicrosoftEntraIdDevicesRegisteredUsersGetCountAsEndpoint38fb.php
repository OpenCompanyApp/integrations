 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/graph.endpoint/$count.
 */
class MicrosoftEntraIdDevicesRegisteredUsersGetCountAsEndpoint38fb extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_users_get_count_as_endpoint_38fb';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/graph.endpoint/$count';
