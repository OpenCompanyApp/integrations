 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdDevicesRegisteredUsersGetCountAsServicePrincipalC21e extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_users_get_count_as_service_principal_c21e';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/graph.servicePrincipal/$count';
