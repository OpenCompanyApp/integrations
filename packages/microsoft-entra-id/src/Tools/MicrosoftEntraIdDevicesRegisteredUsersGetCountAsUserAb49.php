 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/graph.user/$count.
 */
class MicrosoftEntraIdDevicesRegisteredUsersGetCountAsUserAb49 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_users_get_count_as_user_ab49';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/graph.user/$count';
