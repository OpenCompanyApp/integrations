 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/registeredUsers/$count.
 */
class MicrosoftEntraIdDevicesRegisteredUsersGetCountE934 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_registered_users_get_count_e934';
    ...
    protected const PATH = '/devices/{device-id}/registeredUsers/$count';
