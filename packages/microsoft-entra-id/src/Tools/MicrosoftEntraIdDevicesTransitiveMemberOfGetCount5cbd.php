 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/transitiveMemberOf/$count.
 */
class MicrosoftEntraIdDevicesTransitiveMemberOfGetCount5cbd extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_transitive_member_of_get_count_5cbd';
    ...
    protected const PATH = '/devices/{device-id}/transitiveMemberOf/$count';
