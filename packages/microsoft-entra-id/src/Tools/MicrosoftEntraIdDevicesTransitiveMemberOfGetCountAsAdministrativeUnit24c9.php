 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/transitiveMemberOf/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdDevicesTransitiveMemberOfGetCountAsAdministrativeUnit24c9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_transitive_member_of_get_count_as_administrative_unit_24c9';
    ...
    protected const PATH = '/devices/{device-id}/transitiveMemberOf/graph.administrativeUnit/$count';
