 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /devices/{device-id}/transitiveMemberOf/graph.group/$count.
 */
class MicrosoftEntraIdDevicesTransitiveMemberOfGetCountAsGroupBca9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_transitive_member_of_get_count_as_group_bca9';
    ...
    protected const PATH = '/devices/{device-id}/transitiveMemberOf/graph.group/$count';
