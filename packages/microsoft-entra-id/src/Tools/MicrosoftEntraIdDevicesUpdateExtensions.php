 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /devices/{device-id}/extensions/{extension-id}.
 */
class MicrosoftEntraIdDevicesUpdateExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_update_extensions';
    protected const DESCRIPTION = 'Update the navigation property extensions in devices\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /devices/{device-id}/extensions/{extension-id}.';
