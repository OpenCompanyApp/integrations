 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /devices/validateProperties.
 */
class MicrosoftEntraIdDevicesValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_devices_validate_properties';
    ...
    protected const PATH = '/devices/validateProperties';
