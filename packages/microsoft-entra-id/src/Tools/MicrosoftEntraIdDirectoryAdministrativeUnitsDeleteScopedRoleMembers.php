 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directory/administrativeUnits/{administrativeUnit-id}/scopedRoleMembers/{scopedRoleMembership-id}.
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsDeleteScopedRoleMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_delete_scoped_role_members';
    protected const DESCRIPTION = 'Remove a scopedRoleMember\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directory/administrativeUnits/{administrativeUnit-id}/scopedRoleMembers/{scopedRoleMembership-id}.';
