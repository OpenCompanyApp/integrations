 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/administrativeUnits/delta().
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_delta';
    ...
    protected const PATH = '/directory/administrativeUnits/delta()';
