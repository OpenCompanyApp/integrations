 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/administrativeUnits/$count.
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsGetCountA5a1 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_get_count_a5a1';
    ...
    protected const PATH = '/directory/administrativeUnits/$count';
