 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.application.
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsGetMembersAsApplication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_get_members_as_application';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.directoryObject as microsoft.graph.application\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.application.';
    ...
    protected const PATH = '/directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.application';
