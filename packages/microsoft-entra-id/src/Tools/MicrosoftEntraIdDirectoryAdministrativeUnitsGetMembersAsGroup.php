 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsGetMembersAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_get_members_as_group';
    ...
    protected const PATH = '/directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/graph.group';
