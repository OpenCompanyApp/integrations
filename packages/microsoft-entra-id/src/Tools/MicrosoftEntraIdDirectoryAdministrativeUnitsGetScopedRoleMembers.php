 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/administrativeUnits/{administrativeUnit-id}/scopedRoleMembers/{scopedRoleMembership-id}.
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsGetScopedRoleMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_get_scoped_role_members';
    protected const DESCRIPTION = 'Get a scopedRoleMember\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/administrativeUnits/{administrativeUnit-id}/scopedRoleMembers/{scopedRoleMembership-id}.';
