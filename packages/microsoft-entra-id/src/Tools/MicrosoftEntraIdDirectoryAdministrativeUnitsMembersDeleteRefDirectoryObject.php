 ...
 * Remove a member.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdDirectoryAdministrativeUnitsMembersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_administrative_units_members_delete_ref_directory_object';
    ...
    protected const PATH = '/directory/administrativeUnits/{administrativeUnit-id}/members/{directoryObject-id}/$ref';
