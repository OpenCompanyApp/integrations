 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/attributeSets/$count.
 */
class MicrosoftEntraIdDirectoryAttributeSetsGetCount147b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_attribute_sets_get_count_147b';
    ...
    protected const PATH = '/directory/attributeSets/$count';
