 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/administrativeUnits.
 */
class MicrosoftEntraIdDirectoryCreateAdministrativeUnits extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_administrative_units';
    protected const DESCRIPTION = 'Create administrativeUnit\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/administrativeUnits.';
    ...
    protected const PATH = '/directory/administrativeUnits';
