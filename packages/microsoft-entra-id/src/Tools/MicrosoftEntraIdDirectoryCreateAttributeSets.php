 ...
 * Create attributeSet.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/attributeSets.
 */
class MicrosoftEntraIdDirectoryCreateAttributeSets extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_attribute_sets';
    protected const DESCRIPTION = 'Create attributeSet\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/attributeSets.';
    ...
    protected const PATH = '/directory/attributeSets';
