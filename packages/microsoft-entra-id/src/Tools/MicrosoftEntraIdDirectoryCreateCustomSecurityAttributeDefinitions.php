 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/customSecurityAttributeDefinitions.
 */
class MicrosoftEntraIdDirectoryCreateCustomSecurityAttributeDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_custom_security_attribute_definitions';
    protected const DESCRIPTION = 'Create customSecurityAttributeDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/customSecurityAttributeDefinitions.';
    ...
    protected const PATH = '/directory/customSecurityAttributeDefinitions';
