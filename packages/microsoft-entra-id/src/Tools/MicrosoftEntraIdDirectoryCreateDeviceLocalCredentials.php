 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deviceLocalCredentials.
 */
class MicrosoftEntraIdDirectoryCreateDeviceLocalCredentials extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_device_local_credentials';
    protected const DESCRIPTION = 'Create new navigation property to deviceLocalCredentials for directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/deviceLocalCredentials.';
    ...
    protected const PATH = '/directory/deviceLocalCredentials';
