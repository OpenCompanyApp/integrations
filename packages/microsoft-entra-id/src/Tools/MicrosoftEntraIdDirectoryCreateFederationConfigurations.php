 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/federationConfigurations.
 */
class MicrosoftEntraIdDirectoryCreateFederationConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_federation_configurations';
    protected const DESCRIPTION = 'Create new navigation property to federationConfigurations for directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/federationConfigurations.';
    ...
    protected const PATH = '/directory/federationConfigurations';
