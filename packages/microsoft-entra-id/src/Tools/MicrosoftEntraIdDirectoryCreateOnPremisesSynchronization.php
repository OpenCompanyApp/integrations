 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/onPremisesSynchronization.
 */
class MicrosoftEntraIdDirectoryCreateOnPremisesSynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_on_premises_synchronization';
    protected const DESCRIPTION = 'Create new navigation property to onPremisesSynchronization for directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/onPremisesSynchronization.';
    ...
    protected const PATH = '/directory/onPremisesSynchronization';
