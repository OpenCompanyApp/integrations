 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/subscriptions.
 */
class MicrosoftEntraIdDirectoryCreateSubscriptions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_create_subscriptions';
    protected const DESCRIPTION = 'Create new navigation property to subscriptions for directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/subscriptions.';
    ...
    protected const PATH = '/directory/subscriptions';
