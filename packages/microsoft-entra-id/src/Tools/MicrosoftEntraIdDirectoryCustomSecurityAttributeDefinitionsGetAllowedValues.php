 ...
 * Get allowedValue.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition-id}/allowedValues/{allowedValue-id}.
 */
class MicrosoftEntraIdDirectoryCustomSecurityAttributeDefinitionsGetAllowedValues extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_custom_security_attribute_definitions_get_allowed_values';
    protected const DESCRIPTION = 'Get allowedValue\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition-id}/allowedValues/{allowedValue-id}.';
