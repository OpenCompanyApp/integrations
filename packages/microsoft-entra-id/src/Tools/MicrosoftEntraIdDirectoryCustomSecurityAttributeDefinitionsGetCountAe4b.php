 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/customSecurityAttributeDefinitions/$count.
 */
class MicrosoftEntraIdDirectoryCustomSecurityAttributeDefinitionsGetCountAe4b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_custom_security_attribute_definitions_get_count_ae4b';
    ...
    protected const PATH = '/directory/customSecurityAttributeDefinitions/$count';
