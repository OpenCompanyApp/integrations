 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directory/publicKeyInfrastructure.
 */
class MicrosoftEntraIdDirectoryDeletePublicKeyInfrastructure extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_delete_public_key_infrastructure';
    protected const DESCRIPTION = 'Delete navigation property publicKeyInfrastructure for directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directory/publicKeyInfrastructure.';
