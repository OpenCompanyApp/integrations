 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deletedItems/{directoryObject-id}/checkMemberObjects.
 */
class MicrosoftEntraIdDirectoryDeletedItemsDirectoryObjectCheckMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_directory_object_check_member_objects';
    ...
    protected const PATH = '/directory/deletedItems/{directoryObject-id}/checkMemberObjects';
