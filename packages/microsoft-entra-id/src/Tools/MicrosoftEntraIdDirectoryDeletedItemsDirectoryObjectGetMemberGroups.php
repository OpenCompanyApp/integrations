 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deletedItems/{directoryObject-id}/getMemberGroups.
 */
class MicrosoftEntraIdDirectoryDeletedItemsDirectoryObjectGetMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_directory_object_get_member_groups';
    ...
    protected const PATH = '/directory/deletedItems/{directoryObject-id}/getMemberGroups';
