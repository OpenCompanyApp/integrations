 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deletedItems/{directoryObject-id}/restore.
 */
class MicrosoftEntraIdDirectoryDeletedItemsDirectoryObjectRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_directory_object_restore';
    ...
    protected const PATH = '/directory/deletedItems/{directoryObject-id}/restore';
