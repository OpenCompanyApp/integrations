 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deletedItems/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_available_extension_properties';
    ...
    protected const PATH = '/directory/deletedItems/getAvailableExtensionProperties';
