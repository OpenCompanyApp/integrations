 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deletedItems/getByIds.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_by_ids';
    ...
    protected const PATH = '/directory/deletedItems/getByIds';
