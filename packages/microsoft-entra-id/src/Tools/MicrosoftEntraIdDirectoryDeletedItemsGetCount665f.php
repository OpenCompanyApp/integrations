 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCount665f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_665f';
    ...
    protected const PATH = '/directory/deletedItems/$count';
