 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCountAsAdministrativeUnit0f56 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_as_administrative_unit_0f56';
    ...
    protected const PATH = '/directory/deletedItems/graph.administrativeUnit/$count';
