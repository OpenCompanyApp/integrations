 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.application/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCountAsApplication09ac extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_as_application_09ac';
    ...
    protected const PATH = '/directory/deletedItems/graph.application/$count';
