 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.device/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCountAsDevice6f35 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_as_device_6f35';
    ...
    protected const PATH = '/directory/deletedItems/graph.device/$count';
