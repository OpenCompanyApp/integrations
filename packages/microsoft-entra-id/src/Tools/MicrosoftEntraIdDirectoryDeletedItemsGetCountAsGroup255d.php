 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.group/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCountAsGroup255d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_as_group_255d';
    ...
    protected const PATH = '/directory/deletedItems/graph.group/$count';
