 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCountAsServicePrincipal6632 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_as_service_principal_6632';
    ...
    protected const PATH = '/directory/deletedItems/graph.servicePrincipal/$count';
