 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.user/$count.
 */
class MicrosoftEntraIdDirectoryDeletedItemsGetCountAsUserBc15 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_get_count_as_user_bc15';
    ...
    protected const PATH = '/directory/deletedItems/graph.user/$count';
