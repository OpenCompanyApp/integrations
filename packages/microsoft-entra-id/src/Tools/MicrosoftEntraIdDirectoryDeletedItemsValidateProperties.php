 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/deletedItems/validateProperties.
 */
class MicrosoftEntraIdDirectoryDeletedItemsValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_deleted_items_validate_properties';
    ...
    protected const PATH = '/directory/deletedItems/validateProperties';
