 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deviceLocalCredentials/$count.
 */
class MicrosoftEntraIdDirectoryDeviceLocalCredentialsGetCount43fe extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_device_local_credentials_get_count_43fe';
    ...
    protected const PATH = '/directory/deviceLocalCredentials/$count';
