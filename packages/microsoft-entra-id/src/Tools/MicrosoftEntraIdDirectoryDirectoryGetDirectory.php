 ...
 * Get directory.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory.
 */
class MicrosoftEntraIdDirectoryDirectoryGetDirectory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_directory_get_directory';
    protected const DESCRIPTION = 'Get directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory.';
