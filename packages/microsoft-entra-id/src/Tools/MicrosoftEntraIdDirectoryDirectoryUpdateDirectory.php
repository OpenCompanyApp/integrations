 ...
 * Update directory.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directory.
 */
class MicrosoftEntraIdDirectoryDirectoryUpdateDirectory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_directory_update_directory';
    protected const DESCRIPTION = 'Update directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directory.';
    ...
    protected const PATH = '/directory';
