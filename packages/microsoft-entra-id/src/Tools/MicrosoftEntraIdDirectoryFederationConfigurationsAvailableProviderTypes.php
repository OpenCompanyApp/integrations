 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/federationConfigurations/availableProviderTypes().
 */
class MicrosoftEntraIdDirectoryFederationConfigurationsAvailableProviderTypes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_federation_configurations_available_provider_types';
    protected const DESCRIPTION = 'Invoke function availableProviderTypes\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/federationConfigurations/availableProviderTypes().';
    ...
    protected const PATH = '/directory/federationConfigurations/availableProviderTypes()';
