 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/federationConfigurations/$count.
 */
class MicrosoftEntraIdDirectoryFederationConfigurationsGetCount1592 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_federation_configurations_get_count_1592';
    ...
    protected const PATH = '/directory/federationConfigurations/$count';
