 ...
 * Get attributeSet.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/attributeSets/{attributeSet-id}.
 */
class MicrosoftEntraIdDirectoryGetAttributeSets extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_get_attribute_sets';
    protected const DESCRIPTION = 'Get attributeSet\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/attributeSets/{attributeSet-id}.';
