 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/{directoryObject-id}.
 */
class MicrosoftEntraIdDirectoryGetDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_get_deleted_items';
