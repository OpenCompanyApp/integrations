 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/{directoryObject-id}/graph.application.
 */
class MicrosoftEntraIdDirectoryGetDeletedItemsAsApplication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_get_deleted_items_as_application';
    ...
    protected const PATH = '/directory/deletedItems/{directoryObject-id}/graph.application';
