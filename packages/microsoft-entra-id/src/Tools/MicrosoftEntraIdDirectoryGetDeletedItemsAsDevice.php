 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/{directoryObject-id}/graph.device.
 */
class MicrosoftEntraIdDirectoryGetDeletedItemsAsDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_get_deleted_items_as_device';
    ...
    protected const PATH = '/directory/deletedItems/{directoryObject-id}/graph.device';
