 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdDirectoryGetDeletedItemsAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_get_deleted_items_as_group';
    protected const DESCRIPTION = 'List deletedItems (directory objects)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/deletedItems/{directoryObject-id}/graph.group.';
    ...
    protected const PATH = '/directory/deletedItems/{directoryObject-id}/graph.group';
