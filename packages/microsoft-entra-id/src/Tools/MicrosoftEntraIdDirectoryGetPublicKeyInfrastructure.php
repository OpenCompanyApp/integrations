 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/publicKeyInfrastructure.
 */
class MicrosoftEntraIdDirectoryGetPublicKeyInfrastructure extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_get_public_key_infrastructure';
    protected const DESCRIPTION = 'Get publicKeyInfrastructure from directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/publicKeyInfrastructure.';
