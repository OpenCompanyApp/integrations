 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/administrativeUnits.
 */
class MicrosoftEntraIdDirectoryListAdministrativeUnits extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_administrative_units';
    protected const DESCRIPTION = 'List administrativeUnits\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/administrativeUnits.';
