 ...
 * List attributeSets.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/attributeSets.
 */
class MicrosoftEntraIdDirectoryListAttributeSets extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_attribute_sets';
    protected const DESCRIPTION = 'List attributeSets\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/attributeSets.';
