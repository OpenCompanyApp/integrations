 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/customSecurityAttributeDefinitions.
 */
class MicrosoftEntraIdDirectoryListCustomSecurityAttributeDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_custom_security_attribute_definitions';
    protected const DESCRIPTION = 'List customSecurityAttributeDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/customSecurityAttributeDefinitions.';
