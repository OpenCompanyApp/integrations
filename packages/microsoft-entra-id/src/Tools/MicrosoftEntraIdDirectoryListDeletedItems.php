 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems.
 */
class MicrosoftEntraIdDirectoryListDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_deleted_items';
    protected const DESCRIPTION = 'Get deleted item (directory object)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/deletedItems.';
    ...
    protected const PATH = '/directory/deletedItems';
