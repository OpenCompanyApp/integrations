 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.administrativeUnit.
 */
class MicrosoftEntraIdDirectoryListDeletedItemsAsAdministrativeUnit extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_deleted_items_as_administrative_unit';
    ...
    protected const PATH = '/directory/deletedItems/graph.administrativeUnit';
