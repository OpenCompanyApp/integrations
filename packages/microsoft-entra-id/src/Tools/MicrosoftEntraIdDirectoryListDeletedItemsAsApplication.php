 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.application.
 */
class MicrosoftEntraIdDirectoryListDeletedItemsAsApplication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_deleted_items_as_application';
    ...
    protected const PATH = '/directory/deletedItems/graph.application';
