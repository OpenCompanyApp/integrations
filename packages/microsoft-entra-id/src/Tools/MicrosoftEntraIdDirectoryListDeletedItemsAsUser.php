 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deletedItems/graph.user.
 */
class MicrosoftEntraIdDirectoryListDeletedItemsAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_deleted_items_as_user';
    ...
    protected const PATH = '/directory/deletedItems/graph.user';
