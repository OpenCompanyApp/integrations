 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/deviceLocalCredentials.
 */
class MicrosoftEntraIdDirectoryListDeviceLocalCredentials extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_device_local_credentials';
    protected const DESCRIPTION = 'List deviceLocalCredentialInfo\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/deviceLocalCredentials.';
