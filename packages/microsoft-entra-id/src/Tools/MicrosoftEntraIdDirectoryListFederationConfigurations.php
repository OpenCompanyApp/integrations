 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/federationConfigurations.
 */
class MicrosoftEntraIdDirectoryListFederationConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_federation_configurations';
