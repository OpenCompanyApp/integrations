 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/onPremisesSynchronization.
 */
class MicrosoftEntraIdDirectoryListOnPremisesSynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_on_premises_synchronization';
