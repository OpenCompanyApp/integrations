 ...
 * List subscriptions.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/subscriptions.
 */
class MicrosoftEntraIdDirectoryListSubscriptions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_list_subscriptions';
    protected const DESCRIPTION = 'List subscriptions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/subscriptions.';
