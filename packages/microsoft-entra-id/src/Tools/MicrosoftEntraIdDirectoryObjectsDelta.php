 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryObjects/delta().
 */
class MicrosoftEntraIdDirectoryObjectsDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_delta';
    ...
    protected const PATH = '/directoryObjects/delta()';
