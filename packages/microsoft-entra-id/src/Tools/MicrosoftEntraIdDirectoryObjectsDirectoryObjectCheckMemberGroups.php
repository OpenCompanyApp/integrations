 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/{directoryObject-id}/checkMemberGroups.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectCheckMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_check_member_groups';
    ...
    protected const PATH = '/directoryObjects/{directoryObject-id}/checkMemberGroups';
