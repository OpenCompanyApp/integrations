 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectCreateDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_create_directory_object';
    protected const DESCRIPTION = 'Add new entity to directoryObjects\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directoryObjects.';
    ...
    protected const PATH = '/directoryObjects';
