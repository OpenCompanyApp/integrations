 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directoryObjects/{directoryObject-id}.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectDeleteDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_delete_directory_object';
    protected const DESCRIPTION = 'Delete directoryObject\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directoryObjects/{directoryObject-id}.';
