 ...
 * Get directoryObject.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryObjects/{directoryObject-id}.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectGetDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_get_directory_object';
    protected const DESCRIPTION = 'Get directoryObject\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryObjects/{directoryObject-id}.';
