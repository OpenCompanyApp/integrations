 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/{directoryObject-id}/getMemberGroups.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectGetMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_get_member_groups';
    ...
    protected const PATH = '/directoryObjects/{directoryObject-id}/getMemberGroups';
