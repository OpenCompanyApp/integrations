 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/{directoryObject-id}/getMemberObjects.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectGetMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_get_member_objects';
    ...
    protected const PATH = '/directoryObjects/{directoryObject-id}/getMemberObjects';
