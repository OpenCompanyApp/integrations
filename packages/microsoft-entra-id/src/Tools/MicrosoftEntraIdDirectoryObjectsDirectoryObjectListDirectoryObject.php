 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryObjects.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectListDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_list_directory_object';
    protected const DESCRIPTION = 'Get entities from directoryObjects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryObjects.';
