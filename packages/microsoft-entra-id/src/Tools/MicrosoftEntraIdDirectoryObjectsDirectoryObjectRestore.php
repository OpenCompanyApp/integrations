 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/{directoryObject-id}/restore.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_restore';
    ...
    protected const PATH = '/directoryObjects/{directoryObject-id}/restore';
