 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directoryObjects/{directoryObject-id}.
 */
class MicrosoftEntraIdDirectoryObjectsDirectoryObjectUpdateDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_directory_object_update_directory_object';
    protected const DESCRIPTION = 'Update entity in directoryObjects\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directoryObjects/{directoryObject-id}.';
    ...
    protected const PATH = '/directoryObjects/{directoryObject-id}';
