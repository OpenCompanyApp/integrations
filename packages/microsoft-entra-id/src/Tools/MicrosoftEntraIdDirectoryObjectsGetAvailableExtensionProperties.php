 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdDirectoryObjectsGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_get_available_extension_properties';
    ...
    protected const PATH = '/directoryObjects/getAvailableExtensionProperties';
