 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/getByIds.
 */
class MicrosoftEntraIdDirectoryObjectsGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_get_by_ids';
    ...
    protected const PATH = '/directoryObjects/getByIds';
