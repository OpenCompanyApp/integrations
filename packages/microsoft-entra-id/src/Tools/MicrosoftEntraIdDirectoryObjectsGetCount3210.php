 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryObjects/$count.
 */
class MicrosoftEntraIdDirectoryObjectsGetCount3210 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_get_count_3210';
    ...
    protected const PATH = '/directoryObjects/$count';
