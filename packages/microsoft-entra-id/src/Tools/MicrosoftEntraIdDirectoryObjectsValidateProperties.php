 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryObjects/validateProperties.
 */
class MicrosoftEntraIdDirectoryObjectsValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_objects_validate_properties';
    ...
    protected const PATH = '/directoryObjects/validateProperties';
