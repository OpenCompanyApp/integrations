 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/onPremisesSynchronization/$count.
 */
class MicrosoftEntraIdDirectoryOnPremisesSynchronizationGetCountDf9d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_on_premises_synchronization_get_count_df9d';
    ...
    protected const PATH = '/directory/onPremisesSynchronization/$count';
