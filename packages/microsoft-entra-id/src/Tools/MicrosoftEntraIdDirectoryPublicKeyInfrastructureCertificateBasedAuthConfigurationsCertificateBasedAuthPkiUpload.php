 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}/upload.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureCertificateBasedAuthConfigurationsCertificateBasedAuthPkiUpload extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_certificate_based_auth_configurations_certificate_based_auth_pki_upload';
    protected const DESCRIPTION = 'Invoke action upload\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}/upload.';
    ...
    protected const PATH = '/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}/upload';
