 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/$count.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureCertificateBasedAuthConfigurationsGetCount4154 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_certificate_based_auth_configurations_get_count_4154';
    ...
    protected const PATH = '/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/$count';
