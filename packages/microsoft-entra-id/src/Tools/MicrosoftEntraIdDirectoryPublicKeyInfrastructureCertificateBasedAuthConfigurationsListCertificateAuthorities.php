 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}/certificateAuthorities.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureCertificateBasedAuthConfigurationsListCertificateAuthorities extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_certificate_based_auth_configurations_list_certificate_authorities';
    protected const DESCRIPTION = 'List certificateAuthorityDetail objects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}/certificateAuthorities.';
