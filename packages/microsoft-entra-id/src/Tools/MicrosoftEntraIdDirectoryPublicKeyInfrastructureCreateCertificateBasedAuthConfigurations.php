 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureCreateCertificateBasedAuthConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_create_certificate_based_auth_configurations';
    protected const DESCRIPTION = 'Create certificateBasedAuthPki\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations.';
