 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureDeleteCertificateBasedAuthConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_delete_certificate_based_auth_configurations';
    protected const DESCRIPTION = 'Delete certificateBasedAuthPki\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}.';
    ...
    protected const PATH = '/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}';
