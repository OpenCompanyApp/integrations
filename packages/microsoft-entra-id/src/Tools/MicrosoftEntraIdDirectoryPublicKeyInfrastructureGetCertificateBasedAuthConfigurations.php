 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureGetCertificateBasedAuthConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_get_certificate_based_auth_configurations';
    protected const DESCRIPTION = 'Get certificateBasedAuthPki\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}.';
