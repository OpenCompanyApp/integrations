 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureListCertificateBasedAuthConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_list_certificate_based_auth_configurations';
    protected const DESCRIPTION = 'List certificateBasedAuthPki objects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations.';
    ...
    protected const PATH = '/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations';
