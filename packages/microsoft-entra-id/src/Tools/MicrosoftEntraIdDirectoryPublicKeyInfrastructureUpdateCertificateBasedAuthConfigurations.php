 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}.
 */
class MicrosoftEntraIdDirectoryPublicKeyInfrastructureUpdateCertificateBasedAuthConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_public_key_infrastructure_update_certificate_based_auth_configurations';
    protected const DESCRIPTION = 'Update certificateBasedAuthPki\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki-id}.';
