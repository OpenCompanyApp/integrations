 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoleTemplates/delta().
 */
class MicrosoftEntraIdDirectoryRoleTemplatesDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_delta';
    ...
    protected const PATH = '/directoryRoleTemplates/delta()';
