 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoleTemplates.
 */
class MicrosoftEntraIdDirectoryRoleTemplatesDirectoryRoleTemplateCreateDirectoryRoleTemplate extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_directory_role_template_create_directory_role_template';
    protected const DESCRIPTION = 'Add new entity to directoryRoleTemplates\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directoryRoleTemplates.';
    ...
    protected const PATH = '/directoryRoleTemplates';
