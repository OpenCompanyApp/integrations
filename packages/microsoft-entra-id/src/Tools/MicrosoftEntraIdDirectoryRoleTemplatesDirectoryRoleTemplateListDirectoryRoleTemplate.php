 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoleTemplates.
 */
class MicrosoftEntraIdDirectoryRoleTemplatesDirectoryRoleTemplateListDirectoryRoleTemplate extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_directory_role_template_list_directory_role_template';
    protected const DESCRIPTION = 'List directoryRoleTemplates\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryRoleTemplates.';
