 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoleTemplates/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdDirectoryRoleTemplatesGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_get_available_extension_properties';
    protected const DESCRIPTION = 'Invoke action getAvailableExtensionProperties\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directoryRoleTemplates/getAvailableExtensionProperties.';
    ...
    protected const PATH = '/directoryRoleTemplates/getAvailableExtensionProperties';
