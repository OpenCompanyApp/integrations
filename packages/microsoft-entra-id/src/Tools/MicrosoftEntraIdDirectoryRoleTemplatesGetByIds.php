 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoleTemplates/getByIds.
 */
class MicrosoftEntraIdDirectoryRoleTemplatesGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_get_by_ids';
    protected const DESCRIPTION = 'Invoke action getByIds\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directoryRoleTemplates/getByIds.';
    ...
    protected const PATH = '/directoryRoleTemplates/getByIds';
