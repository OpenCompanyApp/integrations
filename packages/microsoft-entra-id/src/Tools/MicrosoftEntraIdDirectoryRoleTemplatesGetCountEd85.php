 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoleTemplates/$count.
 */
class MicrosoftEntraIdDirectoryRoleTemplatesGetCountEd85 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_get_count_ed85';
    ...
    protected const PATH = '/directoryRoleTemplates/$count';
