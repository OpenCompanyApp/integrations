 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoleTemplates/validateProperties.
 */
class MicrosoftEntraIdDirectoryRoleTemplatesValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_role_templates_validate_properties';
    ...
    protected const PATH = '/directoryRoleTemplates/validateProperties';
