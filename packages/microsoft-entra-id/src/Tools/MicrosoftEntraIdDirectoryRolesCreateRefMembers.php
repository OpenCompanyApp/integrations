 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/{directoryRole-id}/members/$ref.
 */
class MicrosoftEntraIdDirectoryRolesCreateRefMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_create_ref_members';
    protected const DESCRIPTION = 'Add directory role member\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directoryRoles/{directoryRole-id}/members/$ref.';
