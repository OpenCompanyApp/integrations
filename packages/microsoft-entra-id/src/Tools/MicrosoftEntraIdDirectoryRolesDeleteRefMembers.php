 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directoryRoles/{directoryRole-id}/members/$ref.
 */
class MicrosoftEntraIdDirectoryRolesDeleteRefMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_delete_ref_members';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/$ref';
