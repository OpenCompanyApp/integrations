 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directoryRoles/{directoryRole-id}/scopedMembers/{scopedRoleMembership-id}.
 */
class MicrosoftEntraIdDirectoryRolesDeleteScopedMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_delete_scoped_members';
    protected const DESCRIPTION = 'Delete navigation property scopedMembers for directoryRoles\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directoryRoles/{directoryRole-id}/scopedMembers/{scopedRoleMembership-id}.';
