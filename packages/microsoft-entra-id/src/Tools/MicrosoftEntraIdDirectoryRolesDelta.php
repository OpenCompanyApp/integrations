 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/delta().
 */
class MicrosoftEntraIdDirectoryRolesDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_delta';
    ...
    protected const PATH = '/directoryRoles/delta()';
