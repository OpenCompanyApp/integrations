 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/{directoryRole-id}/checkMemberGroups.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleCheckMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_check_member_groups';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/checkMemberGroups';
