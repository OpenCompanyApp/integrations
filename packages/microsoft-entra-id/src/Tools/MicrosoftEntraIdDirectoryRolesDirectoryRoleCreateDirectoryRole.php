 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleCreateDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_create_directory_role';
    protected const DESCRIPTION = 'Activate directoryRole\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /directoryRoles.';
    ...
    protected const PATH = '/directoryRoles';
