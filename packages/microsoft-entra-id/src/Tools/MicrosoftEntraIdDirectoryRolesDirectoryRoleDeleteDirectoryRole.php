 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directoryRoles/{directoryRole-id}.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleDeleteDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_delete_directory_role';
    protected const DESCRIPTION = 'Delete entity from directoryRoles\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directoryRoles/{directoryRole-id}.';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}';
