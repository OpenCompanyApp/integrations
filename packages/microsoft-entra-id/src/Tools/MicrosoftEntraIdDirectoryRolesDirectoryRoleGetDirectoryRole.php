 ...
 * Get directoryRole.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleGetDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_get_directory_role';
    protected const DESCRIPTION = 'Get directoryRole\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryRoles/{directoryRole-id}.';
