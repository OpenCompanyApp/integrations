 ...
 * Get directoryRole.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles(roleTemplateId='{roleTemplateId}').
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleGetDirectoryRoleByRoleTemplateId extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_get_directory_role_by_role_template_id';
