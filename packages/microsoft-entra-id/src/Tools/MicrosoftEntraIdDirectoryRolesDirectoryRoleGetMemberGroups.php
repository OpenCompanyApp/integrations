 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/{directoryRole-id}/getMemberGroups.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleGetMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_get_member_groups';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/getMemberGroups';
