 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/{directoryRole-id}/getMemberObjects.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleGetMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_get_member_objects';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/getMemberObjects';
