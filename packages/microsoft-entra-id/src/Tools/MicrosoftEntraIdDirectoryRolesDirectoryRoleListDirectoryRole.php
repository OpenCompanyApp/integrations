 ...
 * List directoryRoles.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleListDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_list_directory_role';
    protected const DESCRIPTION = 'List directoryRoles\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryRoles.';
