 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/{directoryRole-id}/restore.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_restore';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/restore';
