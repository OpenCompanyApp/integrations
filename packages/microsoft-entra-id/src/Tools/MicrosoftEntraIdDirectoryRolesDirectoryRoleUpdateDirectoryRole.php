 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directoryRoles/{directoryRole-id}.
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleUpdateDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_update_directory_role';
    protected const DESCRIPTION = 'Update entity in directoryRoles\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directoryRoles/{directoryRole-id}.';
