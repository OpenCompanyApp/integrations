 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directoryRoles(roleTemplateId='{roleTemplateId}').
 */
class MicrosoftEntraIdDirectoryRolesDirectoryRoleUpdateDirectoryRoleByRoleTemplateId extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_directory_role_update_directory_role_by_role_template_id';
    protected const DESCRIPTION = 'Update entity in directoryRoles by roleTemplateId\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directoryRoles(roleTemplateId=\'{roleTemplateId}\').';
