 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdDirectoryRolesGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_get_available_extension_properties';
    ...
    protected const PATH = '/directoryRoles/getAvailableExtensionProperties';
