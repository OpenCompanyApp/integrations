 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/getByIds.
 */
class MicrosoftEntraIdDirectoryRolesGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_get_by_ids';
    ...
    protected const PATH = '/directoryRoles/getByIds';
