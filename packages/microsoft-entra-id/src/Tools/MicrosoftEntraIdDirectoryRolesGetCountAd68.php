 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/$count.
 */
class MicrosoftEntraIdDirectoryRolesGetCountAd68 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_get_count_ad68';
    ...
    protected const PATH = '/directoryRoles/$count';
