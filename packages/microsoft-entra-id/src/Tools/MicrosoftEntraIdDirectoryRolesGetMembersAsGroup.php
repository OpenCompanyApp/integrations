 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdDirectoryRolesGetMembersAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_get_members_as_group';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/{directoryObject-id}/graph.group';
