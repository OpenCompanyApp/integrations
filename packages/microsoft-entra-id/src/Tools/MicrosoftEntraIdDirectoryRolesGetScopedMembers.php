 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/scopedMembers/{scopedRoleMembership-id}.
 */
class MicrosoftEntraIdDirectoryRolesGetScopedMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_get_scoped_members';
    protected const DESCRIPTION = 'Get scopedMembers from directoryRoles\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryRoles/{directoryRole-id}/scopedMembers/{scopedRoleMembership-id}.';
