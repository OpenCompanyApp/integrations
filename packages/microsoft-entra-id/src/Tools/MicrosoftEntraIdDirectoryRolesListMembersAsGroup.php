 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/graph.group.
 */
class MicrosoftEntraIdDirectoryRolesListMembersAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_list_members_as_group';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/graph.group';
