 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/$ref.
 */
class MicrosoftEntraIdDirectoryRolesListRefMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_list_ref_members';
