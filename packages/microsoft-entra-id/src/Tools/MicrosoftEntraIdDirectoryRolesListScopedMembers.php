 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/scopedMembers.
 */
class MicrosoftEntraIdDirectoryRolesListScopedMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_list_scoped_members';
    protected const DESCRIPTION = 'List scopedMembers for a directory role\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /directoryRoles/{directoryRole-id}/scopedMembers.';
