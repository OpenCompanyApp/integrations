 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /directoryRoles/{directoryRole-id}/members/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdDirectoryRolesMembersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_delete_ref_directory_object';
    protected const DESCRIPTION = 'Remove directory role member\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /directoryRoles/{directoryRole-id}/members/{directoryObject-id}/$ref.';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/{directoryObject-id}/$ref';
