 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/$count.
 */
class MicrosoftEntraIdDirectoryRolesMembersGetCount5361 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_get_count_5361';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/$count';
