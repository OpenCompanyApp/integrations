 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/graph.application/$count.
 */
class MicrosoftEntraIdDirectoryRolesMembersGetCountAsApplication290c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_get_count_as_application_290c';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/graph.application/$count';
