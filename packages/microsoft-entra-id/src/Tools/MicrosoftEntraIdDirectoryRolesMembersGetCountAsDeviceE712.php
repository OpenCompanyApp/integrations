 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/graph.device/$count.
 */
class MicrosoftEntraIdDirectoryRolesMembersGetCountAsDeviceE712 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_get_count_as_device_e712';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/graph.device/$count';
