 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/graph.group/$count.
 */
class MicrosoftEntraIdDirectoryRolesMembersGetCountAsGroupB36f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_get_count_as_group_b36f';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/graph.group/$count';
