 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/graph.orgContact/$count.
 */
class MicrosoftEntraIdDirectoryRolesMembersGetCountAsOrgContact3e36 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_get_count_as_org_contact_3e36';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/graph.orgContact/$count';
