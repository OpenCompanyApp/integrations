 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/members/graph.user/$count.
 */
class MicrosoftEntraIdDirectoryRolesMembersGetCountAsUserAf1f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_members_get_count_as_user_af1f';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/members/graph.user/$count';
