 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directoryRoles/{directoryRole-id}/scopedMembers/$count.
 */
class MicrosoftEntraIdDirectoryRolesScopedMembersGetCountB2b2 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_scoped_members_get_count_b2b2';
    ...
    protected const PATH = '/directoryRoles/{directoryRole-id}/scopedMembers/$count';
