 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /directoryRoles/validateProperties.
 */
class MicrosoftEntraIdDirectoryRolesValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_roles_validate_properties';
    ...
    protected const PATH = '/directoryRoles/validateProperties';
