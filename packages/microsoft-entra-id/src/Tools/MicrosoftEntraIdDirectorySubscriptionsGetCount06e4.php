 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /directory/subscriptions/$count.
 */
class MicrosoftEntraIdDirectorySubscriptionsGetCount06e4 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_subscriptions_get_count_06e4';
    ...
    protected const PATH = '/directory/subscriptions/$count';
