 ...
 * Update attributeSet.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directory/attributeSets/{attributeSet-id}.
 */
class MicrosoftEntraIdDirectoryUpdateAttributeSets extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_update_attribute_sets';
    protected const DESCRIPTION = 'Update attributeSet\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directory/attributeSets/{attributeSet-id}.';
