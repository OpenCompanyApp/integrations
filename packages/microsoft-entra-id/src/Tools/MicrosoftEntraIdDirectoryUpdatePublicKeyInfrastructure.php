 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /directory/publicKeyInfrastructure.
 */
class MicrosoftEntraIdDirectoryUpdatePublicKeyInfrastructure extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_directory_update_public_key_infrastructure';
    protected const DESCRIPTION = 'Update the navigation property publicKeyInfrastructure in directory\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /directory/publicKeyInfrastructure.';
    ...
    protected const PATH = '/directory/publicKeyInfrastructure';
