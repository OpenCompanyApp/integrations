 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}.
 */
class MicrosoftEntraIdDomainsDeleteVerificationDnsRecords extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_delete_verification_dns_records';
    protected const DESCRIPTION = 'Delete navigation property verificationDnsRecords for domains\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}.';
