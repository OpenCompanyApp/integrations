 ...
 * Create domain.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /domains.
 */
class MicrosoftEntraIdDomainsDomainCreateDomain extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_domain_create_domain';
    protected const DESCRIPTION = 'Create domain\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /domains.';
