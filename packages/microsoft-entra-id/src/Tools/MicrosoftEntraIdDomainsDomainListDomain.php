 ...
 * List domains.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /domains.
 */
class MicrosoftEntraIdDomainsDomainListDomain extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_domain_list_domain';
