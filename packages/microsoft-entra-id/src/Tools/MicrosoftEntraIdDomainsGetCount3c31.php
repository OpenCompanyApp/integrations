 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /domains/$count.
 */
class MicrosoftEntraIdDomainsGetCount3c31 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_get_count_3c31';
    ...
    protected const PATH = '/domains/$count';
