 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /domains/{domain-id}/federationConfiguration/{internalDomainFederation-id}.
 */
class MicrosoftEntraIdDomainsGetFederationConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_get_federation_configuration';
    protected const DESCRIPTION = 'Get internalDomainFederation\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /domains/{domain-id}/federationConfiguration/{internalDomainFederation-id}.';
