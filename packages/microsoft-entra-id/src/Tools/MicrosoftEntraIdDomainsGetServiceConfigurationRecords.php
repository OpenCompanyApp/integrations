 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /domains/{domain-id}/serviceConfigurationRecords/{domainDnsRecord-id}.
 */
class MicrosoftEntraIdDomainsGetServiceConfigurationRecords extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_get_service_configuration_records';
    protected const DESCRIPTION = 'Get serviceConfigurationRecords from domains\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /domains/{domain-id}/serviceConfigurationRecords/{domainDnsRecord-id}.';
