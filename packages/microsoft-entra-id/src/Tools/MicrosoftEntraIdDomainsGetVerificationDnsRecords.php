 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}.
 */
class MicrosoftEntraIdDomainsGetVerificationDnsRecords extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_get_verification_dns_records';
    protected const DESCRIPTION = 'Get verificationDnsRecords from domains\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}.';
