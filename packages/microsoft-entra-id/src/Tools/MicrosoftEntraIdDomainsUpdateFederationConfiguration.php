 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /domains/{domain-id}/federationConfiguration/{internalDomainFederation-id}.
 */
class MicrosoftEntraIdDomainsUpdateFederationConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_update_federation_configuration';
    protected const DESCRIPTION = 'Update internalDomainFederation\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /domains/{domain-id}/federationConfiguration/{internalDomainFederation-id}.';
