 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /domains/{domain-id}/serviceConfigurationRecords/{domainDnsRecord-id}.
 */
class MicrosoftEntraIdDomainsUpdateServiceConfigurationRecords extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_update_service_configuration_records';
    protected const DESCRIPTION = 'Update the navigation property serviceConfigurationRecords in domains\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /domains/{domain-id}/serviceConfigurationRecords/{domainDnsRecord-id}.';
