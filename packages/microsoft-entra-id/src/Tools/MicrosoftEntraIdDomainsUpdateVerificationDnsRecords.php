 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}.
 */
class MicrosoftEntraIdDomainsUpdateVerificationDnsRecords extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_domains_update_verification_dns_records';
    protected const DESCRIPTION = 'Update the navigation property verificationDnsRecords in domains\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}.';
    ...
    protected const PATH = '/domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}';
