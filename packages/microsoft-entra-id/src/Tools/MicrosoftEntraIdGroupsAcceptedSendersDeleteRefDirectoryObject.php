 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/acceptedSenders/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdGroupsAcceptedSendersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_accepted_senders_delete_ref_directory_object';
    ...
    protected const PATH = '/groups/{group-id}/acceptedSenders/{directoryObject-id}/$ref';
