 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}.
 */
class MicrosoftEntraIdGroupsDeleteGroupLifecyclePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_delete_group_lifecycle_policies';
    protected const DESCRIPTION = 'Delete navigation property groupLifecyclePolicies for groups\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}.';
