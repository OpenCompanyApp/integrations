 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdGroupsGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_available_extension_properties';
    ...
    protected const PATH = '/groups/getAvailableExtensionProperties';
