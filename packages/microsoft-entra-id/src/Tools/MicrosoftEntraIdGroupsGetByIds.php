 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/getByIds.
 */
class MicrosoftEntraIdGroupsGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_by_ids';
    ...
    protected const PATH = '/groups/getByIds';
