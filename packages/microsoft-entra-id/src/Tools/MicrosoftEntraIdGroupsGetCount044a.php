 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/$count.
 */
class MicrosoftEntraIdGroupsGetCount044a extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_count_044a';
    ...
    protected const PATH = '/groups/$count';
