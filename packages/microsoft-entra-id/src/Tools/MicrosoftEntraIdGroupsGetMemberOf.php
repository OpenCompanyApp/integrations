 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/memberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdGroupsGetMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_member_of';
    protected const DESCRIPTION = 'Get memberOf from groups\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/memberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/groups/{group-id}/memberOf/{directoryObject-id}';
