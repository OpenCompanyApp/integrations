 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/memberOf/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdGroupsGetMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_member_of_as_group';
    ...
    protected const PATH = '/groups/{group-id}/memberOf/{directoryObject-id}/graph.group';
