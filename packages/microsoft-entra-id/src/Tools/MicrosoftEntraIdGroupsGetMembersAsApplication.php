 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/members/{directoryObject-id}/graph.application.
 */
class MicrosoftEntraIdGroupsGetMembersAsApplication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_members_as_application';
    ...
    protected const PATH = '/groups/{group-id}/members/{directoryObject-id}/graph.application';
