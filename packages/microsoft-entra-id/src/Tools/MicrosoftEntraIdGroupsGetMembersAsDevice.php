 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/members/{directoryObject-id}/graph.device.
 */
class MicrosoftEntraIdGroupsGetMembersAsDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_members_as_device';
    ...
    protected const PATH = '/groups/{group-id}/members/{directoryObject-id}/graph.device';
