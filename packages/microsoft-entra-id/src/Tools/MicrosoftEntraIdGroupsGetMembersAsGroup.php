 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/members/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdGroupsGetMembersAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_members_as_group';
    ...
    protected const PATH = '/groups/{group-id}/members/{directoryObject-id}/graph.group';
