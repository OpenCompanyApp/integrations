 ...
 * List group members.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/members/{directoryObject-id}/graph.user.
 */
class MicrosoftEntraIdGroupsGetMembersAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_members_as_user';
    ...
    protected const PATH = '/groups/{group-id}/members/{directoryObject-id}/graph.user';
