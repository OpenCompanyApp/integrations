 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}.
 */
class MicrosoftEntraIdGroupsGetMembersWithLicenseErrors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_members_with_license_errors';
    ...
    protected const PATH = '/groups/{group-id}/membersWithLicenseErrors/{directoryObject-id}';
