 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/owners/{directoryObject-id}/graph.servicePrincipal.
 */
class MicrosoftEntraIdGroupsGetOwnersAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_owners_as_service_principal';
    ...
    protected const PATH = '/groups/{group-id}/owners/{directoryObject-id}/graph.servicePrincipal';
