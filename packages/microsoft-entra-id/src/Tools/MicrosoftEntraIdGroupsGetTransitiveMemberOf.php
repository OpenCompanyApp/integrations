 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/transitiveMemberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdGroupsGetTransitiveMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_transitive_member_of';
    protected const DESCRIPTION = 'Get transitiveMemberOf from groups\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/transitiveMemberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/groups/{group-id}/transitiveMemberOf/{directoryObject-id}';
