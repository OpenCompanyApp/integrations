 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/transitiveMemberOf/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdGroupsGetTransitiveMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_transitive_member_of_as_group';
    ...
    protected const PATH = '/groups/{group-id}/transitiveMemberOf/{directoryObject-id}/graph.group';
