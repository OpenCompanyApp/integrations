 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/transitiveMembers/{directoryObject-id}.
 */
class MicrosoftEntraIdGroupsGetTransitiveMembers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_transitive_members';
    protected const DESCRIPTION = 'Get transitiveMembers from groups\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/transitiveMembers/{directoryObject-id}.';
    ...
    protected const PATH = '/groups/{group-id}/transitiveMembers/{directoryObject-id}';
