 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.orgContact.
 */
class MicrosoftEntraIdGroupsGetTransitiveMembersAsOrgContact extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_transitive_members_as_org_contact';
    ...
    protected const PATH = '/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.orgContact';
