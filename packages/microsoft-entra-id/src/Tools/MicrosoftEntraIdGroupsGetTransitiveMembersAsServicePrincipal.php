 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.servicePrincipal.
 */
class MicrosoftEntraIdGroupsGetTransitiveMembersAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_transitive_members_as_service_principal';
    ...
    protected const PATH = '/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.servicePrincipal';
