 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.user.
 */
class MicrosoftEntraIdGroupsGetTransitiveMembersAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_get_transitive_members_as_user';
    ...
    protected const PATH = '/groups/{group-id}/transitiveMembers/{directoryObject-id}/graph.user';
