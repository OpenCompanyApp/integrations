 ...
 * Create group.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups.
 */
class MicrosoftEntraIdGroupsGroupCreateGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_group_create_group';
