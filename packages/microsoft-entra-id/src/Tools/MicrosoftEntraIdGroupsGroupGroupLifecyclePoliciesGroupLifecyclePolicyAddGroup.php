 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}/addGroup.
 */
class MicrosoftEntraIdGroupsGroupGroupLifecyclePoliciesGroupLifecyclePolicyAddGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_group_group_lifecycle_policies_group_lifecycle_policy_add_group';
    protected const DESCRIPTION = 'Invoke action addGroup\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}/addGroup.';
    ...
    protected const PATH = '/groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}/addGroup';
