 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}/removeGroup.
 */
class MicrosoftEntraIdGroupsGroupGroupLifecyclePoliciesGroupLifecyclePolicyRemoveGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_group_group_lifecycle_policies_group_lifecycle_policy_remove_group';
    protected const DESCRIPTION = 'Invoke action removeGroup\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}/removeGroup.';
    ...
    protected const PATH = '/groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}/removeGroup';
