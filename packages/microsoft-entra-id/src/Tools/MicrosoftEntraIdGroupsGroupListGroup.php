 ...
 * List groups.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups.
 */
class MicrosoftEntraIdGroupsGroupListGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_group_list_group';
