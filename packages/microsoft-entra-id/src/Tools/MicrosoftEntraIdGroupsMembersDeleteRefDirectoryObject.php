 ...
 * Remove member.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/members/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdGroupsMembersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_members_delete_ref_directory_object';
    ...
    protected const PATH = '/groups/{group-id}/members/{directoryObject-id}/$ref';
