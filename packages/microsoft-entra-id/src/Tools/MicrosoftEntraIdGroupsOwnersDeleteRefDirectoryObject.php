 ...
 * Remove group owner.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/owners/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdGroupsOwnersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_owners_delete_ref_directory_object';
    ...
    protected const PATH = '/groups/{group-id}/owners/{directoryObject-id}/$ref';
