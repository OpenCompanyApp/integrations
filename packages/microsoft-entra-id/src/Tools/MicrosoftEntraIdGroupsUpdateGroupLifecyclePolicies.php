 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}.
 */
class MicrosoftEntraIdGroupsUpdateGroupLifecyclePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_update_group_lifecycle_policies';
    protected const DESCRIPTION = 'Update the navigation property groupLifecyclePolicies in groups\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /groups/{group-id}/groupLifecyclePolicies/{groupLifecyclePolicy-id}.';
