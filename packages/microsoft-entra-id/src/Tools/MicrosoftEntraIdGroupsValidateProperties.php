 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/validateProperties.
 */
class MicrosoftEntraIdGroupsValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_groups_validate_properties';
    ...
    protected const PATH = '/groups/validateProperties';
