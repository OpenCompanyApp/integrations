 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationContextClassReferences/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationContextClassReferencesGetCount1d40 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_context_class_references_get_count_1d40';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationContextClassReferences/$count';
