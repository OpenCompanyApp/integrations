 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationStrength/authenticationMethodModes/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationStrengthAuthenticationMethodModesGetCountE876 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_strength_authentication_method_modes_get_count_e876';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationStrength/authenticationMethodModes/$count';
