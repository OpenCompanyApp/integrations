 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/authenticationStrength/authenticationMethodModes.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationStrengthCreateAuthenticationMethodModes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_strength_create_authentication_method_modes';
    protected const DESCRIPTION = 'Create new navigation property to authenticationMethodModes for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/authenticationStrength/authenticationMethodModes.';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationStrength/authenticationMethodModes';
