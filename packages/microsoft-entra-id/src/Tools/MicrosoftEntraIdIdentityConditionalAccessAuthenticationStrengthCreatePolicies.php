 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/authenticationStrength/policies.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationStrengthCreatePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_strength_create_policies';
    protected const DESCRIPTION = 'Create new navigation property to policies for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/authenticationStrength/policies.';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationStrength/policies';
