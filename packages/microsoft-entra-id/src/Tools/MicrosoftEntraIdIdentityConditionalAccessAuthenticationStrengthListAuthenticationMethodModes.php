 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationStrength/authenticationMethodModes.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationStrengthListAuthenticationMethodModes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_strength_list_authentication_method_modes';
    protected const DESCRIPTION = 'List authenticationMethodModes\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/authenticationStrength/authenticationMethodModes.';
