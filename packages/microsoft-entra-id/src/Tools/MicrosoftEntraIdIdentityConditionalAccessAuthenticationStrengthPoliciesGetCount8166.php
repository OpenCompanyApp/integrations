 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationStrength/policies/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationStrengthPoliciesGetCount8166 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_strength_policies_get_count_8166';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationStrength/policies/$count';
