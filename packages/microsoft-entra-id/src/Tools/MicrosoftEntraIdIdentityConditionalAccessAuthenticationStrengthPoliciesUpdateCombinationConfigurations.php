 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessAuthenticationStrengthPoliciesUpdateCombinationConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_authentication_strength_policies_update_combination_configurations';
    protected const DESCRIPTION = 'Update authenticationCombinationConfiguration\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.';
