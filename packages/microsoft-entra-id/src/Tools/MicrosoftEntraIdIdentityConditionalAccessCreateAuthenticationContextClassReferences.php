 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/authenticationContextClassReferences.
 */
class MicrosoftEntraIdIdentityConditionalAccessCreateAuthenticationContextClassReferences extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_create_authentication_context_class_references';
    protected const DESCRIPTION = 'Create new navigation property to authenticationContextClassReferences for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/authenticationContextClassReferences.';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationContextClassReferences';
