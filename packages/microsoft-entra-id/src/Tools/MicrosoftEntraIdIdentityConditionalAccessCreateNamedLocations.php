 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/namedLocations.
 */
class MicrosoftEntraIdIdentityConditionalAccessCreateNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_create_named_locations';
    protected const DESCRIPTION = 'Create namedLocation\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/namedLocations.';
    ...
    protected const PATH = '/identity/conditionalAccess/namedLocations';
