 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/policies.
 */
class MicrosoftEntraIdIdentityConditionalAccessCreatePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_create_policies';
    protected const DESCRIPTION = 'Create conditionalAccessPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/policies.';
    ...
    protected const PATH = '/identity/conditionalAccess/policies';
