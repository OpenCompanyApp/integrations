 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identity/conditionalAccess/authenticationStrength.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeleteAuthenticationStrength extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_delete_authentication_strength';
    protected const DESCRIPTION = 'Delete navigation property authenticationStrength for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identity/conditionalAccess/authenticationStrength.';
