 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identity/conditionalAccess/deletedItems.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeleteDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_delete_deleted_items';
    protected const DESCRIPTION = 'Delete navigation property deletedItems for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identity/conditionalAccess/deletedItems.';
