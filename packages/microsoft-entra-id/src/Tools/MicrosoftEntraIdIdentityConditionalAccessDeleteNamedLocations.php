 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identity/conditionalAccess/namedLocations/{namedLocation-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeleteNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_delete_named_locations';
    protected const DESCRIPTION = 'Delete countryNamedLocation\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identity/conditionalAccess/namedLocations/{namedLocation-id}.';
    ...
    protected const PATH = '/identity/conditionalAccess/namedLocations/{namedLocation-id}';
