 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_delete_policies';
    protected const DESCRIPTION = 'Delete conditionalAccessPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}.';
    ...
    protected const PATH = '/identity/conditionalAccess/policies/{conditionalAccessPolicy-id}';
