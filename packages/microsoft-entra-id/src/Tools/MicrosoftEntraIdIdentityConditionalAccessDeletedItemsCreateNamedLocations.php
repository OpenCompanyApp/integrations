 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/deletedItems/namedLocations.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsCreateNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_create_named_locations';
    protected const DESCRIPTION = 'Create new navigation property to namedLocations for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/deletedItems/namedLocations.';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems/namedLocations';
