 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/deletedItems/policies.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsCreatePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_create_policies';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems/policies';
