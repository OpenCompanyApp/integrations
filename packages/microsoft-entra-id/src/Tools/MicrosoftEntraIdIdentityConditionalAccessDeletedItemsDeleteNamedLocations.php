 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsDeleteNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_delete_named_locations';
    protected const DESCRIPTION = 'Delete navigation property namedLocations for identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}.';
