 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsDeletePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_delete_policies';
