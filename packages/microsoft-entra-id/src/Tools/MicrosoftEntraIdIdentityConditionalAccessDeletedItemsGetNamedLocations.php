 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsGetNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_get_named_locations';
    protected const DESCRIPTION = 'Get namedLocations from identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}.';
