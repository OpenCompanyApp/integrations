 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/deletedItems/namedLocations.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsListNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_list_named_locations';
