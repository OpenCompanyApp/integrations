 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/deletedItems/namedLocations/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsNamedLocationsGetCount74ac extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_named_locations_get_count_74ac';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems/namedLocations/$count';
