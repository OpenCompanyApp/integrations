 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/deletedItems/policies/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsPoliciesGetCount9e9d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_policies_get_count_9e9d';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems/policies/$count';
