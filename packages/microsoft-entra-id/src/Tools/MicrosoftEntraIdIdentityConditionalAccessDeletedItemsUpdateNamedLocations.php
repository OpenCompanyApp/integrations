 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsUpdateNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_update_named_locations';
    protected const DESCRIPTION = 'Update the navigation property namedLocations in identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}.';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems/namedLocations/{namedLocation-id}';
