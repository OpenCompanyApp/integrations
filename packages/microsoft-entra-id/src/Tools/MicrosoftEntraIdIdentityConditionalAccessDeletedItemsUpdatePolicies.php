 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessDeletedItemsUpdatePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_deleted_items_update_policies';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy-id}';
