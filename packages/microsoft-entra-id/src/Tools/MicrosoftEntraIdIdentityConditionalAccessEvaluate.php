 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/evaluate.
 */
class MicrosoftEntraIdIdentityConditionalAccessEvaluate extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_evaluate';
    protected const DESCRIPTION = 'Invoke action evaluate\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identity/conditionalAccess/evaluate.';
    ...
    protected const PATH = '/identity/conditionalAccess/evaluate';
