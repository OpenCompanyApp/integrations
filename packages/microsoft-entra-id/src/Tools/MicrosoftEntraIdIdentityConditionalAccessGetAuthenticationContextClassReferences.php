 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationContextClassReferences/{authenticationContextClassReference-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessGetAuthenticationContextClassReferences extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_get_authentication_context_class_references';
    protected const DESCRIPTION = 'Get authenticationContextClassReference\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/authenticationContextClassReferences/{authenticationContextClassReference-id}.';
