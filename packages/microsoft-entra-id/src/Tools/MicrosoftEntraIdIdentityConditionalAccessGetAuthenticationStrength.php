 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationStrength.
 */
class MicrosoftEntraIdIdentityConditionalAccessGetAuthenticationStrength extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_get_authentication_strength';
    protected const DESCRIPTION = 'Get authenticationStrength from identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/authenticationStrength.';
