 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/deletedItems.
 */
class MicrosoftEntraIdIdentityConditionalAccessGetDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_get_deleted_items';
    protected const DESCRIPTION = 'Get deletedItems from identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/deletedItems.';
