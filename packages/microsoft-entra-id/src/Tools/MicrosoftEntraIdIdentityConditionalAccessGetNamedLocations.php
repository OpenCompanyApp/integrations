 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/namedLocations/{namedLocation-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessGetNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_get_named_locations';
    protected const DESCRIPTION = 'Get countryNamedLocation\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/namedLocations/{namedLocation-id}.';
