 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessGetPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_get_policies';
    protected const DESCRIPTION = 'Get conditionalAccessPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}.';
