 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/authenticationContextClassReferences.
 */
class MicrosoftEntraIdIdentityConditionalAccessListAuthenticationContextClassReferences extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_list_authentication_context_class_references';
    protected const DESCRIPTION = 'List authenticationContextClassReferences\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/authenticationContextClassReferences.';
