 ...
 * List namedLocations.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/namedLocations.
 */
class MicrosoftEntraIdIdentityConditionalAccessListNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_list_named_locations';
    protected const DESCRIPTION = 'List namedLocations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/namedLocations.';
