 ...
 * List policies.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/policies.
 */
class MicrosoftEntraIdIdentityConditionalAccessListPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_list_policies';
