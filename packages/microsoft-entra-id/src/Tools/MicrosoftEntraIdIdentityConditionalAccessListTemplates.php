 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/templates.
 */
class MicrosoftEntraIdIdentityConditionalAccessListTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_list_templates';
    protected const DESCRIPTION = 'List conditionalAccessTemplates\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identity/conditionalAccess/templates.';
    ...
    protected const PATH = '/identity/conditionalAccess/templates';
