 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/namedLocations/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessNamedLocationsGetCountE424 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_named_locations_get_count_e424';
    ...
    protected const PATH = '/identity/conditionalAccess/namedLocations/$count';
