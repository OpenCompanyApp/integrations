 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/namedLocations/{namedLocation-id}/restore.
 */
class MicrosoftEntraIdIdentityConditionalAccessNamedLocationsNamedLocationRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_named_locations_named_location_restore';
    ...
    protected const PATH = '/identity/conditionalAccess/namedLocations/{namedLocation-id}/restore';
