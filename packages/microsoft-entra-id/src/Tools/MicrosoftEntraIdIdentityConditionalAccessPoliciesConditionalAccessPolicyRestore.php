 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}/restore.
 */
class MicrosoftEntraIdIdentityConditionalAccessPoliciesConditionalAccessPolicyRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_policies_conditional_access_policy_restore';
    ...
    protected const PATH = '/identity/conditionalAccess/policies/{conditionalAccessPolicy-id}/restore';
