 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/policies/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessPoliciesGetCount608a extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_policies_get_count_608a';
    ...
    protected const PATH = '/identity/conditionalAccess/policies/$count';
