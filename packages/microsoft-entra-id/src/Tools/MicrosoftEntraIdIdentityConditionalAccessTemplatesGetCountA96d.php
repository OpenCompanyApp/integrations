 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identity/conditionalAccess/templates/$count.
 */
class MicrosoftEntraIdIdentityConditionalAccessTemplatesGetCountA96d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_templates_get_count_a96d';
    ...
    protected const PATH = '/identity/conditionalAccess/templates/$count';
