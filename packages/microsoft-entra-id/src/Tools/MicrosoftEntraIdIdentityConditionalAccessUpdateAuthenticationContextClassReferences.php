 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/authenticationContextClassReferences/{authenticationContextClassReference-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessUpdateAuthenticationContextClassReferences extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_update_authentication_context_class_references';
    protected const DESCRIPTION = 'Create or Update authenticationContextClassReference\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/authenticationContextClassReferences/{authenticationContextClassReference-id}.';
