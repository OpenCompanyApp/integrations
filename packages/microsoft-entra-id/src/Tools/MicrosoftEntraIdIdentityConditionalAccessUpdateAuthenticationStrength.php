 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/authenticationStrength.
 */
class MicrosoftEntraIdIdentityConditionalAccessUpdateAuthenticationStrength extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_update_authentication_strength';
    protected const DESCRIPTION = 'Update the navigation property authenticationStrength in identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/authenticationStrength.';
    ...
    protected const PATH = '/identity/conditionalAccess/authenticationStrength';
