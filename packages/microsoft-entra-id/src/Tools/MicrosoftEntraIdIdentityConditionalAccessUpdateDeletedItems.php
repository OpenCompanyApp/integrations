 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/deletedItems.
 */
class MicrosoftEntraIdIdentityConditionalAccessUpdateDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_update_deleted_items';
    protected const DESCRIPTION = 'Update the navigation property deletedItems in identity\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/deletedItems.';
    ...
    protected const PATH = '/identity/conditionalAccess/deletedItems';
