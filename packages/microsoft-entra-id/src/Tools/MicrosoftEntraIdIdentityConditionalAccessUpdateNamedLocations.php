 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/namedLocations/{namedLocation-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessUpdateNamedLocations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_update_named_locations';
    protected const DESCRIPTION = 'Update countryNamedLocation\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/namedLocations/{namedLocation-id}.';
