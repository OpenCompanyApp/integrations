 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdIdentityConditionalAccessUpdatePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_conditional_access_update_policies';
    protected const DESCRIPTION = 'Update conditionalaccesspolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identity/conditionalAccess/policies/{conditionalAccessPolicy-id}.';
