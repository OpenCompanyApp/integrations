 ...
 * Create definitions.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/accessReviews/definitions.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsCreateDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_create_definitions';
    protected const DESCRIPTION = 'Create definitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/accessReviews/definitions.';
    ...
    protected const PATH = '/identityGovernance/accessReviews/definitions';
