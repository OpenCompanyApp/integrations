 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/accessReviews/historyDefinitions.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsCreateHistoryDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_create_history_definitions';
    protected const DESCRIPTION = 'Create historyDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/accessReviews/historyDefinitions.';
    ...
    protected const PATH = '/identityGovernance/accessReviews/historyDefinitions';
