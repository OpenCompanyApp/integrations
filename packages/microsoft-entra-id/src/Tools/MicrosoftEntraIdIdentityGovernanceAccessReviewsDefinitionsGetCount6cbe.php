 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/definitions/$count.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDefinitionsGetCount6cbe extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_definitions_get_count_6cbe';
    ...
    protected const PATH = '/identityGovernance/accessReviews/definitions/$count';
