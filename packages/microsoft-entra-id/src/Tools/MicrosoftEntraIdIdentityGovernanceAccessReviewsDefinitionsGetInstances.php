 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDefinitionsGetInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_definitions_get_instances';
    protected const DESCRIPTION = 'Get accessReviewInstance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}.';
