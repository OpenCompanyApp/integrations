 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}/contactedReviewers/$count.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDefinitionsInstancesContactedReviewersGetCountFe5f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_definitions_instances_contacted_reviewers_get_count_fe5f';
    ...
    protected const PATH = '/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}/contactedReviewers/$count';
