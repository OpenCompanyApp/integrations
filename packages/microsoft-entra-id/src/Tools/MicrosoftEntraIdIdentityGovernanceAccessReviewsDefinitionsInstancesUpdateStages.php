 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}/stages/{accessReviewStage-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDefinitionsInstancesUpdateStages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_definitions_instances_update_stages';
    protected const DESCRIPTION = 'Update accessReviewStage\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}/stages/{accessReviewStage-id}.';
