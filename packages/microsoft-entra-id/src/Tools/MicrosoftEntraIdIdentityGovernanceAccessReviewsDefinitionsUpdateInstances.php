 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDefinitionsUpdateInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_definitions_update_instances';
    protected const DESCRIPTION = 'Update accessReviewInstance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}.';
