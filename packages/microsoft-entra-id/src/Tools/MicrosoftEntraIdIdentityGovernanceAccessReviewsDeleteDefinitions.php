 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDeleteDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_delete_definitions';
    protected const DESCRIPTION = 'Delete accessReviewScheduleDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}.';
