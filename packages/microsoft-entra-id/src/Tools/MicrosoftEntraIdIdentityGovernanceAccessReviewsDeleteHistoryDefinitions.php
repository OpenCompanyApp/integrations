 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsDeleteHistoryDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_delete_history_definitions';
    protected const DESCRIPTION = 'Delete navigation property historyDefinitions for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}.';
