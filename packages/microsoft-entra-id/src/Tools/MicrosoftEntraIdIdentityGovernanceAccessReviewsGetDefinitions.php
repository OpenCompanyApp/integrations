 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsGetDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_get_definitions';
    protected const DESCRIPTION = 'Get accessReviewScheduleDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}.';
