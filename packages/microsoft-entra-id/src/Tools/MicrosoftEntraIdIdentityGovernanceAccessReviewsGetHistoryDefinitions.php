 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsGetHistoryDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_get_history_definitions';
    protected const DESCRIPTION = 'Get accessReviewHistoryDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}.';
