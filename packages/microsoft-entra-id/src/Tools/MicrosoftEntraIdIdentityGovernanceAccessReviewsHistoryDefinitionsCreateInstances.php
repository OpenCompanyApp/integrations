 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsHistoryDefinitionsCreateInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_history_definitions_create_instances';
    protected const DESCRIPTION = 'Create new navigation property to instances for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances.';
    ...
    protected const PATH = '/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances';
    protected const PATH_PARAMS = ['accessReviewHistoryDefinition-id' => 'access_review_history_definition_id'];
