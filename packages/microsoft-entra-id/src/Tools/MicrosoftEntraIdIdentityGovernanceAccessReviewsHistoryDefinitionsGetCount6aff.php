 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/historyDefinitions/$count.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsHistoryDefinitionsGetCount6aff extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_history_definitions_get_count_6aff';
    ...
    protected const PATH = '/identityGovernance/accessReviews/historyDefinitions/$count';
