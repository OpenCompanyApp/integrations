 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances/$count.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsHistoryDefinitionsInstancesGetCountCbe7 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_history_definitions_instances_get_count_cbe7';
    ...
    protected const PATH = '/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances/$count';
