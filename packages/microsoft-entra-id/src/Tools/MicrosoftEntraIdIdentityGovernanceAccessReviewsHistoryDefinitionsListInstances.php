 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsHistoryDefinitionsListInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_history_definitions_list_instances';
    protected const DESCRIPTION = 'List instances (of an accessReviewHistoryDefinition)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}/instances.';
