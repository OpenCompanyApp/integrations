 ...
 * List definitions.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/definitions.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsListDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_list_definitions';
    protected const DESCRIPTION = 'List definitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews/definitions.';
