 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews/historyDefinitions.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsListHistoryDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_list_history_definitions';
    protected const DESCRIPTION = 'List historyDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews/historyDefinitions.';
