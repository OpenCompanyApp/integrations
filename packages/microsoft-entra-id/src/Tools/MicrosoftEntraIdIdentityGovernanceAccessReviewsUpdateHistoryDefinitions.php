 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAccessReviewsUpdateHistoryDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_access_reviews_update_history_definitions';
    protected const DESCRIPTION = 'Update the navigation property historyDefinitions in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}.';
    ...
    protected const PATH = '/identityGovernance/accessReviews/historyDefinitions/{accessReviewHistoryDefinition-id}';
