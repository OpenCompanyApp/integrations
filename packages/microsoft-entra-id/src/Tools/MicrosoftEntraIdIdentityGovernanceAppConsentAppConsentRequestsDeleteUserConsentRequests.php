 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsDeleteUserConsentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_delete_user_consent_requests';
    protected const DESCRIPTION = 'Delete navigation property userConsentRequests for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}.';
