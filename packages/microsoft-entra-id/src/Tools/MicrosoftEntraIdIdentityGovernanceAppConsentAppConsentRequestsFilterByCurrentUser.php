 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/appConsent/appConsentRequests/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_filter_by_current_user';
    ...
    protected const PATH = '/identityGovernance/appConsent/appConsentRequests/filterByCurrentUser(on=\'{on}\')';
