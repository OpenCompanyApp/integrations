 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/appConsent/appConsentRequests/$count.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsGetCountD9b5 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_get_count_d9b5';
    ...
    protected const PATH = '/identityGovernance/appConsent/appConsentRequests/$count';
