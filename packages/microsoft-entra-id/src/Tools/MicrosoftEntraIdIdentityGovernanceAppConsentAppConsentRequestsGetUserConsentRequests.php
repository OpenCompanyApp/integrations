 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsGetUserConsentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_get_user_consent_requests';
    protected const DESCRIPTION = 'Get userConsentRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}.';
