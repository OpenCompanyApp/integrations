 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsUpdateUserConsentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_update_user_consent_requests';
    protected const DESCRIPTION = 'Update the navigation property userConsentRequests in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}.';
    ...
    protected const PATH = '/identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}';
