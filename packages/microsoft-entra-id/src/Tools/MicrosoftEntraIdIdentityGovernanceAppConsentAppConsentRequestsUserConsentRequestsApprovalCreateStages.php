 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}/approval/stages.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsUserConsentRequestsApprovalCreateStages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_user_consent_requests_approval_create_stages';
