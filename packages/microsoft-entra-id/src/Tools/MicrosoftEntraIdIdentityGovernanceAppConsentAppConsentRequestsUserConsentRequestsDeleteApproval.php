 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}/approval.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsUserConsentRequestsDeleteApproval extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_user_consent_requests_delete_approval';
    protected const DESCRIPTION = 'Delete navigation property approval for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}/approval.';
