 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}/approval.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentAppConsentRequestsUserConsentRequestsGetApproval extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_app_consent_requests_user_consent_requests_get_approval';
    protected const DESCRIPTION = 'Get approval from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/appConsent/appConsentRequests/{appConsentRequest-id}/userConsentRequests/{userConsentRequest-id}/approval.';
