 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/appConsent/appConsentRequests.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentCreateAppConsentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_create_app_consent_requests';
    protected const DESCRIPTION = 'Create new navigation property to appConsentRequests for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/appConsent/appConsentRequests.';
    ...
    protected const PATH = '/identityGovernance/appConsent/appConsentRequests';
