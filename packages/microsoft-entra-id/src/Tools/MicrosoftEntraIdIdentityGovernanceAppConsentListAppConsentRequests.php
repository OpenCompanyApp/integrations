 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/appConsent/appConsentRequests.
 */
class MicrosoftEntraIdIdentityGovernanceAppConsentListAppConsentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_app_consent_list_app_consent_requests';
    protected const DESCRIPTION = 'List appConsentRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/appConsent/appConsentRequests.';
