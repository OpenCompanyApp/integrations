 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/accessReviews.
 */
class MicrosoftEntraIdIdentityGovernanceDeleteAccessReviews extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_delete_access_reviews';
    protected const DESCRIPTION = 'Delete navigation property accessReviews for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/accessReviews.';
