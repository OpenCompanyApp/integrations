 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/appConsent.
 */
class MicrosoftEntraIdIdentityGovernanceDeleteAppConsent extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_delete_app_consent';
    protected const DESCRIPTION = 'Delete navigation property appConsent for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/appConsent.';
