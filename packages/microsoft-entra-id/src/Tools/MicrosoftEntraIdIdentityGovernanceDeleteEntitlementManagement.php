 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement.
 */
class MicrosoftEntraIdIdentityGovernanceDeleteEntitlementManagement extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_delete_entitlement_management';
    protected const DESCRIPTION = 'Delete navigation property entitlementManagement for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/entitlementManagement.';
