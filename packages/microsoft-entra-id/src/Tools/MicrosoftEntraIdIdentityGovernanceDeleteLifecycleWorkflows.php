 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/lifecycleWorkflows.
 */
class MicrosoftEntraIdIdentityGovernanceDeleteLifecycleWorkflows extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_delete_lifecycle_workflows';
    protected const DESCRIPTION = 'Delete navigation property lifecycleWorkflows for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/lifecycleWorkflows.';
