 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/privilegedAccess.
 */
class MicrosoftEntraIdIdentityGovernanceDeletePrivilegedAccess extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_delete_privileged_access';
    protected const DESCRIPTION = 'Delete navigation property privilegedAccess for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/privilegedAccess.';
