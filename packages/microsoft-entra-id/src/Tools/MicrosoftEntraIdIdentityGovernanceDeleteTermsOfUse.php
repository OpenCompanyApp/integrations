 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/termsOfUse.
 */
class MicrosoftEntraIdIdentityGovernanceDeleteTermsOfUse extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_delete_terms_of_use';
    protected const DESCRIPTION = 'Delete navigation property termsOfUse for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/termsOfUse.';
