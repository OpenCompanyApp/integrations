 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}/stages.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackageAssignmentApprovalsCreateStages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_package_assignment_approvals_create_stages';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}/stages';
    protected const PATH_PARAMS = ['approval-id' => 'approval_id'];
