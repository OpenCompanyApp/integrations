 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackageAssignmentApprovalsGetCountAc9b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_package_assignment_approvals_get_count_ac9b';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/$count';
