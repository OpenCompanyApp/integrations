 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}/stages.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackageAssignmentApprovalsListStages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_package_assignment_approvals_list_stages';
    protected const DESCRIPTION = 'List approval stages\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}/stages.';
