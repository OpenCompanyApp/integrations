 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/assignmentPolicies/{accessPackageAssignmentPolicy-id}/customExtensionStageSettings/{customExtensionStageSetting-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackagesAssignmentPoliciesDeleteCustomExtensionStageSettings extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_packages_assignment_policies_delete_custom_extension_stage_settings';
