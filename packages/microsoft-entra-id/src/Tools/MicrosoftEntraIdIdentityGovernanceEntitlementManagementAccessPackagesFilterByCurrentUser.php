 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackages/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackagesFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_packages_filter_by_current_user';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackages/filterByCurrentUser(on=\'{on}\')';
