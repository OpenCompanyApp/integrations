 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackages/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackagesGetCount87ea extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_packages_get_count_87ea';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackages/$count';
