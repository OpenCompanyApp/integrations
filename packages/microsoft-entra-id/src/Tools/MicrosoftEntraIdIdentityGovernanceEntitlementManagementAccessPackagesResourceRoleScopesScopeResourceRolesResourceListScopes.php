 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/resourceRoleScopes/{accessPackageResourceRoleScope-id}/scope/resource/roles/{accessPackageResourceRole-id}/resource/scopes.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAccessPackagesResourceRoleScopesScopeResourceRolesResourceListScopes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_access_packages_resource_role_scopes_scope_resource_roles_resource_list_scopes';
