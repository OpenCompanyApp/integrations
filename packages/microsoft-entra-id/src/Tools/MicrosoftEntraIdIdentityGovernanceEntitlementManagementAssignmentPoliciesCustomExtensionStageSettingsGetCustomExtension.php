 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignmentPolicies/{accessPackageAssignmentPolicy-id}/customExtensionStageSettings/{customExtensionStageSetting-id}/customExtension.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentPoliciesCustomExtensionStageSettingsGetCustomExtension extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignment_policies_custom_extension_stage_settings_get_custom_extension';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignmentPolicies/{accessPackageAssignmentPolicy-id}/customExtensionStageSettings/{customExtensionStageSetting-id}/customExtension';
