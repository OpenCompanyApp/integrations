 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignmentPolicies/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentPoliciesGetCount7f35 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignment_policies_get_count_7f35';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignmentPolicies/$count';
