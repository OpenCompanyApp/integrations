 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/assignmentPolicies/{accessPackageAssignmentPolicy-id}/customExtensionStageSettings/{customExtensionStageSetting-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentPoliciesUpdateCustomExtensionStageSettings extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignment_policies_update_custom_extension_stage_settings';
