 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignmentRequests/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentRequestsFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignment_requests_filter_by_current_user';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignmentRequests/filterByCurrentUser(on=\'{on}\')';
