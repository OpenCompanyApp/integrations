 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignmentRequests/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentRequestsGetCountE1cf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignment_requests_get_count_e1cf';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignmentRequests/$count';
