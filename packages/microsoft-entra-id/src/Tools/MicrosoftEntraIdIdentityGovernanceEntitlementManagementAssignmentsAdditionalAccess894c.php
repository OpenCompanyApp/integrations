 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignments/additionalAccess().
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentsAdditionalAccess894c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignments_additional_access_894c';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignments/additionalAccess()';
