 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignments/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentsFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignments_filter_by_current_user';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignments/filterByCurrentUser(on=\'{on}\')';
