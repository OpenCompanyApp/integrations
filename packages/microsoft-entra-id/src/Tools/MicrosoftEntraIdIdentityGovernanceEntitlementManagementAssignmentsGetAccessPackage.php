 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}/accessPackage.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentsGetAccessPackage extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignments_get_access_package';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}/accessPackage';
