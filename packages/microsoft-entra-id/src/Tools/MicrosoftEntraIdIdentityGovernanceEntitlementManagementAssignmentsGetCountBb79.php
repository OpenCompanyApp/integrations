 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignments/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementAssignmentsGetCountBb79 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_assignments_get_count_bb79';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignments/$count';
