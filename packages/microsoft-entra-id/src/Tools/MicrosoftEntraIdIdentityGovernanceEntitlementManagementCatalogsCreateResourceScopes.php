 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/resourceScopes.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCatalogsCreateResourceScopes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_catalogs_create_resource_scopes';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/resourceScopes';
