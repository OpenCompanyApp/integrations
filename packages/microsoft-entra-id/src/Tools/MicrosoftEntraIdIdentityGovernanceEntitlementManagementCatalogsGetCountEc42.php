 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/catalogs/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCatalogsGetCountEc42 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_catalogs_get_count_ec42';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/catalogs/$count';
