 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCatalogsListCustomWorkflowExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_catalogs_list_custom_workflow_extensions';
    protected const DESCRIPTION = 'List accessPackageCustomWorkflowExtensions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions.';
