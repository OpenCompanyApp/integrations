 ...
 * List resourceRoles.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/resourceRoles.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCatalogsListResourceRoles extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_catalogs_list_resource_roles';
    protected const DESCRIPTION = 'List resourceRoles\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/resourceRoles.';
