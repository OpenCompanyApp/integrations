 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/resourceRoles/{accessPackageResourceRole-id}/resource.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCatalogsResourceRolesDeleteResource extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_catalogs_resource_roles_delete_resource';
