 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions/{customCalloutExtension-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCatalogsUpdateCustomWorkflowExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_catalogs_update_custom_workflow_extensions';
    protected const DESCRIPTION = 'Update accessPackageAssignmentRequestWorkflowExtension\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions/{customCalloutExtension-id}.';
