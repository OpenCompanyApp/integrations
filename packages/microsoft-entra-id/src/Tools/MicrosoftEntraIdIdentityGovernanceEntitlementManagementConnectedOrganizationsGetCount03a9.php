 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/connectedOrganizations/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementConnectedOrganizationsGetCount03a9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_connected_organizations_get_count_03a9';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/connectedOrganizations/$count';
