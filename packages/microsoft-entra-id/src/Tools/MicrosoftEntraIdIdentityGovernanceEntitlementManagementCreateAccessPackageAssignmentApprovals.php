 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateAccessPackageAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_access_package_assignment_approvals';
    protected const DESCRIPTION = 'Create new navigation property to accessPackageAssignmentApprovals for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals';
