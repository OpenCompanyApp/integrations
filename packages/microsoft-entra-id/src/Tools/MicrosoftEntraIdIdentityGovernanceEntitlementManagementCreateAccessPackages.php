 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/accessPackages.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateAccessPackages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_access_packages';
    protected const DESCRIPTION = 'Create accessPackage\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/accessPackages.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackages';
