 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/assignmentPolicies.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateAssignmentPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_assignment_policies';
    protected const DESCRIPTION = 'Create assignmentPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/assignmentPolicies.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignmentPolicies';
