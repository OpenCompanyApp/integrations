 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/assignmentRequests.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateAssignmentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_assignment_requests';
    protected const DESCRIPTION = 'Create accessPackageAssignmentRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/assignmentRequests.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignmentRequests';
