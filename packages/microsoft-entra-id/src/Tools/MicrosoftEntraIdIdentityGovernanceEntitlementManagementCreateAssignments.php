 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/assignments.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_assignments';
    protected const DESCRIPTION = 'Create new navigation property to assignments for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/assignments.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignments';
