 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/catalogs.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateCatalogs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_catalogs';
    protected const DESCRIPTION = 'Create accessPackageCatalog\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/catalogs.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/catalogs';
