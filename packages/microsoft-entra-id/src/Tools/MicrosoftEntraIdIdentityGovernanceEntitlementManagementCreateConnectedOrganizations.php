 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/connectedOrganizations.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateConnectedOrganizations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_connected_organizations';
    protected const DESCRIPTION = 'Create connectedOrganization\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/connectedOrganizations.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/connectedOrganizations';
