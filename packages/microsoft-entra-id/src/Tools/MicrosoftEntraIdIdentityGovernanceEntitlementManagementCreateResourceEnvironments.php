 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceEnvironments.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateResourceEnvironments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_resource_environments';
    protected const DESCRIPTION = 'Create new navigation property to resourceEnvironments for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/resourceEnvironments.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceEnvironments';
