 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceRequests.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateResourceRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_resource_requests';
    protected const DESCRIPTION = 'Create accessPackageResourceRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/resourceRequests.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceRequests';
