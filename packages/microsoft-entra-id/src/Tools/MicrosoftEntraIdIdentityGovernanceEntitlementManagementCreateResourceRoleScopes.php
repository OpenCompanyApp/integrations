 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceRoleScopes.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateResourceRoleScopes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_resource_role_scopes';
    protected const DESCRIPTION = 'Create new navigation property to resourceRoleScopes for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/resourceRoleScopes.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceRoleScopes';
