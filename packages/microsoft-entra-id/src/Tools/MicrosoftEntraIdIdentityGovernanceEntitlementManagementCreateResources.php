 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resources.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementCreateResources extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_create_resources';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resources';
