 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementDeleteAccessPackageAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_delete_access_package_assignment_approvals';
    protected const DESCRIPTION = 'Delete navigation property accessPackageAssignmentApprovals for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}.';
