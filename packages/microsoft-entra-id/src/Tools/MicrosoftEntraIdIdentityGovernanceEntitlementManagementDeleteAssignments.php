 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementDeleteAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_delete_assignments';
    protected const DESCRIPTION = 'Delete navigation property assignments for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}.';
