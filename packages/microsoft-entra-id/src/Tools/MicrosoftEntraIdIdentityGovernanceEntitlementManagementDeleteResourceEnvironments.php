 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementDeleteResourceEnvironments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_delete_resource_environments';
    protected const DESCRIPTION = 'Delete navigation property resourceEnvironments for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}.';
