 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementDeleteResourceRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_delete_resource_requests';
    protected const DESCRIPTION = 'Delete navigation property resourceRequests for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}.';
