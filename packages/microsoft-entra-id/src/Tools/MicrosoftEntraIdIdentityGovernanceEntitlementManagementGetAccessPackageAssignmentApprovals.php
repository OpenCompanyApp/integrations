 ...
 * Get approval.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementGetAccessPackageAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_get_access_package_assignment_approvals';
    protected const DESCRIPTION = 'Get approval\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}.';
