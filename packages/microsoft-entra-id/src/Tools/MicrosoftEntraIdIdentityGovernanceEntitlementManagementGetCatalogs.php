 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementGetCatalogs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_get_catalogs';
    protected const DESCRIPTION = 'Get accessPackageCatalog\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}.';
