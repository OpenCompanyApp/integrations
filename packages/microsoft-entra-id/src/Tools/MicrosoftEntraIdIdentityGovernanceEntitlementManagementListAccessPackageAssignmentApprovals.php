 ...
 * Get approval.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListAccessPackageAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_access_package_assignment_approvals';
