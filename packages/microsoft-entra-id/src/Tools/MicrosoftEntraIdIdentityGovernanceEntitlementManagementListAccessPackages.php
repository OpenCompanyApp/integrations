 ...
 * List accessPackages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/accessPackages.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListAccessPackages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_access_packages';
    protected const DESCRIPTION = 'List accessPackages\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/accessPackages.';
