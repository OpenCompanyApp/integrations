 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignmentPolicies.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListAssignmentPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_assignment_policies';
    protected const DESCRIPTION = 'List assignmentPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/assignmentPolicies.';
