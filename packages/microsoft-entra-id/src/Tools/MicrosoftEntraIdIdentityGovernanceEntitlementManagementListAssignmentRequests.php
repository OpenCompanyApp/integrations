 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignmentRequests.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListAssignmentRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_assignment_requests';
    protected const DESCRIPTION = 'List assignmentRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/assignmentRequests.';
