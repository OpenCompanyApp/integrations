 ...
 * List assignments.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/assignments.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_assignments';
    protected const DESCRIPTION = 'List assignments\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/assignments.';
