 ...
 * List catalogs.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/catalogs.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListCatalogs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_catalogs';
