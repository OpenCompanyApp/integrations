 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/connectedOrganizations.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListConnectedOrganizations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_connected_organizations';
    protected const DESCRIPTION = 'List connectedOrganizations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/connectedOrganizations.';
