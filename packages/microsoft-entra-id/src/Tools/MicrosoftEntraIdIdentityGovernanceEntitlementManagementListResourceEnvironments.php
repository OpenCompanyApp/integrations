 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resourceEnvironments.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListResourceEnvironments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_resource_environments';
    protected const DESCRIPTION = 'List accessPackageResourceEnvironments\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/resourceEnvironments.';
