 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resourceRequests.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListResourceRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_resource_requests';
    protected const DESCRIPTION = 'List accessPackageResourceRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement/resourceRequests.';
