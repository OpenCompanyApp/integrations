 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resourceRoleScopes.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementListResourceRoleScopes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_list_resource_role_scopes';
