 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}/resources/{accessPackageResource-id}/refresh.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceEnvironmentsAccessPackageResourceEnvironmentResourcesAccessPackageResourceRefresh extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_environments_access_package_resource_environment_resources_access_package_resource_refresh';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}/resources/{accessPackageResource-id}/refresh';
