 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}/resources.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceEnvironmentsCreateResources extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_environments_create_resources';
    protected const DESCRIPTION = 'Create new navigation property to resources for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}/resources.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}/resources';
    protected const PATH_PARAMS = ['accessPackageResourceEnvironment-id' => 'access_package_resource_environment_id'];
