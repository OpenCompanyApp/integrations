 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resourceEnvironments/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceEnvironmentsGetCount6cd7 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_environments_get_count_6cd7';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceEnvironments/$count';
