 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/catalog/resources/{accessPackageResource-id}/refresh.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceRequestsAccessPackageResourceRequestCatalogResourcesAccessPackageResourceRefresh extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_requests_access_package_resource_request_catalog_resources_access_package_resource_refresh';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/catalog/resources/{accessPackageResource-id}/refresh';
