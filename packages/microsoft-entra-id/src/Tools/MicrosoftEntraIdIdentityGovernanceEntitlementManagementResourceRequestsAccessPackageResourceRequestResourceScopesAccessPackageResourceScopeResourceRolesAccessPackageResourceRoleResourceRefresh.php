 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/resource/scopes/{accessPackageResourceScope-id}/resource/roles/{accessPackageResourceRole-id}/resource/refresh.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceRequestsAccessPackageResourceRequestResourceScopesAccessPackageResourceScopeResourceRolesAccessPackageResourceRoleResourceRefresh extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_requests_access_package_resource_request_resource_scopes_access_package_resource_scope_resource_roles_access_package_resource_role_resource_refresh';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/resource/scopes/{accessPackageResourceScope-id}/resource/roles/{accessPackageResourceRole-id}/resource/refresh';
