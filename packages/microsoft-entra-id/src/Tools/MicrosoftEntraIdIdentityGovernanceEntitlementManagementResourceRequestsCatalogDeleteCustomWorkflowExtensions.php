 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/catalog/customWorkflowExtensions/{customCalloutExtension-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceRequestsCatalogDeleteCustomWorkflowExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_requests_catalog_delete_custom_workflow_extensions';
    protected const DESCRIPTION = 'Delete navigation property customWorkflowExtensions for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/catalog/customWorkflowExtensions/{customCalloutExtension-id}.';
