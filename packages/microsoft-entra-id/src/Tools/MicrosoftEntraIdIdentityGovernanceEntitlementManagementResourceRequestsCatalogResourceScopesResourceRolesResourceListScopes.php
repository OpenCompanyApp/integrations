 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest-id}/catalog/resourceScopes/{accessPackageResourceScope-id}/resource/roles/{accessPackageResourceRole-id}/resource/scopes.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceRequestsCatalogResourceScopesResourceRolesResourceListScopes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_requests_catalog_resource_scopes_resource_roles_resource_list_scopes';
