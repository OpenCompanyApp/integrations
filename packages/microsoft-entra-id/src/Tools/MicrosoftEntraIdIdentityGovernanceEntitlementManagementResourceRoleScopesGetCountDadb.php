 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resourceRoleScopes/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceRoleScopesGetCountDadb extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_role_scopes_get_count_dadb';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceRoleScopes/$count';
