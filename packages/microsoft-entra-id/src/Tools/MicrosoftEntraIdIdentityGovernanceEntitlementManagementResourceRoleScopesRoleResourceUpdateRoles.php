 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope-id}/role/resource/roles/{accessPackageResourceRole-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourceRoleScopesRoleResourceUpdateRoles extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resource_role_scopes_role_resource_update_roles';
