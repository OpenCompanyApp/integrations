 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/entitlementManagement/resources/{accessPackageResource-id}/scopes/{accessPackageResourceScope-id}/resource/refresh.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourcesAccessPackageResourceScopesAccessPackageResourceScopeResourceRefresh extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resources_access_package_resource_scopes_access_package_resource_scope_resource_refresh';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resources/{accessPackageResource-id}/scopes/{accessPackageResourceScope-id}/resource/refresh';
