 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement/resources/$count.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementResourcesGetCountC197 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_resources_get_count_c197';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resources/$count';
