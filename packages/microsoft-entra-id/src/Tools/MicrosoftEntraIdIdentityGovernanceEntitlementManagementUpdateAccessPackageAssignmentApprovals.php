 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementUpdateAccessPackageAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_update_access_package_assignment_approvals';
    protected const DESCRIPTION = 'Update the navigation property accessPackageAssignmentApprovals in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval-id}';
