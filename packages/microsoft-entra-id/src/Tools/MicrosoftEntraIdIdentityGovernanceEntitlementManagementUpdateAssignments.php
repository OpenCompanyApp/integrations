 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementUpdateAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_update_assignments';
    protected const DESCRIPTION = 'Update the navigation property assignments in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment-id}';
