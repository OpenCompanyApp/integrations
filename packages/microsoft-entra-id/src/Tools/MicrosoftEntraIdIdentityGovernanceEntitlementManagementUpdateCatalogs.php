 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementUpdateCatalogs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_update_catalogs';
    protected const DESCRIPTION = 'Update accessPackageCatalog\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog-id}.';
