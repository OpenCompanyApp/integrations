 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}.
 */
class MicrosoftEntraIdIdentityGovernanceEntitlementManagementUpdateResourceEnvironments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_entitlement_management_update_resource_environments';
    protected const DESCRIPTION = 'Update the navigation property resourceEnvironments in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment-id}';
