 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/accessReviews.
 */
class MicrosoftEntraIdIdentityGovernanceGetAccessReviews extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_get_access_reviews';
    protected const DESCRIPTION = 'Get accessReviews from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/accessReviews.';
