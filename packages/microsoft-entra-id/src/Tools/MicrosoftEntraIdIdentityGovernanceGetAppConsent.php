 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/appConsent.
 */
class MicrosoftEntraIdIdentityGovernanceGetAppConsent extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_get_app_consent';
    protected const DESCRIPTION = 'Get appConsent from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/appConsent.';
