 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/entitlementManagement.
 */
class MicrosoftEntraIdIdentityGovernanceGetEntitlementManagement extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_get_entitlement_management';
    protected const DESCRIPTION = 'Get entitlementManagement from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/entitlementManagement.';
