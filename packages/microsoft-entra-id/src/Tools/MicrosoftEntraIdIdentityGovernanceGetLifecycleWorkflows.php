 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows.
 */
class MicrosoftEntraIdIdentityGovernanceGetLifecycleWorkflows extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_get_lifecycle_workflows';
    protected const DESCRIPTION = 'Get lifecycleWorkflows from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows.';
