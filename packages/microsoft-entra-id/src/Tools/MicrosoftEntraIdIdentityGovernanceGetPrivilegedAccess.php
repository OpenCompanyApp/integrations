 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess.
 */
class MicrosoftEntraIdIdentityGovernanceGetPrivilegedAccess extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_get_privileged_access';
    protected const DESCRIPTION = 'Get privilegedAccess from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess.';
