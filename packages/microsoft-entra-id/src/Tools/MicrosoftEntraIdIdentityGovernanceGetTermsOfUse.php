 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse.
 */
class MicrosoftEntraIdIdentityGovernanceGetTermsOfUse extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_get_terms_of_use';
    protected const DESCRIPTION = 'Get termsOfUse from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/termsOfUse.';
