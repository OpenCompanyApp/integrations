 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance.
 */
class MicrosoftEntraIdIdentityGovernanceIdentityGovernanceGetIdentityGovernance extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_identity_governance_get_identity_governance';
    protected const DESCRIPTION = 'Get identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance.';
