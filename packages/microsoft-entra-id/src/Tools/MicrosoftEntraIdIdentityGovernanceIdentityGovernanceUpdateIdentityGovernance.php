 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance.
 */
class MicrosoftEntraIdIdentityGovernanceIdentityGovernanceUpdateIdentityGovernance extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_identity_governance_update_identity_governance';
    protected const DESCRIPTION = 'Update identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance.';
    ...
    protected const PATH = '/identityGovernance';
