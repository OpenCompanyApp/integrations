 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/lifecycleWorkflows/customTaskExtensions.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsCreateCustomTaskExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_create_custom_task_extensions';
    protected const DESCRIPTION = 'Create customTaskExtensions\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/lifecycleWorkflows/customTaskExtensions.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/customTaskExtensions';
