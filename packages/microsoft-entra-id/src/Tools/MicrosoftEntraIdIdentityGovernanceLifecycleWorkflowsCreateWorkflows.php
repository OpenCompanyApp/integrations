 ...
 * Create workflow.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/lifecycleWorkflows/workflows.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsCreateWorkflows extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_create_workflows';
    protected const DESCRIPTION = 'Create workflow\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/lifecycleWorkflows/workflows.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflows';
