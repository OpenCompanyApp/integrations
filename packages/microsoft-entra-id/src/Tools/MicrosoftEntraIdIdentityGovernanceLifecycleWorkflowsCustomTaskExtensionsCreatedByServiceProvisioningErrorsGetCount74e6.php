 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}/createdBy/serviceProvisioningErrors/$count.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsCustomTaskExtensionsCreatedByServiceProvisioningErrorsGetCount74e6 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_custom_task_extensions_created_by_service_provisioning_errors_get_count_74e6';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}/createdBy/serviceProvisioningErrors/$count';
