 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsDeleteCustomTaskExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_delete_custom_task_extensions';
    protected const DESCRIPTION = 'Delete customTaskExtension\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}';
