 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/lifecycleWorkflows/deletedItems.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsDeleteDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_delete_deleted_items';
    protected const DESCRIPTION = 'Delete navigation property deletedItems for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/lifecycleWorkflows/deletedItems.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/deletedItems';
