 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/deletedItems/workflows.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsDeletedItemsListWorkflows extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_deleted_items_list_workflows';
    protected const DESCRIPTION = 'List deletedItems (deleted lifecycle workflows)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/deletedItems/workflows.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/deletedItems/workflows';
