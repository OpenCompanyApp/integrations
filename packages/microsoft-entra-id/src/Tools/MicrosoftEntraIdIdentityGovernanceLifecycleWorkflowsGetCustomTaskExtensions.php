 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsGetCustomTaskExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_get_custom_task_extensions';
    protected const DESCRIPTION = 'Get customTaskExtension\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}.';
