 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/deletedItems.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsGetDeletedItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_get_deleted_items';
    protected const DESCRIPTION = 'Get deletedItems from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/deletedItems.';
