 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/customTaskExtensions.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsListCustomTaskExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_list_custom_task_extensions';
    protected const DESCRIPTION = 'List customTaskExtensions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/customTaskExtensions.';
