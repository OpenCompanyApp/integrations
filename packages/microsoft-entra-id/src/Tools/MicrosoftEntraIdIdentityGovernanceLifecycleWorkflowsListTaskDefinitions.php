 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/taskDefinitions.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsListTaskDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_list_task_definitions';
    protected const DESCRIPTION = 'List taskDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/taskDefinitions.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/taskDefinitions';
