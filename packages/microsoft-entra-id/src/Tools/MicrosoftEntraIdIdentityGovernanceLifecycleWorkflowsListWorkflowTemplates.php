 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/workflowTemplates.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsListWorkflowTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_list_workflow_templates';
    protected const DESCRIPTION = 'List workflowTemplates\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/workflowTemplates.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflowTemplates';
