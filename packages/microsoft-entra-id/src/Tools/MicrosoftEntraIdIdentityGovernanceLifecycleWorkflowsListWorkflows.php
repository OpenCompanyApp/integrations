 ...
 * List workflows.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/workflows.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsListWorkflows extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_list_workflows';
    protected const DESCRIPTION = 'List workflows\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/lifecycleWorkflows/workflows.';
