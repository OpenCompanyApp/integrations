 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/taskDefinitions/$count.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsTaskDefinitionsGetCount36f9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_task_definitions_get_count_36f9';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/taskDefinitions/$count';
