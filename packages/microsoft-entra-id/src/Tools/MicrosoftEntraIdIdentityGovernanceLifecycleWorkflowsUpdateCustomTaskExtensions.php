 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsUpdateCustomTaskExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_update_custom_task_extensions';
    protected const DESCRIPTION = 'Update customTaskExtension\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension-id}.';
