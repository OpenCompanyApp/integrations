 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/workflows/$count.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsWorkflowsGetCount02c2 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_workflows_get_count_02c2';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflows/$count';
