 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/runs/{run-id}/userProcessingResults/{userProcessingResult-id}/taskProcessingResults.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsWorkflowsRunsUserProcessingResultsListTaskProcessingResults extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_workflows_runs_user_processing_results_list_task_processing_results';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/runs/{run-id}/userProcessingResults/{userProcessingResult-id}/taskProcessingResults';
