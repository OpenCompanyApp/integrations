 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/versions/{workflowVersion-versionNumber}/tasks/{task-id}.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsWorkflowsVersionsUpdateTasks extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_workflows_versions_update_tasks';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/versions/{workflowVersion-versionNumber}/tasks/{task-id}';
