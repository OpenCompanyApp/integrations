 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/runs/{run-id}/userProcessingResults/{userProcessingResult-id}/taskProcessingResults/{taskProcessingResult-id}/microsoft.graph.identityGovernance.resume.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsWorkflowsWorkflowRunsRunUserProcessingResultsUserProcessingResultTaskProcessingResultsTaskProcessingResultResume extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_workflows_workflow_runs_run_user_processing_results_user_processing_result_task_processing_results_task_processing_result_resume';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/runs/{run-id}/userProcessingResults/{userProcessingResult-id}/taskProcessingResults/{taskProcessingResult-id}/microsoft.graph.identityGovernance.resume';
