 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/taskReports/{taskReport-id}/taskProcessingResults/{taskProcessingResult-id}/microsoft.graph.identityGovernance.resume.
 */
class MicrosoftEntraIdIdentityGovernanceLifecycleWorkflowsWorkflowsWorkflowTaskReportsTaskReportTaskProcessingResultsTaskProcessingResultResume extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_lifecycle_workflows_workflows_workflow_task_reports_task_report_task_processing_results_task_processing_result_resume';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows/workflows/{workflow-id}/taskReports/{taskReport-id}/taskProcessingResults/{taskProcessingResult-id}/microsoft.graph.identityGovernance.resume';
