 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/privilegedAccess/group.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessDeleteGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_delete_group';
    protected const DESCRIPTION = 'Delete navigation property group for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/privilegedAccess/group.';
