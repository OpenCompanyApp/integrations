 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}/stages.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupAssignmentApprovalsCreateStages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_assignment_approvals_create_stages';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}/stages';
