 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentApprovals/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupAssignmentApprovalsFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_assignment_approvals_filter_by_current_user';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentApprovals/filterByCurrentUser(on=\'{on}\')';
