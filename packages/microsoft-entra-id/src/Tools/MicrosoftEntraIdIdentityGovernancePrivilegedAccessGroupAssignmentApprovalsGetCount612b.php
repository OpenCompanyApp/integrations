 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentApprovals/$count.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupAssignmentApprovalsGetCount612b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_assignment_approvals_get_count_612b';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentApprovals/$count';
