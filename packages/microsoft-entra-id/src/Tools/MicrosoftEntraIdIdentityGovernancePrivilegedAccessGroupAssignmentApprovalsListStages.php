 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}/stages.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupAssignmentApprovalsListStages extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_assignment_approvals_list_stages';
