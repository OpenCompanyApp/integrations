 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentScheduleInstances/$count.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupAssignmentScheduleInstancesGetCount8aba extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_assignment_schedule_instances_get_count_8aba';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/$count';
