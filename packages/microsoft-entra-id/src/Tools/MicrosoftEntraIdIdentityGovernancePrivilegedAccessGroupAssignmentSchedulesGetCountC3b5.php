 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentSchedules/$count.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupAssignmentSchedulesGetCountC3b5 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_assignment_schedules_get_count_c3b5';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentSchedules/$count';
