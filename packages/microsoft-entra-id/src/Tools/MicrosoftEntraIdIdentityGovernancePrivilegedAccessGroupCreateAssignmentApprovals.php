 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/assignmentApprovals.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_assignment_approvals';
    protected const DESCRIPTION = 'Create new navigation property to assignmentApprovals for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/assignmentApprovals.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentApprovals';
