 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/assignmentScheduleInstances.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateAssignmentScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_assignment_schedule_instances';
    protected const DESCRIPTION = 'Create new navigation property to assignmentScheduleInstances for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/assignmentScheduleInstances.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentScheduleInstances';
