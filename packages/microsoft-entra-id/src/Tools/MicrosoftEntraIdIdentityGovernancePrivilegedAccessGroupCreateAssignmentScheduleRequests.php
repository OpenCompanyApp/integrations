 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/assignmentScheduleRequests.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateAssignmentScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_assignment_schedule_requests';
    protected const DESCRIPTION = 'Create assignmentScheduleRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/assignmentScheduleRequests.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentScheduleRequests';
