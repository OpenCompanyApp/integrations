 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/assignmentSchedules.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateAssignmentSchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_assignment_schedules';
    protected const DESCRIPTION = 'Create new navigation property to assignmentSchedules for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/assignmentSchedules.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentSchedules';
