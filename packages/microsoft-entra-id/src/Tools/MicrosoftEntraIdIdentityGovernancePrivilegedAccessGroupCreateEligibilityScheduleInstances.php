 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/eligibilityScheduleInstances.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateEligibilityScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_eligibility_schedule_instances';
    protected const DESCRIPTION = 'Create new navigation property to eligibilityScheduleInstances for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/eligibilityScheduleInstances.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/eligibilityScheduleInstances';
