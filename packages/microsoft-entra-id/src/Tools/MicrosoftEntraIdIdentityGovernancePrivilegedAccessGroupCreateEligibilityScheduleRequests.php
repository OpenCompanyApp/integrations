 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_eligibility_schedule_requests';
    protected const DESCRIPTION = 'Create eligibilityScheduleRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests';
