 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/privilegedAccess/group/eligibilitySchedules.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupCreateEligibilitySchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_create_eligibility_schedules';
    protected const DESCRIPTION = 'Create new navigation property to eligibilitySchedules for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/privilegedAccess/group/eligibilitySchedules.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/eligibilitySchedules';
