 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupDeleteAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_delete_assignment_approvals';
    protected const DESCRIPTION = 'Delete navigation property assignmentApprovals for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}.';
