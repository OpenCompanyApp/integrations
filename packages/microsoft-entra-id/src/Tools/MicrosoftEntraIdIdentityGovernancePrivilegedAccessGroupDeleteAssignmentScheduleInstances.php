 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupDeleteAssignmentScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_delete_assignment_schedule_instances';
    protected const DESCRIPTION = 'Delete navigation property assignmentScheduleInstances for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance-id}.';
