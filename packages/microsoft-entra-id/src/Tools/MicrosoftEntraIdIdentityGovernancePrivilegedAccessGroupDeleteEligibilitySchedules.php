 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/privilegedAccess/group/eligibilitySchedules/{privilegedAccessGroupEligibilitySchedule-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupDeleteEligibilitySchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_delete_eligibility_schedules';
    protected const DESCRIPTION = 'Delete navigation property eligibilitySchedules for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/privilegedAccess/group/eligibilitySchedules/{privilegedAccessGroupEligibilitySchedule-id}.';
