 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/$count.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequestsGetCountE631 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_eligibility_schedule_requests_get_count_e631';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/$count';
