 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupGetAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_get_assignment_approvals';
    protected const DESCRIPTION = 'Get assignmentApprovals from identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}.';
