 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/eligibilitySchedules/{privilegedAccessGroupEligibilitySchedule-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupGetEligibilitySchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_get_eligibility_schedules';
    protected const DESCRIPTION = 'Get privilegedAccessGroupEligibilitySchedule\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/eligibilitySchedules/{privilegedAccessGroupEligibilitySchedule-id}.';
