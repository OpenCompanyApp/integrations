 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentScheduleInstances.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupListAssignmentScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_list_assignment_schedule_instances';
    protected const DESCRIPTION = 'List assignmentScheduleInstances\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/assignmentScheduleInstances.';
