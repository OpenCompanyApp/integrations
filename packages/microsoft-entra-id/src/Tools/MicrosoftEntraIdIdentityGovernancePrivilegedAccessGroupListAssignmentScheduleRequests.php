 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentScheduleRequests.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupListAssignmentScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_list_assignment_schedule_requests';
    protected const DESCRIPTION = 'List assignmentScheduleRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/assignmentScheduleRequests.';
