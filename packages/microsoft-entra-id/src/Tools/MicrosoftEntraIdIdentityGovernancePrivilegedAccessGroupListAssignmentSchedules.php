 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/assignmentSchedules.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupListAssignmentSchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_list_assignment_schedules';
    protected const DESCRIPTION = 'List assignmentSchedules\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/assignmentSchedules.';
