 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/eligibilityScheduleInstances.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupListEligibilityScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_list_eligibility_schedule_instances';
    protected const DESCRIPTION = 'List eligibilityScheduleInstances\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/eligibilityScheduleInstances.';
