 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupListEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_list_eligibility_schedule_requests';
    protected const DESCRIPTION = 'List eligibilityScheduleRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests.';
