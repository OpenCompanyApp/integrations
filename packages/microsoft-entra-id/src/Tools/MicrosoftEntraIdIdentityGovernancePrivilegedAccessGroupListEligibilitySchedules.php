 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/privilegedAccess/group/eligibilitySchedules.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupListEligibilitySchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_list_eligibility_schedules';
    protected const DESCRIPTION = 'List eligibilitySchedules\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/privilegedAccess/group/eligibilitySchedules.';
