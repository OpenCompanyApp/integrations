 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupUpdateAssignmentApprovals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_update_assignment_approvals';
    protected const DESCRIPTION = 'Update the navigation property assignmentApprovals in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval-id}';
