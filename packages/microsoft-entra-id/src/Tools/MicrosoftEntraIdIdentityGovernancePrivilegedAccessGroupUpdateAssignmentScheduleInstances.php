 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupUpdateAssignmentScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_update_assignment_schedule_instances';
    protected const DESCRIPTION = 'Update the navigation property assignmentScheduleInstances in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance-id}.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance-id}';
