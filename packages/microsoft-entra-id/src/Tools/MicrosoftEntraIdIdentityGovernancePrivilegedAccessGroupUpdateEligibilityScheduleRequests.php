 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest-id}.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessGroupUpdateEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_group_update_eligibility_schedule_requests';
    protected const DESCRIPTION = 'Update the navigation property eligibilityScheduleRequests in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest-id}.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests/{privilegedAccessGroupEligibilityScheduleRequest-id}';
