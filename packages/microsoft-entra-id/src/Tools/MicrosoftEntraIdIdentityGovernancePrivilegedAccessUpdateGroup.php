 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/privilegedAccess/group.
 */
class MicrosoftEntraIdIdentityGovernancePrivilegedAccessUpdateGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_privileged_access_update_group';
    protected const DESCRIPTION = 'Update the navigation property group in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/privilegedAccess/group.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess/group';
