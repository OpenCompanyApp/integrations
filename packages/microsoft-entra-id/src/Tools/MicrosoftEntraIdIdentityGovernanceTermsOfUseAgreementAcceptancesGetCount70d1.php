 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse/agreementAcceptances/$count.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementAcceptancesGetCount70d1 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreement_acceptances_get_count_70d1';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreementAcceptances/$count';
