 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsDeleteFiles extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_delete_files';
    protected const DESCRIPTION = 'Delete navigation property files for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}.';
