 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFileDeleteLocalizations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_file_delete_localizations';
    protected const DESCRIPTION = 'Delete navigation property localizations for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}.';
