 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFileLocalizationsCreateVersions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_file_localizations_create_versions';
    protected const DESCRIPTION = 'Create new navigation property to versions for identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions.';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions';
