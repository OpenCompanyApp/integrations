 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions/{agreementFileVersion-id}.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFileLocalizationsUpdateVersions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_file_localizations_update_versions';
