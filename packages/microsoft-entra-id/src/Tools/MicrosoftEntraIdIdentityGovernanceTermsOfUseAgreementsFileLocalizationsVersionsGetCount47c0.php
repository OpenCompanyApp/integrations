 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions/$count.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFileLocalizationsVersionsGetCount47c0 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_file_localizations_versions_get_count_47c0';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions/$count';
