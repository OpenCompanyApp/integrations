 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFilesCreateVersions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_files_create_versions';
