 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions/{agreementFileVersion-id}.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFilesDeleteVersions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_files_delete_versions';
