 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions/$count.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsFilesVersionsGetCount9b3e extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_files_versions_get_count_9b3e';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions/$count';
