 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse/agreements/$count.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsGetCount7fcc extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_get_count_7fcc';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreements/$count';
