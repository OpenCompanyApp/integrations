 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseAgreementsUpdateFiles extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_agreements_update_files';
    protected const DESCRIPTION = 'Update the navigation property files in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}.';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreements/{agreement-id}/files/{agreementFileLocalization-id}';
