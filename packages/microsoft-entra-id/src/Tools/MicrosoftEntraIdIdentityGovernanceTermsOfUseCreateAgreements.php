 ...
 * Create agreement.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityGovernance/termsOfUse/agreements.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseCreateAgreements extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_create_agreements';
    protected const DESCRIPTION = 'Create agreement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityGovernance/termsOfUse/agreements.';
    ...
    protected const PATH = '/identityGovernance/termsOfUse/agreements';
