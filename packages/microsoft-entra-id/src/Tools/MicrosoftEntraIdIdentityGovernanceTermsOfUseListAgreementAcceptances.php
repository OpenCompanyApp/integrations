 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse/agreementAcceptances.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseListAgreementAcceptances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_list_agreement_acceptances';
