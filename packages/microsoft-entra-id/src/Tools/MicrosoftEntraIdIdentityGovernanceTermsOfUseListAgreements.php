 ...
 * List agreements.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityGovernance/termsOfUse/agreements.
 */
class MicrosoftEntraIdIdentityGovernanceTermsOfUseListAgreements extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_terms_of_use_list_agreements';
    protected const DESCRIPTION = 'List agreements\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityGovernance/termsOfUse/agreements.';
