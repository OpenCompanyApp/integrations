 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/accessReviews.
 */
class MicrosoftEntraIdIdentityGovernanceUpdateAccessReviews extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_update_access_reviews';
    protected const DESCRIPTION = 'Update the navigation property accessReviews in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/accessReviews.';
    ...
    protected const PATH = '/identityGovernance/accessReviews';
