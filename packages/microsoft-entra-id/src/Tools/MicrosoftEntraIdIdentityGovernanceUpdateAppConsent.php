 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/appConsent.
 */
class MicrosoftEntraIdIdentityGovernanceUpdateAppConsent extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_update_app_consent';
    protected const DESCRIPTION = 'Update the navigation property appConsent in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/appConsent.';
    ...
    protected const PATH = '/identityGovernance/appConsent';
