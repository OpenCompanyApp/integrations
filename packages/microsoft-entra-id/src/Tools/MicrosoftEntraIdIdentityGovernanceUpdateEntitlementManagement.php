 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/entitlementManagement.
 */
class MicrosoftEntraIdIdentityGovernanceUpdateEntitlementManagement extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_update_entitlement_management';
    protected const DESCRIPTION = 'Update the navigation property entitlementManagement in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/entitlementManagement.';
    ...
    protected const PATH = '/identityGovernance/entitlementManagement';
