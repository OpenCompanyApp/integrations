 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/lifecycleWorkflows.
 */
class MicrosoftEntraIdIdentityGovernanceUpdateLifecycleWorkflows extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_update_lifecycle_workflows';
    protected const DESCRIPTION = 'Update the navigation property lifecycleWorkflows in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/lifecycleWorkflows.';
    ...
    protected const PATH = '/identityGovernance/lifecycleWorkflows';
