 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/privilegedAccess.
 */
class MicrosoftEntraIdIdentityGovernanceUpdatePrivilegedAccess extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_update_privileged_access';
    protected const DESCRIPTION = 'Update the navigation property privilegedAccess in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/privilegedAccess.';
    ...
    protected const PATH = '/identityGovernance/privilegedAccess';
