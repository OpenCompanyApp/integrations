 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityGovernance/termsOfUse.
 */
class MicrosoftEntraIdIdentityGovernanceUpdateTermsOfUse extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_governance_update_terms_of_use';
    protected const DESCRIPTION = 'Update the navigation property termsOfUse in identityGovernance\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityGovernance/termsOfUse.';
    ...
    protected const PATH = '/identityGovernance/termsOfUse';
