 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskDetections.
 */
class MicrosoftEntraIdIdentityProtectionCreateRiskDetections extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_create_risk_detections';
    protected const DESCRIPTION = 'Create new navigation property to riskDetections for identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/riskDetections.';
    ...
    protected const PATH = '/identityProtection/riskDetections';
