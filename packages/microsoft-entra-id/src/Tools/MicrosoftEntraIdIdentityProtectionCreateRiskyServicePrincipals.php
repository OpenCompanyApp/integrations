 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyServicePrincipals.
 */
class MicrosoftEntraIdIdentityProtectionCreateRiskyServicePrincipals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_create_risky_service_principals';
    protected const DESCRIPTION = 'Create new navigation property to riskyServicePrincipals for identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/riskyServicePrincipals.';
    ...
    protected const PATH = '/identityProtection/riskyServicePrincipals';
