 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyUsers.
 */
class MicrosoftEntraIdIdentityProtectionCreateRiskyUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_create_risky_users';
    protected const DESCRIPTION = 'Create new navigation property to riskyUsers for identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/riskyUsers.';
    ...
    protected const PATH = '/identityProtection/riskyUsers';
