 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/servicePrincipalRiskDetections.
 */
class MicrosoftEntraIdIdentityProtectionCreateServicePrincipalRiskDetections extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_create_service_principal_risk_detections';
    protected const DESCRIPTION = 'Create new navigation property to servicePrincipalRiskDetections for identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/servicePrincipalRiskDetections.';
    ...
    protected const PATH = '/identityProtection/servicePrincipalRiskDetections';
