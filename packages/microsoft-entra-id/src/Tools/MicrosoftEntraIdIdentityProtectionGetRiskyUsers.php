 ...
 * Get riskyUser.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyUsers/{riskyUser-id}.
 */
class MicrosoftEntraIdIdentityProtectionGetRiskyUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_get_risky_users';
    protected const DESCRIPTION = 'Get riskyUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/riskyUsers/{riskyUser-id}.';
