 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection.
 */
class MicrosoftEntraIdIdentityProtectionIdentityProtectionRootGetIdentityProtectionRoot extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_identity_protection_root_get_identity_protection_root';
    protected const DESCRIPTION = 'Get identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection.';
