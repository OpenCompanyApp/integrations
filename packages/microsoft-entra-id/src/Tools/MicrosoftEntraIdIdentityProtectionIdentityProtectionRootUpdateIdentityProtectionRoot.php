 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityProtection.
 */
class MicrosoftEntraIdIdentityProtectionIdentityProtectionRootUpdateIdentityProtectionRoot extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_identity_protection_root_update_identity_protection_root';
    protected const DESCRIPTION = 'Update identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityProtection.';
    ...
    protected const PATH = '/identityProtection';
