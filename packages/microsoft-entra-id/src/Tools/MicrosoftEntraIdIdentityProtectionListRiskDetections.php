 ...
 * List riskDetections.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskDetections.
 */
class MicrosoftEntraIdIdentityProtectionListRiskDetections extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_list_risk_detections';
    protected const DESCRIPTION = 'List riskDetections\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/riskDetections.';
