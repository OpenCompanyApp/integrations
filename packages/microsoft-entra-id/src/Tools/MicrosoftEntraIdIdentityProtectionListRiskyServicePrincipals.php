 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyServicePrincipals.
 */
class MicrosoftEntraIdIdentityProtectionListRiskyServicePrincipals extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_list_risky_service_principals';
    protected const DESCRIPTION = 'List riskyServicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/riskyServicePrincipals.';
