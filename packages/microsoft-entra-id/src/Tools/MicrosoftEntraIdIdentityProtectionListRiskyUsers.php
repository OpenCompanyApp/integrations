 ...
 * List riskyUsers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyUsers.
 */
class MicrosoftEntraIdIdentityProtectionListRiskyUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_list_risky_users';
    protected const DESCRIPTION = 'List riskyUsers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/riskyUsers.';
