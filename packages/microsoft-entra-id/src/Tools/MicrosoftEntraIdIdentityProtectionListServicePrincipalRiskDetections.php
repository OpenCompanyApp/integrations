 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/servicePrincipalRiskDetections.
 */
class MicrosoftEntraIdIdentityProtectionListServicePrincipalRiskDetections extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_list_service_principal_risk_detections';
    protected const DESCRIPTION = 'List servicePrincipalRiskDetections\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/servicePrincipalRiskDetections.';
