 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskDetections/$count.
 */
class MicrosoftEntraIdIdentityProtectionRiskDetectionsGetCountEe19 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risk_detections_get_count_ee19';
    ...
    protected const PATH = '/identityProtection/riskDetections/$count';
