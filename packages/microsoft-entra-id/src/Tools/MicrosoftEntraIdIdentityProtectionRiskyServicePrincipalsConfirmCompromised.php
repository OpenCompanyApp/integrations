 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyServicePrincipals/confirmCompromised.
 */
class MicrosoftEntraIdIdentityProtectionRiskyServicePrincipalsConfirmCompromised extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_service_principals_confirm_compromised';
    protected const DESCRIPTION = 'Invoke action confirmCompromised\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/riskyServicePrincipals/confirmCompromised.';
    ...
    protected const PATH = '/identityProtection/riskyServicePrincipals/confirmCompromised';
