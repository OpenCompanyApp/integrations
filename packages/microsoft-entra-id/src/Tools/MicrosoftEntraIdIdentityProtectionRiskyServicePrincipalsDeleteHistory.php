 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /identityProtection/riskyServicePrincipals/{riskyServicePrincipal-id}/history/{riskyServicePrincipalHistoryItem-id}.
 */
class MicrosoftEntraIdIdentityProtectionRiskyServicePrincipalsDeleteHistory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_service_principals_delete_history';
