 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyServicePrincipals/dismiss.
 */
class MicrosoftEntraIdIdentityProtectionRiskyServicePrincipalsDismiss extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_service_principals_dismiss';
    protected const DESCRIPTION = 'Invoke action dismiss\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/riskyServicePrincipals/dismiss.';
    ...
    protected const PATH = '/identityProtection/riskyServicePrincipals/dismiss';
