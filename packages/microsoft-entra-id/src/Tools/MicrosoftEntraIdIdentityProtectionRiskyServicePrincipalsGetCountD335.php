 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyServicePrincipals/$count.
 */
class MicrosoftEntraIdIdentityProtectionRiskyServicePrincipalsGetCountD335 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_service_principals_get_count_d335';
    ...
    protected const PATH = '/identityProtection/riskyServicePrincipals/$count';
