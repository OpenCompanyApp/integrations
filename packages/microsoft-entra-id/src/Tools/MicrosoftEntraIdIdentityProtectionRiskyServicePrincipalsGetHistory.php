 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyServicePrincipals/{riskyServicePrincipal-id}/history/{riskyServicePrincipalHistoryItem-id}.
 */
class MicrosoftEntraIdIdentityProtectionRiskyServicePrincipalsGetHistory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_service_principals_get_history';
    protected const DESCRIPTION = 'Get history from identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/riskyServicePrincipals/{riskyServicePrincipal-id}/history/{riskyServicePrincipalHistoryItem-id}.';
