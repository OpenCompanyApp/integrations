 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyUsers/confirmCompromised.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersConfirmCompromised extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_confirm_compromised';
    ...
    protected const PATH = '/identityProtection/riskyUsers/confirmCompromised';
