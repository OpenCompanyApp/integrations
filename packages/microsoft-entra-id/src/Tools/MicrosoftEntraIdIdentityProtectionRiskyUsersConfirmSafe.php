 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyUsers/confirmSafe.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersConfirmSafe extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_confirm_safe';
    protected const DESCRIPTION = 'Invoke action confirmSafe\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /identityProtection/riskyUsers/confirmSafe.';
    ...
    protected const PATH = '/identityProtection/riskyUsers/confirmSafe';
