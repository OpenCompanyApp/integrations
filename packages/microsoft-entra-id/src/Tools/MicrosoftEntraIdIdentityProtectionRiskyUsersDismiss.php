 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /identityProtection/riskyUsers/dismiss.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersDismiss extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_dismiss';
    ...
    protected const PATH = '/identityProtection/riskyUsers/dismiss';
