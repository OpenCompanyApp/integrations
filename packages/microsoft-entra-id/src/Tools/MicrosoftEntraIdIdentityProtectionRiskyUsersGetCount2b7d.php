 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyUsers/$count.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersGetCount2b7d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_get_count_2b7d';
    ...
    protected const PATH = '/identityProtection/riskyUsers/$count';
