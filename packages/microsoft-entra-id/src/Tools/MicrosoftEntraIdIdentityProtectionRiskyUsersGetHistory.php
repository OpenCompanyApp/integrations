 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyUsers/{riskyUser-id}/history/{riskyUserHistoryItem-id}.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersGetHistory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_get_history';
