 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyUsers/{riskyUser-id}/history/$count.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersHistoryGetCount33a2 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_history_get_count_33a2';
    ...
    protected const PATH = '/identityProtection/riskyUsers/{riskyUser-id}/history/$count';
