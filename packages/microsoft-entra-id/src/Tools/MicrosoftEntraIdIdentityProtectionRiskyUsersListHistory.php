 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/riskyUsers/{riskyUser-id}/history.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersListHistory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_list_history';
    protected const DESCRIPTION = 'List history of riskyUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /identityProtection/riskyUsers/{riskyUser-id}/history.';
