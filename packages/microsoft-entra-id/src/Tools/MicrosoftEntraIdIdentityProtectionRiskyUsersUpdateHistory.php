 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityProtection/riskyUsers/{riskyUser-id}/history/{riskyUserHistoryItem-id}.
 */
class MicrosoftEntraIdIdentityProtectionRiskyUsersUpdateHistory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_risky_users_update_history';
