 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /identityProtection/servicePrincipalRiskDetections/$count.
 */
class MicrosoftEntraIdIdentityProtectionServicePrincipalRiskDetectionsGetCount1bc5 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_service_principal_risk_detections_get_count_1bc5';
    ...
    protected const PATH = '/identityProtection/servicePrincipalRiskDetections/$count';
