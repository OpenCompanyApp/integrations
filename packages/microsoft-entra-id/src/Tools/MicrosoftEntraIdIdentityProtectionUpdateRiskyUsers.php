 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /identityProtection/riskyUsers/{riskyUser-id}.
 */
class MicrosoftEntraIdIdentityProtectionUpdateRiskyUsers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_identity_protection_update_risky_users';
    protected const DESCRIPTION = 'Update the navigation property riskyUsers in identityProtection\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /identityProtection/riskyUsers/{riskyUser-id}.';
