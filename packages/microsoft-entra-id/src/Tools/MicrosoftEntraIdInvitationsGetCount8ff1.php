 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/$count.
 */
class MicrosoftEntraIdInvitationsGetCount8ff1 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_get_count_8ff1';
    ...
    protected const PATH = '/invitations/$count';
