 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/invitedUser.
 */
class MicrosoftEntraIdInvitationsGetInvitedUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_get_invited_user';
    protected const DESCRIPTION = 'Get invitedUser from invitations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /invitations/invitedUser.';
    ...
    protected const PATH = '/invitations/invitedUser';
