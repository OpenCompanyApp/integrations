 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/invitedUserSponsors/{directoryObject-id}.
 */
class MicrosoftEntraIdInvitationsGetInvitedUserSponsors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_get_invited_user_sponsors';
    protected const DESCRIPTION = 'Get invitedUserSponsors from invitations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /invitations/invitedUserSponsors/{directoryObject-id}.';
    ...
    protected const PATH = '/invitations/invitedUserSponsors/{directoryObject-id}';
