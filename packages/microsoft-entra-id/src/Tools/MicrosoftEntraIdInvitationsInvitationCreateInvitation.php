 ...
 * Create invitation.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /invitations.
 */
class MicrosoftEntraIdInvitationsInvitationCreateInvitation extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_invitation_create_invitation';
    protected const DESCRIPTION = 'Create invitation\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /invitations.';
