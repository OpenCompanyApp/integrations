 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations.
 */
class MicrosoftEntraIdInvitationsInvitationListInvitation extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_invitation_list_invitation';
    protected const DESCRIPTION = 'Get entities from invitations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /invitations.';
