 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/invitedUser/serviceProvisioningErrors.
 */
class MicrosoftEntraIdInvitationsInvitedUserListServiceProvisioningErrors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_invited_user_list_service_provisioning_errors';
    ...
    protected const PATH = '/invitations/invitedUser/serviceProvisioningErrors';
