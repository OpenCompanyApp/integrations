 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/invitedUser/serviceProvisioningErrors/$count.
 */
class MicrosoftEntraIdInvitationsInvitedUserServiceProvisioningErrorsGetCountDf29 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_invited_user_service_provisioning_errors_get_count_df29';
    ...
    protected const PATH = '/invitations/invitedUser/serviceProvisioningErrors/$count';
