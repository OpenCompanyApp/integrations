 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/invitedUserSponsors/$count.
 */
class MicrosoftEntraIdInvitationsInvitedUserSponsorsGetCount648d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_invited_user_sponsors_get_count_648d';
    ...
    protected const PATH = '/invitations/invitedUserSponsors/$count';
