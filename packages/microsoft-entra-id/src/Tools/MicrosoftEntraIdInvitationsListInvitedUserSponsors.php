 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /invitations/invitedUserSponsors.
 */
class MicrosoftEntraIdInvitationsListInvitedUserSponsors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_invitations_list_invited_user_sponsors';
    ...
    protected const PATH = '/invitations/invitedUserSponsors';
