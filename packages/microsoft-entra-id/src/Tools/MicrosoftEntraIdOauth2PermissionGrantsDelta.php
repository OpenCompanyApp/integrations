 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /oauth2PermissionGrants/delta().
 */
class MicrosoftEntraIdOauth2PermissionGrantsDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_oauth2_permission_grants_delta';
    ...
    protected const PATH = '/oauth2PermissionGrants/delta()';
