 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /oauth2PermissionGrants/$count.
 */
class MicrosoftEntraIdOauth2PermissionGrantsGetCount8287 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_oauth2_permission_grants_get_count_8287';
    ...
    protected const PATH = '/oauth2PermissionGrants/$count';
