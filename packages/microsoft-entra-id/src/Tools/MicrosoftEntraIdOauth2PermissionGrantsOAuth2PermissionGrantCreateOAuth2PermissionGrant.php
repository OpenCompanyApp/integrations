 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /oauth2PermissionGrants.
 */
class MicrosoftEntraIdOauth2PermissionGrantsOAuth2PermissionGrantCreateOAuth2PermissionGrant extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_oauth2_permission_grants_o_auth2_permission_grant_create_oauth2_permission_grant';
    protected const DESCRIPTION = 'Create oAuth2PermissionGrant (a delegated permission grant)\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /oauth2PermissionGrants.';
    ...
    protected const PATH = '/oauth2PermissionGrants';
