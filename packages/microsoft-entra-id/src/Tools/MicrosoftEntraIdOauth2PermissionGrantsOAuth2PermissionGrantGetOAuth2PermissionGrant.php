 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /oauth2PermissionGrants/{oAuth2PermissionGrant-id}.
 */
class MicrosoftEntraIdOauth2PermissionGrantsOAuth2PermissionGrantGetOAuth2PermissionGrant extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_oauth2_permission_grants_o_auth2_permission_grant_get_oauth2_permission_grant';
    protected const DESCRIPTION = 'Get oAuth2PermissionGrant (a delegated permission grant)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /oauth2PermissionGrants/{oAuth2PermissionGrant-id}.';
