 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /oauth2PermissionGrants.
 */
class MicrosoftEntraIdOauth2PermissionGrantsOAuth2PermissionGrantListOAuth2PermissionGrant extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_oauth2_permission_grants_o_auth2_permission_grant_list_oauth2_permission_grant';
    protected const DESCRIPTION = 'List oauth2PermissionGrants (delegated permission grants)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /oauth2PermissionGrants.';
