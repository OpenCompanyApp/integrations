 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /oauth2PermissionGrants/{oAuth2PermissionGrant-id}.
 */
class MicrosoftEntraIdOauth2PermissionGrantsOAuth2PermissionGrantUpdateOAuth2PermissionGrant extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_oauth2_permission_grants_o_auth2_permission_grant_update_oauth2_permission_grant';
    protected const DESCRIPTION = 'Update a delegated permission grant (oAuth2PermissionGrant)\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /oauth2PermissionGrants/{oAuth2PermissionGrant-id}.';
