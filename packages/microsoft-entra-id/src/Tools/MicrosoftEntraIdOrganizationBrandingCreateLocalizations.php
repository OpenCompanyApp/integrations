 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/branding/localizations.
 */
class MicrosoftEntraIdOrganizationBrandingCreateLocalizations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_create_localizations';
    protected const DESCRIPTION = 'Create organizationalBrandingLocalization\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /organization/{organization-id}/branding/localizations.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/localizations';
