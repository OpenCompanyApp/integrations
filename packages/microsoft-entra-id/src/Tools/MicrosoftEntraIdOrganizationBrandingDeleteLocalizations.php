 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}.
 */
class MicrosoftEntraIdOrganizationBrandingDeleteLocalizations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_delete_localizations';
    protected const DESCRIPTION = 'Delete organizationalBrandingLocalization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}.';
