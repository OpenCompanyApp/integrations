 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/backgroundImage.
 */
class MicrosoftEntraIdOrganizationBrandingDeleteLocalizationsBackgroundImage extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_delete_localizations_background_image';
    protected const DESCRIPTION = 'Delete backgroundImage for the navigation property localizations in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/backgroundImage.';
