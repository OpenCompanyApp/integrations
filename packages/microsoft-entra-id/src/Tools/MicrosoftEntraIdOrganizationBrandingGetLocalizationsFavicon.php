 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/favicon.
 */
class MicrosoftEntraIdOrganizationBrandingGetLocalizationsFavicon extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_get_localizations_favicon';
    protected const DESCRIPTION = 'Get favicon for the navigation property localizations from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/favicon.';
