 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/headerLogo.
 */
class MicrosoftEntraIdOrganizationBrandingGetLocalizationsHeaderLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_get_localizations_header_logo';
    protected const DESCRIPTION = 'Get headerLogo for the navigation property localizations from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/headerLogo.';
