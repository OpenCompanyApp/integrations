 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/squareLogo.
 */
class MicrosoftEntraIdOrganizationBrandingGetLocalizationsSquareLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_get_localizations_square_logo';
    protected const DESCRIPTION = 'Get squareLogo for the navigation property localizations from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/squareLogo.';
