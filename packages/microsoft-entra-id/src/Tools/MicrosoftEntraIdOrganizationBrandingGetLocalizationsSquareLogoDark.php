 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/squareLogoDark.
 */
class MicrosoftEntraIdOrganizationBrandingGetLocalizationsSquareLogoDark extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_get_localizations_square_logo_dark';
    protected const DESCRIPTION = 'Get squareLogoDark for the navigation property localizations from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/squareLogoDark.';
