 ...
 * List localizations.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/localizations.
 */
class MicrosoftEntraIdOrganizationBrandingListLocalizations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_list_localizations';
    protected const DESCRIPTION = 'List localizations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/localizations.';
