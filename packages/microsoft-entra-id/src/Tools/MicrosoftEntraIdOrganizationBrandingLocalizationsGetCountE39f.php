 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/localizations/$count.
 */
class MicrosoftEntraIdOrganizationBrandingLocalizationsGetCountE39f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_localizations_get_count_e39f';
    ...
    protected const PATH = '/organization/{organization-id}/branding/localizations/$count';
