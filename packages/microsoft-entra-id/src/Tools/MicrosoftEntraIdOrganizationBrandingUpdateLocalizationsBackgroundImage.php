 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/backgroundImage.
 */
class MicrosoftEntraIdOrganizationBrandingUpdateLocalizationsBackgroundImage extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_update_localizations_background_image';
    protected const DESCRIPTION = 'Update backgroundImage for the navigation property localizations in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/backgroundImage.';
