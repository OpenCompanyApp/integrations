 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/bannerLogo.
 */
class MicrosoftEntraIdOrganizationBrandingUpdateLocalizationsBannerLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_update_localizations_banner_logo';
    protected const DESCRIPTION = 'Update organizationalBrandingLocalization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/bannerLogo.';
