 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/headerLogo.
 */
class MicrosoftEntraIdOrganizationBrandingUpdateLocalizationsHeaderLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_branding_update_localizations_header_logo';
    protected const DESCRIPTION = 'Update headerLogo for the navigation property localizations in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/headerLogo.';
