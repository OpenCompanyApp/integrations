 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/certificateBasedAuthConfiguration/$count.
 */
class MicrosoftEntraIdOrganizationCertificateBasedAuthConfigurationGetCount8262 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_certificate_based_auth_configuration_get_count_8262';
    ...
    protected const PATH = '/organization/{organization-id}/certificateBasedAuthConfiguration/$count';
