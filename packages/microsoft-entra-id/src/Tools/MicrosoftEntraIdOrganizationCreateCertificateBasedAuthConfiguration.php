 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/certificateBasedAuthConfiguration.
 */
class MicrosoftEntraIdOrganizationCreateCertificateBasedAuthConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_create_certificate_based_auth_configuration';
    protected const DESCRIPTION = 'Create certificateBasedAuthConfiguration\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /organization/{organization-id}/certificateBasedAuthConfiguration.';
    ...
    protected const PATH = '/organization/{organization-id}/certificateBasedAuthConfiguration';
