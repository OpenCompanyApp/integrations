 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/extensions.
 */
class MicrosoftEntraIdOrganizationCreateExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_create_extensions';
    protected const DESCRIPTION = 'Create new navigation property to extensions for organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /organization/{organization-id}/extensions.';
    ...
    protected const PATH = '/organization/{organization-id}/extensions';
