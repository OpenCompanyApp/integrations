 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding.
 */
class MicrosoftEntraIdOrganizationDeleteBranding extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding';
    protected const DESCRIPTION = 'Delete organizationalBranding\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding.';
    ...
    protected const PATH = '/organization/{organization-id}/branding';
