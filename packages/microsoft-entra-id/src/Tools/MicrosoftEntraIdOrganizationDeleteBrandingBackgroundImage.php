 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/backgroundImage.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingBackgroundImage extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_background_image';
    protected const DESCRIPTION = 'Delete backgroundImage for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/backgroundImage.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/backgroundImage';
