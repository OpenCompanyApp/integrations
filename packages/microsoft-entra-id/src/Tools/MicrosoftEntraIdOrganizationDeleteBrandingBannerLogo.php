 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/bannerLogo.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingBannerLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_banner_logo';
    protected const DESCRIPTION = 'Delete bannerLogo for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/bannerLogo.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/bannerLogo';
