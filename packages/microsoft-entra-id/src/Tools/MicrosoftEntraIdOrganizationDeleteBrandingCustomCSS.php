 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/customCSS.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingCustomCSS extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_custom_css';
    protected const DESCRIPTION = 'Delete customCSS for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/customCSS.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/customCSS';
