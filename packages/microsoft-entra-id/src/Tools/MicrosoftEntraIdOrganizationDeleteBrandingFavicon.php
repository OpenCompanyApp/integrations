 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/favicon.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingFavicon extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_favicon';
    protected const DESCRIPTION = 'Delete favicon for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/favicon.';
