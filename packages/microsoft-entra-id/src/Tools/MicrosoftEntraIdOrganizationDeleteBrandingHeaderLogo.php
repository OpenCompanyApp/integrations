 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/headerLogo.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingHeaderLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_header_logo';
    protected const DESCRIPTION = 'Delete headerLogo for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/headerLogo.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/headerLogo';
