 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/squareLogo.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingSquareLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_square_logo';
    protected const DESCRIPTION = 'Delete squareLogo for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/squareLogo.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/squareLogo';
