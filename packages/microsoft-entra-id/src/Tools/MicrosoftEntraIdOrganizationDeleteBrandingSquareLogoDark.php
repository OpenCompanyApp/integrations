 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}/branding/squareLogoDark.
 */
class MicrosoftEntraIdOrganizationDeleteBrandingSquareLogoDark extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delete_branding_square_logo_dark';
    protected const DESCRIPTION = 'Delete squareLogoDark for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}/branding/squareLogoDark.';
    ...
    protected const PATH = '/organization/{organization-id}/branding/squareLogoDark';
