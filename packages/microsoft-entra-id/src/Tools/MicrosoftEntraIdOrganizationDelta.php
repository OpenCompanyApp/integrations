 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/delta().
 */
class MicrosoftEntraIdOrganizationDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_delta';
    ...
    protected const PATH = '/organization/delta()';
