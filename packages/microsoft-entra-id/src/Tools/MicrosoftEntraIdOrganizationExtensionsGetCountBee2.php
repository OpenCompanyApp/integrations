 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/extensions/$count.
 */
class MicrosoftEntraIdOrganizationExtensionsGetCountBee2 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_extensions_get_count_bee2';
    ...
    protected const PATH = '/organization/{organization-id}/extensions/$count';
