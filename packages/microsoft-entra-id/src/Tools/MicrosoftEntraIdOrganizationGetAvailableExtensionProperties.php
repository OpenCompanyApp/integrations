 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdOrganizationGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_available_extension_properties';
    ...
    protected const PATH = '/organization/getAvailableExtensionProperties';
