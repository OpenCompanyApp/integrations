 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/backgroundImage.
 */
class MicrosoftEntraIdOrganizationGetBrandingBackgroundImage extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_branding_background_image';
    protected const DESCRIPTION = 'Get backgroundImage for the navigation property branding from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/backgroundImage.';
