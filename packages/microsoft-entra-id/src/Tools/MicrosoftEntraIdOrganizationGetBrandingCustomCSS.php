 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/customCSS.
 */
class MicrosoftEntraIdOrganizationGetBrandingCustomCSS extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_branding_custom_css';
    protected const DESCRIPTION = 'Get customCSS for the navigation property branding from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/customCSS.';
