 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/favicon.
 */
class MicrosoftEntraIdOrganizationGetBrandingFavicon extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_branding_favicon';
    protected const DESCRIPTION = 'Get favicon for the navigation property branding from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/favicon.';
