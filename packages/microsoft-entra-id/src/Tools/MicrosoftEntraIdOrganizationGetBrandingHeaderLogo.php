 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/headerLogo.
 */
class MicrosoftEntraIdOrganizationGetBrandingHeaderLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_branding_header_logo';
    protected const DESCRIPTION = 'Get headerLogo for the navigation property branding from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/headerLogo.';
