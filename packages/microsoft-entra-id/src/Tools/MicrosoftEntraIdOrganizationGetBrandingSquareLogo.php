 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/squareLogo.
 */
class MicrosoftEntraIdOrganizationGetBrandingSquareLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_branding_square_logo';
    protected const DESCRIPTION = 'Get squareLogo for the navigation property branding from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/squareLogo.';
