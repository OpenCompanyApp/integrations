 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/branding/squareLogoDark.
 */
class MicrosoftEntraIdOrganizationGetBrandingSquareLogoDark extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_branding_square_logo_dark';
    protected const DESCRIPTION = 'Get squareLogoDark for the navigation property branding from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/branding/squareLogoDark.';
