 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/getByIds.
 */
class MicrosoftEntraIdOrganizationGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_by_ids';
    ...
    protected const PATH = '/organization/getByIds';
