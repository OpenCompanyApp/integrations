 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration-id}.
 */
class MicrosoftEntraIdOrganizationGetCertificateBasedAuthConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_certificate_based_auth_configuration';
    protected const DESCRIPTION = 'Get certificateBasedAuthConfiguration\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration-id}.';
