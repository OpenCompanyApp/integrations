 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/$count.
 */
class MicrosoftEntraIdOrganizationGetCount9453 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_get_count_9453';
    ...
    protected const PATH = '/organization/$count';
