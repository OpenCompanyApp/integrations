 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/certificateBasedAuthConfiguration.
 */
class MicrosoftEntraIdOrganizationListCertificateBasedAuthConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_list_certificate_based_auth_configuration';
    protected const DESCRIPTION = 'List certificateBasedAuthConfigurations\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /organization/{organization-id}/certificateBasedAuthConfiguration.';
