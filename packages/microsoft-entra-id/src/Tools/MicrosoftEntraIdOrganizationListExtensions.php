 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}/extensions.
 */
class MicrosoftEntraIdOrganizationListExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_list_extensions';
