 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/checkMemberGroups.
 */
class MicrosoftEntraIdOrganizationOrganizationCheckMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_check_member_groups';
    ...
    protected const PATH = '/organization/{organization-id}/checkMemberGroups';
