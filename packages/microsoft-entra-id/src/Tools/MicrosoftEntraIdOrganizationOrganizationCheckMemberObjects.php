 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/checkMemberObjects.
 */
class MicrosoftEntraIdOrganizationOrganizationCheckMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_check_member_objects';
    ...
    protected const PATH = '/organization/{organization-id}/checkMemberObjects';
