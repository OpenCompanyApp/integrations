 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization.
 */
class MicrosoftEntraIdOrganizationOrganizationCreateOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_create_organization';
    protected const DESCRIPTION = 'Add new entity to organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /organization.';
    ...
    protected const PATH = '/organization';
