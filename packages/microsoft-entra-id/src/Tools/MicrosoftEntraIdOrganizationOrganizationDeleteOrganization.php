 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /organization/{organization-id}.
 */
class MicrosoftEntraIdOrganizationOrganizationDeleteOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_delete_organization';
    protected const DESCRIPTION = 'Delete entity from organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /organization/{organization-id}.';
    ...
    protected const PATH = '/organization/{organization-id}';
