 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/getMemberObjects.
 */
class MicrosoftEntraIdOrganizationOrganizationGetMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_get_member_objects';
    ...
    protected const PATH = '/organization/{organization-id}/getMemberObjects';
