 ...
 * Get organization.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization/{organization-id}.
 */
class MicrosoftEntraIdOrganizationOrganizationGetOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_get_organization';
