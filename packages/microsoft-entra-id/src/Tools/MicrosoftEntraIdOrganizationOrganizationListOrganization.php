 ...
 * List organizations.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /organization.
 */
class MicrosoftEntraIdOrganizationOrganizationListOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_list_organization';
