 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/{organization-id}/restore.
 */
class MicrosoftEntraIdOrganizationOrganizationRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_restore';
    ...
    protected const PATH = '/organization/{organization-id}/restore';
