 ...
 * Update organization.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /organization/{organization-id}.
 */
class MicrosoftEntraIdOrganizationOrganizationUpdateOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_organization_update_organization';
