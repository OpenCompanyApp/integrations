 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /organization/{organization-id}/branding.
 */
class MicrosoftEntraIdOrganizationUpdateBranding extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_update_branding';
    protected const DESCRIPTION = 'Update organizationalBranding\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /organization/{organization-id}/branding.';
