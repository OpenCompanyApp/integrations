 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/backgroundImage.
 */
class MicrosoftEntraIdOrganizationUpdateBrandingBackgroundImage extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_update_branding_background_image';
    protected const DESCRIPTION = 'Update backgroundImage for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/backgroundImage.';
