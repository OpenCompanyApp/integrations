 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/bannerLogo.
 */
class MicrosoftEntraIdOrganizationUpdateBrandingBannerLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_update_branding_banner_logo';
    protected const DESCRIPTION = 'Update bannerLogo for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/bannerLogo.';
