 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/customCSS.
 */
class MicrosoftEntraIdOrganizationUpdateBrandingCustomCSS extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_update_branding_custom_css';
    protected const DESCRIPTION = 'Update customCSS for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/customCSS.';
