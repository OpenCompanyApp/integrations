 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/headerLogo.
 */
class MicrosoftEntraIdOrganizationUpdateBrandingHeaderLogo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_update_branding_header_logo';
    protected const DESCRIPTION = 'Update headerLogo for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/headerLogo.';
