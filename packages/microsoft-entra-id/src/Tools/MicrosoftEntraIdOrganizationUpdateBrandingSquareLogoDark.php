 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /organization/{organization-id}/branding/squareLogoDark.
 */
class MicrosoftEntraIdOrganizationUpdateBrandingSquareLogoDark extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_update_branding_square_logo_dark';
    protected const DESCRIPTION = 'Update squareLogoDark for the navigation property branding in organization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /organization/{organization-id}/branding/squareLogoDark.';
