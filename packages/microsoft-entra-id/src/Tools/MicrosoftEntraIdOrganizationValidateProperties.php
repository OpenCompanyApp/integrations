 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /organization/validateProperties.
 */
class MicrosoftEntraIdOrganizationValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_organization_validate_properties';
    ...
    protected const PATH = '/organization/validateProperties';
