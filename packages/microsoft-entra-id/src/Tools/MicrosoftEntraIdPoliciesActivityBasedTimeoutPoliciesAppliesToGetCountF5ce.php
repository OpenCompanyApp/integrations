 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}/appliesTo/$count.
 */
class MicrosoftEntraIdPoliciesActivityBasedTimeoutPoliciesAppliesToGetCountF5ce extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_activity_based_timeout_policies_applies_to_get_count_f5ce';
    ...
    protected const PATH = '/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}/appliesTo/$count';
