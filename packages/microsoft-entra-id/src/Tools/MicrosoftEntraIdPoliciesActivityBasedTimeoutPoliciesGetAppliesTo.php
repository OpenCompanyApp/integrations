 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}/appliesTo/{directoryObject-id}.
 */
class MicrosoftEntraIdPoliciesActivityBasedTimeoutPoliciesGetAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_activity_based_timeout_policies_get_applies_to';
