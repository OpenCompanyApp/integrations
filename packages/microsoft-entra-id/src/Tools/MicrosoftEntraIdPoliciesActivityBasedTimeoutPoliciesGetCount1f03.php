 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/activityBasedTimeoutPolicies/$count.
 */
class MicrosoftEntraIdPoliciesActivityBasedTimeoutPoliciesGetCount1f03 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_activity_based_timeout_policies_get_count_1f03';
    ...
    protected const PATH = '/policies/activityBasedTimeoutPolicies/$count';
