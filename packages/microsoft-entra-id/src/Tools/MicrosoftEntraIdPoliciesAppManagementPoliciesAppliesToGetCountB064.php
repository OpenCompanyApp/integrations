 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo/$count.
 */
class MicrosoftEntraIdPoliciesAppManagementPoliciesAppliesToGetCountB064 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_app_management_policies_applies_to_get_count_b064';
    ...
    protected const PATH = '/policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo/$count';
