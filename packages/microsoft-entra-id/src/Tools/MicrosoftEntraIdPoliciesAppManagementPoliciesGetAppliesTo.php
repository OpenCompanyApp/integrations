 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo/{directoryObject-id}.
 */
class MicrosoftEntraIdPoliciesAppManagementPoliciesGetAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_app_management_policies_get_applies_to';
    ...
    protected const PATH = '/policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo/{directoryObject-id}';
    protected const PATH_PARAMS = ['appManagementPolicy-id' => 'app_management_policy_id', 'directoryObject-id' => 'directory_object_id'];
