 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/appManagementPolicies/$count.
 */
class MicrosoftEntraIdPoliciesAppManagementPoliciesGetCountC99e extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_app_management_policies_get_count_c99e';
    ...
    protected const PATH = '/policies/appManagementPolicies/$count';
