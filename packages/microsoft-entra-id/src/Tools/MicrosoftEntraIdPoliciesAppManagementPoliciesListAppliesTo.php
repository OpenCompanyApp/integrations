 ...
 * List appliesTo.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo.
 */
class MicrosoftEntraIdPoliciesAppManagementPoliciesListAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_app_management_policies_list_applies_to';
    ...
    protected const PATH = '/policies/appManagementPolicies/{appManagementPolicy-id}/appliesTo';
