 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationMethodsPolicy/authenticationMethodConfigurations/$count.
 */
class MicrosoftEntraIdPoliciesAuthenticationMethodsPolicyAuthenticationMethodConfigurationsGetCountE541 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_methods_policy_authentication_method_configurations_get_count_e541';
    ...
    protected const PATH = '/policies/authenticationMethodsPolicy/authenticationMethodConfigurations/$count';
