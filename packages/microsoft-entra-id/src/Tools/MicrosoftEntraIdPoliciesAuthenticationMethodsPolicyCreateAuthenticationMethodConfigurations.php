 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/authenticationMethodsPolicy/authenticationMethodConfigurations.
 */
class MicrosoftEntraIdPoliciesAuthenticationMethodsPolicyCreateAuthenticationMethodConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_methods_policy_create_authentication_method_configurations';
    protected const DESCRIPTION = 'Create new navigation property to authenticationMethodConfigurations for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/authenticationMethodsPolicy/authenticationMethodConfigurations.';
    ...
    protected const PATH = '/policies/authenticationMethodsPolicy/authenticationMethodConfigurations';
