 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationMethodsPolicy/authenticationMethodConfigurations.
 */
class MicrosoftEntraIdPoliciesAuthenticationMethodsPolicyListAuthenticationMethodConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_methods_policy_list_authentication_method_configurations';
