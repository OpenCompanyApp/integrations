 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/authenticationStrengthPolicies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.
 */
class MicrosoftEntraIdPoliciesAuthenticationStrengthPoliciesDeleteCombinationConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_strength_policies_delete_combination_configurations';
    protected const DESCRIPTION = 'Delete navigation property combinationConfigurations for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/authenticationStrengthPolicies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.';
