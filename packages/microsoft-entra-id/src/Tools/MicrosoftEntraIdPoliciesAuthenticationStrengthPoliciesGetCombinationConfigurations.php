 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationStrengthPolicies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.
 */
class MicrosoftEntraIdPoliciesAuthenticationStrengthPoliciesGetCombinationConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_strength_policies_get_combination_configurations';
