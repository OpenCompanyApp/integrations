 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationStrengthPolicies/$count.
 */
class MicrosoftEntraIdPoliciesAuthenticationStrengthPoliciesGetCountDb73 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_strength_policies_get_count_db73';
    ...
    protected const PATH = '/policies/authenticationStrengthPolicies/$count';
