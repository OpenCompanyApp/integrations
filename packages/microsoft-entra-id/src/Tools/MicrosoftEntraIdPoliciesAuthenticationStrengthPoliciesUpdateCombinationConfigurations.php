 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/authenticationStrengthPolicies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.
 */
class MicrosoftEntraIdPoliciesAuthenticationStrengthPoliciesUpdateCombinationConfigurations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_authentication_strength_policies_update_combination_configurations';
    protected const DESCRIPTION = 'Update the navigation property combinationConfigurations in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/authenticationStrengthPolicies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}.';
    ...
    protected const PATH = '/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy-id}/combinationConfigurations/{authenticationCombinationConfiguration-id}';
