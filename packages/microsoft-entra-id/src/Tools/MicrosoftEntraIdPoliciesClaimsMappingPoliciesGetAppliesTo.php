 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/claimsMappingPolicies/{claimsMappingPolicy-id}/appliesTo/{directoryObject-id}.
 */
class MicrosoftEntraIdPoliciesClaimsMappingPoliciesGetAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_claims_mapping_policies_get_applies_to';
