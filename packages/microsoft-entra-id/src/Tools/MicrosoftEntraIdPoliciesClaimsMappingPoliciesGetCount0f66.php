 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/claimsMappingPolicies/$count.
 */
class MicrosoftEntraIdPoliciesClaimsMappingPoliciesGetCount0f66 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_claims_mapping_policies_get_count_0f66';
    ...
    protected const PATH = '/policies/claimsMappingPolicies/$count';
