 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}/restore.
 */
class MicrosoftEntraIdPoliciesConditionalAccessPoliciesConditionalAccessPolicyRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_conditional_access_policies_conditional_access_policy_restore';
    ...
    protected const PATH = '/policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}/restore';
