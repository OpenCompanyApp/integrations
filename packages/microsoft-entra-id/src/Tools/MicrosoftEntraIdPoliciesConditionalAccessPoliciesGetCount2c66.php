 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/conditionalAccessPolicies/$count.
 */
class MicrosoftEntraIdPoliciesConditionalAccessPoliciesGetCount2c66 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_conditional_access_policies_get_count_2c66';
    ...
    protected const PATH = '/policies/conditionalAccessPolicies/$count';
