 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/activityBasedTimeoutPolicies.
 */
class MicrosoftEntraIdPoliciesCreateActivityBasedTimeoutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_activity_based_timeout_policies';
    protected const DESCRIPTION = 'Create activityBasedTimeoutPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/activityBasedTimeoutPolicies.';
    ...
    protected const PATH = '/policies/activityBasedTimeoutPolicies';
