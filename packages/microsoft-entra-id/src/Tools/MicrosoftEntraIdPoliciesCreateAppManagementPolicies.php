 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/appManagementPolicies.
 */
class MicrosoftEntraIdPoliciesCreateAppManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_app_management_policies';
    protected const DESCRIPTION = 'Create appManagementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/appManagementPolicies.';
    ...
    protected const PATH = '/policies/appManagementPolicies';
