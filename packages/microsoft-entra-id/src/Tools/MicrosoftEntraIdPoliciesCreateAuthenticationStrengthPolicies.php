 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/authenticationStrengthPolicies.
 */
class MicrosoftEntraIdPoliciesCreateAuthenticationStrengthPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_authentication_strength_policies';
    protected const DESCRIPTION = 'Create authenticationStrengthPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/authenticationStrengthPolicies.';
    ...
    protected const PATH = '/policies/authenticationStrengthPolicies';
