 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/claimsMappingPolicies.
 */
class MicrosoftEntraIdPoliciesCreateClaimsMappingPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_claims_mapping_policies';
    protected const DESCRIPTION = 'Create claimsMappingPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/claimsMappingPolicies.';
    ...
    protected const PATH = '/policies/claimsMappingPolicies';
