 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/conditionalAccessPolicies.
 */
class MicrosoftEntraIdPoliciesCreateConditionalAccessPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_conditional_access_policies';
    protected const DESCRIPTION = 'Create new navigation property to conditionalAccessPolicies for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/conditionalAccessPolicies.';
    ...
    protected const PATH = '/policies/conditionalAccessPolicies';
