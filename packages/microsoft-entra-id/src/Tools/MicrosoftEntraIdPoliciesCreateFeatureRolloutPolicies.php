 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/featureRolloutPolicies.
 */
class MicrosoftEntraIdPoliciesCreateFeatureRolloutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_feature_rollout_policies';
    protected const DESCRIPTION = 'Create featureRolloutPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/featureRolloutPolicies.';
    ...
    protected const PATH = '/policies/featureRolloutPolicies';
