 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/homeRealmDiscoveryPolicies.
 */
class MicrosoftEntraIdPoliciesCreateHomeRealmDiscoveryPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_home_realm_discovery_policies';
    protected const DESCRIPTION = 'Create homeRealmDiscoveryPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/homeRealmDiscoveryPolicies.';
    ...
    protected const PATH = '/policies/homeRealmDiscoveryPolicies';
