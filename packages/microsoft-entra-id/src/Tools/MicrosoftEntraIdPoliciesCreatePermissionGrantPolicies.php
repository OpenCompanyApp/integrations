 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/permissionGrantPolicies.
 */
class MicrosoftEntraIdPoliciesCreatePermissionGrantPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_permission_grant_policies';
    protected const DESCRIPTION = 'Create permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/permissionGrantPolicies.';
    ...
    protected const PATH = '/policies/permissionGrantPolicies';
