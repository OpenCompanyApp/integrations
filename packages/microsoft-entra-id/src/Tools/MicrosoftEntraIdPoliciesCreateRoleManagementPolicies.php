 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/roleManagementPolicies.
 */
class MicrosoftEntraIdPoliciesCreateRoleManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_role_management_policies';
    protected const DESCRIPTION = 'Create new navigation property to roleManagementPolicies for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/roleManagementPolicies.';
    ...
    protected const PATH = '/policies/roleManagementPolicies';
