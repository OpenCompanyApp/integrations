 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/roleManagementPolicyAssignments.
 */
class MicrosoftEntraIdPoliciesCreateRoleManagementPolicyAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_role_management_policy_assignments';
    protected const DESCRIPTION = 'Create new navigation property to roleManagementPolicyAssignments for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/roleManagementPolicyAssignments.';
    ...
    protected const PATH = '/policies/roleManagementPolicyAssignments';
