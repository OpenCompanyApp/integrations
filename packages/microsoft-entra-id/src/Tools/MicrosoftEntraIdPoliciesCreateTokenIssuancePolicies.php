 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/tokenIssuancePolicies.
 */
class MicrosoftEntraIdPoliciesCreateTokenIssuancePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_token_issuance_policies';
    protected const DESCRIPTION = 'Create tokenIssuancePolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/tokenIssuancePolicies.';
    ...
    protected const PATH = '/policies/tokenIssuancePolicies';
