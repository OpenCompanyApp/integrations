 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/tokenLifetimePolicies.
 */
class MicrosoftEntraIdPoliciesCreateTokenLifetimePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_create_token_lifetime_policies';
    protected const DESCRIPTION = 'Create tokenLifetimePolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/tokenLifetimePolicies.';
    ...
    protected const PATH = '/policies/tokenLifetimePolicies';
