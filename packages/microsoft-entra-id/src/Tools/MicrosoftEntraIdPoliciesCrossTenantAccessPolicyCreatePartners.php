 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/crossTenantAccessPolicy/partners.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyCreatePartners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_create_partners';
    protected const DESCRIPTION = 'Create crossTenantAccessPolicyConfigurationPartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/crossTenantAccessPolicy/partners.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/partners';
