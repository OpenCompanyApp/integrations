 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/crossTenantAccessPolicy/default/resetToSystemDefault.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyDefaultResetToSystemDefault extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_default_reset_to_system_default';
    protected const DESCRIPTION = 'Invoke action resetToSystemDefault\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/crossTenantAccessPolicy/default/resetToSystemDefault.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/default/resetToSystemDefault';
