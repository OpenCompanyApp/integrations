 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy/default.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyDeleteDefault extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_delete_default';
    protected const DESCRIPTION = 'Delete navigation property default for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy/default.';
