 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyDeletePartners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_delete_partners';
    protected const DESCRIPTION = 'Delete crossTenantAccessPolicyConfigurationPartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}';
