 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy/templates.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyDeleteTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_delete_templates';
    protected const DESCRIPTION = 'Delete navigation property templates for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy/templates.';
