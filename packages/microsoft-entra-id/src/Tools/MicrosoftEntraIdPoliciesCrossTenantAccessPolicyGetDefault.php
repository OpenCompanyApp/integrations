 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/default.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyGetDefault extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_get_default';
    protected const DESCRIPTION = 'Get crossTenantAccessPolicyConfigurationDefault\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy/default.';
