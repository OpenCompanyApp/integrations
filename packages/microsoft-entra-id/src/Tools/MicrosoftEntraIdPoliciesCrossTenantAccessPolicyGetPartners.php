 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyGetPartners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_get_partners';
    protected const DESCRIPTION = 'Get crossTenantAccessPolicyConfigurationPartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}.';
