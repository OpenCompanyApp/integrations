 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/templates.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyGetTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_get_templates';
    protected const DESCRIPTION = 'Get templates from policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy/templates.';
