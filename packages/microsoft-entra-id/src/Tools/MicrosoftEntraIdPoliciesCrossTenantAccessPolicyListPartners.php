 ...
 * List partners.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/partners.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyListPartners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_list_partners';
    protected const DESCRIPTION = 'List partners\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy/partners.';
