 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}/identitySynchronization.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyPartnersDeleteIdentitySynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_partners_delete_identity_synchronization';
    protected const DESCRIPTION = 'Delete crossTenantIdentitySyncPolicyPartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}/identitySynchronization.';
