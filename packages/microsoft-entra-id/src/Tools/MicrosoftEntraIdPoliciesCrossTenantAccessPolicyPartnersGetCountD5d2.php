 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/partners/$count.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyPartnersGetCountD5d2 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_partners_get_count_d5d2';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/partners/$count';
