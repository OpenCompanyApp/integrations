 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}/identitySynchronization.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyPartnersSetIdentitySynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_partners_set_identity_synchronization';
    protected const DESCRIPTION = 'Create identitySynchronization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}/identitySynchronization.';
