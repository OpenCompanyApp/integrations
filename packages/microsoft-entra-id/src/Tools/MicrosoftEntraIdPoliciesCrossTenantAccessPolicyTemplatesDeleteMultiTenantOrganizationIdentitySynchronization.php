 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyTemplatesDeleteMultiTenantOrganizationIdentitySynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_templates_delete_multi_tenant_organization_identity_synchronization';
    protected const DESCRIPTION = 'Delete navigation property multiTenantOrganizationIdentitySynchronization for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization';
