 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyTemplatesDeleteMultiTenantOrganizationPartnerConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_templates_delete_multi_tenant_organization_partner_configuration';
    protected const DESCRIPTION = 'Delete navigation property multiTenantOrganizationPartnerConfiguration for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration';
