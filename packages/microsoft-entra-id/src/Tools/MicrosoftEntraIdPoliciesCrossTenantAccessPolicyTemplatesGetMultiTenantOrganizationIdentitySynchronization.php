 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyTemplatesGetMultiTenantOrganizationIdentitySynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_templates_get_multi_tenant_organization_identity_synchronization';
    protected const DESCRIPTION = 'Get multiTenantOrganizationIdentitySyncPolicyTemplate\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization.';
