 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyTemplatesGetMultiTenantOrganizationPartnerConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_templates_get_multi_tenant_organization_partner_configuration';
    protected const DESCRIPTION = 'Get multiTenantOrganizationPartnerConfigurationTemplate\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration.';
