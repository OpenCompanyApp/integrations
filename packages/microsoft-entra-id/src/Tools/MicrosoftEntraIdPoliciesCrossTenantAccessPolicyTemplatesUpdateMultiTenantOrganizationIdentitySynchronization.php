 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyTemplatesUpdateMultiTenantOrganizationIdentitySynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_templates_update_multi_tenant_organization_identity_synchronization';
    protected const DESCRIPTION = 'Update multiTenantOrganizationIdentitySyncPolicyTemplate\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization.';
