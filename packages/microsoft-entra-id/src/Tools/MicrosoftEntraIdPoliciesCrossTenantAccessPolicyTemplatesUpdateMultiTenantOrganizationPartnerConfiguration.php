 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyTemplatesUpdateMultiTenantOrganizationPartnerConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_templates_update_multi_tenant_organization_partner_configuration';
    protected const DESCRIPTION = 'Update multiTenantOrganizationPartnerConfigurationTemplate\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/crossTenantAccessPolicy/templates/multiTenantOrganizationPartnerConfiguration.';
