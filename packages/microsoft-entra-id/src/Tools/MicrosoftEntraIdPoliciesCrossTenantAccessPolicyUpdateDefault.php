 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/crossTenantAccessPolicy/default.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyUpdateDefault extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_update_default';
    protected const DESCRIPTION = 'Update crossTenantAccessPolicyConfigurationDefault\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/crossTenantAccessPolicy/default.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/default';
