 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyUpdatePartners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_update_partners';
    protected const DESCRIPTION = 'Update crossTenantAccessPolicyConfigurationPartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner-tenantId}.';
