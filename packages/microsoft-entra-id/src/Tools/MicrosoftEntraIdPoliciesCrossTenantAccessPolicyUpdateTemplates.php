 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/crossTenantAccessPolicy/templates.
 */
class MicrosoftEntraIdPoliciesCrossTenantAccessPolicyUpdateTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_cross_tenant_access_policy_update_templates';
    protected const DESCRIPTION = 'Update the navigation property templates in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/crossTenantAccessPolicy/templates.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy/templates';
