 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}.
 */
class MicrosoftEntraIdPoliciesDeleteActivityBasedTimeoutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_activity_based_timeout_policies';
    protected const DESCRIPTION = 'Delete activityBasedTimeoutPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}.';
    ...
    protected const PATH = '/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}';
