 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/adminConsentRequestPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteAdminConsentRequestPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_admin_consent_request_policy';
    protected const DESCRIPTION = 'Delete navigation property adminConsentRequestPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/adminConsentRequestPolicy.';
    ...
    protected const PATH = '/policies/adminConsentRequestPolicy';
