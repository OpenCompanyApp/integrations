 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/authenticationFlowsPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteAuthenticationFlowsPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_authentication_flows_policy';
    protected const DESCRIPTION = 'Delete navigation property authenticationFlowsPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/authenticationFlowsPolicy.';
    ...
    protected const PATH = '/policies/authenticationFlowsPolicy';
