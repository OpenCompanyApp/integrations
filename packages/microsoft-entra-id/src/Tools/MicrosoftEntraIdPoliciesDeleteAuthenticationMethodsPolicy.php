 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/authenticationMethodsPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteAuthenticationMethodsPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_authentication_methods_policy';
    protected const DESCRIPTION = 'Delete navigation property authenticationMethodsPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/authenticationMethodsPolicy.';
    ...
    protected const PATH = '/policies/authenticationMethodsPolicy';
