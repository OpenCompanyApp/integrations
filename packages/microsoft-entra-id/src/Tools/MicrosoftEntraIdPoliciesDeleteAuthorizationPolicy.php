 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/authorizationPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteAuthorizationPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_authorization_policy';
    protected const DESCRIPTION = 'Delete navigation property authorizationPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/authorizationPolicy.';
    ...
    protected const PATH = '/policies/authorizationPolicy';
