 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdPoliciesDeleteConditionalAccessPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_conditional_access_policies';
    protected const DESCRIPTION = 'Delete navigation property conditionalAccessPolicies for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}.';
