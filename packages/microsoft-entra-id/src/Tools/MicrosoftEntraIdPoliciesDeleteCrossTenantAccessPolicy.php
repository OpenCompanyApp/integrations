 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/crossTenantAccessPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteCrossTenantAccessPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_cross_tenant_access_policy';
    protected const DESCRIPTION = 'Delete navigation property crossTenantAccessPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/crossTenantAccessPolicy.';
    ...
    protected const PATH = '/policies/crossTenantAccessPolicy';
