 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/defaultAppManagementPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteDefaultAppManagementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_default_app_management_policy';
    protected const DESCRIPTION = 'Delete navigation property defaultAppManagementPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/defaultAppManagementPolicy.';
    ...
    protected const PATH = '/policies/defaultAppManagementPolicy';
