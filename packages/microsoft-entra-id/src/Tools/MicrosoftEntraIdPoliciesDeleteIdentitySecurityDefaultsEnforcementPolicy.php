 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/identitySecurityDefaultsEnforcementPolicy.
 */
class MicrosoftEntraIdPoliciesDeleteIdentitySecurityDefaultsEnforcementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_identity_security_defaults_enforcement_policy';
    protected const DESCRIPTION = 'Delete navigation property identitySecurityDefaultsEnforcementPolicy for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/identitySecurityDefaultsEnforcementPolicy.';
    ...
    protected const PATH = '/policies/identitySecurityDefaultsEnforcementPolicy';
