 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/permissionGrantPolicies/{permissionGrantPolicy-id}.
 */
class MicrosoftEntraIdPoliciesDeletePermissionGrantPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_delete_permission_grant_policies';
    protected const DESCRIPTION = 'Delete permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/permissionGrantPolicies/{permissionGrantPolicy-id}.';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/{permissionGrantPolicy-id}';
