 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$count.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesAppliesToGetCountB7fc extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_applies_to_get_count_b7fc';
    ...
    protected const PATH = '/policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$count';
