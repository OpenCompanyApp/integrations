 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesCreateAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_create_applies_to';
    ...
    protected const PATH = '/policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo';
