 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$ref.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesCreateRefAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_create_ref_applies_to';
    protected const DESCRIPTION = 'Assign appliesTo on a featureRolloutPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$ref.';
    ...
    protected const PATH = '/policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$ref';
