 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$ref.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesDeleteRefAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_delete_ref_applies_to';
