 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/featureRolloutPolicies/$count.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesGetCountBb08 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_get_count_bb08';
    ...
    protected const PATH = '/policies/featureRolloutPolicies/$count';
