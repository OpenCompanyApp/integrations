 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesListAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_list_applies_to';
