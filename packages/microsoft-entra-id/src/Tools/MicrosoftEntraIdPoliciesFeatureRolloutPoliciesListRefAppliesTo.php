 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$ref.
 */
class MicrosoftEntraIdPoliciesFeatureRolloutPoliciesListRefAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_feature_rollout_policies_list_ref_applies_to';
    protected const DESCRIPTION = 'Get ref of appliesTo from policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/featureRolloutPolicies/{featureRolloutPolicy-id}/appliesTo/$ref.';
