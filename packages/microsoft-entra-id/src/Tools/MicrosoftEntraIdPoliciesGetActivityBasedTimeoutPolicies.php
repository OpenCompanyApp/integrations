 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}.
 */
class MicrosoftEntraIdPoliciesGetActivityBasedTimeoutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_activity_based_timeout_policies';
    protected const DESCRIPTION = 'Get activityBasedTimeoutPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}.';
