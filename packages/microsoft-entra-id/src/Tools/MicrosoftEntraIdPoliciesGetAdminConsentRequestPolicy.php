 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/adminConsentRequestPolicy.
 */
class MicrosoftEntraIdPoliciesGetAdminConsentRequestPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_admin_consent_request_policy';
    protected const DESCRIPTION = 'Get adminConsentRequestPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/adminConsentRequestPolicy.';
