 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/appManagementPolicies/{appManagementPolicy-id}.
 */
class MicrosoftEntraIdPoliciesGetAppManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_app_management_policies';
    protected const DESCRIPTION = 'Get appManagementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/appManagementPolicies/{appManagementPolicy-id}.';
