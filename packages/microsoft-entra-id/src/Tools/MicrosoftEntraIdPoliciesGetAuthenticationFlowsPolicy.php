 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationFlowsPolicy.
 */
class MicrosoftEntraIdPoliciesGetAuthenticationFlowsPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_authentication_flows_policy';
    protected const DESCRIPTION = 'Get authenticationFlowsPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/authenticationFlowsPolicy.';
