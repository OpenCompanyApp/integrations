 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationMethodsPolicy.
 */
class MicrosoftEntraIdPoliciesGetAuthenticationMethodsPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_authentication_methods_policy';
    protected const DESCRIPTION = 'Get authenticationMethodsPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/authenticationMethodsPolicy.';
