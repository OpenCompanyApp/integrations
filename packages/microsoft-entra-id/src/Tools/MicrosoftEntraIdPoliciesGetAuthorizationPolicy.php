 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authorizationPolicy.
 */
class MicrosoftEntraIdPoliciesGetAuthorizationPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_authorization_policy';
    protected const DESCRIPTION = 'Get authorizationPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/authorizationPolicy.';
