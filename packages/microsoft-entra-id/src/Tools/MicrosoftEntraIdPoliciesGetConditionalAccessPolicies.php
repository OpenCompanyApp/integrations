 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdPoliciesGetConditionalAccessPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_conditional_access_policies';
    protected const DESCRIPTION = 'Get conditionalAccessPolicies from policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}.';
