 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/crossTenantAccessPolicy.
 */
class MicrosoftEntraIdPoliciesGetCrossTenantAccessPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_cross_tenant_access_policy';
    protected const DESCRIPTION = 'Get crossTenantAccessPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/crossTenantAccessPolicy.';
