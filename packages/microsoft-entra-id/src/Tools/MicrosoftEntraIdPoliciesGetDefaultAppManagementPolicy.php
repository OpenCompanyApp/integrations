 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/defaultAppManagementPolicy.
 */
class MicrosoftEntraIdPoliciesGetDefaultAppManagementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_default_app_management_policy';
    protected const DESCRIPTION = 'Get tenantAppManagementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/defaultAppManagementPolicy.';
