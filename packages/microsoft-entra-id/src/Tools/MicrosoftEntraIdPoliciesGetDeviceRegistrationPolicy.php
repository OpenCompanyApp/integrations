 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/deviceRegistrationPolicy.
 */
class MicrosoftEntraIdPoliciesGetDeviceRegistrationPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_device_registration_policy';
    protected const DESCRIPTION = 'Get deviceRegistrationPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/deviceRegistrationPolicy.';
    ...
    protected const PATH = '/policies/deviceRegistrationPolicy';
