 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/featureRolloutPolicies/{featureRolloutPolicy-id}.
 */
class MicrosoftEntraIdPoliciesGetFeatureRolloutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_feature_rollout_policies';
    protected const DESCRIPTION = 'Get featureRolloutPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/featureRolloutPolicies/{featureRolloutPolicy-id}.';
