 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/identitySecurityDefaultsEnforcementPolicy.
 */
class MicrosoftEntraIdPoliciesGetIdentitySecurityDefaultsEnforcementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_identity_security_defaults_enforcement_policy';
    protected const DESCRIPTION = 'Get identitySecurityDefaultsEnforcementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/identitySecurityDefaultsEnforcementPolicy.';
