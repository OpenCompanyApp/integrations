 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/ownerlessGroupPolicy.
 */
class MicrosoftEntraIdPoliciesGetOwnerlessGroupPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_get_ownerless_group_policy';
    protected const DESCRIPTION = 'Get ownerlessGroupPolicy from policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/ownerlessGroupPolicy.';
