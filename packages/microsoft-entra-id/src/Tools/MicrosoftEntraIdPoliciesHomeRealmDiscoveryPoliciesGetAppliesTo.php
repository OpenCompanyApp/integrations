 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy-id}/appliesTo/{directoryObject-id}.
 */
class MicrosoftEntraIdPoliciesHomeRealmDiscoveryPoliciesGetAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_home_realm_discovery_policies_get_applies_to';
