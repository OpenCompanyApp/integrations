 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/homeRealmDiscoveryPolicies/$count.
 */
class MicrosoftEntraIdPoliciesHomeRealmDiscoveryPoliciesGetCount9451 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_home_realm_discovery_policies_get_count_9451';
    ...
    protected const PATH = '/policies/homeRealmDiscoveryPolicies/$count';
