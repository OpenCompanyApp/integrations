 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/appManagementPolicies.
 */
class MicrosoftEntraIdPoliciesListAppManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_app_management_policies';
    protected const DESCRIPTION = 'List appManagementPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/appManagementPolicies.';
