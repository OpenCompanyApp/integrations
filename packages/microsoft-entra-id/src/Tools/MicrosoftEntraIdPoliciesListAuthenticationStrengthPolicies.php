 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/authenticationStrengthPolicies.
 */
class MicrosoftEntraIdPoliciesListAuthenticationStrengthPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_authentication_strength_policies';
    protected const DESCRIPTION = 'List authenticationStrengthPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/authenticationStrengthPolicies.';
