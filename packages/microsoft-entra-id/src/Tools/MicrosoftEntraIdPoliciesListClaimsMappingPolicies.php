 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/claimsMappingPolicies.
 */
class MicrosoftEntraIdPoliciesListClaimsMappingPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_claims_mapping_policies';
    protected const DESCRIPTION = 'List claimsMappingPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/claimsMappingPolicies.';
