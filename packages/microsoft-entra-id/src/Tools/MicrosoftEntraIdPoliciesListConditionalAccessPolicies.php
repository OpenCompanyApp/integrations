 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/conditionalAccessPolicies.
 */
class MicrosoftEntraIdPoliciesListConditionalAccessPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_conditional_access_policies';
