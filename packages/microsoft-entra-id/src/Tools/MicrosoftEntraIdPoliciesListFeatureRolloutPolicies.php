 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/featureRolloutPolicies.
 */
class MicrosoftEntraIdPoliciesListFeatureRolloutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_feature_rollout_policies';
    protected const DESCRIPTION = 'List featureRolloutPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/featureRolloutPolicies.';
