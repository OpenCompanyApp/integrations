 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/homeRealmDiscoveryPolicies.
 */
class MicrosoftEntraIdPoliciesListHomeRealmDiscoveryPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_home_realm_discovery_policies';
    protected const DESCRIPTION = 'List homeRealmDiscoveryPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/homeRealmDiscoveryPolicies.';
