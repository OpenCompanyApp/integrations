 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies.
 */
class MicrosoftEntraIdPoliciesListPermissionGrantPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_permission_grant_policies';
    protected const DESCRIPTION = 'List permissionGrantPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/permissionGrantPolicies.';
