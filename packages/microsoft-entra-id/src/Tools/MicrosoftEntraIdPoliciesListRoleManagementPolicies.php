 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/roleManagementPolicies.
 */
class MicrosoftEntraIdPoliciesListRoleManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_role_management_policies';
    protected const DESCRIPTION = 'List roleManagementPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/roleManagementPolicies.';
