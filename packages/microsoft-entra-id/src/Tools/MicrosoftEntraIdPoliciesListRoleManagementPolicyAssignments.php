 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/roleManagementPolicyAssignments.
 */
class MicrosoftEntraIdPoliciesListRoleManagementPolicyAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_role_management_policy_assignments';
    protected const DESCRIPTION = 'List roleManagementPolicyAssignments\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/roleManagementPolicyAssignments.';
