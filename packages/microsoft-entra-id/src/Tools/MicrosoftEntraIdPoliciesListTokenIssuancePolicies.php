 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/tokenIssuancePolicies.
 */
class MicrosoftEntraIdPoliciesListTokenIssuancePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_token_issuance_policies';
    protected const DESCRIPTION = 'List tokenIssuancePolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/tokenIssuancePolicies.';
