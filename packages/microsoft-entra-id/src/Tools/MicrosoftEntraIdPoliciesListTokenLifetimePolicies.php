 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/tokenLifetimePolicies.
 */
class MicrosoftEntraIdPoliciesListTokenLifetimePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_list_token_lifetime_policies';
    protected const DESCRIPTION = 'List tokenLifetimePolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/tokenLifetimePolicies.';
