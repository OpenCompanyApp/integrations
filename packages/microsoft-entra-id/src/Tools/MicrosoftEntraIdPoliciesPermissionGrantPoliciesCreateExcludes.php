 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesCreateExcludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_create_excludes';
    protected const DESCRIPTION = 'Create permissionGrantConditionSet in excludes collection of permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes.';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes';
