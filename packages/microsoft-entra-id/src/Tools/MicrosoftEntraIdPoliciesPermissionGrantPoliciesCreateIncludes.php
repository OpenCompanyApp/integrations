 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesCreateIncludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_create_includes';
    protected const DESCRIPTION = 'Create permissionGrantConditionSet in includes collection of permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes.';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes';
    protected const PATH_PARAMS = ['permissionGrantPolicy-id' => 'permission_grant_policy_id'];
