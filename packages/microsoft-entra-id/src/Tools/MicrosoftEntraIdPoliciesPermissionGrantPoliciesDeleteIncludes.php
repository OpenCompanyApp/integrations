 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesDeleteIncludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_delete_includes';
    protected const DESCRIPTION = 'Delete permissionGrantConditionSet from includes collection of permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}.';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}';
