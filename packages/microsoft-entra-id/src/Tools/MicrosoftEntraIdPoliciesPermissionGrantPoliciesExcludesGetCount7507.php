 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/$count.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesExcludesGetCount7507 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_excludes_get_count_7507';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/$count';
