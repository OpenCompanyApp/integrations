 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/$count.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesGetCount86b8 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_get_count_86b8';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/$count';
