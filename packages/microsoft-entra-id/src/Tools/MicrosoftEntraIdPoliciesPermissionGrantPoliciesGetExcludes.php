 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/{permissionGrantConditionSet-id}.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesGetExcludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_get_excludes';
    protected const DESCRIPTION = 'Get excludes from policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/{permissionGrantConditionSet-id}.';
