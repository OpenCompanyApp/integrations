 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesGetIncludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_get_includes';
    protected const DESCRIPTION = 'Get includes from policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}.';
