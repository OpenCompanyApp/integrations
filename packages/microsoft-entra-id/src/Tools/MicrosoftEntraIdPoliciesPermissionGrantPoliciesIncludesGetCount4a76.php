 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/$count.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesIncludesGetCount4a76 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_includes_get_count_4a76';
    ...
    protected const PATH = '/policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/$count';
