 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesListExcludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_list_excludes';
    protected const DESCRIPTION = 'List excludes collection of permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes.';
