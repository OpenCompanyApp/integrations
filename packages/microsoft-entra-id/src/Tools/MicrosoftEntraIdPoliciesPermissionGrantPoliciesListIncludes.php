 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesListIncludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_list_includes';
    protected const DESCRIPTION = 'List includes collection of permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes.';
