 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/{permissionGrantConditionSet-id}.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesUpdateExcludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_update_excludes';
    protected const DESCRIPTION = 'Update the navigation property excludes in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/{permissionGrantConditionSet-id}.';
