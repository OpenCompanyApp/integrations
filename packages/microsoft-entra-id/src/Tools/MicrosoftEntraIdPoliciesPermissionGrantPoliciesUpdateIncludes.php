 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}.
 */
class MicrosoftEntraIdPoliciesPermissionGrantPoliciesUpdateIncludes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_permission_grant_policies_update_includes';
    protected const DESCRIPTION = 'Update the navigation property includes in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/{permissionGrantConditionSet-id}.';
