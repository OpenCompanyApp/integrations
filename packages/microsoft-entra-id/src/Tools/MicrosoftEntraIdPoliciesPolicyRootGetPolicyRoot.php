 ...
 * Get policies.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies.
 */
class MicrosoftEntraIdPoliciesPolicyRootGetPolicyRoot extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_policy_root_get_policy_root';
    protected const DESCRIPTION = 'Get policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies.';
