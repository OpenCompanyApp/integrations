 ...
 * Update policies.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies.
 */
class MicrosoftEntraIdPoliciesPolicyRootUpdatePolicyRoot extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_policy_root_update_policy_root';
    protected const DESCRIPTION = 'Update policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies.';
