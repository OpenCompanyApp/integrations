 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/effectiveRules/{unifiedRoleManagementPolicyRule-id}.
 */
class MicrosoftEntraIdPoliciesRoleManagementPoliciesDeleteEffectiveRules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_role_management_policies_delete_effective_rules';
    protected const DESCRIPTION = 'Delete navigation property effectiveRules for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/effectiveRules/{unifiedRoleManagementPolicyRule-id}.';
