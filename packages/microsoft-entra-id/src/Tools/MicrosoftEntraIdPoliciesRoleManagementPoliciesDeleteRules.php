 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules/{unifiedRoleManagementPolicyRule-id}.
 */
class MicrosoftEntraIdPoliciesRoleManagementPoliciesDeleteRules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_role_management_policies_delete_rules';
    protected const DESCRIPTION = 'Delete navigation property rules for policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules/{unifiedRoleManagementPolicyRule-id}.';
