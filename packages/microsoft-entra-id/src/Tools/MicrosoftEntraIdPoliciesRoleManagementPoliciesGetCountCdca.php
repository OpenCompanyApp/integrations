 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/roleManagementPolicies/$count.
 */
class MicrosoftEntraIdPoliciesRoleManagementPoliciesGetCountCdca extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_role_management_policies_get_count_cdca';
    ...
    protected const PATH = '/policies/roleManagementPolicies/$count';
