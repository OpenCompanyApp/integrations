 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules/{unifiedRoleManagementPolicyRule-id}.
 */
class MicrosoftEntraIdPoliciesRoleManagementPoliciesGetRules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_role_management_policies_get_rules';
    protected const DESCRIPTION = 'Get unifiedRoleManagementPolicyRule\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules/{unifiedRoleManagementPolicyRule-id}.';
