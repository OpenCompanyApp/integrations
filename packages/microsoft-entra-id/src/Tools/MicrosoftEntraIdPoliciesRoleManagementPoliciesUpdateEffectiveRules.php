 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/effectiveRules/{unifiedRoleManagementPolicyRule-id}.
 */
class MicrosoftEntraIdPoliciesRoleManagementPoliciesUpdateEffectiveRules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_role_management_policies_update_effective_rules';
    protected const DESCRIPTION = 'Update the navigation property effectiveRules in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/effectiveRules/{unifiedRoleManagementPolicyRule-id}.';
    ...
    protected const PATH = '/policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/effectiveRules/{unifiedRoleManagementPolicyRule-id}';
