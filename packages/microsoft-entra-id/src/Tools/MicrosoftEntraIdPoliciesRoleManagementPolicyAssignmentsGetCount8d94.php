 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/roleManagementPolicyAssignments/$count.
 */
class MicrosoftEntraIdPoliciesRoleManagementPolicyAssignmentsGetCount8d94 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_role_management_policy_assignments_get_count_8d94';
    ...
    protected const PATH = '/policies/roleManagementPolicyAssignments/$count';
