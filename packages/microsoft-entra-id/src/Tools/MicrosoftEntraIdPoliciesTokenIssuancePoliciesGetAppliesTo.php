 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/tokenIssuancePolicies/{tokenIssuancePolicy-id}/appliesTo/{directoryObject-id}.
 */
class MicrosoftEntraIdPoliciesTokenIssuancePoliciesGetAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_token_issuance_policies_get_applies_to';
