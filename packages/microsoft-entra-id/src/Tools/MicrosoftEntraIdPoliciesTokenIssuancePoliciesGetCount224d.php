 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/tokenIssuancePolicies/$count.
 */
class MicrosoftEntraIdPoliciesTokenIssuancePoliciesGetCount224d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_token_issuance_policies_get_count_224d';
    ...
    protected const PATH = '/policies/tokenIssuancePolicies/$count';
