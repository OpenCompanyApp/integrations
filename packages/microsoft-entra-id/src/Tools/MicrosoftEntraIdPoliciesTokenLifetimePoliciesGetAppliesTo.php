 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/tokenLifetimePolicies/{tokenLifetimePolicy-id}/appliesTo/{directoryObject-id}.
 */
class MicrosoftEntraIdPoliciesTokenLifetimePoliciesGetAppliesTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_token_lifetime_policies_get_applies_to';
