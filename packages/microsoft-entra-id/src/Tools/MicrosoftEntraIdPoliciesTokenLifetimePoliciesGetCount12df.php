 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /policies/tokenLifetimePolicies/$count.
 */
class MicrosoftEntraIdPoliciesTokenLifetimePoliciesGetCount12df extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_token_lifetime_policies_get_count_12df';
    ...
    protected const PATH = '/policies/tokenLifetimePolicies/$count';
