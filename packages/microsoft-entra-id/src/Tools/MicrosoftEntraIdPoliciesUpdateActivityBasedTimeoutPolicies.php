 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}.
 */
class MicrosoftEntraIdPoliciesUpdateActivityBasedTimeoutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_activity_based_timeout_policies';
    protected const DESCRIPTION = 'Update activitybasedtimeoutpolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy-id}.';
