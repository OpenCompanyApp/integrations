 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/adminConsentRequestPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateAdminConsentRequestPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_admin_consent_request_policy';
    protected const DESCRIPTION = 'Update adminConsentRequestPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/adminConsentRequestPolicy.';
