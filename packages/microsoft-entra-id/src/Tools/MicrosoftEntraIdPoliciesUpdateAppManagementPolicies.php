 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/appManagementPolicies/{appManagementPolicy-id}.
 */
class MicrosoftEntraIdPoliciesUpdateAppManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_app_management_policies';
    protected const DESCRIPTION = 'Update appManagementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/appManagementPolicies/{appManagementPolicy-id}.';
