 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/authenticationFlowsPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateAuthenticationFlowsPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_authentication_flows_policy';
    protected const DESCRIPTION = 'Update authenticationFlowsPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/authenticationFlowsPolicy.';
