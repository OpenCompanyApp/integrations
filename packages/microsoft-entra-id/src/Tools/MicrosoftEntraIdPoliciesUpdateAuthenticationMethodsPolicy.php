 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/authenticationMethodsPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateAuthenticationMethodsPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_authentication_methods_policy';
    protected const DESCRIPTION = 'Update authenticationMethodsPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/authenticationMethodsPolicy.';
