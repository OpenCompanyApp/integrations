 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/authorizationPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateAuthorizationPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_authorization_policy';
    protected const DESCRIPTION = 'Update authorizationPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/authorizationPolicy.';
