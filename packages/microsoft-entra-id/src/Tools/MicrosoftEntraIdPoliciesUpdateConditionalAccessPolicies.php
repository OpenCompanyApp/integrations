 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}.
 */
class MicrosoftEntraIdPoliciesUpdateConditionalAccessPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_conditional_access_policies';
    protected const DESCRIPTION = 'Update the navigation property conditionalAccessPolicies in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}.';
    ...
    protected const PATH = '/policies/conditionalAccessPolicies/{conditionalAccessPolicy-id}';
