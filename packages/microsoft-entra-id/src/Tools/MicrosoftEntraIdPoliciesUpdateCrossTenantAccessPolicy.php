 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/crossTenantAccessPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateCrossTenantAccessPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_cross_tenant_access_policy';
    protected const DESCRIPTION = 'Update crossTenantAccessPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/crossTenantAccessPolicy.';
