 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/defaultAppManagementPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateDefaultAppManagementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_default_app_management_policy';
    protected const DESCRIPTION = 'Update tenantAppManagementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/defaultAppManagementPolicy.';
