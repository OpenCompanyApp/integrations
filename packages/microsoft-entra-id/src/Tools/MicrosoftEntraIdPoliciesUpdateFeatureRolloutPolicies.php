 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/featureRolloutPolicies/{featureRolloutPolicy-id}.
 */
class MicrosoftEntraIdPoliciesUpdateFeatureRolloutPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_feature_rollout_policies';
    protected const DESCRIPTION = 'Update featurerolloutpolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/featureRolloutPolicies/{featureRolloutPolicy-id}.';
