 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/identitySecurityDefaultsEnforcementPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateIdentitySecurityDefaultsEnforcementPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_identity_security_defaults_enforcement_policy';
    protected const DESCRIPTION = 'Update identitySecurityDefaultsEnforcementPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/identitySecurityDefaultsEnforcementPolicy.';
