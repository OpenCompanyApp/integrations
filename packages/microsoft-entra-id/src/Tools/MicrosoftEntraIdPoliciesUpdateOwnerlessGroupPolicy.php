 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/ownerlessGroupPolicy.
 */
class MicrosoftEntraIdPoliciesUpdateOwnerlessGroupPolicy extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_ownerless_group_policy';
    protected const DESCRIPTION = 'Update the navigation property ownerlessGroupPolicy in policies\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/ownerlessGroupPolicy.';
    ...
    protected const PATH = '/policies/ownerlessGroupPolicy';
