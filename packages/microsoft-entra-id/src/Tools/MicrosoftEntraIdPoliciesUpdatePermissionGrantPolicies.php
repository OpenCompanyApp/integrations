 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /policies/permissionGrantPolicies/{permissionGrantPolicy-id}.
 */
class MicrosoftEntraIdPoliciesUpdatePermissionGrantPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_policies_update_permission_grant_policies';
    protected const DESCRIPTION = 'Update permissionGrantPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /policies/permissionGrantPolicies/{permissionGrantPolicy-id}.';
