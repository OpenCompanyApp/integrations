 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /roleManagement/directory.
 */
class MicrosoftEntraIdRoleManagementDeleteDirectory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_delete_directory';
    protected const DESCRIPTION = 'Delete navigation property directory for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /roleManagement/directory.';
