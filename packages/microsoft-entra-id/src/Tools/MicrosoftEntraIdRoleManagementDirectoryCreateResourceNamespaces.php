 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/resourceNamespaces.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateResourceNamespaces extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_resource_namespaces';
    protected const DESCRIPTION = 'Create new navigation property to resourceNamespaces for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/resourceNamespaces.';
    ...
    protected const PATH = '/roleManagement/directory/resourceNamespaces';
