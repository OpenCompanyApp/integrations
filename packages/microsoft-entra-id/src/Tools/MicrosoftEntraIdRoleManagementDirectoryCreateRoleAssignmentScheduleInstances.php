 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleAssignmentScheduleInstances.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleAssignmentScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_assignment_schedule_instances';
    protected const DESCRIPTION = 'Create new navigation property to roleAssignmentScheduleInstances for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleAssignmentScheduleInstances.';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentScheduleInstances';
