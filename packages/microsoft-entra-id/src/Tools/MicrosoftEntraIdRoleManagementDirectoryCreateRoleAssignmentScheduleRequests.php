 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleAssignmentScheduleRequests.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleAssignmentScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_assignment_schedule_requests';
    protected const DESCRIPTION = 'Create roleAssignmentScheduleRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleAssignmentScheduleRequests.';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentScheduleRequests';
