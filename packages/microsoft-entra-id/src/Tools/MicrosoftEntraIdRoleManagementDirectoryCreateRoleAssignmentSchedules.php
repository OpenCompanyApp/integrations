 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleAssignmentSchedules.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleAssignmentSchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_assignment_schedules';
    protected const DESCRIPTION = 'Create new navigation property to roleAssignmentSchedules for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleAssignmentSchedules.';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentSchedules';
