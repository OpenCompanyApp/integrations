 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleAssignments.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_assignments';
    protected const DESCRIPTION = 'Create unifiedRoleAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleAssignments.';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignments';
