 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleDefinitions.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_definitions';
    protected const DESCRIPTION = 'Create roleDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleDefinitions.';
    ...
    protected const PATH = '/roleManagement/directory/roleDefinitions';
