 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleEligibilityScheduleInstances.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleEligibilityScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_eligibility_schedule_instances';
    protected const DESCRIPTION = 'Create new navigation property to roleEligibilityScheduleInstances for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleEligibilityScheduleInstances.';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleInstances';
