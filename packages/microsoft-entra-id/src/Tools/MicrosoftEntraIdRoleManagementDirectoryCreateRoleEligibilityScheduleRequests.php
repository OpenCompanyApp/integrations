 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleEligibilityScheduleRequests.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_eligibility_schedule_requests';
    protected const DESCRIPTION = 'Create roleEligibilityScheduleRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleEligibilityScheduleRequests.';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleRequests';
