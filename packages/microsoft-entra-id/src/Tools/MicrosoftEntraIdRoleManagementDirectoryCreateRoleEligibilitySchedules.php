 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleEligibilitySchedules.
 */
class MicrosoftEntraIdRoleManagementDirectoryCreateRoleEligibilitySchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_create_role_eligibility_schedules';
    protected const DESCRIPTION = 'Create new navigation property to roleEligibilitySchedules for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleEligibilitySchedules.';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilitySchedules';
