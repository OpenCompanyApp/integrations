 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryDeleteRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_delete_role_assignments';
    protected const DESCRIPTION = 'Delete unifiedRoleAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}.';
