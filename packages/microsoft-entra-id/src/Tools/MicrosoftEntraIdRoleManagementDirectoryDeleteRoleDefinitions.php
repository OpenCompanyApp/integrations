 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryDeleteRoleDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_delete_role_definitions';
    protected const DESCRIPTION = 'Delete unifiedRoleDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}.';
    ...
    protected const PATH = '/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}';
