 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryDeleteRoleEligibilityScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_delete_role_eligibility_schedule_instances';
    protected const DESCRIPTION = 'Delete navigation property roleEligibilityScheduleInstances for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}.';
