 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryDeleteRoleEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_delete_role_eligibility_schedule_requests';
    protected const DESCRIPTION = 'Delete navigation property roleEligibilityScheduleRequests for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}.';
