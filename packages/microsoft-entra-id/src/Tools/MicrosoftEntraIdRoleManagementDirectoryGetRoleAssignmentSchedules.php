 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryGetRoleAssignmentSchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_get_role_assignment_schedules';
    protected const DESCRIPTION = 'Get unifiedRoleAssignmentSchedule\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}.';
