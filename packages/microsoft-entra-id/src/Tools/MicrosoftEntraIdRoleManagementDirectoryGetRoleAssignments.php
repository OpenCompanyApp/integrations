 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryGetRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_get_role_assignments';
    protected const DESCRIPTION = 'Get unifiedRoleAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}.';
