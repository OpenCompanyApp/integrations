 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryGetRoleDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_get_role_definitions';
    protected const DESCRIPTION = 'Get unifiedRoleDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}.';
