 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryGetRoleEligibilityScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_get_role_eligibility_schedule_instances';
    protected const DESCRIPTION = 'Get unifiedRoleEligibilityScheduleInstance\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}.';
