 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryGetRoleEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_get_role_eligibility_schedule_requests';
    protected const DESCRIPTION = 'Get unifiedRoleEligibilityScheduleRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}.';
