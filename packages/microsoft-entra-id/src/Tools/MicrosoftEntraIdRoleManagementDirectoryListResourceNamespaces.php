 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/resourceNamespaces.
 */
class MicrosoftEntraIdRoleManagementDirectoryListResourceNamespaces extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_resource_namespaces';
