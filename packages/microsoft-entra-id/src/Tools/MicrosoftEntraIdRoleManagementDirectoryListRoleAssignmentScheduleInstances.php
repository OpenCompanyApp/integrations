 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentScheduleInstances.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleAssignmentScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_assignment_schedule_instances';
    protected const DESCRIPTION = 'List roleAssignmentScheduleInstances\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleAssignmentScheduleInstances.';
