 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentScheduleRequests.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleAssignmentScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_assignment_schedule_requests';
    protected const DESCRIPTION = 'List roleAssignmentScheduleRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleAssignmentScheduleRequests.';
