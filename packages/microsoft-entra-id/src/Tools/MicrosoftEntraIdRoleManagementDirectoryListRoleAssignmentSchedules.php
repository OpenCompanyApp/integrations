 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentSchedules.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleAssignmentSchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_assignment_schedules';
    protected const DESCRIPTION = 'List roleAssignmentSchedules\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleAssignmentSchedules.';
