 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleDefinitions.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_definitions';
    protected const DESCRIPTION = 'List roleDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleDefinitions.';
