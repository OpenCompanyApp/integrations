 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleInstances.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleEligibilityScheduleInstances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_eligibility_schedule_instances';
    protected const DESCRIPTION = 'List roleEligibilityScheduleInstances\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleEligibilityScheduleInstances.';
