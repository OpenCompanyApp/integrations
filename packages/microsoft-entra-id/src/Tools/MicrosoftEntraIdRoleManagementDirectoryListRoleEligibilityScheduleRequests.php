 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleRequests.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_eligibility_schedule_requests';
    protected const DESCRIPTION = 'List roleEligibilityScheduleRequests\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleEligibilityScheduleRequests.';
