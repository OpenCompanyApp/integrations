 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilitySchedules.
 */
class MicrosoftEntraIdRoleManagementDirectoryListRoleEligibilitySchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_list_role_eligibility_schedules';
    protected const DESCRIPTION = 'List roleEligibilitySchedules\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleEligibilitySchedules.';
