 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/resourceNamespaces/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryResourceNamespacesGetCount2247 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_resource_namespaces_get_count_2247';
    ...
    protected const PATH = '/roleManagement/directory/resourceNamespaces/$count';
