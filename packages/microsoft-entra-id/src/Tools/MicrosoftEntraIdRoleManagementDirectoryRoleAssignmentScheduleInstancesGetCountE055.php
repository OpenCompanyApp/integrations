 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentScheduleInstances/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentScheduleInstancesGetCountE055 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignment_schedule_instances_get_count_e055';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentScheduleInstances/$count';
