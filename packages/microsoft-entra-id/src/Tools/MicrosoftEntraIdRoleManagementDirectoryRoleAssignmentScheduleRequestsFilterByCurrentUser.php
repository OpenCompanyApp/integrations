 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentScheduleRequests/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentScheduleRequestsFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignment_schedule_requests_filter_by_current_user';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentScheduleRequests/filterByCurrentUser(on=\'{on}\')';
