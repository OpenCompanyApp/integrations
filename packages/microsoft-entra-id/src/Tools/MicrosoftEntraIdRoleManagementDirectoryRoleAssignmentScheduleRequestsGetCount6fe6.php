 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentScheduleRequests/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentScheduleRequestsGetCount6fe6 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignment_schedule_requests_get_count_6fe6';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentScheduleRequests/$count';
