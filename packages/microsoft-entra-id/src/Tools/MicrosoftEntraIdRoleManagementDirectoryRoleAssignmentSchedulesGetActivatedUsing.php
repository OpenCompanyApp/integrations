 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}/activatedUsing.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentSchedulesGetActivatedUsing extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignment_schedules_get_activated_using';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}/activatedUsing';
