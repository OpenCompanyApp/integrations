 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentSchedules/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentSchedulesGetCount6f04 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignment_schedules_get_count_6f04';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentSchedules/$count';
