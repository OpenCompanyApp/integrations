 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}/roleDefinition.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentSchedulesGetRoleDefinition extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignment_schedules_get_role_definition';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}/roleDefinition';
