 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/appScope.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentsDeleteAppScope extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignments_delete_app_scope';
    protected const DESCRIPTION = 'Delete navigation property appScope for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/appScope.';
