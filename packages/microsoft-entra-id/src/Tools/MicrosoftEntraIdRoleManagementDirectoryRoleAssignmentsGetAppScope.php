 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/appScope.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentsGetAppScope extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignments_get_app_scope';
