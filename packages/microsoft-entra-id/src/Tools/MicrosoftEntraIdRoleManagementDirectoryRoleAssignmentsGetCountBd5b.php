 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignments/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentsGetCountBd5b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignments_get_count_bd5b';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignments/$count';
