 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/directoryScope.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentsGetDirectoryScope extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignments_get_directory_scope';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/directoryScope';
