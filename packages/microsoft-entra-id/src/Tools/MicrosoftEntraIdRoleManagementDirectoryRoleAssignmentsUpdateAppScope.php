 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/appScope.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleAssignmentsUpdateAppScope extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_assignments_update_app_scope';
    protected const DESCRIPTION = 'Update the navigation property appScope in roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/appScope.';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}/appScope';
