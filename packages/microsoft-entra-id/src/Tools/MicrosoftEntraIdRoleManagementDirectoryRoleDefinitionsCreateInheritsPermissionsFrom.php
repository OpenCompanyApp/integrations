 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleDefinitionsCreateInheritsPermissionsFrom extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_definitions_create_inherits_permissions_from';
    protected const DESCRIPTION = 'Create new navigation property to inheritsPermissionsFrom for roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom.';
    ...
    protected const PATH = '/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom';
