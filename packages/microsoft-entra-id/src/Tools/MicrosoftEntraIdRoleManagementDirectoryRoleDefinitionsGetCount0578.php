 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleDefinitions/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleDefinitionsGetCount0578 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_definitions_get_count_0578';
    ...
    protected const PATH = '/roleManagement/directory/roleDefinitions/$count';
