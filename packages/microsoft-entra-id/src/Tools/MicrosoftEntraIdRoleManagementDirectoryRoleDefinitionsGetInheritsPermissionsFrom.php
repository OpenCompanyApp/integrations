 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom/{unifiedRoleDefinition-id1}.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleDefinitionsGetInheritsPermissionsFrom extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_definitions_get_inherits_permissions_from';
