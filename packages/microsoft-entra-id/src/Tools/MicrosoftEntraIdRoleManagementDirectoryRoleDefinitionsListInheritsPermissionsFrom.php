 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleDefinitionsListInheritsPermissionsFrom extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_definitions_list_inherits_permissions_from';
    protected const DESCRIPTION = 'Get inheritsPermissionsFrom from roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom.';
