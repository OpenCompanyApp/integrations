 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom/{unifiedRoleDefinition-id1}.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleDefinitionsUpdateInheritsPermissionsFrom extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_definitions_update_inherits_permissions_from';
    protected const DESCRIPTION = 'Update the navigation property inheritsPermissionsFrom in roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}/inheritsPermissionsFrom/{unifiedRoleDefinition-id1}.';
