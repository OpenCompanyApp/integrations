 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleInstances/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleEligibilityScheduleInstancesFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_eligibility_schedule_instances_filter_by_current_user';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleInstances/filterByCurrentUser(on=\'{on}\')';
