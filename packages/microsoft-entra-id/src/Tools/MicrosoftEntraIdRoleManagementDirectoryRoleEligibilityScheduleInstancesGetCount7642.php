 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleInstances/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleEligibilityScheduleInstancesGetCount7642 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_eligibility_schedule_instances_get_count_7642';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleInstances/$count';
