 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleRequests/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleEligibilityScheduleRequestsFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_eligibility_schedule_requests_filter_by_current_user';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleRequests/filterByCurrentUser(on=\'{on}\')';
