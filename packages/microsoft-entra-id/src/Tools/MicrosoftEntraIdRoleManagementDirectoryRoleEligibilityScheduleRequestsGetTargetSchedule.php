 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}/targetSchedule.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleEligibilityScheduleRequestsGetTargetSchedule extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_eligibility_schedule_requests_get_target_schedule';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}/targetSchedule';
