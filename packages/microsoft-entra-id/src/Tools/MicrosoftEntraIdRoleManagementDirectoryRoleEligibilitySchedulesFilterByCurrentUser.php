 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilitySchedules/filterByCurrentUser(on='{on}').
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleEligibilitySchedulesFilterByCurrentUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_eligibility_schedules_filter_by_current_user';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilitySchedules/filterByCurrentUser(on=\'{on}\')';
