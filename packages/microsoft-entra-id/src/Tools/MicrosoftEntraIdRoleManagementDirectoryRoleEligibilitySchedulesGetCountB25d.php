 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory/roleEligibilitySchedules/$count.
 */
class MicrosoftEntraIdRoleManagementDirectoryRoleEligibilitySchedulesGetCountB25d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_role_eligibility_schedules_get_count_b25d';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilitySchedules/$count';
