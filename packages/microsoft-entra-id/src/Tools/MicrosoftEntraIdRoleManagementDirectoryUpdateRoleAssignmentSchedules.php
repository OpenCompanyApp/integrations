 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryUpdateRoleAssignmentSchedules extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_update_role_assignment_schedules';
    protected const DESCRIPTION = 'Update the navigation property roleAssignmentSchedules in roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}.';
