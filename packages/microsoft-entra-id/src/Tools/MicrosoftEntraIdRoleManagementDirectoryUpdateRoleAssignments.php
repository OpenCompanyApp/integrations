 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryUpdateRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_update_role_assignments';
    protected const DESCRIPTION = 'Update the navigation property roleAssignments in roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}.';
    ...
    protected const PATH = '/roleManagement/directory/roleAssignments/{unifiedRoleAssignment-id}';
