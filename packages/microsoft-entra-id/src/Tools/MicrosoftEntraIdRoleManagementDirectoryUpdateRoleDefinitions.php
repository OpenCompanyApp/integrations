 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryUpdateRoleDefinitions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_update_role_definitions';
    protected const DESCRIPTION = 'Update unifiedRoleDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory/roleDefinitions/{unifiedRoleDefinition-id}.';
