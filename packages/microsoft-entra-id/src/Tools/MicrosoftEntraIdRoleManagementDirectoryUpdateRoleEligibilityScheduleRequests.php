 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}.
 */
class MicrosoftEntraIdRoleManagementDirectoryUpdateRoleEligibilityScheduleRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_directory_update_role_eligibility_schedule_requests';
    protected const DESCRIPTION = 'Update the navigation property roleEligibilityScheduleRequests in roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}.';
    ...
    protected const PATH = '/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}';
