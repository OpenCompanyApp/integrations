 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /roleManagement/directory.
 */
class MicrosoftEntraIdRoleManagementGetDirectory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_get_directory';
    protected const DESCRIPTION = 'Get directory from roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /roleManagement/directory.';
