 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /roleManagement/directory.
 */
class MicrosoftEntraIdRoleManagementUpdateDirectory extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_role_management_update_directory';
    protected const DESCRIPTION = 'Update the navigation property directory in roleManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /roleManagement/directory.';
    ...
    protected const PATH = '/roleManagement/directory';
