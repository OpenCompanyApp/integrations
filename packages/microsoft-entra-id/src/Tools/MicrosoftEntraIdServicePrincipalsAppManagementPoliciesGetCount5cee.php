 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/appManagementPolicies/$count.
 */
class MicrosoftEntraIdServicePrincipalsAppManagementPoliciesGetCount5cee extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_app_management_policies_get_count_5cee';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/appManagementPolicies/$count';
