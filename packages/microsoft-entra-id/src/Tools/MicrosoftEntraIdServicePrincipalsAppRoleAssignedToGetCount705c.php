 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo/$count.
 */
class MicrosoftEntraIdServicePrincipalsAppRoleAssignedToGetCount705c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_app_role_assigned_to_get_count_705c';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo/$count';
