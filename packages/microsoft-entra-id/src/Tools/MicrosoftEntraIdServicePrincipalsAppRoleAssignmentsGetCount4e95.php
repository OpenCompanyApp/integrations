 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/appRoleAssignments/$count.
 */
class MicrosoftEntraIdServicePrincipalsAppRoleAssignmentsGetCount4e95 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_app_role_assignments_get_count_4e95';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/appRoleAssignments/$count';
