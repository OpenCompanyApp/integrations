 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$count.
 */
class MicrosoftEntraIdServicePrincipalsClaimsMappingPoliciesGetCount832a extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_claims_mapping_policies_get_count_832a';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$count';
