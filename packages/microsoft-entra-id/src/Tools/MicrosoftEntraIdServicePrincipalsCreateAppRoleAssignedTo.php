 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo.
 */
class MicrosoftEntraIdServicePrincipalsCreateAppRoleAssignedTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_app_role_assigned_to';
    protected const DESCRIPTION = 'Grant an appRoleAssignment for a service principal\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo';
