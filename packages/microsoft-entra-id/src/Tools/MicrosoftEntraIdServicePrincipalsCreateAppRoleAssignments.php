 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/appRoleAssignments.
 */
class MicrosoftEntraIdServicePrincipalsCreateAppRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_app_role_assignments';
    protected const DESCRIPTION = 'Grant an appRoleAssignment to a service principal\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/appRoleAssignments.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/appRoleAssignments';
