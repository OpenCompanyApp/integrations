 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications.
 */
class MicrosoftEntraIdServicePrincipalsCreateDelegatedPermissionClassifications extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_delegated_permission_classifications';
    protected const DESCRIPTION = 'Create delegatedPermissionClassification\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications.';
