 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/endpoints.
 */
class MicrosoftEntraIdServicePrincipalsCreateEndpoints extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_endpoints';
    protected const DESCRIPTION = 'Create new navigation property to endpoints for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/endpoints.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/endpoints';
