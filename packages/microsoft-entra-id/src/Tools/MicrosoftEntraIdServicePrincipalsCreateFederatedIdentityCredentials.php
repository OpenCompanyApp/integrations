 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials.
 */
class MicrosoftEntraIdServicePrincipalsCreateFederatedIdentityCredentials extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_federated_identity_credentials';
    protected const DESCRIPTION = 'Create new navigation property to federatedIdentityCredentials for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials';
