 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsCreateRefClaimsMappingPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_ref_claims_mapping_policies';
    protected const DESCRIPTION = 'Assign claimsMappingPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$ref.';
