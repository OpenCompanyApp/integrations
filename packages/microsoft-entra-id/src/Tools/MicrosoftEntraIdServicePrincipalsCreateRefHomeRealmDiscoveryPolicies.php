 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsCreateRefHomeRealmDiscoveryPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_ref_home_realm_discovery_policies';
    protected const DESCRIPTION = 'Assign homeRealmDiscoveryPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$ref.';
