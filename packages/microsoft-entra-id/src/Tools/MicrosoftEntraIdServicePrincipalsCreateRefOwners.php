 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/owners/$ref.
 */
class MicrosoftEntraIdServicePrincipalsCreateRefOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_ref_owners';
    protected const DESCRIPTION = 'servicePrincipal: Add owner\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/owners/$ref.';
