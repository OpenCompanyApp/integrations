 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsCreateRefTokenIssuancePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_ref_token_issuance_policies';
    protected const DESCRIPTION = 'Create new navigation property ref to tokenIssuancePolicies for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$ref.';
