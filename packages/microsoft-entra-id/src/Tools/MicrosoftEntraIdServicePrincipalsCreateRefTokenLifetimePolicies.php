 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsCreateRefTokenLifetimePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_create_ref_token_lifetime_policies';
    protected const DESCRIPTION = 'Add tokenLifetimePolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$ref.';
