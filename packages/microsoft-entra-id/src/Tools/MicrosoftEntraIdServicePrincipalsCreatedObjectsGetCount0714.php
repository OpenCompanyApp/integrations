 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/createdObjects/$count.
 */
class MicrosoftEntraIdServicePrincipalsCreatedObjectsGetCount0714 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_created_objects_get_count_0714';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/createdObjects/$count';
