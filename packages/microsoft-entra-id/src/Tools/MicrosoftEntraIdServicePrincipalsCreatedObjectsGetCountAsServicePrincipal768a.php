 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/createdObjects/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdServicePrincipalsCreatedObjectsGetCountAsServicePrincipal768a extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_created_objects_get_count_as_service_principal_768a';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/createdObjects/graph.servicePrincipal/$count';
