 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications/$count.
 */
class MicrosoftEntraIdServicePrincipalsDelegatedPermissionClassificationsGetCount31f9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delegated_permission_classifications_get_count_31f9';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications/$count';
