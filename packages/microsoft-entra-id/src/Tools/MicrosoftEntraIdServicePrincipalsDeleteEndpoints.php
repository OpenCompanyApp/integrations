 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/endpoints/{endpoint-id}.
 */
class MicrosoftEntraIdServicePrincipalsDeleteEndpoints extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delete_endpoints';
    protected const DESCRIPTION = 'Delete navigation property endpoints for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/endpoints/{endpoint-id}.';
