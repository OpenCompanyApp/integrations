 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsDeleteRefClaimsMappingPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delete_ref_claims_mapping_policies';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$ref';
