 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsDeleteRefTokenLifetimePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delete_ref_token_lifetime_policies';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$ref';
