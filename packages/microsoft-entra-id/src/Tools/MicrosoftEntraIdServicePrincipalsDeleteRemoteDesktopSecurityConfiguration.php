 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration.
 */
class MicrosoftEntraIdServicePrincipalsDeleteRemoteDesktopSecurityConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delete_remote_desktop_security_configuration';
    protected const DESCRIPTION = 'Delete remoteDesktopSecurityConfiguration\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration';
