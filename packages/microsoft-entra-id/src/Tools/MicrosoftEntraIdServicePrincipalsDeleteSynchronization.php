 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/synchronization.
 */
class MicrosoftEntraIdServicePrincipalsDeleteSynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delete_synchronization';
    protected const DESCRIPTION = 'Delete navigation property synchronization for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/synchronization.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization';
