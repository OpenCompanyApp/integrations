 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/delta().
 */
class MicrosoftEntraIdServicePrincipalsDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_delta';
    ...
    protected const PATH = '/servicePrincipals/delta()';
