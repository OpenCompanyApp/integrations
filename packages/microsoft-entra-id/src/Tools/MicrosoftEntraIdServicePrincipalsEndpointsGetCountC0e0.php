 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/endpoints/$count.
 */
class MicrosoftEntraIdServicePrincipalsEndpointsGetCountC0e0 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_endpoints_get_count_c0e0';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/endpoints/$count';
