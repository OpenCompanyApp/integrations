 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials/$count.
 */
class MicrosoftEntraIdServicePrincipalsFederatedIdentityCredentialsGetCountD9cd extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_federated_identity_credentials_get_count_d9cd';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials/$count';
