 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdServicePrincipalsGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_available_extension_properties';
    ...
    protected const PATH = '/servicePrincipals/getAvailableExtensionProperties';
