 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/getByIds.
 */
class MicrosoftEntraIdServicePrincipalsGetByIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_by_ids';
    ...
    protected const PATH = '/servicePrincipals/getByIds';
