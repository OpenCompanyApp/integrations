 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/$count.
 */
class MicrosoftEntraIdServicePrincipalsGetCountDa6d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_count_da6d';
    ...
    protected const PATH = '/servicePrincipals/$count';
