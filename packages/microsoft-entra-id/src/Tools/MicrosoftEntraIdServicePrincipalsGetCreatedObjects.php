 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/createdObjects/{directoryObject-id}.
 */
class MicrosoftEntraIdServicePrincipalsGetCreatedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_created_objects';
    protected const DESCRIPTION = 'Get createdObjects from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/createdObjects/{directoryObject-id}.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/createdObjects/{directoryObject-id}';
