 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdServicePrincipalsGetMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_member_of';
    protected const DESCRIPTION = 'Get memberOf from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/memberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf/{directoryObject-id}';
