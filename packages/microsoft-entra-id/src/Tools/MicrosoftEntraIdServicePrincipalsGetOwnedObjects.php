 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}.
 */
class MicrosoftEntraIdServicePrincipalsGetOwnedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_owned_objects';
    protected const DESCRIPTION = 'Get ownedObjects from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}';
