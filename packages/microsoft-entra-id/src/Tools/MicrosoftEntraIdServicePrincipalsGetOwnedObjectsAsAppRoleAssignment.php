 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}/graph.appRoleAssignment.
 */
class MicrosoftEntraIdServicePrincipalsGetOwnedObjectsAsAppRoleAssignment extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_owned_objects_as_app_role_assignment';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.directoryObject as microsoft.graph.appRoleAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}/graph.appRoleAssignment.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}/graph.appRoleAssignment';
