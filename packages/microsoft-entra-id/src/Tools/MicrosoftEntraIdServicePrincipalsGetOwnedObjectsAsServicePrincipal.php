 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}/graph.servicePrincipal.
 */
class MicrosoftEntraIdServicePrincipalsGetOwnedObjectsAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_owned_objects_as_service_principal';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/{directoryObject-id}/graph.servicePrincipal';
