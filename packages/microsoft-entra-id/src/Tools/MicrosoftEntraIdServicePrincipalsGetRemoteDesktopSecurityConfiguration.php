 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration.
 */
class MicrosoftEntraIdServicePrincipalsGetRemoteDesktopSecurityConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_remote_desktop_security_configuration';
    protected const DESCRIPTION = 'Get remoteDesktopSecurityConfiguration\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration.';
