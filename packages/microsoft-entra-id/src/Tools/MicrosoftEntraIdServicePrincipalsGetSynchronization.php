 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization.
 */
class MicrosoftEntraIdServicePrincipalsGetSynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_synchronization';
    protected const DESCRIPTION = 'Get synchronization from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/synchronization.';
