 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdServicePrincipalsGetTransitiveMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_get_transitive_member_of';
    protected const DESCRIPTION = 'Get transitiveMemberOf from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/{directoryObject-id}';
