 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$count.
 */
class MicrosoftEntraIdServicePrincipalsHomeRealmDiscoveryPoliciesGetCountD161 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_home_realm_discovery_policies_get_count_d161';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$count';
