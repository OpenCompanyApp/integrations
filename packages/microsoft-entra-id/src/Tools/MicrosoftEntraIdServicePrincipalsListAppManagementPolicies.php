 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/appManagementPolicies.
 */
class MicrosoftEntraIdServicePrincipalsListAppManagementPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_app_management_policies';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/appManagementPolicies';
