 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo.
 */
class MicrosoftEntraIdServicePrincipalsListAppRoleAssignedTo extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_app_role_assigned_to';
