 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies.
 */
class MicrosoftEntraIdServicePrincipalsListClaimsMappingPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_claims_mapping_policies';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies';
