 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/createdObjects.
 */
class MicrosoftEntraIdServicePrincipalsListCreatedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_created_objects';
    protected const DESCRIPTION = 'servicePrincipal: List createdObjects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/createdObjects.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/createdObjects';
