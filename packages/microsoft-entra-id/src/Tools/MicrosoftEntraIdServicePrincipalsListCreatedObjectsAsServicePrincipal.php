 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/createdObjects/graph.servicePrincipal.
 */
class MicrosoftEntraIdServicePrincipalsListCreatedObjectsAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_created_objects_as_service_principal';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/createdObjects/graph.servicePrincipal';
