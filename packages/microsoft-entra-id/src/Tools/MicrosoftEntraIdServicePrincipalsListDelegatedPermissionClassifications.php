 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications.
 */
class MicrosoftEntraIdServicePrincipalsListDelegatedPermissionClassifications extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_delegated_permission_classifications';
    protected const DESCRIPTION = 'List delegatedPermissionClassifications collection of servicePrincipal\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/delegatedPermissionClassifications';
