 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials.
 */
class MicrosoftEntraIdServicePrincipalsListFederatedIdentityCredentials extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_federated_identity_credentials';
