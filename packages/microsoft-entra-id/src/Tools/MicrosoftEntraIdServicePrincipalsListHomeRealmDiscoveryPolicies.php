 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies.
 */
class MicrosoftEntraIdServicePrincipalsListHomeRealmDiscoveryPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_home_realm_discovery_policies';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies';
