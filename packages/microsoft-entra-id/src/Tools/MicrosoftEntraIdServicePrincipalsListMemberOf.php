 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf.
 */
class MicrosoftEntraIdServicePrincipalsListMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_member_of';
    protected const DESCRIPTION = 'List servicePrincipal memberOf\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/memberOf.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf';
