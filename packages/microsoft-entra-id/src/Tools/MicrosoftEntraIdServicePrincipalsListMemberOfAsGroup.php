 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf/graph.group.
 */
class MicrosoftEntraIdServicePrincipalsListMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_member_of_as_group';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf/graph.group';
