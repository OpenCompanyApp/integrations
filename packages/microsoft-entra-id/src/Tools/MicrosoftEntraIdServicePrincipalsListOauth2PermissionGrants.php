 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants.
 */
class MicrosoftEntraIdServicePrincipalsListOauth2PermissionGrants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_oauth2_permission_grants';
    protected const DESCRIPTION = 'List oauth2PermissionGrants granted to a service principal\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants';
