 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects.
 */
class MicrosoftEntraIdServicePrincipalsListOwnedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_owned_objects';
    protected const DESCRIPTION = 'servicePrincipals: List ownedObjects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/ownedObjects.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects';
