 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.servicePrincipal.
 */
class MicrosoftEntraIdServicePrincipalsListOwnedObjectsAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_owned_objects_as_service_principal';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.servicePrincipal';
