 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners.
 */
class MicrosoftEntraIdServicePrincipalsListOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_owners';
    protected const DESCRIPTION = 'Get owners from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/owners.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners';
