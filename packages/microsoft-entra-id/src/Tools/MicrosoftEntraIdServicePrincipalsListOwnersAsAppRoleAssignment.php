 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/graph.appRoleAssignment.
 */
class MicrosoftEntraIdServicePrincipalsListOwnersAsAppRoleAssignment extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_owners_as_app_role_assignment';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/graph.appRoleAssignment';
