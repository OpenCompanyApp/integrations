 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/graph.user.
 */
class MicrosoftEntraIdServicePrincipalsListOwnersAsUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_owners_as_user';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/graph.user';
