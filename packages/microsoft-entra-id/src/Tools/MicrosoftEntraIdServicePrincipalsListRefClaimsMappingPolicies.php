 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsListRefClaimsMappingPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_ref_claims_mapping_policies';
    protected const DESCRIPTION = 'List assigned claimsMappingPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/claimsMappingPolicies/$ref.';
