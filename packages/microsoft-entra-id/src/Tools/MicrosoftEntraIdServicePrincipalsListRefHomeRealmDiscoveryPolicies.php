 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsListRefHomeRealmDiscoveryPolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_ref_home_realm_discovery_policies';
    protected const DESCRIPTION = 'List assigned homeRealmDiscoveryPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$ref.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/homeRealmDiscoveryPolicies/$ref';
