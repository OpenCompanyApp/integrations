 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/$ref.
 */
class MicrosoftEntraIdServicePrincipalsListRefOwners extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_ref_owners';
    protected const DESCRIPTION = 'Get ref of owners from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/owners/$ref.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/$ref';
