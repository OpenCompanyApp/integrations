 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsListRefTokenIssuancePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_ref_token_issuance_policies';
    protected const DESCRIPTION = 'Get ref of tokenIssuancePolicies from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$ref.';
