 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$ref.
 */
class MicrosoftEntraIdServicePrincipalsListRefTokenLifetimePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_ref_token_lifetime_policies';
