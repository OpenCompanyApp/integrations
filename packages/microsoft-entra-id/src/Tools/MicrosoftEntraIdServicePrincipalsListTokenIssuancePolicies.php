 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies.
 */
class MicrosoftEntraIdServicePrincipalsListTokenIssuancePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_token_issuance_policies';
    protected const DESCRIPTION = 'Get tokenIssuancePolicies from servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies';
