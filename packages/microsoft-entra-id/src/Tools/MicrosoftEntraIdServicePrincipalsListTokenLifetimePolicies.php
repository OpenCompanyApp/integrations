 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies.
 */
class MicrosoftEntraIdServicePrincipalsListTokenLifetimePolicies extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_token_lifetime_policies';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies';
