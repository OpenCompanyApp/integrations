 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf.
 */
class MicrosoftEntraIdServicePrincipalsListTransitiveMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_transitive_member_of';
    protected const DESCRIPTION = 'List servicePrincipal transitive memberOf\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf';
