 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.directoryRole.
 */
class MicrosoftEntraIdServicePrincipalsListTransitiveMemberOfAsDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_list_transitive_member_of_as_directory_role';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.directoryRole in the microsoft.graph.directoryObject collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.directoryRole.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.directoryRole';
