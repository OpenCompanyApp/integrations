 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdServicePrincipalsMemberOfGetCountAsAdministrativeUnit472e extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_member_of_get_count_as_administrative_unit_472e';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf/graph.administrativeUnit/$count';
