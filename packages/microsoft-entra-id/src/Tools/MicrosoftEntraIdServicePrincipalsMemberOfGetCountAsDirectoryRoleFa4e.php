 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf/graph.directoryRole/$count.
 */
class MicrosoftEntraIdServicePrincipalsMemberOfGetCountAsDirectoryRoleFa4e extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_member_of_get_count_as_directory_role_fa4e';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf/graph.directoryRole/$count';
