 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf/graph.group/$count.
 */
class MicrosoftEntraIdServicePrincipalsMemberOfGetCountAsGroup96d9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_member_of_get_count_as_group_96d9';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf/graph.group/$count';
