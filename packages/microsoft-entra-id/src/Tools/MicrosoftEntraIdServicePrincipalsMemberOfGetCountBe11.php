 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/memberOf/$count.
 */
class MicrosoftEntraIdServicePrincipalsMemberOfGetCountBe11 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_member_of_get_count_be11';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/memberOf/$count';
