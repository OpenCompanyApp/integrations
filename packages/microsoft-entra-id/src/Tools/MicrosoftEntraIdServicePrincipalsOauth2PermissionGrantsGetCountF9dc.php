 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants/$count.
 */
class MicrosoftEntraIdServicePrincipalsOauth2PermissionGrantsGetCountF9dc extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_oauth2_permission_grants_get_count_f9dc';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants/$count';
