 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnedObjectsGetCount7ae7 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owned_objects_get_count_7ae7';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/$count';
