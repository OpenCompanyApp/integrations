 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.appRoleAssignment/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnedObjectsGetCountAsAppRoleAssignment793c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owned_objects_get_count_as_app_role_assignment_793c';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.appRoleAssignment/$count';
