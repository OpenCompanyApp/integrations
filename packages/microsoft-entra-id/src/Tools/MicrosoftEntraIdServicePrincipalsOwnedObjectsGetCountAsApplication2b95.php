 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.application/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnedObjectsGetCountAsApplication2b95 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owned_objects_get_count_as_application_2b95';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.application/$count';
