 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.endpoint/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnedObjectsGetCountAsEndpoint4594 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owned_objects_get_count_as_endpoint_4594';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.endpoint/$count';
