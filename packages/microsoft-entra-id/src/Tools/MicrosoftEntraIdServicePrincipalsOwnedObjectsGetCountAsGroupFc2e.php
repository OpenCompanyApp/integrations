 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.group/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnedObjectsGetCountAsGroupFc2e extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owned_objects_get_count_as_group_fc2e';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.group/$count';
