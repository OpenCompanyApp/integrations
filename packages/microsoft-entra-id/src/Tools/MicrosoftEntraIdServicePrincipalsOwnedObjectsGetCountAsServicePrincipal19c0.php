 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnedObjectsGetCountAsServicePrincipal19c0 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owned_objects_get_count_as_service_principal_19c0';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/ownedObjects/graph.servicePrincipal/$count';
