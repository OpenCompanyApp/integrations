 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/owners/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdServicePrincipalsOwnersDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owners_delete_ref_directory_object';
    protected const DESCRIPTION = 'Remove service principal owner\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/owners/{directoryObject-id}/$ref.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/{directoryObject-id}/$ref';
