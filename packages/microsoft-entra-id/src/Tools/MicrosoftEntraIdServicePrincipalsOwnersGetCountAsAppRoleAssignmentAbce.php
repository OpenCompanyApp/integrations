 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/graph.appRoleAssignment/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnersGetCountAsAppRoleAssignmentAbce extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owners_get_count_as_app_role_assignment_abce';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/graph.appRoleAssignment/$count';
