 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/graph.endpoint/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnersGetCountAsEndpoint9454 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owners_get_count_as_endpoint_9454';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/graph.endpoint/$count';
