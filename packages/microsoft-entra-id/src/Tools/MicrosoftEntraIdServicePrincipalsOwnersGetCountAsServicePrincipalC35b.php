 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnersGetCountAsServicePrincipalC35b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owners_get_count_as_service_principal_c35b';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/graph.servicePrincipal/$count';
