 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/owners/$count.
 */
class MicrosoftEntraIdServicePrincipalsOwnersGetCountEc9a extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_owners_get_count_ec9a';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/owners/$count';
