 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps/$count.
 */
class MicrosoftEntraIdServicePrincipalsRemoteDesktopSecurityConfigurationApprovedClientAppsGetCountBea1 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_remote_desktop_security_configuration_approved_client_apps_get_count_bea1';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps/$count';
