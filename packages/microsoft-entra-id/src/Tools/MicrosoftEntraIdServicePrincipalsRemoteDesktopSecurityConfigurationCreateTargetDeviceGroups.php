 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/targetDeviceGroups.
 */
class MicrosoftEntraIdServicePrincipalsRemoteDesktopSecurityConfigurationCreateTargetDeviceGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_remote_desktop_security_configuration_create_target_device_groups';
    protected const DESCRIPTION = 'Create targetDeviceGroup\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/targetDeviceGroups.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/targetDeviceGroups';
