 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps.
 */
class MicrosoftEntraIdServicePrincipalsRemoteDesktopSecurityConfigurationListApprovedClientApps extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_remote_desktop_security_configuration_list_approved_client_apps';
    protected const DESCRIPTION = 'List approvedClientApp objects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps';
