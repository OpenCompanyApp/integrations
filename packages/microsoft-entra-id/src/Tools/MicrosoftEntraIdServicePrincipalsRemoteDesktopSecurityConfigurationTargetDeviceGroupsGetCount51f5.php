 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/targetDeviceGroups/$count.
 */
class MicrosoftEntraIdServicePrincipalsRemoteDesktopSecurityConfigurationTargetDeviceGroupsGetCount51f5 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_remote_desktop_security_configuration_target_device_groups_get_count_51f5';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/targetDeviceGroups/$count';
