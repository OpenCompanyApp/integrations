 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps/{approvedClientApp-id}.
 */
class MicrosoftEntraIdServicePrincipalsRemoteDesktopSecurityConfigurationUpdateApprovedClientApps extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_remote_desktop_security_configuration_update_approved_client_apps';
    protected const DESCRIPTION = 'Update approvedClientApp\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration/approvedClientApps/{approvedClientApp-id}.';
