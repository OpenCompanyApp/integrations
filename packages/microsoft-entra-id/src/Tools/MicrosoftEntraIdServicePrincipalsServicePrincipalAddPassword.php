 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/addPassword.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalAddPassword extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_add_password';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/addPassword';
