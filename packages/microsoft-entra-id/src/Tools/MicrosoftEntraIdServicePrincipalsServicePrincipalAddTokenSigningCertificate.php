 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/addTokenSigningCertificate.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalAddTokenSigningCertificate extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_add_token_signing_certificate';
    protected const DESCRIPTION = 'Invoke action addTokenSigningCertificate\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/addTokenSigningCertificate.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/addTokenSigningCertificate';
