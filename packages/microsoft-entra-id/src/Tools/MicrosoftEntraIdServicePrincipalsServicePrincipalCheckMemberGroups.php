 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/checkMemberGroups.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalCheckMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_check_member_groups';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/checkMemberGroups';
