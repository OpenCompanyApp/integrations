 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalCreateServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_create_service_principal';
    protected const DESCRIPTION = 'Create servicePrincipal\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals.';
    ...
    protected const PATH = '/servicePrincipals';
