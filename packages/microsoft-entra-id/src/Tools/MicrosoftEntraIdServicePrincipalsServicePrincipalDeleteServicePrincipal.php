 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalDeleteServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_delete_service_principal';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}';
