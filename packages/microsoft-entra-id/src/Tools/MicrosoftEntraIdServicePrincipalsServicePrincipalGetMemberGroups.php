 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/getMemberGroups.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalGetMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_get_member_groups';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/getMemberGroups';
