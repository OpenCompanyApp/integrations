 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/getMemberObjects.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalGetMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_get_member_objects';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/getMemberObjects';
