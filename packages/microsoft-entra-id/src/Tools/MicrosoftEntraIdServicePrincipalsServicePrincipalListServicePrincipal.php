 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalListServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_list_service_principal';
    protected const DESCRIPTION = 'List servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals.';
