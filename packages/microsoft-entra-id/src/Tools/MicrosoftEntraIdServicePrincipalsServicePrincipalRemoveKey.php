 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/removeKey.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalRemoveKey extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_remove_key';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/removeKey';
