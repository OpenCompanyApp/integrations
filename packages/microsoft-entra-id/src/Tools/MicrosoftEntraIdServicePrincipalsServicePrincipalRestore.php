 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/restore.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_restore';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/restore';
