 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/synchronization/acquireAccessToken.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalSynchronizationAcquireAccessToken extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_synchronization_acquire_access_token';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/acquireAccessToken';
