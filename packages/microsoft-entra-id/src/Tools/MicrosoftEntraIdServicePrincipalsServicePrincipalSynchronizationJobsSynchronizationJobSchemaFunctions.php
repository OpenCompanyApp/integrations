 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/schema/functions().
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalSynchronizationJobsSynchronizationJobSchemaFunctions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_synchronization_jobs_synchronization_job_schema_functions';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/schema/functions()';
