 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/schema/parseExpression.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalSynchronizationJobsSynchronizationJobSchemaParseExpression extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_synchronization_jobs_synchronization_job_schema_parse_expression';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/schema/parseExpression';
