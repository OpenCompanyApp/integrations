 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/validateCredentials.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalSynchronizationJobsValidateCredentials extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_synchronization_jobs_validate_credentials';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/validateCredentials';
