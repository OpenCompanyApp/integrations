 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/functions().
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalSynchronizationTemplatesSynchronizationTemplateSchemaFunctions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_synchronization_templates_synchronization_template_schema_functions';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/functions()';
