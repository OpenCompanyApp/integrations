 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/parseExpression.
 */
class MicrosoftEntraIdServicePrincipalsServicePrincipalSynchronizationTemplatesSynchronizationTemplateSchemaParseExpression extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_service_principal_synchronization_templates_synchronization_template_schema_parse_expression';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/parseExpression';
    protected const PATH_PARAMS = ['servicePrincipal-id' => 'service_principal_id', 'synchronizationTemplate-id' => 'synchronization_template_id'];
