 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /servicePrincipals/{servicePrincipal-id}/synchronization.
 */
class MicrosoftEntraIdServicePrincipalsSetSynchronization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_set_synchronization';
    protected const DESCRIPTION = 'Update the navigation property synchronization in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /servicePrincipals/{servicePrincipal-id}/synchronization.';
