 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/synchronization/jobs.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationCreateJobs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_create_jobs';
    protected const DESCRIPTION = 'Create synchronizationJob\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/synchronization/jobs.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs';
