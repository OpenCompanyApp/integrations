 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/{servicePrincipal-id}/synchronization/templates.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationCreateTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_create_templates';
    protected const DESCRIPTION = 'Create new navigation property to templates for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /servicePrincipals/{servicePrincipal-id}/synchronization/templates.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/templates';
