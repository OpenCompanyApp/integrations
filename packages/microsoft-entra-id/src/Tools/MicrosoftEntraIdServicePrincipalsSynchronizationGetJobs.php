 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationGetJobs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_get_jobs';
    protected const DESCRIPTION = 'Get synchronizationJob\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}.';
