 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationJobsDeleteBulkUpload extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_jobs_delete_bulk_upload';
    protected const DESCRIPTION = 'Delete navigation property bulkUpload for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload.';
