 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload/$value.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationJobsDeleteBulkUploadContent extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_jobs_delete_bulk_upload_content';
    protected const DESCRIPTION = 'Delete media content for the navigation property bulkUpload in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload/$value.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload/$value';
