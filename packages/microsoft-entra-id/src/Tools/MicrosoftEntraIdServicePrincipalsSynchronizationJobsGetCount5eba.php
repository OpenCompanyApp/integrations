 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/$count.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationJobsGetCount5eba extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_jobs_get_count_5eba';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/$count';
