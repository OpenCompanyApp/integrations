 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationJobsUpdateBulkUpload extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_jobs_update_bulk_upload';
    protected const DESCRIPTION = 'Update the navigation property bulkUpload in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload';
