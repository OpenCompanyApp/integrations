 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload/$value.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationJobsUpdateBulkUploadContent extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_jobs_update_bulk_upload_content';
    protected const DESCRIPTION = 'Update media content for the navigation property bulkUpload in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/bulkUpload/$value.';
