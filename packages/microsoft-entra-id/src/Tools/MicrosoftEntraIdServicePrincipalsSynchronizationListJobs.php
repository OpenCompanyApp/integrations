 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/jobs.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationListJobs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_list_jobs';
    protected const DESCRIPTION = 'List synchronization jobs\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /servicePrincipals/{servicePrincipal-id}/synchronization/jobs.';
