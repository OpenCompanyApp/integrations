 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/secrets/$count.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationSecretsGetCount65c9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_secrets_get_count_65c9';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/secrets/$count';
