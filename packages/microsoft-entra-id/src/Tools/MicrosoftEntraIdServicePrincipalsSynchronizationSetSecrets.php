 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /servicePrincipals/{servicePrincipal-id}/synchronization/secrets.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationSetSecrets extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_set_secrets';
    protected const DESCRIPTION = 'Add synchronization secrets\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /servicePrincipals/{servicePrincipal-id}/synchronization/secrets.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/secrets';
