 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationTemplatesDeleteSchema extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_templates_delete_schema';
    protected const DESCRIPTION = 'Delete navigation property schema for servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema.';
