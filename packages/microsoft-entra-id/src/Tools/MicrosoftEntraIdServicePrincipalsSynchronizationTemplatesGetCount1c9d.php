 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/templates/$count.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationTemplatesGetCount1c9d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_templates_get_count_1c9d';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/templates/$count';
