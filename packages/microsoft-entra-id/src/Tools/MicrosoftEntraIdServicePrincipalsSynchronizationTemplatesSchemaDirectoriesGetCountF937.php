 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/directories/$count.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationTemplatesSchemaDirectoriesGetCountF937 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_templates_schema_directories_get_count_f937';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/directories/$count';
