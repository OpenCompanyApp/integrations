 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}/schema/directories.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationTemplatesSchemaListDirectories extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_templates_schema_list_directories';
