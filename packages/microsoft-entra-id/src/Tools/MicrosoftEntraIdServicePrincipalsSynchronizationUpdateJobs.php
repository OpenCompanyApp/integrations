 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationUpdateJobs extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_update_jobs';
    protected const DESCRIPTION = 'Update the navigation property jobs in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}';
