 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}.
 */
class MicrosoftEntraIdServicePrincipalsSynchronizationUpdateTemplates extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_synchronization_update_templates';
    protected const DESCRIPTION = 'Update the navigation property templates in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}.';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}';
