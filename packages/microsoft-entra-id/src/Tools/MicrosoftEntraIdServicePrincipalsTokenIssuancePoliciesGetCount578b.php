 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$count.
 */
class MicrosoftEntraIdServicePrincipalsTokenIssuancePoliciesGetCount578b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_token_issuance_policies_get_count_578b';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/tokenIssuancePolicies/$count';
