 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$count.
 */
class MicrosoftEntraIdServicePrincipalsTokenLifetimePoliciesGetCount4121 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_token_lifetime_policies_get_count_4121';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/tokenLifetimePolicies/$count';
