 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/$count.
 */
class MicrosoftEntraIdServicePrincipalsTransitiveMemberOfGetCount4794 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_transitive_member_of_get_count_4794';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/$count';
