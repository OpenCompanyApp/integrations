 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdServicePrincipalsTransitiveMemberOfGetCountAsAdministrativeUnit4450 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_transitive_member_of_get_count_as_administrative_unit_4450';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.administrativeUnit/$count';
