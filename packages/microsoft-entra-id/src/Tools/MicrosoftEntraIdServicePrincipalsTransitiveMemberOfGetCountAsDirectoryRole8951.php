 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.directoryRole/$count.
 */
class MicrosoftEntraIdServicePrincipalsTransitiveMemberOfGetCountAsDirectoryRole8951 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_transitive_member_of_get_count_as_directory_role_8951';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.directoryRole/$count';
