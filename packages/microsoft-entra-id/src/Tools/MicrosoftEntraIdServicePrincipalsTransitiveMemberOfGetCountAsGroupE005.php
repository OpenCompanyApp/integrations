 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.group/$count.
 */
class MicrosoftEntraIdServicePrincipalsTransitiveMemberOfGetCountAsGroupE005 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_transitive_member_of_get_count_as_group_e005';
    ...
    protected const PATH = '/servicePrincipals/{servicePrincipal-id}/transitiveMemberOf/graph.group/$count';
