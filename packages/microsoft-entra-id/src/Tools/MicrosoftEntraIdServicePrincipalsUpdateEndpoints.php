 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /servicePrincipals/{servicePrincipal-id}/endpoints/{endpoint-id}.
 */
class MicrosoftEntraIdServicePrincipalsUpdateEndpoints extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_update_endpoints';
    protected const DESCRIPTION = 'Update the navigation property endpoints in servicePrincipals\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /servicePrincipals/{servicePrincipal-id}/endpoints/{endpoint-id}.';
