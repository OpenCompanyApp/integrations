 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration.
 */
class MicrosoftEntraIdServicePrincipalsUpdateRemoteDesktopSecurityConfiguration extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_update_remote_desktop_security_configuration';
    protected const DESCRIPTION = 'Update remoteDesktopSecurityConfiguration\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /servicePrincipals/{servicePrincipal-id}/remoteDesktopSecurityConfiguration.';
