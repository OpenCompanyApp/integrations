 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /servicePrincipals/validateProperties.
 */
class MicrosoftEntraIdServicePrincipalsValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_service_principals_validate_properties';
    ...
    protected const PATH = '/servicePrincipals/validateProperties';
