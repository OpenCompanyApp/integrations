 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /subscribedSkus.
 */
class MicrosoftEntraIdSubscribedSkusSubscribedSkuCreateSubscribedSku extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_subscribed_skus_subscribed_sku_create_subscribed_sku';
    protected const DESCRIPTION = 'Add new entity to subscribedSkus\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /subscribedSkus.';
    ...
    protected const PATH = '/subscribedSkus';
