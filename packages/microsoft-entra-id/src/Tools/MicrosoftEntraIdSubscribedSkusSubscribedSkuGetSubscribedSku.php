 ...
 * Get subscribedSku.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /subscribedSkus/{subscribedSku-id}.
 */
class MicrosoftEntraIdSubscribedSkusSubscribedSkuGetSubscribedSku extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_subscribed_skus_subscribed_sku_get_subscribed_sku';
    protected const DESCRIPTION = 'Get subscribedSku\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /subscribedSkus/{subscribedSku-id}.';
