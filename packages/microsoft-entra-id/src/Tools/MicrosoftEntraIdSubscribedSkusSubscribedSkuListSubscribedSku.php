 ...
 * List subscribedSkus.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /subscribedSkus.
 */
class MicrosoftEntraIdSubscribedSkusSubscribedSkuListSubscribedSku extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_subscribed_skus_subscribed_sku_list_subscribed_sku';
    protected const DESCRIPTION = 'List subscribedSkus\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /subscribedSkus.';
