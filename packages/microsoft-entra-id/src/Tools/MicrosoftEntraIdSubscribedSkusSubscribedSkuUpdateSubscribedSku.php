 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /subscribedSkus/{subscribedSku-id}.
 */
class MicrosoftEntraIdSubscribedSkusSubscribedSkuUpdateSubscribedSku extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_subscribed_skus_subscribed_sku_update_subscribed_sku';
    protected const DESCRIPTION = 'Update entity in subscribedSkus\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /subscribedSkus/{subscribedSku-id}.';
