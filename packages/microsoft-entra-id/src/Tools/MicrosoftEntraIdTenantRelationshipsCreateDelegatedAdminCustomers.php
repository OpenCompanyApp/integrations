 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /tenantRelationships/delegatedAdminCustomers.
 */
class MicrosoftEntraIdTenantRelationshipsCreateDelegatedAdminCustomers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_create_delegated_admin_customers';
    protected const DESCRIPTION = 'Create new navigation property to delegatedAdminCustomers for tenantRelationships\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /tenantRelationships/delegatedAdminCustomers.';
    ...
    protected const PATH = '/tenantRelationships/delegatedAdminCustomers';
