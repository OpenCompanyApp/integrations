 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /tenantRelationships/delegatedAdminRelationships.
 */
class MicrosoftEntraIdTenantRelationshipsCreateDelegatedAdminRelationships extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_create_delegated_admin_relationships';
    protected const DESCRIPTION = 'Create delegatedAdminRelationship\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /tenantRelationships/delegatedAdminRelationships.';
    ...
    protected const PATH = '/tenantRelationships/delegatedAdminRelationships';
