 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/delegatedAdminCustomers/$count.
 */
class MicrosoftEntraIdTenantRelationshipsDelegatedAdminCustomersGetCountE293 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_delegated_admin_customers_get_count_e293';
    ...
    protected const PATH = '/tenantRelationships/delegatedAdminCustomers/$count';
