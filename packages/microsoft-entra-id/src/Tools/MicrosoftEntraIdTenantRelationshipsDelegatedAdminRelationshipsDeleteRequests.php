 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/requests/{delegatedAdminRelationshipRequest-id}.
 */
class MicrosoftEntraIdTenantRelationshipsDelegatedAdminRelationshipsDeleteRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_delegated_admin_relationships_delete_requests';
    protected const DESCRIPTION = 'Delete navigation property requests for tenantRelationships\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/requests/{delegatedAdminRelationshipRequest-id}.';
