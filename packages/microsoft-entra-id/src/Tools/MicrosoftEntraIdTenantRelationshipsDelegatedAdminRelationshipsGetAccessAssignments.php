 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/accessAssignments/{delegatedAdminAccessAssignment-id}.
 */
class MicrosoftEntraIdTenantRelationshipsDelegatedAdminRelationshipsGetAccessAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_delegated_admin_relationships_get_access_assignments';
    protected const DESCRIPTION = 'Get delegatedAdminAccessAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/accessAssignments/{delegatedAdminAccessAssignment-id}.';
