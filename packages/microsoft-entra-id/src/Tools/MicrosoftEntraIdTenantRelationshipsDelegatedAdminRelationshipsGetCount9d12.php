 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/delegatedAdminRelationships/$count.
 */
class MicrosoftEntraIdTenantRelationshipsDelegatedAdminRelationshipsGetCount9d12 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_delegated_admin_relationships_get_count_9d12';
    ...
    protected const PATH = '/tenantRelationships/delegatedAdminRelationships/$count';
