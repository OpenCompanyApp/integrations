 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/requests/{delegatedAdminRelationshipRequest-id}.
 */
class MicrosoftEntraIdTenantRelationshipsDelegatedAdminRelationshipsGetRequests extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_delegated_admin_relationships_get_requests';
    protected const DESCRIPTION = 'Get delegatedAdminRelationshipRequest\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/requests/{delegatedAdminRelationshipRequest-id}.';
