 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/accessAssignments/{delegatedAdminAccessAssignment-id}.
 */
class MicrosoftEntraIdTenantRelationshipsDelegatedAdminRelationshipsUpdateAccessAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_delegated_admin_relationships_update_access_assignments';
    protected const DESCRIPTION = 'Update delegatedAdminAccessAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}/accessAssignments/{delegatedAdminAccessAssignment-id}.';
