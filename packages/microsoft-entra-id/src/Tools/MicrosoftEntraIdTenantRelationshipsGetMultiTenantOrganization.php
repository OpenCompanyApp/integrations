 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/multiTenantOrganization.
 */
class MicrosoftEntraIdTenantRelationshipsGetMultiTenantOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_get_multi_tenant_organization';
    protected const DESCRIPTION = 'Get multiTenantOrganization\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/multiTenantOrganization.';
