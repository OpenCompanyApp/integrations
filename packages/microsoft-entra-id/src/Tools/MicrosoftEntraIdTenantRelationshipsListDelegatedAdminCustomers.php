 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/delegatedAdminCustomers.
 */
class MicrosoftEntraIdTenantRelationshipsListDelegatedAdminCustomers extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_list_delegated_admin_customers';
    protected const DESCRIPTION = 'List delegatedAdminCustomers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/delegatedAdminCustomers.';
