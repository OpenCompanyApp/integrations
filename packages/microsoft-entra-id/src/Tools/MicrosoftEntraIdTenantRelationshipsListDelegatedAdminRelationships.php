 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/delegatedAdminRelationships.
 */
class MicrosoftEntraIdTenantRelationshipsListDelegatedAdminRelationships extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_list_delegated_admin_relationships';
    protected const DESCRIPTION = 'List delegatedAdminRelationships\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/delegatedAdminRelationships.';
