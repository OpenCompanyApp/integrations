 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /tenantRelationships/multiTenantOrganization/tenants.
 */
class MicrosoftEntraIdTenantRelationshipsMultiTenantOrganizationCreateTenants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_multi_tenant_organization_create_tenants';
    protected const DESCRIPTION = 'Add multiTenantOrganizationMember\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /tenantRelationships/multiTenantOrganization/tenants.';
    ...
    protected const PATH = '/tenantRelationships/multiTenantOrganization/tenants';
