 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember-id}.
 */
class MicrosoftEntraIdTenantRelationshipsMultiTenantOrganizationDeleteTenants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_multi_tenant_organization_delete_tenants';
    protected const DESCRIPTION = 'Remove multiTenantOrganizationMember\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember-id}.';
