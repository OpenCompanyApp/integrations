 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/multiTenantOrganization/joinRequest.
 */
class MicrosoftEntraIdTenantRelationshipsMultiTenantOrganizationGetJoinRequest extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_multi_tenant_organization_get_join_request';
    protected const DESCRIPTION = 'Get multiTenantOrganizationJoinRequestRecord\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/multiTenantOrganization/joinRequest.';
    ...
    protected const PATH = '/tenantRelationships/multiTenantOrganization/joinRequest';
