 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember-id}.
 */
class MicrosoftEntraIdTenantRelationshipsMultiTenantOrganizationGetTenants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_multi_tenant_organization_get_tenants';
    protected const DESCRIPTION = 'Get multiTenantOrganizationMember\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember-id}.';
