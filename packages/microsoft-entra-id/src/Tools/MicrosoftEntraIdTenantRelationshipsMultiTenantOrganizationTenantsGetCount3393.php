 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships/multiTenantOrganization/tenants/$count.
 */
class MicrosoftEntraIdTenantRelationshipsMultiTenantOrganizationTenantsGetCount3393 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_multi_tenant_organization_tenants_get_count_3393';
    ...
    protected const PATH = '/tenantRelationships/multiTenantOrganization/tenants/$count';
