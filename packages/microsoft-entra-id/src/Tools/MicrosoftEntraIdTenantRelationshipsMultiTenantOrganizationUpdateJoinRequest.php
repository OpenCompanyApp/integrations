 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /tenantRelationships/multiTenantOrganization/joinRequest.
 */
class MicrosoftEntraIdTenantRelationshipsMultiTenantOrganizationUpdateJoinRequest extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_multi_tenant_organization_update_join_request';
    protected const DESCRIPTION = 'Update multiTenantOrganizationJoinRequestRecord\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /tenantRelationships/multiTenantOrganization/joinRequest.';
