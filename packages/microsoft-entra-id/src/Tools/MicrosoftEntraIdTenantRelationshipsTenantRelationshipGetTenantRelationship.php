 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /tenantRelationships.
 */
class MicrosoftEntraIdTenantRelationshipsTenantRelationshipGetTenantRelationship extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_tenant_relationship_get_tenant_relationship';
    protected const DESCRIPTION = 'Get tenantRelationships\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /tenantRelationships.';
