 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /tenantRelationships.
 */
class MicrosoftEntraIdTenantRelationshipsTenantRelationshipUpdateTenantRelationship extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_tenant_relationship_update_tenant_relationship';
    protected const DESCRIPTION = 'Update tenantRelationships\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /tenantRelationships.';
    ...
    protected const PATH = '/tenantRelationships';
