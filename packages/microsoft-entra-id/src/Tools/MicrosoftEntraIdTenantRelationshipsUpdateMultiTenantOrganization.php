 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /tenantRelationships/multiTenantOrganization.
 */
class MicrosoftEntraIdTenantRelationshipsUpdateMultiTenantOrganization extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_tenant_relationships_update_multi_tenant_organization';
    protected const DESCRIPTION = 'Update multiTenantOrganization\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /tenantRelationships/multiTenantOrganization.';
    ...
    protected const PATH = '/tenantRelationships/multiTenantOrganization';
