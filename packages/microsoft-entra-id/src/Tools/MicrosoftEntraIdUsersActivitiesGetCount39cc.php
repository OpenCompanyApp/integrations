 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/activities/$count.
 */
class MicrosoftEntraIdUsersActivitiesGetCount39cc extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_activities_get_count_39cc';
    ...
    protected const PATH = '/users/{user-id}/activities/$count';
