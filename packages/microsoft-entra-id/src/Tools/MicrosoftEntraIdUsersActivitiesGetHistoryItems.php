 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}.
 */
class MicrosoftEntraIdUsersActivitiesGetHistoryItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_activities_get_history_items';
