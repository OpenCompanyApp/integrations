 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}/activity.
 */
class MicrosoftEntraIdUsersActivitiesHistoryItemsGetActivity extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_activities_history_items_get_activity';
    protected const DESCRIPTION = 'Get activity from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}/activity.';
    ...
    protected const PATH = '/users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}/activity';
