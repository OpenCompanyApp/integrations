 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}.
 */
class MicrosoftEntraIdUsersActivitiesUpdateHistoryItems extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_activities_update_history_items';
    protected const DESCRIPTION = 'Update the navigation property historyItems in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}.';
