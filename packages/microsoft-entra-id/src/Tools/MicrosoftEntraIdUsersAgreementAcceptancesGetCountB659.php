 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/agreementAcceptances/$count.
 */
class MicrosoftEntraIdUsersAgreementAcceptancesGetCountB659 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_agreement_acceptances_get_count_b659';
    ...
    protected const PATH = '/users/{user-id}/agreementAcceptances/$count';
