 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/appRoleAssignments/$count.
 */
class MicrosoftEntraIdUsersAppRoleAssignmentsGetCountD180 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_app_role_assignments_get_count_d180';
    ...
    protected const PATH = '/users/{user-id}/appRoleAssignments/$count';
