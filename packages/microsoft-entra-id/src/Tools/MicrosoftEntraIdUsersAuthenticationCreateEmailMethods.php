 ...
 * Create emailMethod.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/emailMethods.
 */
class MicrosoftEntraIdUsersAuthenticationCreateEmailMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_email_methods';
    protected const DESCRIPTION = 'Create emailMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/emailMethods.';
