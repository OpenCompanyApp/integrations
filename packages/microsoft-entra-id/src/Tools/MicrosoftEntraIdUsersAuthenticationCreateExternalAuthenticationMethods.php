 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/externalAuthenticationMethods.
 */
class MicrosoftEntraIdUsersAuthenticationCreateExternalAuthenticationMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_external_authentication_methods';
    protected const DESCRIPTION = 'Create externalAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/externalAuthenticationMethods.';
