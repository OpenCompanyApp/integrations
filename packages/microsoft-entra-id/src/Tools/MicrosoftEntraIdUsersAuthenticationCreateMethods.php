 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/methods.
 */
class MicrosoftEntraIdUsersAuthenticationCreateMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_methods';
    protected const DESCRIPTION = 'Create new navigation property to methods for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/methods.';
    ...
    protected const PATH = '/users/{user-id}/authentication/methods';
