 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/operations.
 */
class MicrosoftEntraIdUsersAuthenticationCreateOperations extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/operations.';
    ...
    protected const PATH = '/users/{user-id}/authentication/operations';
