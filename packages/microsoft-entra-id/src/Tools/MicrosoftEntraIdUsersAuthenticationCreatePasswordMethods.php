 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/passwordMethods.
 */
class MicrosoftEntraIdUsersAuthenticationCreatePasswordMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_password_methods';
    protected const DESCRIPTION = 'Create new navigation property to passwordMethods for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/passwordMethods.';
    ...
    protected const PATH = '/users/{user-id}/authentication/passwordMethods';
