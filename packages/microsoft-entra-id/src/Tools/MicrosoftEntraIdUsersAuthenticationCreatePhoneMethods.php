 ...
 * Create phoneMethod.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/phoneMethods.
 */
class MicrosoftEntraIdUsersAuthenticationCreatePhoneMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_phone_methods';
    protected const DESCRIPTION = 'Create phoneMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/phoneMethods.';
