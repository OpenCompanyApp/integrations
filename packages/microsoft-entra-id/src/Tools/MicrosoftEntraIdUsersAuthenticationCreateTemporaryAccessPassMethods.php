 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/temporaryAccessPassMethods.
 */
class MicrosoftEntraIdUsersAuthenticationCreateTemporaryAccessPassMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_create_temporary_access_pass_methods';
    protected const DESCRIPTION = 'Create temporaryAccessPassMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/temporaryAccessPassMethods.';
    ...
    protected const PATH = '/users/{user-id}/authentication/temporaryAccessPassMethods';
