 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/authentication/externalAuthenticationMethods/{externalAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationDeleteExternalAuthenticationMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_delete_external_authentication_methods';
    protected const DESCRIPTION = 'Delete externalAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/authentication/externalAuthenticationMethods/{externalAuthenticationMethod-id}.';
