 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationDeleteMicrosoftAuthenticatorMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_delete_microsoft_authenticator_methods';
    protected const DESCRIPTION = 'Delete microsoftAuthenticatorAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod-id}.';
