 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationDeletePhoneMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_delete_phone_methods';
    protected const DESCRIPTION = 'Delete navigation property phoneMethods for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}.';
    ...
    protected const PATH = '/users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}';
