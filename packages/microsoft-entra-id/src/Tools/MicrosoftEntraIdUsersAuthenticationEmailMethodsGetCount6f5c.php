 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/emailMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationEmailMethodsGetCount6f5c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_email_methods_get_count_6f5c';
    ...
    protected const PATH = '/users/{user-id}/authentication/emailMethods/$count';
