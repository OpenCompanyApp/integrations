 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/externalAuthenticationMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationExternalAuthenticationMethodsGetCountD9e5 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_external_authentication_methods_get_count_d9e5';
    ...
    protected const PATH = '/users/{user-id}/authentication/externalAuthenticationMethods/$count';
