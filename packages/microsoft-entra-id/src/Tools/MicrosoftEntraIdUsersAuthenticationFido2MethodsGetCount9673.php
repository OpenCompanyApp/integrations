 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/fido2Methods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationFido2MethodsGetCount9673 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_fido2_methods_get_count_9673';
    ...
    protected const PATH = '/users/{user-id}/authentication/fido2Methods/$count';
