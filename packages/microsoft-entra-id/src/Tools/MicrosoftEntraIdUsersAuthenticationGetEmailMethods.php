 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/emailMethods/{emailAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationGetEmailMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_get_email_methods';
