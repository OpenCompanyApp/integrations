 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/externalAuthenticationMethods/{externalAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationGetExternalAuthenticationMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_get_external_authentication_methods';
    protected const DESCRIPTION = 'Get externalAuthenticationMethods from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/externalAuthenticationMethods/{externalAuthenticationMethod-id}.';
