 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationGetPhoneMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_get_phone_methods';
    protected const DESCRIPTION = 'Get phoneMethods from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}.';
