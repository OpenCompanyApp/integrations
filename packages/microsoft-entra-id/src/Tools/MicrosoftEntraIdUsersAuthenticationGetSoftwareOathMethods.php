 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/softwareOathMethods/{softwareOathAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationGetSoftwareOathMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_get_software_oath_methods';
    protected const DESCRIPTION = 'Get softwareOathMethods from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/softwareOathMethods/{softwareOathAuthenticationMethod-id}.';
