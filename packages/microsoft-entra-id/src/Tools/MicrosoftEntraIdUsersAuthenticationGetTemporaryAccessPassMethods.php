 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationGetTemporaryAccessPassMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_get_temporary_access_pass_methods';
    protected const DESCRIPTION = 'Get temporaryAccessPassAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethod-id}.';
