 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationGetWindowsHelloForBusinessMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_get_windows_hello_for_business_methods';
    protected const DESCRIPTION = 'Get windowsHelloForBusinessAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod-id}.';
