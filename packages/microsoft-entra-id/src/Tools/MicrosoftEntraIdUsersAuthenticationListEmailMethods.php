 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/emailMethods.
 */
class MicrosoftEntraIdUsersAuthenticationListEmailMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_list_email_methods';
    protected const DESCRIPTION = 'Get emailMethods from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/emailMethods.';
    ...
    protected const PATH = '/users/{user-id}/authentication/emailMethods';
