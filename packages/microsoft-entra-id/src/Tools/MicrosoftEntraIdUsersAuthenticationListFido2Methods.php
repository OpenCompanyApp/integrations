 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/fido2Methods.
 */
class MicrosoftEntraIdUsersAuthenticationListFido2Methods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_list_fido2_methods';
    ...
    protected const PATH = '/users/{user-id}/authentication/fido2Methods';
