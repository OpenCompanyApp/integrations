 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/microsoftAuthenticatorMethods.
 */
class MicrosoftEntraIdUsersAuthenticationListMicrosoftAuthenticatorMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_list_microsoft_authenticator_methods';
    protected const DESCRIPTION = 'List microsoftAuthenticatorAuthenticationMethods\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/microsoftAuthenticatorMethods.';
    ...
    protected const PATH = '/users/{user-id}/authentication/microsoftAuthenticatorMethods';
