 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/platformCredentialMethods.
 */
class MicrosoftEntraIdUsersAuthenticationListPlatformCredentialMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_list_platform_credential_methods';
    ...
    protected const PATH = '/users/{user-id}/authentication/platformCredentialMethods';
