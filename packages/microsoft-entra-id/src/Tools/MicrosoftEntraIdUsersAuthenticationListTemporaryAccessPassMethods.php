 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/temporaryAccessPassMethods.
 */
class MicrosoftEntraIdUsersAuthenticationListTemporaryAccessPassMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_list_temporary_access_pass_methods';
    protected const DESCRIPTION = 'List temporaryAccessPassMethods\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/temporaryAccessPassMethods.';
