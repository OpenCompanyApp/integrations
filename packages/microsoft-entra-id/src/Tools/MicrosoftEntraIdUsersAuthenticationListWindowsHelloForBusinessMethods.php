 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/windowsHelloForBusinessMethods.
 */
class MicrosoftEntraIdUsersAuthenticationListWindowsHelloForBusinessMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_list_windows_hello_for_business_methods';
    protected const DESCRIPTION = 'List windowsHelloForBusinessAuthenticationMethods\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/windowsHelloForBusinessMethods.';
    ...
    protected const PATH = '/users/{user-id}/authentication/windowsHelloForBusinessMethods';
