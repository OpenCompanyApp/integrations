 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/methods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationMethodsGetCount0da1 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_methods_get_count_0da1';
    ...
    protected const PATH = '/users/{user-id}/authentication/methods/$count';
