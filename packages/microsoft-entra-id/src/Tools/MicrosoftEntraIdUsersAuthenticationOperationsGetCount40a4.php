 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/operations/$count.
 */
class MicrosoftEntraIdUsersAuthenticationOperationsGetCount40a4 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_operations_get_count_40a4';
    ...
    protected const PATH = '/users/{user-id}/authentication/operations/$count';
