 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/passwordMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationPasswordMethodsGetCountEc55 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_password_methods_get_count_ec55';
    ...
    protected const PATH = '/users/{user-id}/authentication/passwordMethods/$count';
