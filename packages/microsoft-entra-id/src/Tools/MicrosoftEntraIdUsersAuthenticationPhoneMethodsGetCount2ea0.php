 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/phoneMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationPhoneMethodsGetCount2ea0 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_phone_methods_get_count_2ea0';
    ...
    protected const PATH = '/users/{user-id}/authentication/phoneMethods/$count';
