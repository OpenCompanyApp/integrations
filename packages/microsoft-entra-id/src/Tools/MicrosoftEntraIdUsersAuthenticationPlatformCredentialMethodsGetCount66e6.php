 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/platformCredentialMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationPlatformCredentialMethodsGetCount66e6 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_platform_credential_methods_get_count_66e6';
    ...
    protected const PATH = '/users/{user-id}/authentication/platformCredentialMethods/$count';
