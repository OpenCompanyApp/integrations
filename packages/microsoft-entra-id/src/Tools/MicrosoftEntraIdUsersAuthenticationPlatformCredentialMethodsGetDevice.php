 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethod-id}/device.
 */
class MicrosoftEntraIdUsersAuthenticationPlatformCredentialMethodsGetDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_platform_credential_methods_get_device';
    protected const DESCRIPTION = 'Get device from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethod-id}/device.';
    ...
    protected const PATH = '/users/{user-id}/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethod-id}/device';
