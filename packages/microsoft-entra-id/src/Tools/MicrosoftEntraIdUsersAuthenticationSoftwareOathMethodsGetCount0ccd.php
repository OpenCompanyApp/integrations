 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/softwareOathMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationSoftwareOathMethodsGetCount0ccd extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_software_oath_methods_get_count_0ccd';
    ...
    protected const PATH = '/users/{user-id}/authentication/softwareOathMethods/$count';
