 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/temporaryAccessPassMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationTemporaryAccessPassMethodsGetCount3b4c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_temporary_access_pass_methods_get_count_3b4c';
    ...
    protected const PATH = '/users/{user-id}/authentication/temporaryAccessPassMethods/$count';
