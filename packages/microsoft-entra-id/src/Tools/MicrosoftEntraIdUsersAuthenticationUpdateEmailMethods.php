 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/authentication/emailMethods/{emailAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationUpdateEmailMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_update_email_methods';
    protected const DESCRIPTION = 'Update emailAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/authentication/emailMethods/{emailAuthenticationMethod-id}.';
