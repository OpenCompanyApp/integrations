 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}.
 */
class MicrosoftEntraIdUsersAuthenticationUpdatePhoneMethods extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_update_phone_methods';
    protected const DESCRIPTION = 'Update phoneAuthenticationMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}.';
