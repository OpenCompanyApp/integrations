 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/windowsHelloForBusinessMethods/$count.
 */
class MicrosoftEntraIdUsersAuthenticationWindowsHelloForBusinessMethodsGetCount0479 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_authentication_windows_hello_for_business_methods_get_count_0479';
    ...
    protected const PATH = '/users/{user-id}/authentication/windowsHelloForBusinessMethods/$count';
