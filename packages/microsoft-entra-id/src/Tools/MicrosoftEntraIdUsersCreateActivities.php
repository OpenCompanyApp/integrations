 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/activities.
 */
class MicrosoftEntraIdUsersCreateActivities extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_activities';
    protected const DESCRIPTION = 'Create new navigation property to activities for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/activities.';
    ...
    protected const PATH = '/users/{user-id}/activities';
