 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/appRoleAssignments.
 */
class MicrosoftEntraIdUsersCreateAppRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_app_role_assignments';
    protected const DESCRIPTION = 'Create appRoleAssignment (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/appRoleAssignments.';
    ...
    protected const PATH = '/users/{user-id}/appRoleAssignments';
