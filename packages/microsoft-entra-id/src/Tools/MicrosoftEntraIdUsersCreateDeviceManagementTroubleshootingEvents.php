 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/deviceManagementTroubleshootingEvents.
 */
class MicrosoftEntraIdUsersCreateDeviceManagementTroubleshootingEvents extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_device_management_troubleshooting_events';
    protected const DESCRIPTION = 'Create new navigation property to deviceManagementTroubleshootingEvents for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/deviceManagementTroubleshootingEvents.';
    ...
    protected const PATH = '/users/{user-id}/deviceManagementTroubleshootingEvents';
