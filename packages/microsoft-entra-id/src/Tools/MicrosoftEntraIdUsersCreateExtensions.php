 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/extensions.
 */
class MicrosoftEntraIdUsersCreateExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_extensions';
    protected const DESCRIPTION = 'Create new navigation property to extensions for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/extensions.';
    ...
    protected const PATH = '/users/{user-id}/extensions';
