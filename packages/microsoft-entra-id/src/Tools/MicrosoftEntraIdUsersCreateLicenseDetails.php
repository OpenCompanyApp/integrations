 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/licenseDetails.
 */
class MicrosoftEntraIdUsersCreateLicenseDetails extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_license_details';
    protected const DESCRIPTION = 'Create new navigation property to licenseDetails for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/licenseDetails.';
    ...
    protected const PATH = '/users/{user-id}/licenseDetails';
