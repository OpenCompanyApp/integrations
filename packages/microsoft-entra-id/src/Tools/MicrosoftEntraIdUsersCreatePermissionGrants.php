 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/permissionGrants.
 */
class MicrosoftEntraIdUsersCreatePermissionGrants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_permission_grants';
    protected const DESCRIPTION = 'Create new navigation property to permissionGrants for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/permissionGrants.';
    ...
    protected const PATH = '/users/{user-id}/permissionGrants';
