 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/sponsors/$ref.
 */
class MicrosoftEntraIdUsersCreateRefSponsors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_ref_sponsors';
    protected const DESCRIPTION = 'Add sponsors (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/sponsors/$ref.';
