 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/scopedRoleMemberOf.
 */
class MicrosoftEntraIdUsersCreateScopedRoleMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_create_scoped_role_member_of';
    protected const DESCRIPTION = 'Create new navigation property to scopedRoleMemberOf for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/scopedRoleMemberOf.';
    ...
    protected const PATH = '/users/{user-id}/scopedRoleMemberOf';
