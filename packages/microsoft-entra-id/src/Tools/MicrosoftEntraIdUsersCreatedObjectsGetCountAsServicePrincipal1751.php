 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/createdObjects/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdUsersCreatedObjectsGetCountAsServicePrincipal1751 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_created_objects_get_count_as_service_principal_1751';
    ...
    protected const PATH = '/users/{user-id}/createdObjects/graph.servicePrincipal/$count';
