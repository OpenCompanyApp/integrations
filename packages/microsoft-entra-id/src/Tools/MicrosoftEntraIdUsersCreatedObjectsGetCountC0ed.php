 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/createdObjects/$count.
 */
class MicrosoftEntraIdUsersCreatedObjectsGetCountC0ed extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_created_objects_get_count_c0ed';
    ...
    protected const PATH = '/users/{user-id}/createdObjects/$count';
