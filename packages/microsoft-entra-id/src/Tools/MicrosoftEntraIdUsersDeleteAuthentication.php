 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/authentication.
 */
class MicrosoftEntraIdUsersDeleteAuthentication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_delete_authentication';
    protected const DESCRIPTION = 'Delete navigation property authentication for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/authentication.';
