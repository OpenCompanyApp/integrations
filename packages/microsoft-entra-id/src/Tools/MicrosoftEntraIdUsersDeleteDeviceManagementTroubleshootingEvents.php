 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftEntraIdUsersDeleteDeviceManagementTroubleshootingEvents extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_delete_device_management_troubleshooting_events';
    protected const DESCRIPTION = 'Delete navigation property deviceManagementTroubleshootingEvents for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.';
