 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onPremisesSyncBehavior.
 */
class MicrosoftEntraIdUsersDeleteOnPremisesSyncBehavior extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_delete_on_premises_sync_behavior';
    protected const DESCRIPTION = 'Delete navigation property onPremisesSyncBehavior for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/onPremisesSyncBehavior.';
