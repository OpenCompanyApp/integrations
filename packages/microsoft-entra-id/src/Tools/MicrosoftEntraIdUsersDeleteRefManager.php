 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/manager/$ref.
 */
class MicrosoftEntraIdUsersDeleteRefManager extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_delete_ref_manager';
    protected const DESCRIPTION = 'Remove manager (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/manager/$ref.';
    ...
    protected const PATH = '/users/{user-id}/manager/$ref';
