 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/sponsors/$ref.
 */
class MicrosoftEntraIdUsersDeleteRefSponsors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_delete_ref_sponsors';
    ...
    protected const PATH = '/users/{user-id}/sponsors/$ref';
