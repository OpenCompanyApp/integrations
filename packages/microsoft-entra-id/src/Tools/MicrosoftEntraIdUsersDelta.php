 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/delta().
 */
class MicrosoftEntraIdUsersDelta extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_delta';
    ...
    protected const PATH = '/users/delta()';
