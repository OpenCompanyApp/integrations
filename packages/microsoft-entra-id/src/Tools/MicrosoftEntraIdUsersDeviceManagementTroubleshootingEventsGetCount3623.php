 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/deviceManagementTroubleshootingEvents/$count.
 */
class MicrosoftEntraIdUsersDeviceManagementTroubleshootingEventsGetCount3623 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_device_management_troubleshooting_events_get_count_3623';
    ...
    protected const PATH = '/users/{user-id}/deviceManagementTroubleshootingEvents/$count';
