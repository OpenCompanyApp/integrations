 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports/$count.
 */
class MicrosoftEntraIdUsersDirectReportsGetCount0678 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_direct_reports_get_count_0678';
    ...
    protected const PATH = '/users/{user-id}/directReports/$count';
