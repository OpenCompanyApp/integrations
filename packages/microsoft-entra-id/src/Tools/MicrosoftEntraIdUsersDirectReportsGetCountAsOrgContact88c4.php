 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports/graph.orgContact/$count.
 */
class MicrosoftEntraIdUsersDirectReportsGetCountAsOrgContact88c4 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_direct_reports_get_count_as_org_contact_88c4';
    ...
    protected const PATH = '/users/{user-id}/directReports/graph.orgContact/$count';
