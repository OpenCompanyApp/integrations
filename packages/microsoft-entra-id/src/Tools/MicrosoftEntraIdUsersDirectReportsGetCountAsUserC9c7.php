 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports/graph.user/$count.
 */
class MicrosoftEntraIdUsersDirectReportsGetCountAsUserC9c7 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_direct_reports_get_count_as_user_c9c7';
    ...
    protected const PATH = '/users/{user-id}/directReports/graph.user/$count';
