 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/extensions/$count.
 */
class MicrosoftEntraIdUsersExtensionsGetCount4b1c extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_extensions_get_count_4b1c';
    ...
    protected const PATH = '/users/{user-id}/extensions/$count';
