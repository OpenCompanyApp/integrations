 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication.
 */
class MicrosoftEntraIdUsersGetAuthentication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_authentication';
    protected const DESCRIPTION = 'Get authentication from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication.';
