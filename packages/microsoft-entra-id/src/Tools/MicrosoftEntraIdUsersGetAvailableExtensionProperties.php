 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/getAvailableExtensionProperties.
 */
class MicrosoftEntraIdUsersGetAvailableExtensionProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_available_extension_properties';
    ...
    protected const PATH = '/users/getAvailableExtensionProperties';
