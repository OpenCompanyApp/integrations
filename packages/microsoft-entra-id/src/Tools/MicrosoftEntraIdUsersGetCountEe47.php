 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/$count.
 */
class MicrosoftEntraIdUsersGetCountEe47 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_count_ee47';
