 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/createdObjects/{directoryObject-id}.
 */
class MicrosoftEntraIdUsersGetCreatedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_created_objects';
    protected const DESCRIPTION = 'Get createdObjects from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/createdObjects/{directoryObject-id}.';
    ...
    protected const PATH = '/users/{user-id}/createdObjects/{directoryObject-id}';
