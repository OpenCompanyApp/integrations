 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/createdObjects/{directoryObject-id}/graph.servicePrincipal.
 */
class MicrosoftEntraIdUsersGetCreatedObjectsAsServicePrincipal extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_created_objects_as_service_principal';
    ...
    protected const PATH = '/users/{user-id}/createdObjects/{directoryObject-id}/graph.servicePrincipal';
