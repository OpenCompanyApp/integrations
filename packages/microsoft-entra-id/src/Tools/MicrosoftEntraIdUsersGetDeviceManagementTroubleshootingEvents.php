 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftEntraIdUsersGetDeviceManagementTroubleshootingEvents extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_device_management_troubleshooting_events';
