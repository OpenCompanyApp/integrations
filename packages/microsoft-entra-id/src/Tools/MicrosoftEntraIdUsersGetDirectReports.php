 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports/{directoryObject-id}.
 */
class MicrosoftEntraIdUsersGetDirectReports extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_direct_reports';
    protected const DESCRIPTION = 'Get directReports from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/directReports/{directoryObject-id}.';
    ...
    protected const PATH = '/users/{user-id}/directReports/{directoryObject-id}';
