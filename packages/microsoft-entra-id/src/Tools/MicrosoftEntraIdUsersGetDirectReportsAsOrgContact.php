 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports/{directoryObject-id}/graph.orgContact.
 */
class MicrosoftEntraIdUsersGetDirectReportsAsOrgContact extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_direct_reports_as_org_contact';
    ...
    protected const PATH = '/users/{user-id}/directReports/{directoryObject-id}/graph.orgContact';
