 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/inferenceClassification.
 */
class MicrosoftEntraIdUsersGetInferenceClassification extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_inference_classification';
    protected const DESCRIPTION = 'Get inferenceClassification from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/inferenceClassification.';
