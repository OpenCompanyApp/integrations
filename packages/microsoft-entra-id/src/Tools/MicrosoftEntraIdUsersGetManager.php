 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/manager.
 */
class MicrosoftEntraIdUsersGetManager extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_manager';
    ...
    protected const PATH = '/users/{user-id}/manager';
