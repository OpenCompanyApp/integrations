 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdUsersGetMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_member_of';
    protected const DESCRIPTION = 'Get memberOf from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/memberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/users/{user-id}/memberOf/{directoryObject-id}';
