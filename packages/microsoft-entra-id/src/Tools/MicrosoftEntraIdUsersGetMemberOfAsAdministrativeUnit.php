 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/{directoryObject-id}/graph.administrativeUnit.
 */
class MicrosoftEntraIdUsersGetMemberOfAsAdministrativeUnit extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_member_of_as_administrative_unit';
    ...
    protected const PATH = '/users/{user-id}/memberOf/{directoryObject-id}/graph.administrativeUnit';
