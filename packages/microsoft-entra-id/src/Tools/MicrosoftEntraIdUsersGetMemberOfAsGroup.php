 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdUsersGetMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_member_of_as_group';
    protected const DESCRIPTION = 'List a user\'s direct memberships\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/memberOf/{directoryObject-id}/graph.group.';
    ...
    protected const PATH = '/users/{user-id}/memberOf/{directoryObject-id}/graph.group';
