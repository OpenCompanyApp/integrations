 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onPremisesSyncBehavior.
 */
class MicrosoftEntraIdUsersGetOnPremisesSyncBehavior extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_on_premises_sync_behavior';
    protected const DESCRIPTION = 'Get onPremisesSyncBehavior from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/onPremisesSyncBehavior.';
