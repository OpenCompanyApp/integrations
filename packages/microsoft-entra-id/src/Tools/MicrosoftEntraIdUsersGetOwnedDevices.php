 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/{directoryObject-id}.
 */
class MicrosoftEntraIdUsersGetOwnedDevices extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_owned_devices';
    protected const DESCRIPTION = 'Get ownedDevices from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/ownedDevices/{directoryObject-id}.';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/{directoryObject-id}';
