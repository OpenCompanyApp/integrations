 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/{directoryObject-id}/graph.appRoleAssignment.
 */
class MicrosoftEntraIdUsersGetOwnedDevicesAsAppRoleAssignment extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_owned_devices_as_app_role_assignment';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/{directoryObject-id}/graph.appRoleAssignment';
