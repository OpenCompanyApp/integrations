 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/{directoryObject-id}/graph.device.
 */
class MicrosoftEntraIdUsersGetOwnedDevicesAsDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_owned_devices_as_device';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/{directoryObject-id}/graph.device';
