 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedObjects/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdUsersGetOwnedObjectsAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_owned_objects_as_group';
    ...
    protected const PATH = '/users/{user-id}/ownedObjects/{directoryObject-id}/graph.group';
