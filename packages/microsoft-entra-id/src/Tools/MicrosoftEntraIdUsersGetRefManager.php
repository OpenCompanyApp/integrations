 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/manager/$ref.
 */
class MicrosoftEntraIdUsersGetRefManager extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_ref_manager';
    protected const DESCRIPTION = 'List manager (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/manager/$ref.';
