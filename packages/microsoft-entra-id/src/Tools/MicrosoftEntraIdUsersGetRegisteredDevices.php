 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/{directoryObject-id}.
 */
class MicrosoftEntraIdUsersGetRegisteredDevices extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_registered_devices';
    protected const DESCRIPTION = 'Get registeredDevices from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/registeredDevices/{directoryObject-id}.';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/{directoryObject-id}';
