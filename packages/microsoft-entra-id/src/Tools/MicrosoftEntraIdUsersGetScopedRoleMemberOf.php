 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/scopedRoleMemberOf/{scopedRoleMembership-id}.
 */
class MicrosoftEntraIdUsersGetScopedRoleMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_scoped_role_member_of';
