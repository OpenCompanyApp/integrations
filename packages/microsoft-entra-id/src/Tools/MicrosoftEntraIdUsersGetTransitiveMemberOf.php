 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/{directoryObject-id}.
 */
class MicrosoftEntraIdUsersGetTransitiveMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_transitive_member_of';
    protected const DESCRIPTION = 'Get transitiveMemberOf from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/transitiveMemberOf/{directoryObject-id}.';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/{directoryObject-id}';
