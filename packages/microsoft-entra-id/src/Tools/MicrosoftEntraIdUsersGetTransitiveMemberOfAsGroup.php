 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/{directoryObject-id}/graph.group.
 */
class MicrosoftEntraIdUsersGetTransitiveMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_get_transitive_member_of_as_group';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/{directoryObject-id}/graph.group';
