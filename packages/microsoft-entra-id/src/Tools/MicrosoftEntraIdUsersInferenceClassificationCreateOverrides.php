 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/inferenceClassification/overrides.
 */
class MicrosoftEntraIdUsersInferenceClassificationCreateOverrides extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_inference_classification_create_overrides';
    protected const DESCRIPTION = 'Create new navigation property to overrides for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/inferenceClassification/overrides.';
    ...
    protected const PATH = '/users/{user-id}/inferenceClassification/overrides';
