 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/inferenceClassification/overrides/{inferenceClassificationOverride-id}.
 */
class MicrosoftEntraIdUsersInferenceClassificationDeleteOverrides extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_inference_classification_delete_overrides';
    protected const DESCRIPTION = 'Delete navigation property overrides for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/inferenceClassification/overrides/{inferenceClassificationOverride-id}.';
