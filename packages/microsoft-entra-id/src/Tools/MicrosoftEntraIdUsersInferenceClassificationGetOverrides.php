 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/inferenceClassification/overrides/{inferenceClassificationOverride-id}.
 */
class MicrosoftEntraIdUsersInferenceClassificationGetOverrides extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_inference_classification_get_overrides';
    protected const DESCRIPTION = 'Get overrides from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/inferenceClassification/overrides/{inferenceClassificationOverride-id}.';
