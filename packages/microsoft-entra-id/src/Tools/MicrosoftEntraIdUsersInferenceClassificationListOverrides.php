 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/inferenceClassification/overrides.
 */
class MicrosoftEntraIdUsersInferenceClassificationListOverrides extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_inference_classification_list_overrides';
