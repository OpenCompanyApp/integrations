 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/inferenceClassification/overrides/$count.
 */
class MicrosoftEntraIdUsersInferenceClassificationOverridesGetCountF355 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_inference_classification_overrides_get_count_f355';
    ...
    protected const PATH = '/users/{user-id}/inferenceClassification/overrides/$count';
