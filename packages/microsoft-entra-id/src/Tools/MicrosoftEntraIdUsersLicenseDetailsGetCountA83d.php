 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/licenseDetails/$count.
 */
class MicrosoftEntraIdUsersLicenseDetailsGetCountA83d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_license_details_get_count_a83d';
    ...
    protected const PATH = '/users/{user-id}/licenseDetails/$count';
