 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/activities.
 */
class MicrosoftEntraIdUsersListActivities extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_activities';
