 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/agreementAcceptances.
 */
class MicrosoftEntraIdUsersListAgreementAcceptances extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_agreement_acceptances';
    ...
    protected const PATH = '/users/{user-id}/agreementAcceptances';
