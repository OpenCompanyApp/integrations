 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/appRoleAssignments.
 */
class MicrosoftEntraIdUsersListAppRoleAssignments extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_app_role_assignments';
    protected const DESCRIPTION = 'List appRoleAssignments (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/appRoleAssignments.';
