 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/createdObjects.
 */
class MicrosoftEntraIdUsersListCreatedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_created_objects';
    ...
    protected const PATH = '/users/{user-id}/createdObjects';
