 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/deviceManagementTroubleshootingEvents.
 */
class MicrosoftEntraIdUsersListDeviceManagementTroubleshootingEvents extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_device_management_troubleshooting_events';
    protected const DESCRIPTION = 'Get deviceManagementTroubleshootingEvents from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/deviceManagementTroubleshootingEvents.';
