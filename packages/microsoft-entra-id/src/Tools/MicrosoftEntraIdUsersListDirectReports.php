 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports.
 */
class MicrosoftEntraIdUsersListDirectReports extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_direct_reports';
    protected const DESCRIPTION = 'List directReports (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/directReports.';
    ...
    protected const PATH = '/users/{user-id}/directReports';
