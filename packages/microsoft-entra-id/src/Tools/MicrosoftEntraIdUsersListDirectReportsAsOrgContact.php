 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/directReports/graph.orgContact.
 */
class MicrosoftEntraIdUsersListDirectReportsAsOrgContact extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_direct_reports_as_org_contact';
    ...
    protected const PATH = '/users/{user-id}/directReports/graph.orgContact';
