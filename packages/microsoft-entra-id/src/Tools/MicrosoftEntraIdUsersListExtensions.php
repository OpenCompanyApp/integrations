 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/extensions.
 */
class MicrosoftEntraIdUsersListExtensions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_extensions';
