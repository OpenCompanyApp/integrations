 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf.
 */
class MicrosoftEntraIdUsersListMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_member_of';
    protected const DESCRIPTION = 'List agentUser direct memberships\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/memberOf.';
    ...
    protected const PATH = '/users/{user-id}/memberOf';
