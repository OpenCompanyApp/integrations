 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/graph.group.
 */
class MicrosoftEntraIdUsersListMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_member_of_as_group';
    ...
    protected const PATH = '/users/{user-id}/memberOf/graph.group';
