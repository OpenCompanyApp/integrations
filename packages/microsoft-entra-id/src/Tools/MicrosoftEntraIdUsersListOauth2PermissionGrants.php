 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/oauth2PermissionGrants.
 */
class MicrosoftEntraIdUsersListOauth2PermissionGrants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_oauth2_permission_grants';
    protected const DESCRIPTION = 'List a user\'s oauth2PermissionGrants\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/oauth2PermissionGrants.';
    ...
    protected const PATH = '/users/{user-id}/oauth2PermissionGrants';
