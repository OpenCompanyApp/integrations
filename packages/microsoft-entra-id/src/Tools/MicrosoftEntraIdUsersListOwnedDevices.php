 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices.
 */
class MicrosoftEntraIdUsersListOwnedDevices extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_owned_devices';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices';
