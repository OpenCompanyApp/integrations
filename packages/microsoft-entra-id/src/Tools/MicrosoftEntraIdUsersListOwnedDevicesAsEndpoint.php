 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/graph.endpoint.
 */
class MicrosoftEntraIdUsersListOwnedDevicesAsEndpoint extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_owned_devices_as_endpoint';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/graph.endpoint';
