 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedObjects.
 */
class MicrosoftEntraIdUsersListOwnedObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_owned_objects';
    protected const DESCRIPTION = 'List ownedObjects (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/ownedObjects.';
    ...
    protected const PATH = '/users/{user-id}/ownedObjects';
