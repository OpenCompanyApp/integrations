 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/people.
 */
class MicrosoftEntraIdUsersListPeople extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_people';
    ...
    protected const PATH = '/users/{user-id}/people';
