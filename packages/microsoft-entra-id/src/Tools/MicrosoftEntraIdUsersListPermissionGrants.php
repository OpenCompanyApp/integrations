 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/permissionGrants.
 */
class MicrosoftEntraIdUsersListPermissionGrants extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_permission_grants';
    protected const DESCRIPTION = 'List permissionGrants of a user\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/permissionGrants.';
