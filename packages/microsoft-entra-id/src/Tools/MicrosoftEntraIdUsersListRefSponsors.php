 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/sponsors/$ref.
 */
class MicrosoftEntraIdUsersListRefSponsors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_ref_sponsors';
    protected const DESCRIPTION = 'List sponsors (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/sponsors/$ref.';
