 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/graph.appRoleAssignment.
 */
class MicrosoftEntraIdUsersListRegisteredDevicesAsAppRoleAssignment extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_registered_devices_as_app_role_assignment';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/graph.appRoleAssignment';
