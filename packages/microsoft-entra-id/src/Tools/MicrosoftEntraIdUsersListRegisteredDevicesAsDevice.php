 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/graph.device.
 */
class MicrosoftEntraIdUsersListRegisteredDevicesAsDevice extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_registered_devices_as_device';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/graph.device';
