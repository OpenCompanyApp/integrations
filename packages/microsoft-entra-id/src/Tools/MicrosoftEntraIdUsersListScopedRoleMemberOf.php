 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/scopedRoleMemberOf.
 */
class MicrosoftEntraIdUsersListScopedRoleMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_scoped_role_member_of';
    protected const DESCRIPTION = 'Get scopedRoleMemberOf from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/scopedRoleMemberOf.';
