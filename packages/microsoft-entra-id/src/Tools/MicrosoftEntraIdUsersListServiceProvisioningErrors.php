 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/serviceProvisioningErrors.
 */
class MicrosoftEntraIdUsersListServiceProvisioningErrors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_service_provisioning_errors';
    ...
    protected const PATH = '/users/{user-id}/serviceProvisioningErrors';
