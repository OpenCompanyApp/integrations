 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/sponsors.
 */
class MicrosoftEntraIdUsersListSponsors extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_sponsors';
    ...
    protected const PATH = '/users/{user-id}/sponsors';
