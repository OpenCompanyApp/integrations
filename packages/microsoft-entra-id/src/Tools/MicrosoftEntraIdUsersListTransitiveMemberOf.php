 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf.
 */
class MicrosoftEntraIdUsersListTransitiveMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_transitive_member_of';
    protected const DESCRIPTION = 'List transitiveMemberOf\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/transitiveMemberOf.';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf';
