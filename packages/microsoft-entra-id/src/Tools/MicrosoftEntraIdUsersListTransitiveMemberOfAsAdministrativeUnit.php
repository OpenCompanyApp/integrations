 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/graph.administrativeUnit.
 */
class MicrosoftEntraIdUsersListTransitiveMemberOfAsAdministrativeUnit extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_transitive_member_of_as_administrative_unit';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/graph.administrativeUnit';
