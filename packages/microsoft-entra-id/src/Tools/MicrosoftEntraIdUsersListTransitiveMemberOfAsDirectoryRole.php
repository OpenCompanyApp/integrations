 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/graph.directoryRole.
 */
class MicrosoftEntraIdUsersListTransitiveMemberOfAsDirectoryRole extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_transitive_member_of_as_directory_role';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/graph.directoryRole';
