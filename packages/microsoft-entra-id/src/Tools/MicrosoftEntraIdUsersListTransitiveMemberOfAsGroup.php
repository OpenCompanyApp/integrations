 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/graph.group.
 */
class MicrosoftEntraIdUsersListTransitiveMemberOfAsGroup extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_list_transitive_member_of_as_group';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/graph.group';
