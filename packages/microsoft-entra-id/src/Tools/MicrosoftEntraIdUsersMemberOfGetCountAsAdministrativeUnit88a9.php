 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdUsersMemberOfGetCountAsAdministrativeUnit88a9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_member_of_get_count_as_administrative_unit_88a9';
    ...
    protected const PATH = '/users/{user-id}/memberOf/graph.administrativeUnit/$count';
