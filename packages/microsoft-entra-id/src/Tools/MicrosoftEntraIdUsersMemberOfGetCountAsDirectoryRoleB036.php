 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/graph.directoryRole/$count.
 */
class MicrosoftEntraIdUsersMemberOfGetCountAsDirectoryRoleB036 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_member_of_get_count_as_directory_role_b036';
    ...
    protected const PATH = '/users/{user-id}/memberOf/graph.directoryRole/$count';
