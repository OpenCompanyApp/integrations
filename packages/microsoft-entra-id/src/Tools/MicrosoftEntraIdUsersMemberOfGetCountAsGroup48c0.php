 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/graph.group/$count.
 */
class MicrosoftEntraIdUsersMemberOfGetCountAsGroup48c0 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_member_of_get_count_as_group_48c0';
    ...
    protected const PATH = '/users/{user-id}/memberOf/graph.group/$count';
