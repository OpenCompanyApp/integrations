 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/memberOf/$count.
 */
class MicrosoftEntraIdUsersMemberOfGetCountFc20 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_member_of_get_count_fc20';
    ...
    protected const PATH = '/users/{user-id}/memberOf/$count';
