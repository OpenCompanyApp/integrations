 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/oauth2PermissionGrants/$count.
 */
class MicrosoftEntraIdUsersOauth2PermissionGrantsGetCountFb7b extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_oauth2_permission_grants_get_count_fb7b';
    ...
    protected const PATH = '/users/{user-id}/oauth2PermissionGrants/$count';
