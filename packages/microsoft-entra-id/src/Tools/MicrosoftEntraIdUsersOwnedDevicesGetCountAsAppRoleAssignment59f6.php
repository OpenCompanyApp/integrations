 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/graph.appRoleAssignment/$count.
 */
class MicrosoftEntraIdUsersOwnedDevicesGetCountAsAppRoleAssignment59f6 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_devices_get_count_as_app_role_assignment_59f6';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/graph.appRoleAssignment/$count';
