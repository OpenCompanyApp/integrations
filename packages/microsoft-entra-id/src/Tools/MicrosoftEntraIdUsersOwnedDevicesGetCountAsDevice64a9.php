 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/graph.device/$count.
 */
class MicrosoftEntraIdUsersOwnedDevicesGetCountAsDevice64a9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_devices_get_count_as_device_64a9';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/graph.device/$count';
