 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/graph.endpoint/$count.
 */
class MicrosoftEntraIdUsersOwnedDevicesGetCountAsEndpointBd17 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_devices_get_count_as_endpoint_bd17';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/graph.endpoint/$count';
