 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedDevices/$count.
 */
class MicrosoftEntraIdUsersOwnedDevicesGetCountE76d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_devices_get_count_e76d';
    ...
    protected const PATH = '/users/{user-id}/ownedDevices/$count';
