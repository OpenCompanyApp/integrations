 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedObjects/$count.
 */
class MicrosoftEntraIdUsersOwnedObjectsGetCount2c09 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_objects_get_count_2c09';
    ...
    protected const PATH = '/users/{user-id}/ownedObjects/$count';
