 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedObjects/graph.application/$count.
 */
class MicrosoftEntraIdUsersOwnedObjectsGetCountAsApplication1b6d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_objects_get_count_as_application_1b6d';
    ...
    protected const PATH = '/users/{user-id}/ownedObjects/graph.application/$count';
