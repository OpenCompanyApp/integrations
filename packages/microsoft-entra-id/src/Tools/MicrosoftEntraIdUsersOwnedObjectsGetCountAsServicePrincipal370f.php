 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/ownedObjects/graph.servicePrincipal/$count.
 */
class MicrosoftEntraIdUsersOwnedObjectsGetCountAsServicePrincipal370f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_owned_objects_get_count_as_service_principal_370f';
    ...
    protected const PATH = '/users/{user-id}/ownedObjects/graph.servicePrincipal/$count';
