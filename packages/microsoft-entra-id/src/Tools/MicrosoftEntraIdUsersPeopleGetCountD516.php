 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/people/$count.
 */
class MicrosoftEntraIdUsersPeopleGetCountD516 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_people_get_count_d516';
    ...
    protected const PATH = '/users/{user-id}/people/$count';
