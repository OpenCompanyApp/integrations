 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/permissionGrants/$count.
 */
class MicrosoftEntraIdUsersPermissionGrantsGetCount07aa extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_permission_grants_get_count_07aa';
    ...
    protected const PATH = '/users/{user-id}/permissionGrants/$count';
