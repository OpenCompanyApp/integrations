 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/$count.
 */
class MicrosoftEntraIdUsersRegisteredDevicesGetCount0403 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_registered_devices_get_count_0403';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/$count';
