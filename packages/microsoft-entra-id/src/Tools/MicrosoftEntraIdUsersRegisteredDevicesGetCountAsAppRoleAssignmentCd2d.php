 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/graph.appRoleAssignment/$count.
 */
class MicrosoftEntraIdUsersRegisteredDevicesGetCountAsAppRoleAssignmentCd2d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_registered_devices_get_count_as_app_role_assignment_cd2d';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/graph.appRoleAssignment/$count';
