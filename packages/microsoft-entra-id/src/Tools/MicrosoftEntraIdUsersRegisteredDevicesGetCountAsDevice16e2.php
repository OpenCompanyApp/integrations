 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/graph.device/$count.
 */
class MicrosoftEntraIdUsersRegisteredDevicesGetCountAsDevice16e2 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_registered_devices_get_count_as_device_16e2';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/graph.device/$count';
