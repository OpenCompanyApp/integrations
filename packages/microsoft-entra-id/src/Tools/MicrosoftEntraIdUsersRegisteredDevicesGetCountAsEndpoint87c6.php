 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/registeredDevices/graph.endpoint/$count.
 */
class MicrosoftEntraIdUsersRegisteredDevicesGetCountAsEndpoint87c6 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_registered_devices_get_count_as_endpoint_87c6';
    ...
    protected const PATH = '/users/{user-id}/registeredDevices/graph.endpoint/$count';
