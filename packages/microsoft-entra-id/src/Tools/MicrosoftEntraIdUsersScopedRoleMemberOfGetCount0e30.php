 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/scopedRoleMemberOf/$count.
 */
class MicrosoftEntraIdUsersScopedRoleMemberOfGetCount0e30 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_scoped_role_member_of_get_count_0e30';
    ...
    protected const PATH = '/users/{user-id}/scopedRoleMemberOf/$count';
