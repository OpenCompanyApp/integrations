 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/serviceProvisioningErrors/$count.
 */
class MicrosoftEntraIdUsersServiceProvisioningErrorsGetCountBccc extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_service_provisioning_errors_get_count_bccc';
    ...
    protected const PATH = '/users/{user-id}/serviceProvisioningErrors/$count';
