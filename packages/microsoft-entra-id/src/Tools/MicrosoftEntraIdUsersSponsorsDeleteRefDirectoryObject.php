 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/sponsors/{directoryObject-id}/$ref.
 */
class MicrosoftEntraIdUsersSponsorsDeleteRefDirectoryObject extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_sponsors_delete_ref_directory_object';
    protected const DESCRIPTION = 'Remove sponsor (for agentUser)\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/sponsors/{directoryObject-id}/$ref.';
    ...
    protected const PATH = '/users/{user-id}/sponsors/{directoryObject-id}/$ref';
