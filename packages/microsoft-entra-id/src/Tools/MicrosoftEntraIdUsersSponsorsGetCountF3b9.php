 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/sponsors/$count.
 */
class MicrosoftEntraIdUsersSponsorsGetCountF3b9 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_sponsors_get_count_f3b9';
    ...
    protected const PATH = '/users/{user-id}/sponsors/$count';
