 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/graph.administrativeUnit/$count.
 */
class MicrosoftEntraIdUsersTransitiveMemberOfGetCountAsAdministrativeUnit9c79 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_transitive_member_of_get_count_as_administrative_unit_9c79';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/graph.administrativeUnit/$count';
