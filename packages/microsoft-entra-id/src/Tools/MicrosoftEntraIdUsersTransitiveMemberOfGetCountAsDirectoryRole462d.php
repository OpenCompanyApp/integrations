 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/graph.directoryRole/$count.
 */
class MicrosoftEntraIdUsersTransitiveMemberOfGetCountAsDirectoryRole462d extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_transitive_member_of_get_count_as_directory_role_462d';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/graph.directoryRole/$count';
