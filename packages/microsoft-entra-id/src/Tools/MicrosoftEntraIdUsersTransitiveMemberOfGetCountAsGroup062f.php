 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/graph.group/$count.
 */
class MicrosoftEntraIdUsersTransitiveMemberOfGetCountAsGroup062f extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_transitive_member_of_get_count_as_group_062f';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/graph.group/$count';
