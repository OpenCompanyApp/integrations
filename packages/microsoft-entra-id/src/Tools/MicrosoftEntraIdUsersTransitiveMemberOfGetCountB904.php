 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/transitiveMemberOf/$count.
 */
class MicrosoftEntraIdUsersTransitiveMemberOfGetCountB904 extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_transitive_member_of_get_count_b904';
    ...
    protected const PATH = '/users/{user-id}/transitiveMemberOf/$count';
