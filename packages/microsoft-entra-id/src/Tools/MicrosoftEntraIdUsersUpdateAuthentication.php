 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/authentication.
 */
class MicrosoftEntraIdUsersUpdateAuthentication extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_update_authentication';
    protected const DESCRIPTION = 'Update the navigation property authentication in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/authentication.';
    ...
    protected const PATH = '/users/{user-id}/authentication';
