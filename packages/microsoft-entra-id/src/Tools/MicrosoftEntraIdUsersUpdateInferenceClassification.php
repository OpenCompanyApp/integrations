 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/inferenceClassification.
 */
class MicrosoftEntraIdUsersUpdateInferenceClassification extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_update_inference_classification';
    protected const DESCRIPTION = 'Update the navigation property inferenceClassification in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/inferenceClassification.';
    ...
    protected const PATH = '/users/{user-id}/inferenceClassification';
