 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/onPremisesSyncBehavior.
 */
class MicrosoftEntraIdUsersUpdateOnPremisesSyncBehavior extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_update_on_premises_sync_behavior';
    protected const DESCRIPTION = 'Update the navigation property onPremisesSyncBehavior in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/onPremisesSyncBehavior.';
    ...
    protected const PATH = '/users/{user-id}/onPremisesSyncBehavior';
