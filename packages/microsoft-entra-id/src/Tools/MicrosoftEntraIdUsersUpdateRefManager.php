 ...
 * Assign manager.
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /users/{user-id}/manager/$ref.
 */
class MicrosoftEntraIdUsersUpdateRefManager extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_update_ref_manager';
    protected const DESCRIPTION = 'Assign manager\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /users/{user-id}/manager/$ref.';
