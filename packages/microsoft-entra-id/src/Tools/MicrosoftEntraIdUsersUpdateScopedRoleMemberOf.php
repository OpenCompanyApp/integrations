 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/scopedRoleMemberOf/{scopedRoleMembership-id}.
 */
class MicrosoftEntraIdUsersUpdateScopedRoleMemberOf extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_update_scoped_role_member_of';
    protected const DESCRIPTION = 'Update the navigation property scopedRoleMemberOf in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/scopedRoleMemberOf/{scopedRoleMembership-id}.';
