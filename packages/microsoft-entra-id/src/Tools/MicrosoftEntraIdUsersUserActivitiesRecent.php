 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/activities/recent().
 */
class MicrosoftEntraIdUsersUserActivitiesRecent extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_activities_recent';
    ...
    protected const PATH = '/users/{user-id}/activities/recent()';
