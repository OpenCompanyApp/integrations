 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/assignLicense.
 */
class MicrosoftEntraIdUsersUserAssignLicense extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_assign_license';
    ...
    protected const PATH = '/users/{user-id}/assignLicense';
