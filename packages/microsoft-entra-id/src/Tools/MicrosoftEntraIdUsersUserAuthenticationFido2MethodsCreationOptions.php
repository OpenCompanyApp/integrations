 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/authentication/fido2Methods/creationOptions().
 */
class MicrosoftEntraIdUsersUserAuthenticationFido2MethodsCreationOptions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_authentication_fido2_methods_creation_options';
    protected const DESCRIPTION = 'Invoke function creationOptions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/authentication/fido2Methods/creationOptions().';
    ...
    protected const PATH = '/users/{user-id}/authentication/fido2Methods/creationOptions()';
