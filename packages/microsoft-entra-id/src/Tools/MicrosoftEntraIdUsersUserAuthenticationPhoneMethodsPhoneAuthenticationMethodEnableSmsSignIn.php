 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}/enableSmsSignIn.
 */
class MicrosoftEntraIdUsersUserAuthenticationPhoneMethodsPhoneAuthenticationMethodEnableSmsSignIn extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_authentication_phone_methods_phone_authentication_method_enable_sms_sign_in';
    protected const DESCRIPTION = 'Invoke action enableSmsSignIn\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}/enableSmsSignIn.';
    ...
    protected const PATH = '/users/{user-id}/authentication/phoneMethods/{phoneAuthenticationMethod-id}/enableSmsSignIn';
