 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/changePassword.
 */
class MicrosoftEntraIdUsersUserChangePassword extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_change_password';
    protected const DESCRIPTION = 'Invoke action changePassword\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/changePassword.';
    ...
    protected const PATH = '/users/{user-id}/changePassword';
