 ...
 * Create User.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users.
 */
class MicrosoftEntraIdUsersUserCreateUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_create_user';
