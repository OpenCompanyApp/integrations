 ...
 * Delete a user.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}.
 */
class MicrosoftEntraIdUsersUserDeleteUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_delete_user';
    ...
    protected const PATH = '/users/{user-id}';
