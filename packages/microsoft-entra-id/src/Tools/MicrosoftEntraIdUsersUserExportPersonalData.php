 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/exportPersonalData.
 */
class MicrosoftEntraIdUsersUserExportPersonalData extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_export_personal_data';
    protected const DESCRIPTION = 'Invoke action exportPersonalData\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/exportPersonalData.';
    ...
    protected const PATH = '/users/{user-id}/exportPersonalData';
