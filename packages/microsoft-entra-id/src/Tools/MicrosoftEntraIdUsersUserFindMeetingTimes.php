 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/findMeetingTimes.
 */
class MicrosoftEntraIdUsersUserFindMeetingTimes extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_find_meeting_times';
    protected const DESCRIPTION = 'Invoke action findMeetingTimes\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/findMeetingTimes.';
    ...
    protected const PATH = '/users/{user-id}/findMeetingTimes';
