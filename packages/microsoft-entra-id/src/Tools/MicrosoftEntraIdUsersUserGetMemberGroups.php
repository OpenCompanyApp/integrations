 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/getMemberGroups.
 */
class MicrosoftEntraIdUsersUserGetMemberGroups extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_get_member_groups';
    ...
    protected const PATH = '/users/{user-id}/getMemberGroups';
