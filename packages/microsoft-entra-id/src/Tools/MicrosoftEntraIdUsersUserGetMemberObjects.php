 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/getMemberObjects.
 */
class MicrosoftEntraIdUsersUserGetMemberObjects extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_get_member_objects';
    ...
    protected const PATH = '/users/{user-id}/getMemberObjects';
