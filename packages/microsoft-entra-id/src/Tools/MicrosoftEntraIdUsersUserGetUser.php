 ...
 * Get a user.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}.
 */
class MicrosoftEntraIdUsersUserGetUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_get_user';
