 ...
 * Get a user.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users(userPrincipalName='{userPrincipalName}').
 */
class MicrosoftEntraIdUsersUserGetUserByUserPrincipalName extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_get_user_by_user_principal_name';
