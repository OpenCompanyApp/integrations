 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/licenseDetails/getTeamsLicensingDetails().
 */
class MicrosoftEntraIdUsersUserLicenseDetailsGetTeamsLicensingDetails extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_license_details_get_teams_licensing_details';
    protected const DESCRIPTION = 'Invoke function getTeamsLicensingDetails\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/licenseDetails/getTeamsLicensingDetails().';
    ...
    protected const PATH = '/users/{user-id}/licenseDetails/getTeamsLicensingDetails()';
