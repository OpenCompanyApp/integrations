 ...
 * List users.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users.
 */
class MicrosoftEntraIdUsersUserListUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_list_user';
