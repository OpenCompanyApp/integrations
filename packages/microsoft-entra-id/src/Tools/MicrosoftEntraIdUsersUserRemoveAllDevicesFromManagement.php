 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/removeAllDevicesFromManagement.
 */
class MicrosoftEntraIdUsersUserRemoveAllDevicesFromManagement extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_remove_all_devices_from_management';
    protected const DESCRIPTION = 'Invoke action removeAllDevicesFromManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/removeAllDevicesFromManagement.';
    ...
    protected const PATH = '/users/{user-id}/removeAllDevicesFromManagement';
