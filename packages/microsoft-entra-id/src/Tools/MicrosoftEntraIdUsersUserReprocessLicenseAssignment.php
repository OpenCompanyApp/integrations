 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/reprocessLicenseAssignment.
 */
class MicrosoftEntraIdUsersUserReprocessLicenseAssignment extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_reprocess_license_assignment';
    protected const DESCRIPTION = 'Invoke action reprocessLicenseAssignment\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/reprocessLicenseAssignment.';
    ...
    protected const PATH = '/users/{user-id}/reprocessLicenseAssignment';
