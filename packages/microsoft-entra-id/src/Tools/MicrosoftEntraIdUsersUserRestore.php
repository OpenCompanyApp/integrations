 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/restore.
 */
class MicrosoftEntraIdUsersUserRestore extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_restore';
    ...
    protected const PATH = '/users/{user-id}/restore';
