 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/retryServiceProvisioning.
 */
class MicrosoftEntraIdUsersUserRetryServiceProvisioning extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_retry_service_provisioning';
    ...
    protected const PATH = '/users/{user-id}/retryServiceProvisioning';
