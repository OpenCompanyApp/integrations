 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/revokeSignInSessions.
 */
class MicrosoftEntraIdUsersUserRevokeSignInSessions extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_revoke_sign_in_sessions';
    protected const DESCRIPTION = 'Invoke action revokeSignInSessions\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/revokeSignInSessions.';
    ...
    protected const PATH = '/users/{user-id}/revokeSignInSessions';
