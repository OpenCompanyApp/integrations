 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/translateExchangeIds.
 */
class MicrosoftEntraIdUsersUserTranslateExchangeIds extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_translate_exchange_ids';
    protected const DESCRIPTION = 'Invoke action translateExchangeIds\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/translateExchangeIds.';
    ...
    protected const PATH = '/users/{user-id}/translateExchangeIds';
