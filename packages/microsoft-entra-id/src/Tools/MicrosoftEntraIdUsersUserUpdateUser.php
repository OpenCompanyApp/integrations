 ...
 * Update user.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}.
 */
class MicrosoftEntraIdUsersUserUpdateUser extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_update_user';
