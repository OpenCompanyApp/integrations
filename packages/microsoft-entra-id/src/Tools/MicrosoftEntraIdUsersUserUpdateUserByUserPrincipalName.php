 ...
 * Update user.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users(userPrincipalName='{userPrincipalName}').
 */
class MicrosoftEntraIdUsersUserUpdateUserByUserPrincipalName extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_update_user_by_user_principal_name';
