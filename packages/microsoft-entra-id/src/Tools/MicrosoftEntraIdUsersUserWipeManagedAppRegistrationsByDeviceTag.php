 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/wipeManagedAppRegistrationsByDeviceTag.
 */
class MicrosoftEntraIdUsersUserWipeManagedAppRegistrationsByDeviceTag extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_user_wipe_managed_app_registrations_by_device_tag';
    protected const DESCRIPTION = 'Invoke action wipeManagedAppRegistrationsByDeviceTag\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/wipeManagedAppRegistrationsByDeviceTag.';
    ...
    protected const PATH = '/users/{user-id}/wipeManagedAppRegistrationsByDeviceTag';
