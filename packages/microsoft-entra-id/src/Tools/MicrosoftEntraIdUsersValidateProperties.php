 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/validateProperties.
 */
class MicrosoftEntraIdUsersValidateProperties extends AbstractMicrosoftEntraIdTool
{
    protected const NAME = 'microsoft_entra_id_users_validate_properties';
    ...
    protected const PATH = '/users/validateProperties';
