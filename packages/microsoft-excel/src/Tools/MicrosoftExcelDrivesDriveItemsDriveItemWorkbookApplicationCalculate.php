 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/application/calculate.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookApplicationCalculate extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_application_calculate';
    protected const DESCRIPTION = 'Invoke action calculate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/application/calculate.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/application/calculate';
