 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/closeSession.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookCloseSession extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_close_session';
    protected const DESCRIPTION = 'Invoke action closeSession\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/closeSession.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/closeSession';
