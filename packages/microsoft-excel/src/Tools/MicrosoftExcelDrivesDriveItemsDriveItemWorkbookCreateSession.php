 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/createSession.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookCreateSession extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_create_session';
    protected const DESCRIPTION = 'Invoke action createSession\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/createSession.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/createSession';
