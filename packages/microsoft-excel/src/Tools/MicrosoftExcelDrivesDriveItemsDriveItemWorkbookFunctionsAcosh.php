 ...
 * Invoke action acosh.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/acosh.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsAcosh extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_acosh';
    protected const DESCRIPTION = 'Invoke action acosh\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/acosh.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/acosh';
