 ...
 * Invoke action acoth.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/acoth.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsAcoth extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_acoth';
    protected const DESCRIPTION = 'Invoke action acoth\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/acoth.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/acoth';
