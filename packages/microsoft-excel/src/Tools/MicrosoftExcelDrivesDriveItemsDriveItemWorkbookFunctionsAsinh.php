 ...
 * Invoke action asinh.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/asinh.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsAsinh extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_asinh';
    protected const DESCRIPTION = 'Invoke action asinh\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/asinh.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/asinh';
