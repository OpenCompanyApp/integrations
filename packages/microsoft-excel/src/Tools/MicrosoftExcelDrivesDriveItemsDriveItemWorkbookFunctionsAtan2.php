 ...
 * Invoke action atan2.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/atan2.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsAtan2 extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_atan2';
    protected const DESCRIPTION = 'Invoke action atan2\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/atan2.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/atan2';
