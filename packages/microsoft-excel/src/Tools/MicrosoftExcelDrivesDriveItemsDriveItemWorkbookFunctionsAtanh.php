 ...
 * Invoke action atanh.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/atanh.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsAtanh extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_atanh';
    protected const DESCRIPTION = 'Invoke action atanh\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/atanh.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/atanh';
