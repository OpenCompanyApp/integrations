 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/binom_Dist_Range.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsBinomDistRange extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_binom_dist_range';
    protected const DESCRIPTION = 'Invoke action binom_Dist_Range\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/binom_Dist_Range.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/binom_Dist_Range';
