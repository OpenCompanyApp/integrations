 ...
 * Invoke action bitor.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/bitor.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsBitor extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_bitor';
    protected const DESCRIPTION = 'Invoke action bitor\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/bitor.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/bitor';
