 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/ceiling_Math.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsCeilingMath extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_ceiling_math';
    protected const DESCRIPTION = 'Invoke action ceiling_Math\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/ceiling_Math.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/ceiling_Math';
