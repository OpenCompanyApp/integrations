 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/chiSq_Dist.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsChiSqDist extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_chi_sq_dist';
    protected const DESCRIPTION = 'Invoke action chiSq_Dist\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/chiSq_Dist.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/chiSq_Dist';
