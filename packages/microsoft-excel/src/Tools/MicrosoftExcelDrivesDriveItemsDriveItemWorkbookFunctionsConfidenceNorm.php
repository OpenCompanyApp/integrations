 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/confidence_Norm.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsConfidenceNorm extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_confidence_norm';
    protected const DESCRIPTION = 'Invoke action confidence_Norm\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/confidence_Norm.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/confidence_Norm';
