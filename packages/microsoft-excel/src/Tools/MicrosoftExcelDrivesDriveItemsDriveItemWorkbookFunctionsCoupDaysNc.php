 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/coupDaysNc.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsCoupDaysNc extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_coup_days_nc';
    protected const DESCRIPTION = 'Invoke action coupDaysNc\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/coupDaysNc.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/coupDaysNc';
