 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/cumIPmt.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsCumIpmt extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_cum_ipmt';
    protected const DESCRIPTION = 'Invoke action cumIPmt\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/cumIPmt.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/cumIPmt';
