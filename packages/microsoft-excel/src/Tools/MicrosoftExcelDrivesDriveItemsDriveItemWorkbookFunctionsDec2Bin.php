 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/dec2Bin.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsDec2Bin extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_dec2_bin';
    protected const DESCRIPTION = 'Invoke action dec2Bin\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/dec2Bin.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/dec2Bin';
