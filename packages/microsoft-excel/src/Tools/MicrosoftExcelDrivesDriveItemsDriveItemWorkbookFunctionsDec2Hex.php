 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/dec2Hex.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsDec2Hex extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_dec2_hex';
    protected const DESCRIPTION = 'Invoke action dec2Hex\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/dec2Hex.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/dec2Hex';
