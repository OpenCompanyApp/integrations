 ...
 * Invoke action devSq.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/devSq.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsDevSq extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_dev_sq';
    protected const DESCRIPTION = 'Invoke action devSq\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/devSq.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/devSq';
