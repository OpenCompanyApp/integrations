 ...
 * Invoke action dvarP.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/dvarP.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsDvarP extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_dvar_p';
    protected const DESCRIPTION = 'Invoke action dvarP\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/dvarP.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/dvarP';
