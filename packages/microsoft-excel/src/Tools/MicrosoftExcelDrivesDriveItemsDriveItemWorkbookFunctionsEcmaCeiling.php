 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/ecma_Ceiling.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsEcmaCeiling extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_ecma_ceiling';
    protected const DESCRIPTION = 'Invoke action ecma_Ceiling\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/ecma_Ceiling.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/ecma_Ceiling';
