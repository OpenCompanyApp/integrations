 ...
 * Invoke action fixed.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/fixed.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsFixed extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_fixed';
    protected const DESCRIPTION = 'Invoke action fixed\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/fixed.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/fixed';
