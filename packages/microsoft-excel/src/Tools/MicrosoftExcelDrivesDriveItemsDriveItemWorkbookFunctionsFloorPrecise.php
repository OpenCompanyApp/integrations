 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/floor_Precise.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsFloorPrecise extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_floor_precise';
    protected const DESCRIPTION = 'Invoke action floor_Precise\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/floor_Precise.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/floor_Precise';
