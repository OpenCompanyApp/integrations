 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/gammaLn_Precise.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsGammaLnPrecise extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_gamma_ln_precise';
    protected const DESCRIPTION = 'Invoke action gammaLn_Precise\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/gammaLn_Precise.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/gammaLn_Precise';
