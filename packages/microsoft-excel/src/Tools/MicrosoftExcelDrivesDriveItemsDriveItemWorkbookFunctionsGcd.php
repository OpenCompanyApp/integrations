 ...
 * Invoke action gcd.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/gcd.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsGcd extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_gcd';
    protected const DESCRIPTION = 'Invoke action gcd\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/gcd.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/gcd';
