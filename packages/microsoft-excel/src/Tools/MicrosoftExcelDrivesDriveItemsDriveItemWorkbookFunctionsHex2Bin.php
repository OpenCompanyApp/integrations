 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/hex2Bin.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsHex2Bin extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_hex2_bin';
    protected const DESCRIPTION = 'Invoke action hex2Bin\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/hex2Bin.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/hex2Bin';
