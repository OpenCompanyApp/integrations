 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/hypGeom_Dist.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsHypGeomDist extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_hyp_geom_dist';
    protected const DESCRIPTION = 'Invoke action hypGeom_Dist\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/hypGeom_Dist.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/hypGeom_Dist';
