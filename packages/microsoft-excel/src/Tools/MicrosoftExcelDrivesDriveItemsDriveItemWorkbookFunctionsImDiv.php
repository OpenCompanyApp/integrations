 ...
 * Invoke action imDiv.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/imDiv.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsImDiv extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_im_div';
    protected const DESCRIPTION = 'Invoke action imDiv\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/imDiv.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/imDiv';
