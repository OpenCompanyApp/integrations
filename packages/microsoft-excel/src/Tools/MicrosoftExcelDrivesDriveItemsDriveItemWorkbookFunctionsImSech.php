 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/imSech.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsImSech extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_im_sech';
    protected const DESCRIPTION = 'Invoke action imSech\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/imSech.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/imSech';
