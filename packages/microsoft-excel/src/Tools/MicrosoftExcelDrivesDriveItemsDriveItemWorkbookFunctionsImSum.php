 ...
 * Invoke action imSum.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/imSum.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsImSum extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_im_sum';
    protected const DESCRIPTION = 'Invoke action imSum\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/imSum.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/imSum';
