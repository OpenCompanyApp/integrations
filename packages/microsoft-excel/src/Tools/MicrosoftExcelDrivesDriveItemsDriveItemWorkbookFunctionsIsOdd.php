 ...
 * Invoke action isOdd.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/isOdd.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsIsOdd extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_is_odd';
    protected const DESCRIPTION = 'Invoke action isOdd\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/isOdd.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/isOdd';
