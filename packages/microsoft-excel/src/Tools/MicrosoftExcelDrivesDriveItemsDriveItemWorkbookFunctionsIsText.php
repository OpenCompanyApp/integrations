 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/isText.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsIsText extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_is_text';
    protected const DESCRIPTION = 'Invoke action isText\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/isText.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/isText';
