 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/iso_Ceiling.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsIsoCeiling extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_iso_ceiling';
    protected const DESCRIPTION = 'Invoke action iso_Ceiling\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/iso_Ceiling.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/iso_Ceiling';
