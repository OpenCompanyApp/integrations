 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/isoWeekNum.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsIsoWeekNum extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_iso_week_num';
    protected const DESCRIPTION = 'Invoke action isoWeekNum\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/isoWeekNum.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/isoWeekNum';
