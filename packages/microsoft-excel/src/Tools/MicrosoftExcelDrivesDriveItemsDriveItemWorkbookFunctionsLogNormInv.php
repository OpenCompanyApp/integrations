 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/logNorm_Inv.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsLogNormInv extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_log_norm_inv';
    protected const DESCRIPTION = 'Invoke action logNorm_Inv\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/logNorm_Inv.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/logNorm_Inv';
