 ...
 * Invoke action maxA.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/maxA.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsMaxA extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_max_a';
    protected const DESCRIPTION = 'Invoke action maxA\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/maxA.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/maxA';
