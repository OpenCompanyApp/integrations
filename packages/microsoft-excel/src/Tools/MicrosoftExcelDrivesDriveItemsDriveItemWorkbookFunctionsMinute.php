 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/minute.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsMinute extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_minute';
    protected const DESCRIPTION = 'Invoke action minute\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/minute.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/minute';
