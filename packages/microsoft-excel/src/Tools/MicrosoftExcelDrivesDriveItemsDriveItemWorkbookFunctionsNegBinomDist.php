 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/negBinom_Dist.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsNegBinomDist extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_neg_binom_dist';
    protected const DESCRIPTION = 'Invoke action negBinom_Dist\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/negBinom_Dist.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/negBinom_Dist';
