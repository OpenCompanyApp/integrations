 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/networkDays_Intl.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsNetworkDaysIntl extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_network_days_intl';
    protected const DESCRIPTION = 'Invoke action networkDays_Intl\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/networkDays_Intl.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/networkDays_Intl';
