 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_Dist.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsNormDist extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_norm_dist';
    protected const DESCRIPTION = 'Invoke action norm_Dist\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_Dist.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_Dist';
