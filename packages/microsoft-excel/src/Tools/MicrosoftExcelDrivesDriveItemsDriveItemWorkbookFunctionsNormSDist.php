 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_S_Dist.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsNormSDist extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_norm_s_dist';
    protected const DESCRIPTION = 'Invoke action norm_S_Dist\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_S_Dist.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_S_Dist';
