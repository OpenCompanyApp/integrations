 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_S_Inv.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsNormSInv extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_norm_s_inv';
    protected const DESCRIPTION = 'Invoke action norm_S_Inv\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_S_Inv.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/norm_S_Inv';
