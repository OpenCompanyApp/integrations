 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/oddFPrice.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsOddFprice extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_odd_fprice';
    protected const DESCRIPTION = 'Invoke action oddFPrice\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/oddFPrice.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/oddFPrice';
