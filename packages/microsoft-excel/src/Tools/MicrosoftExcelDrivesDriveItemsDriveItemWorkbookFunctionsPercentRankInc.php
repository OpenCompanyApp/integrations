 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentRank_Inc.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsPercentRankInc extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_percent_rank_inc';
    protected const DESCRIPTION = 'Invoke action percentRank_Inc\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentRank_Inc.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentRank_Inc';
