 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentile_Exc.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsPercentileExc extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_percentile_exc';
    protected const DESCRIPTION = 'Invoke action percentile_Exc\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentile_Exc.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentile_Exc';
