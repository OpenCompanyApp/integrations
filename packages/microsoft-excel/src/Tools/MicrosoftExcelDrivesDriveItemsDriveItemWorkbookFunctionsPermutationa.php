 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/permutationa.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsPermutationa extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_permutationa';
    protected const DESCRIPTION = 'Invoke action permutationa\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/permutationa.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/permutationa';
