 ...
 * Invoke action pmt.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/pmt.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsPmt extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_pmt';
    protected const DESCRIPTION = 'Invoke action pmt\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/pmt.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/pmt';
