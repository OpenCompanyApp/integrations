 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/quartile_Exc.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsQuartileExc extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_quartile_exc';
    protected const DESCRIPTION = 'Invoke action quartile_Exc\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/quartile_Exc.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/quartile_Exc';
