 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/quartile_Inc.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsQuartileInc extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_quartile_inc';
    protected const DESCRIPTION = 'Invoke action quartile_Inc\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/quartile_Inc.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/quartile_Inc';
