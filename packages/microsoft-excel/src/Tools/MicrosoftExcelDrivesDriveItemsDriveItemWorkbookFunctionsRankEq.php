 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/rank_Eq.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsRankEq extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_rank_eq';
    protected const DESCRIPTION = 'Invoke action rank_Eq\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/rank_Eq.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/rank_Eq';
