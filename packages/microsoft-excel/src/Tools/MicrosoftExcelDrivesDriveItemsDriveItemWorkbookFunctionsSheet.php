 ...
 * Invoke action sheet.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sheet.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsSheet extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_sheet';
    protected const DESCRIPTION = 'Invoke action sheet\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sheet.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/sheet';
