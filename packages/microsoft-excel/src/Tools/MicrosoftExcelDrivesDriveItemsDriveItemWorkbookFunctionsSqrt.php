 ...
 * Invoke action sqrt.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sqrt.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsSqrt extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_sqrt';
    protected const DESCRIPTION = 'Invoke action sqrt\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sqrt.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/sqrt';
