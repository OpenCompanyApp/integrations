 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sqrtPi.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsSqrtPi extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_sqrt_pi';
    protected const DESCRIPTION = 'Invoke action sqrtPi\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sqrtPi.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/sqrtPi';
