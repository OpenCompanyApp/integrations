 ...
 * Invoke action sumIf.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sumIf.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsSumIf extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_sum_if';
    protected const DESCRIPTION = 'Invoke action sumIf\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sumIf.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/sumIf';
