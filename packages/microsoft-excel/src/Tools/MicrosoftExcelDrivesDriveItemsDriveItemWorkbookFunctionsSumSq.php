 ...
 * Invoke action sumSq.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sumSq.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsSumSq extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_sum_sq';
    protected const DESCRIPTION = 'Invoke action sumSq\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/sumSq.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/sumSq';
