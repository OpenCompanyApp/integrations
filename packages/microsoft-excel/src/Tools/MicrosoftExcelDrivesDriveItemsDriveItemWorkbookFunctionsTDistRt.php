 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Dist_RT.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsTDistRt extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_t_dist_rt';
    protected const DESCRIPTION = 'Invoke action t_Dist_RT\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Dist_RT.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Dist_RT';
