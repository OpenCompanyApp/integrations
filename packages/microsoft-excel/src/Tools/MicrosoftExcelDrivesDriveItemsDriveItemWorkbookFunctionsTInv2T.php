 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Inv_2T.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsTInv2T extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_t_inv_2_t';
    protected const DESCRIPTION = 'Invoke action t_Inv_2T\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Inv_2T.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/t_Inv_2T';
