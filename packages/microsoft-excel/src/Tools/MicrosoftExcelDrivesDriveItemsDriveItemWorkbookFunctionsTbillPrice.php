 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/tbillPrice.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsTbillPrice extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_tbill_price';
    protected const DESCRIPTION = 'Invoke action tbillPrice\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/tbillPrice.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/tbillPrice';
