 ...
 * Invoke action varPA.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/varPA.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsVarPa extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_var_pa';
    protected const DESCRIPTION = 'Invoke action varPA\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/varPA.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/varPA';
