 ...
 * Invoke action vdb.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/vdb.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsVdb extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_vdb';
    protected const DESCRIPTION = 'Invoke action vdb\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/vdb.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/vdb';
