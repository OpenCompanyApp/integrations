 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/workDay_Intl.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsWorkDayIntl extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_work_day_intl';
    protected const DESCRIPTION = 'Invoke action workDay_Intl\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/workDay_Intl.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/workDay_Intl';
