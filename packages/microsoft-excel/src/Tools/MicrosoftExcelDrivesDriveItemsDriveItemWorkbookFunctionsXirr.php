 ...
 * Invoke action xirr.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/xirr.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsXirr extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_xirr';
    protected const DESCRIPTION = 'Invoke action xirr\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/xirr.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/xirr';
