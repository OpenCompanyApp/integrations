 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/yieldDisc.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookFunctionsYieldDisc extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_functions_yield_disc';
    protected const DESCRIPTION = 'Invoke action yieldDisc\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/functions/yieldDisc.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions/yieldDisc';
