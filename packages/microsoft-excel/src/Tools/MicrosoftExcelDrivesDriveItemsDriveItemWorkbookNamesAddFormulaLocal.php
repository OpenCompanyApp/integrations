 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/names/addFormulaLocal.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookNamesAddFormulaLocal extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_names_add_formula_local';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/names/addFormulaLocal';
