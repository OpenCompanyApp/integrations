 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}/range()/delete.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookNamesWorkbookNamedItemRangeDelete extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_names_workbook_named_item_range_delete';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}/range()/delete';
