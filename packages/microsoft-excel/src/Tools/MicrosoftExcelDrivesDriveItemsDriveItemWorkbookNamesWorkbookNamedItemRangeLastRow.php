 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}/range()/lastRow().
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookNamesWorkbookNamedItemRangeLastRow extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_names_workbook_named_item_range_last_row';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}/range()/lastRow()';
