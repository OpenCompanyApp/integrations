 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/refreshSession.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookRefreshSession extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_refresh_session';
    protected const DESCRIPTION = 'Invoke action refreshSession\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/refreshSession.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/refreshSession';
