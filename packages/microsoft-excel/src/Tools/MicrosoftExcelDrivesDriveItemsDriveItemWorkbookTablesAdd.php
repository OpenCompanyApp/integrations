 ...
 * Invoke action add.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/tables/add.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookTablesAdd extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_tables_add';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/tables/add';
