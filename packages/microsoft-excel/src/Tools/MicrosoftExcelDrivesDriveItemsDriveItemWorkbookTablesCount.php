 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/tables/count().
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookTablesCount extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_tables_count';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/tables/count()';
