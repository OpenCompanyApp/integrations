 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/tables/itemAt(index={index})/convertToRange.
 */
class MicrosoftExcelDrivesDriveItemsDriveItemWorkbookTablesItemAtConvertToRange extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_drive_items_drive_item_workbook_tables_item_at_convert_to_range';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/tables/itemAt(index={index})/convertToRange';
