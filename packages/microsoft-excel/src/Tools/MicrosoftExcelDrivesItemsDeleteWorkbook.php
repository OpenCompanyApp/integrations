 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/workbook.
 */
class MicrosoftExcelDrivesItemsDeleteWorkbook extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_delete_workbook';
    protected const DESCRIPTION = 'Delete navigation property workbook for drives\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/workbook.';
