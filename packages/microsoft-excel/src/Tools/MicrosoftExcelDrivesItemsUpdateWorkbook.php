 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/workbook.
 */
class MicrosoftExcelDrivesItemsUpdateWorkbook extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_update_workbook';
    protected const DESCRIPTION = 'Update the navigation property workbook in drives\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/workbook.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook';
