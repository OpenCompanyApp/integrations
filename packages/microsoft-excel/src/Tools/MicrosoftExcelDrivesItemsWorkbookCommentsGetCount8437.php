 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/comments/$count.
 */
class MicrosoftExcelDrivesItemsWorkbookCommentsGetCount8437 extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_comments_get_count_8437';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/comments/$count';
