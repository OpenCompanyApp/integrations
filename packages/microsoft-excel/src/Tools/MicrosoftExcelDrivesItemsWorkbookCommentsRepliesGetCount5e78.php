 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/replies/$count.
 */
class MicrosoftExcelDrivesItemsWorkbookCommentsRepliesGetCount5e78 extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_comments_replies_get_count_5e78';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/replies/$count';
