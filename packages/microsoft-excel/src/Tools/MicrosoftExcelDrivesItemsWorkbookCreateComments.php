 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/comments.
 */
class MicrosoftExcelDrivesItemsWorkbookCreateComments extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_create_comments';
    protected const DESCRIPTION = 'Create new navigation property to comments for drives\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/comments.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/comments';
