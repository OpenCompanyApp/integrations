 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/names.
 */
class MicrosoftExcelDrivesItemsWorkbookCreateNames extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_create_names';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/names';
