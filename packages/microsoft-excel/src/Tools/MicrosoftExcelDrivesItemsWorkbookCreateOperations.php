 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/operations.
 */
class MicrosoftExcelDrivesItemsWorkbookCreateOperations extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_create_operations';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/operations';
