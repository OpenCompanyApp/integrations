 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets.
 */
class MicrosoftExcelDrivesItemsWorkbookCreateWorksheets extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_create_worksheets';
    protected const DESCRIPTION = 'Create new navigation property to worksheets for drives\n\nOfficial Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets';
