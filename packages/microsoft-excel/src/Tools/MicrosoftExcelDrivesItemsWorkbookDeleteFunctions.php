 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/functions.
 */
class MicrosoftExcelDrivesItemsWorkbookDeleteFunctions extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_delete_functions';
    protected const DESCRIPTION = 'Delete navigation property functions for drives\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/functions.';
