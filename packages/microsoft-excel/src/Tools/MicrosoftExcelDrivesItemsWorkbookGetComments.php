 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}.
 */
class MicrosoftExcelDrivesItemsWorkbookGetComments extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_get_comments';
    protected const DESCRIPTION = 'Get comments from drives\n\nOfficial Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}.';
