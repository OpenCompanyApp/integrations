 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}/range()/format.
 */
class MicrosoftExcelDrivesItemsWorkbookNamesRangeUpdateFormat extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_names_range_update_format';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}/range()/format';
