 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/operations/$count.
 */
class MicrosoftExcelDrivesItemsWorkbookOperationsGetCount67f8 extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_operations_get_count_67f8';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/operations/$count';
