 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/tables/itemAt(index={index})/sort.
 */
class MicrosoftExcelDrivesItemsWorkbookTablesItemAtDeleteSort extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_tables_item_at_delete_sort';
