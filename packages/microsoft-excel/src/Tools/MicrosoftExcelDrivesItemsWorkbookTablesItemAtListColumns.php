 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/workbook/tables/itemAt(index={index})/columns.
 */
class MicrosoftExcelDrivesItemsWorkbookTablesItemAtListColumns extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_tables_item_at_list_columns';
