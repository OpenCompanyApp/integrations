 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/tables/itemAt(index={index})/sort.
 */
class MicrosoftExcelDrivesItemsWorkbookTablesItemAtUpdateSort extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_tables_item_at_update_sort';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/tables/itemAt(index={index})/sort';
