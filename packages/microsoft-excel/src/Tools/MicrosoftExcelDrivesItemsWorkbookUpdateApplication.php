 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/application.
 */
class MicrosoftExcelDrivesItemsWorkbookUpdateApplication extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_update_application';
    protected const DESCRIPTION = 'Update the navigation property application in drives\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/application.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/application';
