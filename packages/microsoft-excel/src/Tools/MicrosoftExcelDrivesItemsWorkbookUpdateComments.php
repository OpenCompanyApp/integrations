 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}.
 */
class MicrosoftExcelDrivesItemsWorkbookUpdateComments extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_update_comments';
    protected const DESCRIPTION = 'Update the navigation property comments in drives\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}';
