 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/functions.
 */
class MicrosoftExcelDrivesItemsWorkbookUpdateFunctions extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_update_functions';
    protected const DESCRIPTION = 'Update the navigation property functions in drives\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/workbook/functions.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/functions';
