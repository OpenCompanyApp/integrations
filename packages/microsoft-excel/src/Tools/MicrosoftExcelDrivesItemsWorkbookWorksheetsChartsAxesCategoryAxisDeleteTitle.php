 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/charts/{workbookChart-id}/axes/categoryAxis/title.
 */
class MicrosoftExcelDrivesItemsWorkbookWorksheetsChartsAxesCategoryAxisDeleteTitle extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_worksheets_charts_axes_category_axis_delete_title';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/charts/{workbookChart-id}/axes/categoryAxis/title';
