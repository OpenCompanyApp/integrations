 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/charts/{workbookChart-id}/axes/categoryAxis.
 */
class MicrosoftExcelDrivesItemsWorkbookWorksheetsChartsAxesDeleteCategoryAxis extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_worksheets_charts_axes_delete_category_axis';
    protected const DESCRIPTION = 'Delete navigation property categoryAxis for drives\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/charts/{workbookChart-id}/axes/categoryAxis.';
