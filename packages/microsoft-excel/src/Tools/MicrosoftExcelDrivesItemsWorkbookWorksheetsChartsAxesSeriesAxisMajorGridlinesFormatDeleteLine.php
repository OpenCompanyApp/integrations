 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/charts/{workbookChart-id}/axes/seriesAxis/majorGridlines/format/line.
 */
class MicrosoftExcelDrivesItemsWorkbookWorksheetsChartsAxesSeriesAxisMajorGridlinesFormatDeleteLine extends AbstractMicrosoftExcelTool
{
    protected const NAME = 'microsoft_excel_drives_items_workbook_worksheets_charts_axes_series_axis_major_gridlines_format_delete_line';
