 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/alerts/$count.
 */
class MicrosoftGraphSecurityAlertsGetCount82d4 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_alerts_get_count_82d4';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/alerts/$count.';
    ...
    protected const PATH = '/security/alerts/$count';
