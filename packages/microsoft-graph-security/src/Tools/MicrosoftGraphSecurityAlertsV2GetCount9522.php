 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/alerts_v2/$count.
 */
class MicrosoftGraphSecurityAlertsV2GetCount9522 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_alerts_v2_get_count_9522';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/alerts_v2/$count.';
    ...
    protected const PATH = '/security/alerts_v2/$count';
