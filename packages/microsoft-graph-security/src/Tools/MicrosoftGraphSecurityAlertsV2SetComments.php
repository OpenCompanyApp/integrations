 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/alerts_v2/{alert-id}/comments.
 */
class MicrosoftGraphSecurityAlertsV2SetComments extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_alerts_v2_set_comments';
    protected const DESCRIPTION = 'Create comment for alert\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/alerts_v2/{alert-id}/comments.';
    ...
    protected const PATH = '/security/alerts_v2/{alert-id}/comments';
