 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/endUserNotifications.
 */
class MicrosoftGraphSecurityAttackSimulationCreateEndUserNotifications extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_end_user_notifications';
    protected const DESCRIPTION = 'Create new navigation property to endUserNotifications for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/endUserNotifications.';
    ...
    protected const PATH = '/security/attackSimulation/endUserNotifications';
