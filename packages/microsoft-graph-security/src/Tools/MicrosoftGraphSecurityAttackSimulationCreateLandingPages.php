 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/landingPages.
 */
class MicrosoftGraphSecurityAttackSimulationCreateLandingPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_landing_pages';
    protected const DESCRIPTION = 'Create new navigation property to landingPages for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/landingPages.';
    ...
    protected const PATH = '/security/attackSimulation/landingPages';
