 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/loginPages.
 */
class MicrosoftGraphSecurityAttackSimulationCreateLoginPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_login_pages';
    protected const DESCRIPTION = 'Create new navigation property to loginPages for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/loginPages.';
    ...
    protected const PATH = '/security/attackSimulation/loginPages';
