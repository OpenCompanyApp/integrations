 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/operations.
 */
class MicrosoftGraphSecurityAttackSimulationCreateOperations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/operations.';
    ...
    protected const PATH = '/security/attackSimulation/operations';
