 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/payloads.
 */
class MicrosoftGraphSecurityAttackSimulationCreatePayloads extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_payloads';
    protected const DESCRIPTION = 'Create new navigation property to payloads for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/payloads.';
    ...
    protected const PATH = '/security/attackSimulation/payloads';
