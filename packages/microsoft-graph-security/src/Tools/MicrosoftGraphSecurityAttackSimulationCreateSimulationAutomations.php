 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/simulationAutomations.
 */
class MicrosoftGraphSecurityAttackSimulationCreateSimulationAutomations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_simulation_automations';
    protected const DESCRIPTION = 'Create new navigation property to simulationAutomations for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/simulationAutomations.';
    ...
    protected const PATH = '/security/attackSimulation/simulationAutomations';
