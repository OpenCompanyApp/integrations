 ...
 * Create simulation.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/simulations.
 */
class MicrosoftGraphSecurityAttackSimulationCreateSimulations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_simulations';
    protected const DESCRIPTION = 'Create simulation\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/simulations.';
    ...
    protected const PATH = '/security/attackSimulation/simulations';
