 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/trainings.
 */
class MicrosoftGraphSecurityAttackSimulationCreateTrainings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_create_trainings';
    protected const DESCRIPTION = 'Create new navigation property to trainings for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/trainings.';
    ...
    protected const PATH = '/security/attackSimulation/trainings';
