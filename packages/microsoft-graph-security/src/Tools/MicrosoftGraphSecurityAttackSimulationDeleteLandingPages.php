 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/attackSimulation/landingPages/{landingPage-id}.
 */
class MicrosoftGraphSecurityAttackSimulationDeleteLandingPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_delete_landing_pages';
    protected const DESCRIPTION = 'Delete navigation property landingPages for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/attackSimulation/landingPages/{landingPage-id}.';
