 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/attackSimulation/loginPages/{loginPage-id}.
 */
class MicrosoftGraphSecurityAttackSimulationDeleteLoginPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_delete_login_pages';
    protected const DESCRIPTION = 'Delete navigation property loginPages for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/attackSimulation/loginPages/{loginPage-id}.';
