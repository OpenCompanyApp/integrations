 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/attackSimulation/operations/{attackSimulationOperation-id}.
 */
class MicrosoftGraphSecurityAttackSimulationDeleteOperations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_delete_operations';
    protected const DESCRIPTION = 'Delete navigation property operations for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/attackSimulation/operations/{attackSimulationOperation-id}.';
