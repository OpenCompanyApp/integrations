 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/attackSimulation/simulationAutomations/{simulationAutomation-id}.
 */
class MicrosoftGraphSecurityAttackSimulationDeleteSimulationAutomations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_delete_simulation_automations';
    protected const DESCRIPTION = 'Delete navigation property simulationAutomations for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/attackSimulation/simulationAutomations/{simulationAutomation-id}.';
