 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details.
 */
class MicrosoftGraphSecurityAttackSimulationEndUserNotificationsCreateDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_end_user_notifications_create_details';
    protected const DESCRIPTION = 'Create new navigation property to details for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details.';
    ...
    protected const PATH = '/security/attackSimulation/endUserNotifications/{endUserNotification-id}/details';
