 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/endUserNotifications/$count.
 */
class MicrosoftGraphSecurityAttackSimulationEndUserNotificationsGetCount421b extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_end_user_notifications_get_count_421b';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/endUserNotifications/$count.';
    ...
    protected const PATH = '/security/attackSimulation/endUserNotifications/$count';
