 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details/{endUserNotificationDetail-id}.
 */
class MicrosoftGraphSecurityAttackSimulationEndUserNotificationsGetDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_end_user_notifications_get_details';
    protected const DESCRIPTION = 'Get details from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details/{endUserNotificationDetail-id}.';
