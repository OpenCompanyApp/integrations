 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details/{endUserNotificationDetail-id}.
 */
class MicrosoftGraphSecurityAttackSimulationEndUserNotificationsUpdateDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_end_user_notifications_update_details';
    protected const DESCRIPTION = 'Update the navigation property details in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details/{endUserNotificationDetail-id}.';
