 ...
 * Get loginPage.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/loginPages/{loginPage-id}.
 */
class MicrosoftGraphSecurityAttackSimulationGetLoginPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_get_login_pages';
    protected const DESCRIPTION = 'Get loginPage\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/loginPages/{loginPage-id}.';
