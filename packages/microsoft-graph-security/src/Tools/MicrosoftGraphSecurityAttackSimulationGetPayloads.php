 ...
 * Get payload.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/payloads/{payload-id}.
 */
class MicrosoftGraphSecurityAttackSimulationGetPayloads extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_get_payloads';
    protected const DESCRIPTION = 'Get payload\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/payloads/{payload-id}.';
