 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulationAutomations/{simulationAutomation-id}.
 */
class MicrosoftGraphSecurityAttackSimulationGetSimulationAutomations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_get_simulation_automations';
    protected const DESCRIPTION = 'Get simulationAutomation\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulationAutomations/{simulationAutomation-id}.';
