 ...
 * Get simulation.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulations/{simulation-id}.
 */
class MicrosoftGraphSecurityAttackSimulationGetSimulations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_get_simulations';
    protected const DESCRIPTION = 'Get simulation\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulations/{simulation-id}.';
