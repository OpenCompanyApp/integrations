 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/landingPages/{landingPage-id}/details.
 */
class MicrosoftGraphSecurityAttackSimulationLandingPagesCreateDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_landing_pages_create_details';
    protected const DESCRIPTION = 'Create new navigation property to details for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/landingPages/{landingPage-id}/details.';
    ...
    protected const PATH = '/security/attackSimulation/landingPages/{landingPage-id}/details';
