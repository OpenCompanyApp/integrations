 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/attackSimulation/landingPages/{landingPage-id}/details/{landingPageDetail-id}.
 */
class MicrosoftGraphSecurityAttackSimulationLandingPagesDeleteDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_landing_pages_delete_details';
    protected const DESCRIPTION = 'Delete navigation property details for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/attackSimulation/landingPages/{landingPage-id}/details/{landingPageDetail-id}.';
