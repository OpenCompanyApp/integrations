 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/landingPages/{landingPage-id}/details/$count.
 */
class MicrosoftGraphSecurityAttackSimulationLandingPagesDetailsGetCount8be7 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_landing_pages_details_get_count_8be7';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/landingPages/{landingPage-id}/details/$count.';
    ...
    protected const PATH = '/security/attackSimulation/landingPages/{landingPage-id}/details/$count';
