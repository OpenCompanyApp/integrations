 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/landingPages/$count.
 */
class MicrosoftGraphSecurityAttackSimulationLandingPagesGetCount7f61 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_landing_pages_get_count_7f61';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/landingPages/$count.';
    ...
    protected const PATH = '/security/attackSimulation/landingPages/$count';
