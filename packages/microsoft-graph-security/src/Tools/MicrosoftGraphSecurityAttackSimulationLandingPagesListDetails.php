 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/landingPages/{landingPage-id}/details.
 */
class MicrosoftGraphSecurityAttackSimulationLandingPagesListDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_landing_pages_list_details';
    protected const DESCRIPTION = 'Get details from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/landingPages/{landingPage-id}/details.';
