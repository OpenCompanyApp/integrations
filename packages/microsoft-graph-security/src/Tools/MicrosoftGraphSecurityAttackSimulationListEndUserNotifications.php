 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/endUserNotifications.
 */
class MicrosoftGraphSecurityAttackSimulationListEndUserNotifications extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_end_user_notifications';
    protected const DESCRIPTION = 'List endUserNotifications\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/endUserNotifications.';
