 ...
 * List landingPages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/landingPages.
 */
class MicrosoftGraphSecurityAttackSimulationListLandingPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_landing_pages';
    protected const DESCRIPTION = 'List landingPages\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/landingPages.';
