 ...
 * List loginPages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/loginPages.
 */
class MicrosoftGraphSecurityAttackSimulationListLoginPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_login_pages';
    protected const DESCRIPTION = 'List loginPages\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/loginPages.';
