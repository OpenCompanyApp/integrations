 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/operations.
 */
class MicrosoftGraphSecurityAttackSimulationListOperations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_operations';
    protected const DESCRIPTION = 'Get attackSimulationOperation\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/operations.';
