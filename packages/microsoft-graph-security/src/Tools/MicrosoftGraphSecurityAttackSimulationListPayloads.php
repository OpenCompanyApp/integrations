 ...
 * List payloads.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/payloads.
 */
class MicrosoftGraphSecurityAttackSimulationListPayloads extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_payloads';
    protected const DESCRIPTION = 'List payloads\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/payloads.';
