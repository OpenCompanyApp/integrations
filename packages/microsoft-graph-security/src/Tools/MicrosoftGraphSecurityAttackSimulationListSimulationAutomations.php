 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulationAutomations.
 */
class MicrosoftGraphSecurityAttackSimulationListSimulationAutomations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_simulation_automations';
    protected const DESCRIPTION = 'List simulationAutomations\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulationAutomations.';
