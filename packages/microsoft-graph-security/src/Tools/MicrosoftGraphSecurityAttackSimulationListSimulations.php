 ...
 * List simulations.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulations.
 */
class MicrosoftGraphSecurityAttackSimulationListSimulations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_simulations';
    protected const DESCRIPTION = 'List simulations\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulations.';
