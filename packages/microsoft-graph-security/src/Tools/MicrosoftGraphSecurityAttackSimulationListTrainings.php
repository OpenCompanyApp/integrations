 ...
 * List trainings.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/trainings.
 */
class MicrosoftGraphSecurityAttackSimulationListTrainings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_list_trainings';
    protected const DESCRIPTION = 'List trainings\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/trainings.';
