 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/loginPages/$count.
 */
class MicrosoftGraphSecurityAttackSimulationLoginPagesGetCountA7ea extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_login_pages_get_count_a7ea';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/loginPages/$count.';
    ...
    protected const PATH = '/security/attackSimulation/loginPages/$count';
