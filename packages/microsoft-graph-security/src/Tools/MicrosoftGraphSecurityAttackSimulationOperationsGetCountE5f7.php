 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/operations/$count.
 */
class MicrosoftGraphSecurityAttackSimulationOperationsGetCountE5f7 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_operations_get_count_e5f7';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/operations/$count.';
    ...
    protected const PATH = '/security/attackSimulation/operations/$count';
