 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/payloads/$count.
 */
class MicrosoftGraphSecurityAttackSimulationPayloadsGetCountF3a2 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_payloads_get_count_f3a2';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/payloads/$count.';
    ...
    protected const PATH = '/security/attackSimulation/payloads/$count';
