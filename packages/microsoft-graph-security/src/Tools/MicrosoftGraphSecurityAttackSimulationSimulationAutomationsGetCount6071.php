 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulationAutomations/$count.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationAutomationsGetCount6071 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulation_automations_get_count_6071';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulationAutomations/$count.';
    ...
    protected const PATH = '/security/attackSimulation/simulationAutomations/$count';
