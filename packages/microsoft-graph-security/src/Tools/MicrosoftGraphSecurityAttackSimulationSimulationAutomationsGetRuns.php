 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulationAutomations/{simulationAutomation-id}/runs/{simulationAutomationRun-id}.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationAutomationsGetRuns extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulation_automations_get_runs';
    protected const DESCRIPTION = 'Get runs from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulationAutomations/{simulationAutomation-id}/runs/{simulationAutomationRun-id}.';
