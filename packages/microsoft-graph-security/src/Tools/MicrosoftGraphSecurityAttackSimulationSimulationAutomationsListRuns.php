 ...
 * List runs.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulationAutomations/{simulationAutomation-id}/runs.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationAutomationsListRuns extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulation_automations_list_runs';
    protected const DESCRIPTION = 'List runs\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulationAutomations/{simulationAutomation-id}/runs.';
