 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/simulationAutomations/{simulationAutomation-id}/runs/{simulationAutomationRun-id}.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationAutomationsUpdateRuns extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulation_automations_update_runs';
    protected const DESCRIPTION = 'Update the navigation property runs in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/simulationAutomations/{simulationAutomation-id}/runs/{simulationAutomationRun-id}.';
