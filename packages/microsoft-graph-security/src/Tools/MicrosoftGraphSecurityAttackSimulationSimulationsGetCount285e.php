 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulations/$count.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationsGetCount285e extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulations_get_count_285e';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulations/$count.';
    ...
    protected const PATH = '/security/attackSimulation/simulations/$count';
