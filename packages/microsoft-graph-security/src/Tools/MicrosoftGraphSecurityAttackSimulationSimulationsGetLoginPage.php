 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulations/{simulation-id}/loginPage.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationsGetLoginPage extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulations_get_login_page';
    protected const DESCRIPTION = 'Get loginPage from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulations/{simulation-id}/loginPage.';
    ...
    protected const PATH = '/security/attackSimulation/simulations/{simulation-id}/loginPage';
