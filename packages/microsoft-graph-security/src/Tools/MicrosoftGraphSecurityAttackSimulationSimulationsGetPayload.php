 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/simulations/{simulation-id}/payload.
 */
class MicrosoftGraphSecurityAttackSimulationSimulationsGetPayload extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_simulations_get_payload';
    protected const DESCRIPTION = 'Get payload from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/simulations/{simulation-id}/payload.';
    ...
    protected const PATH = '/security/attackSimulation/simulations/{simulation-id}/payload';
