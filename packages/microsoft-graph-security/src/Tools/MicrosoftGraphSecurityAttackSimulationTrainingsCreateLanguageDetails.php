 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/attackSimulation/trainings/{training-id}/languageDetails.
 */
class MicrosoftGraphSecurityAttackSimulationTrainingsCreateLanguageDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_trainings_create_language_details';
    protected const DESCRIPTION = 'Create new navigation property to languageDetails for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/attackSimulation/trainings/{training-id}/languageDetails.';
