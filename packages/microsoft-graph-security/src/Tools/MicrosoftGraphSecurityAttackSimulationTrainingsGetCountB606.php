 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/trainings/$count.
 */
class MicrosoftGraphSecurityAttackSimulationTrainingsGetCountB606 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_trainings_get_count_b606';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/trainings/$count.';
    ...
    protected const PATH = '/security/attackSimulation/trainings/$count';
