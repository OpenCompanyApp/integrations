 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation/trainings/{training-id}/languageDetails/$count.
 */
class MicrosoftGraphSecurityAttackSimulationTrainingsLanguageDetailsGetCountB009 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_trainings_language_details_get_count_b009';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation/trainings/{training-id}/languageDetails/$count.';
    ...
    protected const PATH = '/security/attackSimulation/trainings/{training-id}/languageDetails/$count';
