 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/trainings/{training-id}/languageDetails/{trainingLanguageDetail-id}.
 */
class MicrosoftGraphSecurityAttackSimulationTrainingsUpdateLanguageDetails extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_trainings_update_language_details';
    protected const DESCRIPTION = 'Update the navigation property languageDetails in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/trainings/{training-id}/languageDetails/{trainingLanguageDetail-id}.';
