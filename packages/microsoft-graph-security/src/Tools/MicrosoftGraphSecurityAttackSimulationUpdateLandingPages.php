 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/landingPages/{landingPage-id}.
 */
class MicrosoftGraphSecurityAttackSimulationUpdateLandingPages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_update_landing_pages';
    protected const DESCRIPTION = 'Update the navigation property landingPages in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/landingPages/{landingPage-id}.';
