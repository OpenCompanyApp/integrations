 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/operations/{attackSimulationOperation-id}.
 */
class MicrosoftGraphSecurityAttackSimulationUpdateOperations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_update_operations';
    protected const DESCRIPTION = 'Update the navigation property operations in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/operations/{attackSimulationOperation-id}.';
