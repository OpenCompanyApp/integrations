 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/payloads/{payload-id}.
 */
class MicrosoftGraphSecurityAttackSimulationUpdatePayloads extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_update_payloads';
    protected const DESCRIPTION = 'Update the navigation property payloads in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/payloads/{payload-id}.';
