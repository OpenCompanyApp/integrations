 ...
 * Update simulation.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/simulations/{simulation-id}.
 */
class MicrosoftGraphSecurityAttackSimulationUpdateSimulations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_update_simulations';
    protected const DESCRIPTION = 'Update simulation\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/simulations/{simulation-id}.';
