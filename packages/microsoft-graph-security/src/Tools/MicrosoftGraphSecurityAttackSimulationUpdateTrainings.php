 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation/trainings/{training-id}.
 */
class MicrosoftGraphSecurityAttackSimulationUpdateTrainings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_attack_simulation_update_trainings';
    protected const DESCRIPTION = 'Update the navigation property trainings in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation/trainings/{training-id}.';
