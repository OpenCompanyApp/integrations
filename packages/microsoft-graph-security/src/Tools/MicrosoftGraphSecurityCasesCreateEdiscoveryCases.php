 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases.
 */
class MicrosoftGraphSecurityCasesCreateEdiscoveryCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_create_ediscovery_cases';
    protected const DESCRIPTION = 'Create ediscoveryCase\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases';
