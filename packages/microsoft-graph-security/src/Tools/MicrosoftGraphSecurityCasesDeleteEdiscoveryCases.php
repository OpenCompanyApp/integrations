 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/cases/ediscoveryCases/{ediscoveryCase-id}.
 */
class MicrosoftGraphSecurityCasesDeleteEdiscoveryCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_delete_ediscovery_cases';
    protected const DESCRIPTION = 'Delete ediscoveryCase\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/cases/ediscoveryCases/{ediscoveryCase-id}.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}';
