 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/caseMembers.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesCreateCaseMembers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_create_case_members';
    protected const DESCRIPTION = 'Add ediscoveryCaseMember\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/caseMembers.';
