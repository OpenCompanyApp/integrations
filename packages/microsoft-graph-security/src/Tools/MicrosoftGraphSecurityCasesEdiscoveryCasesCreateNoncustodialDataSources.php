 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/noncustodialDataSources.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesCreateNoncustodialDataSources extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_create_noncustodial_data_sources';
    protected const DESCRIPTION = 'Create nonCustodialDataSources\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/noncustodialDataSources.';
