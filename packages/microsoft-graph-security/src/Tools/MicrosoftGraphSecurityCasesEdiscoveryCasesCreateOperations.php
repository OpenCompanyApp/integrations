 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/operations.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesCreateOperations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/operations.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/operations';
