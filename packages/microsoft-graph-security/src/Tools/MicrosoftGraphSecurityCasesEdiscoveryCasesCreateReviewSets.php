 ...
 * Create reviewSets.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesCreateReviewSets extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_create_review_sets';
    protected const DESCRIPTION = 'Create reviewSets\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets';
