 ...
 * Create searches.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/searches.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesCreateSearches extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_create_searches';
    protected const DESCRIPTION = 'Create searches\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/searches.';
