 ...
 * Create tags.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesCreateTags extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_create_tags';
    protected const DESCRIPTION = 'Create tags\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/tags';
