 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/cases/ediscoveryCases/{ediscoveryCase-id}/settings.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesDeleteSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_delete_settings';
    protected const DESCRIPTION = 'Delete navigation property settings for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/cases/ediscoveryCases/{ediscoveryCase-id}/settings.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/settings';
