 ...
 * Invoke action close.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/microsoft.graph.security.close.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesEdiscoveryCaseClose extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_ediscovery_case_close';
    protected const DESCRIPTION = 'Invoke action close\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/microsoft.graph.security.close.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/microsoft.graph.security.close';
