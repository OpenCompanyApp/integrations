 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians/{ediscoveryCustodian-id}/microsoft.graph.security.applyHold.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesEdiscoveryCaseCustodiansEdiscoveryCustodianApplyHold extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_ediscovery_case_custodians_ediscovery_custodian_apply_hold';
    protected const DESCRIPTION = 'Invoke action applyHold\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians/{ediscoveryCustodian-id}/microsoft.graph.security.applyHold.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians/{ediscoveryCustodian-id}/microsoft.graph.security.applyHold';
