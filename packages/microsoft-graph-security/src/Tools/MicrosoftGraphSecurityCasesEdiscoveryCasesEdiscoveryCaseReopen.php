 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/microsoft.graph.security.reopen.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesEdiscoveryCaseReopen extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_ediscovery_case_reopen';
    protected const DESCRIPTION = 'Invoke action reopen\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/microsoft.graph.security.reopen.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/microsoft.graph.security.reopen';
