 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags/microsoft.graph.security.asHierarchy().
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesEdiscoveryCaseTagsAsHierarchy extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_ediscovery_case_tags_as_hierarchy';
    protected const DESCRIPTION = 'Invoke function asHierarchy\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags/microsoft.graph.security.asHierarchy().';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/tags/microsoft.graph.security.asHierarchy()';
