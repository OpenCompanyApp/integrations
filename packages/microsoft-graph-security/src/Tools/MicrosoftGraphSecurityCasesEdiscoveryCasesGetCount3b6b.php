 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/$count.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesGetCount3b6b extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_get_count_3b6b';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/$count.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/$count';
