 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/settings.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesGetSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_get_settings';
    protected const DESCRIPTION = 'Get ediscoveryCaseSettings\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/settings.';
