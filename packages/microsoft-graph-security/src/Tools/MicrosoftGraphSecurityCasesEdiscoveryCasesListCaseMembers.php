 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/caseMembers.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesListCaseMembers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_list_case_members';
    protected const DESCRIPTION = 'List ediscoveryCaseMember objects\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/caseMembers.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/caseMembers';
