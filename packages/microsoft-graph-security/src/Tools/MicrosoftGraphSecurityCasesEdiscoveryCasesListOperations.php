 ...
 * List caseOperations.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/operations.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesListOperations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_list_operations';
    protected const DESCRIPTION = 'List caseOperations\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/operations.';
