 ...
 * List reviewSets.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesListReviewSets extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_list_review_sets';
    protected const DESCRIPTION = 'List reviewSets\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets.';
