 ...
 * List tags.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesListTags extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_list_tags';
    protected const DESCRIPTION = 'List tags\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags.';
