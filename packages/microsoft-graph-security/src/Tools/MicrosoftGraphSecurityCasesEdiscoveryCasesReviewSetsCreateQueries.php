 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/{ediscoveryReviewSet-id}/queries.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesReviewSetsCreateQueries extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_review_sets_create_queries';
    protected const DESCRIPTION = 'Create ediscoveryReviewSetQuery\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/{ediscoveryReviewSet-id}/queries.';
