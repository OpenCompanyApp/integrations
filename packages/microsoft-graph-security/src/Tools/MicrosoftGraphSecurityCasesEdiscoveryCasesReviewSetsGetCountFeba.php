 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/$count.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesReviewSetsGetCountFeba extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_review_sets_get_count_feba';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/$count.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/$count';
