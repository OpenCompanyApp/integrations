 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians/{ediscoveryCustodian-id}.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesUpdateCustodians extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_update_custodians';
    protected const DESCRIPTION = 'Update the navigation property custodians in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians/{ediscoveryCustodian-id}.';
    ...
    protected const PATH = '/security/cases/ediscoveryCases/{ediscoveryCase-id}/custodians/{ediscoveryCustodian-id}';
