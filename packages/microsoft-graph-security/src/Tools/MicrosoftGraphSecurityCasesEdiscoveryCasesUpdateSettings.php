 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}/settings.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesUpdateSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_update_settings';
    protected const DESCRIPTION = 'Update ediscoveryCaseSettings\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}/settings.';
