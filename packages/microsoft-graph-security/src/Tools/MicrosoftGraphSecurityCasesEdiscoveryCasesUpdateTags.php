 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags/{ediscoveryReviewTag-id}.
 */
class MicrosoftGraphSecurityCasesEdiscoveryCasesUpdateTags extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_ediscovery_cases_update_tags';
    protected const DESCRIPTION = 'Update ediscoveryReviewTag\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}/tags/{ediscoveryReviewTag-id}.';
