 ...
 * Get ediscoveryCase.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases/{ediscoveryCase-id}.
 */
class MicrosoftGraphSecurityCasesGetEdiscoveryCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_get_ediscovery_cases';
    protected const DESCRIPTION = 'Get ediscoveryCase\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases/{ediscoveryCase-id}.';
