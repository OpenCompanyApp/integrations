 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases/ediscoveryCases.
 */
class MicrosoftGraphSecurityCasesListEdiscoveryCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_list_ediscovery_cases';
    protected const DESCRIPTION = 'List ediscoveryCases\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases/ediscoveryCases.';
