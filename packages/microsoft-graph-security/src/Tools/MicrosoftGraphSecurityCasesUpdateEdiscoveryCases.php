 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}.
 */
class MicrosoftGraphSecurityCasesUpdateEdiscoveryCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_cases_update_ediscovery_cases';
    protected const DESCRIPTION = 'Update ediscoveryCase\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/cases/ediscoveryCases/{ediscoveryCase-id}.';
