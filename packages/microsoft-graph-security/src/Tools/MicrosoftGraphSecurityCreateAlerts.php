 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/alerts.
 */
class MicrosoftGraphSecurityCreateAlerts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_create_alerts';
    protected const DESCRIPTION = 'Create new navigation property to alerts for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/alerts.';
    ...
    protected const PATH = '/security/alerts';
