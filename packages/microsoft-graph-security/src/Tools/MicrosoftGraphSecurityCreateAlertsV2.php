 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/alerts_v2.
 */
class MicrosoftGraphSecurityCreateAlertsV2 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_create_alerts_v2';
    protected const DESCRIPTION = 'Create new navigation property to alerts_v2 for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/alerts_v2.';
    ...
    protected const PATH = '/security/alerts_v2';
