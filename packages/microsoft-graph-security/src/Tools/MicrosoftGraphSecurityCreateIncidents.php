 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/incidents.
 */
class MicrosoftGraphSecurityCreateIncidents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_create_incidents';
    protected const DESCRIPTION = 'Create new navigation property to incidents for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/incidents.';
    ...
    protected const PATH = '/security/incidents';
