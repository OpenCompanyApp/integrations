 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/secureScoreControlProfiles.
 */
class MicrosoftGraphSecurityCreateSecureScoreControlProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_create_secure_score_control_profiles';
    protected const DESCRIPTION = 'Create new navigation property to secureScoreControlProfiles for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/secureScoreControlProfiles.';
    ...
    protected const PATH = '/security/secureScoreControlProfiles';
