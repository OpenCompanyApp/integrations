 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/secureScores.
 */
class MicrosoftGraphSecurityCreateSecureScores extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_create_secure_scores';
    protected const DESCRIPTION = 'Create new navigation property to secureScores for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/secureScores.';
    ...
    protected const PATH = '/security/secureScores';
