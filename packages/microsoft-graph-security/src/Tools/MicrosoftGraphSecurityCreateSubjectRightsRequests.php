 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/subjectRightsRequests.
 */
class MicrosoftGraphSecurityCreateSubjectRightsRequests extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_create_subject_rights_requests';
    protected const DESCRIPTION = 'Create new navigation property to subjectRightsRequests for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/subjectRightsRequests.';
    ...
    protected const PATH = '/security/subjectRightsRequests';
