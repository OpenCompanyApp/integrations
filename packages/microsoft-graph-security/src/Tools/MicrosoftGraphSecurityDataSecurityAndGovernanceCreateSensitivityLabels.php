 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/dataSecurityAndGovernance/sensitivityLabels.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceCreateSensitivityLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_create_sensitivity_labels';
    protected const DESCRIPTION = 'Create new navigation property to sensitivityLabels for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/dataSecurityAndGovernance/sensitivityLabels.';
    ...
    protected const PATH = '/security/dataSecurityAndGovernance/sensitivityLabels';
