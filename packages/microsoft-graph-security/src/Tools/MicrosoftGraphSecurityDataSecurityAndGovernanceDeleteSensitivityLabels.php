 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceDeleteSensitivityLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_delete_sensitivity_labels';
    protected const DESCRIPTION = 'Delete navigation property sensitivityLabels for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}.';
