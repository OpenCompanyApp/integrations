 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/dataSecurityAndGovernance/protectionScopes.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceGetProtectionScopes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_get_protection_scopes';
    protected const DESCRIPTION = 'Get protectionScopes from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/dataSecurityAndGovernance/protectionScopes.';
