 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceGetSensitivityLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_get_sensitivity_labels';
    protected const DESCRIPTION = 'Get sensitivityLabel\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}.';
