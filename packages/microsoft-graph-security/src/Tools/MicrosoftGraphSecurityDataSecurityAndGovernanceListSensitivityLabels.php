 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/dataSecurityAndGovernance/sensitivityLabels.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceListSensitivityLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_list_sensitivity_labels';
    protected const DESCRIPTION = 'List sensitivityLabels\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/dataSecurityAndGovernance/sensitivityLabels.';
