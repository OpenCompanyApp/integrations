 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/dataSecurityAndGovernance/processContentAsync.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceProcessContentAsync extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_process_content_async';
    protected const DESCRIPTION = 'Invoke action processContentAsync\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/dataSecurityAndGovernance/processContentAsync.';
    ...
    protected const PATH = '/security/dataSecurityAndGovernance/processContentAsync';
