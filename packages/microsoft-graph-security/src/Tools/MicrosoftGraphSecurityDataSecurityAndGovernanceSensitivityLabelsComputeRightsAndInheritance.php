 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/dataSecurityAndGovernance/sensitivityLabels/computeRightsAndInheritance.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceSensitivityLabelsComputeRightsAndInheritance extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_sensitivity_labels_compute_rights_and_inheritance';
    protected const DESCRIPTION = 'Invoke action computeRightsAndInheritance\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/dataSecurityAndGovernance/sensitivityLabels/computeRightsAndInheritance.';
    ...
    protected const PATH = '/security/dataSecurityAndGovernance/sensitivityLabels/computeRightsAndInheritance';
