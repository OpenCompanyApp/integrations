 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceSensitivityLabelsDeleteSublabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_sensitivity_labels_delete_sublabels';
    protected const DESCRIPTION = 'Delete navigation property sublabels for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}.';
