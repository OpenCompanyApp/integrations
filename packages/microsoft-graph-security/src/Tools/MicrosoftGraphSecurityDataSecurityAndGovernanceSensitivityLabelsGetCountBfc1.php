 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/dataSecurityAndGovernance/sensitivityLabels/$count.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceSensitivityLabelsGetCountBfc1 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_sensitivity_labels_get_count_bfc1';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/dataSecurityAndGovernance/sensitivityLabels/$count.';
    ...
    protected const PATH = '/security/dataSecurityAndGovernance/sensitivityLabels/$count';
