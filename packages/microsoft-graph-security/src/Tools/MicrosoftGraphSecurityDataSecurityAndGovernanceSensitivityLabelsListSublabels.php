 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceSensitivityLabelsListSublabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_sensitivity_labels_list_sublabels';
    protected const DESCRIPTION = 'Get sublabels from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels.';
