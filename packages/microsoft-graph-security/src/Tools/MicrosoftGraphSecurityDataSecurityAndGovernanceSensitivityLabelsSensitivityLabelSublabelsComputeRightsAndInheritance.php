 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/computeRightsAndInheritance.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceSensitivityLabelsSensitivityLabelSublabelsComputeRightsAndInheritance extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_sensitivity_labels_sensitivity_label_sublabels_compute_rights_and_inheritance';
    protected const DESCRIPTION = 'Invoke action computeRightsAndInheritance\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/computeRightsAndInheritance.';
    ...
    protected const PATH = '/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/computeRightsAndInheritance';
