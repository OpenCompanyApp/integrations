 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceSensitivityLabelsUpdateSublabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_sensitivity_labels_update_sublabels';
    protected const DESCRIPTION = 'Update the navigation property sublabels in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}.';
