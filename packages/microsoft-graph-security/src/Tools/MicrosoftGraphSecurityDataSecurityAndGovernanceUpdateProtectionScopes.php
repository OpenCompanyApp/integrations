 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/dataSecurityAndGovernance/protectionScopes.
 */
class MicrosoftGraphSecurityDataSecurityAndGovernanceUpdateProtectionScopes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_data_security_and_governance_update_protection_scopes';
    protected const DESCRIPTION = 'Update the navigation property protectionScopes in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/dataSecurityAndGovernance/protectionScopes.';
