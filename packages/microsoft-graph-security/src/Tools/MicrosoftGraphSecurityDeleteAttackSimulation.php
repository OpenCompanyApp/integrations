 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/attackSimulation.
 */
class MicrosoftGraphSecurityDeleteAttackSimulation extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_attack_simulation';
    protected const DESCRIPTION = 'Delete navigation property attackSimulation for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/attackSimulation.';
