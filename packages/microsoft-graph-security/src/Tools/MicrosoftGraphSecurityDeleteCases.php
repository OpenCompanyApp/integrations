 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/cases.
 */
class MicrosoftGraphSecurityDeleteCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_cases';
    protected const DESCRIPTION = 'Delete navigation property cases for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/cases.';
