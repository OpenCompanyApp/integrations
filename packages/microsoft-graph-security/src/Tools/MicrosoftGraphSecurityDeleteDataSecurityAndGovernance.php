 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/dataSecurityAndGovernance.
 */
class MicrosoftGraphSecurityDeleteDataSecurityAndGovernance extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_data_security_and_governance';
    protected const DESCRIPTION = 'Delete navigation property dataSecurityAndGovernance for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/dataSecurityAndGovernance.';
