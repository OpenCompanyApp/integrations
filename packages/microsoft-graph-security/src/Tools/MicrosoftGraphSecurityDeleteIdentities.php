 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/identities.
 */
class MicrosoftGraphSecurityDeleteIdentities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_identities';
    protected const DESCRIPTION = 'Delete navigation property identities for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/identities.';
