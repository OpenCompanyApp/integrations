 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/labels.
 */
class MicrosoftGraphSecurityDeleteLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_labels';
    protected const DESCRIPTION = 'Delete navigation property labels for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/labels.';
