 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/secureScoreControlProfiles/{secureScoreControlProfile-id}.
 */
class MicrosoftGraphSecurityDeleteSecureScoreControlProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_secure_score_control_profiles';
    protected const DESCRIPTION = 'Delete navigation property secureScoreControlProfiles for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/secureScoreControlProfiles/{secureScoreControlProfile-id}.';
