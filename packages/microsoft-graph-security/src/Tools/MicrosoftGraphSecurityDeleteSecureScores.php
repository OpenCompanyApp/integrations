 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/secureScores/{secureScore-id}.
 */
class MicrosoftGraphSecurityDeleteSecureScores extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_secure_scores';
    protected const DESCRIPTION = 'Delete navigation property secureScores for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/secureScores/{secureScore-id}.';
