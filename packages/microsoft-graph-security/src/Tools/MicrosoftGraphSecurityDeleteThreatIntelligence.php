 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence.
 */
class MicrosoftGraphSecurityDeleteThreatIntelligence extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_threat_intelligence';
    protected const DESCRIPTION = 'Delete navigation property threatIntelligence for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence.';
