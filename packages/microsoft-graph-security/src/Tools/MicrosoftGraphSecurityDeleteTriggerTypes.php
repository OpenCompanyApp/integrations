 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/triggerTypes.
 */
class MicrosoftGraphSecurityDeleteTriggerTypes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_trigger_types';
    protected const DESCRIPTION = 'Delete navigation property triggerTypes for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/triggerTypes.';
    ...
    protected const PATH = '/security/triggerTypes';
