 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/triggers.
 */
class MicrosoftGraphSecurityDeleteTriggers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_delete_triggers';
    protected const DESCRIPTION = 'Delete navigation property triggers for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/triggers.';
