 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/attackSimulation.
 */
class MicrosoftGraphSecurityGetAttackSimulation extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_attack_simulation';
    protected const DESCRIPTION = 'Get attackSimulation from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/attackSimulation.';
