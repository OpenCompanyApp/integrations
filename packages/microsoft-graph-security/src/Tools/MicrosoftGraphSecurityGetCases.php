 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/cases.
 */
class MicrosoftGraphSecurityGetCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_cases';
    protected const DESCRIPTION = 'Get cases from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/cases.';
