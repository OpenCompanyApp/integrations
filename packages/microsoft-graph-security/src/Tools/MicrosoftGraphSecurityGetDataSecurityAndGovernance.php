 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/dataSecurityAndGovernance.
 */
class MicrosoftGraphSecurityGetDataSecurityAndGovernance extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_data_security_and_governance';
    protected const DESCRIPTION = 'Get dataSecurityAndGovernance from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/dataSecurityAndGovernance.';
