 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities.
 */
class MicrosoftGraphSecurityGetIdentities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_identities';
    protected const DESCRIPTION = 'Get identities from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities.';
