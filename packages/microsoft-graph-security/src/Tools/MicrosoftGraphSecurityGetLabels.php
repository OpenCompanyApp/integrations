 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels.
 */
class MicrosoftGraphSecurityGetLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_labels';
    protected const DESCRIPTION = 'Get labels from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels.';
