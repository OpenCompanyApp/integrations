 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/secureScoreControlProfiles/{secureScoreControlProfile-id}.
 */
class MicrosoftGraphSecurityGetSecureScoreControlProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_secure_score_control_profiles';
    protected const DESCRIPTION = 'Get secureScoreControlProfile\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/secureScoreControlProfiles/{secureScoreControlProfile-id}.';
