 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence.
 */
class MicrosoftGraphSecurityGetThreatIntelligence extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_threat_intelligence';
    protected const DESCRIPTION = 'Get threatIntelligence from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence.';
