 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/triggerTypes.
 */
class MicrosoftGraphSecurityGetTriggerTypes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_trigger_types';
    protected const DESCRIPTION = 'Get triggerTypes from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/triggerTypes.';
