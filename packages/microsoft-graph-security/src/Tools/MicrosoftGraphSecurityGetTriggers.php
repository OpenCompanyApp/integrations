 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/triggers.
 */
class MicrosoftGraphSecurityGetTriggers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_get_triggers';
    protected const DESCRIPTION = 'Get triggers from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/triggers.';
