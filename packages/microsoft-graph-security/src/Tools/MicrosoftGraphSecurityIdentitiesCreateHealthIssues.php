 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/identities/healthIssues.
 */
class MicrosoftGraphSecurityIdentitiesCreateHealthIssues extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_create_health_issues';
    protected const DESCRIPTION = 'Create new navigation property to healthIssues for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/identities/healthIssues.';
    ...
    protected const PATH = '/security/identities/healthIssues';
