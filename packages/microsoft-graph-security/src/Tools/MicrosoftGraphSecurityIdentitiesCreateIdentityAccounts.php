 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/identities/identityAccounts.
 */
class MicrosoftGraphSecurityIdentitiesCreateIdentityAccounts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_create_identity_accounts';
    protected const DESCRIPTION = 'Create new navigation property to identityAccounts for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/identities/identityAccounts.';
    ...
    protected const PATH = '/security/identities/identityAccounts';
