 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/identities/sensorCandidates.
 */
class MicrosoftGraphSecurityIdentitiesCreateSensorCandidates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_create_sensor_candidates';
    protected const DESCRIPTION = 'Create new navigation property to sensorCandidates for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/identities/sensorCandidates.';
    ...
    protected const PATH = '/security/identities/sensorCandidates';
