 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/identities/sensors.
 */
class MicrosoftGraphSecurityIdentitiesCreateSensors extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_create_sensors';
    protected const DESCRIPTION = 'Create new navigation property to sensors for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/identities/sensors.';
    ...
    protected const PATH = '/security/identities/sensors';
