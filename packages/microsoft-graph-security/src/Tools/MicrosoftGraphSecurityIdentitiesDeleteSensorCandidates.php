 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/identities/sensorCandidates/{sensorCandidate-id}.
 */
class MicrosoftGraphSecurityIdentitiesDeleteSensorCandidates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_delete_sensor_candidates';
    protected const DESCRIPTION = 'Delete navigation property sensorCandidates for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/identities/sensorCandidates/{sensorCandidate-id}.';
