 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/identities/settings.
 */
class MicrosoftGraphSecurityIdentitiesDeleteSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_delete_settings';
    protected const DESCRIPTION = 'Delete navigation property settings for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/identities/settings.';
