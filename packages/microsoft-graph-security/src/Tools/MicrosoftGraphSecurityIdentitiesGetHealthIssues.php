 ...
 * Get healthIssue.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/healthIssues/{healthIssue-id}.
 */
class MicrosoftGraphSecurityIdentitiesGetHealthIssues extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_get_health_issues';
    protected const DESCRIPTION = 'Get healthIssue\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/healthIssues/{healthIssue-id}.';
