 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensorCandidateActivationConfiguration.
 */
class MicrosoftGraphSecurityIdentitiesGetSensorCandidateActivationConfiguration extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_get_sensor_candidate_activation_configuration';
    protected const DESCRIPTION = 'Get sensorCandidateActivationConfiguration\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensorCandidateActivationConfiguration.';
