 ...
 * Get sensor.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensors/{sensor-id}.
 */
class MicrosoftGraphSecurityIdentitiesGetSensors extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_get_sensors';
    protected const DESCRIPTION = 'Get sensor\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensors/{sensor-id}.';
