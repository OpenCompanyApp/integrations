 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/settings.
 */
class MicrosoftGraphSecurityIdentitiesGetSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_get_settings';
    protected const DESCRIPTION = 'Get settings from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/settings.';
