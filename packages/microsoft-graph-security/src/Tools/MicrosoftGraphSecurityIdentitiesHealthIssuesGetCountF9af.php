 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/healthIssues/$count.
 */
class MicrosoftGraphSecurityIdentitiesHealthIssuesGetCountF9af extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_health_issues_get_count_f9af';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/healthIssues/$count.';
    ...
    protected const PATH = '/security/identities/healthIssues/$count';
