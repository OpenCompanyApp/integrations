 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/identityAccounts/$count.
 */
class MicrosoftGraphSecurityIdentitiesIdentityAccountsGetCount3544 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_identity_accounts_get_count_3544';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/identityAccounts/$count.';
    ...
    protected const PATH = '/security/identities/identityAccounts/$count';
