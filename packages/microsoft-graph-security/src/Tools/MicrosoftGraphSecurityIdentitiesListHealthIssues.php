 ...
 * List healthIssues.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/healthIssues.
 */
class MicrosoftGraphSecurityIdentitiesListHealthIssues extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_list_health_issues';
    protected const DESCRIPTION = 'List healthIssues\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/healthIssues.';
