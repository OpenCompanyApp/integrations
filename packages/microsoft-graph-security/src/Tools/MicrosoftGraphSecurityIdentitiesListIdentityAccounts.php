 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/identityAccounts.
 */
class MicrosoftGraphSecurityIdentitiesListIdentityAccounts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_list_identity_accounts';
    protected const DESCRIPTION = 'List identityAccounts objects\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/identityAccounts.';
