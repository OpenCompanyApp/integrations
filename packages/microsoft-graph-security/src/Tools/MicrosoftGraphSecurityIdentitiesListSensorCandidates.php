 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensorCandidates.
 */
class MicrosoftGraphSecurityIdentitiesListSensorCandidates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_list_sensor_candidates';
    protected const DESCRIPTION = 'List sensorCandidate objects\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensorCandidates.';
