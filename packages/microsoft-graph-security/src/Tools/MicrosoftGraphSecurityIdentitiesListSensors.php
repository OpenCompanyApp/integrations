 ...
 * List sensors.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensors.
 */
class MicrosoftGraphSecurityIdentitiesListSensors extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_list_sensors';
    protected const DESCRIPTION = 'List sensors\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensors.';
