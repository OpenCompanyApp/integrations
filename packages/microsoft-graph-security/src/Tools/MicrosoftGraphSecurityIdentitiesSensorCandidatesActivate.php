 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/identities/sensorCandidates/microsoft.graph.security.activate.
 */
class MicrosoftGraphSecurityIdentitiesSensorCandidatesActivate extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensor_candidates_activate';
    protected const DESCRIPTION = 'Invoke action activate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/identities/sensorCandidates/microsoft.graph.security.activate.';
    ...
    protected const PATH = '/security/identities/sensorCandidates/microsoft.graph.security.activate';
