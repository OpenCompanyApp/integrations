 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensorCandidates/$count.
 */
class MicrosoftGraphSecurityIdentitiesSensorCandidatesGetCountFa5a extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensor_candidates_get_count_fa5a';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensorCandidates/$count.';
    ...
    protected const PATH = '/security/identities/sensorCandidates/$count';
