 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensors/$count.
 */
class MicrosoftGraphSecurityIdentitiesSensorsGetCount000d extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensors_get_count_000d';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensors/$count.';
    ...
    protected const PATH = '/security/identities/sensors/$count';
