 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensors/microsoft.graph.security.getDeploymentAccessKey().
 */
class MicrosoftGraphSecurityIdentitiesSensorsGetDeploymentAccessKey extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensors_get_deployment_access_key';
    protected const DESCRIPTION = 'Invoke function getDeploymentAccessKey\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensors/microsoft.graph.security.getDeploymentAccessKey().';
    ...
    protected const PATH = '/security/identities/sensors/microsoft.graph.security.getDeploymentAccessKey()';
