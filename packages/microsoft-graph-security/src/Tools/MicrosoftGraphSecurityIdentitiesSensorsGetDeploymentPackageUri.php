 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensors/microsoft.graph.security.getDeploymentPackageUri().
 */
class MicrosoftGraphSecurityIdentitiesSensorsGetDeploymentPackageUri extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensors_get_deployment_package_uri';
    protected const DESCRIPTION = 'Invoke function getDeploymentPackageUri\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensors/microsoft.graph.security.getDeploymentPackageUri().';
    ...
    protected const PATH = '/security/identities/sensors/microsoft.graph.security.getDeploymentPackageUri()';
