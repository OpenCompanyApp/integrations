 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/sensors/{sensor-id}/healthIssues/$count.
 */
class MicrosoftGraphSecurityIdentitiesSensorsHealthIssuesGetCount0a59 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensors_health_issues_get_count_0a59';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/sensors/{sensor-id}/healthIssues/$count.';
    ...
    protected const PATH = '/security/identities/sensors/{sensor-id}/healthIssues/$count';
