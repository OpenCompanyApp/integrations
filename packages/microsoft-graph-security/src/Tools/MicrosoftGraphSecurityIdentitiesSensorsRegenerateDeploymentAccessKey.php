 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/identities/sensors/microsoft.graph.security.regenerateDeploymentAccessKey.
 */
class MicrosoftGraphSecurityIdentitiesSensorsRegenerateDeploymentAccessKey extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_sensors_regenerate_deployment_access_key';
    protected const DESCRIPTION = 'Invoke action regenerateDeploymentAccessKey\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/identities/sensors/microsoft.graph.security.regenerateDeploymentAccessKey.';
    ...
    protected const PATH = '/security/identities/sensors/microsoft.graph.security.regenerateDeploymentAccessKey';
