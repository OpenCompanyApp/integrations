 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/identities/settings/autoAuditingConfiguration.
 */
class MicrosoftGraphSecurityIdentitiesSettingsDeleteAutoAuditingConfiguration extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_settings_delete_auto_auditing_configuration';
    protected const DESCRIPTION = 'Delete navigation property autoAuditingConfiguration for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/identities/settings/autoAuditingConfiguration.';
    ...
    protected const PATH = '/security/identities/settings/autoAuditingConfiguration';
