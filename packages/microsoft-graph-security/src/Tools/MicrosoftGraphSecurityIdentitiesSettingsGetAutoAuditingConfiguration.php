 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/identities/settings/autoAuditingConfiguration.
 */
class MicrosoftGraphSecurityIdentitiesSettingsGetAutoAuditingConfiguration extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_settings_get_auto_auditing_configuration';
    protected const DESCRIPTION = 'Get autoAuditingConfiguration\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/identities/settings/autoAuditingConfiguration.';
