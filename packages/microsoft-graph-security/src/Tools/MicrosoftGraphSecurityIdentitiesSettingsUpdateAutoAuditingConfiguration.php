 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities/settings/autoAuditingConfiguration.
 */
class MicrosoftGraphSecurityIdentitiesSettingsUpdateAutoAuditingConfiguration extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_settings_update_auto_auditing_configuration';
    protected const DESCRIPTION = 'Update autoAuditingConfiguration\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities/settings/autoAuditingConfiguration.';
