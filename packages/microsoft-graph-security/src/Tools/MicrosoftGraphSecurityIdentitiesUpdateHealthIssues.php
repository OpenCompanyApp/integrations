 ...
 * Update healthIssue.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities/healthIssues/{healthIssue-id}.
 */
class MicrosoftGraphSecurityIdentitiesUpdateHealthIssues extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_update_health_issues';
    protected const DESCRIPTION = 'Update healthIssue\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities/healthIssues/{healthIssue-id}.';
