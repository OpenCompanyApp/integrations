 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities/identityAccounts/{identityAccounts-id}.
 */
class MicrosoftGraphSecurityIdentitiesUpdateIdentityAccounts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_update_identity_accounts';
    protected const DESCRIPTION = 'Update the navigation property identityAccounts in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities/identityAccounts/{identityAccounts-id}.';
