 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities/sensorCandidateActivationConfiguration.
 */
class MicrosoftGraphSecurityIdentitiesUpdateSensorCandidateActivationConfiguration extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_update_sensor_candidate_activation_configuration';
    protected const DESCRIPTION = 'Update the navigation property sensorCandidateActivationConfiguration in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities/sensorCandidateActivationConfiguration.';
