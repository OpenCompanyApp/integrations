 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities/sensorCandidates/{sensorCandidate-id}.
 */
class MicrosoftGraphSecurityIdentitiesUpdateSensorCandidates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_update_sensor_candidates';
    protected const DESCRIPTION = 'Update the navigation property sensorCandidates in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities/sensorCandidates/{sensorCandidate-id}.';
