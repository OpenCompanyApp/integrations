 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities/settings.
 */
class MicrosoftGraphSecurityIdentitiesUpdateSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_identities_update_settings';
    protected const DESCRIPTION = 'Update the navigation property settings in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities/settings.';
    ...
    protected const PATH = '/security/identities/settings';
