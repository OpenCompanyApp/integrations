 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/incidents/{incident-id}/alerts/{alert-id}/comments/$count.
 */
class MicrosoftGraphSecurityIncidentsAlertsCommentsGetCountEe8f extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_incidents_alerts_comments_get_count_ee8f';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/incidents/{incident-id}/alerts/{alert-id}/comments/$count.';
    ...
    protected const PATH = '/security/incidents/{incident-id}/alerts/{alert-id}/comments/$count';
