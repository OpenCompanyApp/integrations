 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/incidents/{incident-id}/alerts/{alert-id}.
 */
class MicrosoftGraphSecurityIncidentsGetAlerts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_incidents_get_alerts';
    protected const DESCRIPTION = 'Get alerts from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/incidents/{incident-id}/alerts/{alert-id}.';
    ...
    protected const PATH = '/security/incidents/{incident-id}/alerts/{alert-id}';
