 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/incidents/$count.
 */
class MicrosoftGraphSecurityIncidentsGetCount9725 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_incidents_get_count_9725';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/incidents/$count.';
    ...
    protected const PATH = '/security/incidents/$count';
