 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/authorities/$count.
 */
class MicrosoftGraphSecurityLabelsAuthoritiesGetCountEcc0 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_authorities_get_count_ecc0';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/authorities/$count.';
    ...
    protected const PATH = '/security/labels/authorities/$count';
