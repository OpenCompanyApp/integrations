 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/categories/$count.
 */
class MicrosoftGraphSecurityLabelsCategoriesGetCount908b extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_categories_get_count_908b';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/categories/$count.';
    ...
    protected const PATH = '/security/labels/categories/$count';
