 ...
 * List subcategories.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/categories/{categoryTemplate-id}/subcategories.
 */
class MicrosoftGraphSecurityLabelsCategoriesListSubcategories extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_categories_list_subcategories';
    protected const DESCRIPTION = 'List subcategories\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/categories/{categoryTemplate-id}/subcategories.';
