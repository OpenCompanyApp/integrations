 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/categories/{categoryTemplate-id}/subcategories/$count.
 */
class MicrosoftGraphSecurityLabelsCategoriesSubcategoriesGetCountEc6d extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_categories_subcategories_get_count_ec6d';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/categories/{categoryTemplate-id}/subcategories/$count.';
    ...
    protected const PATH = '/security/labels/categories/{categoryTemplate-id}/subcategories/$count';
