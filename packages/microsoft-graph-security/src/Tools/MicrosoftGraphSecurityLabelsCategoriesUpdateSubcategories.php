 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/labels/categories/{categoryTemplate-id}/subcategories/{subcategoryTemplate-id}.
 */
class MicrosoftGraphSecurityLabelsCategoriesUpdateSubcategories extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_categories_update_subcategories';
    protected const DESCRIPTION = 'Update the navigation property subcategories in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/labels/categories/{categoryTemplate-id}/subcategories/{subcategoryTemplate-id}.';
