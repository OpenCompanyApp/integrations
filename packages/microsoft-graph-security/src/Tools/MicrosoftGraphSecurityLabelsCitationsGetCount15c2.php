 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/citations/$count.
 */
class MicrosoftGraphSecurityLabelsCitationsGetCount15c2 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_citations_get_count_15c2';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/citations/$count.';
    ...
    protected const PATH = '/security/labels/citations/$count';
