 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/labels/authorities.
 */
class MicrosoftGraphSecurityLabelsCreateAuthorities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_create_authorities';
    protected const DESCRIPTION = 'Create authorityTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/labels/authorities.';
    ...
    protected const PATH = '/security/labels/authorities';
