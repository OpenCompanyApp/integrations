 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/labels/categories.
 */
class MicrosoftGraphSecurityLabelsCreateCategories extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_create_categories';
    protected const DESCRIPTION = 'Create categoryTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/labels/categories.';
    ...
    protected const PATH = '/security/labels/categories';
