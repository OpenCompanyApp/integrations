 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/labels/citations.
 */
class MicrosoftGraphSecurityLabelsCreateCitations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_create_citations';
    protected const DESCRIPTION = 'Create citationTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/labels/citations.';
    ...
    protected const PATH = '/security/labels/citations';
