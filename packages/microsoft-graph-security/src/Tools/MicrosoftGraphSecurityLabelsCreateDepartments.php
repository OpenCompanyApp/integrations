 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/labels/departments.
 */
class MicrosoftGraphSecurityLabelsCreateDepartments extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_create_departments';
    protected const DESCRIPTION = 'Create departmentTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/labels/departments.';
    ...
    protected const PATH = '/security/labels/departments';
