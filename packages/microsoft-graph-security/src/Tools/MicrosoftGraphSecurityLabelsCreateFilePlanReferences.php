 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/labels/filePlanReferences.
 */
class MicrosoftGraphSecurityLabelsCreateFilePlanReferences extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_create_file_plan_references';
    protected const DESCRIPTION = 'Create filePlanReferenceTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/labels/filePlanReferences.';
    ...
    protected const PATH = '/security/labels/filePlanReferences';
