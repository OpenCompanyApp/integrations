 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/labels/retentionLabels.
 */
class MicrosoftGraphSecurityLabelsCreateRetentionLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_create_retention_labels';
    protected const DESCRIPTION = 'Create retentionLabel\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/labels/retentionLabels.';
    ...
    protected const PATH = '/security/labels/retentionLabels';
