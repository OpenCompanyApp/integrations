 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/labels/categories/{categoryTemplate-id}.
 */
class MicrosoftGraphSecurityLabelsDeleteCategories extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_delete_categories';
    protected const DESCRIPTION = 'Delete categoryTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/labels/categories/{categoryTemplate-id}.';
