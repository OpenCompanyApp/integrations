 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/labels/retentionLabels/{retentionLabel-id}.
 */
class MicrosoftGraphSecurityLabelsDeleteRetentionLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_delete_retention_labels';
    protected const DESCRIPTION = 'Delete retentionLabel\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/labels/retentionLabels/{retentionLabel-id}.';
