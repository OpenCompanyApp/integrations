 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/departments/$count.
 */
class MicrosoftGraphSecurityLabelsDepartmentsGetCountB983 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_departments_get_count_b983';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/departments/$count.';
    ...
    protected const PATH = '/security/labels/departments/$count';
