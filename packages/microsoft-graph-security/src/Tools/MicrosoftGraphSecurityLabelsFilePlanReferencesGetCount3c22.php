 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/filePlanReferences/$count.
 */
class MicrosoftGraphSecurityLabelsFilePlanReferencesGetCount3c22 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_file_plan_references_get_count_3c22';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/filePlanReferences/$count.';
    ...
    protected const PATH = '/security/labels/filePlanReferences/$count';
