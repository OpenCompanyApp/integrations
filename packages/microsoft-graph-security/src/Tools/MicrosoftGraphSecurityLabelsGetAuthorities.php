 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/authorities/{authorityTemplate-id}.
 */
class MicrosoftGraphSecurityLabelsGetAuthorities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_get_authorities';
    protected const DESCRIPTION = 'Get authorityTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/authorities/{authorityTemplate-id}.';
