 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/departments/{departmentTemplate-id}.
 */
class MicrosoftGraphSecurityLabelsGetDepartments extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_get_departments';
    protected const DESCRIPTION = 'Get departmentTemplate\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/departments/{departmentTemplate-id}.';
