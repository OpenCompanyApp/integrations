 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels/{retentionLabel-id}.
 */
class MicrosoftGraphSecurityLabelsGetRetentionLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_get_retention_labels';
    protected const DESCRIPTION = 'Get retentionLabels from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels/{retentionLabel-id}.';
    ...
    protected const PATH = '/security/labels/retentionLabels/{retentionLabel-id}';
