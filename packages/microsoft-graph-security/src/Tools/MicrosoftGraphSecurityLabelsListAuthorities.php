 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/authorities.
 */
class MicrosoftGraphSecurityLabelsListAuthorities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_list_authorities';
    protected const DESCRIPTION = 'List authorityTemplates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/authorities.';
