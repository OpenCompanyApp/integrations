 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/categories.
 */
class MicrosoftGraphSecurityLabelsListCategories extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_list_categories';
    protected const DESCRIPTION = 'List categoryTemplates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/categories.';
