 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/citations.
 */
class MicrosoftGraphSecurityLabelsListCitations extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_list_citations';
    protected const DESCRIPTION = 'List citationTemplates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/citations.';
