 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/departments.
 */
class MicrosoftGraphSecurityLabelsListDepartments extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_list_departments';
    protected const DESCRIPTION = 'List departmentTemplates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/departments.';
