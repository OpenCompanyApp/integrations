 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/filePlanReferences.
 */
class MicrosoftGraphSecurityLabelsListFilePlanReferences extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_list_file_plan_references';
    protected const DESCRIPTION = 'List filePlanReferenceTemplates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/filePlanReferences.';
