 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels.
 */
class MicrosoftGraphSecurityLabelsListRetentionLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_list_retention_labels';
    protected const DESCRIPTION = 'List retentionLabels\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels.';
