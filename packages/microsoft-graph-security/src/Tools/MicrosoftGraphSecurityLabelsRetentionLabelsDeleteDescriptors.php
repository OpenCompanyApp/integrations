 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/labels/retentionLabels/{retentionLabel-id}/descriptors.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsDeleteDescriptors extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_delete_descriptors';
    protected const DESCRIPTION = 'Delete navigation property descriptors for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/labels/retentionLabels/{retentionLabel-id}/descriptors.';
