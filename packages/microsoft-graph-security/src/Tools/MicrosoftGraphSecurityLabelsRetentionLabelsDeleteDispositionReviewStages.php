 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/labels/retentionLabels/{retentionLabel-id}/dispositionReviewStages/{dispositionReviewStage-stageNumber}.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsDeleteDispositionReviewStages extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_delete_disposition_review_stages';
    protected const DESCRIPTION = 'Delete navigation property dispositionReviewStages for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/labels/retentionLabels/{retentionLabel-id}/dispositionReviewStages/{dispositionReviewStage-stageNumber}.';
