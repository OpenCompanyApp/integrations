 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels/{retentionLabel-id}/descriptors/categoryTemplate.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsDescriptorsGetCategoryTemplate extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_descriptors_get_category_template';
    protected const DESCRIPTION = 'Get categoryTemplate from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels/{retentionLabel-id}/descriptors/categoryTemplate.';
    ...
    protected const PATH = '/security/labels/retentionLabels/{retentionLabel-id}/descriptors/categoryTemplate';
