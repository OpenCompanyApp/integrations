 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels/{retentionLabel-id}/descriptors/departmentTemplate.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsDescriptorsGetDepartmentTemplate extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_descriptors_get_department_template';
    protected const DESCRIPTION = 'Get departmentTemplate from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels/{retentionLabel-id}/descriptors/departmentTemplate.';
    ...
    protected const PATH = '/security/labels/retentionLabels/{retentionLabel-id}/descriptors/departmentTemplate';
