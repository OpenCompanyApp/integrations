 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels/{retentionLabel-id}/descriptors/filePlanReferenceTemplate.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsDescriptorsGetFilePlanReferenceTemplate extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_descriptors_get_file_plan_reference_template';
    protected const DESCRIPTION = 'Get filePlanReferenceTemplate from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels/{retentionLabel-id}/descriptors/filePlanReferenceTemplate.';
    ...
    protected const PATH = '/security/labels/retentionLabels/{retentionLabel-id}/descriptors/filePlanReferenceTemplate';
