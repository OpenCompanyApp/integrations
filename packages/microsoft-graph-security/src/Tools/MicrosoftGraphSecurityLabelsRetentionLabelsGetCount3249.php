 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels/$count.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsGetCount3249 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_get_count_3249';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels/$count.';
    ...
    protected const PATH = '/security/labels/retentionLabels/$count';
