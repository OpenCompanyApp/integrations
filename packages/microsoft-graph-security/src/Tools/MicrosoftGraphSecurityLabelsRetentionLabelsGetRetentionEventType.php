 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/labels/retentionLabels/{retentionLabel-id}/retentionEventType.
 */
class MicrosoftGraphSecurityLabelsRetentionLabelsGetRetentionEventType extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_retention_labels_get_retention_event_type';
    protected const DESCRIPTION = 'Get retentionEventType from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/labels/retentionLabels/{retentionLabel-id}/retentionEventType.';
    ...
    protected const PATH = '/security/labels/retentionLabels/{retentionLabel-id}/retentionEventType';
