 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/labels/departments/{departmentTemplate-id}.
 */
class MicrosoftGraphSecurityLabelsUpdateDepartments extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_update_departments';
    protected const DESCRIPTION = 'Update the navigation property departments in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/labels/departments/{departmentTemplate-id}.';
