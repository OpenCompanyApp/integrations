 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/labels/filePlanReferences/{filePlanReferenceTemplate-id}.
 */
class MicrosoftGraphSecurityLabelsUpdateFilePlanReferences extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_update_file_plan_references';
    protected const DESCRIPTION = 'Update the navigation property filePlanReferences in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/labels/filePlanReferences/{filePlanReferenceTemplate-id}.';
