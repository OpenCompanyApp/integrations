 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/labels/retentionLabels/{retentionLabel-id}.
 */
class MicrosoftGraphSecurityLabelsUpdateRetentionLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_labels_update_retention_labels';
    protected const DESCRIPTION = 'Update retentionLabel\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/labels/retentionLabels/{retentionLabel-id}.';
