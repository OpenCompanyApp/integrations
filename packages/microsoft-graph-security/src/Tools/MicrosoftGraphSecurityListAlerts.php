 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/alerts.
 */
class MicrosoftGraphSecurityListAlerts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_list_alerts';
    protected const DESCRIPTION = 'List alerts (deprecated)\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/alerts.';
