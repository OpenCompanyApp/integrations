 ...
 * List alerts_v2.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/alerts_v2.
 */
class MicrosoftGraphSecurityListAlertsV2 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_list_alerts_v2';
    protected const DESCRIPTION = 'List alerts_v2\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/alerts_v2.';
