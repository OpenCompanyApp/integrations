 ...
 * List incidents.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/incidents.
 */
class MicrosoftGraphSecurityListIncidents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_list_incidents';
    protected const DESCRIPTION = 'List incidents\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/incidents.';
