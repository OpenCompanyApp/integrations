 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/secureScoreControlProfiles.
 */
class MicrosoftGraphSecurityListSecureScoreControlProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_list_secure_score_control_profiles';
    protected const DESCRIPTION = 'List secureScoreControlProfiles\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/secureScoreControlProfiles.';
