 ...
 * List secureScores.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/secureScores.
 */
class MicrosoftGraphSecurityListSecureScores extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_list_secure_scores';
    protected const DESCRIPTION = 'List secureScores\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/secureScores.';
