 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests.
 */
class MicrosoftGraphSecurityListSubjectRightsRequests extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_list_subject_rights_requests';
    protected const DESCRIPTION = 'Get subjectRightsRequests from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests.';
