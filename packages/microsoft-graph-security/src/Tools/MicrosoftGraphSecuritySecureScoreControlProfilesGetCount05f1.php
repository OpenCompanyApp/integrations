 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/secureScoreControlProfiles/$count.
 */
class MicrosoftGraphSecuritySecureScoreControlProfilesGetCount05f1 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_secure_score_control_profiles_get_count_05f1';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/secureScoreControlProfiles/$count.';
    ...
    protected const PATH = '/security/secureScoreControlProfiles/$count';
