 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/secureScores/$count.
 */
class MicrosoftGraphSecuritySecureScoresGetCountCb39 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_secure_scores_get_count_cb39';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/secureScores/$count.';
    ...
    protected const PATH = '/security/secureScores/$count';
