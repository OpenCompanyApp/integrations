 ...
 * Get security.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security.
 */
class MicrosoftGraphSecuritySecurityGetSecurity extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_security_get_security';
    protected const DESCRIPTION = 'Get security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security.';
