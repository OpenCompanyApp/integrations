 ...
 * Update security.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security.
 */
class MicrosoftGraphSecuritySecurityUpdateSecurity extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_security_update_security';
    protected const DESCRIPTION = 'Update security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security.';
