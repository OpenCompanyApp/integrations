 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers/$count.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsApproversGetCount2c51 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_approvers_get_count_2c51';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers/$count.';
    ...
    protected const PATH = '/security/subjectRightsRequests/{subjectRightsRequest-id}/approvers/$count';
