 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers/{user-id}/mailboxSettings.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsApproversUpdateMailboxSettings extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_approvers_update_mailbox_settings';
    protected const DESCRIPTION = 'Update property mailboxSettings value.\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers/{user-id}/mailboxSettings.';
