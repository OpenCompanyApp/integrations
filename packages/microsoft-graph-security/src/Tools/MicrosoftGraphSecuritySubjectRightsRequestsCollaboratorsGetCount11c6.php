 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests/{subjectRightsRequest-id}/collaborators/$count.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsCollaboratorsGetCount11c6 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_collaborators_get_count_11c6';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests/{subjectRightsRequest-id}/collaborators/$count.';
    ...
    protected const PATH = '/security/subjectRightsRequests/{subjectRightsRequest-id}/collaborators/$count';
