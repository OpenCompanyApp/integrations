 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests/$count.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsGetCount8072 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_get_count_8072';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests/$count.';
    ...
    protected const PATH = '/security/subjectRightsRequests/$count';
