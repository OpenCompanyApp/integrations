 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests/{subjectRightsRequest-id}/team.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsGetTeam extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_get_team';
    protected const DESCRIPTION = 'Get team from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests/{subjectRightsRequest-id}/team.';
    ...
    protected const PATH = '/security/subjectRightsRequests/{subjectRightsRequest-id}/team';
