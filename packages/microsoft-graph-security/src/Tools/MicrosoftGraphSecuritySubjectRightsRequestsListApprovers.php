 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsListApprovers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_list_approvers';
    protected const DESCRIPTION = 'Get approvers from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers.';
    ...
    protected const PATH = '/security/subjectRightsRequests/{subjectRightsRequest-id}/approvers';
