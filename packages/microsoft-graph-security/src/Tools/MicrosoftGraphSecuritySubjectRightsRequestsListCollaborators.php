 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/subjectRightsRequests/{subjectRightsRequest-id}/collaborators.
 */
class MicrosoftGraphSecuritySubjectRightsRequestsListCollaborators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_subject_rights_requests_list_collaborators';
    protected const DESCRIPTION = 'Get collaborators from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/subjectRightsRequests/{subjectRightsRequest-id}/collaborators.';
    ...
    protected const PATH = '/security/subjectRightsRequests/{subjectRightsRequest-id}/collaborators';
