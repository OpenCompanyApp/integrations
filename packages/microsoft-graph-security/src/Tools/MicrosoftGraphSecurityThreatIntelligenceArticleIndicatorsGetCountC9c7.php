 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articleIndicators/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceArticleIndicatorsGetCountC9c7 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_article_indicators_get_count_c9c7';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articleIndicators/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/articleIndicators/$count';
