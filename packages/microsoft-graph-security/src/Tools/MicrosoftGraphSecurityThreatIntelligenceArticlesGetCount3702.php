 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articles/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceArticlesGetCount3702 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_articles_get_count_3702';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articles/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/articles/$count';
