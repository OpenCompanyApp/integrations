 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articles/{article-id}/indicators/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceArticlesIndicatorsGetCount1d6c extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_articles_indicators_get_count_1d6c';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articles/{article-id}/indicators/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/articles/{article-id}/indicators/$count';
