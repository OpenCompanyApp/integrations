 ...
 * List indicators.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articles/{article-id}/indicators.
 */
class MicrosoftGraphSecurityThreatIntelligenceArticlesListIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_articles_list_indicators';
    protected const DESCRIPTION = 'List indicators\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articles/{article-id}/indicators.';
    ...
    protected const PATH = '/security/threatIntelligence/articles/{article-id}/indicators';
