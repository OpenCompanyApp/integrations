 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/articleIndicators.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateArticleIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_article_indicators';
    protected const DESCRIPTION = 'Create new navigation property to articleIndicators for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/articleIndicators.';
    ...
    protected const PATH = '/security/threatIntelligence/articleIndicators';
