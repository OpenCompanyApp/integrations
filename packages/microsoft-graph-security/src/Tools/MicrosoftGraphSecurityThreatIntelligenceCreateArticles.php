 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/articles.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateArticles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_articles';
    protected const DESCRIPTION = 'Create new navigation property to articles for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/articles.';
    ...
    protected const PATH = '/security/threatIntelligence/articles';
