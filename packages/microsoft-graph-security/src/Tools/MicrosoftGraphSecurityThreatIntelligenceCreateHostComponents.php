 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hostComponents.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHostComponents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_host_components';
    protected const DESCRIPTION = 'Create new navigation property to hostComponents for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hostComponents.';
    ...
    protected const PATH = '/security/threatIntelligence/hostComponents';
