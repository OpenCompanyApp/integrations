 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hostCookies.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHostCookies extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_host_cookies';
    protected const DESCRIPTION = 'Create new navigation property to hostCookies for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hostCookies.';
    ...
    protected const PATH = '/security/threatIntelligence/hostCookies';
