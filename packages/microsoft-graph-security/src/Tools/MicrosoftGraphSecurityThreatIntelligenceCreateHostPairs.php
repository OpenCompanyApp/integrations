 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hostPairs.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHostPairs extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_host_pairs';
    protected const DESCRIPTION = 'Create new navigation property to hostPairs for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hostPairs.';
    ...
    protected const PATH = '/security/threatIntelligence/hostPairs';
