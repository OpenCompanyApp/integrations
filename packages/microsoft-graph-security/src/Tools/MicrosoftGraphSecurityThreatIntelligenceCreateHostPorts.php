 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hostPorts.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHostPorts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_host_ports';
    protected const DESCRIPTION = 'Create new navigation property to hostPorts for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hostPorts.';
    ...
    protected const PATH = '/security/threatIntelligence/hostPorts';
