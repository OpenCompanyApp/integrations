 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hostSslCertificates.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHostSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_host_ssl_certificates';
    protected const DESCRIPTION = 'Create new navigation property to hostSslCertificates for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hostSslCertificates.';
    ...
    protected const PATH = '/security/threatIntelligence/hostSslCertificates';
