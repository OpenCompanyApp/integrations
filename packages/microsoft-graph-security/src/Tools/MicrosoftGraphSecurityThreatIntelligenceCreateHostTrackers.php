 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hostTrackers.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHostTrackers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_host_trackers';
    protected const DESCRIPTION = 'Create new navigation property to hostTrackers for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hostTrackers.';
    ...
    protected const PATH = '/security/threatIntelligence/hostTrackers';
