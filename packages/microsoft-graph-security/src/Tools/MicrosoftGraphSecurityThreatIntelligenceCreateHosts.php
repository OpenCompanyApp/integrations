 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/hosts.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateHosts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_hosts';
    protected const DESCRIPTION = 'Create new navigation property to hosts for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/hosts.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts';
