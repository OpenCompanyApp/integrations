 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/intelProfiles.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateIntelProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_intel_profiles';
    protected const DESCRIPTION = 'Create new navigation property to intelProfiles for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/intelProfiles.';
    ...
    protected const PATH = '/security/threatIntelligence/intelProfiles';
