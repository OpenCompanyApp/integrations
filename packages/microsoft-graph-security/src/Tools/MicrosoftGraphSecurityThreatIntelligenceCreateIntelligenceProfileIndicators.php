 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/intelligenceProfileIndicators.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateIntelligenceProfileIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_intelligence_profile_indicators';
    protected const DESCRIPTION = 'Create new navigation property to intelligenceProfileIndicators for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/intelligenceProfileIndicators.';
    ...
    protected const PATH = '/security/threatIntelligence/intelligenceProfileIndicators';
