 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/passiveDnsRecords.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreatePassiveDnsRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_passive_dns_records';
    protected const DESCRIPTION = 'Create new navigation property to passiveDnsRecords for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/passiveDnsRecords.';
    ...
    protected const PATH = '/security/threatIntelligence/passiveDnsRecords';
