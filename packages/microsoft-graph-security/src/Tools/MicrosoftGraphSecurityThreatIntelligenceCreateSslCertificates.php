 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/sslCertificates.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_ssl_certificates';
    protected const DESCRIPTION = 'Create new navigation property to sslCertificates for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/sslCertificates.';
    ...
    protected const PATH = '/security/threatIntelligence/sslCertificates';
