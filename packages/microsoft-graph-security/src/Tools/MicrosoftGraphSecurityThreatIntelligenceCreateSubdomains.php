 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/subdomains.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateSubdomains extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_subdomains';
    protected const DESCRIPTION = 'Create new navigation property to subdomains for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/subdomains.';
    ...
    protected const PATH = '/security/threatIntelligence/subdomains';
