 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/vulnerabilities.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateVulnerabilities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_vulnerabilities';
    protected const DESCRIPTION = 'Create new navigation property to vulnerabilities for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/vulnerabilities.';
    ...
    protected const PATH = '/security/threatIntelligence/vulnerabilities';
