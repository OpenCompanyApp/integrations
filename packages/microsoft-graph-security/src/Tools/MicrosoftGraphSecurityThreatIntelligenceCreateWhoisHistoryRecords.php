 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/whoisHistoryRecords.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateWhoisHistoryRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_whois_history_records';
    protected const DESCRIPTION = 'Create new navigation property to whoisHistoryRecords for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/whoisHistoryRecords.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisHistoryRecords';
