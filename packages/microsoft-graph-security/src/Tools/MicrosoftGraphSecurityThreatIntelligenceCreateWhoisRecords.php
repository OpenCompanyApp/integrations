 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/threatIntelligence/whoisRecords.
 */
class MicrosoftGraphSecurityThreatIntelligenceCreateWhoisRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_create_whois_records';
    protected const DESCRIPTION = 'Create new navigation property to whoisRecords for security\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/threatIntelligence/whoisRecords.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisRecords';
