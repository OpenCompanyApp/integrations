 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/hostPairs/{hostPair-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteHostPairs extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_host_pairs';
    protected const DESCRIPTION = 'Delete navigation property hostPairs for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/hostPairs/{hostPair-id}.';
