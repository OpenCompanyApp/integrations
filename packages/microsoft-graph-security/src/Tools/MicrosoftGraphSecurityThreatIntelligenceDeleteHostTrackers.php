 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/hostTrackers/{hostTracker-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteHostTrackers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_host_trackers';
    protected const DESCRIPTION = 'Delete navigation property hostTrackers for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/hostTrackers/{hostTracker-id}.';
