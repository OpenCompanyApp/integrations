 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/hosts/{host-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteHosts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_hosts';
    protected const DESCRIPTION = 'Delete navigation property hosts for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/hosts/{host-id}.';
