 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/intelProfiles/{intelligenceProfile-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteIntelProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_intel_profiles';
    protected const DESCRIPTION = 'Delete navigation property intelProfiles for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/intelProfiles/{intelligenceProfile-id}.';
