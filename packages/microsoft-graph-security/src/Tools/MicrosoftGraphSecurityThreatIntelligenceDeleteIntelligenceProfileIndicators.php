 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/intelligenceProfileIndicators/{intelligenceProfileIndicator-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteIntelligenceProfileIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_intelligence_profile_indicators';
    protected const DESCRIPTION = 'Delete navigation property intelligenceProfileIndicators for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/intelligenceProfileIndicators/{intelligenceProfileIndicator-id}.';
