 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeletePassiveDnsRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_passive_dns_records';
    protected const DESCRIPTION = 'Delete navigation property passiveDnsRecords for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}.';
