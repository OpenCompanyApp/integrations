 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/vulnerabilities/{vulnerability-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteVulnerabilities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_vulnerabilities';
    protected const DESCRIPTION = 'Delete navigation property vulnerabilities for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/vulnerabilities/{vulnerability-id}.';
