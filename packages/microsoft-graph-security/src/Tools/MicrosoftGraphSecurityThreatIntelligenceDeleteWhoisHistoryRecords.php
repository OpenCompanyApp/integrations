 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/whoisHistoryRecords/{whoisHistoryRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteWhoisHistoryRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_whois_history_records';
    protected const DESCRIPTION = 'Delete navigation property whoisHistoryRecords for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/whoisHistoryRecords/{whoisHistoryRecord-id}.';
