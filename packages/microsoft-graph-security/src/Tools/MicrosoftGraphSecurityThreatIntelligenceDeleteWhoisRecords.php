 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/threatIntelligence/whoisRecords/{whoisRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceDeleteWhoisRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_delete_whois_records';
    protected const DESCRIPTION = 'Delete navigation property whoisRecords for security\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/threatIntelligence/whoisRecords/{whoisRecord-id}.';
