 ...
 * Get article.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articles/{article-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetArticles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_articles';
    protected const DESCRIPTION = 'Get article\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articles/{article-id}.';
