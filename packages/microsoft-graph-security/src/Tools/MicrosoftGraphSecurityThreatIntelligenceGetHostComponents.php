 ...
 * Get hostComponent.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostComponents/{hostComponent-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetHostComponents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_host_components';
    protected const DESCRIPTION = 'Get hostComponent\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostComponents/{hostComponent-id}.';
