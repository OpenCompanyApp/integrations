 ...
 * Get hostPair.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostPairs/{hostPair-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetHostPairs extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_host_pairs';
    protected const DESCRIPTION = 'Get hostPair\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostPairs/{hostPair-id}.';
