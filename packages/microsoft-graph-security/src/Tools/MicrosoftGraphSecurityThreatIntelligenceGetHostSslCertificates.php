 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetHostSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_host_ssl_certificates';
    protected const DESCRIPTION = 'Get hostSslCertificate\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}.';
