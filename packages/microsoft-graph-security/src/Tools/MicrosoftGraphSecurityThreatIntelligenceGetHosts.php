 ...
 * Get host.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetHosts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_hosts';
    protected const DESCRIPTION = 'Get host\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}.';
