 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/intelProfiles/{intelligenceProfile-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetIntelProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_intel_profiles';
    protected const DESCRIPTION = 'Get intelligenceProfile\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/intelProfiles/{intelligenceProfile-id}.';
