 ...
 * Get sslCertificate.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/sslCertificates/{sslCertificate-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_ssl_certificates';
    protected const DESCRIPTION = 'Get sslCertificate\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/sslCertificates/{sslCertificate-id}.';
