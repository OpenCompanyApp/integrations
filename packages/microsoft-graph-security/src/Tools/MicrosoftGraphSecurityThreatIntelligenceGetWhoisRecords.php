 ...
 * Get whoisRecord.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceGetWhoisRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_get_whois_records';
    protected const DESCRIPTION = 'Get whoisRecord\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}.';
