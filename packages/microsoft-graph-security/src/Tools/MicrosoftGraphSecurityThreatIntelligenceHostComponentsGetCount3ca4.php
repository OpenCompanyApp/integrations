 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostComponents/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostComponentsGetCount3ca4 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_components_get_count_3ca4';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostComponents/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hostComponents/$count';
