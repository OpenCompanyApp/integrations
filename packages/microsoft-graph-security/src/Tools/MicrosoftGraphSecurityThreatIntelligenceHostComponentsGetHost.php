 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostComponents/{hostComponent-id}/host.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostComponentsGetHost extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_components_get_host';
    protected const DESCRIPTION = 'Get host from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostComponents/{hostComponent-id}/host.';
    ...
    protected const PATH = '/security/threatIntelligence/hostComponents/{hostComponent-id}/host';
