 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostCookies/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostCookiesGetCountCa74 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_cookies_get_count_ca74';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostCookies/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hostCookies/$count';
