 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostPairs/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostPairsGetCount6e30 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_pairs_get_count_6e30';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostPairs/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hostPairs/$count';
