 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostPairs/{hostPair-id}/parentHost.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostPairsGetParentHost extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_pairs_get_parent_host';
    protected const DESCRIPTION = 'Get parentHost from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostPairs/{hostPair-id}/parentHost.';
    ...
    protected const PATH = '/security/threatIntelligence/hostPairs/{hostPair-id}/parentHost';
