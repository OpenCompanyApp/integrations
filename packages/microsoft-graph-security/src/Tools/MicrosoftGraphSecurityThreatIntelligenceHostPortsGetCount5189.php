 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostPorts/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostPortsGetCount5189 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_ports_get_count_5189';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostPorts/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hostPorts/$count';
