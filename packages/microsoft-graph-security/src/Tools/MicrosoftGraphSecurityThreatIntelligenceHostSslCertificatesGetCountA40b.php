 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostSslCertificates/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostSslCertificatesGetCountA40b extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_ssl_certificates_get_count_a40b';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostSslCertificates/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hostSslCertificates/$count';
