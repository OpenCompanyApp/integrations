 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}/host.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostSslCertificatesGetHost extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_ssl_certificates_get_host';
    protected const DESCRIPTION = 'Get host from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}/host.';
    ...
    protected const PATH = '/security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}/host';
