 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}/sslCertificate.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostSslCertificatesGetSslCertificate extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_ssl_certificates_get_ssl_certificate';
    protected const DESCRIPTION = 'Get sslCertificate from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}/sslCertificate.';
    ...
    protected const PATH = '/security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}/sslCertificate';
