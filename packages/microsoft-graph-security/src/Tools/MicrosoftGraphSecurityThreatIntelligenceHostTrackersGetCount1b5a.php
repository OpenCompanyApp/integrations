 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostTrackers/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostTrackersGetCount1b5a extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_trackers_get_count_1b5a';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostTrackers/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hostTrackers/$count';
