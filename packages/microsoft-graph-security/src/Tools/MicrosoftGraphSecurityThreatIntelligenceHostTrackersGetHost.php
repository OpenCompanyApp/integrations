 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostTrackers/{hostTracker-id}/host.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostTrackersGetHost extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_host_trackers_get_host';
    protected const DESCRIPTION = 'Get host from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostTrackers/{hostTracker-id}/host.';
    ...
    protected const PATH = '/security/threatIntelligence/hostTrackers/{hostTracker-id}/host';
