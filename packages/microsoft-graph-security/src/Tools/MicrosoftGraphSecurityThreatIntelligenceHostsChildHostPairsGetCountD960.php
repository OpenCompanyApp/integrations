 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/childHostPairs/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsChildHostPairsGetCountD960 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_child_host_pairs_get_count_d960';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/childHostPairs/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/childHostPairs/$count';
