 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/components/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsComponentsGetCount3f6d extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_components_get_count_3f6d';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/components/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/components/$count';
