 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/cookies/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsCookiesGetCountD607 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_cookies_get_count_d607';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/cookies/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/cookies/$count';
