 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsGetCount5d36 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_get_count_5d36';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/$count';
