 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/{passiveDnsRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsGetPassiveDnsReverse extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_get_passive_dns_reverse';
    protected const DESCRIPTION = 'Get passiveDnsReverse from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/{passiveDnsRecord-id}.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/{passiveDnsRecord-id}';
