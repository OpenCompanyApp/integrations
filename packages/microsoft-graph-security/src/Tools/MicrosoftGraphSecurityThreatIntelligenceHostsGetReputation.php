 ...
 * Get hostReputation.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/reputation.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsGetReputation extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_get_reputation';
    protected const DESCRIPTION = 'Get hostReputation\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/reputation.';
