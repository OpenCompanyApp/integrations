 ...
 * Get whoisRecord.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/whois.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsGetWhois extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_get_whois';
    protected const DESCRIPTION = 'Get whoisRecord\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/whois.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/whois';
