 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/hostPairs/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsHostPairsGetCountE637 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_host_pairs_get_count_e637';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/hostPairs/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/hostPairs/$count';
