 ...
 * List childHostPairs.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/childHostPairs.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListChildHostPairs extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_child_host_pairs';
    protected const DESCRIPTION = 'List childHostPairs\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/childHostPairs.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/childHostPairs';
