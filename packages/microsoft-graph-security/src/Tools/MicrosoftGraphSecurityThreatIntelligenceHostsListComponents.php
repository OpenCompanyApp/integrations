 ...
 * List components.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/components.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListComponents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_components';
    protected const DESCRIPTION = 'List components\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/components.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/components';
