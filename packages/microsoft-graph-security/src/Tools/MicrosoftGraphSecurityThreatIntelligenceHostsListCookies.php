 ...
 * List cookies.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/cookies.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListCookies extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_cookies';
    protected const DESCRIPTION = 'List cookies\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/cookies.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/cookies';
