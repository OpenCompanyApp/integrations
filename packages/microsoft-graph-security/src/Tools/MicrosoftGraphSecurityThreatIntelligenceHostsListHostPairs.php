 ...
 * List hostPairs.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/hostPairs.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListHostPairs extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_host_pairs';
    protected const DESCRIPTION = 'List hostPairs\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/hostPairs.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/hostPairs';
