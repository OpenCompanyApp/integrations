 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/parentHostPairs.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListParentHostPairs extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_parent_host_pairs';
    protected const DESCRIPTION = 'List parentHostPairs\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/parentHostPairs.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/parentHostPairs';
