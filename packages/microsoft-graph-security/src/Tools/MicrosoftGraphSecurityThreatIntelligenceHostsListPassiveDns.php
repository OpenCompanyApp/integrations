 ...
 * List passiveDns.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/passiveDns.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListPassiveDns extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_passive_dns';
    protected const DESCRIPTION = 'List passiveDns\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/passiveDns.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/passiveDns';
