 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListPassiveDnsReverse extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_passive_dns_reverse';
    protected const DESCRIPTION = 'List passiveDnsReverse\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/passiveDnsReverse';
