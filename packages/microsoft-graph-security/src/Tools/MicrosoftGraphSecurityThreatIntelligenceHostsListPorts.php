 ...
 * List hostPorts.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/ports.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListPorts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_ports';
    protected const DESCRIPTION = 'List hostPorts\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/ports.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/ports';
