 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/sslCertificates.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_ssl_certificates';
    protected const DESCRIPTION = 'List hostSslCertificates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/sslCertificates.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/sslCertificates';
