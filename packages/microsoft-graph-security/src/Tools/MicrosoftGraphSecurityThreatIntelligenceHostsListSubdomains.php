 ...
 * List subdomains.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/subdomains.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListSubdomains extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_subdomains';
    protected const DESCRIPTION = 'List subdomains\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/subdomains.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/subdomains';
