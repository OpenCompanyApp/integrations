 ...
 * List trackers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/trackers.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsListTrackers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_list_trackers';
    protected const DESCRIPTION = 'List trackers\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/trackers.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/trackers';
