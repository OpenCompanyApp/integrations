 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/parentHostPairs/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsParentHostPairsGetCount51b4 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_parent_host_pairs_get_count_51b4';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/parentHostPairs/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/parentHostPairs/$count';
