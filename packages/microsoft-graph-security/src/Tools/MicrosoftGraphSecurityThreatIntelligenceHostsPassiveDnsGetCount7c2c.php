 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/passiveDns/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsPassiveDnsGetCount7c2c extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_passive_dns_get_count_7c2c';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/passiveDns/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/passiveDns/$count';
