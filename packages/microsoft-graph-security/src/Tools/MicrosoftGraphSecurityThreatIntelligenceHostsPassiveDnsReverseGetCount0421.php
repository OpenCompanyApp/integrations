 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsPassiveDnsReverseGetCount0421 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_passive_dns_reverse_get_count_0421';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/$count';
