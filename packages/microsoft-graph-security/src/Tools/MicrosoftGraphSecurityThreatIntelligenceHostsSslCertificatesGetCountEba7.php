 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/sslCertificates/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsSslCertificatesGetCountEba7 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_ssl_certificates_get_count_eba7';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/sslCertificates/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/sslCertificates/$count';
