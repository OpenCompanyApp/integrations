 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/subdomains/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsSubdomainsGetCount67a8 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_subdomains_get_count_67a8';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/subdomains/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/subdomains/$count';
