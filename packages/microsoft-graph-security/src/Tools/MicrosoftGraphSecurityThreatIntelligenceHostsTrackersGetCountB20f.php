 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts/{host-id}/trackers/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsTrackersGetCountB20f extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_trackers_get_count_b20f';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts/{host-id}/trackers/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}/trackers/$count';
