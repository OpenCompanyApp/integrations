 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/hosts/{host-id}/reputation.
 */
class MicrosoftGraphSecurityThreatIntelligenceHostsUpdateReputation extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_hosts_update_reputation';
    protected const DESCRIPTION = 'Update the navigation property reputation in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/hosts/{host-id}/reputation.';
