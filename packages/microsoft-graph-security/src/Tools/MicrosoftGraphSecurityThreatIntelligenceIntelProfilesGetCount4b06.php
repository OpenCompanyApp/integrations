 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/intelProfiles/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceIntelProfilesGetCount4b06 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_intel_profiles_get_count_4b06';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/intelProfiles/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/intelProfiles/$count';
