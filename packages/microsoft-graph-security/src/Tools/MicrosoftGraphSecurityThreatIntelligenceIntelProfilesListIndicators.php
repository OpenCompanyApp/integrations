 ...
 * List indicators.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/intelProfiles/{intelligenceProfile-id}/indicators.
 */
class MicrosoftGraphSecurityThreatIntelligenceIntelProfilesListIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_intel_profiles_list_indicators';
    protected const DESCRIPTION = 'List indicators\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/intelProfiles/{intelligenceProfile-id}/indicators.';
    ...
    protected const PATH = '/security/threatIntelligence/intelProfiles/{intelligenceProfile-id}/indicators';
