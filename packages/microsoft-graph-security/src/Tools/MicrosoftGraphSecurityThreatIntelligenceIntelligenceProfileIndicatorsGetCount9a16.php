 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/intelligenceProfileIndicators/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceIntelligenceProfileIndicatorsGetCount9a16 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_intelligence_profile_indicators_get_count_9a16';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/intelligenceProfileIndicators/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/intelligenceProfileIndicators/$count';
