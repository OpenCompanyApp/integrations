 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articleIndicators.
 */
class MicrosoftGraphSecurityThreatIntelligenceListArticleIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_article_indicators';
    protected const DESCRIPTION = 'Get articleIndicator\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articleIndicators.';
