 ...
 * List articles.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/articles.
 */
class MicrosoftGraphSecurityThreatIntelligenceListArticles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_articles';
    protected const DESCRIPTION = 'List articles\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/articles.';
