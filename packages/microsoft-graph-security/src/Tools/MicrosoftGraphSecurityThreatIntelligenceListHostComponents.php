 ...
 * Get hostComponent.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostComponents.
 */
class MicrosoftGraphSecurityThreatIntelligenceListHostComponents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_host_components';
    protected const DESCRIPTION = 'Get hostComponent\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostComponents.';
