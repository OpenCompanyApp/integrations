 ...
 * Get hostCookie.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostCookies.
 */
class MicrosoftGraphSecurityThreatIntelligenceListHostCookies extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_host_cookies';
    protected const DESCRIPTION = 'Get hostCookie\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostCookies.';
