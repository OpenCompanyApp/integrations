 ...
 * Get hostPort.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostPorts.
 */
class MicrosoftGraphSecurityThreatIntelligenceListHostPorts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_host_ports';
    protected const DESCRIPTION = 'Get hostPort\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostPorts.';
