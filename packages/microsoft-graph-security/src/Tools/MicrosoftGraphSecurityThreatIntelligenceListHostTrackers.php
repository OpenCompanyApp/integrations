 ...
 * Get hostTracker.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hostTrackers.
 */
class MicrosoftGraphSecurityThreatIntelligenceListHostTrackers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_host_trackers';
    protected const DESCRIPTION = 'Get hostTracker\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hostTrackers.';
