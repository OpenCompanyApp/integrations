 ...
 * Get host.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/hosts.
 */
class MicrosoftGraphSecurityThreatIntelligenceListHosts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_hosts';
    protected const DESCRIPTION = 'Get host\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/hosts.';
