 ...
 * List intelProfiles.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/intelProfiles.
 */
class MicrosoftGraphSecurityThreatIntelligenceListIntelProfiles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_intel_profiles';
    protected const DESCRIPTION = 'List intelProfiles\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/intelProfiles.';
