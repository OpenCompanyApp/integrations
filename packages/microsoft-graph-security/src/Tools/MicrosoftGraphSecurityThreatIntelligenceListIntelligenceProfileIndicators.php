 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/intelligenceProfileIndicators.
 */
class MicrosoftGraphSecurityThreatIntelligenceListIntelligenceProfileIndicators extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_intelligence_profile_indicators';
    protected const DESCRIPTION = 'Get intelligenceProfileIndicator\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/intelligenceProfileIndicators.';
