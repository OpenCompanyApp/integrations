 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/passiveDnsRecords.
 */
class MicrosoftGraphSecurityThreatIntelligenceListPassiveDnsRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_passive_dns_records';
    protected const DESCRIPTION = 'Get passiveDnsRecord\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/passiveDnsRecords.';
