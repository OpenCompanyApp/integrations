 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/sslCertificates.
 */
class MicrosoftGraphSecurityThreatIntelligenceListSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_ssl_certificates';
    protected const DESCRIPTION = 'List sslCertificates\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/sslCertificates.';
