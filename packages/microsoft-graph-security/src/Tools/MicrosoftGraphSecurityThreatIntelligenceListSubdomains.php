 ...
 * Get subdomain.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/subdomains.
 */
class MicrosoftGraphSecurityThreatIntelligenceListSubdomains extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_subdomains';
    protected const DESCRIPTION = 'Get subdomain\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/subdomains.';
