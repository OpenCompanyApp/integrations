 ...
 * Get vulnerability.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/vulnerabilities.
 */
class MicrosoftGraphSecurityThreatIntelligenceListVulnerabilities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_vulnerabilities';
    protected const DESCRIPTION = 'Get vulnerability\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/vulnerabilities.';
