 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisHistoryRecords.
 */
class MicrosoftGraphSecurityThreatIntelligenceListWhoisHistoryRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_whois_history_records';
    protected const DESCRIPTION = 'Get whoisHistoryRecords from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisHistoryRecords.';
