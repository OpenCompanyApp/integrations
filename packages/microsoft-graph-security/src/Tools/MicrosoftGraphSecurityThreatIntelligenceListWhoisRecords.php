 ...
 * List whoisRecords.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisRecords.
 */
class MicrosoftGraphSecurityThreatIntelligenceListWhoisRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_list_whois_records';
    protected const DESCRIPTION = 'List whoisRecords\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisRecords.';
