 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}/artifact.
 */
class MicrosoftGraphSecurityThreatIntelligencePassiveDnsRecordsGetArtifact extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_passive_dns_records_get_artifact';
    protected const DESCRIPTION = 'Get artifact from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}/artifact.';
    ...
    protected const PATH = '/security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}/artifact';
