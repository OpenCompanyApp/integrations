 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/passiveDnsRecords/$count.
 */
class MicrosoftGraphSecurityThreatIntelligencePassiveDnsRecordsGetCountA5be extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_passive_dns_records_get_count_a5be';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/passiveDnsRecords/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/passiveDnsRecords/$count';
