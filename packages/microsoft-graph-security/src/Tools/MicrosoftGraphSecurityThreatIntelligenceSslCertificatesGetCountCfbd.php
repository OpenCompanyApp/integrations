 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/sslCertificates/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceSslCertificatesGetCountCfbd extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_ssl_certificates_get_count_cfbd';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/sslCertificates/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/sslCertificates/$count';
