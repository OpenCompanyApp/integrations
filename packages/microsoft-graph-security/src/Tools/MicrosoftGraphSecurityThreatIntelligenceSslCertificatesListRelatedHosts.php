 ...
 * List relatedHosts.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts.
 */
class MicrosoftGraphSecurityThreatIntelligenceSslCertificatesListRelatedHosts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_ssl_certificates_list_related_hosts';
    protected const DESCRIPTION = 'List relatedHosts\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts.';
    ...
    protected const PATH = '/security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts';
