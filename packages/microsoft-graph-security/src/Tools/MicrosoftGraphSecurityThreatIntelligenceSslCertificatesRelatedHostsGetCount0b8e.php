 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceSslCertificatesRelatedHostsGetCount0b8e extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_ssl_certificates_related_hosts_get_count_0b8e';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/sslCertificates/{sslCertificate-id}/relatedHosts/$count';
