 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/subdomains/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceSubdomainsGetCount34a3 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_subdomains_get_count_34a3';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/subdomains/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/subdomains/$count';
