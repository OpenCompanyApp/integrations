 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/articles/{article-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateArticles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_articles';
    protected const DESCRIPTION = 'Update the navigation property articles in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/articles/{article-id}.';
