 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateHostSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_host_ssl_certificates';
    protected const DESCRIPTION = 'Update the navigation property hostSslCertificates in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/hostSslCertificates/{hostSslCertificate-id}.';
