 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/hostTrackers/{hostTracker-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateHostTrackers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_host_trackers';
    protected const DESCRIPTION = 'Update the navigation property hostTrackers in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/hostTrackers/{hostTracker-id}.';
