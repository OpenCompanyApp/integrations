 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/hosts/{host-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateHosts extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_hosts';
    protected const DESCRIPTION = 'Update the navigation property hosts in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/hosts/{host-id}.';
    ...
    protected const PATH = '/security/threatIntelligence/hosts/{host-id}';
