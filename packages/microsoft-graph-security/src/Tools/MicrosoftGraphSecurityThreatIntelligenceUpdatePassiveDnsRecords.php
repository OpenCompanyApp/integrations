 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdatePassiveDnsRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_passive_dns_records';
    protected const DESCRIPTION = 'Update the navigation property passiveDnsRecords in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord-id}.';
