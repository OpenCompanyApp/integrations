 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/sslCertificates/{sslCertificate-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateSslCertificates extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_ssl_certificates';
    protected const DESCRIPTION = 'Update the navigation property sslCertificates in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/sslCertificates/{sslCertificate-id}.';
