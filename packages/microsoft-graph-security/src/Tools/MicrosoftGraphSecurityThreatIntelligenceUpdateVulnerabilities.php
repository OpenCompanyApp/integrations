 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/vulnerabilities/{vulnerability-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateVulnerabilities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_vulnerabilities';
    protected const DESCRIPTION = 'Update the navigation property vulnerabilities in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/vulnerabilities/{vulnerability-id}.';
    ...
    protected const PATH = '/security/threatIntelligence/vulnerabilities/{vulnerability-id}';
