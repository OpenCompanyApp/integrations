 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence/whoisRecords/{whoisRecord-id}.
 */
class MicrosoftGraphSecurityThreatIntelligenceUpdateWhoisRecords extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_update_whois_records';
    protected const DESCRIPTION = 'Update the navigation property whoisRecords in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence/whoisRecords/{whoisRecord-id}.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisRecords/{whoisRecord-id}';
