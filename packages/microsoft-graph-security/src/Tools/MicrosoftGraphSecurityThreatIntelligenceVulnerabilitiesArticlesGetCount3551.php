 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/vulnerabilities/{vulnerability-id}/articles/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceVulnerabilitiesArticlesGetCount3551 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_vulnerabilities_articles_get_count_3551';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/vulnerabilities/{vulnerability-id}/articles/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/vulnerabilities/{vulnerability-id}/articles/$count';
