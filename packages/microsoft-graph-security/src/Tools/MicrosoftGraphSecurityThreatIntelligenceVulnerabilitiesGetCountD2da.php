 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/vulnerabilities/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceVulnerabilitiesGetCountD2da extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_vulnerabilities_get_count_d2da';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/vulnerabilities/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/vulnerabilities/$count';
