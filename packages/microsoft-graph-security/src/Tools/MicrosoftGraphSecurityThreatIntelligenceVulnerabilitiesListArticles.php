 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/vulnerabilities/{vulnerability-id}/articles.
 */
class MicrosoftGraphSecurityThreatIntelligenceVulnerabilitiesListArticles extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_vulnerabilities_list_articles';
    protected const DESCRIPTION = 'Get articles from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/vulnerabilities/{vulnerability-id}/articles.';
    ...
    protected const PATH = '/security/threatIntelligence/vulnerabilities/{vulnerability-id}/articles';
