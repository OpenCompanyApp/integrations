 ...
 * List components.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/vulnerabilities/{vulnerability-id}/components.
 */
class MicrosoftGraphSecurityThreatIntelligenceVulnerabilitiesListComponents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_vulnerabilities_list_components';
    protected const DESCRIPTION = 'List components\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/vulnerabilities/{vulnerability-id}/components.';
