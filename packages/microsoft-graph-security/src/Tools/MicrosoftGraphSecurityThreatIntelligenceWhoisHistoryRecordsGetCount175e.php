 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisHistoryRecords/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceWhoisHistoryRecordsGetCount175e extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_whois_history_records_get_count_175e';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisHistoryRecords/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisHistoryRecords/$count';
