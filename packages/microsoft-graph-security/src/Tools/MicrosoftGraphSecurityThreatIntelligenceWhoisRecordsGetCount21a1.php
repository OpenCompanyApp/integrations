 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisRecords/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceWhoisRecordsGetCount21a1 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_whois_records_get_count_21a1';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisRecords/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisRecords/$count';
