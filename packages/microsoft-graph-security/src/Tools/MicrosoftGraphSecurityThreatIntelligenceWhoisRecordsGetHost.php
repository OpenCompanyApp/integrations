 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}/host.
 */
class MicrosoftGraphSecurityThreatIntelligenceWhoisRecordsGetHost extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_whois_records_get_host';
    protected const DESCRIPTION = 'Get host from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}/host.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisRecords/{whoisRecord-id}/host';
