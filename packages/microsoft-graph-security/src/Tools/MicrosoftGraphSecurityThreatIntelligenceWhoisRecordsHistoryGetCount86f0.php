 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}/history/$count.
 */
class MicrosoftGraphSecurityThreatIntelligenceWhoisRecordsHistoryGetCount86f0 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_whois_records_history_get_count_86f0';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}/history/$count.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisRecords/{whoisRecord-id}/history/$count';
