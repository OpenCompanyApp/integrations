 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}/history.
 */
class MicrosoftGraphSecurityThreatIntelligenceWhoisRecordsListHistory extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_threat_intelligence_whois_records_list_history';
    protected const DESCRIPTION = 'Get history from security\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/threatIntelligence/whoisRecords/{whoisRecord-id}/history.';
    ...
    protected const PATH = '/security/threatIntelligence/whoisRecords/{whoisRecord-id}/history';
    protected const PATH_PARAMS = ['whoisRecord-id' => 'whois_record_id'];
