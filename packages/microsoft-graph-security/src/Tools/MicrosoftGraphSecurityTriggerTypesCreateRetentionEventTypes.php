 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/triggerTypes/retentionEventTypes.
 */
class MicrosoftGraphSecurityTriggerTypesCreateRetentionEventTypes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_trigger_types_create_retention_event_types';
    protected const DESCRIPTION = 'Create retentionEventType\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/triggerTypes/retentionEventTypes.';
    ...
    protected const PATH = '/security/triggerTypes/retentionEventTypes';
