 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/triggerTypes/retentionEventTypes.
 */
class MicrosoftGraphSecurityTriggerTypesListRetentionEventTypes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_trigger_types_list_retention_event_types';
    protected const DESCRIPTION = 'List retentionEventTypes\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/triggerTypes/retentionEventTypes.';
