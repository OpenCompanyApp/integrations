 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/triggerTypes/retentionEventTypes/$count.
 */
class MicrosoftGraphSecurityTriggerTypesRetentionEventTypesGetCountE3fe extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_trigger_types_retention_event_types_get_count_e3fe';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/triggerTypes/retentionEventTypes/$count.';
    ...
    protected const PATH = '/security/triggerTypes/retentionEventTypes/$count';
