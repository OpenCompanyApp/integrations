 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /security/triggers/retentionEvents.
 */
class MicrosoftGraphSecurityTriggersCreateRetentionEvents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_triggers_create_retention_events';
    protected const DESCRIPTION = 'Create retentionEvent\n\nOfficial Microsoft Graph v1.0 endpoint: POST /security/triggers/retentionEvents.';
    ...
    protected const PATH = '/security/triggers/retentionEvents';
