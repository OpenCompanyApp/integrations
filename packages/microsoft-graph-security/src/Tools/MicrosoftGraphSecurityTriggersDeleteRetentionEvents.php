 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /security/triggers/retentionEvents/{retentionEvent-id}.
 */
class MicrosoftGraphSecurityTriggersDeleteRetentionEvents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_triggers_delete_retention_events';
    protected const DESCRIPTION = 'Delete retentionEvent\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /security/triggers/retentionEvents/{retentionEvent-id}.';
