 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/triggers/retentionEvents.
 */
class MicrosoftGraphSecurityTriggersListRetentionEvents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_triggers_list_retention_events';
    protected const DESCRIPTION = 'List retentionEvents\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/triggers/retentionEvents.';
