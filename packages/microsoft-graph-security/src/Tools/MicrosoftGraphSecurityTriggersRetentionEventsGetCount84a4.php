 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /security/triggers/retentionEvents/$count.
 */
class MicrosoftGraphSecurityTriggersRetentionEventsGetCount84a4 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_triggers_retention_events_get_count_84a4';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /security/triggers/retentionEvents/$count.';
    ...
    protected const PATH = '/security/triggers/retentionEvents/$count';
