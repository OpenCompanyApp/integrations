 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/triggers/retentionEvents/{retentionEvent-id}.
 */
class MicrosoftGraphSecurityTriggersUpdateRetentionEvents extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_triggers_update_retention_events';
    protected const DESCRIPTION = 'Update the navigation property retentionEvents in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/triggers/retentionEvents/{retentionEvent-id}.';
