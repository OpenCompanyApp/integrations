 ...
 * Update alert.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/alerts_v2/{alert-id}.
 */
class MicrosoftGraphSecurityUpdateAlertsV2 extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_alerts_v2';
    protected const DESCRIPTION = 'Update alert\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/alerts_v2/{alert-id}.';
