 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/attackSimulation.
 */
class MicrosoftGraphSecurityUpdateAttackSimulation extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_attack_simulation';
    protected const DESCRIPTION = 'Update the navigation property attackSimulation in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/attackSimulation.';
    ...
    protected const PATH = '/security/attackSimulation';
