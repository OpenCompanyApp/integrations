 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/cases.
 */
class MicrosoftGraphSecurityUpdateCases extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_cases';
    protected const DESCRIPTION = 'Update the navigation property cases in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/cases.';
    ...
    protected const PATH = '/security/cases';
