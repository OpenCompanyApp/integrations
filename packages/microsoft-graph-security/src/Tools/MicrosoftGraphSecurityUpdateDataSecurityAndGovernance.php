 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/dataSecurityAndGovernance.
 */
class MicrosoftGraphSecurityUpdateDataSecurityAndGovernance extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_data_security_and_governance';
    protected const DESCRIPTION = 'Update the navigation property dataSecurityAndGovernance in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/dataSecurityAndGovernance.';
    ...
    protected const PATH = '/security/dataSecurityAndGovernance';
