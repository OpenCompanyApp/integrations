 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/identities.
 */
class MicrosoftGraphSecurityUpdateIdentities extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_identities';
    protected const DESCRIPTION = 'Update the navigation property identities in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/identities.';
    ...
    protected const PATH = '/security/identities';
