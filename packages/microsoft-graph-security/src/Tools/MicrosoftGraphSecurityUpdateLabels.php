 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/labels.
 */
class MicrosoftGraphSecurityUpdateLabels extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_labels';
    protected const DESCRIPTION = 'Update the navigation property labels in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/labels.';
    ...
    protected const PATH = '/security/labels';
