 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/secureScores/{secureScore-id}.
 */
class MicrosoftGraphSecurityUpdateSecureScores extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_secure_scores';
    protected const DESCRIPTION = 'Update the navigation property secureScores in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/secureScores/{secureScore-id}.';
