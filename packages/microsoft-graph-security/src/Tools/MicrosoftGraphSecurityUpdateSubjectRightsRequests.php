 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/subjectRightsRequests/{subjectRightsRequest-id}.
 */
class MicrosoftGraphSecurityUpdateSubjectRightsRequests extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_subject_rights_requests';
    protected const DESCRIPTION = 'Update the navigation property subjectRightsRequests in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/subjectRightsRequests/{subjectRightsRequest-id}.';
