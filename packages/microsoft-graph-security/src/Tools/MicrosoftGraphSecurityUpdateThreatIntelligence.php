 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/threatIntelligence.
 */
class MicrosoftGraphSecurityUpdateThreatIntelligence extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_threat_intelligence';
    protected const DESCRIPTION = 'Update the navigation property threatIntelligence in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/threatIntelligence.';
    ...
    protected const PATH = '/security/threatIntelligence';
