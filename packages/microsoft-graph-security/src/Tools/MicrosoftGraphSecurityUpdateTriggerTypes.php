 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/triggerTypes.
 */
class MicrosoftGraphSecurityUpdateTriggerTypes extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_trigger_types';
    protected const DESCRIPTION = 'Update the navigation property triggerTypes in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/triggerTypes.';
