 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /security/triggers.
 */
class MicrosoftGraphSecurityUpdateTriggers extends AbstractMicrosoftGraphSecurityTool
{
    protected const NAME = 'microsoft_graph_security_update_triggers';
    protected const DESCRIPTION = 'Update the navigation property triggers in security\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /security/triggers.';
    ...
    protected const PATH = '/security/triggers';
