...
/**
 * Shared executor for generated Microsoft Intune tools.
 *
 ...
 */
abstract class AbstractMicrosoftIntuneTool implements Tool
{
    ...
    /** @param  MicrosoftIntuneService  $service  Microsoft Intune API client. */
    public function __construct(protected MicrosoftIntuneService $service) {}
    ...
    {
        try {
            if (!$this->service->isConfigured()) { return ToolResult::error('Microsoft Intune access token is required.'); }
