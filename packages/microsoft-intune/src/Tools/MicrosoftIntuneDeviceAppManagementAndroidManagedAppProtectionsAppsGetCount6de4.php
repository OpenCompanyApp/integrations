 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/apps/$count.
 */
class MicrosoftIntuneDeviceAppManagementAndroidManagedAppProtectionsAppsGetCount6de4 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_android_managed_app_protections_apps_get_count_6de4';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/apps/$count';
