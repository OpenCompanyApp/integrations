 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementAndroidManagedAppProtectionsAssignmentsGetCount574a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_android_managed_app_protections_assignments_get_count_574a';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/assignments/$count';
