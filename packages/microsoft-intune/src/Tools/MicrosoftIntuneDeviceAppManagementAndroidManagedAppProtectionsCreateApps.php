 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/apps.
 */
class MicrosoftIntuneDeviceAppManagementAndroidManagedAppProtectionsCreateApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_android_managed_app_protections_create_apps';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/apps';
