 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/assignments.
 */
class MicrosoftIntuneDeviceAppManagementAndroidManagedAppProtectionsCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_android_managed_app_protections_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/assignments';
