 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}/assignments/{targetedManagedAppPolicyAssignment-id}.
 */
class MicrosoftIntuneDeviceAppManagementAndroidManagedAppProtectionsGetAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_android_managed_app_protections_get_assignments';
