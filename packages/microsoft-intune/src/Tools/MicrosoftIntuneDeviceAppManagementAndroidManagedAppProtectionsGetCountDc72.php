 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/androidManagedAppProtections/$count.
 */
class MicrosoftIntuneDeviceAppManagementAndroidManagedAppProtectionsGetCountDc72 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_android_managed_app_protections_get_count_dc72';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections/$count';
