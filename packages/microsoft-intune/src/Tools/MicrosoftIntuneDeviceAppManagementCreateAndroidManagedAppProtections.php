 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/androidManagedAppProtections.
 */
class MicrosoftIntuneDeviceAppManagementCreateAndroidManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_android_managed_app_protections';
    protected const DESCRIPTION = 'Create new navigation property to androidManagedAppProtections for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/androidManagedAppProtections.';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections';
