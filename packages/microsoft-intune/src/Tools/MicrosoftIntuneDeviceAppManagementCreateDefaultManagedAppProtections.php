 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/defaultManagedAppProtections.
 */
class MicrosoftIntuneDeviceAppManagementCreateDefaultManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_default_managed_app_protections';
    protected const DESCRIPTION = 'Create new navigation property to defaultManagedAppProtections for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/defaultManagedAppProtections.';
    ...
    protected const PATH = '/deviceAppManagement/defaultManagedAppProtections';
