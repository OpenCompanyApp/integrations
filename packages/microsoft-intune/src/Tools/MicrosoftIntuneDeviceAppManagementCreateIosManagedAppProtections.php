 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/iosManagedAppProtections.
 */
class MicrosoftIntuneDeviceAppManagementCreateIosManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_ios_managed_app_protections';
    protected const DESCRIPTION = 'Create new navigation property to iosManagedAppProtections for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/iosManagedAppProtections.';
    ...
    protected const PATH = '/deviceAppManagement/iosManagedAppProtections';
