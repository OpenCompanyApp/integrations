 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedAppPolicies.
 */
class MicrosoftIntuneDeviceAppManagementCreateManagedAppPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_managed_app_policies';
    protected const DESCRIPTION = 'Create new navigation property to managedAppPolicies for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/managedAppPolicies.';
    ...
    protected const PATH = '/deviceAppManagement/managedAppPolicies';
