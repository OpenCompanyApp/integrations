 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedAppRegistrations.
 */
class MicrosoftIntuneDeviceAppManagementCreateManagedAppRegistrations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_managed_app_registrations';
    protected const DESCRIPTION = 'Create new navigation property to managedAppRegistrations for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/managedAppRegistrations.';
    ...
    protected const PATH = '/deviceAppManagement/managedAppRegistrations';
