 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedAppStatuses.
 */
class MicrosoftIntuneDeviceAppManagementCreateManagedAppStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_managed_app_statuses';
    protected const DESCRIPTION = 'Create new navigation property to managedAppStatuses for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/managedAppStatuses.';
    ...
    protected const PATH = '/deviceAppManagement/managedAppStatuses';
