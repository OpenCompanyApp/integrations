 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedEBooks.
 */
class MicrosoftIntuneDeviceAppManagementCreateManagedEBooks extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_managed_ebooks';
    protected const DESCRIPTION = 'Create new navigation property to managedEBooks for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/managedEBooks.';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks';
