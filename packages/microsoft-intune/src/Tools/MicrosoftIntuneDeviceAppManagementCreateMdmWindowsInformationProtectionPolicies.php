 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies.
 */
class MicrosoftIntuneDeviceAppManagementCreateMdmWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_mdm_windows_information_protection_policies';
    protected const DESCRIPTION = 'Create new navigation property to mdmWindowsInformationProtectionPolicies for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies.';
    ...
    protected const PATH = '/deviceAppManagement/mdmWindowsInformationProtectionPolicies';
