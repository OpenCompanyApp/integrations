 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileAppCategories.
 */
class MicrosoftIntuneDeviceAppManagementCreateMobileAppCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_mobile_app_categories';
    protected const DESCRIPTION = 'Create new navigation property to mobileAppCategories for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mobileAppCategories.';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppCategories';
