 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileAppConfigurations.
 */
class MicrosoftIntuneDeviceAppManagementCreateMobileAppConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_mobile_app_configurations';
    protected const DESCRIPTION = 'Create new navigation property to mobileAppConfigurations for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mobileAppConfigurations.';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppConfigurations';
