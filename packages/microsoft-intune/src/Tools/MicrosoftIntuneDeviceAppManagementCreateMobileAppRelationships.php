 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileAppRelationships.
 */
class MicrosoftIntuneDeviceAppManagementCreateMobileAppRelationships extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_mobile_app_relationships';
    protected const DESCRIPTION = 'Create new navigation property to mobileAppRelationships for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mobileAppRelationships.';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppRelationships';
