 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps.
 */
class MicrosoftIntuneDeviceAppManagementCreateMobileApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_mobile_apps';
    protected const DESCRIPTION = 'Create new navigation property to mobileApps for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mobileApps.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps';
