 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/targetedManagedAppConfigurations.
 */
class MicrosoftIntuneDeviceAppManagementCreateTargetedManagedAppConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_targeted_managed_app_configurations';
    protected const DESCRIPTION = 'Create new navigation property to targetedManagedAppConfigurations for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/targetedManagedAppConfigurations.';
    ...
    protected const PATH = '/deviceAppManagement/targetedManagedAppConfigurations';
