 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/vppTokens.
 */
class MicrosoftIntuneDeviceAppManagementCreateVppTokens extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_vpp_tokens';
    protected const DESCRIPTION = 'Create new navigation property to vppTokens for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/vppTokens.';
    ...
    protected const PATH = '/deviceAppManagement/vppTokens';
