 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/windowsInformationProtectionPolicies.
 */
class MicrosoftIntuneDeviceAppManagementCreateWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_create_windows_information_protection_policies';
    protected const DESCRIPTION = 'Create new navigation property to windowsInformationProtectionPolicies for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/windowsInformationProtectionPolicies.';
    ...
    protected const PATH = '/deviceAppManagement/windowsInformationProtectionPolicies';
