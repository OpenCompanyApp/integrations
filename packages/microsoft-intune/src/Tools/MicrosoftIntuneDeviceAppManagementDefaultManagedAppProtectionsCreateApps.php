 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/apps.
 */
class MicrosoftIntuneDeviceAppManagementDefaultManagedAppProtectionsCreateApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_default_managed_app_protections_create_apps';
    ...
    protected const PATH = '/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/apps';
