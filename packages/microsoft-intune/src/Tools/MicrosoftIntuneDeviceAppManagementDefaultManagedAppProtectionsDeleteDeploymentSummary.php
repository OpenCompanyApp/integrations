 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/deploymentSummary.
 */
class MicrosoftIntuneDeviceAppManagementDefaultManagedAppProtectionsDeleteDeploymentSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_default_managed_app_protections_delete_deployment_summary';
