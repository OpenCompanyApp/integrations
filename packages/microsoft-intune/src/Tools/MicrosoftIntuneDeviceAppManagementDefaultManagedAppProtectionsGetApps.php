 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/apps/{managedMobileApp-id}.
 */
class MicrosoftIntuneDeviceAppManagementDefaultManagedAppProtectionsGetApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_default_managed_app_protections_get_apps';
