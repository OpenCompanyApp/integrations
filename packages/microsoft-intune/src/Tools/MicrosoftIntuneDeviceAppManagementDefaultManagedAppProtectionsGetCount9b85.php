 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/defaultManagedAppProtections/$count.
 */
class MicrosoftIntuneDeviceAppManagementDefaultManagedAppProtectionsGetCount9b85 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_default_managed_app_protections_get_count_9b85';
    ...
    protected const PATH = '/deviceAppManagement/defaultManagedAppProtections/$count';
