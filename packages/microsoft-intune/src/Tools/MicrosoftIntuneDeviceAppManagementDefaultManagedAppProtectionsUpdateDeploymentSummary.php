 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/deploymentSummary.
 */
class MicrosoftIntuneDeviceAppManagementDefaultManagedAppProtectionsUpdateDeploymentSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_default_managed_app_protections_update_deployment_summary';
    ...
    protected const PATH = '/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}/deploymentSummary';
    protected const PATH_PARAMS = ['defaultManagedAppProtection-id' => 'default_managed_app_protection_id'];
