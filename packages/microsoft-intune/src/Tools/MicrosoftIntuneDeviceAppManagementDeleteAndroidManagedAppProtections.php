 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteAndroidManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_android_managed_app_protections';
    protected const DESCRIPTION = 'Delete navigation property androidManagedAppProtections for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}.';
