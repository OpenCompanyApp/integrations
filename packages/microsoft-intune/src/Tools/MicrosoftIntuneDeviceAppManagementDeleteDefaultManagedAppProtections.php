 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteDefaultManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_default_managed_app_protections';
    protected const DESCRIPTION = 'Delete navigation property defaultManagedAppProtections for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}.';
