 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/managedAppStatuses/{managedAppStatus-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteManagedAppStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_managed_app_statuses';
    protected const DESCRIPTION = 'Delete navigation property managedAppStatuses for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/managedAppStatuses/{managedAppStatus-id}.';
