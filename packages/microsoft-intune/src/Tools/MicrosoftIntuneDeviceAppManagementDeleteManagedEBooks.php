 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/managedEBooks/{managedEBook-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteManagedEBooks extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_managed_ebooks';
    protected const DESCRIPTION = 'Delete navigation property managedEBooks for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/managedEBooks/{managedEBook-id}.';
