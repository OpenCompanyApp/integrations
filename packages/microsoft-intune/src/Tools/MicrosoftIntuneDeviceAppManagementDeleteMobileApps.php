 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/mobileApps/{mobileApp-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteMobileApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_mobile_apps';
    protected const DESCRIPTION = 'Delete navigation property mobileApps for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/mobileApps/{mobileApp-id}.';
