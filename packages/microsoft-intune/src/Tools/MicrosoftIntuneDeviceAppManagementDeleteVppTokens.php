 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/vppTokens/{vppToken-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteVppTokens extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_vpp_tokens';
    protected const DESCRIPTION = 'Delete navigation property vppTokens for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/vppTokens/{vppToken-id}.';
