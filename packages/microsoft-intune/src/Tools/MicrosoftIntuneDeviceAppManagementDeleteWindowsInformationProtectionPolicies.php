 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}.
 */
class MicrosoftIntuneDeviceAppManagementDeleteWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_delete_windows_information_protection_policies';
    protected const DESCRIPTION = 'Delete navigation property windowsInformationProtectionPolicies for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}.';
