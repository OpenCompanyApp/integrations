 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement.
 */
class MicrosoftIntuneDeviceAppManagementDeviceAppManagementGetDeviceAppManagement extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_device_app_management_get_device_app_management';
    protected const DESCRIPTION = 'Get deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement.';
