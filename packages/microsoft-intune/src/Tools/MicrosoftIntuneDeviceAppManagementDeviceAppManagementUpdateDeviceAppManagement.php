 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement.
 */
class MicrosoftIntuneDeviceAppManagementDeviceAppManagementUpdateDeviceAppManagement extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_device_app_management_update_device_app_management';
    protected const DESCRIPTION = 'Update deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement.';
    ...
    protected const PATH = '/deviceAppManagement';
