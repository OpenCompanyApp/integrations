 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetAndroidManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_android_managed_app_protections';
    protected const DESCRIPTION = 'Get androidManagedAppProtections from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}.';
