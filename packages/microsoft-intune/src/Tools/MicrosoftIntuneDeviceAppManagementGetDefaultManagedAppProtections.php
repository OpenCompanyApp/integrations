 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetDefaultManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_default_managed_app_protections';
    protected const DESCRIPTION = 'Get defaultManagedAppProtections from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}.';
