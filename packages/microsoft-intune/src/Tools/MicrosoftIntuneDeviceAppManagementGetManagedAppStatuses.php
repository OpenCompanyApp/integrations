 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppStatuses/{managedAppStatus-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetManagedAppStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_managed_app_statuses';
    protected const DESCRIPTION = 'Get managedAppStatuses from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/managedAppStatuses/{managedAppStatus-id}.';
