 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetManagedEBooks extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_managed_ebooks';
    protected const DESCRIPTION = 'Get managedEBooks from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/managedEBooks/{managedEBook-id}.';
