 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetMdmWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mdm_windows_information_protection_policies';
    protected const DESCRIPTION = 'Get mdmWindowsInformationProtectionPolicies from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}.';
