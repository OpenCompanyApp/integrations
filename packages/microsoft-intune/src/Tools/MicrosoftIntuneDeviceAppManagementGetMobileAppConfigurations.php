 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetMobileAppConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mobile_app_configurations';
    protected const DESCRIPTION = 'Get mobileAppConfigurations from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}.';
