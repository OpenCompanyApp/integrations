 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp.
 */
class MicrosoftIntuneDeviceAppManagementGetMobileAppsAsAndroidLobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mobile_apps_as_android_lob_app';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.mobileApp as microsoft.graph.androidLobApp\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp';
