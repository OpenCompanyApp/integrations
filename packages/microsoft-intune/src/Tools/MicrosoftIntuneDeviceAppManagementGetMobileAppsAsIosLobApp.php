 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp.
 */
class MicrosoftIntuneDeviceAppManagementGetMobileAppsAsIosLobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mobile_apps_as_ios_lob_app';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.mobileApp as microsoft.graph.iosLobApp\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp';
