 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosStoreApp.
 */
class MicrosoftIntuneDeviceAppManagementGetMobileAppsAsIosStoreApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mobile_apps_as_ios_store_app';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.mobileApp as microsoft.graph.iosStoreApp\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosStoreApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosStoreApp';
