 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp.
 */
class MicrosoftIntuneDeviceAppManagementGetMobileAppsAsMicrosoftStoreForBusinessApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mobile_apps_as_microsoft_store_for_business_app';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.mobileApp as microsoft.graph.microsoftStoreForBusinessApp\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp';
