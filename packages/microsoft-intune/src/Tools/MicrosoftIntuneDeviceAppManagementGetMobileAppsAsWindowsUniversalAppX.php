 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX.
 */
class MicrosoftIntuneDeviceAppManagementGetMobileAppsAsWindowsUniversalAppX extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_mobile_apps_as_windows_universal_app_x';
    protected const DESCRIPTION = 'Get the item of type microsoft.graph.mobileApp as microsoft.graph.windowsUniversalAppX\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX';
