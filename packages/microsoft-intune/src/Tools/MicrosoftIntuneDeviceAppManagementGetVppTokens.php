 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/vppTokens/{vppToken-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetVppTokens extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_vpp_tokens';
    protected const DESCRIPTION = 'Get vppTokens from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/vppTokens/{vppToken-id}.';
