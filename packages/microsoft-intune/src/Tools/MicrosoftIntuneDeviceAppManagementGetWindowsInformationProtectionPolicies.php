 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}.
 */
class MicrosoftIntuneDeviceAppManagementGetWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_get_windows_information_protection_policies';
    protected const DESCRIPTION = 'Get windowsInformationProtectionPolicies from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}.';
