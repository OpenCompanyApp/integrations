 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/iosManagedAppProtections/$count.
 */
class MicrosoftIntuneDeviceAppManagementIosManagedAppProtectionsGetCountDcdc extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_ios_managed_app_protections_get_count_dcdc';
    ...
    protected const PATH = '/deviceAppManagement/iosManagedAppProtections/$count';
