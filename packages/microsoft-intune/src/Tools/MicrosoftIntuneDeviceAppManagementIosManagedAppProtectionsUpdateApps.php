 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection-id}/apps/{managedMobileApp-id}.
 */
class MicrosoftIntuneDeviceAppManagementIosManagedAppProtectionsUpdateApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_ios_managed_app_protections_update_apps';
