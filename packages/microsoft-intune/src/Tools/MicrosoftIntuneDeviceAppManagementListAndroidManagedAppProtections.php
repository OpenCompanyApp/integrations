 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/androidManagedAppProtections.
 */
class MicrosoftIntuneDeviceAppManagementListAndroidManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_android_managed_app_protections';
