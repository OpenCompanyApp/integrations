 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/defaultManagedAppProtections.
 */
class MicrosoftIntuneDeviceAppManagementListDefaultManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_default_managed_app_protections';
