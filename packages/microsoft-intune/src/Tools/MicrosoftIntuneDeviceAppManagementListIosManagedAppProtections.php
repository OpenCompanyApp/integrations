 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/iosManagedAppProtections.
 */
class MicrosoftIntuneDeviceAppManagementListIosManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_ios_managed_app_protections';
