 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppPolicies.
 */
class MicrosoftIntuneDeviceAppManagementListManagedAppPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_managed_app_policies';
