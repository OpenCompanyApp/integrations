 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppRegistrations.
 */
class MicrosoftIntuneDeviceAppManagementListManagedAppRegistrations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_managed_app_registrations';
