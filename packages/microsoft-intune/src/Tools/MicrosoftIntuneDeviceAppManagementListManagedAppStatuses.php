 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppStatuses.
 */
class MicrosoftIntuneDeviceAppManagementListManagedAppStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_managed_app_statuses';
