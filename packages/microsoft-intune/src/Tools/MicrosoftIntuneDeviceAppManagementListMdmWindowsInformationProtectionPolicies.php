 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mdmWindowsInformationProtectionPolicies.
 */
class MicrosoftIntuneDeviceAppManagementListMdmWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mdm_windows_information_protection_policies';
