 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.androidLobApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsAndroidLobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_android_lob_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.androidLobApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.androidLobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.androidLobApp';
