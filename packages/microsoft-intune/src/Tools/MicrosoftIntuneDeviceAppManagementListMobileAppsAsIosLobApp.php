 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.iosLobApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsIosLobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_ios_lob_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.iosLobApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.iosLobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.iosLobApp';
