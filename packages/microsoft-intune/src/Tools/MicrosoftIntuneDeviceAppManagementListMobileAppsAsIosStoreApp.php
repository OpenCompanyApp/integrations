 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.iosStoreApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsIosStoreApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_ios_store_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.iosStoreApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.iosStoreApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.iosStoreApp';
