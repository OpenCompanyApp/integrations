 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.iosVppApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsIosVppApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_ios_vpp_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.iosVppApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.iosVppApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.iosVppApp';
