 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.macOSLobApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsMacOSLobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_mac_oslob_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.macOSLobApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.macOSLobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.macOSLobApp';
