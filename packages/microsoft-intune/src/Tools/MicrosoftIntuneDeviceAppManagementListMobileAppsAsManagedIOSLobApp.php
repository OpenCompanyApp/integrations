 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.managedIOSLobApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsManagedIOSLobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_managed_ioslob_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.managedIOSLobApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.managedIOSLobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.managedIOSLobApp';
