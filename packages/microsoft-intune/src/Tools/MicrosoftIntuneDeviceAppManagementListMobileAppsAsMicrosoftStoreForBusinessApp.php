 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsMicrosoftStoreForBusinessApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_microsoft_store_for_business_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.microsoftStoreForBusinessApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp';
