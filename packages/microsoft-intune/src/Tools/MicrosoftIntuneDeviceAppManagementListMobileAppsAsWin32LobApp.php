 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.win32LobApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsWin32LobApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_win32_lob_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.win32LobApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.win32LobApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.win32LobApp';
