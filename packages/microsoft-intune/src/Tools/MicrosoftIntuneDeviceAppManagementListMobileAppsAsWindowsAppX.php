 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.windowsAppX.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsWindowsAppX extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_windows_app_x';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.windowsAppX in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.windowsAppX.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.windowsAppX';
