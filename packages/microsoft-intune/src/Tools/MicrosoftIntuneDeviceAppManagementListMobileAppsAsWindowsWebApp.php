 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.windowsWebApp.
 */
class MicrosoftIntuneDeviceAppManagementListMobileAppsAsWindowsWebApp extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_mobile_apps_as_windows_web_app';
    protected const DESCRIPTION = 'Get the items of type microsoft.graph.windowsWebApp in the microsoft.graph.mobileApp collection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/mobileApps/graph.windowsWebApp.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.windowsWebApp';
