 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/targetedManagedAppConfigurations.
 */
class MicrosoftIntuneDeviceAppManagementListTargetedManagedAppConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_targeted_managed_app_configurations';
