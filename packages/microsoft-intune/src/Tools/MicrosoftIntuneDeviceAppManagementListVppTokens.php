 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/vppTokens.
 */
class MicrosoftIntuneDeviceAppManagementListVppTokens extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_vpp_tokens';
