 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/windowsInformationProtectionPolicies.
 */
class MicrosoftIntuneDeviceAppManagementListWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_list_windows_information_protection_policies';
