 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppPolicies/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedAppPoliciesGetCountB24d extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_app_policies_get_count_b24d';
    ...
    protected const PATH = '/deviceAppManagement/managedAppPolicies/$count';
