 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppRegistrations/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedAppRegistrationsGetCountE04a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_app_registrations_get_count_e04a';
    ...
    protected const PATH = '/deviceAppManagement/managedAppRegistrations/$count';
