 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppRegistrations/getUserIdsWithFlaggedAppRegistration().
 */
class MicrosoftIntuneDeviceAppManagementManagedAppRegistrationsGetUserIdsWithFlaggedAppRegistration extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_app_registrations_get_user_ids_with_flagged_app_registration';
    protected const DESCRIPTION = 'Invoke function getUserIdsWithFlaggedAppRegistration\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/managedAppRegistrations/getUserIdsWithFlaggedAppRegistration().';
    ...
    protected const PATH = '/deviceAppManagement/managedAppRegistrations/getUserIdsWithFlaggedAppRegistration()';
