 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedAppStatuses/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedAppStatusesGetCount1655 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_app_statuses_get_count_1655';
    ...
    protected const PATH = '/deviceAppManagement/managedAppStatuses/$count';
