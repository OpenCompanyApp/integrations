 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksAssignmentsGetCountB034 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_assignments_get_count_b034';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/assignments/$count';
