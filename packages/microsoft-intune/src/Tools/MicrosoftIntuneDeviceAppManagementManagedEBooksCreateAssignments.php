 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedEBooks/{managedEBook-id}/assignments.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/assignments';
