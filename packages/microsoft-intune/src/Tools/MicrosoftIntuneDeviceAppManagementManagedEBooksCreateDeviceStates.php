 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedEBooks/{managedEBook-id}/deviceStates.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksCreateDeviceStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_create_device_states';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/deviceStates';
