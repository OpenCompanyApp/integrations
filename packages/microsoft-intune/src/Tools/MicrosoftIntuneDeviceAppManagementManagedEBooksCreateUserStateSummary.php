 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksCreateUserStateSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_create_user_state_summary';
    protected const DESCRIPTION = 'Create new navigation property to userStateSummary for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary.';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary';
