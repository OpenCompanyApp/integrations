 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/deviceStates/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksDeviceStatesGetCount6c04 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_device_states_get_count_6c04';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/deviceStates/$count';
