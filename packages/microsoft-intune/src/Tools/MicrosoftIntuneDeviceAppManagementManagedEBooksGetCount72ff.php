 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksGetCount72ff extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_get_count_72ff';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/$count';
