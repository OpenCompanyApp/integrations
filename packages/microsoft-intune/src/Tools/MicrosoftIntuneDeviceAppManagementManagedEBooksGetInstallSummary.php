 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/installSummary.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksGetInstallSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_get_install_summary';
    protected const DESCRIPTION = 'Get installSummary from deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceAppManagement/managedEBooks/{managedEBook-id}/installSummary.';
