 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/deviceStates.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksListDeviceStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_list_device_states';
