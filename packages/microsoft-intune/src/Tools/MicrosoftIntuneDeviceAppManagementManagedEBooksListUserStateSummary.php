 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksListUserStateSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_list_user_state_summary';
