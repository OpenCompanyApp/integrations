 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedEBooks/{managedEBook-id}/assign.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksManagedEBookAssign extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_managed_ebook_assign';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/assign';
