 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/managedEBooks/{managedEBook-id}/installSummary.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksUpdateInstallSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_update_install_summary';
    protected const DESCRIPTION = 'Update the navigation property installSummary in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/managedEBooks/{managedEBook-id}/installSummary.';
