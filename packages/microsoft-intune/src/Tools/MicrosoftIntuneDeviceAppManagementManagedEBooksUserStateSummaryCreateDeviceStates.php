 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/{userInstallStateSummary-id}/deviceStates.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksUserStateSummaryCreateDeviceStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_user_state_summary_create_device_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceStates for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/{userInstallStateSummary-id}/deviceStates.';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/{userInstallStateSummary-id}/deviceStates';
    protected const PATH_PARAMS = ['managedEBook-id' => 'managed_ebook_id', 'userInstallStateSummary-id' => 'user_install_state_summary_id'];
