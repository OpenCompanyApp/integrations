 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/{userInstallStateSummary-id}/deviceStates/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksUserStateSummaryDeviceStatesGetCountA97e extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_user_state_summary_device_states_get_count_a97e';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/{userInstallStateSummary-id}/deviceStates/$count';
