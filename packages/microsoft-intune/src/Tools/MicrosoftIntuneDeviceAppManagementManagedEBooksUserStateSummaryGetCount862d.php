 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/$count.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksUserStateSummaryGetCount862d extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_user_state_summary_get_count_862d';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/$count';
