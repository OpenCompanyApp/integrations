 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/managedEBooks/{managedEBook-id}/userStateSummary/{userInstallStateSummary-id}/deviceStates.
 */
class MicrosoftIntuneDeviceAppManagementManagedEBooksUserStateSummaryListDeviceStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_managed_ebooks_user_state_summary_list_device_states';
