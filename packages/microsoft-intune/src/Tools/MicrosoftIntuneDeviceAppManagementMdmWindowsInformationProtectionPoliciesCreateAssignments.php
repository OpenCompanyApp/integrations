 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMdmWindowsInformationProtectionPoliciesCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mdm_windows_information_protection_policies_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/assignments';
