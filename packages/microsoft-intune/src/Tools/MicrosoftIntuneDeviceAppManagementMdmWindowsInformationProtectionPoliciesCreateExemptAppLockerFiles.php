 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/exemptAppLockerFiles.
 */
class MicrosoftIntuneDeviceAppManagementMdmWindowsInformationProtectionPoliciesCreateExemptAppLockerFiles extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mdm_windows_information_protection_policies_create_exempt_app_locker_files';
    protected const DESCRIPTION = 'Create new navigation property to exemptAppLockerFiles for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/exemptAppLockerFiles.';
    ...
    protected const PATH = '/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/exemptAppLockerFiles';
