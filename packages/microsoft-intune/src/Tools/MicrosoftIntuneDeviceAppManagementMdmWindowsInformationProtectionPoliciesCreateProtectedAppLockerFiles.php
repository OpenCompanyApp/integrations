 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/protectedAppLockerFiles.
 */
class MicrosoftIntuneDeviceAppManagementMdmWindowsInformationProtectionPoliciesCreateProtectedAppLockerFiles extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mdm_windows_information_protection_policies_create_protected_app_locker_files';
    protected const DESCRIPTION = 'Create new navigation property to protectedAppLockerFiles for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/protectedAppLockerFiles.';
    ...
    protected const PATH = '/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/protectedAppLockerFiles';
    protected const PATH_PARAMS = ['mdmWindowsInformationProtectionPolicy-id' => 'mdm_windows_information_protection_policy_id'];
