 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mdmWindowsInformationProtectionPolicies/$count.
 */
class MicrosoftIntuneDeviceAppManagementMdmWindowsInformationProtectionPoliciesGetCountA680 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mdm_windows_information_protection_policies_get_count_a680';
    ...
    protected const PATH = '/deviceAppManagement/mdmWindowsInformationProtectionPolicies/$count';
