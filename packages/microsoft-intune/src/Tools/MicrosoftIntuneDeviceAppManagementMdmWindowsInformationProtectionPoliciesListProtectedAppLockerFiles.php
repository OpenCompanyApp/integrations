 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}/protectedAppLockerFiles.
 */
class MicrosoftIntuneDeviceAppManagementMdmWindowsInformationProtectionPoliciesListProtectedAppLockerFiles extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mdm_windows_information_protection_policies_list_protected_app_locker_files';
