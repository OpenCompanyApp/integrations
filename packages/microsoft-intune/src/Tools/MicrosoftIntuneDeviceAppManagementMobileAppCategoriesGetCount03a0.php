 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileAppCategories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppCategoriesGetCount03a0 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_categories_get_count_03a0';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppCategories/$count';
