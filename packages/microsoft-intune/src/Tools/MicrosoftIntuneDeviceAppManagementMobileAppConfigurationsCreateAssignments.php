 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppConfigurationsCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_configurations_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/assignments';
