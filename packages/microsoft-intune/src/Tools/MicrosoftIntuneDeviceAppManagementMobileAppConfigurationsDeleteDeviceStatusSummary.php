 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/deviceStatusSummary.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppConfigurationsDeleteDeviceStatusSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_configurations_delete_device_status_summary';
    protected const DESCRIPTION = 'Delete navigation property deviceStatusSummary for deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/deviceStatusSummary.';
