 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileAppConfigurations/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppConfigurationsGetCount15a7 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_configurations_get_count_15a7';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppConfigurations/$count';
