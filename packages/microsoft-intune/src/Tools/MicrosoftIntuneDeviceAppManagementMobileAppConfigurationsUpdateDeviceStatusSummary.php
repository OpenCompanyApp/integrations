 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/deviceStatusSummary.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppConfigurationsUpdateDeviceStatusSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_configurations_update_device_status_summary';
    protected const DESCRIPTION = 'Update the navigation property deviceStatusSummary in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/deviceStatusSummary.';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/deviceStatusSummary';
    protected const PATH_PARAMS = ['managedDeviceMobileAppConfiguration-id' => 'managed_device_mobile_app_configuration_id'];
