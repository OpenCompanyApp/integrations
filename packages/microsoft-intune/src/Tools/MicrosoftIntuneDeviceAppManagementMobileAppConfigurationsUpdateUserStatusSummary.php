 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/userStatusSummary.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppConfigurationsUpdateUserStatusSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_configurations_update_user_status_summary';
    protected const DESCRIPTION = 'Update the navigation property userStatusSummary in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/userStatusSummary.';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration-id}/userStatusSummary';
