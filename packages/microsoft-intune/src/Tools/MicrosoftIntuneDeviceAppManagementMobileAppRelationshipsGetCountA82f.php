 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileAppRelationships/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppRelationshipsGetCountA82f extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_app_relationships_get_count_a82f';
    ...
    protected const PATH = '/deviceAppManagement/mobileAppRelationships/$count';
