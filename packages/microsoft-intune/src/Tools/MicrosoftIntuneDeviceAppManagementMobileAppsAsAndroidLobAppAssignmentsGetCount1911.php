 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidLobAppAssignmentsGetCount1911 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_lob_app_assignments_get_count_1911';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/assignments/$count';
