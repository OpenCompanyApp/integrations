 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/contentVersions/{mobileAppContent-id}/files.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidLobAppContentVersionsCreateFiles extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_lob_app_content_versions_create_files';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/contentVersions/{mobileAppContent-id}/files';
