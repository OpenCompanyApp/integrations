 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/contentVersions/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidLobAppContentVersionsGetCount12ca extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_lob_app_content_versions_get_count_12ca';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/contentVersions/$count';
