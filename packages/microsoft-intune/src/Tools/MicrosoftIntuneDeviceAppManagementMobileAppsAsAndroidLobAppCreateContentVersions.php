 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/contentVersions.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidLobAppCreateContentVersions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_lob_app_create_content_versions';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidLobApp/contentVersions';
