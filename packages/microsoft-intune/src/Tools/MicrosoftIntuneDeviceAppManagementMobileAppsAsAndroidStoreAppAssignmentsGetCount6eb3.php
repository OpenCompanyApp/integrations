 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidStoreAppAssignmentsGetCount6eb3 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_store_app_assignments_get_count_6eb3';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/assignments/$count';
