 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidStoreAppCategoriesGetCount2f24 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_store_app_categories_get_count_2f24';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/categories/$count';
