 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidStoreAppCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_store_app_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/assignments';
