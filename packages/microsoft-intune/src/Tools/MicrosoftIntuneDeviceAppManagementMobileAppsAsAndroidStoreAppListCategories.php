 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/categories.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsAndroidStoreAppListCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_android_store_app_list_categories';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.androidStoreApp/categories';
