 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosLobAppAssignmentsGetCount22ac extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_lob_app_assignments_get_count_22ac';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp/assignments/$count';
