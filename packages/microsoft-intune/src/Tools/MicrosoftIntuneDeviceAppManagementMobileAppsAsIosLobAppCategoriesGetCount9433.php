 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosLobAppCategoriesGetCount9433 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_lob_app_categories_get_count_9433';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp/categories/$count';
