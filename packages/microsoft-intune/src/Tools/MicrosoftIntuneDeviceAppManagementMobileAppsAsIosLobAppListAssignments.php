 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosLobApp/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosLobAppListAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_lob_app_list_assignments';
