 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosStoreApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosStoreAppCategoriesGetCount06f1 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_store_app_categories_get_count_06f1';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosStoreApp/categories/$count';
