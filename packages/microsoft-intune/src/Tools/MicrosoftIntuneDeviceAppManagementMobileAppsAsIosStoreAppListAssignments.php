 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosStoreApp/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosStoreAppListAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_store_app_list_assignments';
