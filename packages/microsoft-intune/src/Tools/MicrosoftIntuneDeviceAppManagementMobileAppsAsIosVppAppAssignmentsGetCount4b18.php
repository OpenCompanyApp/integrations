 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosVppApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosVppAppAssignmentsGetCount4b18 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_vpp_app_assignments_get_count_4b18';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosVppApp/assignments/$count';
