 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosVppApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosVppAppCategoriesGetCount7fa7 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_vpp_app_categories_get_count_7fa7';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosVppApp/categories/$count';
