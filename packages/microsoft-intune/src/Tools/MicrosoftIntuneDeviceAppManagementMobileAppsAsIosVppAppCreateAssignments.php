 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosVppApp/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsIosVppAppCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_ios_vpp_app_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.iosVppApp/assignments';
