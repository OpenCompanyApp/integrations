 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSDmgApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMacOSDmgAppAssignmentsGetCount2a85 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_mac_osdmg_app_assignments_get_count_2a85';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSDmgApp/assignments/$count';
