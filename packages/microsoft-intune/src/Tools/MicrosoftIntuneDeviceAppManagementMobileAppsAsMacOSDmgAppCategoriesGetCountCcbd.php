 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSDmgApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMacOSDmgAppCategoriesGetCountCcbd extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_mac_osdmg_app_categories_get_count_ccbd';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSDmgApp/categories/$count';
