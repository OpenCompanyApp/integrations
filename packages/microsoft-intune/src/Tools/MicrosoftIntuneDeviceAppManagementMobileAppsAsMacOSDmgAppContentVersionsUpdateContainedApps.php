 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSDmgApp/contentVersions/{mobileAppContent-id}/containedApps/{mobileContainedApp-id}.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMacOSDmgAppContentVersionsUpdateContainedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_mac_osdmg_app_content_versions_update_contained_apps';
