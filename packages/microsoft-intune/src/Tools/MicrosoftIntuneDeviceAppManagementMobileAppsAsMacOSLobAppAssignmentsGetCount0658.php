 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSLobApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMacOSLobAppAssignmentsGetCount0658 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_mac_oslob_app_assignments_get_count_0658';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSLobApp/assignments/$count';
