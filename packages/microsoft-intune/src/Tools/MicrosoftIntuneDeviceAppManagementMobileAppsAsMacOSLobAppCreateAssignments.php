 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSLobApp/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMacOSLobAppCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_mac_oslob_app_create_assignments';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSLobApp/assignments';
