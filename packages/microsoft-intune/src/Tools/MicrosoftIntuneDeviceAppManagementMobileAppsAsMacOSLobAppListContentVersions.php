 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.macOSLobApp/contentVersions.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMacOSLobAppListContentVersions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_mac_oslob_app_list_content_versions';
