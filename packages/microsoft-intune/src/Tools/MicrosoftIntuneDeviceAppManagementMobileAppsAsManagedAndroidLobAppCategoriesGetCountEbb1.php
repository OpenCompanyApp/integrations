 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedAndroidLobApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsManagedAndroidLobAppCategoriesGetCountEbb1 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_managed_android_lob_app_categories_get_count_ebb1';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedAndroidLobApp/categories/$count';
