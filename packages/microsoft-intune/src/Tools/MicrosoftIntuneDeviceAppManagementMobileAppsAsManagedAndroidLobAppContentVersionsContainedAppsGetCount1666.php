 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedAndroidLobApp/contentVersions/{mobileAppContent-id}/containedApps/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsManagedAndroidLobAppContentVersionsContainedAppsGetCount1666 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_managed_android_lob_app_content_versions_contained_apps_get_count_1666';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedAndroidLobApp/contentVersions/{mobileAppContent-id}/containedApps/$count';
