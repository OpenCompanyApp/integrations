 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedAndroidLobApp/contentVersions/{mobileAppContent-id}.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsManagedAndroidLobAppGetContentVersions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_managed_android_lob_app_get_content_versions';
