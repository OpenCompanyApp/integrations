 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedIOSLobApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsManagedIOSLobAppAssignmentsGetCount6633 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_managed_ioslob_app_assignments_get_count_6633';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedIOSLobApp/assignments/$count';
