 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedIOSLobApp/contentVersions/{mobileAppContent-id}/containedApps.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsManagedIOSLobAppContentVersionsListContainedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_managed_ioslob_app_content_versions_list_contained_apps';
