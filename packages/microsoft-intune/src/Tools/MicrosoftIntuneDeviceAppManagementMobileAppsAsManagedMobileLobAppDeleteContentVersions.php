 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedMobileLobApp/contentVersions/{mobileAppContent-id}.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsManagedMobileLobAppDeleteContentVersions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_managed_mobile_lob_app_delete_content_versions';
