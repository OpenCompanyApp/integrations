 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMicrosoftStoreForBusinessAppAssignmentsGetCount38b3 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_microsoft_store_for_business_app_assignments_get_count_38b3';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp/assignments/$count';
