 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.microsoftStoreForBusinessApp/assignments/{mobileAppAssignment-id}.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsMicrosoftStoreForBusinessAppGetAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_microsoft_store_for_business_app_get_assignments';
