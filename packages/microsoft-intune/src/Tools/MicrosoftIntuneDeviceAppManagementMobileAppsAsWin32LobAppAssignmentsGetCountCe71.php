 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWin32LobAppAssignmentsGetCountCe71 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_win32_lob_app_assignments_get_count_ce71';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/assignments/$count';
