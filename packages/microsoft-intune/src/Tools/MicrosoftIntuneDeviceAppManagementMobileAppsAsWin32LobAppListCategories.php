 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/categories.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWin32LobAppListCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_win32_lob_app_list_categories';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/categories';
