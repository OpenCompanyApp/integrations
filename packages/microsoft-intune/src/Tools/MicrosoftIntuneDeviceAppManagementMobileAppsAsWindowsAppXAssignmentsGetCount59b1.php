 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsAppXAssignmentsGetCount59b1 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_app_x_assignments_get_count_59b1';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/assignments/$count';
