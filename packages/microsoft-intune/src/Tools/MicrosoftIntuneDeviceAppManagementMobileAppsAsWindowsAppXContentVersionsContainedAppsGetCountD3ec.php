 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/contentVersions/{mobileAppContent-id}/containedApps/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsAppXContentVersionsContainedAppsGetCountD3ec extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_app_x_content_versions_contained_apps_get_count_d3ec';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/contentVersions/{mobileAppContent-id}/containedApps/$count';
