 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/contentVersions/{mobileAppContent-id}.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsAppXUpdateContentVersions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_app_x_update_content_versions';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsAppX/contentVersions/{mobileAppContent-id}';
