 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsMobileMSI/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsMobileMSICategoriesGetCount4240 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_mobile_msi_categories_get_count_4240';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsMobileMSI/categories/$count';
