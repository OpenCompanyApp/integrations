 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsMobileMSI/contentVersions.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsMobileMSIListContentVersions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_mobile_msi_list_content_versions';
