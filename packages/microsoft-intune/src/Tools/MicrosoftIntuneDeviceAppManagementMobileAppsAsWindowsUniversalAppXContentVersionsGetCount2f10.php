 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX/contentVersions/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsUniversalAppXContentVersionsGetCount2f10 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_universal_app_x_content_versions_get_count_2f10';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX/contentVersions/$count';
