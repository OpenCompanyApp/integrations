 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsUniversalAppX/committedContainedApps.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsUniversalAppXListCommittedContainedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_universal_app_x_list_committed_contained_apps';
