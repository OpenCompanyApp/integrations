 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsWebApp/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsWebAppCategoriesGetCount79ca extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_web_app_categories_get_count_79ca';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsWebApp/categories/$count';
