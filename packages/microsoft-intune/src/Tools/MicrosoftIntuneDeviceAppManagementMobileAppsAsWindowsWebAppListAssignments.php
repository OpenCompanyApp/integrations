 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/graph.windowsWebApp/assignments.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAsWindowsWebAppListAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_as_windows_web_app_list_assignments';
