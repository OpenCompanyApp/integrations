 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/assignments/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsAssignmentsGetCount493c extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_assignments_get_count_493c';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments/$count';
