 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/{mobileApp-id}/categories/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsCategoriesGetCount6d0e extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_categories_get_count_6d0e';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/categories/$count';
