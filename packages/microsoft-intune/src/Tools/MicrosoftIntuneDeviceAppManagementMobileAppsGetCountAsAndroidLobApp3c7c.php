 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.androidLobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsAndroidLobApp3c7c extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_android_lob_app_3c7c';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.androidLobApp/$count';
