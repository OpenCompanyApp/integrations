 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.androidStoreApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsAndroidStoreAppFff5 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_android_store_app_fff5';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.androidStoreApp/$count';
