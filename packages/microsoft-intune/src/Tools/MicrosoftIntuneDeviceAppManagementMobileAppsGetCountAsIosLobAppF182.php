 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.iosLobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsIosLobAppF182 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_ios_lob_app_f182';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.iosLobApp/$count';
