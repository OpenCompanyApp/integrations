 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.iosStoreApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsIosStoreApp6fbc extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_ios_store_app_6fbc';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.iosStoreApp/$count';
