 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.iosVppApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsIosVppAppDa96 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_ios_vpp_app_da96';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.iosVppApp/$count';
