 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.macOSDmgApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsMacOSDmgAppB712 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_mac_osdmg_app_b712';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.macOSDmgApp/$count';
