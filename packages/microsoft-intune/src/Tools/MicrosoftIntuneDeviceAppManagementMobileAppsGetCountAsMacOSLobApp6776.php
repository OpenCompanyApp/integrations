 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.macOSLobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsMacOSLobApp6776 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_mac_oslob_app_6776';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.macOSLobApp/$count';
