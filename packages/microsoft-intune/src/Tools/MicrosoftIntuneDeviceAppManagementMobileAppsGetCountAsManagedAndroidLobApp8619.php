 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.managedAndroidLobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsManagedAndroidLobApp8619 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_managed_android_lob_app_8619';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.managedAndroidLobApp/$count';
