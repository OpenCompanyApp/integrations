 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.managedIOSLobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsManagedIOSLobApp11b8 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_managed_ioslob_app_11b8';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.managedIOSLobApp/$count';
