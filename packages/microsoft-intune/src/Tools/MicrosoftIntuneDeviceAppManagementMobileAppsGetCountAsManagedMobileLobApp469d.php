 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.managedMobileLobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsManagedMobileLobApp469d extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_managed_mobile_lob_app_469d';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.managedMobileLobApp/$count';
