 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsMicrosoftStoreForBusinessApp724e extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_microsoft_store_for_business_app_724e';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp/$count';
