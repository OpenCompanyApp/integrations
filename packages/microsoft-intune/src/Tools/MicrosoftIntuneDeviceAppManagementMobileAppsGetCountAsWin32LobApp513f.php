 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.win32LobApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsWin32LobApp513f extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_win32_lob_app_513f';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.win32LobApp/$count';
