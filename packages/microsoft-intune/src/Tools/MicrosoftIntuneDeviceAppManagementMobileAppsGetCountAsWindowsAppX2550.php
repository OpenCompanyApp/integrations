 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.windowsAppX/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsWindowsAppX2550 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_windows_app_x_2550';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.windowsAppX/$count';
