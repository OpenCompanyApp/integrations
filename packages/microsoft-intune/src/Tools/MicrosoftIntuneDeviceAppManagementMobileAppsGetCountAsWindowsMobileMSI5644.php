 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.windowsMobileMSI/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsWindowsMobileMSI5644 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_windows_mobile_msi_5644';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.windowsMobileMSI/$count';
