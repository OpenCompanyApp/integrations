 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.windowsUniversalAppX/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsWindowsUniversalAppXFe04 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_windows_universal_app_x_fe04';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.windowsUniversalAppX/$count';
