 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/graph.windowsWebApp/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountAsWindowsWebAppF73a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_as_windows_web_app_f73a';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/graph.windowsWebApp/$count';
