 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/mobileApps/$count.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsGetCountDcef extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_get_count_dcef';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/$count';
