 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/assign.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsMobileAppAssign extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_mobile_app_assign';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/assign';
