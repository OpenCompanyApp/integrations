 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedIOSLobApp/contentVersions/{mobileAppContent-id}/files/{mobileAppContentFile-id}/renewUpload.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsMobileAppMicrosoftGraphManagedIOSLobAppContentVersionsMobileAppContentFilesMobileAppContentFileRenewUpload extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_mobile_app_microsoft_graph_managed_ioslob_app_content_versions_mobile_app_content_files_mobile_app_content_file_renew_upload';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.managedIOSLobApp/contentVersions/{mobileAppContent-id}/files/{mobileAppContentFile-id}/renewUpload';
