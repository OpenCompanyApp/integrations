 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/contentVersions/{mobileAppContent-id}/files/{mobileAppContentFile-id}/commit.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsMobileAppMicrosoftGraphWin32LobAppContentVersionsMobileAppContentFilesMobileAppContentFileCommit extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_mobile_app_microsoft_graph_win32_lob_app_content_versions_mobile_app_content_files_mobile_app_content_file_commit';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/graph.win32LobApp/contentVersions/{mobileAppContent-id}/files/{mobileAppContentFile-id}/commit';
