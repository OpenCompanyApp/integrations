 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mobileApps/{mobileApp-id}/assignments/{mobileAppAssignment-id}.
 */
class MicrosoftIntuneDeviceAppManagementMobileAppsUpdateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_mobile_apps_update_assignments';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}/assignments/{mobileAppAssignment-id}';
