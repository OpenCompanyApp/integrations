 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/syncMicrosoftStoreForBusinessApps.
 */
class MicrosoftIntuneDeviceAppManagementSyncMicrosoftStoreForBusinessApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_sync_microsoft_store_for_business_apps';
    protected const DESCRIPTION = 'Invoke action syncMicrosoftStoreForBusinessApps\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceAppManagement/syncMicrosoftStoreForBusinessApps.';
    ...
    protected const PATH = '/deviceAppManagement/syncMicrosoftStoreForBusinessApps';
