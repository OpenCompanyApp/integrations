 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration-id}/apps/{managedMobileApp-id}.
 */
class MicrosoftIntuneDeviceAppManagementTargetedManagedAppConfigurationsGetApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_targeted_managed_app_configurations_get_apps';
