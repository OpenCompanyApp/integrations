 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/targetedManagedAppConfigurations/$count.
 */
class MicrosoftIntuneDeviceAppManagementTargetedManagedAppConfigurationsGetCount8d50 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_targeted_managed_app_configurations_get_count_8d50';
    ...
    protected const PATH = '/deviceAppManagement/targetedManagedAppConfigurations/$count';
