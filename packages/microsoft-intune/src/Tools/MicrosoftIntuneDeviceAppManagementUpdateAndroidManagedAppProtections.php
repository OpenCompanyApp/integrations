 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateAndroidManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_android_managed_app_protections';
    protected const DESCRIPTION = 'Update the navigation property androidManagedAppProtections in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}.';
    ...
    protected const PATH = '/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection-id}';
