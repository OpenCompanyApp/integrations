 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateDefaultManagedAppProtections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_default_managed_app_protections';
    protected const DESCRIPTION = 'Update the navigation property defaultManagedAppProtections in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}.';
    ...
    protected const PATH = '/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection-id}';
