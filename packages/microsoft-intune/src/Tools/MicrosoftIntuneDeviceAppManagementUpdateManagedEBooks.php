 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/managedEBooks/{managedEBook-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateManagedEBooks extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_managed_ebooks';
    protected const DESCRIPTION = 'Update the navigation property managedEBooks in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/managedEBooks/{managedEBook-id}.';
    ...
    protected const PATH = '/deviceAppManagement/managedEBooks/{managedEBook-id}';
