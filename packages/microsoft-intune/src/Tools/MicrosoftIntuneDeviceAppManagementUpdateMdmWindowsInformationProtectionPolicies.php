 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateMdmWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_mdm_windows_information_protection_policies';
    protected const DESCRIPTION = 'Update the navigation property mdmWindowsInformationProtectionPolicies in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}.';
    ...
    protected const PATH = '/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy-id}';
