 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/mobileApps/{mobileApp-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateMobileApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_mobile_apps';
    protected const DESCRIPTION = 'Update the navigation property mobileApps in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/mobileApps/{mobileApp-id}.';
    ...
    protected const PATH = '/deviceAppManagement/mobileApps/{mobileApp-id}';
