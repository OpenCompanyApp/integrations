 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/vppTokens/{vppToken-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateVppTokens extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_vpp_tokens';
    protected const DESCRIPTION = 'Update the navigation property vppTokens in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/vppTokens/{vppToken-id}.';
    ...
    protected const PATH = '/deviceAppManagement/vppTokens/{vppToken-id}';
