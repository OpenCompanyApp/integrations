 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}.
 */
class MicrosoftIntuneDeviceAppManagementUpdateWindowsInformationProtectionPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_update_windows_information_protection_policies';
    protected const DESCRIPTION = 'Update the navigation property windowsInformationProtectionPolicies in deviceAppManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}.';
    ...
    protected const PATH = '/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}';
