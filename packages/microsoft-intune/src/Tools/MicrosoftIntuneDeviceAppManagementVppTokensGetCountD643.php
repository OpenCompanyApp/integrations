 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/vppTokens/$count.
 */
class MicrosoftIntuneDeviceAppManagementVppTokensGetCountD643 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_vpp_tokens_get_count_d643';
    ...
    protected const PATH = '/deviceAppManagement/vppTokens/$count';
