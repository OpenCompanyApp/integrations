 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}/exemptAppLockerFiles.
 */
class MicrosoftIntuneDeviceAppManagementWindowsInformationProtectionPoliciesCreateExemptAppLockerFiles extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_windows_information_protection_policies_create_exempt_app_locker_files';
    ...
    protected const PATH = '/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy-id}/exemptAppLockerFiles';
