 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceAppManagement/windowsInformationProtectionPolicies/$count.
 */
class MicrosoftIntuneDeviceAppManagementWindowsInformationProtectionPoliciesGetCountB909 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_app_management_windows_information_protection_policies_get_count_b909';
    ...
    protected const PATH = '/deviceAppManagement/windowsInformationProtectionPolicies/$count';
