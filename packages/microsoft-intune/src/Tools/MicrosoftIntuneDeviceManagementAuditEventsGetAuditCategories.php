 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/auditEvents/getAuditCategories().
 */
class MicrosoftIntuneDeviceManagementAuditEventsGetAuditCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_audit_events_get_audit_categories';
    protected const DESCRIPTION = 'Invoke function getAuditCategories\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/auditEvents/getAuditCategories().';
    ...
    protected const PATH = '/deviceManagement/auditEvents/getAuditCategories()';
