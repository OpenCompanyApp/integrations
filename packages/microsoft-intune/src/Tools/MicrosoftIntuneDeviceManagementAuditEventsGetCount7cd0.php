 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/auditEvents/$count.
 */
class MicrosoftIntuneDeviceManagementAuditEventsGetCount7cd0 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_audit_events_get_count_7cd0';
    ...
    protected const PATH = '/deviceManagement/auditEvents/$count';
