 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/complianceManagementPartners/$count.
 */
class MicrosoftIntuneDeviceManagementComplianceManagementPartnersGetCountEeb1 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_compliance_management_partners_get_count_eeb1';
    ...
    protected const PATH = '/deviceManagement/complianceManagementPartners/$count';
