 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/auditEvents.
 */
class MicrosoftIntuneDeviceManagementCreateAuditEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_audit_events';
    ...
    protected const PATH = '/deviceManagement/auditEvents';
