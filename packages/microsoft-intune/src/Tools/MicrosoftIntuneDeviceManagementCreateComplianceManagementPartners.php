 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/complianceManagementPartners.
 */
class MicrosoftIntuneDeviceManagementCreateComplianceManagementPartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_compliance_management_partners';
    protected const DESCRIPTION = 'Create new navigation property to complianceManagementPartners for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/complianceManagementPartners.';
    ...
    protected const PATH = '/deviceManagement/complianceManagementPartners';
