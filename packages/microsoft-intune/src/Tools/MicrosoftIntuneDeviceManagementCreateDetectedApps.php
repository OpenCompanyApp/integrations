 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/detectedApps.
 */
class MicrosoftIntuneDeviceManagementCreateDetectedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_detected_apps';
    protected const DESCRIPTION = 'Create new navigation property to detectedApps for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/detectedApps.';
    ...
    protected const PATH = '/deviceManagement/detectedApps';
