 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceCategories.
 */
class MicrosoftIntuneDeviceManagementCreateDeviceCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_device_categories';
    protected const DESCRIPTION = 'Create new navigation property to deviceCategories for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceCategories.';
    ...
    protected const PATH = '/deviceManagement/deviceCategories';
