 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceCompliancePolicies.
 */
class MicrosoftIntuneDeviceManagementCreateDeviceCompliancePolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_device_compliance_policies';
    protected const DESCRIPTION = 'Create new navigation property to deviceCompliancePolicies for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceCompliancePolicies.';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicies';
