 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceCompliancePolicySettingStateSummaries.
 */
class MicrosoftIntuneDeviceManagementCreateDeviceCompliancePolicySettingStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_device_compliance_policy_setting_state_summaries';
    protected const DESCRIPTION = 'Create new navigation property to deviceCompliancePolicySettingStateSummaries for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceCompliancePolicySettingStateSummaries.';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicySettingStateSummaries';
