 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceConfigurations.
 */
class MicrosoftIntuneDeviceManagementCreateDeviceConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_device_configurations';
    protected const DESCRIPTION = 'Create new navigation property to deviceConfigurations for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceConfigurations.';
    ...
    protected const PATH = '/deviceManagement/deviceConfigurations';
