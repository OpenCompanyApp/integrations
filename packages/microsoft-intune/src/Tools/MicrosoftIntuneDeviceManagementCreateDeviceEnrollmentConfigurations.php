 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceEnrollmentConfigurations.
 */
class MicrosoftIntuneDeviceManagementCreateDeviceEnrollmentConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_device_enrollment_configurations';
    protected const DESCRIPTION = 'Create new navigation property to deviceEnrollmentConfigurations for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceEnrollmentConfigurations.';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations';
