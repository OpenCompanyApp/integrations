 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceManagementPartners.
 */
class MicrosoftIntuneDeviceManagementCreateDeviceManagementPartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_device_management_partners';
    protected const DESCRIPTION = 'Create new navigation property to deviceManagementPartners for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceManagementPartners.';
    ...
    protected const PATH = '/deviceManagement/deviceManagementPartners';
