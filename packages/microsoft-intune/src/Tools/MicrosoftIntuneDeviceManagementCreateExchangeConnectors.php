 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/exchangeConnectors.
 */
class MicrosoftIntuneDeviceManagementCreateExchangeConnectors extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_exchange_connectors';
    protected const DESCRIPTION = 'Create new navigation property to exchangeConnectors for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/exchangeConnectors.';
    ...
    protected const PATH = '/deviceManagement/exchangeConnectors';
