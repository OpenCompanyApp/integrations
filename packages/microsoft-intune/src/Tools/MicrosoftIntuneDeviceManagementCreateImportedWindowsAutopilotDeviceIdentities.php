 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/importedWindowsAutopilotDeviceIdentities.
 */
class MicrosoftIntuneDeviceManagementCreateImportedWindowsAutopilotDeviceIdentities extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_imported_windows_autopilot_device_identities';
    protected const DESCRIPTION = 'Create new navigation property to importedWindowsAutopilotDeviceIdentities for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/importedWindowsAutopilotDeviceIdentities.';
    ...
    protected const PATH = '/deviceManagement/importedWindowsAutopilotDeviceIdentities';
