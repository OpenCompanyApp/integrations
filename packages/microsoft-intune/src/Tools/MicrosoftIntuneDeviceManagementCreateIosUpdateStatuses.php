 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/iosUpdateStatuses.
 */
class MicrosoftIntuneDeviceManagementCreateIosUpdateStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_ios_update_statuses';
    protected const DESCRIPTION = 'Create new navigation property to iosUpdateStatuses for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/iosUpdateStatuses.';
    ...
    protected const PATH = '/deviceManagement/iosUpdateStatuses';
