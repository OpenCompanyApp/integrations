 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices.
 */
class MicrosoftIntuneDeviceManagementCreateManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_managed_devices';
    protected const DESCRIPTION = 'Create new navigation property to managedDevices for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices.';
    ...
    protected const PATH = '/deviceManagement/managedDevices';
