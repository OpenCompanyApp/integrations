 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/mobileAppTroubleshootingEvents.
 */
class MicrosoftIntuneDeviceManagementCreateMobileAppTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_mobile_app_troubleshooting_events';
    protected const DESCRIPTION = 'Create new navigation property to mobileAppTroubleshootingEvents for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/mobileAppTroubleshootingEvents.';
    ...
    protected const PATH = '/deviceManagement/mobileAppTroubleshootingEvents';
