 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/mobileThreatDefenseConnectors.
 */
class MicrosoftIntuneDeviceManagementCreateMobileThreatDefenseConnectors extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_mobile_threat_defense_connectors';
    protected const DESCRIPTION = 'Create new navigation property to mobileThreatDefenseConnectors for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/mobileThreatDefenseConnectors.';
    ...
    protected const PATH = '/deviceManagement/mobileThreatDefenseConnectors';
