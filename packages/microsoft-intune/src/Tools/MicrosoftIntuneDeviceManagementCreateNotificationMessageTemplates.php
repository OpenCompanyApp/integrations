 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/notificationMessageTemplates.
 */
class MicrosoftIntuneDeviceManagementCreateNotificationMessageTemplates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_notification_message_templates';
    protected const DESCRIPTION = 'Create new navigation property to notificationMessageTemplates for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/notificationMessageTemplates.';
    ...
    protected const PATH = '/deviceManagement/notificationMessageTemplates';
