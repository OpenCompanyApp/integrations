 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/remoteAssistancePartners.
 */
class MicrosoftIntuneDeviceManagementCreateRemoteAssistancePartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_remote_assistance_partners';
    protected const DESCRIPTION = 'Create remoteAssistancePartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/remoteAssistancePartners.';
    ...
    protected const PATH = '/deviceManagement/remoteAssistancePartners';
