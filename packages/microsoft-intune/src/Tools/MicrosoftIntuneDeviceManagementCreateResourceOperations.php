 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/resourceOperations.
 */
class MicrosoftIntuneDeviceManagementCreateResourceOperations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_resource_operations';
    protected const DESCRIPTION = 'Create new navigation property to resourceOperations for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/resourceOperations.';
    ...
    protected const PATH = '/deviceManagement/resourceOperations';
