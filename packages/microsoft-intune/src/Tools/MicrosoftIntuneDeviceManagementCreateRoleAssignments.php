 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/roleAssignments.
 */
class MicrosoftIntuneDeviceManagementCreateRoleAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_role_assignments';
    ...
    protected const PATH = '/deviceManagement/roleAssignments';
