 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/roleDefinitions.
 */
class MicrosoftIntuneDeviceManagementCreateRoleDefinitions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_role_definitions';
    protected const DESCRIPTION = 'Create new navigation property to roleDefinitions for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/roleDefinitions.';
    ...
    protected const PATH = '/deviceManagement/roleDefinitions';
