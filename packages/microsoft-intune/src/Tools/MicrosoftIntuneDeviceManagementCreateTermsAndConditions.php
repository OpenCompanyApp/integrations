 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/termsAndConditions.
 */
class MicrosoftIntuneDeviceManagementCreateTermsAndConditions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_terms_and_conditions';
    protected const DESCRIPTION = 'Create new navigation property to termsAndConditions for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/termsAndConditions.';
    ...
    protected const PATH = '/deviceManagement/termsAndConditions';
