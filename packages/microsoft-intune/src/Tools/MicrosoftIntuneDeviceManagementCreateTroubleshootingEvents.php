 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/troubleshootingEvents.
 */
class MicrosoftIntuneDeviceManagementCreateTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_troubleshooting_events';
    protected const DESCRIPTION = 'Create new navigation property to troubleshootingEvents for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/troubleshootingEvents.';
    ...
    protected const PATH = '/deviceManagement/troubleshootingEvents';
