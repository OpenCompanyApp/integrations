 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsAppHealthApplicationPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_app_health_application_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsAppHealthApplicationPerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformance';
