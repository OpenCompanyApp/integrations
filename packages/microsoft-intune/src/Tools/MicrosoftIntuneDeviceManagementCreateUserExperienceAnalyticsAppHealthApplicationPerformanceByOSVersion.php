 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_app_health_application_performance_by_osversion';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion.';
