 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsAppHealthDeviceModelPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_app_health_device_model_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsAppHealthDeviceModelPerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance';
