 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsAppHealthDevicePerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_app_health_device_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsAppHealthDevicePerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance';
