 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsAppHealthDevicePerformanceDetails extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_app_health_device_performance_details';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsAppHealthDevicePerformanceDetails for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails';
