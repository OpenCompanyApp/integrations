 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsAppHealthOSVersionPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_app_health_osversion_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsAppHealthOSVersionPerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance';
