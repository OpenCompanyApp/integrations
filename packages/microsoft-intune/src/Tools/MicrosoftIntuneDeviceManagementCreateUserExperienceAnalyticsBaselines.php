 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsBaselines.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsBaselines extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_baselines';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsBaselines for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsBaselines.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsBaselines';
