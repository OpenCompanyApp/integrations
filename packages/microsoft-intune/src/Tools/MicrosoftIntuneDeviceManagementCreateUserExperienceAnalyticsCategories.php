 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsCategories.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_categories';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsCategories for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsCategories.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsCategories';
