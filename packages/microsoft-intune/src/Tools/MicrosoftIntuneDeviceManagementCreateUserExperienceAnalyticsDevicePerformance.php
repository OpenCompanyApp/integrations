 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsDevicePerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsDevicePerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_device_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsDevicePerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsDevicePerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDevicePerformance';
