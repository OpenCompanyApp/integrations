 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsDeviceScores.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsDeviceScores extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_device_scores';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsDeviceScores for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsDeviceScores.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceScores';
