 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsDeviceStartupHistory.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsDeviceStartupHistory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_device_startup_history';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsDeviceStartupHistory for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsDeviceStartupHistory.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceStartupHistory';
