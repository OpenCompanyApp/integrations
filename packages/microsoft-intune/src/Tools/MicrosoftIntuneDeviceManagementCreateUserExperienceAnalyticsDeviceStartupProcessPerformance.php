 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsDeviceStartupProcessPerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsDeviceStartupProcessPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_device_startup_process_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsDeviceStartupProcessPerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsDeviceStartupProcessPerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceStartupProcessPerformance';
