 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsDeviceStartupProcesses.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsDeviceStartupProcesses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_device_startup_processes';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsDeviceStartupProcesses for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsDeviceStartupProcesses.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceStartupProcesses';
