 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsMetricHistory.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsMetricHistory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_metric_history';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsMetricHistory for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsMetricHistory.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsMetricHistory';
