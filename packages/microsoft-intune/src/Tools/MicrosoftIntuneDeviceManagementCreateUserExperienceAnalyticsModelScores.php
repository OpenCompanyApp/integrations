 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsModelScores.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsModelScores extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_model_scores';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsModelScores for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsModelScores.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsModelScores';
