 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsScoreHistory.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsScoreHistory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_score_history';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsScoreHistory for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsScoreHistory.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsScoreHistory';
