 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsWorkFromAnywhereMetrics extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_work_from_anywhere_metrics';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsWorkFromAnywhereMetrics for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics';
