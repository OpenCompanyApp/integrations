 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance.
 */
class MicrosoftIntuneDeviceManagementCreateUserExperienceAnalyticsWorkFromAnywhereModelPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_user_experience_analytics_work_from_anywhere_model_performance';
    protected const DESCRIPTION = 'Create new navigation property to userExperienceAnalyticsWorkFromAnywhereModelPerformance for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance';
