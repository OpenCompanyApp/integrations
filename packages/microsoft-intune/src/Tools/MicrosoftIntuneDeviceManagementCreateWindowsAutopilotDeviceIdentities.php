 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/windowsAutopilotDeviceIdentities.
 */
class MicrosoftIntuneDeviceManagementCreateWindowsAutopilotDeviceIdentities extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_windows_autopilot_device_identities';
    protected const DESCRIPTION = 'Create new navigation property to windowsAutopilotDeviceIdentities for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/windowsAutopilotDeviceIdentities.';
    ...
    protected const PATH = '/deviceManagement/windowsAutopilotDeviceIdentities';
