 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/windowsInformationProtectionAppLearningSummaries.
 */
class MicrosoftIntuneDeviceManagementCreateWindowsInformationProtectionAppLearningSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_windows_information_protection_app_learning_summaries';
    protected const DESCRIPTION = 'Create new navigation property to windowsInformationProtectionAppLearningSummaries for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/windowsInformationProtectionAppLearningSummaries.';
    ...
    protected const PATH = '/deviceManagement/windowsInformationProtectionAppLearningSummaries';
