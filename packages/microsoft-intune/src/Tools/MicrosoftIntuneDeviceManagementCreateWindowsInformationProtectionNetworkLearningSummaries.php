 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/windowsInformationProtectionNetworkLearningSummaries.
 */
class MicrosoftIntuneDeviceManagementCreateWindowsInformationProtectionNetworkLearningSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_create_windows_information_protection_network_learning_summaries';
    protected const DESCRIPTION = 'Create new navigation property to windowsInformationProtectionNetworkLearningSummaries for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/windowsInformationProtectionNetworkLearningSummaries.';
    ...
    protected const PATH = '/deviceManagement/windowsInformationProtectionNetworkLearningSummaries';
