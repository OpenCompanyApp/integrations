 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/applePushNotificationCertificate.
 */
class MicrosoftIntuneDeviceManagementDeleteApplePushNotificationCertificate extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_apple_push_notification_certificate';
    protected const DESCRIPTION = 'Delete navigation property applePushNotificationCertificate for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/applePushNotificationCertificate.';
