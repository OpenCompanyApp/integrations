 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/conditionalAccessSettings.
 */
class MicrosoftIntuneDeviceManagementDeleteConditionalAccessSettings extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_conditional_access_settings';
    protected const DESCRIPTION = 'Delete navigation property conditionalAccessSettings for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/conditionalAccessSettings.';
