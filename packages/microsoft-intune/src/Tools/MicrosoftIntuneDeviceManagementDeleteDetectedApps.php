 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/detectedApps/{detectedApp-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteDetectedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_detected_apps';
    protected const DESCRIPTION = 'Delete navigation property detectedApps for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/detectedApps/{detectedApp-id}.';
