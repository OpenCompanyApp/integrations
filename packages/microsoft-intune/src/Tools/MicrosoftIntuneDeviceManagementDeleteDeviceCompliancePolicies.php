 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteDeviceCompliancePolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_device_compliance_policies';
    protected const DESCRIPTION = 'Delete navigation property deviceCompliancePolicies for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}.';
