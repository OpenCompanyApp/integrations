 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/deviceCompliancePolicyDeviceStateSummary.
 */
class MicrosoftIntuneDeviceManagementDeleteDeviceCompliancePolicyDeviceStateSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_device_compliance_policy_device_state_summary';
    protected const DESCRIPTION = 'Delete navigation property deviceCompliancePolicyDeviceStateSummary for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/deviceCompliancePolicyDeviceStateSummary.';
