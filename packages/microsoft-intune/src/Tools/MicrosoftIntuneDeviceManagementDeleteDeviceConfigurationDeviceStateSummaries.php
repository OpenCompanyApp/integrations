 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/deviceConfigurationDeviceStateSummaries.
 */
class MicrosoftIntuneDeviceManagementDeleteDeviceConfigurationDeviceStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_device_configuration_device_state_summaries';
    protected const DESCRIPTION = 'Delete navigation property deviceConfigurationDeviceStateSummaries for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/deviceConfigurationDeviceStateSummaries.';
