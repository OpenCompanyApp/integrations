 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteDeviceEnrollmentConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_device_enrollment_configurations';
    protected const DESCRIPTION = 'Delete navigation property deviceEnrollmentConfigurations for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}.';
