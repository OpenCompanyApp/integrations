 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_managed_devices';
    protected const DESCRIPTION = 'Delete navigation property managedDevices for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/managedDevices/{managedDevice-id}.';
