 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/mobileThreatDefenseConnectors/{mobileThreatDefenseConnector-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteMobileThreatDefenseConnectors extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_mobile_threat_defense_connectors';
    protected const DESCRIPTION = 'Delete navigation property mobileThreatDefenseConnectors for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/mobileThreatDefenseConnectors/{mobileThreatDefenseConnector-id}.';
