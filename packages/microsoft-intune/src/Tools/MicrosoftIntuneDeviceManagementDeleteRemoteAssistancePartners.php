 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteRemoteAssistancePartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_remote_assistance_partners';
    protected const DESCRIPTION = 'Delete remoteAssistancePartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}.';
    ...
    protected const PATH = '/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}';
