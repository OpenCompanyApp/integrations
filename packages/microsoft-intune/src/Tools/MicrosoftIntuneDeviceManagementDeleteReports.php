 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/reports.
 */
class MicrosoftIntuneDeviceManagementDeleteReports extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_reports';
    protected const DESCRIPTION = 'Delete navigation property reports for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/reports.';
