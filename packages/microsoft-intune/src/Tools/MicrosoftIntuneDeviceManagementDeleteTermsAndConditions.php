 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/termsAndConditions/{termsAndConditions-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteTermsAndConditions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_terms_and_conditions';
    protected const DESCRIPTION = 'Delete navigation property termsAndConditions for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/termsAndConditions/{termsAndConditions-id}.';
