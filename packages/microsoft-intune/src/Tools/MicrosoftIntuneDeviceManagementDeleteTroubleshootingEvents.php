 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_troubleshooting_events';
    protected const DESCRIPTION = 'Delete navigation property troubleshootingEvents for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.';
