 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/userExperienceAnalyticsAppHealthOverview.
 */
class MicrosoftIntuneDeviceManagementDeleteUserExperienceAnalyticsAppHealthOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_user_experience_analytics_app_health_overview';
    protected const DESCRIPTION = 'Delete navigation property userExperienceAnalyticsAppHealthOverview for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/userExperienceAnalyticsAppHealthOverview.';
