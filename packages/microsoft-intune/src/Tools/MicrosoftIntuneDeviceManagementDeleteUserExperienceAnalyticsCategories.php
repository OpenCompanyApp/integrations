 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory-id}.
 */
class MicrosoftIntuneDeviceManagementDeleteUserExperienceAnalyticsCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_user_experience_analytics_categories';
    protected const DESCRIPTION = 'Delete navigation property userExperienceAnalyticsCategories for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory-id}.';
