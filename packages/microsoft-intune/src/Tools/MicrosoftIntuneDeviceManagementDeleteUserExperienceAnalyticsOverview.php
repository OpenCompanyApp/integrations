 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/userExperienceAnalyticsOverview.
 */
class MicrosoftIntuneDeviceManagementDeleteUserExperienceAnalyticsOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_user_experience_analytics_overview';
    protected const DESCRIPTION = 'Delete navigation property userExperienceAnalyticsOverview for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/userExperienceAnalyticsOverview.';
