 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric.
 */
class MicrosoftIntuneDeviceManagementDeleteUserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_user_experience_analytics_work_from_anywhere_hardware_readiness_metric';
    protected const DESCRIPTION = 'Delete navigation property userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric.';
