 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/virtualEndpoint.
 */
class MicrosoftIntuneDeviceManagementDeleteVirtualEndpoint extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_delete_virtual_endpoint';
    protected const DESCRIPTION = 'Delete navigation property virtualEndpoint for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/virtualEndpoint.';
