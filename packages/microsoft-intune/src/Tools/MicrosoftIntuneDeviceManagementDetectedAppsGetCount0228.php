 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/detectedApps/$count.
 */
class MicrosoftIntuneDeviceManagementDetectedAppsGetCount0228 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_detected_apps_get_count_0228';
    ...
    protected const PATH = '/deviceManagement/detectedApps/$count';
