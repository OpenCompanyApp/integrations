 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/detectedApps/{detectedApp-id}/managedDevices.
 */
class MicrosoftIntuneDeviceManagementDetectedAppsListManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_detected_apps_list_managed_devices';
    ...
    protected const PATH = '/deviceManagement/detectedApps/{detectedApp-id}/managedDevices';
