 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCategories/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceCategoriesGetCountEd54 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_categories_get_count_ed54';
    ...
    protected const PATH = '/deviceManagement/deviceCategories/$count';
