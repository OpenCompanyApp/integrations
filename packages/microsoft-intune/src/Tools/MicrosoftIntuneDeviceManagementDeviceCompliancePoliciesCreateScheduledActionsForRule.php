 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/scheduledActionsForRule.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesCreateScheduledActionsForRule extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_create_scheduled_actions_for_rule';
    protected const DESCRIPTION = 'Create new navigation property to scheduledActionsForRule for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/scheduledActionsForRule.';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/scheduledActionsForRule';
