 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/deviceStatusOverview.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesDeleteDeviceStatusOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_delete_device_status_overview';
