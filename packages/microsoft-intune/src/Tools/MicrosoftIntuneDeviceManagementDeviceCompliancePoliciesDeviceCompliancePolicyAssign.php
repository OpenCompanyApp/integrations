 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/assign.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesDeviceCompliancePolicyAssign extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_device_compliance_policy_assign';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/assign';
