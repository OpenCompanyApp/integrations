 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicies/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesGetCount6c5d extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_get_count_6c5d';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicies/$count';
