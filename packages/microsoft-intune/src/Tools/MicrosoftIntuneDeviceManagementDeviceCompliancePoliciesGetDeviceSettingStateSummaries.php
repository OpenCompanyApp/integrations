 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/deviceSettingStateSummaries/{settingStateDeviceSummary-id}.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesGetDeviceSettingStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_get_device_setting_state_summaries';
