 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/userStatusOverview.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesGetUserStatusOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_get_user_status_overview';
