 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/scheduledActionsForRule.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesListScheduledActionsForRule extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_list_scheduled_actions_for_rule';
