 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/userStatuses.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesListUserStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_list_user_statuses';
