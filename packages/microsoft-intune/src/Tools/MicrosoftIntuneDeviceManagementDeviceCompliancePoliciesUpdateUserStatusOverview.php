 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/userStatusOverview.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePoliciesUpdateUserStatusOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policies_update_user_status_overview';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}/userStatusOverview';
