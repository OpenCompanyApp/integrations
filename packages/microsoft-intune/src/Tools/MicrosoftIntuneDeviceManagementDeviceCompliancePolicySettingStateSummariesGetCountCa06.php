 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicySettingStateSummaries/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceCompliancePolicySettingStateSummariesGetCountCa06 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_compliance_policy_setting_state_summaries_get_count_ca06';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicySettingStateSummaries/$count';
