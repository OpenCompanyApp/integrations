 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/deviceConfigurations/{deviceConfiguration-id}/assignments/{deviceConfigurationAssignment-id}.
 */
class MicrosoftIntuneDeviceManagementDeviceConfigurationsDeleteAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_configurations_delete_assignments';
