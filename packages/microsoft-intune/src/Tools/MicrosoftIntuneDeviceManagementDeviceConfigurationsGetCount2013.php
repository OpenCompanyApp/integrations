 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceConfigurations/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceConfigurationsGetCount2013 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_configurations_get_count_2013';
    ...
    protected const PATH = '/deviceManagement/deviceConfigurations/$count';
