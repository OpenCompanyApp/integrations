 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceConfigurations/{deviceConfiguration-id}/deviceSettingStateSummaries/{settingStateDeviceSummary-id}.
 */
class MicrosoftIntuneDeviceManagementDeviceConfigurationsGetDeviceSettingStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_configurations_get_device_setting_state_summaries';
