 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceConfigurations/{deviceConfiguration-id}/deviceSettingStateSummaries/{settingStateDeviceSummary-id}.
 */
class MicrosoftIntuneDeviceManagementDeviceConfigurationsUpdateDeviceSettingStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_configurations_update_device_setting_state_summaries';
