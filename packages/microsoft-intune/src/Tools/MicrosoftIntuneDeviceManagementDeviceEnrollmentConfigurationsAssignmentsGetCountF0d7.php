 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assignments/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceEnrollmentConfigurationsAssignmentsGetCountF0d7 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_enrollment_configurations_assignments_get_count_f0d7';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assignments/$count';
