 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assignments.
 */
class MicrosoftIntuneDeviceManagementDeviceEnrollmentConfigurationsCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_enrollment_configurations_create_assignments';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assignments';
