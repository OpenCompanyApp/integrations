 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assign.
 */
class MicrosoftIntuneDeviceManagementDeviceEnrollmentConfigurationsDeviceEnrollmentConfigurationAssign extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_enrollment_configurations_device_enrollment_configuration_assign';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assign';
