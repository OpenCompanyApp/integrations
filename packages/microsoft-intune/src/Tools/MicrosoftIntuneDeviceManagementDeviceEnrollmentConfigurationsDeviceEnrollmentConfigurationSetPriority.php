 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/setPriority.
 */
class MicrosoftIntuneDeviceManagementDeviceEnrollmentConfigurationsDeviceEnrollmentConfigurationSetPriority extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_enrollment_configurations_device_enrollment_configuration_set_priority';
    protected const DESCRIPTION = 'Invoke action setPriority\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/setPriority.';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/setPriority';
    protected const PATH_PARAMS = ['deviceEnrollmentConfiguration-id' => 'device_enrollment_configuration_id'];
