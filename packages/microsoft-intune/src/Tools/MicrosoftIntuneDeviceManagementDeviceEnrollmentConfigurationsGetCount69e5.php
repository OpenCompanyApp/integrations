 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceEnrollmentConfigurations/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceEnrollmentConfigurationsGetCount69e5 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_enrollment_configurations_get_count_69e5';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations/$count';
