 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}/assignments.
 */
class MicrosoftIntuneDeviceManagementDeviceEnrollmentConfigurationsListAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_enrollment_configurations_list_assignments';
