 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement.
 */
class MicrosoftIntuneDeviceManagementDeviceManagementGetDeviceManagement extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_management_get_device_management';
    protected const DESCRIPTION = 'Get deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement.';
