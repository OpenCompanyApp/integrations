 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/deviceManagementPartners/{deviceManagementPartner-id}/terminate.
 */
class MicrosoftIntuneDeviceManagementDeviceManagementPartnersDeviceManagementPartnerTerminate extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_management_partners_device_management_partner_terminate';
    protected const DESCRIPTION = 'Invoke action terminate\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/deviceManagementPartners/{deviceManagementPartner-id}/terminate.';
    ...
    protected const PATH = '/deviceManagement/deviceManagementPartners/{deviceManagementPartner-id}/terminate';
