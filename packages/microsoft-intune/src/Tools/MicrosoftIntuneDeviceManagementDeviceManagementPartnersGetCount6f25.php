 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceManagementPartners/$count.
 */
class MicrosoftIntuneDeviceManagementDeviceManagementPartnersGetCount6f25 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_management_partners_get_count_6f25';
    ...
    protected const PATH = '/deviceManagement/deviceManagementPartners/$count';
