 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement.
 */
class MicrosoftIntuneDeviceManagementDeviceManagementUpdateDeviceManagement extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_device_management_update_device_management';
    protected const DESCRIPTION = 'Update deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement.';
    ...
    protected const PATH = '/deviceManagement';
