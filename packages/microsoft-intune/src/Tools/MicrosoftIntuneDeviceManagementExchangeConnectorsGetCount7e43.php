 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/exchangeConnectors/$count.
 */
class MicrosoftIntuneDeviceManagementExchangeConnectorsGetCount7e43 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_exchange_connectors_get_count_7e43';
    ...
    protected const PATH = '/deviceManagement/exchangeConnectors/$count';
