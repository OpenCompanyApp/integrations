 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/applePushNotificationCertificate.
 */
class MicrosoftIntuneDeviceManagementGetApplePushNotificationCertificate extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_apple_push_notification_certificate';
    protected const DESCRIPTION = 'Get applePushNotificationCertificate from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/applePushNotificationCertificate.';
