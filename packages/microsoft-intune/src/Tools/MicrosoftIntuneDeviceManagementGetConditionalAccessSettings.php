 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/conditionalAccessSettings.
 */
class MicrosoftIntuneDeviceManagementGetConditionalAccessSettings extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_conditional_access_settings';
    protected const DESCRIPTION = 'Get conditionalAccessSettings from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/conditionalAccessSettings.';
