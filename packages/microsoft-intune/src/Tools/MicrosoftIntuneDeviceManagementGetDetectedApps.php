 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/detectedApps/{detectedApp-id}.
 */
class MicrosoftIntuneDeviceManagementGetDetectedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_detected_apps';
    protected const DESCRIPTION = 'Get detectedApps from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/detectedApps/{detectedApp-id}.';
