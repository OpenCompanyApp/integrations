 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}.
 */
class MicrosoftIntuneDeviceManagementGetDeviceCompliancePolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_device_compliance_policies';
    protected const DESCRIPTION = 'Get deviceCompliancePolicies from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}.';
