 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicyDeviceStateSummary.
 */
class MicrosoftIntuneDeviceManagementGetDeviceCompliancePolicyDeviceStateSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_device_compliance_policy_device_state_summary';
    protected const DESCRIPTION = 'Get deviceCompliancePolicyDeviceStateSummary from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/deviceCompliancePolicyDeviceStateSummary.';
