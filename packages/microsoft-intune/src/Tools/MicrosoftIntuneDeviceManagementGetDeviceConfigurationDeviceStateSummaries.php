 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceConfigurationDeviceStateSummaries.
 */
class MicrosoftIntuneDeviceManagementGetDeviceConfigurationDeviceStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_device_configuration_device_state_summaries';
    protected const DESCRIPTION = 'Get deviceConfigurationDeviceStateSummaries from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/deviceConfigurationDeviceStateSummaries.';
