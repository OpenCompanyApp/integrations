 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}.
 */
class MicrosoftIntuneDeviceManagementGetDeviceEnrollmentConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_device_enrollment_configurations';
    protected const DESCRIPTION = 'Get deviceEnrollmentConfigurations from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}.';
