 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDeviceOverview.
 */
class MicrosoftIntuneDeviceManagementGetManagedDeviceOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_managed_device_overview';
    protected const DESCRIPTION = 'Get managedDeviceOverview from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/managedDeviceOverview.';
    ...
    protected const PATH = '/deviceManagement/managedDeviceOverview';
