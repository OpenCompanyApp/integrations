 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneDeviceManagementGetManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_managed_devices';
