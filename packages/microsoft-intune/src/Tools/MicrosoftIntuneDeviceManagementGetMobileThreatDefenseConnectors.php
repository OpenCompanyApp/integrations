 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/mobileThreatDefenseConnectors/{mobileThreatDefenseConnector-id}.
 */
class MicrosoftIntuneDeviceManagementGetMobileThreatDefenseConnectors extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_mobile_threat_defense_connectors';
    protected const DESCRIPTION = 'Get mobileThreatDefenseConnectors from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/mobileThreatDefenseConnectors/{mobileThreatDefenseConnector-id}.';
