 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}.
 */
class MicrosoftIntuneDeviceManagementGetRemoteAssistancePartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_remote_assistance_partners';
    protected const DESCRIPTION = 'Get remoteAssistancePartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}.';
