 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/reports.
 */
class MicrosoftIntuneDeviceManagementGetReports extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_reports';
    protected const DESCRIPTION = 'Get reports from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/reports.';
