 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/softwareUpdateStatusSummary.
 */
class MicrosoftIntuneDeviceManagementGetSoftwareUpdateStatusSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_software_update_status_summary';
    protected const DESCRIPTION = 'Get softwareUpdateStatusSummary from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/softwareUpdateStatusSummary.';
    ...
    protected const PATH = '/deviceManagement/softwareUpdateStatusSummary';
