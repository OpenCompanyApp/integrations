 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftIntuneDeviceManagementGetTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_troubleshooting_events';
    protected const DESCRIPTION = 'Get troubleshootingEvents from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.';
