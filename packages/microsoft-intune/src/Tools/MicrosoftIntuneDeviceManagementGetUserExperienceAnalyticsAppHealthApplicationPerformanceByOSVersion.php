 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion/{userExperienceAnalyticsAppHealthAppPerformanceByOSVersion-id}.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_app_health_application_performance_by_osversion';
