 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance/{userExperienceAnalyticsAppHealthDeviceModelPerformance-id}.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsAppHealthDeviceModelPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_app_health_device_model_performance';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsAppHealthDeviceModelPerformance from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance/{userExperienceAnalyticsAppHealthDeviceModelPerformance-id}.';
