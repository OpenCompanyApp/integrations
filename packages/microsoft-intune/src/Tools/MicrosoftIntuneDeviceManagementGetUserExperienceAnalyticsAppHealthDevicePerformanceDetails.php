 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails/{userExperienceAnalyticsAppHealthDevicePerformanceDetails-id}.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsAppHealthDevicePerformanceDetails extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_app_health_device_performance_details';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsAppHealthDevicePerformanceDetails from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails/{userExperienceAnalyticsAppHealthDevicePerformanceDetails-id}.';
