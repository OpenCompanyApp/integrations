 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthOverview.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsAppHealthOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_app_health_overview';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsAppHealthOverview from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsAppHealthOverview.';
