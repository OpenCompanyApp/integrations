 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsOverview.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_overview';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsOverview from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsOverview.';
