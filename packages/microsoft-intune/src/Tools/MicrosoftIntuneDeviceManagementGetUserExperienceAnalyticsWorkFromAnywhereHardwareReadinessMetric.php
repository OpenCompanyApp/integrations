 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_work_from_anywhere_hardware_readiness_metric';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric.';
