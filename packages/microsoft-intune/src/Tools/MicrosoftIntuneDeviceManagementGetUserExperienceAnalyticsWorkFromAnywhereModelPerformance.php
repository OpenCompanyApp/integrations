 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance/{userExperienceAnalyticsWorkFromAnywhereModelPerformance-id}.
 */
class MicrosoftIntuneDeviceManagementGetUserExperienceAnalyticsWorkFromAnywhereModelPerformance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_user_experience_analytics_work_from_anywhere_model_performance';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsWorkFromAnywhereModelPerformance from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance/{userExperienceAnalyticsWorkFromAnywhereModelPerformance-id}.';
