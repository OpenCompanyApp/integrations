 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint.
 */
class MicrosoftIntuneDeviceManagementGetVirtualEndpoint extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_virtual_endpoint';
    protected const DESCRIPTION = 'Get virtualEndpoint from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint.';
