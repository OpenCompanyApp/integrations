 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsInformationProtectionNetworkLearningSummaries/{windowsInformationProtectionNetworkLearningSummary-id}.
 */
class MicrosoftIntuneDeviceManagementGetWindowsInformationProtectionNetworkLearningSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_get_windows_information_protection_network_learning_summaries';
    protected const DESCRIPTION = 'Get windowsInformationProtectionNetworkLearningSummaries from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/windowsInformationProtectionNetworkLearningSummaries/{windowsInformationProtectionNetworkLearningSummary-id}.';
