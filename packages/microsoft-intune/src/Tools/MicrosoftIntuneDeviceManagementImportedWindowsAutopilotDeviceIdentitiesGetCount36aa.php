 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/importedWindowsAutopilotDeviceIdentities/$count.
 */
class MicrosoftIntuneDeviceManagementImportedWindowsAutopilotDeviceIdentitiesGetCount36aa extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_imported_windows_autopilot_device_identities_get_count_36aa';
    ...
    protected const PATH = '/deviceManagement/importedWindowsAutopilotDeviceIdentities/$count';
