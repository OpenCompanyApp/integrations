 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/importedWindowsAutopilotDeviceIdentities/import.
 */
class MicrosoftIntuneDeviceManagementImportedWindowsAutopilotDeviceIdentitiesImport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_imported_windows_autopilot_device_identities_import';
    protected const DESCRIPTION = 'Invoke action import\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/importedWindowsAutopilotDeviceIdentities/import.';
    ...
    protected const PATH = '/deviceManagement/importedWindowsAutopilotDeviceIdentities/import';
