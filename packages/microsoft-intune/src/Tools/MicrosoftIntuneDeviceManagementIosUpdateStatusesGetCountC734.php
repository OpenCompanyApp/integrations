 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/iosUpdateStatuses/$count.
 */
class MicrosoftIntuneDeviceManagementIosUpdateStatusesGetCountC734 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_ios_update_statuses_get_count_c734';
    ...
    protected const PATH = '/deviceManagement/iosUpdateStatuses/$count';
