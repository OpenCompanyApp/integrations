 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/auditEvents.
 */
class MicrosoftIntuneDeviceManagementListAuditEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_audit_events';
