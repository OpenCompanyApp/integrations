 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/complianceManagementPartners.
 */
class MicrosoftIntuneDeviceManagementListComplianceManagementPartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_compliance_management_partners';
