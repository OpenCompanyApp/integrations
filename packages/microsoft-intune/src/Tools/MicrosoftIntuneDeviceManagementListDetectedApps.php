 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/detectedApps.
 */
class MicrosoftIntuneDeviceManagementListDetectedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_detected_apps';
