 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceCompliancePolicySettingStateSummaries.
 */
class MicrosoftIntuneDeviceManagementListDeviceCompliancePolicySettingStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_device_compliance_policy_setting_state_summaries';
