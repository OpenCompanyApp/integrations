 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceConfigurations.
 */
class MicrosoftIntuneDeviceManagementListDeviceConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_device_configurations';
