 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceEnrollmentConfigurations.
 */
class MicrosoftIntuneDeviceManagementListDeviceEnrollmentConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_device_enrollment_configurations';
