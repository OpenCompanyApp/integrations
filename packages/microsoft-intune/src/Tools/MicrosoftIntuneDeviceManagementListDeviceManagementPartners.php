 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/deviceManagementPartners.
 */
class MicrosoftIntuneDeviceManagementListDeviceManagementPartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_device_management_partners';
