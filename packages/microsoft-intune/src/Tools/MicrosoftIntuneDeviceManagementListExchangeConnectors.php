 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/exchangeConnectors.
 */
class MicrosoftIntuneDeviceManagementListExchangeConnectors extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_exchange_connectors';
