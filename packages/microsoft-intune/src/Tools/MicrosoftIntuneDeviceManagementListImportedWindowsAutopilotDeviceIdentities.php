 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/importedWindowsAutopilotDeviceIdentities.
 */
class MicrosoftIntuneDeviceManagementListImportedWindowsAutopilotDeviceIdentities extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_imported_windows_autopilot_device_identities';
