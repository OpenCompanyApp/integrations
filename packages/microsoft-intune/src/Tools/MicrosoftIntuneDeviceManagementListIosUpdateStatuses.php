 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/iosUpdateStatuses.
 */
class MicrosoftIntuneDeviceManagementListIosUpdateStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_ios_update_statuses';
