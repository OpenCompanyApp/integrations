 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices.
 */
class MicrosoftIntuneDeviceManagementListManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_managed_devices';
