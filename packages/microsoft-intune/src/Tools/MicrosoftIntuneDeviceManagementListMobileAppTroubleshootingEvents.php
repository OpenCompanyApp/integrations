 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/mobileAppTroubleshootingEvents.
 */
class MicrosoftIntuneDeviceManagementListMobileAppTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_mobile_app_troubleshooting_events';
