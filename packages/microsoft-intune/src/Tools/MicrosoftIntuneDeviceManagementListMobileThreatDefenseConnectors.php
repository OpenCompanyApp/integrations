 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/mobileThreatDefenseConnectors.
 */
class MicrosoftIntuneDeviceManagementListMobileThreatDefenseConnectors extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_mobile_threat_defense_connectors';
