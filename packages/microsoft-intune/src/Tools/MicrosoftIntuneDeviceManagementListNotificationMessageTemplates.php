 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/notificationMessageTemplates.
 */
class MicrosoftIntuneDeviceManagementListNotificationMessageTemplates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_notification_message_templates';
