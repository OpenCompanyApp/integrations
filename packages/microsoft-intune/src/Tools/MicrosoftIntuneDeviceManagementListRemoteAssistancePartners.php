 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/remoteAssistancePartners.
 */
class MicrosoftIntuneDeviceManagementListRemoteAssistancePartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_remote_assistance_partners';
    protected const DESCRIPTION = 'List remoteAssistancePartners\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/remoteAssistancePartners.';
