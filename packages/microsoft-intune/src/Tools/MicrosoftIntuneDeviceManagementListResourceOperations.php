 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/resourceOperations.
 */
class MicrosoftIntuneDeviceManagementListResourceOperations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_resource_operations';
