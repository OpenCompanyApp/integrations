 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/roleAssignments.
 */
class MicrosoftIntuneDeviceManagementListRoleAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_role_assignments';
