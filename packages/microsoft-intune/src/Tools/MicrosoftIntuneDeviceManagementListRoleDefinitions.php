 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/roleDefinitions.
 */
class MicrosoftIntuneDeviceManagementListRoleDefinitions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_role_definitions';
