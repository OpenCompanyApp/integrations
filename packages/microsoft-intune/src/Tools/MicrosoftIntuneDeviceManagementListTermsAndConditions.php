 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/termsAndConditions.
 */
class MicrosoftIntuneDeviceManagementListTermsAndConditions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_terms_and_conditions';
