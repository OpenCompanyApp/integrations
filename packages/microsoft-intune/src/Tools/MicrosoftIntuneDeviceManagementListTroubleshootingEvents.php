 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/troubleshootingEvents.
 */
class MicrosoftIntuneDeviceManagementListTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_troubleshooting_events';
