 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDeviceId.
 */
class MicrosoftIntuneDeviceManagementListUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDeviceId extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_user_experience_analytics_app_health_application_performance_by_app_version_device_id';
