 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsCategories.
 */
class MicrosoftIntuneDeviceManagementListUserExperienceAnalyticsCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_user_experience_analytics_categories';
