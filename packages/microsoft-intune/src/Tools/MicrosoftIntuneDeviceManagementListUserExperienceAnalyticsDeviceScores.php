 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsDeviceScores.
 */
class MicrosoftIntuneDeviceManagementListUserExperienceAnalyticsDeviceScores extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_user_experience_analytics_device_scores';
    protected const DESCRIPTION = 'Get userExperienceAnalyticsDeviceScores from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsDeviceScores.';
