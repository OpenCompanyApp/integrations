 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsMetricHistory.
 */
class MicrosoftIntuneDeviceManagementListUserExperienceAnalyticsMetricHistory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_user_experience_analytics_metric_history';
