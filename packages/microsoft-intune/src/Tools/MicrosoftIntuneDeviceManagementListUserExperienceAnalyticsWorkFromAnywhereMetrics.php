 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics.
 */
class MicrosoftIntuneDeviceManagementListUserExperienceAnalyticsWorkFromAnywhereMetrics extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_user_experience_analytics_work_from_anywhere_metrics';
