 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsAutopilotDeviceIdentities.
 */
class MicrosoftIntuneDeviceManagementListWindowsAutopilotDeviceIdentities extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_windows_autopilot_device_identities';
