 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsInformationProtectionAppLearningSummaries.
 */
class MicrosoftIntuneDeviceManagementListWindowsInformationProtectionAppLearningSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_windows_information_protection_app_learning_summaries';
