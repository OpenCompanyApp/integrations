 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsInformationProtectionNetworkLearningSummaries.
 */
class MicrosoftIntuneDeviceManagementListWindowsInformationProtectionNetworkLearningSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_list_windows_information_protection_network_learning_summaries';
