 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesCreateDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_create_device_compliance_policy_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceCompliancePolicyStates for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates';
