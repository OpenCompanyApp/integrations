 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesCreateDeviceConfigurationStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_create_device_configuration_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceConfigurationStates for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates';
