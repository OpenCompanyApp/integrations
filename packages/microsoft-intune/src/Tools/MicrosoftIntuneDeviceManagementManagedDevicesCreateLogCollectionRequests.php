 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesCreateLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_create_log_collection_requests';
    protected const DESCRIPTION = 'Create new navigation property to logCollectionRequests for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests';
