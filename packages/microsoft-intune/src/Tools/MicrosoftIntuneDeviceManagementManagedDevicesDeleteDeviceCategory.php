 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesDeleteDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_delete_device_category';
    protected const DESCRIPTION = 'Delete navigation property deviceCategory for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory.';
