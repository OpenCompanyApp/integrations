 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesDeleteRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_delete_ref_device_category';
    protected const DESCRIPTION = 'Delete ref of navigation property deviceCategory for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deviceCategory/$ref';
