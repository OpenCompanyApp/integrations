 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesDeleteWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_delete_windows_protection_state';
    protected const DESCRIPTION = 'Delete navigation property windowsProtectionState for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState.';
