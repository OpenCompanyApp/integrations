 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/$count.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesDeviceCompliancePolicyStatesGetCountDafa extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_device_compliance_policy_states_get_count_dafa';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/$count';
