 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates/$count.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesDeviceConfigurationStatesGetCountA01e extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_device_configuration_states_get_count_a01e';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates/$count';
