 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/$count.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesGetCount8108 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_get_count_8108';
    ...
    protected const PATH = '/deviceManagement/managedDevices/$count';
