 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesGetDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_get_device_category';
    protected const DESCRIPTION = 'Get deviceCategory from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory.';
