 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesGetWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_get_windows_protection_state';
    protected const DESCRIPTION = 'Get windowsProtectionState from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState.';
