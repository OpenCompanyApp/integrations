 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesListDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_list_device_compliance_policy_states';
