 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/deviceConfigurationStates.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesListDeviceConfigurationStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_list_device_configuration_states';
