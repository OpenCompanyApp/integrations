 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesListLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_list_log_collection_requests';
