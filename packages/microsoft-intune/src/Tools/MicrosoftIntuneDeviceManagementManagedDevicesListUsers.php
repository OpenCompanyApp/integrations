 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/users.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesListUsers extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_list_users';
    protected const DESCRIPTION = 'Get users from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/managedDevices/{managedDevice-id}/users.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/users';
