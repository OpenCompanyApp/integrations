 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests/$count.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesLogCollectionRequestsGetCount78aa extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_log_collection_requests_get_count_78aa';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/logCollectionRequests/$count';
