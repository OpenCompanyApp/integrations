 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/bypassActivationLock.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceBypassActivationLock extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_bypass_activation_lock';
    protected const DESCRIPTION = 'Invoke action bypassActivationLock\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/bypassActivationLock.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/bypassActivationLock';
