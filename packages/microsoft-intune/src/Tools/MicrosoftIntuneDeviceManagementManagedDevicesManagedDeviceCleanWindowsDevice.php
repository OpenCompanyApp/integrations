 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/cleanWindowsDevice.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceCleanWindowsDevice extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_clean_windows_device';
    protected const DESCRIPTION = 'Invoke action cleanWindowsDevice\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/cleanWindowsDevice.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/cleanWindowsDevice';
