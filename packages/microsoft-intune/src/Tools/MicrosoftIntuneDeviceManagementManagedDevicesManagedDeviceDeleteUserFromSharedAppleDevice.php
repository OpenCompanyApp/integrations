 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/deleteUserFromSharedAppleDevice.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceDeleteUserFromSharedAppleDevice extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_delete_user_from_shared_apple_device';
    protected const DESCRIPTION = 'Invoke action deleteUserFromSharedAppleDevice\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/deleteUserFromSharedAppleDevice.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deleteUserFromSharedAppleDevice';
