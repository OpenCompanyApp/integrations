 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/disableLostMode.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceDisableLostMode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_disable_lost_mode';
    protected const DESCRIPTION = 'Invoke action disableLostMode\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/disableLostMode.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/disableLostMode';
