 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/locateDevice.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceLocateDevice extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_locate_device';
    protected const DESCRIPTION = 'Invoke action locateDevice\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/locateDevice.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/locateDevice';
