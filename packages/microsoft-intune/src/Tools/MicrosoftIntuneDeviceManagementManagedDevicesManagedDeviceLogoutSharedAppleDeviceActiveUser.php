 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceLogoutSharedAppleDeviceActiveUser extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_logout_shared_apple_device_active_user';
    protected const DESCRIPTION = 'Invoke action logoutSharedAppleDeviceActiveUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser';
