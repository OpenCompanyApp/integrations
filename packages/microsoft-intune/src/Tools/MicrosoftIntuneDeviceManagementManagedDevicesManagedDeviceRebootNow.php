 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/rebootNow.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceRebootNow extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_reboot_now';
    protected const DESCRIPTION = 'Invoke action rebootNow\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/rebootNow.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/rebootNow';
