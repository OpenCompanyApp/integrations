 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/recoverPasscode.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceRecoverPasscode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_recover_passcode';
    protected const DESCRIPTION = 'Invoke action recoverPasscode\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/recoverPasscode.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/recoverPasscode';
