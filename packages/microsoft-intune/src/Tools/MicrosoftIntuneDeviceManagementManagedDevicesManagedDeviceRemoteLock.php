 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/remoteLock.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceRemoteLock extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_remote_lock';
    protected const DESCRIPTION = 'Invoke action remoteLock\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/remoteLock.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/remoteLock';
