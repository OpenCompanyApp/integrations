 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/requestRemoteAssistance.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceRequestRemoteAssistance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_request_remote_assistance';
    protected const DESCRIPTION = 'Invoke action requestRemoteAssistance\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/requestRemoteAssistance.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/requestRemoteAssistance';
