 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/retire.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceRetire extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_retire';
    protected const DESCRIPTION = 'Invoke action retire\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/retire.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/retire';
