 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/shutDown.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceShutDown extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_shut_down';
    protected const DESCRIPTION = 'Invoke action shutDown\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/shutDown.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/shutDown';
