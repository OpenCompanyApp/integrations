 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/syncDevice.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceSyncDevice extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_sync_device';
    protected const DESCRIPTION = 'Invoke action syncDevice\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/syncDevice.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/syncDevice';
