 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/updateWindowsDeviceAccount.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceUpdateWindowsDeviceAccount extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_update_windows_device_account';
    protected const DESCRIPTION = 'Invoke action updateWindowsDeviceAccount\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/updateWindowsDeviceAccount.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/updateWindowsDeviceAccount';
