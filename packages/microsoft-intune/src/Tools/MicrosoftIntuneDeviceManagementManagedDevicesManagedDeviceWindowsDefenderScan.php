 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/windowsDefenderScan.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceWindowsDefenderScan extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_windows_defender_scan';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/windowsDefenderScan';
