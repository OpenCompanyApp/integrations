 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/windowsDefenderUpdateSignatures.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceWindowsDefenderUpdateSignatures extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_windows_defender_update_signatures';
    protected const DESCRIPTION = 'Invoke action windowsDefenderUpdateSignatures\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/windowsDefenderUpdateSignatures.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/windowsDefenderUpdateSignatures';
