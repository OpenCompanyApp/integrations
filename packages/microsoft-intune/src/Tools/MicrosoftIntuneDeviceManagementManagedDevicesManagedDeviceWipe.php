 ...
 * Invoke action wipe.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/managedDevices/{managedDevice-id}/wipe.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesManagedDeviceWipe extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_managed_device_wipe';
    protected const DESCRIPTION = 'Invoke action wipe\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/managedDevices/{managedDevice-id}/wipe.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/wipe';
