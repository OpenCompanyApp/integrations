 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesUpdateDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_update_device_category';
    protected const DESCRIPTION = 'Update the navigation property deviceCategory in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/deviceCategory';
