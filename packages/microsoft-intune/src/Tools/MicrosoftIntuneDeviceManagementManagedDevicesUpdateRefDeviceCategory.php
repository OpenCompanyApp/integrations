 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesUpdateRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_update_ref_device_category';
    protected const DESCRIPTION = 'Update the ref of navigation property deviceCategory in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /deviceManagement/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
