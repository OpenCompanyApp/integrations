 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneDeviceManagementManagedDevicesUpdateWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_managed_devices_update_windows_protection_state';
    protected const DESCRIPTION = 'Update the navigation property windowsProtectionState in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}/windowsProtectionState';
