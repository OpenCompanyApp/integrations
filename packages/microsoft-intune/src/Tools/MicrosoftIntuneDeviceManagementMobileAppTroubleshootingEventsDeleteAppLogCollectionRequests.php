 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent-id}/appLogCollectionRequests/{appLogCollectionRequest-id}.
 */
class MicrosoftIntuneDeviceManagementMobileAppTroubleshootingEventsDeleteAppLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_mobile_app_troubleshooting_events_delete_app_log_collection_requests';
    protected const DESCRIPTION = 'Delete navigation property appLogCollectionRequests for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent-id}/appLogCollectionRequests/{appLogCollectionRequest-id}.';
