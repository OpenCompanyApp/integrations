 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/mobileAppTroubleshootingEvents/$count.
 */
class MicrosoftIntuneDeviceManagementMobileAppTroubleshootingEventsGetCount9f2d extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_mobile_app_troubleshooting_events_get_count_9f2d';
    ...
    protected const PATH = '/deviceManagement/mobileAppTroubleshootingEvents/$count';
