 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent-id}/appLogCollectionRequests/{appLogCollectionRequest-id}.
 */
class MicrosoftIntuneDeviceManagementMobileAppTroubleshootingEventsUpdateAppLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_mobile_app_troubleshooting_events_update_app_log_collection_requests';
    protected const DESCRIPTION = 'Update the navigation property appLogCollectionRequests in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent-id}/appLogCollectionRequests/{appLogCollectionRequest-id}.';
