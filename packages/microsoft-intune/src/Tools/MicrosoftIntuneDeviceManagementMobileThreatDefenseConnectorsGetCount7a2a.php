 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/mobileThreatDefenseConnectors/$count.
 */
class MicrosoftIntuneDeviceManagementMobileThreatDefenseConnectorsGetCount7a2a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_mobile_threat_defense_connectors_get_count_7a2a';
    ...
    protected const PATH = '/deviceManagement/mobileThreatDefenseConnectors/$count';
