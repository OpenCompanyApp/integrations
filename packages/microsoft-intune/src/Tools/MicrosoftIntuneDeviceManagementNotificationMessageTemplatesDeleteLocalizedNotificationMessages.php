 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/notificationMessageTemplates/{notificationMessageTemplate-id}/localizedNotificationMessages/{localizedNotificationMessage-id}.
 */
class MicrosoftIntuneDeviceManagementNotificationMessageTemplatesDeleteLocalizedNotificationMessages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_notification_message_templates_delete_localized_notification_messages';
    protected const DESCRIPTION = 'Delete navigation property localizedNotificationMessages for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/notificationMessageTemplates/{notificationMessageTemplate-id}/localizedNotificationMessages/{localizedNotificationMessage-id}.';
