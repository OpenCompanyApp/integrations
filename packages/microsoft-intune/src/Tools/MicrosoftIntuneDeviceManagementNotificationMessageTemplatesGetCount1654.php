 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/notificationMessageTemplates/$count.
 */
class MicrosoftIntuneDeviceManagementNotificationMessageTemplatesGetCount1654 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_notification_message_templates_get_count_1654';
    ...
    protected const PATH = '/deviceManagement/notificationMessageTemplates/$count';
