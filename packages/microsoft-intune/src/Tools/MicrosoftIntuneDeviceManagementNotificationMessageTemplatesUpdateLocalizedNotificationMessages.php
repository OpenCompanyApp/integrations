 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/notificationMessageTemplates/{notificationMessageTemplate-id}/localizedNotificationMessages/{localizedNotificationMessage-id}.
 */
class MicrosoftIntuneDeviceManagementNotificationMessageTemplatesUpdateLocalizedNotificationMessages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_notification_message_templates_update_localized_notification_messages';
    protected const DESCRIPTION = 'Update the navigation property localizedNotificationMessages in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/notificationMessageTemplates/{notificationMessageTemplate-id}/localizedNotificationMessages/{localizedNotificationMessage-id}.';
