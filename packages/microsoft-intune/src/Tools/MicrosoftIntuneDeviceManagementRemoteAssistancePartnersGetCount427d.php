 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/remoteAssistancePartners/$count.
 */
class MicrosoftIntuneDeviceManagementRemoteAssistancePartnersGetCount427d extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_remote_assistance_partners_get_count_427d';
    ...
    protected const PATH = '/deviceManagement/remoteAssistancePartners/$count';
