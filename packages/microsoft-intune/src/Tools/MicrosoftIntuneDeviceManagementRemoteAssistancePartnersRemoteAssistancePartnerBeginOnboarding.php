 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}/beginOnboarding.
 */
class MicrosoftIntuneDeviceManagementRemoteAssistancePartnersRemoteAssistancePartnerBeginOnboarding extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_remote_assistance_partners_remote_assistance_partner_begin_onboarding';
    protected const DESCRIPTION = 'Invoke action beginOnboarding\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}/beginOnboarding.';
    ...
    protected const PATH = '/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}/beginOnboarding';
