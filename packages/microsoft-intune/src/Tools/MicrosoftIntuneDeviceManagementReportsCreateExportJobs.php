 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/exportJobs.
 */
class MicrosoftIntuneDeviceManagementReportsCreateExportJobs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_create_export_jobs';
    protected const DESCRIPTION = 'Create new navigation property to exportJobs for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/exportJobs.';
    ...
    protected const PATH = '/deviceManagement/reports/exportJobs';
