 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/reports/exportJobs/$count.
 */
class MicrosoftIntuneDeviceManagementReportsExportJobsGetCount5277 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_export_jobs_get_count_5277';
    ...
    protected const PATH = '/deviceManagement/reports/exportJobs/$count';
