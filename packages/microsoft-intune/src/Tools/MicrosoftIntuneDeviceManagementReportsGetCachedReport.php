 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getCachedReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetCachedReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_cached_report';
    protected const DESCRIPTION = 'Invoke action getCachedReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getCachedReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getCachedReport';
