 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getCompliancePolicyNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetCompliancePolicyNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_compliance_policy_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getCompliancePolicyNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getCompliancePolicyNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getCompliancePolicyNonComplianceReport';
