 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getCompliancePolicyNonComplianceSummaryReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetCompliancePolicyNonComplianceSummaryReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_compliance_policy_non_compliance_summary_report';
    protected const DESCRIPTION = 'Invoke action getCompliancePolicyNonComplianceSummaryReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getCompliancePolicyNonComplianceSummaryReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getCompliancePolicyNonComplianceSummaryReport';
