 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getComplianceSettingNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetComplianceSettingNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_compliance_setting_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getComplianceSettingNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getComplianceSettingNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getComplianceSettingNonComplianceReport';
