 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getConfigurationPolicyNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetConfigurationPolicyNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_configuration_policy_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getConfigurationPolicyNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getConfigurationPolicyNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getConfigurationPolicyNonComplianceReport';
