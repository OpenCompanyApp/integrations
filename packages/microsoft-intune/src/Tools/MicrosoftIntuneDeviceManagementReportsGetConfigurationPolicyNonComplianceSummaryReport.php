 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getConfigurationPolicyNonComplianceSummaryReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetConfigurationPolicyNonComplianceSummaryReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_configuration_policy_non_compliance_summary_report';
    protected const DESCRIPTION = 'Invoke action getConfigurationPolicyNonComplianceSummaryReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getConfigurationPolicyNonComplianceSummaryReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getConfigurationPolicyNonComplianceSummaryReport';
