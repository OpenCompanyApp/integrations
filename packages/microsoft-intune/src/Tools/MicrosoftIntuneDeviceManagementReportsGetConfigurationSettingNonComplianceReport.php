 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getConfigurationSettingNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetConfigurationSettingNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_configuration_setting_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getConfigurationSettingNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getConfigurationSettingNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getConfigurationSettingNonComplianceReport';
