 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getDeviceManagementIntentPerSettingContributingProfiles.
 */
class MicrosoftIntuneDeviceManagementReportsGetDeviceManagementIntentPerSettingContributingProfiles extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_device_management_intent_per_setting_contributing_profiles';
    protected const DESCRIPTION = 'Invoke action getDeviceManagementIntentPerSettingContributingProfiles\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getDeviceManagementIntentPerSettingContributingProfiles.';
    ...
    protected const PATH = '/deviceManagement/reports/getDeviceManagementIntentPerSettingContributingProfiles';
