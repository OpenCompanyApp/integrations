 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getDeviceManagementIntentSettingsReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetDeviceManagementIntentSettingsReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_device_management_intent_settings_report';
    protected const DESCRIPTION = 'Invoke action getDeviceManagementIntentSettingsReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getDeviceManagementIntentSettingsReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getDeviceManagementIntentSettingsReport';
