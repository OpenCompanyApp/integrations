 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getDeviceNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetDeviceNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_device_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getDeviceNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getDeviceNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getDeviceNonComplianceReport';
