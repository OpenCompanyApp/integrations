 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getDevicesWithoutCompliancePolicyReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetDevicesWithoutCompliancePolicyReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_devices_without_compliance_policy_report';
    protected const DESCRIPTION = 'Invoke action getDevicesWithoutCompliancePolicyReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getDevicesWithoutCompliancePolicyReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getDevicesWithoutCompliancePolicyReport';
