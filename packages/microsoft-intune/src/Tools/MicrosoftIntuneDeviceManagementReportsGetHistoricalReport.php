 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getHistoricalReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetHistoricalReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_historical_report';
    protected const DESCRIPTION = 'Invoke action getHistoricalReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getHistoricalReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getHistoricalReport';
