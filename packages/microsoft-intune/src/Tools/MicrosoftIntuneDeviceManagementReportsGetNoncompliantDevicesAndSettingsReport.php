 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getNoncompliantDevicesAndSettingsReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetNoncompliantDevicesAndSettingsReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_noncompliant_devices_and_settings_report';
    protected const DESCRIPTION = 'Invoke action getNoncompliantDevicesAndSettingsReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getNoncompliantDevicesAndSettingsReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getNoncompliantDevicesAndSettingsReport';
