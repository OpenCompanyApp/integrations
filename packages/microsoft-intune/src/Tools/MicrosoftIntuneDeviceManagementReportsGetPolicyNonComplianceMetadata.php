 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getPolicyNonComplianceMetadata.
 */
class MicrosoftIntuneDeviceManagementReportsGetPolicyNonComplianceMetadata extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_policy_non_compliance_metadata';
    protected const DESCRIPTION = 'Invoke action getPolicyNonComplianceMetadata\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getPolicyNonComplianceMetadata.';
    ...
    protected const PATH = '/deviceManagement/reports/getPolicyNonComplianceMetadata';
