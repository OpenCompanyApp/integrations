 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getPolicyNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetPolicyNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_policy_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getPolicyNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getPolicyNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getPolicyNonComplianceReport';
