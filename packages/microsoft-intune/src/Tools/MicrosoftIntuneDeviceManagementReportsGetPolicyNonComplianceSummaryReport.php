 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getPolicyNonComplianceSummaryReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetPolicyNonComplianceSummaryReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_policy_non_compliance_summary_report';
    protected const DESCRIPTION = 'Invoke action getPolicyNonComplianceSummaryReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getPolicyNonComplianceSummaryReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getPolicyNonComplianceSummaryReport';
