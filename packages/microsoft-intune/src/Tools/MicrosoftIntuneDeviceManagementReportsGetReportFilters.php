 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getReportFilters.
 */
class MicrosoftIntuneDeviceManagementReportsGetReportFilters extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_report_filters';
    protected const DESCRIPTION = 'Invoke action getReportFilters\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getReportFilters.';
    ...
    protected const PATH = '/deviceManagement/reports/getReportFilters';
