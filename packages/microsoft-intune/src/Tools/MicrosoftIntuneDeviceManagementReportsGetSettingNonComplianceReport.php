 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/getSettingNonComplianceReport.
 */
class MicrosoftIntuneDeviceManagementReportsGetSettingNonComplianceReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_get_setting_non_compliance_report';
    protected const DESCRIPTION = 'Invoke action getSettingNonComplianceReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/getSettingNonComplianceReport.';
    ...
    protected const PATH = '/deviceManagement/reports/getSettingNonComplianceReport';
