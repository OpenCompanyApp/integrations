 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/reports/exportJobs.
 */
class MicrosoftIntuneDeviceManagementReportsListExportJobs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_list_export_jobs';
