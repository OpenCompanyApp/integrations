 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/reports/retrieveDeviceAppInstallationStatusReport.
 */
class MicrosoftIntuneDeviceManagementReportsRetrieveDeviceAppInstallationStatusReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_reports_retrieve_device_app_installation_status_report';
    protected const DESCRIPTION = 'Invoke action retrieveDeviceAppInstallationStatusReport\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/reports/retrieveDeviceAppInstallationStatusReport.';
    ...
    protected const PATH = '/deviceManagement/reports/retrieveDeviceAppInstallationStatusReport';
