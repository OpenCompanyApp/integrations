 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/resourceOperations/$count.
 */
class MicrosoftIntuneDeviceManagementResourceOperationsGetCountDb11 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_resource_operations_get_count_db11';
    ...
    protected const PATH = '/deviceManagement/resourceOperations/$count';
