 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/roleAssignments/$count.
 */
class MicrosoftIntuneDeviceManagementRoleAssignmentsGetCount13e6 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_role_assignments_get_count_13e6';
    ...
    protected const PATH = '/deviceManagement/roleAssignments/$count';
