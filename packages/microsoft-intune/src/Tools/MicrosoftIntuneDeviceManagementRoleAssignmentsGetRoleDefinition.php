 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment-id}/roleDefinition.
 */
class MicrosoftIntuneDeviceManagementRoleAssignmentsGetRoleDefinition extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_role_assignments_get_role_definition';
    ...
    protected const PATH = '/deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment-id}/roleDefinition';
