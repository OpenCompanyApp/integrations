 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/roleDefinitions/$count.
 */
class MicrosoftIntuneDeviceManagementRoleDefinitionsGetCount031b extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_role_definitions_get_count_031b';
    ...
    protected const PATH = '/deviceManagement/roleDefinitions/$count';
