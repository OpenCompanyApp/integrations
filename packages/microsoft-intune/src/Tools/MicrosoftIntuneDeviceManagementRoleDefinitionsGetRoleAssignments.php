 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/roleDefinitions/{roleDefinition-id}/roleAssignments/{roleAssignment-id}.
 */
class MicrosoftIntuneDeviceManagementRoleDefinitionsGetRoleAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_role_definitions_get_role_assignments';
