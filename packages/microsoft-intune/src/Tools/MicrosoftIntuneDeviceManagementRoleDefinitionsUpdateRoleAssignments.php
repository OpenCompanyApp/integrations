 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/roleDefinitions/{roleDefinition-id}/roleAssignments/{roleAssignment-id}.
 */
class MicrosoftIntuneDeviceManagementRoleDefinitionsUpdateRoleAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_role_definitions_update_role_assignments';
    protected const DESCRIPTION = 'Update the navigation property roleAssignments in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/roleDefinitions/{roleDefinition-id}/roleAssignments/{roleAssignment-id}.';
