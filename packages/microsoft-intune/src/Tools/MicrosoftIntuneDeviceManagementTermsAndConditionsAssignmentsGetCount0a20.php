 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments/$count.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsAssignmentsGetCount0a20 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_assignments_get_count_0a20';
    ...
    protected const PATH = '/deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments/$count';
