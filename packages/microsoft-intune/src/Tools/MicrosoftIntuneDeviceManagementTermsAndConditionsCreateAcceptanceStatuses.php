 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsCreateAcceptanceStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_create_acceptance_statuses';
    protected const DESCRIPTION = 'Create new navigation property to acceptanceStatuses for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses.';
    ...
    protected const PATH = '/deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses';
