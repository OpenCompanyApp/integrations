 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_create_assignments';
    ...
    protected const PATH = '/deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments';
