 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses/{termsAndConditionsAcceptanceStatus-id}.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsDeleteAcceptanceStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_delete_acceptance_statuses';
    protected const DESCRIPTION = 'Delete navigation property acceptanceStatuses for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses/{termsAndConditionsAcceptanceStatus-id}.';
