 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments/{termsAndConditionsAssignment-id}.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsDeleteAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_delete_assignments';
