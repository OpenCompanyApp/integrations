 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses/{termsAndConditionsAcceptanceStatus-id}.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsGetAcceptanceStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_get_acceptance_statuses';
