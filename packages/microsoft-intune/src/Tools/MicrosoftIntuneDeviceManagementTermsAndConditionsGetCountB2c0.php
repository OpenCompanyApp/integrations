 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/termsAndConditions/$count.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsGetCountB2c0 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_get_count_b2c0';
    ...
    protected const PATH = '/deviceManagement/termsAndConditions/$count';
