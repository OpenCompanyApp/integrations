 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsListAcceptanceStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_list_acceptance_statuses';
    protected const DESCRIPTION = 'Get acceptanceStatuses from deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/termsAndConditions/{termsAndConditions-id}/acceptanceStatuses.';
