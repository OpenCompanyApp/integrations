 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/termsAndConditions/{termsAndConditions-id}/assignments/{termsAndConditionsAssignment-id}.
 */
class MicrosoftIntuneDeviceManagementTermsAndConditionsUpdateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_terms_and_conditions_update_assignments';
