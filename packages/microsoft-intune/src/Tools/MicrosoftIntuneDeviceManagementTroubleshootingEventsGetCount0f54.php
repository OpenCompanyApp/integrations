 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/troubleshootingEvents/$count.
 */
class MicrosoftIntuneDeviceManagementTroubleshootingEventsGetCount0f54 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_troubleshooting_events_get_count_0f54';
    ...
    protected const PATH = '/deviceManagement/troubleshootingEvents/$count';
