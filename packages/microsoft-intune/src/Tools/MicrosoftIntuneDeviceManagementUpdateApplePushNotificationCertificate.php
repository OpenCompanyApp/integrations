 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/applePushNotificationCertificate.
 */
class MicrosoftIntuneDeviceManagementUpdateApplePushNotificationCertificate extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_apple_push_notification_certificate';
    protected const DESCRIPTION = 'Update the navigation property applePushNotificationCertificate in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/applePushNotificationCertificate.';
    ...
    protected const PATH = '/deviceManagement/applePushNotificationCertificate';
