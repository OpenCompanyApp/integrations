 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/conditionalAccessSettings.
 */
class MicrosoftIntuneDeviceManagementUpdateConditionalAccessSettings extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_conditional_access_settings';
    protected const DESCRIPTION = 'Update the navigation property conditionalAccessSettings in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/conditionalAccessSettings.';
    ...
    protected const PATH = '/deviceManagement/conditionalAccessSettings';
