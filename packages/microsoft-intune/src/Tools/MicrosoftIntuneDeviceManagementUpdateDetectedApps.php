 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/detectedApps/{detectedApp-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateDetectedApps extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_detected_apps';
    protected const DESCRIPTION = 'Update the navigation property detectedApps in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/detectedApps/{detectedApp-id}.';
    ...
    protected const PATH = '/deviceManagement/detectedApps/{detectedApp-id}';
