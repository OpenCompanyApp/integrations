 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateDeviceCompliancePolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_device_compliance_policies';
    protected const DESCRIPTION = 'Update the navigation property deviceCompliancePolicies in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}.';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy-id}';
