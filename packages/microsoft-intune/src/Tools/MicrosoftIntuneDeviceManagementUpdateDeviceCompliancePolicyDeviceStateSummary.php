 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceCompliancePolicyDeviceStateSummary.
 */
class MicrosoftIntuneDeviceManagementUpdateDeviceCompliancePolicyDeviceStateSummary extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_device_compliance_policy_device_state_summary';
    protected const DESCRIPTION = 'Update the navigation property deviceCompliancePolicyDeviceStateSummary in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/deviceCompliancePolicyDeviceStateSummary.';
    ...
    protected const PATH = '/deviceManagement/deviceCompliancePolicyDeviceStateSummary';
