 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceConfigurationDeviceStateSummaries.
 */
class MicrosoftIntuneDeviceManagementUpdateDeviceConfigurationDeviceStateSummaries extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_device_configuration_device_state_summaries';
    protected const DESCRIPTION = 'Update the navigation property deviceConfigurationDeviceStateSummaries in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/deviceConfigurationDeviceStateSummaries.';
    ...
    protected const PATH = '/deviceManagement/deviceConfigurationDeviceStateSummaries';
