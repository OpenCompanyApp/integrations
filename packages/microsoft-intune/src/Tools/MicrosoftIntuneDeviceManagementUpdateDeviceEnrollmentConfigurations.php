 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateDeviceEnrollmentConfigurations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_device_enrollment_configurations';
    protected const DESCRIPTION = 'Update the navigation property deviceEnrollmentConfigurations in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}.';
    ...
    protected const PATH = '/deviceManagement/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}';
