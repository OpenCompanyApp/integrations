 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/deviceManagementPartners/{deviceManagementPartner-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateDeviceManagementPartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_device_management_partners';
    protected const DESCRIPTION = 'Update the navigation property deviceManagementPartners in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/deviceManagementPartners/{deviceManagementPartner-id}.';
