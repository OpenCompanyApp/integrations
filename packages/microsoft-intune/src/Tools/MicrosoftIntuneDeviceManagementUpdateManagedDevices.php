 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_managed_devices';
    protected const DESCRIPTION = 'Update the navigation property managedDevices in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/managedDevices/{managedDevice-id}.';
    ...
    protected const PATH = '/deviceManagement/managedDevices/{managedDevice-id}';
