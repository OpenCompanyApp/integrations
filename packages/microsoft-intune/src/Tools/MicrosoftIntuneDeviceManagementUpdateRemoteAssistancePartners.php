 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateRemoteAssistancePartners extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_remote_assistance_partners';
    protected const DESCRIPTION = 'Update remoteAssistancePartner\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}.';
