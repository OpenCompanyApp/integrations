 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/reports.
 */
class MicrosoftIntuneDeviceManagementUpdateReports extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_reports';
    protected const DESCRIPTION = 'Update the navigation property reports in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/reports.';
    ...
    protected const PATH = '/deviceManagement/reports';
