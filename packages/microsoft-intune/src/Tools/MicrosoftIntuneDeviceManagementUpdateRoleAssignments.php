 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateRoleAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_role_assignments';
