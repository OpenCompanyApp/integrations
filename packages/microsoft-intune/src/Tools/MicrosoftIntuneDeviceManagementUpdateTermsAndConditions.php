 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/termsAndConditions/{termsAndConditions-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateTermsAndConditions extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_terms_and_conditions';
    protected const DESCRIPTION = 'Update the navigation property termsAndConditions in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/termsAndConditions/{termsAndConditions-id}.';
    ...
    protected const PATH = '/deviceManagement/termsAndConditions/{termsAndConditions-id}';
