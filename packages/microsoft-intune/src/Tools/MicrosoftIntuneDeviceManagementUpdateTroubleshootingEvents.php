 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_troubleshooting_events';
    protected const DESCRIPTION = 'Update the navigation property troubleshootingEvents in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.';
    ...
    protected const PATH = '/deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}';
