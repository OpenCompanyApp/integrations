 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/userExperienceAnalyticsAppHealthOverview.
 */
class MicrosoftIntuneDeviceManagementUpdateUserExperienceAnalyticsAppHealthOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_user_experience_analytics_app_health_overview';
    protected const DESCRIPTION = 'Update the navigation property userExperienceAnalyticsAppHealthOverview in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/userExperienceAnalyticsAppHealthOverview.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthOverview';
