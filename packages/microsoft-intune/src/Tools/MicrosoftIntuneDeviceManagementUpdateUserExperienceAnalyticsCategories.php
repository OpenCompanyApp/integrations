 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateUserExperienceAnalyticsCategories extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_user_experience_analytics_categories';
    protected const DESCRIPTION = 'Update the navigation property userExperienceAnalyticsCategories in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory-id}.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory-id}';
