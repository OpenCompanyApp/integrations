 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/userExperienceAnalyticsMetricHistory/{userExperienceAnalyticsMetricHistory-id}.
 */
class MicrosoftIntuneDeviceManagementUpdateUserExperienceAnalyticsMetricHistory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_user_experience_analytics_metric_history';
    protected const DESCRIPTION = 'Update the navigation property userExperienceAnalyticsMetricHistory in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/userExperienceAnalyticsMetricHistory/{userExperienceAnalyticsMetricHistory-id}.';
