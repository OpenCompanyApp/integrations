 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/userExperienceAnalyticsOverview.
 */
class MicrosoftIntuneDeviceManagementUpdateUserExperienceAnalyticsOverview extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_user_experience_analytics_overview';
    protected const DESCRIPTION = 'Update the navigation property userExperienceAnalyticsOverview in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/userExperienceAnalyticsOverview.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsOverview';
