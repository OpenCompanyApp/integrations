 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/virtualEndpoint.
 */
class MicrosoftIntuneDeviceManagementUpdateVirtualEndpoint extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_update_virtual_endpoint';
    protected const DESCRIPTION = 'Update the navigation property virtualEndpoint in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/virtualEndpoint.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint';
