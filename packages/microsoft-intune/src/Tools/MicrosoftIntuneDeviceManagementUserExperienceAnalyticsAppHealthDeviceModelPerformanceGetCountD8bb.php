 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthDeviceModelPerformanceGetCountD8bb extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_device_model_performance_get_count_d8bb';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance/$count';
