 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthDevicePerformanceDetailsGetCount4666 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_device_performance_details_get_count_4666';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails/$count';
