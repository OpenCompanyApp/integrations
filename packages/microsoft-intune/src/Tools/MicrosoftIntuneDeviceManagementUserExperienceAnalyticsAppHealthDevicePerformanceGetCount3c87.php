 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthDevicePerformanceGetCount3c87 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_device_performance_get_count_3c87';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance/$count';
