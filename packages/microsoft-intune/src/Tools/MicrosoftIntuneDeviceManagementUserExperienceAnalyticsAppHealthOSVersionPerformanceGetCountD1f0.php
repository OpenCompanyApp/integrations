 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthOSVersionPerformanceGetCountD1f0 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_osversion_performance_get_count_d1f0';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance/$count';
