 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthOverviewCreateMetricValues extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_overview_create_metric_values';
    protected const DESCRIPTION = 'Create new navigation property to metricValues for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues.';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues';
