 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthOverviewListMetricValues extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_overview_list_metric_values';
