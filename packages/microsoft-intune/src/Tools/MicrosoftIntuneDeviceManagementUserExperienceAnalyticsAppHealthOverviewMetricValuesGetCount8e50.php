 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthOverviewMetricValuesGetCount8e50 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_overview_metric_values_get_count_8e50';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues/$count';
