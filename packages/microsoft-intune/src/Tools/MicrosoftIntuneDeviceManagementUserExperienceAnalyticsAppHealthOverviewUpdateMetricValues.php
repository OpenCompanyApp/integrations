 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues/{userExperienceAnalyticsMetric-id}.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsAppHealthOverviewUpdateMetricValues extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_app_health_overview_update_metric_values';
