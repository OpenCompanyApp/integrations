 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsBaselines/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsBaselinesGetCountCb93 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_baselines_get_count_cb93';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsBaselines/$count';
