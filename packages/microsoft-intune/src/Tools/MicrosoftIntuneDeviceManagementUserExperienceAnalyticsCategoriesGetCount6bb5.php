 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsCategories/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsCategoriesGetCount6bb5 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_categories_get_count_6bb5';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsCategories/$count';
