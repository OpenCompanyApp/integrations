 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsDevicePerformance/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsDevicePerformanceGetCount7e9c extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_device_performance_get_count_7e9c';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDevicePerformance/$count';
