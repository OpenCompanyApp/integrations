 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsDeviceScores/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsDeviceScoresGetCount396a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_device_scores_get_count_396a';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceScores/$count';
