 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsDeviceStartupHistory/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsDeviceStartupHistoryGetCountA819 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_device_startup_history_get_count_a819';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceStartupHistory/$count';
