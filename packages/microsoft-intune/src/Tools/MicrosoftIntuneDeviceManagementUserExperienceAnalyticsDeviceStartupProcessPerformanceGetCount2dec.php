 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsDeviceStartupProcessPerformance/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsDeviceStartupProcessPerformanceGetCount2dec extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_device_startup_process_performance_get_count_2dec';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceStartupProcessPerformance/$count';
