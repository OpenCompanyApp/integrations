 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsDeviceStartupProcesses/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsDeviceStartupProcessesGetCountF629 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_device_startup_processes_get_count_f629';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsDeviceStartupProcesses/$count';
