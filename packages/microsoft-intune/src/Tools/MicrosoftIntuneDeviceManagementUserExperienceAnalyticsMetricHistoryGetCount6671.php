 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsMetricHistory/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsMetricHistoryGetCount6671 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_metric_history_get_count_6671';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsMetricHistory/$count';
