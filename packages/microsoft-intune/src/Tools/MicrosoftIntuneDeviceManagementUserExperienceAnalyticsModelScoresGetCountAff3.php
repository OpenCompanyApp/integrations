 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsModelScores/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsModelScoresGetCountAff3 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_model_scores_get_count_aff3';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsModelScores/$count';
