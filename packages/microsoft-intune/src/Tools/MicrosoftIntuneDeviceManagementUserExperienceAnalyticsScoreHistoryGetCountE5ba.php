 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsScoreHistory/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsScoreHistoryGetCountE5ba extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_score_history_get_count_e5ba';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsScoreHistory/$count';
