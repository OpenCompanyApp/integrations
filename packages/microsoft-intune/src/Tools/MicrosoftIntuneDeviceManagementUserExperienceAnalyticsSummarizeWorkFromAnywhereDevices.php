 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsSummarizeWorkFromAnywhereDevices().
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsSummarizeWorkFromAnywhereDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_summarize_work_from_anywhere_devices';
    protected const DESCRIPTION = 'Invoke function userExperienceAnalyticsSummarizeWorkFromAnywhereDevices\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/userExperienceAnalyticsSummarizeWorkFromAnywhereDevices().';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsSummarizeWorkFromAnywhereDevices()';
