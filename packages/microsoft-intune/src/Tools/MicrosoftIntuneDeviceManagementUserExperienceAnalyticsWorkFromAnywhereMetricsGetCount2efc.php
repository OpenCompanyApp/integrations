 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricsGetCount2efc extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_work_from_anywhere_metrics_get_count_2efc';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics/$count';
