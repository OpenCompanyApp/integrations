 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance/$count.
 */
class MicrosoftIntuneDeviceManagementUserExperienceAnalyticsWorkFromAnywhereModelPerformanceGetCount4b25 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_user_experience_analytics_work_from_anywhere_model_performance_get_count_4b25';
    ...
    protected const PATH = '/deviceManagement/userExperienceAnalyticsWorkFromAnywhereModelPerformance/$count';
