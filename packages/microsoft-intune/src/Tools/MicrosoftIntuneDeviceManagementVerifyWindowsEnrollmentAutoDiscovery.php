 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/verifyWindowsEnrollmentAutoDiscovery(domainName='{domainName}').
 */
class MicrosoftIntuneDeviceManagementVerifyWindowsEnrollmentAutoDiscovery extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_verify_windows_enrollment_auto_discovery';
    protected const DESCRIPTION = 'Invoke function verifyWindowsEnrollmentAutoDiscovery\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/verifyWindowsEnrollmentAutoDiscovery(domainName=\'{domainName}\').';
    ...
    protected const PATH = '/deviceManagement/verifyWindowsEnrollmentAutoDiscovery(domainName=\'{domainName}\')';
