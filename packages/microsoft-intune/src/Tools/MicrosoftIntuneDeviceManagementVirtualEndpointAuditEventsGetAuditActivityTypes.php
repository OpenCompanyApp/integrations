 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/auditEvents/getAuditActivityTypes().
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointAuditEventsGetAuditActivityTypes extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_audit_events_get_audit_activity_types';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/auditEvents/getAuditActivityTypes()';
