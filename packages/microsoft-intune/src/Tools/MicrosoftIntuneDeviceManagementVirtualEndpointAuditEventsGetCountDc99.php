 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/auditEvents/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointAuditEventsGetCountDc99 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_audit_events_get_count_dc99';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/auditEvents/$count';
