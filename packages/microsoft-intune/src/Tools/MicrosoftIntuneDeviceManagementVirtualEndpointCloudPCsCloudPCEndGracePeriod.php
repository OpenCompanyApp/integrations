 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/endGracePeriod.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCloudPCsCloudPCEndGracePeriod extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_cloud_pcs_cloud_pc_end_grace_period';
    protected const DESCRIPTION = 'Invoke action endGracePeriod\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/endGracePeriod.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/endGracePeriod';
