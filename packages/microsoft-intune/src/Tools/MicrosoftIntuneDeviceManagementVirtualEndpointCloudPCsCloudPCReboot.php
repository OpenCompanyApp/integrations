 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/reboot.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCloudPCsCloudPCReboot extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_cloud_pcs_cloud_pc_reboot';
    protected const DESCRIPTION = 'Invoke action reboot\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/reboot.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/reboot';
