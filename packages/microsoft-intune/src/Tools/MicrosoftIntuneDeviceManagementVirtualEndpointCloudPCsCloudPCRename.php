 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/rename.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCloudPCsCloudPCRename extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_cloud_pcs_cloud_pc_rename';
    protected const DESCRIPTION = 'Invoke action rename\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/rename.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/rename';
