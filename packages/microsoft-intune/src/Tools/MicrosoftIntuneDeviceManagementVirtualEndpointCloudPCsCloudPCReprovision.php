 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/reprovision.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCloudPCsCloudPCReprovision extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_cloud_pcs_cloud_pc_reprovision';
    protected const DESCRIPTION = 'Invoke action reprovision\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/reprovision.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/reprovision';
