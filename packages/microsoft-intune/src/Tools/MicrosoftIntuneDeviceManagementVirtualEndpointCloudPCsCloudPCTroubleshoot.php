 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/troubleshoot.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCloudPCsCloudPCTroubleshoot extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_cloud_pcs_cloud_pc_troubleshoot';
    protected const DESCRIPTION = 'Invoke action troubleshoot\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/troubleshoot.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}/troubleshoot';
