 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/cloudPCs/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCloudPCsGetCount07ce extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_cloud_pcs_get_count_07ce';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/$count';
