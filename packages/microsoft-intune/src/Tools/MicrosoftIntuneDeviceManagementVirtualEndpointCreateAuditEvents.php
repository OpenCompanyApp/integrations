 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/auditEvents.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateAuditEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_audit_events';
    protected const DESCRIPTION = 'Create new navigation property to auditEvents for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/auditEvents.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/auditEvents';
