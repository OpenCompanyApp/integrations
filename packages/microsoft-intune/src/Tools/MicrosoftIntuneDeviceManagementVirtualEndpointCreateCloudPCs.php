 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/cloudPCs.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateCloudPCs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_cloud_pcs';
    protected const DESCRIPTION = 'Create new navigation property to cloudPCs for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/cloudPCs.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs';
