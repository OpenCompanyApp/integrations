 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/deviceImages.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateDeviceImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_device_images';
    protected const DESCRIPTION = 'Create cloudPcDeviceImage\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/deviceImages.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/deviceImages';
