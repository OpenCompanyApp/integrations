 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/galleryImages.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateGalleryImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_gallery_images';
    protected const DESCRIPTION = 'Create new navigation property to galleryImages for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/galleryImages.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/galleryImages';
