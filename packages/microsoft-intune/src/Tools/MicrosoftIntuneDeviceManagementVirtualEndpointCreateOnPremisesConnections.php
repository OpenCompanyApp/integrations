 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/onPremisesConnections.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateOnPremisesConnections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_on_premises_connections';
    protected const DESCRIPTION = 'Create cloudPcOnPremisesConnection\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/onPremisesConnections.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/onPremisesConnections';
