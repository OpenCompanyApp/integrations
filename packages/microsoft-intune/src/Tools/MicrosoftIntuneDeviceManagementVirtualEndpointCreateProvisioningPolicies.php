 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/provisioningPolicies.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateProvisioningPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_provisioning_policies';
    protected const DESCRIPTION = 'Create cloudPcProvisioningPolicy\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/provisioningPolicies.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/provisioningPolicies';
