 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/userSettings.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointCreateUserSettings extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_create_user_settings';
    protected const DESCRIPTION = 'Create cloudPcUserSetting\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/userSettings.';
