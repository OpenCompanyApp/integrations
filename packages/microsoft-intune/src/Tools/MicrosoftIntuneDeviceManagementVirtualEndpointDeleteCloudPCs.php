 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointDeleteCloudPCs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_delete_cloud_pcs';
    protected const DESCRIPTION = 'Delete navigation property cloudPCs for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}.';
