 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointDeleteDeviceImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_delete_device_images';
    protected const DESCRIPTION = 'Delete cloudPcDeviceImage\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage-id}.';
