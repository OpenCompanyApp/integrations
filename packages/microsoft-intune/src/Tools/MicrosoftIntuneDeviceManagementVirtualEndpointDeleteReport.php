 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /deviceManagement/virtualEndpoint/report.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointDeleteReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_delete_report';
    protected const DESCRIPTION = 'Delete navigation property report for deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /deviceManagement/virtualEndpoint/report.';
