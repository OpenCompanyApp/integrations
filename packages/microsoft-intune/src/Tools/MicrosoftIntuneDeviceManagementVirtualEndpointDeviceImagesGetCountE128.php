 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/deviceImages/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointDeviceImagesGetCountE128 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_device_images_get_count_e128';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/deviceImages/$count';
