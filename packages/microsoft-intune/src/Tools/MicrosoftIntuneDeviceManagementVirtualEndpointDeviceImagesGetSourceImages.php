 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/deviceImages/getSourceImages().
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointDeviceImagesGetSourceImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_device_images_get_source_images';
    protected const DESCRIPTION = 'Invoke function getSourceImages\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/deviceImages/getSourceImages().';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/deviceImages/getSourceImages()';
