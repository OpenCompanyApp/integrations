 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/galleryImages/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointGalleryImagesGetCountBe1a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_gallery_images_get_count_be1a';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/galleryImages/$count';
