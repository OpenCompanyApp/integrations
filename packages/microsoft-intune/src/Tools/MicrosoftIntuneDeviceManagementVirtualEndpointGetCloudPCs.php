 ...
 * Get cloudPC.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointGetCloudPCs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_get_cloud_pcs';
    protected const DESCRIPTION = 'Get cloudPC\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}.';
