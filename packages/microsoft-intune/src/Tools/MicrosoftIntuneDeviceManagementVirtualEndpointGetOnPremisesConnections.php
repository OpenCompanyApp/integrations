 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointGetOnPremisesConnections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_get_on_premises_connections';
    protected const DESCRIPTION = 'Get cloudPcOnPremisesConnection\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}.';
