 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointGetUserSettings extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_get_user_settings';
    protected const DESCRIPTION = 'Get cloudPcUserSetting\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}.';
