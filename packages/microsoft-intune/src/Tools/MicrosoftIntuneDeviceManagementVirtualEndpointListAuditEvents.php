 ...
 * List auditEvents.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/auditEvents.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointListAuditEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_list_audit_events';
    protected const DESCRIPTION = 'List auditEvents\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/auditEvents.';
