 ...
 * List cloudPCs.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/cloudPCs.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointListCloudPCs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_list_cloud_pcs';
    protected const DESCRIPTION = 'List cloudPCs\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/cloudPCs.';
