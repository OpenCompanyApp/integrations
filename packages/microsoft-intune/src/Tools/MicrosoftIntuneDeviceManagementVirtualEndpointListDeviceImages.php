 ...
 * List deviceImages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/deviceImages.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointListDeviceImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_list_device_images';
    protected const DESCRIPTION = 'List deviceImages\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/deviceImages.';
