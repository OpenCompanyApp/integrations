 ...
 * List galleryImages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/galleryImages.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointListGalleryImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_list_gallery_images';
    protected const DESCRIPTION = 'List galleryImages\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/galleryImages.';
