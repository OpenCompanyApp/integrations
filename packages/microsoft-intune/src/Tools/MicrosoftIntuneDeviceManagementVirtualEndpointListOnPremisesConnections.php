 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/onPremisesConnections.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointListOnPremisesConnections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_list_on_premises_connections';
    protected const DESCRIPTION = 'List onPremisesConnections\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/onPremisesConnections.';
