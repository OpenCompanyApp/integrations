 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/provisioningPolicies.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointListProvisioningPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_list_provisioning_policies';
    protected const DESCRIPTION = 'List provisioningPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /deviceManagement/virtualEndpoint/provisioningPolicies.';
