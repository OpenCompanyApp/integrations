 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}/updateAdDomainPassword.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointOnPremisesConnectionsCloudPcOnPremisesConnectionUpdateAdDomainPassword extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_on_premises_connections_cloud_pc_on_premises_connection_update_ad_domain_password';
    protected const DESCRIPTION = 'Invoke action updateAdDomainPassword\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}/updateAdDomainPassword.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}/updateAdDomainPassword';
