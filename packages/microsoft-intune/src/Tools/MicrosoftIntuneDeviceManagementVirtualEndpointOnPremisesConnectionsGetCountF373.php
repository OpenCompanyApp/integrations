 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/onPremisesConnections/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointOnPremisesConnectionsGetCountF373 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_on_premises_connections_get_count_f373';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/onPremisesConnections/$count';
