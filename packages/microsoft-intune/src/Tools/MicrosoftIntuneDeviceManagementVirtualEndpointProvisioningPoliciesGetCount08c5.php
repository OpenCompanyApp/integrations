 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/provisioningPolicies/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointProvisioningPoliciesGetCount08c5 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_provisioning_policies_get_count_08c5';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/provisioningPolicies/$count';
