 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/report/retrieveCloudPcRecommendationReports.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointReportRetrieveCloudPcRecommendationReports extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_report_retrieve_cloud_pc_recommendation_reports';
    protected const DESCRIPTION = 'Invoke action retrieveCloudPcRecommendationReports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /deviceManagement/virtualEndpoint/report/retrieveCloudPcRecommendationReports.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/report/retrieveCloudPcRecommendationReports';
