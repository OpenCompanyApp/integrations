 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUpdateCloudPCs extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_update_cloud_pcs';
    protected const DESCRIPTION = 'Update the navigation property cloudPCs in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC-id}';
