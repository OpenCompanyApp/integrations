 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUpdateDeviceImages extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_update_device_images';
    protected const DESCRIPTION = 'Update the navigation property deviceImages in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage-id}.';
