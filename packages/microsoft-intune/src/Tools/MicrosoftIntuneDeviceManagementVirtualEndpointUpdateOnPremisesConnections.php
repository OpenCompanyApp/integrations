 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUpdateOnPremisesConnections extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_update_on_premises_connections';
    protected const DESCRIPTION = 'Update cloudPcOnPremisesConnection\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection-id}.';
