 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/virtualEndpoint/report.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUpdateReport extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_update_report';
    protected const DESCRIPTION = 'Update the navigation property report in deviceManagement\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/virtualEndpoint/report.';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/report';
