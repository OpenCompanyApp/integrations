 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUpdateUserSettings extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_update_user_settings';
    protected const DESCRIPTION = 'Update cloudPcUserSetting\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}.';
