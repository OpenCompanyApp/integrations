 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}/assignments/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUserSettingsAssignmentsGetCountE245 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_user_settings_assignments_get_count_e245';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}/assignments/$count';
