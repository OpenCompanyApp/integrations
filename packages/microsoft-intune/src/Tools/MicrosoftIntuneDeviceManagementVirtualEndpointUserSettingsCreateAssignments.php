 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}/assignments.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUserSettingsCreateAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_user_settings_create_assignments';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}/assignments';
