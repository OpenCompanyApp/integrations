 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/userSettings/$count.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUserSettingsGetCount4aa3 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_user_settings_get_count_4aa3';
    ...
    protected const PATH = '/deviceManagement/virtualEndpoint/userSettings/$count';
