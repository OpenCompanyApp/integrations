 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting-id}/assignments.
 */
class MicrosoftIntuneDeviceManagementVirtualEndpointUserSettingsListAssignments extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_virtual_endpoint_user_settings_list_assignments';
