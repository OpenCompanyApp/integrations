 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsAutopilotDeviceIdentities/$count.
 */
class MicrosoftIntuneDeviceManagementWindowsAutopilotDeviceIdentitiesGetCount0841 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_windows_autopilot_device_identities_get_count_0841';
    ...
    protected const PATH = '/deviceManagement/windowsAutopilotDeviceIdentities/$count';
