 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsInformationProtectionAppLearningSummaries/$count.
 */
class MicrosoftIntuneDeviceManagementWindowsInformationProtectionAppLearningSummariesGetCount07af extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_windows_information_protection_app_learning_summaries_get_count_07af';
    ...
    protected const PATH = '/deviceManagement/windowsInformationProtectionAppLearningSummaries/$count';
