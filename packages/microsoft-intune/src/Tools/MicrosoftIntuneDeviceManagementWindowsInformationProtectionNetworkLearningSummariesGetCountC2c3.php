 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /deviceManagement/windowsInformationProtectionNetworkLearningSummaries/$count.
 */
class MicrosoftIntuneDeviceManagementWindowsInformationProtectionNetworkLearningSummariesGetCountC2c3 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_device_management_windows_information_protection_network_learning_summaries_get_count_c2c3';
    ...
    protected const PATH = '/deviceManagement/windowsInformationProtectionNetworkLearningSummaries/$count';
