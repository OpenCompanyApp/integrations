 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/deviceManagementTroubleshootingEvents.
 */
class MicrosoftIntuneMeCreateDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_create_device_management_troubleshooting_events';
    protected const DESCRIPTION = 'Create new navigation property to deviceManagementTroubleshootingEvents for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /me/deviceManagementTroubleshootingEvents.';
    ...
    protected const PATH = '/me/deviceManagementTroubleshootingEvents';
