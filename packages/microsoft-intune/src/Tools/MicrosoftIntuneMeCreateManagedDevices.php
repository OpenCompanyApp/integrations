 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices.
 */
class MicrosoftIntuneMeCreateManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_create_managed_devices';
    protected const DESCRIPTION = 'Create new navigation property to managedDevices for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /me/managedDevices.';
    ...
    protected const PATH = '/me/managedDevices';
