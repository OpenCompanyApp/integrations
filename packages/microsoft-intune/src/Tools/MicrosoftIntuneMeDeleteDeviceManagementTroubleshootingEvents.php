 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftIntuneMeDeleteDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_delete_device_management_troubleshooting_events';
    protected const DESCRIPTION = 'Delete navigation property deviceManagementTroubleshootingEvents for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.';
