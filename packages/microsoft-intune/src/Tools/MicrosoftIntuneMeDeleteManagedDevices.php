 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneMeDeleteManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_delete_managed_devices';
    protected const DESCRIPTION = 'Delete navigation property managedDevices for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/managedDevices/{managedDevice-id}.';
