 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/deviceManagementTroubleshootingEvents/$count.
 */
class MicrosoftIntuneMeDeviceManagementTroubleshootingEventsGetCount0d38 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_device_management_troubleshooting_events_get_count_0d38';
    ...
    protected const PATH = '/me/deviceManagementTroubleshootingEvents/$count';
