 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.
 */
class MicrosoftIntuneMeGetDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_get_device_management_troubleshooting_events';
    protected const DESCRIPTION = 'Get deviceManagementTroubleshootingEvents from me\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/deviceManagementTroubleshootingEvents/{deviceManagementTroubleshootingEvent-id}.';
