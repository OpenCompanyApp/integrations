 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/getManagedAppPolicies().
 */
class MicrosoftIntuneMeGetManagedAppPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_get_managed_app_policies';
    ...
    protected const PATH = '/me/getManagedAppPolicies()';
