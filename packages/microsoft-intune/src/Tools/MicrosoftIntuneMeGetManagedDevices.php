 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneMeGetManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_get_managed_devices';
    protected const DESCRIPTION = 'Get managedDevices from me\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/managedDevices/{managedDevice-id}.';
