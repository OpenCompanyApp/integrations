 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/deviceManagementTroubleshootingEvents.
 */
class MicrosoftIntuneMeListDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_list_device_management_troubleshooting_events';
