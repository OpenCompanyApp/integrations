 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedAppRegistrations.
 */
class MicrosoftIntuneMeListManagedAppRegistrations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_list_managed_app_registrations';
    ...
    protected const PATH = '/me/managedAppRegistrations';
