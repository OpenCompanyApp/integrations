 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices.
 */
class MicrosoftIntuneMeListManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_list_managed_devices';
