 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedAppRegistrations/$count.
 */
class MicrosoftIntuneMeManagedAppRegistrationsGetCount3124 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_app_registrations_get_count_3124';
    ...
    protected const PATH = '/me/managedAppRegistrations/$count';
