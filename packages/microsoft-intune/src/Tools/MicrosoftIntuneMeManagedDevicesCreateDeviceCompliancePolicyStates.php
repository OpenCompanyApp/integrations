 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.
 */
class MicrosoftIntuneMeManagedDevicesCreateDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_create_device_compliance_policy_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceCompliancePolicyStates for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /me/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates';
