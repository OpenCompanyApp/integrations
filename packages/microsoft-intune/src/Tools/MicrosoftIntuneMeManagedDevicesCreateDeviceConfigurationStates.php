 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/deviceConfigurationStates.
 */
class MicrosoftIntuneMeManagedDevicesCreateDeviceConfigurationStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_create_device_configuration_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceConfigurationStates for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /me/managedDevices/{managedDevice-id}/deviceConfigurationStates.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/deviceConfigurationStates';
