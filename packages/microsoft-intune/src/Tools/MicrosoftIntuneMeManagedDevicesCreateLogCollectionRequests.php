 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/logCollectionRequests.
 */
class MicrosoftIntuneMeManagedDevicesCreateLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_create_log_collection_requests';
    protected const DESCRIPTION = 'Create new navigation property to logCollectionRequests for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /me/managedDevices/{managedDevice-id}/logCollectionRequests.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/logCollectionRequests';
