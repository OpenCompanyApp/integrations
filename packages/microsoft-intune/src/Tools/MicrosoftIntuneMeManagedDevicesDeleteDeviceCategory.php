 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneMeManagedDevicesDeleteDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_delete_device_category';
    protected const DESCRIPTION = 'Delete navigation property deviceCategory for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/managedDevices/{managedDevice-id}/deviceCategory.';
