 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneMeManagedDevicesDeleteRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_delete_ref_device_category';
    protected const DESCRIPTION = 'Delete ref of navigation property deviceCategory for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
