 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneMeManagedDevicesDeleteWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_delete_windows_protection_state';
    protected const DESCRIPTION = 'Delete navigation property windowsProtectionState for me\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/managedDevices/{managedDevice-id}/windowsProtectionState.';
