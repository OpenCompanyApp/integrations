 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/deviceConfigurationStates/$count.
 */
class MicrosoftIntuneMeManagedDevicesDeviceConfigurationStatesGetCountC4ef extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_device_configuration_states_get_count_c4ef';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/deviceConfigurationStates/$count';
