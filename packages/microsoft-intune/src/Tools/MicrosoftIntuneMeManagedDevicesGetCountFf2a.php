 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/$count.
 */
class MicrosoftIntuneMeManagedDevicesGetCountFf2a extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_get_count_ff2a';
    ...
    protected const PATH = '/me/managedDevices/$count';
