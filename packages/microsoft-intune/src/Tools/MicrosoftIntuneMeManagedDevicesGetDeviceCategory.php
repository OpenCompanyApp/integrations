 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneMeManagedDevicesGetDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_get_device_category';
    protected const DESCRIPTION = 'Get deviceCategory from me\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/managedDevices/{managedDevice-id}/deviceCategory.';
