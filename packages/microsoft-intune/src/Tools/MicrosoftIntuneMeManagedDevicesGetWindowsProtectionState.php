 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneMeManagedDevicesGetWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_get_windows_protection_state';
    protected const DESCRIPTION = 'Get windowsProtectionState from me\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/managedDevices/{managedDevice-id}/windowsProtectionState.';
