 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.
 */
class MicrosoftIntuneMeManagedDevicesListDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_list_device_compliance_policy_states';
    protected const DESCRIPTION = 'Get deviceCompliancePolicyStates from me\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.';
