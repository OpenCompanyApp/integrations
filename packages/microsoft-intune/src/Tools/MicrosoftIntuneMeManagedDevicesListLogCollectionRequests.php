 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/logCollectionRequests.
 */
class MicrosoftIntuneMeManagedDevicesListLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_list_log_collection_requests';
