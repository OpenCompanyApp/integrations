 ...
 * Get users from me.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/users.
 */
class MicrosoftIntuneMeManagedDevicesListUsers extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_list_users';
    protected const DESCRIPTION = 'Get users from me\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/managedDevices/{managedDevice-id}/users.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/users';
