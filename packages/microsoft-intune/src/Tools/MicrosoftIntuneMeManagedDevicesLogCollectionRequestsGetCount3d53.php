 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/managedDevices/{managedDevice-id}/logCollectionRequests/$count.
 */
class MicrosoftIntuneMeManagedDevicesLogCollectionRequestsGetCount3d53 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_log_collection_requests_get_count_3d53';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/logCollectionRequests/$count';
