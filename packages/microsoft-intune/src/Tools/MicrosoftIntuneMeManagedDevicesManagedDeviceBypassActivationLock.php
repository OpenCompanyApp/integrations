 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/bypassActivationLock.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceBypassActivationLock extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_bypass_activation_lock';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/bypassActivationLock';
