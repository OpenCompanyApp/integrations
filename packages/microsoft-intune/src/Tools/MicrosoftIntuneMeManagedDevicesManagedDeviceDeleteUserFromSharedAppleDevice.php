 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/deleteUserFromSharedAppleDevice.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceDeleteUserFromSharedAppleDevice extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_delete_user_from_shared_apple_device';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/deleteUserFromSharedAppleDevice';
