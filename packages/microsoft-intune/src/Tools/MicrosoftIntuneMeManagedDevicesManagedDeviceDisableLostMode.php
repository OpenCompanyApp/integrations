 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/disableLostMode.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceDisableLostMode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_disable_lost_mode';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/disableLostMode';
