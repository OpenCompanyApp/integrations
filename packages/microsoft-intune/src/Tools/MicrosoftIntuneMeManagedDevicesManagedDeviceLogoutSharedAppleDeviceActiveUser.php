 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceLogoutSharedAppleDeviceActiveUser extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_logout_shared_apple_device_active_user';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser';
