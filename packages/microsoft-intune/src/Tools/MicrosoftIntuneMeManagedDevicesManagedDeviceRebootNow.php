 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/rebootNow.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceRebootNow extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_reboot_now';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/rebootNow';
