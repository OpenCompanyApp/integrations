 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/recoverPasscode.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceRecoverPasscode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_recover_passcode';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/recoverPasscode';
