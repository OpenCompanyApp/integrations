 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/requestRemoteAssistance.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceRequestRemoteAssistance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_request_remote_assistance';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/requestRemoteAssistance';
