 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/resetPasscode.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceResetPasscode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_reset_passcode';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/resetPasscode';
