 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/shutDown.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceShutDown extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_shut_down';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/shutDown';
