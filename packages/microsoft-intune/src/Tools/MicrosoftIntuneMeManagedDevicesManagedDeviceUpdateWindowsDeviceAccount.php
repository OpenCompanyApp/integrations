 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/updateWindowsDeviceAccount.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceUpdateWindowsDeviceAccount extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_update_windows_device_account';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/updateWindowsDeviceAccount';
