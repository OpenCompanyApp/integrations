 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/windowsDefenderUpdateSignatures.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceWindowsDefenderUpdateSignatures extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_windows_defender_update_signatures';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/windowsDefenderUpdateSignatures';
