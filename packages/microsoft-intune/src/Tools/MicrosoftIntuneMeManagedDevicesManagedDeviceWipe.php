 ...
 * Invoke action wipe.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/managedDevices/{managedDevice-id}/wipe.
 */
class MicrosoftIntuneMeManagedDevicesManagedDeviceWipe extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_managed_device_wipe';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/wipe';
