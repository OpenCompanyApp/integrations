 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneMeManagedDevicesUpdateDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_update_device_category';
    protected const DESCRIPTION = 'Update the navigation property deviceCategory in me\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/managedDevices/{managedDevice-id}/deviceCategory.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/deviceCategory';
