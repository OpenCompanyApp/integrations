 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/managedDevices/{managedDevice-id}/logCollectionRequests/{deviceLogCollectionResponse-id}.
 */
class MicrosoftIntuneMeManagedDevicesUpdateLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_update_log_collection_requests';
    protected const DESCRIPTION = 'Update the navigation property logCollectionRequests in me\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/managedDevices/{managedDevice-id}/logCollectionRequests/{deviceLogCollectionResponse-id}.';
