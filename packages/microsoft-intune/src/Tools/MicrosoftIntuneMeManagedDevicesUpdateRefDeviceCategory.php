 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /me/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneMeManagedDevicesUpdateRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_update_ref_device_category';
    protected const DESCRIPTION = 'Update the ref of navigation property deviceCategory in me\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /me/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/deviceCategory/$ref';
