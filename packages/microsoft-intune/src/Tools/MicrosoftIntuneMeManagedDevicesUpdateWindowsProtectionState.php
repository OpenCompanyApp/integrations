 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneMeManagedDevicesUpdateWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_managed_devices_update_windows_protection_state';
    protected const DESCRIPTION = 'Update the navigation property windowsProtectionState in me\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/managedDevices/{managedDevice-id}/windowsProtectionState.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}/windowsProtectionState';
