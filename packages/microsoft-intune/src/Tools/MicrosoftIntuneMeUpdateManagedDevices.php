 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneMeUpdateManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_update_managed_devices';
    protected const DESCRIPTION = 'Update the navigation property managedDevices in me\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/managedDevices/{managedDevice-id}.';
    ...
    protected const PATH = '/me/managedDevices/{managedDevice-id}';
