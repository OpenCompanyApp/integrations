 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/wipeManagedAppRegistrationsByDeviceTag.
 */
class MicrosoftIntuneMeWipeManagedAppRegistrationsByDeviceTag extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_me_wipe_managed_app_registrations_by_device_tag';
    ...
    protected const PATH = '/me/wipeManagedAppRegistrationsByDeviceTag';
