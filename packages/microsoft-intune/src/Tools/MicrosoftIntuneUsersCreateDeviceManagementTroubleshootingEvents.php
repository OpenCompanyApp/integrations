 ...
 */
class MicrosoftIntuneUsersCreateDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_create_device_management_troubleshooting_events';
