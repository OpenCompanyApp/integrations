 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices.
 */
class MicrosoftIntuneUsersCreateManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_create_managed_devices';
    protected const DESCRIPTION = 'Create new navigation property to managedDevices for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/managedDevices.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices';
