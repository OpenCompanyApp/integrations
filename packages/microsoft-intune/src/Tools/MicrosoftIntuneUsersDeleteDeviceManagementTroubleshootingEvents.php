 ...
 */
class MicrosoftIntuneUsersDeleteDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_delete_device_management_troubleshooting_events';
