 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneUsersDeleteManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_delete_managed_devices';
    protected const DESCRIPTION = 'Delete navigation property managedDevices for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/managedDevices/{managedDevice-id}.';
