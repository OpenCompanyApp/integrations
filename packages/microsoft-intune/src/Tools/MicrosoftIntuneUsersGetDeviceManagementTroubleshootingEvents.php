 ...
 */
class MicrosoftIntuneUsersGetDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_get_device_management_troubleshooting_events';
