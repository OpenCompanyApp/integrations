 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneUsersGetManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_get_managed_devices';
    protected const DESCRIPTION = 'Get managedDevices from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/managedDevices/{managedDevice-id}.';
