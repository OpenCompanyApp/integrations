 ...
 */
class MicrosoftIntuneUsersListDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_list_device_management_troubleshooting_events';
