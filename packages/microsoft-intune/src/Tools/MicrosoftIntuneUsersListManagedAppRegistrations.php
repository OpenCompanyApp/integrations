 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedAppRegistrations.
 */
class MicrosoftIntuneUsersListManagedAppRegistrations extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_list_managed_app_registrations';
    ...
    protected const PATH = '/users/{user-id}/managedAppRegistrations';
