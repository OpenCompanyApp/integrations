 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedAppRegistrations/$count.
 */
class MicrosoftIntuneUsersManagedAppRegistrationsGetCount9add extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_app_registrations_get_count_9add';
    ...
    protected const PATH = '/users/{user-id}/managedAppRegistrations/$count';
