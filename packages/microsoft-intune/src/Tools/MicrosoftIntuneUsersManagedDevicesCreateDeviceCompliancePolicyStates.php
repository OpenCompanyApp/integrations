 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.
 */
class MicrosoftIntuneUsersManagedDevicesCreateDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_create_device_compliance_policy_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceCompliancePolicyStates for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates';
