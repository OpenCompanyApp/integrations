 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/deviceConfigurationStates.
 */
class MicrosoftIntuneUsersManagedDevicesCreateDeviceConfigurationStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_create_device_configuration_states';
    protected const DESCRIPTION = 'Create new navigation property to deviceConfigurationStates for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/managedDevices/{managedDevice-id}/deviceConfigurationStates.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/deviceConfigurationStates';
