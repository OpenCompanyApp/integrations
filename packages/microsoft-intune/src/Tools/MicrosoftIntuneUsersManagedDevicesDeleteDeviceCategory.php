 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneUsersManagedDevicesDeleteDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_delete_device_category';
    protected const DESCRIPTION = 'Delete navigation property deviceCategory for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory.';
