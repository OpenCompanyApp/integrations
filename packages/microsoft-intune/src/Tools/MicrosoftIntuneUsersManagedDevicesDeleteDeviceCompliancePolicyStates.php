 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}.
 */
class MicrosoftIntuneUsersManagedDevicesDeleteDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_delete_device_compliance_policy_states';
    protected const DESCRIPTION = 'Delete navigation property deviceCompliancePolicyStates for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}.';
