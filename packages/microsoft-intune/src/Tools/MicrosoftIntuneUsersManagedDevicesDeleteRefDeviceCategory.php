 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneUsersManagedDevicesDeleteRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_delete_ref_device_category';
    protected const DESCRIPTION = 'Delete ref of navigation property deviceCategory for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
