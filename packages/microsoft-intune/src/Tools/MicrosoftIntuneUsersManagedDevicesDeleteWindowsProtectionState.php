 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneUsersManagedDevicesDeleteWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_delete_windows_protection_state';
    protected const DESCRIPTION = 'Delete navigation property windowsProtectionState for users\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState.';
