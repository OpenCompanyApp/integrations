 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/$count.
 */
class MicrosoftIntuneUsersManagedDevicesDeviceCompliancePolicyStatesGetCount51d2 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_device_compliance_policy_states_get_count_51d2';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/$count';
