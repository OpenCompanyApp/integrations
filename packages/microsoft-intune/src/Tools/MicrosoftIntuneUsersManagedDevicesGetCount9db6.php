 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/$count.
 */
class MicrosoftIntuneUsersManagedDevicesGetCount9db6 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_get_count_9db6';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/$count';
