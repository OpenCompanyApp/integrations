 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}.
 */
class MicrosoftIntuneUsersManagedDevicesGetDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_get_device_compliance_policy_states';
    protected const DESCRIPTION = 'Get deviceCompliancePolicyStates from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}.';
