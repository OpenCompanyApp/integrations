 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneUsersManagedDevicesGetRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_get_ref_device_category';
    protected const DESCRIPTION = 'Get ref of deviceCategory from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
