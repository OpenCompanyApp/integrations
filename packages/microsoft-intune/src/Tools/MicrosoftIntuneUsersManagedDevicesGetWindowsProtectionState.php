 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneUsersManagedDevicesGetWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_get_windows_protection_state';
    protected const DESCRIPTION = 'Get windowsProtectionState from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState.';
