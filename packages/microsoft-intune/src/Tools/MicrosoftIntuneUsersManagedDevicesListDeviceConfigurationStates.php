 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/deviceConfigurationStates.
 */
class MicrosoftIntuneUsersManagedDevicesListDeviceConfigurationStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_list_device_configuration_states';
