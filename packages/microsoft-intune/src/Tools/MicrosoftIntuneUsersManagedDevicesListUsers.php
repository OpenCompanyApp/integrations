 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/users.
 */
class MicrosoftIntuneUsersManagedDevicesListUsers extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_list_users';
    protected const DESCRIPTION = 'Get users from users\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/managedDevices/{managedDevice-id}/users.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/users';
