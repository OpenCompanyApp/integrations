 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/managedDevices/{managedDevice-id}/logCollectionRequests/$count.
 */
class MicrosoftIntuneUsersManagedDevicesLogCollectionRequestsGetCountFcd3 extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_log_collection_requests_get_count_fcd3';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/logCollectionRequests/$count';
