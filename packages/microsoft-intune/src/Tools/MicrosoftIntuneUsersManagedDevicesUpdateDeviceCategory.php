 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory.
 */
class MicrosoftIntuneUsersManagedDevicesUpdateDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_update_device_category';
    protected const DESCRIPTION = 'Update the navigation property deviceCategory in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory';
