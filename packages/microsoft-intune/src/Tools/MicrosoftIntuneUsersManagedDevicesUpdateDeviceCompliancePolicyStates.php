 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}.
 */
class MicrosoftIntuneUsersManagedDevicesUpdateDeviceCompliancePolicyStates extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_update_device_compliance_policy_states';
    protected const DESCRIPTION = 'Update the navigation property deviceCompliancePolicyStates in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState-id}';
    protected const PATH_PARAMS = ['user-id' => 'user_id', 'managedDevice-id' => 'managed_device_id', 'deviceCompliancePolicyState-id' => 'device_compliance_policy_state_id'];
