 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/managedDevices/{managedDevice-id}/logCollectionRequests/{deviceLogCollectionResponse-id}.
 */
class MicrosoftIntuneUsersManagedDevicesUpdateLogCollectionRequests extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_update_log_collection_requests';
    protected const DESCRIPTION = 'Update the navigation property logCollectionRequests in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/managedDevices/{managedDevice-id}/logCollectionRequests/{deviceLogCollectionResponse-id}.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/logCollectionRequests/{deviceLogCollectionResponse-id}';
