 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref.
 */
class MicrosoftIntuneUsersManagedDevicesUpdateRefDeviceCategory extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_update_ref_device_category';
    protected const DESCRIPTION = 'Update the ref of navigation property deviceCategory in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/deviceCategory/$ref';
