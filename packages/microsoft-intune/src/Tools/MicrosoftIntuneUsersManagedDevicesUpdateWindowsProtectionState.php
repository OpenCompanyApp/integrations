 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState.
 */
class MicrosoftIntuneUsersManagedDevicesUpdateWindowsProtectionState extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_managed_devices_update_windows_protection_state';
    protected const DESCRIPTION = 'Update the navigation property windowsProtectionState in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/windowsProtectionState';
