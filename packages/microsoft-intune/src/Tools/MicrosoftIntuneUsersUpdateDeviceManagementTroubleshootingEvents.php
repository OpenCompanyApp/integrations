 ...
 */
class MicrosoftIntuneUsersUpdateDeviceManagementTroubleshootingEvents extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_update_device_management_troubleshooting_events';
