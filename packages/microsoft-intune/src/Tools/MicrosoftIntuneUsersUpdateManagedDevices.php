 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/managedDevices/{managedDevice-id}.
 */
class MicrosoftIntuneUsersUpdateManagedDevices extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_update_managed_devices';
    protected const DESCRIPTION = 'Update the navigation property managedDevices in users\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/managedDevices/{managedDevice-id}.';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}';
