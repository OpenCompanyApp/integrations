 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/getManagedAppDiagnosticStatuses().
 */
class MicrosoftIntuneUsersUserGetManagedAppDiagnosticStatuses extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_get_managed_app_diagnostic_statuses';
    protected const DESCRIPTION = 'Invoke function getManagedAppDiagnosticStatuses\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/getManagedAppDiagnosticStatuses().';
    ...
    protected const PATH = '/users/{user-id}/getManagedAppDiagnosticStatuses()';
