 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/getManagedAppPolicies().
 */
class MicrosoftIntuneUsersUserGetManagedAppPolicies extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_get_managed_app_policies';
    protected const DESCRIPTION = 'Invoke function getManagedAppPolicies\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/getManagedAppPolicies().';
    ...
    protected const PATH = '/users/{user-id}/getManagedAppPolicies()';
