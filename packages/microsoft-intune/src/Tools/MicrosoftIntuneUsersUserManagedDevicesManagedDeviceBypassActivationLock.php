 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/bypassActivationLock.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceBypassActivationLock extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_bypass_activation_lock';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/bypassActivationLock';
