 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/disableLostMode.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceDisableLostMode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_disable_lost_mode';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/disableLostMode';
