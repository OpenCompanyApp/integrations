 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceLogoutSharedAppleDeviceActiveUser extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_logout_shared_apple_device_active_user';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/logoutSharedAppleDeviceActiveUser';
