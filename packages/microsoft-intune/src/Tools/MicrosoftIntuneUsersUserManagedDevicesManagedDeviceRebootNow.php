 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/rebootNow.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceRebootNow extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_reboot_now';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/rebootNow';
