 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/recoverPasscode.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceRecoverPasscode extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_recover_passcode';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/recoverPasscode';
