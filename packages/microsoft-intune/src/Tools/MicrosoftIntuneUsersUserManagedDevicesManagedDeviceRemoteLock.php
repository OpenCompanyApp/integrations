 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/remoteLock.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceRemoteLock extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_remote_lock';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/remoteLock';
