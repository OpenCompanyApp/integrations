 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/requestRemoteAssistance.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceRequestRemoteAssistance extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_request_remote_assistance';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/requestRemoteAssistance';
