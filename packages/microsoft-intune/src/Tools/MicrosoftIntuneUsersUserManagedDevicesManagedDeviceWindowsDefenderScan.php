 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/managedDevices/{managedDevice-id}/windowsDefenderScan.
 */
class MicrosoftIntuneUsersUserManagedDevicesManagedDeviceWindowsDefenderScan extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_managed_devices_managed_device_windows_defender_scan';
    ...
    protected const PATH = '/users/{user-id}/managedDevices/{managedDevice-id}/windowsDefenderScan';
