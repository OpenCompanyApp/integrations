 ...
 */
class MicrosoftIntuneUsersUserWipeManagedAppRegistrationsByDeviceTag extends AbstractMicrosoftIntuneTool
{
    protected const NAME = 'microsoft_intune_users_user_wipe_managed_app_registrations_by_device_tag';
