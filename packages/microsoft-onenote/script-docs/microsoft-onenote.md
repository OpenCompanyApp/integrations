...
```ruby
notebooks = app.call("integrations.microsoft-onenote.list_notebooks", top: 10)
pages = app.call("integrations.microsoft-onenote.list_onenotepages", top: 25, select: "id,title,createdDateTime")
updated = app.call("integrations.microsoft-onenote.update_page", onenote_page_id: "page-id", body: {content: "<html><body>Updated</body></html>", content_type: "text/html"})
```