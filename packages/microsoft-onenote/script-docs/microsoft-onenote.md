...
```js
var notebooks = microsoft_onenote_me_onenote_list_notebooks({ top: 10 })
var pages = microsoft_onenote_me_onenote_list_pages({ top: 25, select: "id,title,createdDateTime" })
var updated = microsoft_onenote_me_onenote_update_pages_content({
