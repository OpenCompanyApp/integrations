 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/notebooks/{notebook-id}/copyNotebook.
 */
class MicrosoftOneNoteGroupsGroupOnenoteNotebooksNotebookCopyNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_group_onenote_notebooks_notebook_copy_notebook';
    protected const DESCRIPTION = 'Invoke action copyNotebook\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/onenote/notebooks/{notebook-id}/copyNotebook.';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}/copyNotebook';
