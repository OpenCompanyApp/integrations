 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/pages/{onenotePage-id}/copyToSection.
 */
class MicrosoftOneNoteGroupsGroupOnenotePagesOnenotePageCopyToSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_group_onenote_pages_onenote_page_copy_to_section';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/{onenotePage-id}/copyToSection';
