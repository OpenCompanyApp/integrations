 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/pages/{onenotePage-id}/onenotePatchContent.
 */
class MicrosoftOneNoteGroupsGroupOnenotePagesOnenotePageOnenotePatchContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_group_onenote_pages_onenote_page_onenote_patch_content';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/{onenotePage-id}/onenotePatchContent';
