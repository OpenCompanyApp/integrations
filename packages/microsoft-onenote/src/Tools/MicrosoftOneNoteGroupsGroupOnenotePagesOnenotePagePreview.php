 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/pages/{onenotePage-id}/preview().
 */
class MicrosoftOneNoteGroupsGroupOnenotePagesOnenotePagePreview extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_group_onenote_pages_onenote_page_preview';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/{onenotePage-id}/preview()';
