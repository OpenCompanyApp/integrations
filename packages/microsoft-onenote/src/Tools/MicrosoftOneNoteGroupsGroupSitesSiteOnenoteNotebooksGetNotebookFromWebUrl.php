 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/sites/{site-id}/onenote/notebooks/getNotebookFromWebUrl.
 */
class MicrosoftOneNoteGroupsGroupSitesSiteOnenoteNotebooksGetNotebookFromWebUrl extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_group_sites_site_onenote_notebooks_get_notebook_from_web_url';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/notebooks/getNotebookFromWebUrl';
