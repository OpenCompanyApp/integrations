 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/preview().
 */
class MicrosoftOneNoteGroupsGroupSitesSiteOnenoteNotebooksNotebookSectionsOnenoteSectionPagesOnenotePagePreview extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_group_sites_site_onenote_notebooks_notebook_sections_onenote_section_pages_onenote_page_preview';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/preview()';
