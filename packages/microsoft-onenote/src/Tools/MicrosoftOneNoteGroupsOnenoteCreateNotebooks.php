 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/notebooks.
 */
class MicrosoftOneNoteGroupsOnenoteCreateNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_create_notebooks';
    protected const DESCRIPTION = 'Create new navigation property to notebooks for groups\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/onenote/notebooks.';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks';
