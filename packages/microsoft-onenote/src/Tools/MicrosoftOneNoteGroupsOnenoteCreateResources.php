 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/resources.
 */
class MicrosoftOneNoteGroupsOnenoteCreateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_create_resources';
    ...
    protected const PATH = '/groups/{group-id}/onenote/resources';
