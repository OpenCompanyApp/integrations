 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/sectionGroups.
 */
class MicrosoftOneNoteGroupsOnenoteCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_create_section_groups';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sectionGroups';
