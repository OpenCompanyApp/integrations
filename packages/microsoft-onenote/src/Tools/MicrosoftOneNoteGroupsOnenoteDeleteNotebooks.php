 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteGroupsOnenoteDeleteNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_delete_notebooks';
    protected const DESCRIPTION = 'Delete navigation property notebooks for groups\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /groups/{group-id}/onenote/notebooks/{notebook-id}.';
