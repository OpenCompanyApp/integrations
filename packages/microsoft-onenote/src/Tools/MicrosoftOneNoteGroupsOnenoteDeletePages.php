 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/onenote/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteGroupsOnenoteDeletePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_delete_pages';
