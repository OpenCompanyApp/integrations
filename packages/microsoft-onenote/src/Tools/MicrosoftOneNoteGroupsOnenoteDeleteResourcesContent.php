 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteGroupsOnenoteDeleteResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_delete_resources_content';
