 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteGroupsOnenoteGetPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_get_pages';
