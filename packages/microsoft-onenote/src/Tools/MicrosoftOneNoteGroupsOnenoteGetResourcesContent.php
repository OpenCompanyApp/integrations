 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteGroupsOnenoteGetResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_get_resources_content';
