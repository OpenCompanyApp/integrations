 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteGroupsOnenoteGetSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_get_section_groups';
