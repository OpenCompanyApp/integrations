 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sections.
 */
class MicrosoftOneNoteGroupsOnenoteListSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_list_sections';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sections';
