 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_create_section_groups';
    protected const DESCRIPTION = 'Create new navigation property to sectionGroups for groups\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups.';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups';
    protected const PATH_PARAMS = ['group-id' => 'group_id', 'notebook-id' => 'notebook_id'];
