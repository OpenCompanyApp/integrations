 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/notebooks/$count.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksGetCount4d2a extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_get_count_4d2a';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/$count';
