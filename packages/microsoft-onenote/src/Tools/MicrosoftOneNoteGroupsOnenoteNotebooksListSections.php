 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/notebooks/{notebook-id}/sections.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksListSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_list_sections';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections';
