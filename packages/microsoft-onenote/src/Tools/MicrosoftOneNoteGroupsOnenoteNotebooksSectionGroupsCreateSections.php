 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksSectionGroupsCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_section_groups_create_sections';
