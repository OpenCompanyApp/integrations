 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentNotebook.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksSectionGroupsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_section_groups_get_parent_notebook';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/parentNotebook';
    protected const PATH_PARAMS = ['group-id' => 'group_id', 'notebook-id' => 'notebook_id', 'sectionGroup-id' => 'section_group_id'];
