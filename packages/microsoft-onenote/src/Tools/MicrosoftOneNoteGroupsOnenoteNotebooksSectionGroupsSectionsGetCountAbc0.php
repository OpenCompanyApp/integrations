 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/$count.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksSectionGroupsSectionsGetCountAbc0 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_section_groups_sections_get_count_abc0';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/$count';
