 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/notebooks/{notebook-id}/sections/$count.
 */
class MicrosoftOneNoteGroupsOnenoteNotebooksSectionsGetCount8678 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_notebooks_sections_get_count_8678';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}/sections/$count';
