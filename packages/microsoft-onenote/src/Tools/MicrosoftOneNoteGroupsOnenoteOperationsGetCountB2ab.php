 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/operations/$count.
 */
class MicrosoftOneNoteGroupsOnenoteOperationsGetCountB2ab extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_operations_get_count_b2ab';
    ...
    protected const PATH = '/groups/{group-id}/onenote/operations/$count';
