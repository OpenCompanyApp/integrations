 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/pages/$count.
 */
class MicrosoftOneNoteGroupsOnenotePagesGetCount8bf6 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_pages_get_count_8bf6';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/$count';
