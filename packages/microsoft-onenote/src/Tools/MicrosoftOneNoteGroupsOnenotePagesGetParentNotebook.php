 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook.
 */
class MicrosoftOneNoteGroupsOnenotePagesGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_pages_get_parent_notebook';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentNotebook';
