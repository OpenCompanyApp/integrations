 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection.
 */
class MicrosoftOneNoteGroupsOnenotePagesGetParentSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_pages_get_parent_section';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/{onenotePage-id}/parentSection';
