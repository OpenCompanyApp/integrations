 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/resources/$count.
 */
class MicrosoftOneNoteGroupsOnenoteResourcesGetCountB07f extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_resources_get_count_b07f';
    ...
    protected const PATH = '/groups/{group-id}/onenote/resources/$count';
