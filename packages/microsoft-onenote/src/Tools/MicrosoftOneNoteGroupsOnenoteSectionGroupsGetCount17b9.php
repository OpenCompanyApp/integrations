 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sectionGroups/$count.
 */
class MicrosoftOneNoteGroupsOnenoteSectionGroupsGetCount17b9 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_section_groups_get_count_17b9';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sectionGroups/$count';
