 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook.
 */
class MicrosoftOneNoteGroupsOnenoteSectionGroupsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_section_groups_get_parent_notebook';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentNotebook';
