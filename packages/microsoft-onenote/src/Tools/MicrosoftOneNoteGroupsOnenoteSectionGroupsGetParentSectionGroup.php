 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentSectionGroup.
 */
class MicrosoftOneNoteGroupsOnenoteSectionGroupsGetParentSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_section_groups_get_parent_section_group';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/parentSectionGroup';
