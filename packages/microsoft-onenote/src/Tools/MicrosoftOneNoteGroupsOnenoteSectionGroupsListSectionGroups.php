 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sectionGroups.
 */
class MicrosoftOneNoteGroupsOnenoteSectionGroupsListSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_section_groups_list_section_groups';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sectionGroups';
