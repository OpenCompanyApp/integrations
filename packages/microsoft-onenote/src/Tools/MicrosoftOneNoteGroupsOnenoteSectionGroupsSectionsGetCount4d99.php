 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/$count.
 */
class MicrosoftOneNoteGroupsOnenoteSectionGroupsSectionsGetCount4d99 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_section_groups_sections_get_count_4d99';
    ...
    protected const PATH = '/groups/{group-id}/onenote/sectionGroups/{sectionGroup-id}/sections/$count';
