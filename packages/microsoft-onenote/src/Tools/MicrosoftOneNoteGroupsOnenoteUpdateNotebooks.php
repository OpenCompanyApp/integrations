 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteGroupsOnenoteUpdateNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_update_notebooks';
    protected const DESCRIPTION = 'Update the navigation property notebooks in groups\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /groups/{group-id}/onenote/notebooks/{notebook-id}.';
    ...
    protected const PATH = '/groups/{group-id}/onenote/notebooks/{notebook-id}';
