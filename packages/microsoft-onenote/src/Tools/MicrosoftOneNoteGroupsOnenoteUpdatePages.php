 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/onenote/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteGroupsOnenoteUpdatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_update_pages';
    ...
    protected const PATH = '/groups/{group-id}/onenote/pages/{onenotePage-id}';
