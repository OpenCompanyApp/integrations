 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /groups/{group-id}/onenote/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteGroupsOnenoteUpdatePagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_update_pages_content';
