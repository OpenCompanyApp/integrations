 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteGroupsOnenoteUpdateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_onenote_update_resources';
