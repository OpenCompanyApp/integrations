 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/sites/{site-id}/onenote.
 */
class MicrosoftOneNoteGroupsSitesDeleteOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_delete_onenote';
