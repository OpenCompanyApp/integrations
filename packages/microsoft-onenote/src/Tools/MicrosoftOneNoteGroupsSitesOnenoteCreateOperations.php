 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/sites/{site-id}/onenote/operations.
 */
class MicrosoftOneNoteGroupsSitesOnenoteCreateOperations extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for groups\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/sites/{site-id}/onenote/operations.';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/operations';
