 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/sites/{site-id}/onenote/pages.
 */
class MicrosoftOneNoteGroupsSitesOnenoteCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_create_pages';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/pages';
