 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/sites/{site-id}/onenote/resources.
 */
class MicrosoftOneNoteGroupsSitesOnenoteCreateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_create_resources';
    protected const DESCRIPTION = 'Create new navigation property to resources for groups\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/sites/{site-id}/onenote/resources.';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/resources';
