 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/sites/{site-id}/onenote/sectionGroups.
 */
class MicrosoftOneNoteGroupsSitesOnenoteCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_create_section_groups';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/sectionGroups';
