 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteDeleteNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_delete_notebooks';
