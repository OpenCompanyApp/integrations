 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteDeleteResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_delete_resources';
    protected const DESCRIPTION = 'Delete navigation property resources for groups\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}.';
