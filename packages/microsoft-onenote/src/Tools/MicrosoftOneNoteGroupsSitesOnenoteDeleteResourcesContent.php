 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteGroupsSitesOnenoteDeleteResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_delete_resources_content';
    protected const DESCRIPTION = 'Delete content for the navigation property resources in groups\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}/content.';
