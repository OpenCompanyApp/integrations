 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteDeleteSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_delete_section_groups';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}';
