 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteGetResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_get_resources';
