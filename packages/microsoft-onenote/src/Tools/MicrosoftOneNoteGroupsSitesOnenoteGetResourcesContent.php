 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteGroupsSitesOnenoteGetResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_get_resources_content';
    protected const DESCRIPTION = 'Get content for the navigation property resources from groups\n\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}/content.';
