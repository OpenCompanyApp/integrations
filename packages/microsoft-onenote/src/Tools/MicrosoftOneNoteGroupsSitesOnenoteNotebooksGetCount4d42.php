 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/notebooks/$count.
 */
class MicrosoftOneNoteGroupsSitesOnenoteNotebooksGetCount4d42 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_notebooks_get_count_4d42';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/notebooks/$count';
