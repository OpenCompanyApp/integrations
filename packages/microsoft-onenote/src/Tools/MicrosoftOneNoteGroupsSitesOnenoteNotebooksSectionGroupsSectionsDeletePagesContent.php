 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteGroupsSitesOnenoteNotebooksSectionGroupsSectionsDeletePagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_notebooks_section_groups_sections_delete_pages_content';
