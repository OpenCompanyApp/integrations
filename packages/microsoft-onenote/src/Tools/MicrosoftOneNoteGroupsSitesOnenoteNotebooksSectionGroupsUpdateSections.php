 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteNotebooksSectionGroupsUpdateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_notebooks_section_groups_update_sections';
