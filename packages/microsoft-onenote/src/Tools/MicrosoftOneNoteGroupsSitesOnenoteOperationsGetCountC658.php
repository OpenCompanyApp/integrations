 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/operations/$count.
 */
class MicrosoftOneNoteGroupsSitesOnenoteOperationsGetCountC658 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_operations_get_count_c658';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/operations/$count';
