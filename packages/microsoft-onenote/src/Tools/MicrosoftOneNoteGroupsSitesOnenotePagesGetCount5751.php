 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/pages/$count.
 */
class MicrosoftOneNoteGroupsSitesOnenotePagesGetCount5751 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_pages_get_count_5751';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/pages/$count';
