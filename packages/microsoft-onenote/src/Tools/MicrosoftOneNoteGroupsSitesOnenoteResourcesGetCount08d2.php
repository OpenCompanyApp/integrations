 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/resources/$count.
 */
class MicrosoftOneNoteGroupsSitesOnenoteResourcesGetCount08d2 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_resources_get_count_08d2';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/resources/$count';
