 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages.
 */
class MicrosoftOneNoteGroupsSitesOnenoteSectionsCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_sections_create_pages';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages';
