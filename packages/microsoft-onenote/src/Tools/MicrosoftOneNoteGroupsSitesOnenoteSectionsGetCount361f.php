 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/sections/$count.
 */
class MicrosoftOneNoteGroupsSitesOnenoteSectionsGetCount361f extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_sections_get_count_361f';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/sections/$count';
