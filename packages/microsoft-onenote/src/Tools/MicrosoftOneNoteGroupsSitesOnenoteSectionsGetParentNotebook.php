 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook.
 */
class MicrosoftOneNoteGroupsSitesOnenoteSectionsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_sections_get_parent_notebook';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentNotebook';
