 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteUpdateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_update_resources';
    protected const DESCRIPTION = 'Update the navigation property resources in groups\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}.';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote/resources/{onenoteResource-id}';
