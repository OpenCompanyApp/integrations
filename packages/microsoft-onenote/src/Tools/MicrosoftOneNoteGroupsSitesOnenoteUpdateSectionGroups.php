 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteGroupsSitesOnenoteUpdateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_onenote_update_section_groups';
