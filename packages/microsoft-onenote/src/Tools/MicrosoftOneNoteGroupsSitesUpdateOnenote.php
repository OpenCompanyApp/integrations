 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/sites/{site-id}/onenote.
 */
class MicrosoftOneNoteGroupsSitesUpdateOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_sites_update_onenote';
    ...
    protected const PATH = '/groups/{group-id}/sites/{site-id}/onenote';
