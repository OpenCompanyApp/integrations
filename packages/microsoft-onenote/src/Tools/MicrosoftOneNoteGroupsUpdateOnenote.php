 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/onenote.
 */
class MicrosoftOneNoteGroupsUpdateOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_groups_update_onenote';
    ...
    protected const PATH = '/groups/{group-id}/onenote';
