 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote.
 */
class MicrosoftOneNoteMeDeleteOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_delete_onenote';
    protected const DESCRIPTION = 'Delete navigation property onenote for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/onenote.';
