 ...
 * Get onenote from me.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote.
 */
class MicrosoftOneNoteMeGetOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_get_onenote';
    protected const DESCRIPTION = 'Get onenote from me\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote.';
    ...
    protected const PATH = '/me/onenote';
