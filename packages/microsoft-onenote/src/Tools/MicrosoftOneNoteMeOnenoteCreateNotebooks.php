 ...
 * Create notebook.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/notebooks.
 */
class MicrosoftOneNoteMeOnenoteCreateNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_create_notebooks';
    protected const DESCRIPTION = 'Create notebook\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/notebooks.';
    ...
    protected const PATH = '/me/onenote/notebooks';
