 ...
 * Create onenotePage.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/pages.
 */
class MicrosoftOneNoteMeOnenoteCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_create_pages';
    protected const DESCRIPTION = 'Create onenotePage\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/pages.';
    ...
    protected const PATH = '/me/onenote/pages';
