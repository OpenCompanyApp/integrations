 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/resources.
 */
class MicrosoftOneNoteMeOnenoteCreateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_create_resources';
    protected const DESCRIPTION = 'Create new navigation property to resources for me\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/resources.';
    ...
    protected const PATH = '/me/onenote/resources';
