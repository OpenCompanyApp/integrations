 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sectionGroups.
 */
class MicrosoftOneNoteMeOnenoteCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_create_section_groups';
    protected const DESCRIPTION = 'Create new navigation property to sectionGroups for me\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/sectionGroups.';
    ...
    protected const PATH = '/me/onenote/sectionGroups';
