 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sections.
 */
class MicrosoftOneNoteMeOnenoteCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_create_sections';
    ...
    protected const PATH = '/me/onenote/sections';
