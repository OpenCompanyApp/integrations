 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteMeOnenoteDeleteNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_delete_notebooks';
    protected const DESCRIPTION = 'Delete navigation property notebooks for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/onenote/notebooks/{notebook-id}.';
