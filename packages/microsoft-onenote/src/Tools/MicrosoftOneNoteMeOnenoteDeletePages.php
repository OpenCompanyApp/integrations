 ...
 * Delete page.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteMeOnenoteDeletePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_delete_pages';
    protected const DESCRIPTION = 'Delete page\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/onenote/pages/{onenotePage-id}.';
    ...
    protected const PATH = '/me/onenote/pages/{onenotePage-id}';
