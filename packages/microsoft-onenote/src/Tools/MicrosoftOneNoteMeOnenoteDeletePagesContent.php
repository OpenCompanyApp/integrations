 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteMeOnenoteDeletePagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_delete_pages_content';
