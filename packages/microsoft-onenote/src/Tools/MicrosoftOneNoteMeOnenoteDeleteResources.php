 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteMeOnenoteDeleteResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_delete_resources';
    protected const DESCRIPTION = 'Delete navigation property resources for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/onenote/resources/{onenoteResource-id}.';
