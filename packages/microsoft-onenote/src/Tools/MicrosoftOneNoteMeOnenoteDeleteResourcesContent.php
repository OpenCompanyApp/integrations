 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteMeOnenoteDeleteResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_delete_resources_content';
    protected const DESCRIPTION = 'Delete content for the navigation property resources in me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/onenote/resources/{onenoteResource-id}/content.';
    ...
    protected const PATH = '/me/onenote/resources/{onenoteResource-id}/content';
