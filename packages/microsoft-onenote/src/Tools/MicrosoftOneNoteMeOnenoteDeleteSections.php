 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteMeOnenoteDeleteSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_delete_sections';
