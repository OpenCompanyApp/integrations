 ...
 * Get notebook.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteMeOnenoteGetNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_get_notebooks';
    protected const DESCRIPTION = 'Get notebook\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/notebooks/{notebook-id}.';
