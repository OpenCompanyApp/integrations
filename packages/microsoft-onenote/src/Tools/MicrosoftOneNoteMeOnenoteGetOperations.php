 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/operations/{onenoteOperation-id}.
 */
class MicrosoftOneNoteMeOnenoteGetOperations extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_get_operations';
