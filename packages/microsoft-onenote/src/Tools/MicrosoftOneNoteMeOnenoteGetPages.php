 ...
 * Get page.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteMeOnenoteGetPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_get_pages';
    protected const DESCRIPTION = 'Get page\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/pages/{onenotePage-id}.';
