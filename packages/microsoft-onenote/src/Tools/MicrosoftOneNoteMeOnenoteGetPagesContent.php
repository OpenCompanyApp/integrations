 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteMeOnenoteGetPagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_get_pages_content';
    ...
    protected const PATH = '/me/onenote/pages/{onenotePage-id}/content';
