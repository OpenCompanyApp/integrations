 ...
 * Get resource.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteMeOnenoteGetResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_get_resources_content';
    protected const DESCRIPTION = 'Get resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/resources/{onenoteResource-id}/content.';
