 ...
 * List notebooks.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks.
 */
class MicrosoftOneNoteMeOnenoteListNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_list_notebooks';
    protected const DESCRIPTION = 'List notebooks\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/notebooks.';
