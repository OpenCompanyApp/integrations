 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/operations.
 */
class MicrosoftOneNoteMeOnenoteListOperations extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_list_operations';
    protected const DESCRIPTION = 'Get onenoteOperation\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/operations.';
    ...
    protected const PATH = '/me/onenote/operations';
