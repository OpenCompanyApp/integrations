 ...
 * List onenotePages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/pages.
 */
class MicrosoftOneNoteMeOnenoteListPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_list_pages';
    protected const DESCRIPTION = 'List onenotePages\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/pages.';
