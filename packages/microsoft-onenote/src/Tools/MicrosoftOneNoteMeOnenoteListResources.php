 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/resources.
 */
class MicrosoftOneNoteMeOnenoteListResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_list_resources';
