 ...
 * List sectionGroups.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sectionGroups.
 */
class MicrosoftOneNoteMeOnenoteListSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_list_section_groups';
