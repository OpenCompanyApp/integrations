 ...
 * List sections.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections.
 */
class MicrosoftOneNoteMeOnenoteListSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_list_sections';
