 ...
 * Create sectionGroup.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/notebooks/{notebook-id}/sectionGroups.
 */
class MicrosoftOneNoteMeOnenoteNotebooksCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_create_section_groups';
    protected const DESCRIPTION = 'Create sectionGroup\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/notebooks/{notebook-id}/sectionGroups.';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/sectionGroups';
