 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteMeOnenoteNotebooksDeleteSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_delete_sections';
