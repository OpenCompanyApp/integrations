 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/$count.
 */
class MicrosoftOneNoteMeOnenoteNotebooksGetCount6c1a extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_get_count_6c1a';
    ...
    protected const PATH = '/me/onenote/notebooks/$count';
