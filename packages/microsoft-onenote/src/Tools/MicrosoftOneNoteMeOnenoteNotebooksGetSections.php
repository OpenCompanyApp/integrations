 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteMeOnenoteNotebooksGetSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_get_sections';
