 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/notebooks/{notebook-id}/copyNotebook.
 */
class MicrosoftOneNoteMeOnenoteNotebooksNotebookCopyNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_notebook_copy_notebook';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/copyNotebook';
