 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections.
 */
class MicrosoftOneNoteMeOnenoteNotebooksSectionGroupsCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_section_groups_create_sections';
    protected const DESCRIPTION = 'Create new navigation property to sections for me\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections.';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections';
    protected const PATH_PARAMS = ['notebook-id' => 'notebook_id', 'sectionGroup-id' => 'section_group_id'];
