 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections.
 */
class MicrosoftOneNoteMeOnenoteNotebooksSectionGroupsListSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_section_groups_list_sections';
    protected const DESCRIPTION = 'Get sections from me\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections.';
