 ...
 * Get pages from me.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteMeOnenoteNotebooksSectionGroupsSectionsGetPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_section_groups_sections_get_pages';
