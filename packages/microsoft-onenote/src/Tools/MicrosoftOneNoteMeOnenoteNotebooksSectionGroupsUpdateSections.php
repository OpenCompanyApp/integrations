 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteMeOnenoteNotebooksSectionGroupsUpdateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_section_groups_update_sections';
    protected const DESCRIPTION = 'Update the navigation property sections in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}.';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}';
