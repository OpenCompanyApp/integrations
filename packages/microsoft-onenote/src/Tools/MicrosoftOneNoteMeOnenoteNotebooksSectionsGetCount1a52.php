 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/{notebook-id}/sections/$count.
 */
class MicrosoftOneNoteMeOnenoteNotebooksSectionsGetCount1a52 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_sections_get_count_1a52';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/sections/$count';
