 ...
 * Get pages from me.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages.
 */
class MicrosoftOneNoteMeOnenoteNotebooksSectionsListPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_sections_list_pages';
