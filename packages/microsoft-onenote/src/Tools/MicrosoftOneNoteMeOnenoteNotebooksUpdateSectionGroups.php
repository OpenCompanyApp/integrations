 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteMeOnenoteNotebooksUpdateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_update_section_groups';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}';
