 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteMeOnenoteNotebooksUpdateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_notebooks_update_sections';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}';
