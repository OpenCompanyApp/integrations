 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/operations/$count.
 */
class MicrosoftOneNoteMeOnenoteOperationsGetCount7b8c extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_operations_get_count_7b8c';
    ...
    protected const PATH = '/me/onenote/operations/$count';
