 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/pages/{onenotePage-id}/parentNotebook.
 */
class MicrosoftOneNoteMeOnenotePagesGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_pages_get_parent_notebook';
    ...
    protected const PATH = '/me/onenote/pages/{onenotePage-id}/parentNotebook';
