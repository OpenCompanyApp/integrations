 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/pages/{onenotePage-id}/parentSection.
 */
class MicrosoftOneNoteMeOnenotePagesGetParentSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_pages_get_parent_section';
    ...
    protected const PATH = '/me/onenote/pages/{onenotePage-id}/parentSection';
