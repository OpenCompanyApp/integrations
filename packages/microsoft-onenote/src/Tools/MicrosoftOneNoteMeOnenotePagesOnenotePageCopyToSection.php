 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/pages/{onenotePage-id}/copyToSection.
 */
class MicrosoftOneNoteMeOnenotePagesOnenotePageCopyToSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_pages_onenote_page_copy_to_section';
    ...
    protected const PATH = '/me/onenote/pages/{onenotePage-id}/copyToSection';
