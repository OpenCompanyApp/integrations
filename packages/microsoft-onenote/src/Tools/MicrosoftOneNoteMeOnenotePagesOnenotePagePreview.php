 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/pages/{onenotePage-id}/preview().
 */
class MicrosoftOneNoteMeOnenotePagesOnenotePagePreview extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_pages_onenote_page_preview';
    ...
    protected const PATH = '/me/onenote/pages/{onenotePage-id}/preview()';
