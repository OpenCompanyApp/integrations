 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/resources/$count.
 */
class MicrosoftOneNoteMeOnenoteResourcesGetCountD3f1 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_resources_get_count_d3f1';
    ...
    protected const PATH = '/me/onenote/resources/$count';
