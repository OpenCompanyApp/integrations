 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sectionGroups/$count.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsGetCountE635 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_get_count_e635';
    ...
    protected const PATH = '/me/onenote/sectionGroups/$count';
