 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/copyToNotebook.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionGroupSectionsOnenoteSectionCopyToNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_section_group_sections_onenote_section_copy_to_notebook';
    ...
    protected const PATH = '/me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/copyToNotebook';
