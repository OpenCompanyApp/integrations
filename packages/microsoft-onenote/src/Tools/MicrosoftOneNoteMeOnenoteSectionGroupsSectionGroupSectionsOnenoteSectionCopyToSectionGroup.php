 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/copyToSectionGroup.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionGroupSectionsOnenoteSectionCopyToSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_section_group_sections_onenote_section_copy_to_section_group';
    ...
    protected const PATH = '/me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/copyToSectionGroup';
