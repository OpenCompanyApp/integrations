 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/preview().
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionGroupSectionsOnenoteSectionPagesOnenotePagePreview extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_section_group_sections_onenote_section_pages_onenote_page_preview';
    ...
    protected const PATH = '/me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/preview()';
