 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_sections_get_parent_notebook';
    ...
    protected const PATH = '/me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook';
