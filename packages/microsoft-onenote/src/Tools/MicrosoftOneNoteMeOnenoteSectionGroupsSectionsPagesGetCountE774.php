 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/$count.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionsPagesGetCountE774 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_sections_pages_get_count_e774';
    ...
    protected const PATH = '/me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/$count';
