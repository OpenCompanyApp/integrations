 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionsUpdatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_sections_update_pages';
