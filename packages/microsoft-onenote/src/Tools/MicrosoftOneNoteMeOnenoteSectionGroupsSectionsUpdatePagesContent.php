 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /me/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteMeOnenoteSectionGroupsSectionsUpdatePagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_section_groups_sections_update_pages_content';
