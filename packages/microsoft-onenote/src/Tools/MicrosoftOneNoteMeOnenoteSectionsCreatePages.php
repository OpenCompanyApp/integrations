 ...
 * Create page.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sections/{onenoteSection-id}/pages.
 */
class MicrosoftOneNoteMeOnenoteSectionsCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_create_pages';
    protected const DESCRIPTION = 'Create page\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/onenote/sections/{onenoteSection-id}/pages.';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/pages';
