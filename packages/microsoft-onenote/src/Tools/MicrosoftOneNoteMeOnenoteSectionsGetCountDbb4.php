 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections/$count.
 */
class MicrosoftOneNoteMeOnenoteSectionsGetCountDbb4 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_get_count_dbb4';
    ...
    protected const PATH = '/me/onenote/sections/$count';
