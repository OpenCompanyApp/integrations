 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteMeOnenoteSectionsGetPagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_get_pages_content';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content';
