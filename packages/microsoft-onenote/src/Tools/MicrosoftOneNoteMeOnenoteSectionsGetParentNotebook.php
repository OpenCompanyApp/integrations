 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections/{onenoteSection-id}/parentNotebook.
 */
class MicrosoftOneNoteMeOnenoteSectionsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_get_parent_notebook';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/parentNotebook';
