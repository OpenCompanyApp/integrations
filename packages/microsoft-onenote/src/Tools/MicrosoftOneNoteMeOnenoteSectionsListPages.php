 ...
 * List pages.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections/{onenoteSection-id}/pages.
 */
class MicrosoftOneNoteMeOnenoteSectionsListPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_list_pages';
    protected const DESCRIPTION = 'List pages\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/onenote/sections/{onenoteSection-id}/pages.';
