 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sections/{onenoteSection-id}/copyToNotebook.
 */
class MicrosoftOneNoteMeOnenoteSectionsOnenoteSectionCopyToNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_onenote_section_copy_to_notebook';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/copyToNotebook';
