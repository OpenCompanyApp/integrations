 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sections/{onenoteSection-id}/copyToSectionGroup.
 */
class MicrosoftOneNoteMeOnenoteSectionsOnenoteSectionCopyToSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_onenote_section_copy_to_section_group';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/copyToSectionGroup';
