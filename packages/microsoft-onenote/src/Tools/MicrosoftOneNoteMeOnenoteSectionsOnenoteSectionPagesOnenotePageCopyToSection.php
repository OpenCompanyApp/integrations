 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/copyToSection.
 */
class MicrosoftOneNoteMeOnenoteSectionsOnenoteSectionPagesOnenotePageCopyToSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_onenote_section_pages_onenote_page_copy_to_section';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/copyToSection';
