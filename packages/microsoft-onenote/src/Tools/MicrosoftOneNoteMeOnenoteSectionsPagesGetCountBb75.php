 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections/{onenoteSection-id}/pages/$count.
 */
class MicrosoftOneNoteMeOnenoteSectionsPagesGetCountBb75 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_pages_get_count_bb75';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/pages/$count';
