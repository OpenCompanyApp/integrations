 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection.
 */
class MicrosoftOneNoteMeOnenoteSectionsPagesGetParentSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_pages_get_parent_section';
    ...
    protected const PATH = '/me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/parentSection';
