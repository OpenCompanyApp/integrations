 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteMeOnenoteSectionsUpdatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_sections_update_pages';
