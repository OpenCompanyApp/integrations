 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteMeOnenoteUpdateNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_update_notebooks';
    protected const DESCRIPTION = 'Update the navigation property notebooks in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/onenote/notebooks/{notebook-id}.';
    ...
    protected const PATH = '/me/onenote/notebooks/{notebook-id}';
