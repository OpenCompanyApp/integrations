 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteMeOnenoteUpdatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_update_pages';
