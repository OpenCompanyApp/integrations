 ...
 * Update page.
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /me/onenote/pages/{onenotePage-id}/content.
 */
class MicrosoftOneNoteMeOnenoteUpdatePagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_update_pages_content';
    protected const DESCRIPTION = 'Update page\n\nOfficial Microsoft Graph v1.0 endpoint: PUT /me/onenote/pages/{onenotePage-id}/content.';
