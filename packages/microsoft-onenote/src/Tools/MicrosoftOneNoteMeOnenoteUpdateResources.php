 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteMeOnenoteUpdateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_update_resources';
    protected const DESCRIPTION = 'Update the navigation property resources in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/onenote/resources/{onenoteResource-id}.';
