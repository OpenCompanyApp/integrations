 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /me/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteMeOnenoteUpdateResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_update_resources_content';
    protected const DESCRIPTION = 'Update content for the navigation property resources in me\n\nOfficial Microsoft Graph v1.0 endpoint: PUT /me/onenote/resources/{onenoteResource-id}/content.';
