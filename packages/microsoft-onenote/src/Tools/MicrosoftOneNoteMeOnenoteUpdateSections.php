 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteMeOnenoteUpdateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_onenote_update_sections';
