 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/onenote.
 */
class MicrosoftOneNoteMeUpdateOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_me_update_onenote';
    protected const DESCRIPTION = 'Update the navigation property onenote in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/onenote.';
