 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/getByPath(path='{path}')/onenote.
 */
class MicrosoftOneNoteSitesGetByPathDeleteOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_get_by_path_delete_onenote';
