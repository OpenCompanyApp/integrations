 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/getByPath(path='{path}')/onenote.
 */
class MicrosoftOneNoteSitesGetByPathGetOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_get_by_path_get_onenote';
