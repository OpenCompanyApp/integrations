 ...
 */
class MicrosoftOneNoteSitesOnenoteCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_create_section_groups';
