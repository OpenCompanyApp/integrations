 ...
 */
class MicrosoftOneNoteSitesOnenoteCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_create_sections';
