 ...
 */
class MicrosoftOneNoteSitesOnenoteDeleteNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_delete_notebooks';
