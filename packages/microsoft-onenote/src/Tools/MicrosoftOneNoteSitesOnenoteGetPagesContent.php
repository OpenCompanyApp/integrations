 ...
 */
class MicrosoftOneNoteSitesOnenoteGetPagesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_get_pages_content';
