 ...
 */
class MicrosoftOneNoteSitesOnenoteListOperations extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_list_operations';
