 ...
 */
class MicrosoftOneNoteSitesOnenoteListSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_list_section_groups';
