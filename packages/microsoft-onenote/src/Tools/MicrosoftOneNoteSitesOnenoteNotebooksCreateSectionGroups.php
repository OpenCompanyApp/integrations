 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_create_section_groups';
