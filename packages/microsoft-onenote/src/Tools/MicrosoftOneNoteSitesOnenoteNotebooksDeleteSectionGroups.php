 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksDeleteSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_delete_section_groups';
