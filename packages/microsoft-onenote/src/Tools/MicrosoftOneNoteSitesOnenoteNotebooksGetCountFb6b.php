 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksGetCountFb6b extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_get_count_fb6b';
