 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksListSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_list_sections';
