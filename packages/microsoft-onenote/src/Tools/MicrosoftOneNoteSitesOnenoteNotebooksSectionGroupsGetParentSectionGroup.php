 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksSectionGroupsGetParentSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_section_groups_get_parent_section_group';
