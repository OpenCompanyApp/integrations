 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksSectionGroupsSectionsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_section_groups_sections_get_parent_notebook';
