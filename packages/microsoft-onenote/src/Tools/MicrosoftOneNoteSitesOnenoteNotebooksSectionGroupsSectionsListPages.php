 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksSectionGroupsSectionsListPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_section_groups_sections_list_pages';
