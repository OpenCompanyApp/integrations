 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksSectionsCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_sections_create_pages';
