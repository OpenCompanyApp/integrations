 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksSectionsGetPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_sections_get_pages';
