 ...
 */
class MicrosoftOneNoteSitesOnenoteNotebooksSectionsPagesGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_notebooks_sections_pages_get_parent_notebook';
