 ...
 */
class MicrosoftOneNoteSitesOnenoteOperationsGetCountEadd extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_operations_get_count_eadd';
