 ...
 */
class MicrosoftOneNoteSitesOnenotePagesGetCountBfb1 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_pages_get_count_bfb1';
