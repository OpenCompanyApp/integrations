 ...
 */
class MicrosoftOneNoteSitesOnenotePagesGetParentSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_pages_get_parent_section';
