 ...
 */
class MicrosoftOneNoteSitesOnenoteSectionGroupsSectionsPagesGetParentSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_section_groups_sections_pages_get_parent_section';
