 ...
 */
class MicrosoftOneNoteSitesOnenoteSectionsCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_sections_create_pages';
