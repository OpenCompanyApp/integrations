 ...
 */
class MicrosoftOneNoteSitesOnenoteSectionsPagesGetCountA33a extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_sections_pages_get_count_a33a';
