 ...
 */
class MicrosoftOneNoteSitesOnenoteUpdateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_onenote_update_sections';
