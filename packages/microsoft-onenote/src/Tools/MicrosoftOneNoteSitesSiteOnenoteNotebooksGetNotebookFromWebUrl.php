 ...
 */
class MicrosoftOneNoteSitesSiteOnenoteNotebooksGetNotebookFromWebUrl extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_site_onenote_notebooks_get_notebook_from_web_url';
