 ...
 */
class MicrosoftOneNoteSitesSiteOnenoteNotebooksNotebookCopyNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_site_onenote_notebooks_notebook_copy_notebook';
