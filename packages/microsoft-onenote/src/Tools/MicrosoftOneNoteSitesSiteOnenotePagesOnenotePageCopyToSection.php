 ...
 */
class MicrosoftOneNoteSitesSiteOnenotePagesOnenotePageCopyToSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_site_onenote_pages_onenote_page_copy_to_section';
