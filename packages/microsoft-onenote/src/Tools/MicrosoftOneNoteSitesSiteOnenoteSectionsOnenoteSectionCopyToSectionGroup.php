 ...
 */
class MicrosoftOneNoteSitesSiteOnenoteSectionsOnenoteSectionCopyToSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_sites_site_onenote_sections_onenote_section_copy_to_section_group';
