 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote.
 */
class MicrosoftOneNoteUsersGetOnenote extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_get_onenote';
    protected const DESCRIPTION = 'Get onenote from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/onenote.';
