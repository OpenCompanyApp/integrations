 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks.
 */
class MicrosoftOneNoteUsersOnenoteCreateNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_create_notebooks';
    protected const DESCRIPTION = 'Create new navigation property to notebooks for users\n\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/onenote/notebooks.';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks';
