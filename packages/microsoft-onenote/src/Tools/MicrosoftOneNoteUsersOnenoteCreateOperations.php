 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/operations.
 */
class MicrosoftOneNoteUsersOnenoteCreateOperations extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_create_operations';
    ...
    protected const PATH = '/users/{user-id}/onenote/operations';
