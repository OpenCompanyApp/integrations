 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/resources.
 */
class MicrosoftOneNoteUsersOnenoteCreateResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_create_resources';
    protected const DESCRIPTION = 'Create new navigation property to resources for users\n\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/onenote/resources.';
    ...
    protected const PATH = '/users/{user-id}/onenote/resources';
