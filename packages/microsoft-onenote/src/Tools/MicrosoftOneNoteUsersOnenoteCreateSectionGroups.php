 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/sectionGroups.
 */
class MicrosoftOneNoteUsersOnenoteCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_create_section_groups';
    ...
    protected const PATH = '/users/{user-id}/onenote/sectionGroups';
