 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/sections.
 */
class MicrosoftOneNoteUsersOnenoteCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_create_sections';
    ...
    protected const PATH = '/users/{user-id}/onenote/sections';
