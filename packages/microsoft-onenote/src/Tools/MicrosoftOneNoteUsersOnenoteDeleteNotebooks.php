 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteUsersOnenoteDeleteNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_delete_notebooks';
    protected const DESCRIPTION = 'Delete navigation property notebooks for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/onenote/notebooks/{notebook-id}.';
