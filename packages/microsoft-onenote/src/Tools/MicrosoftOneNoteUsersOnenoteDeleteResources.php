 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteUsersOnenoteDeleteResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_delete_resources';
    protected const DESCRIPTION = 'Delete navigation property resources for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/onenote/resources/{onenoteResource-id}.';
