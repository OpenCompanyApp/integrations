 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteUsersOnenoteDeleteResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_delete_resources_content';
    protected const DESCRIPTION = 'Delete content for the navigation property resources in users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/onenote/resources/{onenoteResource-id}/content.';
