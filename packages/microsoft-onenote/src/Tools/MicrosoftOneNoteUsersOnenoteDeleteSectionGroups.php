 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteUsersOnenoteDeleteSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_delete_section_groups';
