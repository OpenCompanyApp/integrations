 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteUsersOnenoteGetNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_get_notebooks';
    protected const DESCRIPTION = 'Get notebooks from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/onenote/notebooks/{notebook-id}.';
