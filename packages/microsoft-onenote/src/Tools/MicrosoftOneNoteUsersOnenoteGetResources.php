 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/resources/{onenoteResource-id}.
 */
class MicrosoftOneNoteUsersOnenoteGetResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_get_resources';
