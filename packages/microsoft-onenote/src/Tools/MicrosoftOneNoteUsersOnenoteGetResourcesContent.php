 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/resources/{onenoteResource-id}/content.
 */
class MicrosoftOneNoteUsersOnenoteGetResourcesContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_get_resources_content';
    protected const DESCRIPTION = 'Get content for the navigation property resources from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/onenote/resources/{onenoteResource-id}/content.';
