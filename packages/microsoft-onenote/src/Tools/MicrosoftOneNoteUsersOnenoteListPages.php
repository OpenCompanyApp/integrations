 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/pages.
 */
class MicrosoftOneNoteUsersOnenoteListPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_list_pages';
    ...
    protected const PATH = '/users/{user-id}/onenote/pages';
