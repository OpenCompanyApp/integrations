 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/resources.
 */
class MicrosoftOneNoteUsersOnenoteListResources extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_list_resources';
    protected const DESCRIPTION = 'Get resources from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/onenote/resources.';
