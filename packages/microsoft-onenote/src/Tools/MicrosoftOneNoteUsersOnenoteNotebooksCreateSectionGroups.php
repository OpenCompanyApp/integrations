 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksCreateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_create_section_groups';
    protected const DESCRIPTION = 'Create new navigation property to sectionGroups for users\n\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups.';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups';
    protected const PATH_PARAMS = ['user-id' => 'user_id', 'notebook-id' => 'notebook_id'];
