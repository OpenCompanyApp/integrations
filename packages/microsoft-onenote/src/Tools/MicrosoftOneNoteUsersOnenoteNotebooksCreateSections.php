 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks/{notebook-id}/sections.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_create_sections';
    protected const DESCRIPTION = 'Create new navigation property to sections for users\n\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/onenote/notebooks/{notebook-id}/sections.';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sections';
