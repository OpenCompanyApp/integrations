 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksDeleteSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_delete_section_groups';
    protected const DESCRIPTION = 'Delete navigation property sectionGroups for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}.';
