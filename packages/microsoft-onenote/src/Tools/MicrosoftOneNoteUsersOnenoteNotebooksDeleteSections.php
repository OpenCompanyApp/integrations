 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksDeleteSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_delete_sections';
