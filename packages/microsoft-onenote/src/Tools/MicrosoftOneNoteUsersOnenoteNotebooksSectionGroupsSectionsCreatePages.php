 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksSectionGroupsSectionsCreatePages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_section_groups_sections_create_pages';
