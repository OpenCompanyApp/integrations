 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksSectionGroupsSectionsGetParentNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_section_groups_sections_get_parent_notebook';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/parentNotebook';
