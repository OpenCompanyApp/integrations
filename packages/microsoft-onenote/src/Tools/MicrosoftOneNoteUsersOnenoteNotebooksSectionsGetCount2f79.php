 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/notebooks/{notebook-id}/sections/$count.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksSectionsGetCount2f79 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_sections_get_count_2f79';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sections/$count';
