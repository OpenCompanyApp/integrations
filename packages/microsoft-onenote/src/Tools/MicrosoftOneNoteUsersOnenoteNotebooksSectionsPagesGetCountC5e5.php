 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/$count.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksSectionsPagesGetCountC5e5 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_sections_pages_get_count_c5e5';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/pages/$count';
