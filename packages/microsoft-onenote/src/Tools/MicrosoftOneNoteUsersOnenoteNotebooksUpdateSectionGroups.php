 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}.
 */
class MicrosoftOneNoteUsersOnenoteNotebooksUpdateSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_notebooks_update_section_groups';
    protected const DESCRIPTION = 'Update the navigation property sectionGroups in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}.';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}';
