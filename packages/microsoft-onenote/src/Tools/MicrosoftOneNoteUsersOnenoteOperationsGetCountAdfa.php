 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/operations/$count.
 */
class MicrosoftOneNoteUsersOnenoteOperationsGetCountAdfa extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_operations_get_count_adfa';
    ...
    protected const PATH = '/users/{user-id}/onenote/operations/$count';
