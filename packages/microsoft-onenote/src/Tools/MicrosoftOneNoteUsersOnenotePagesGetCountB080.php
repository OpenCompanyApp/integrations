 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/pages/$count.
 */
class MicrosoftOneNoteUsersOnenotePagesGetCountB080 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_pages_get_count_b080';
    ...
    protected const PATH = '/users/{user-id}/onenote/pages/$count';
