 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/resources/$count.
 */
class MicrosoftOneNoteUsersOnenoteResourcesGetCountDba6 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_resources_get_count_dba6';
    ...
    protected const PATH = '/users/{user-id}/onenote/resources/$count';
