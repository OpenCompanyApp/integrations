 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections.
 */
class MicrosoftOneNoteUsersOnenoteSectionGroupsCreateSections extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_section_groups_create_sections';
