 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/parentSectionGroup.
 */
class MicrosoftOneNoteUsersOnenoteSectionGroupsGetParentSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_section_groups_get_parent_section_group';
    ...
    protected const PATH = '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/parentSectionGroup';
