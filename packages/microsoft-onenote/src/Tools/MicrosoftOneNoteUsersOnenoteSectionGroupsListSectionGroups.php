 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sectionGroups.
 */
class MicrosoftOneNoteUsersOnenoteSectionGroupsListSectionGroups extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_section_groups_list_section_groups';
    ...
    protected const PATH = '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sectionGroups';
