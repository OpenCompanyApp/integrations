 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sectionGroups/$count.
 */
class MicrosoftOneNoteUsersOnenoteSectionGroupsSectionGroupsGetCount497a extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_section_groups_section_groups_get_count_497a';
    ...
    protected const PATH = '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sectionGroups/$count';
