 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/$count.
 */
class MicrosoftOneNoteUsersOnenoteSectionGroupsSectionsGetCount6826 extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_section_groups_sections_get_count_6826';
    ...
    protected const PATH = '/users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/$count';
