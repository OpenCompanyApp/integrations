 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/sections/$count.
 */
class MicrosoftOneNoteUsersOnenoteSectionsGetCount8b0b extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_sections_get_count_8b0b';
    ...
    protected const PATH = '/users/{user-id}/onenote/sections/$count';
