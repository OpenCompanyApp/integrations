 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}.
 */
class MicrosoftOneNoteUsersOnenoteSectionsGetPages extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_sections_get_pages';
