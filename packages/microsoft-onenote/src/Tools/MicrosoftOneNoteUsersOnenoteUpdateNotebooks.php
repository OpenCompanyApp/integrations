 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftOneNoteUsersOnenoteUpdateNotebooks extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_onenote_update_notebooks';
    protected const DESCRIPTION = 'Update the navigation property notebooks in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/onenote/notebooks/{notebook-id}.';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}';
