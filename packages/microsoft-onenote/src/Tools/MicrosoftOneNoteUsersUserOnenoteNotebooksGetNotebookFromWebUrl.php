 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks/getNotebookFromWebUrl.
 */
class MicrosoftOneNoteUsersUserOnenoteNotebooksGetNotebookFromWebUrl extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_user_onenote_notebooks_get_notebook_from_web_url';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/getNotebookFromWebUrl';
