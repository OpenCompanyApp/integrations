 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks/{notebook-id}/copyNotebook.
 */
class MicrosoftOneNoteUsersUserOnenoteNotebooksNotebookCopyNotebook extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_user_onenote_notebooks_notebook_copy_notebook';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/copyNotebook';
