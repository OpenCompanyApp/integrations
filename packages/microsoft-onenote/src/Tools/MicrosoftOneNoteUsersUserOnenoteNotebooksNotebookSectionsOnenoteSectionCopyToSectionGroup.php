 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/copyToSectionGroup.
 */
class MicrosoftOneNoteUsersUserOnenoteNotebooksNotebookSectionsOnenoteSectionCopyToSectionGroup extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_user_onenote_notebooks_notebook_sections_onenote_section_copy_to_section_group';
    ...
    protected const PATH = '/users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/copyToSectionGroup';
