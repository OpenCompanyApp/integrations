 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/copyToSection.
 */
class MicrosoftOneNoteUsersUserOnenoteSectionsOnenoteSectionPagesOnenotePageCopyToSection extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_user_onenote_sections_onenote_section_pages_onenote_page_copy_to_section';
    ...
    protected const PATH = '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/copyToSection';
