 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/onenotePatchContent.
 */
class MicrosoftOneNoteUsersUserOnenoteSectionsOnenoteSectionPagesOnenotePageOnenotePatchContent extends AbstractMicrosoftOneNoteTool
{
    protected const NAME = 'microsoft_onenote_users_user_onenote_sections_onenote_section_pages_onenote_page_onenote_patch_content';
    ...
    protected const PATH = '/users/{user-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/onenotePatchContent';
