 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people.
 */
class MicrosoftPeopleAdminGetPeople extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_get_people';
    protected const DESCRIPTION = 'Get peopleAdminSettings\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people.';
    ...
    protected const PATH = '/admin/people';
