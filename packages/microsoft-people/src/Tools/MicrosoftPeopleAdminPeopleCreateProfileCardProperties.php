 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /admin/people/profileCardProperties.
 */
class MicrosoftPeopleAdminPeopleCreateProfileCardProperties extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_create_profile_card_properties';
    protected const DESCRIPTION = 'Create profileCardProperty\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /admin/people/profileCardProperties.';
    ...
    protected const PATH = '/admin/people/profileCardProperties';
