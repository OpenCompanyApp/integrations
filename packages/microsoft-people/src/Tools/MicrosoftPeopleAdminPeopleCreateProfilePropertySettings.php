 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /admin/people/profilePropertySettings.
 */
class MicrosoftPeopleAdminPeopleCreateProfilePropertySettings extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_create_profile_property_settings';
    protected const DESCRIPTION = 'Create profilePropertySetting\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /admin/people/profilePropertySettings.';
    ...
    protected const PATH = '/admin/people/profilePropertySettings';
