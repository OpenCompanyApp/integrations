 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /admin/people/profileSources.
 */
class MicrosoftPeopleAdminPeopleCreateProfileSources extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_create_profile_sources';
    protected const DESCRIPTION = 'Create profileSource\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /admin/people/profileSources.';
    ...
    protected const PATH = '/admin/people/profileSources';
