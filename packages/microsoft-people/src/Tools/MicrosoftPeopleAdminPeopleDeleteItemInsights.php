 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /admin/people/itemInsights.
 */
class MicrosoftPeopleAdminPeopleDeleteItemInsights extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_delete_item_insights';
    protected const DESCRIPTION = 'Delete navigation property itemInsights for admin\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /admin/people/itemInsights.';
    ...
    protected const PATH = '/admin/people/itemInsights';
