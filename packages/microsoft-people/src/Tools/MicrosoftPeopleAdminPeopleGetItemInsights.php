 ...
 * List itemInsights.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/itemInsights.
 */
class MicrosoftPeopleAdminPeopleGetItemInsights extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_get_item_insights';
    protected const DESCRIPTION = 'List itemInsights\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/itemInsights.';
