 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profileCardProperties/{profileCardProperty-id}.
 */
class MicrosoftPeopleAdminPeopleGetProfileCardProperties extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_get_profile_card_properties';
    protected const DESCRIPTION = 'Get profileCardProperty\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/profileCardProperties/{profileCardProperty-id}.';
