 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profilePropertySettings/{profilePropertySetting-id}.
 */
class MicrosoftPeopleAdminPeopleGetProfilePropertySettings extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_get_profile_property_settings';
    protected const DESCRIPTION = 'Get profilePropertySetting\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/profilePropertySettings/{profilePropertySetting-id}.';
