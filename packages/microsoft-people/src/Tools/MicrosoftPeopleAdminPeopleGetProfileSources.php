 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profileSources/{profileSource-id}.
 */
class MicrosoftPeopleAdminPeopleGetProfileSources extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_get_profile_sources';
