 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/pronouns.
 */
class MicrosoftPeopleAdminPeopleGetPronouns extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_get_pronouns';
    protected const DESCRIPTION = 'List pronounsSettings\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/pronouns.';
