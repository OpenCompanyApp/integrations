 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profileCardProperties.
 */
class MicrosoftPeopleAdminPeopleListProfileCardProperties extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_list_profile_card_properties';
    protected const DESCRIPTION = 'List profileCardProperties\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/profileCardProperties.';
