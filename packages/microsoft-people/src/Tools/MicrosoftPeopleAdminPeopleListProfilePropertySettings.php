 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profilePropertySettings.
 */
class MicrosoftPeopleAdminPeopleListProfilePropertySettings extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_list_profile_property_settings';
    protected const DESCRIPTION = 'List profilePropertySettings\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/profilePropertySettings.';
