 ...
 * List profileSources.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profileSources.
 */
class MicrosoftPeopleAdminPeopleListProfileSources extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_list_profile_sources';
    protected const DESCRIPTION = 'List profileSources\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /admin/people/profileSources.';
