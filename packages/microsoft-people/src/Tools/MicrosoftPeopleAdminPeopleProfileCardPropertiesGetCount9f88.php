 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profileCardProperties/$count.
 */
class MicrosoftPeopleAdminPeopleProfileCardPropertiesGetCount9f88 extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_profile_card_properties_get_count_9f88';
    ...
    protected const PATH = '/admin/people/profileCardProperties/$count';
