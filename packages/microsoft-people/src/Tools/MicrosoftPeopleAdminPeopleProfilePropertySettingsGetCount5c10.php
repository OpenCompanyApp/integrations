 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profilePropertySettings/$count.
 */
class MicrosoftPeopleAdminPeopleProfilePropertySettingsGetCount5c10 extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_profile_property_settings_get_count_5c10';
    ...
    protected const PATH = '/admin/people/profilePropertySettings/$count';
