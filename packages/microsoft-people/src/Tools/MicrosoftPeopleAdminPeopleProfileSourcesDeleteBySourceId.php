 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /admin/people/profileSources(sourceId='{sourceId}').
 */
class MicrosoftPeopleAdminPeopleProfileSourcesDeleteBySourceId extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_profile_sources_delete_by_source_id';
