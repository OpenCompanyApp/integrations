 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /admin/people/profileSources/$count.
 */
class MicrosoftPeopleAdminPeopleProfileSourcesGetCountE997 extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_profile_sources_get_count_e997';
    ...
    protected const PATH = '/admin/people/profileSources/$count';
