 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /admin/people/profileSources(sourceId='{sourceId}').
 */
class MicrosoftPeopleAdminPeopleProfileSourcesUpdateBySourceId extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_profile_sources_update_by_source_id';
