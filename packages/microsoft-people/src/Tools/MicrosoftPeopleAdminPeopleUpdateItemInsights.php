 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /admin/people/itemInsights.
 */
class MicrosoftPeopleAdminPeopleUpdateItemInsights extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_update_item_insights';
    protected const DESCRIPTION = 'Update insightsSettings\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /admin/people/itemInsights.';
