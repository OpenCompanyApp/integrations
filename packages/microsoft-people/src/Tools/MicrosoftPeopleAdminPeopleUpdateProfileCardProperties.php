 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /admin/people/profileCardProperties/{profileCardProperty-id}.
 */
class MicrosoftPeopleAdminPeopleUpdateProfileCardProperties extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_update_profile_card_properties';
    protected const DESCRIPTION = 'Update profileCardProperty\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /admin/people/profileCardProperties/{profileCardProperty-id}.';
