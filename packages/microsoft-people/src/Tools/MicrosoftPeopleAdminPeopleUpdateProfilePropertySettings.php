 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /admin/people/profilePropertySettings/{profilePropertySetting-id}.
 */
class MicrosoftPeopleAdminPeopleUpdateProfilePropertySettings extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_update_profile_property_settings';
    protected const DESCRIPTION = 'Update profilePropertySetting\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /admin/people/profilePropertySettings/{profilePropertySetting-id}.';
