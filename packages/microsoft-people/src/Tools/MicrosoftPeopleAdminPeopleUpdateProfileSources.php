 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /admin/people/profileSources/{profileSource-id}.
 */
class MicrosoftPeopleAdminPeopleUpdateProfileSources extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_update_profile_sources';
    protected const DESCRIPTION = 'Update profileSource\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /admin/people/profileSources/{profileSource-id}.';
