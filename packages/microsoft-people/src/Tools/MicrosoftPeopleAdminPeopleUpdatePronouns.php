 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /admin/people/pronouns.
 */
class MicrosoftPeopleAdminPeopleUpdatePronouns extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_admin_people_update_pronouns';
    protected const DESCRIPTION = 'Update pronounsSettings\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /admin/people/pronouns.';
    ...
    protected const PATH = '/admin/people/pronouns';
