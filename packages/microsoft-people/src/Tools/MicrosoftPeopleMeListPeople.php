 ...
 * List people.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/people.
 */
class MicrosoftPeopleMeListPeople extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_me_list_people';
    protected const DESCRIPTION = 'List people\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /me/people.';
    ...
    protected const PATH = '/me/people';
