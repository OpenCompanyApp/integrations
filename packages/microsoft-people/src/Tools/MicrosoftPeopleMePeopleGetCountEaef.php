 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/people/$count.
 */
class MicrosoftPeopleMePeopleGetCountEaef extends AbstractMicrosoftPeopleTool
{
    protected const NAME = 'microsoft_people_me_people_get_count_eaef';
    ...
    protected const PATH = '/me/people/$count';
