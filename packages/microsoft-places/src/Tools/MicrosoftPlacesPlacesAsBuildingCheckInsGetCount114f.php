 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsBuildingCheckInsGetCount114f extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_check_ins_get_count_114f';
    ...
    protected const PATH = '/places/{place-id}/graph.building/checkIns/$count';
