 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.building/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsBuildingDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_delete_check_ins';
