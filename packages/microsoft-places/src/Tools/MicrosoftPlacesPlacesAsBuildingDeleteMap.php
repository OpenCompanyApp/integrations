 ...
 * Delete buildingMap.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.building/map.
 */
class MicrosoftPlacesPlacesAsBuildingDeleteMap extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_delete_map';
    protected const DESCRIPTION = 'Delete buildingMap\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}/graph.building/map.';
