 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsBuildingGetCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_get_check_ins';
