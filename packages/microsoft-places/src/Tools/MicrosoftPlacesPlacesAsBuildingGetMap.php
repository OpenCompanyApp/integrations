 ...
 * Get buildingMap.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map.
 */
class MicrosoftPlacesPlacesAsBuildingGetMap extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_get_map';
    protected const DESCRIPTION = 'Get buildingMap\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map.';
