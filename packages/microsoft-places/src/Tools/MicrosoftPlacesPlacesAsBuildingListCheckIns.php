 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/checkIns.
 */
class MicrosoftPlacesPlacesAsBuildingListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_list_check_ins';
