 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.building/map/footprints.
 */
class MicrosoftPlacesPlacesAsBuildingMapCreateFootprints extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_create_footprints';
    protected const DESCRIPTION = 'Create new navigation property to footprints for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.building/map/footprints.';
