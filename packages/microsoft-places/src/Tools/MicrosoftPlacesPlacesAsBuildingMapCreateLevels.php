 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.building/map/levels.
 */
class MicrosoftPlacesPlacesAsBuildingMapCreateLevels extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_create_levels';
    protected const DESCRIPTION = 'Create new navigation property to levels for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.building/map/levels.';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels';
