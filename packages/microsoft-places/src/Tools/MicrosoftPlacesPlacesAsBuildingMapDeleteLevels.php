 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.building/map/levels/{levelMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapDeleteLevels extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_delete_levels';
    protected const DESCRIPTION = 'Delete navigation property levels for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}/graph.building/map/levels/{levelMap-id}.';
