 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/footprints/$count.
 */
class MicrosoftPlacesPlacesAsBuildingMapFootprintsGetCount273d extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_footprints_get_count_273d';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/footprints/$count';
