 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/footprints/{footprintMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapGetFootprints extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_get_footprints';
    protected const DESCRIPTION = 'Get footprints from places\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map/footprints/{footprintMap-id}.';
