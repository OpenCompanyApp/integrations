 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapGetLevels extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_get_levels';
    protected const DESCRIPTION = 'Get levels from places\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map/levels/{levelMap-id}.';
