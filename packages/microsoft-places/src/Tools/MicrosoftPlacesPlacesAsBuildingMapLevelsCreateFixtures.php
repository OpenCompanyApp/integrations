 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsCreateFixtures extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_create_fixtures';
    protected const DESCRIPTION = 'Create new navigation property to fixtures for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures.';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures';
    protected const PATH_PARAMS = ['place-id' => 'place_id', 'levelMap-id' => 'level_map_id'];
