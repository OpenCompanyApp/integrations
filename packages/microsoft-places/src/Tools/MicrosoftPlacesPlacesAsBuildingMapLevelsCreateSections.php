 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.building/map/levels/{levelMap-id}/sections.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsCreateSections extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_create_sections';
    protected const DESCRIPTION = 'Create new navigation property to sections for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.building/map/levels/{levelMap-id}/sections.';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}/sections';
