 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.building/map/levels/{levelMap-id}/units.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsCreateUnits extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_create_units';
    protected const DESCRIPTION = 'Create new navigation property to units for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.building/map/levels/{levelMap-id}/units.';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}/units';
