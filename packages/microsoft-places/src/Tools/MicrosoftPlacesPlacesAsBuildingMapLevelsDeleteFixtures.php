 ...
 * Delete fixtureMap.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/{fixtureMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsDeleteFixtures extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_delete_fixtures';
    protected const DESCRIPTION = 'Delete fixtureMap\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/{fixtureMap-id}.';
