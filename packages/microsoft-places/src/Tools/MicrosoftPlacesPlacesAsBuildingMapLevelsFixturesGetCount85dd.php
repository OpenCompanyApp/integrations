 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/$count.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsFixturesGetCount85dd extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_fixtures_get_count_85dd';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/$count';
