 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/$count.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsGetCount292f extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_get_count_292f';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/$count';
