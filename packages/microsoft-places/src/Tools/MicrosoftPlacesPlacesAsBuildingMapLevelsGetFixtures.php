 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/{fixtureMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsGetFixtures extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_get_fixtures';
    protected const DESCRIPTION = 'Get fixtures from places\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures/{fixtureMap-id}.';
