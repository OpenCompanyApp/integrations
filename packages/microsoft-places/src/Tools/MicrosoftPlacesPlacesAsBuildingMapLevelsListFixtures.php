 ...
 * List fixtures.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsListFixtures extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_list_fixtures';
    protected const DESCRIPTION = 'List fixtures\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/fixtures.';
