 ...
 * List sections.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/sections.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsListSections extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_list_sections';
