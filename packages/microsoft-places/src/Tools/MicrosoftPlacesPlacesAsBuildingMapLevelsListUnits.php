 ...
 * List units.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/units.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsListUnits extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_list_units';
    protected const DESCRIPTION = 'List units\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/units.';
