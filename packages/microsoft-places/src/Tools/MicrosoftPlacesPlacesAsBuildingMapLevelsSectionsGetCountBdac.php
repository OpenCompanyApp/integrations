 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/sections/$count.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsSectionsGetCountBdac extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_sections_get_count_bdac';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}/sections/$count';
