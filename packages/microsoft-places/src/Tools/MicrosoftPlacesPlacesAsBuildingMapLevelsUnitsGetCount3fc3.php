 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels/{levelMap-id}/units/$count.
 */
class MicrosoftPlacesPlacesAsBuildingMapLevelsUnitsGetCount3fc3 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_levels_units_get_count_3fc3';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}/units/$count';
