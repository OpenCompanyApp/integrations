 ...
 * List levels.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building/map/levels.
 */
class MicrosoftPlacesPlacesAsBuildingMapListLevels extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_list_levels';
    protected const DESCRIPTION = 'List levels\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.building/map/levels.';
