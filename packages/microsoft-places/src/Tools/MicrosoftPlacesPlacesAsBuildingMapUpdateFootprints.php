 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.building/map/footprints/{footprintMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapUpdateFootprints extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_update_footprints';
    protected const DESCRIPTION = 'Update the navigation property footprints in places\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /places/{place-id}/graph.building/map/footprints/{footprintMap-id}.';
