 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.building/map/levels/{levelMap-id}.
 */
class MicrosoftPlacesPlacesAsBuildingMapUpdateLevels extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_map_update_levels';
    protected const DESCRIPTION = 'Update the navigation property levels in places\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /places/{place-id}/graph.building/map/levels/{levelMap-id}.';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map/levels/{levelMap-id}';
