 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.building/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsBuildingUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.building/checkIns/{checkInClaim-calendarEventId}';
