 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.building/map.
 */
class MicrosoftPlacesPlacesAsBuildingUpdateMap extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_building_update_map';
    protected const DESCRIPTION = 'Update the navigation property map in places\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /places/{place-id}/graph.building/map.';
    ...
    protected const PATH = '/places/{place-id}/graph.building/map';
