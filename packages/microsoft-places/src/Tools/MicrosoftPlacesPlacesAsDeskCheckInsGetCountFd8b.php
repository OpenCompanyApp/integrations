 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.desk/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsDeskCheckInsGetCountFd8b extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_desk_check_ins_get_count_fd8b';
    ...
    protected const PATH = '/places/{place-id}/graph.desk/checkIns/$count';
