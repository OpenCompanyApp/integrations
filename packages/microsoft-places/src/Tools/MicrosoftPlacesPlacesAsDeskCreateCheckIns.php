 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.desk/checkIns.
 */
class MicrosoftPlacesPlacesAsDeskCreateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_desk_create_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.desk/checkIns';
