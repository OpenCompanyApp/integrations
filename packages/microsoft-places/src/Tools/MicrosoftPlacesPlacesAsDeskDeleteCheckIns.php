 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.desk/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsDeskDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_desk_delete_check_ins';
