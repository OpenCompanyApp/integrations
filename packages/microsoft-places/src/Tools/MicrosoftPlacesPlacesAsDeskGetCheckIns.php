 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.desk/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsDeskGetCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_desk_get_check_ins';
