 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.desk/checkIns.
 */
class MicrosoftPlacesPlacesAsDeskListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_desk_list_check_ins';
