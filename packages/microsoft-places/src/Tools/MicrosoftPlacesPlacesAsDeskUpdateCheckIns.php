 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.desk/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsDeskUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_desk_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.desk/checkIns/{checkInClaim-calendarEventId}';
