 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.floor/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsFloorCheckInsGetCountE279 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_floor_check_ins_get_count_e279';
    ...
    protected const PATH = '/places/{place-id}/graph.floor/checkIns/$count';
