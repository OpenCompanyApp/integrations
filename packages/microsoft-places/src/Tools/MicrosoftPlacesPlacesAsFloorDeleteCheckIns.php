 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.floor/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsFloorDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_floor_delete_check_ins';
