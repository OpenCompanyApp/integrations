 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.floor/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsFloorGetCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_floor_get_check_ins';
