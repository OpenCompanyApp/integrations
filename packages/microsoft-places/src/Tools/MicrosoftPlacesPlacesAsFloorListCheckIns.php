 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.floor/checkIns.
 */
class MicrosoftPlacesPlacesAsFloorListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_floor_list_check_ins';
