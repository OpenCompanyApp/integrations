 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.floor/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsFloorUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_floor_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.floor/checkIns/{checkInClaim-calendarEventId}';
