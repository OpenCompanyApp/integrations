 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.room/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsRoomCheckInsGetCount9b19 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_check_ins_get_count_9b19';
    ...
    protected const PATH = '/places/{place-id}/graph.room/checkIns/$count';
