 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.room/checkIns.
 */
class MicrosoftPlacesPlacesAsRoomCreateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_create_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.room/checkIns';
