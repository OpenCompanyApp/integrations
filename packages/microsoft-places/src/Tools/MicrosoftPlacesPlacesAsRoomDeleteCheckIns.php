 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.room/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsRoomDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_delete_check_ins';
