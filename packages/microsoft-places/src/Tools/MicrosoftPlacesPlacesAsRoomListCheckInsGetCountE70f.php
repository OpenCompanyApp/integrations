 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsRoomListCheckInsGetCountE70f extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_check_ins_get_count_e70f';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/checkIns/$count';
