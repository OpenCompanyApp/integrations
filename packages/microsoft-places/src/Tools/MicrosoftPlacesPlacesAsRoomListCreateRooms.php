 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.roomList/rooms.
 */
class MicrosoftPlacesPlacesAsRoomListCreateRooms extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_create_rooms';
    protected const DESCRIPTION = 'Create new navigation property to rooms for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.roomList/rooms.';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/rooms';
