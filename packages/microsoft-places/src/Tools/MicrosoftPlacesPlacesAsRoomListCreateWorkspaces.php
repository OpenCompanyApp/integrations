 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.roomList/workspaces.
 */
class MicrosoftPlacesPlacesAsRoomListCreateWorkspaces extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_create_workspaces';
    protected const DESCRIPTION = 'Create new navigation property to workspaces for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.roomList/workspaces.';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/workspaces';
