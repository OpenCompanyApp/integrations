 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.roomList/rooms/{room-id}.
 */
class MicrosoftPlacesPlacesAsRoomListDeleteRooms extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_delete_rooms';
    protected const DESCRIPTION = 'Delete navigation property rooms for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}/graph.roomList/rooms/{room-id}.';
