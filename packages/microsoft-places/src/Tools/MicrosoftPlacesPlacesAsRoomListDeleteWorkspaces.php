 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.roomList/workspaces/{workspace-id}.
 */
class MicrosoftPlacesPlacesAsRoomListDeleteWorkspaces extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_delete_workspaces';
    protected const DESCRIPTION = 'Delete navigation property workspaces for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}/graph.roomList/workspaces/{workspace-id}.';
