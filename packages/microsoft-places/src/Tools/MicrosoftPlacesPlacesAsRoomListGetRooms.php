 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/rooms/{room-id}.
 */
class MicrosoftPlacesPlacesAsRoomListGetRooms extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_get_rooms';
    protected const DESCRIPTION = 'Get rooms from places\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.roomList/rooms/{room-id}.';
