 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/workspaces/{workspace-id}.
 */
class MicrosoftPlacesPlacesAsRoomListGetWorkspaces extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_get_workspaces';
    protected const DESCRIPTION = 'Get workspaces from places\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.roomList/workspaces/{workspace-id}.';
