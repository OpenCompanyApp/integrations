 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/rooms/{room-id}/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsRoomListRoomsCheckInsGetCount28dc extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_rooms_check_ins_get_count_28dc';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/rooms/{room-id}/checkIns/$count';
