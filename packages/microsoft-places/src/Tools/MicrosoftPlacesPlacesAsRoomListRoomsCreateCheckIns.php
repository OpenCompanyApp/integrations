 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.roomList/rooms/{room-id}/checkIns.
 */
class MicrosoftPlacesPlacesAsRoomListRoomsCreateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_rooms_create_check_ins';
    protected const DESCRIPTION = 'Create new navigation property to checkIns for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/graph.roomList/rooms/{room-id}/checkIns.';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/rooms/{room-id}/checkIns';
    protected const PATH_PARAMS = ['place-id' => 'place_id', 'room-id' => 'room_id'];
