 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/rooms/$count.
 */
class MicrosoftPlacesPlacesAsRoomListRoomsGetCountB534 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_rooms_get_count_b534';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/rooms/$count';
