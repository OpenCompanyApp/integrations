 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.roomList/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsRoomListUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/checkIns/{checkInClaim-calendarEventId}';
