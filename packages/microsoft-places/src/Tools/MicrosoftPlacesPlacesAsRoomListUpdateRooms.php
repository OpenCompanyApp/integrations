 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.roomList/rooms/{room-id}.
 */
class MicrosoftPlacesPlacesAsRoomListUpdateRooms extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_update_rooms';
    protected const DESCRIPTION = 'Update the navigation property rooms in places\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /places/{place-id}/graph.roomList/rooms/{room-id}.';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/rooms/{room-id}';
