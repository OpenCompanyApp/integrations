 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.roomList/workspaces/{workspace-id}.
 */
class MicrosoftPlacesPlacesAsRoomListUpdateWorkspaces extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_update_workspaces';
    protected const DESCRIPTION = 'Update the navigation property workspaces in places\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /places/{place-id}/graph.roomList/workspaces/{workspace-id}.';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/workspaces/{workspace-id}';
