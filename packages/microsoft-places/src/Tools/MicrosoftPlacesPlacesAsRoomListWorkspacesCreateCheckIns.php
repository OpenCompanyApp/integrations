 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.roomList/workspaces/{workspace-id}/checkIns.
 */
class MicrosoftPlacesPlacesAsRoomListWorkspacesCreateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_workspaces_create_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/workspaces/{workspace-id}/checkIns';
