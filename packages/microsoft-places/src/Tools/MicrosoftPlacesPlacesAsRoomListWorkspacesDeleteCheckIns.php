 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.roomList/workspaces/{workspace-id}/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsRoomListWorkspacesDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_workspaces_delete_check_ins';
    protected const DESCRIPTION = 'Delete navigation property checkIns for places\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}/graph.roomList/workspaces/{workspace-id}/checkIns/{checkInClaim-calendarEventId}.';
