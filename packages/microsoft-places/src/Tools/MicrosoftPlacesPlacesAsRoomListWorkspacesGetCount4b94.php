 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/workspaces/$count.
 */
class MicrosoftPlacesPlacesAsRoomListWorkspacesGetCount4b94 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_workspaces_get_count_4b94';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList/workspaces/$count';
