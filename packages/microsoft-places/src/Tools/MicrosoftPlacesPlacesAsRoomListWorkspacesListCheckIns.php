 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList/workspaces/{workspace-id}/checkIns.
 */
class MicrosoftPlacesPlacesAsRoomListWorkspacesListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_list_workspaces_list_check_ins';
