 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.room/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsRoomUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_room_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.room/checkIns/{checkInClaim-calendarEventId}';
