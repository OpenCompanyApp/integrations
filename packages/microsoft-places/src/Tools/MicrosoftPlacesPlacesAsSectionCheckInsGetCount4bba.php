 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.section/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsSectionCheckInsGetCount4bba extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_section_check_ins_get_count_4bba';
    ...
    protected const PATH = '/places/{place-id}/graph.section/checkIns/$count';
