 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.section/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsSectionDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_section_delete_check_ins';
