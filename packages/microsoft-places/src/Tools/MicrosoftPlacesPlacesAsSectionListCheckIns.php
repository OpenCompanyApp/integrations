 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.section/checkIns.
 */
class MicrosoftPlacesPlacesAsSectionListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_section_list_check_ins';
