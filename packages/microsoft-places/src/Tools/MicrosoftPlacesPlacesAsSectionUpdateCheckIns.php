 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.section/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsSectionUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_section_update_check_ins';
