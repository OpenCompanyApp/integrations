 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.workspace/checkIns/$count.
 */
class MicrosoftPlacesPlacesAsWorkspaceCheckInsGetCountD022 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_workspace_check_ins_get_count_d022';
    ...
    protected const PATH = '/places/{place-id}/graph.workspace/checkIns/$count';
