 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/graph.workspace/checkIns.
 */
class MicrosoftPlacesPlacesAsWorkspaceCreateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_workspace_create_check_ins';
