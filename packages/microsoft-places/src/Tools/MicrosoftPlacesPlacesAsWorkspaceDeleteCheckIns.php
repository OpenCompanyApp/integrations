 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/graph.workspace/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsWorkspaceDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_workspace_delete_check_ins';
