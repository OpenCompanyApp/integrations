 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.workspace/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsWorkspaceGetCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_workspace_get_check_ins';
