 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.workspace/checkIns.
 */
class MicrosoftPlacesPlacesAsWorkspaceListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_workspace_list_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.workspace/checkIns';
