 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/graph.workspace/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesAsWorkspaceUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_as_workspace_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/graph.workspace/checkIns/{checkInClaim-calendarEventId}';
