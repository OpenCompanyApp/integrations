 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/checkIns/$count.
 */
class MicrosoftPlacesPlacesCheckInsGetCount2709 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_check_ins_get_count_2709';
    ...
    protected const PATH = '/places/{place-id}/checkIns/$count';
