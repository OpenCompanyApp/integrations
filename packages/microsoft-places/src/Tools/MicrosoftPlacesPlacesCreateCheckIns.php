 ...
 * Create checkInClaim.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places/{place-id}/checkIns.
 */
class MicrosoftPlacesPlacesCreateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_create_check_ins';
    protected const DESCRIPTION = 'Create checkInClaim\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places/{place-id}/checkIns.';
    ...
    protected const PATH = '/places/{place-id}/checkIns';
