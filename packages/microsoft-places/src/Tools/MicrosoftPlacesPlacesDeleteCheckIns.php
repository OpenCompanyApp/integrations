 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesDeleteCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_delete_check_ins';
