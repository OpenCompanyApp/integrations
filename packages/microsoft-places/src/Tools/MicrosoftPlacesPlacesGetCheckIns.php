 ...
 * Get checkInClaim.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesGetCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_get_check_ins';
    protected const DESCRIPTION = 'Get checkInClaim\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/checkIns/{checkInClaim-calendarEventId}.';
