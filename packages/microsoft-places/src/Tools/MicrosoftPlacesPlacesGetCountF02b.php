 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/$count.
 */
class MicrosoftPlacesPlacesGetCountF02b extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_get_count_f02b';
    ...
    protected const PATH = '/places/$count';
