 ...
 * Get checkInClaim.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/checkIns.
 */
class MicrosoftPlacesPlacesListCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_list_check_ins';
