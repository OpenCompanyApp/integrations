 ...
 * Create place.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /places.
 */
class MicrosoftPlacesPlacesPlaceCreatePlace extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_create_place';
    protected const DESCRIPTION = 'Create place\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /places.';
