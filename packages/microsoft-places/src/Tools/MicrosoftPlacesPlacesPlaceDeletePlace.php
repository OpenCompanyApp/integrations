 ...
 * Delete place.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /places/{place-id}.
 */
class MicrosoftPlacesPlacesPlaceDeletePlace extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_delete_place';
    protected const DESCRIPTION = 'Delete place\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /places/{place-id}.';
    ...
    protected const PATH = '/places/{place-id}';
