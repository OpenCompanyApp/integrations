 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/descendants().
 */
class MicrosoftPlacesPlacesPlaceDescendants extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_descendants';
    protected const DESCRIPTION = 'Invoke function descendants\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/descendants().';
    ...
    protected const PATH = '/places/{place-id}/descendants()';
