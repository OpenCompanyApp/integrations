 ...
 * List place objects.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.building.
 */
class MicrosoftPlacesPlacesPlaceGetPlaceAsBuilding extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_get_place_as_building';
    ...
    protected const PATH = '/places/{place-id}/graph.building';
