 ...
 * List place objects.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.floor.
 */
class MicrosoftPlacesPlacesPlaceGetPlaceAsFloor extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_get_place_as_floor';
    ...
    protected const PATH = '/places/{place-id}/graph.floor';
