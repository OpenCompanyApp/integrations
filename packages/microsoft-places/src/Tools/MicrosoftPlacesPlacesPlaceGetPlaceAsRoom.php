 ...
 * List place objects.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.room.
 */
class MicrosoftPlacesPlacesPlaceGetPlaceAsRoom extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_get_place_as_room';
    ...
    protected const PATH = '/places/{place-id}/graph.room';
