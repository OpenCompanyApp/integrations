 ...
 * Get place.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.roomList.
 */
class MicrosoftPlacesPlacesPlaceGetPlaceAsRoomList extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_get_place_as_room_list';
    protected const DESCRIPTION = 'Get place\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.roomList.';
    ...
    protected const PATH = '/places/{place-id}/graph.roomList';
