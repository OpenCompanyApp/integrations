 ...
 * List place objects.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/{place-id}/graph.workspace.
 */
class MicrosoftPlacesPlacesPlaceGetPlaceAsWorkspace extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_get_place_as_workspace';
    protected const DESCRIPTION = 'List place objects\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /places/{place-id}/graph.workspace.';
    ...
    protected const PATH = '/places/{place-id}/graph.workspace';
