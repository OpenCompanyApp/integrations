 ...
 * List place objects.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.building.
 */
class MicrosoftPlacesPlacesPlaceListPlaceAsBuilding extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_list_place_as_building';
    ...
    protected const PATH = '/places/graph.building';
