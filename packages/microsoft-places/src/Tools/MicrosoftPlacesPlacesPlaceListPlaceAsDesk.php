 ...
 * List place objects.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.desk.
 */
class MicrosoftPlacesPlacesPlaceListPlaceAsDesk extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_list_place_as_desk';
    ...
    protected const PATH = '/places/graph.desk';
