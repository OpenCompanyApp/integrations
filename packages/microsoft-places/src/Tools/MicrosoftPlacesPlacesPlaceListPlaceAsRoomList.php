 ...
 * Get place.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.roomList.
 */
class MicrosoftPlacesPlacesPlaceListPlaceAsRoomList extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_list_place_as_room_list';
    ...
    protected const PATH = '/places/graph.roomList';
