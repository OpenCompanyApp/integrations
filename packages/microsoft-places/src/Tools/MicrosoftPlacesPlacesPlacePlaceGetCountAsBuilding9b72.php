 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.building/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsBuilding9b72 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_building_9b72';
    ...
    protected const PATH = '/places/graph.building/$count';
