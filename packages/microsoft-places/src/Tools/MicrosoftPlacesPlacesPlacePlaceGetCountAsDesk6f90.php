 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.desk/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsDesk6f90 extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_desk_6f90';
    ...
    protected const PATH = '/places/graph.desk/$count';
