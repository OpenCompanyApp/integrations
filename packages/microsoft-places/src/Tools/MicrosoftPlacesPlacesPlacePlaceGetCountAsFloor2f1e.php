 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.floor/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsFloor2f1e extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_floor_2f1e';
    ...
    protected const PATH = '/places/graph.floor/$count';
