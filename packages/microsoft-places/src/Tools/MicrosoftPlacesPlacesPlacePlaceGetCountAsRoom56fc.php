 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.room/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsRoom56fc extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_room_56fc';
    ...
    protected const PATH = '/places/graph.room/$count';
