 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.roomList/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsRoomListE9fd extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_room_list_e9fd';
    ...
    protected const PATH = '/places/graph.roomList/$count';
