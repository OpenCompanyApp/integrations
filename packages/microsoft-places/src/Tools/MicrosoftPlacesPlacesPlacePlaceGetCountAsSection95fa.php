 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.section/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsSection95fa extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_section_95fa';
    ...
    protected const PATH = '/places/graph.section/$count';
