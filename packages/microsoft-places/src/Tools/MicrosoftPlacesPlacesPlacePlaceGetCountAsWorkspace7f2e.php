 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /places/graph.workspace/$count.
 */
class MicrosoftPlacesPlacesPlacePlaceGetCountAsWorkspace7f2e extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_place_get_count_as_workspace_7f2e';
    ...
    protected const PATH = '/places/graph.workspace/$count';
