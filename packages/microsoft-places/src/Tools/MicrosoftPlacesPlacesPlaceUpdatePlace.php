 ...
 * Update place.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}.
 */
class MicrosoftPlacesPlacesPlaceUpdatePlace extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_place_update_place';
    protected const DESCRIPTION = 'Update place\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /places/{place-id}.';
