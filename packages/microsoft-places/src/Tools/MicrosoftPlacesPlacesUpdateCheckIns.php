 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /places/{place-id}/checkIns/{checkInClaim-calendarEventId}.
 */
class MicrosoftPlacesPlacesUpdateCheckIns extends AbstractMicrosoftPlacesTool
{
    protected const NAME = 'microsoft_places_places_update_check_ins';
    ...
    protected const PATH = '/places/{place-id}/checkIns/{checkInClaim-calendarEventId}';
