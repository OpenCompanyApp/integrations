 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /planner/buckets/{plannerBucket-id}/tasks.
 */
class MicrosoftPlannerBucketsCreateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_create_tasks';
    protected const DESCRIPTION = 'Create new navigation property to tasks for planner\n\nOfficial Microsoft Graph v1.0 endpoint: POST /planner/buckets/{plannerBucket-id}/tasks.';
    ...
    protected const PATH = '/planner/buckets/{plannerBucket-id}/tasks';
