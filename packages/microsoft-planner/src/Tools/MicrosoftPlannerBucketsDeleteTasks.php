 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerBucketsDeleteTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_delete_tasks';
    protected const DESCRIPTION = 'Delete navigation property tasks for planner\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}.';
