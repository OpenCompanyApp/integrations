 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/buckets/$count.
 */
class MicrosoftPlannerBucketsGetCount9ddb extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_get_count_9ddb';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/buckets/$count.';
    ...
    protected const PATH = '/planner/buckets/$count';
