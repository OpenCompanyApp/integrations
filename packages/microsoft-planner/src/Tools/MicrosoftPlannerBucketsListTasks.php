 ...
 * List tasks.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/buckets/{plannerBucket-id}/tasks.
 */
class MicrosoftPlannerBucketsListTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_list_tasks';
    protected const DESCRIPTION = 'List tasks\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/buckets/{plannerBucket-id}/tasks.';
