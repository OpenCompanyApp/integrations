 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerBucketsTasksDeleteProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_tasks_delete_progress_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property progressTaskBoardFormat for planner\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/progressTaskBoardFormat.';
