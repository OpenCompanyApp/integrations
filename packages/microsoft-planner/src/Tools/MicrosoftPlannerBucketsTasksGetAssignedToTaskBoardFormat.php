 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerBucketsTasksGetAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_tasks_get_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Get assignedToTaskBoardFormat from planner\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
