 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerBucketsTasksGetDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_tasks_get_details';
    protected const DESCRIPTION = 'Get details from planner\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details.';
