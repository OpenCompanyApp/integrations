 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerBucketsTasksUpdateAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_tasks_update_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property assignedToTaskBoardFormat in planner\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
    ...
    protected const PATH = '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat';
