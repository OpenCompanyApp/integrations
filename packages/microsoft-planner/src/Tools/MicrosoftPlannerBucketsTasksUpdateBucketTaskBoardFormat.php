 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerBucketsTasksUpdateBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_tasks_update_bucket_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property bucketTaskBoardFormat in planner\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
    ...
    protected const PATH = '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat';
