 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerBucketsTasksUpdateDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_tasks_update_details';
    protected const DESCRIPTION = 'Update the navigation property details in planner\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details.';
    ...
    protected const PATH = '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}/details';
