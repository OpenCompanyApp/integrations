 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerBucketsUpdateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_buckets_update_tasks';
    protected const DESCRIPTION = 'Update the navigation property tasks in planner\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}.';
    ...
    protected const PATH = '/planner/buckets/{plannerBucket-id}/tasks/{plannerTask-id}';
