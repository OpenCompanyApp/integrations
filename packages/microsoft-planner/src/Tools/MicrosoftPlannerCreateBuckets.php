 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /planner/buckets.
 */
class MicrosoftPlannerCreateBuckets extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_create_buckets';
    protected const DESCRIPTION = 'Create plannerBucket\n\nOfficial Microsoft Graph v1.0 endpoint: POST /planner/buckets.';
    ...
    protected const PATH = '/planner/buckets';
