 ...
 * Create plannerPlan.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /planner/plans.
 */
class MicrosoftPlannerCreatePlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_create_plans';
    protected const DESCRIPTION = 'Create plannerPlan\n\nOfficial Microsoft Graph v1.0 endpoint: POST /planner/plans.';
    ...
    protected const PATH = '/planner/plans';
