 ...
 * Create plannerTask.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /planner/tasks.
 */
class MicrosoftPlannerCreateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_create_tasks';
    protected const DESCRIPTION = 'Create plannerTask\n\nOfficial Microsoft Graph v1.0 endpoint: POST /planner/tasks.';
    ...
    protected const PATH = '/planner/tasks';
