 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/buckets/{plannerBucket-id}.
 */
class MicrosoftPlannerDeleteBuckets extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_delete_buckets';
    protected const DESCRIPTION = 'Delete plannerBucket\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/buckets/{plannerBucket-id}.';
