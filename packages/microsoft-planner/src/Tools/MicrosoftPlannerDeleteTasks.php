 ...
 * Delete plannerTask.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerDeleteTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_delete_tasks';
    protected const DESCRIPTION = 'Delete plannerTask\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/tasks/{plannerTask-id}.';
