 ...
 * Get plannerTask.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerGetTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_get_tasks';
    protected const DESCRIPTION = 'Get plannerTask\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks/{plannerTask-id}.';
