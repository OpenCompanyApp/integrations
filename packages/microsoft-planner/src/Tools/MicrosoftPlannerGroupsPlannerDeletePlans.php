 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /groups/{group-id}/planner/plans/{plannerPlan-id}.
 */
class MicrosoftPlannerGroupsPlannerDeletePlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_delete_plans';
    protected const DESCRIPTION = 'Delete navigation property plans for groups\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /groups/{group-id}/planner/plans/{plannerPlan-id}.';
