 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/planner/plans/{plannerPlan-id}.
 */
class MicrosoftPlannerGroupsPlannerGetPlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_get_plans';
    protected const DESCRIPTION = 'Get plans from groups\n\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/planner/plans/{plannerPlan-id}.';
