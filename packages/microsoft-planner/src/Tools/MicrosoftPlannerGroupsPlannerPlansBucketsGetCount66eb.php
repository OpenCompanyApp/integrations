 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets/$count.
 */
class MicrosoftPlannerGroupsPlannerPlansBucketsGetCount66eb extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_buckets_get_count_66eb';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets/$count.';
    ...
    protected const PATH = '/groups/{group-id}/planner/plans/{plannerPlan-id}/buckets/$count';
