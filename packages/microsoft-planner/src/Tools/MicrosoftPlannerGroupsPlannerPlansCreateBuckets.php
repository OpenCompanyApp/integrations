 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets.
 */
class MicrosoftPlannerGroupsPlannerPlansCreateBuckets extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_create_buckets';
    protected const DESCRIPTION = 'Create new navigation property to buckets for groups\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets.';
    ...
    protected const PATH = '/groups/{group-id}/planner/plans/{plannerPlan-id}/buckets';
