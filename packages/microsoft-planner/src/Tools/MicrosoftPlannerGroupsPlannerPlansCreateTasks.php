 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /groups/{group-id}/planner/plans/{plannerPlan-id}/tasks.
 */
class MicrosoftPlannerGroupsPlannerPlansCreateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_create_tasks';
    protected const DESCRIPTION = 'Create new navigation property to tasks for groups\n\nOfficial Microsoft Graph v1.0 endpoint: POST /groups/{group-id}/planner/plans/{plannerPlan-id}/tasks.';
    ...
    protected const PATH = '/groups/{group-id}/planner/plans/{plannerPlan-id}/tasks';
