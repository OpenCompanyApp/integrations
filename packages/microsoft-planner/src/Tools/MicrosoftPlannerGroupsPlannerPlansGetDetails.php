 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/planner/plans/{plannerPlan-id}/details.
 */
class MicrosoftPlannerGroupsPlannerPlansGetDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_get_details';
    protected const DESCRIPTION = 'Get details from groups\n\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/planner/plans/{plannerPlan-id}/details.';
