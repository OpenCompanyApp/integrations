 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets.
 */
class MicrosoftPlannerGroupsPlannerPlansListBuckets extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_list_buckets';
    protected const DESCRIPTION = 'Get buckets from groups\n\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets.';
