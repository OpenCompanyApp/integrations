 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /groups/{group-id}/planner/plans/{plannerPlan-id}/tasks.
 */
class MicrosoftPlannerGroupsPlannerPlansListTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_list_tasks';
    protected const DESCRIPTION = 'Get tasks from groups\n\nOfficial Microsoft Graph v1.0 endpoint: GET /groups/{group-id}/planner/plans/{plannerPlan-id}/tasks.';
