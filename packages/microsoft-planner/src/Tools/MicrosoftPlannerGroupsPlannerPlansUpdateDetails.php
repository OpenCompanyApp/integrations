 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/planner/plans/{plannerPlan-id}/details.
 */
class MicrosoftPlannerGroupsPlannerPlansUpdateDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_plans_update_details';
    protected const DESCRIPTION = 'Update the navigation property details in groups\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /groups/{group-id}/planner/plans/{plannerPlan-id}/details.';
