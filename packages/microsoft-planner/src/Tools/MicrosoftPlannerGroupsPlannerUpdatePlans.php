 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /groups/{group-id}/planner/plans/{plannerPlan-id}.
 */
class MicrosoftPlannerGroupsPlannerUpdatePlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_groups_planner_update_plans';
    protected const DESCRIPTION = 'Update the navigation property plans in groups\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /groups/{group-id}/planner/plans/{plannerPlan-id}.';
    ...
    protected const PATH = '/groups/{group-id}/planner/plans/{plannerPlan-id}';
