 ...
 * List buckets.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/buckets.
 */
class MicrosoftPlannerListBuckets extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_list_buckets';
    protected const DESCRIPTION = 'List buckets\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/buckets.';
