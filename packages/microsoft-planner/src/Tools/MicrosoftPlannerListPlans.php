 ...
 * List plans.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/plans.
 */
class MicrosoftPlannerListPlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_list_plans';
    protected const DESCRIPTION = 'List plans\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/plans.';
