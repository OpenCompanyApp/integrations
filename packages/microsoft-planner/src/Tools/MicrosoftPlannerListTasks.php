 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks.
 */
class MicrosoftPlannerListTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_list_tasks';
    protected const DESCRIPTION = 'List plannerTask objects\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks.';
