 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/planner.
 */
class MicrosoftPlannerMeDeletePlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_delete_planner';
    protected const DESCRIPTION = 'Delete navigation property planner for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/planner.';
