 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/planner/plans.
 */
class MicrosoftPlannerMePlannerCreatePlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_create_plans';
    protected const DESCRIPTION = 'Create new navigation property to plans for me\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/planner/plans.';
    ...
    protected const PATH = '/me/planner/plans';
