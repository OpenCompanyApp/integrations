 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /me/planner/tasks.
 */
class MicrosoftPlannerMePlannerCreateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_create_tasks';
    protected const DESCRIPTION = 'Create new navigation property to tasks for me\n\nOfficial Microsoft Graph v1.0 endpoint: POST /me/planner/tasks.';
    ...
    protected const PATH = '/me/planner/tasks';
