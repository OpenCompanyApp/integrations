 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerMePlannerDeleteTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_delete_tasks';
    protected const DESCRIPTION = 'Delete navigation property tasks for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/planner/tasks/{plannerTask-id}.';
