 ...
 * Get tasks from me.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerMePlannerGetTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_get_tasks';
    protected const DESCRIPTION = 'Get tasks from me\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/tasks/{plannerTask-id}.';
