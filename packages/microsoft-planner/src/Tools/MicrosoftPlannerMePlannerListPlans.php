 ...
 * List plans.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/plans.
 */
class MicrosoftPlannerMePlannerListPlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_list_plans';
    protected const DESCRIPTION = 'List plans\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/plans.';
