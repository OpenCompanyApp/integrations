 ...
 * List tasks.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/tasks.
 */
class MicrosoftPlannerMePlannerListTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_list_tasks';
    protected const DESCRIPTION = 'List tasks\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/tasks.';
