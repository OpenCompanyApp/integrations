 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/plans/$count.
 */
class MicrosoftPlannerMePlannerPlansGetCount036a extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_plans_get_count_036a';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/plans/$count.';
    ...
    protected const PATH = '/me/planner/plans/$count';
