 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerMePlannerTasksDeleteBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_delete_bucket_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property bucketTaskBoardFormat for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
