 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /me/planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerMePlannerTasksDeleteDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_delete_details';
    protected const DESCRIPTION = 'Delete navigation property details for me\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /me/planner/tasks/{plannerTask-id}/details.';
