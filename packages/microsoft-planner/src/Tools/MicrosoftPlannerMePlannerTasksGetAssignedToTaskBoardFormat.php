 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerMePlannerTasksGetAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_get_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Get assignedToTaskBoardFormat from me\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
