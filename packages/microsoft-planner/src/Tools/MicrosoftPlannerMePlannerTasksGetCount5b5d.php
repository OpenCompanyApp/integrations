 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/tasks/$count.
 */
class MicrosoftPlannerMePlannerTasksGetCount5b5d extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_get_count_5b5d';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/tasks/$count.';
    ...
    protected const PATH = '/me/planner/tasks/$count';
