 ...
 * Get details from me.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerMePlannerTasksGetDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_get_details';
    protected const DESCRIPTION = 'Get details from me\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/tasks/{plannerTask-id}/details.';
