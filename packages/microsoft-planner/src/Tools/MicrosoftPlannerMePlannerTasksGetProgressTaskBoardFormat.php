 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /me/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerMePlannerTasksGetProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_get_progress_task_board_format';
    protected const DESCRIPTION = 'Get progressTaskBoardFormat from me\n\nOfficial Microsoft Graph v1.0 endpoint: GET /me/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
