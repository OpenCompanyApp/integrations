 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerMePlannerTasksUpdateAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_update_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property assignedToTaskBoardFormat in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
    ...
    protected const PATH = '/me/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat';
