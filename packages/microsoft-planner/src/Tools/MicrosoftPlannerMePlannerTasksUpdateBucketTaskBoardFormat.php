 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerMePlannerTasksUpdateBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_update_bucket_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property bucketTaskBoardFormat in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
    ...
    protected const PATH = '/me/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat';
