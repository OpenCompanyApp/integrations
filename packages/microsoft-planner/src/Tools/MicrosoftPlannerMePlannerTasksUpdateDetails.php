 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerMePlannerTasksUpdateDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_update_details';
    protected const DESCRIPTION = 'Update the navigation property details in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/planner/tasks/{plannerTask-id}/details.';
    ...
    protected const PATH = '/me/planner/tasks/{plannerTask-id}/details';
