 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerMePlannerTasksUpdateProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_tasks_update_progress_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property progressTaskBoardFormat in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
    ...
    protected const PATH = '/me/planner/tasks/{plannerTask-id}/progressTaskBoardFormat';
