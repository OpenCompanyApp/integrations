 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerMePlannerUpdateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_planner_update_tasks';
    protected const DESCRIPTION = 'Update the navigation property tasks in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/planner/tasks/{plannerTask-id}.';
    ...
    protected const PATH = '/me/planner/tasks/{plannerTask-id}';
