 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /me/planner.
 */
class MicrosoftPlannerMeUpdatePlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_me_update_planner';
    protected const DESCRIPTION = 'Update the navigation property planner in me\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /me/planner.';
