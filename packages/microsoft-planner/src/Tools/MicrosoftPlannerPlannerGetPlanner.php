 ...
 * Get planner.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner.
 */
class MicrosoftPlannerPlannerGetPlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_planner_get_planner';
    protected const DESCRIPTION = 'Get planner\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner.';
