 ...
 * Update planner.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner.
 */
class MicrosoftPlannerPlannerUpdatePlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_planner_update_planner';
    protected const DESCRIPTION = 'Update planner\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner.';
