 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/plans/$count.
 */
class MicrosoftPlannerPlansGetCountE322 extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_plans_get_count_e322';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/plans/$count.';
    ...
    protected const PATH = '/planner/plans/$count';
