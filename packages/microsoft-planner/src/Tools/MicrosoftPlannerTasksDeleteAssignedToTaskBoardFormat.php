 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerTasksDeleteAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_delete_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property assignedToTaskBoardFormat for planner\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
    ...
    protected const PATH = '/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat';
