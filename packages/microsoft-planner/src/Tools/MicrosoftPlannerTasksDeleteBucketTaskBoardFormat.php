 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerTasksDeleteBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_delete_bucket_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property bucketTaskBoardFormat for planner\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
    ...
    protected const PATH = '/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat';
