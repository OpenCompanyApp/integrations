 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerTasksDeleteProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_delete_progress_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property progressTaskBoardFormat for planner\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
    ...
    protected const PATH = '/planner/tasks/{plannerTask-id}/progressTaskBoardFormat';
