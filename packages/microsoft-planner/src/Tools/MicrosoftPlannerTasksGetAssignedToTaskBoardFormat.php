 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerTasksGetAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_get_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Get plannerAssignedToTaskBoardTaskFormat\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
