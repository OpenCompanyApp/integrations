 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerTasksGetBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_get_bucket_task_board_format';
    protected const DESCRIPTION = 'Get plannerBucketTaskBoardTaskFormat\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
