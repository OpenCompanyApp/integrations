 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks/$count.
 */
class MicrosoftPlannerTasksGetCountBfd2 extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_get_count_bfd2';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks/$count.';
    ...
    protected const PATH = '/planner/tasks/$count';
