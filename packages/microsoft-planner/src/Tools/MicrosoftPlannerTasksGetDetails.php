 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerTasksGetDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_get_details';
    protected const DESCRIPTION = 'Get plannerTaskDetails\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks/{plannerTask-id}/details.';
