 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerTasksGetProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_get_progress_task_board_format';
    protected const DESCRIPTION = 'Get plannerProgressTaskBoardTaskFormat\n\nOfficial Microsoft Graph v1.0 endpoint: GET /planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
