 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerTasksUpdateAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_update_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Update plannerAssignedToTaskBoardTaskFormat\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
