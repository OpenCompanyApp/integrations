 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerTasksUpdateBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_update_bucket_task_board_format';
    protected const DESCRIPTION = 'Update plannerBucketTaskBoardTaskFormat\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
