 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerTasksUpdateDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_update_details';
    protected const DESCRIPTION = 'Update plannertaskdetails\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/tasks/{plannerTask-id}/details.';
