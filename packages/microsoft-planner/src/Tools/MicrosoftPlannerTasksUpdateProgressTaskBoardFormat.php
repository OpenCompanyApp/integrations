 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerTasksUpdateProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_tasks_update_progress_task_board_format';
    protected const DESCRIPTION = 'Update plannerProgressTaskBoardTaskFormat\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
