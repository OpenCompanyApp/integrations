 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /planner/buckets/{plannerBucket-id}.
 */
class MicrosoftPlannerUpdateBuckets extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_update_buckets';
    protected const DESCRIPTION = 'Update plannerbucket\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /planner/buckets/{plannerBucket-id}.';
