 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner.
 */
class MicrosoftPlannerUsersDeletePlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_delete_planner';
    protected const DESCRIPTION = 'Delete navigation property planner for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner.';
