 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner.
 */
class MicrosoftPlannerUsersGetPlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_get_planner';
    protected const DESCRIPTION = 'Get planner from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner.';
