 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/planner/plans.
 */
class MicrosoftPlannerUsersPlannerCreatePlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_create_plans';
    protected const DESCRIPTION = 'Create new navigation property to plans for users\n\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/planner/plans.';
    ...
    protected const PATH = '/users/{user-id}/planner/plans';
