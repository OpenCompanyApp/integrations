 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /users/{user-id}/planner/tasks.
 */
class MicrosoftPlannerUsersPlannerCreateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_create_tasks';
    protected const DESCRIPTION = 'Create new navigation property to tasks for users\n\nOfficial Microsoft Graph v1.0 endpoint: POST /users/{user-id}/planner/tasks.';
    ...
    protected const PATH = '/users/{user-id}/planner/tasks';
