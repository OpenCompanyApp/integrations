 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerUsersPlannerDeleteTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_delete_tasks';
    protected const DESCRIPTION = 'Delete navigation property tasks for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner/tasks/{plannerTask-id}.';
