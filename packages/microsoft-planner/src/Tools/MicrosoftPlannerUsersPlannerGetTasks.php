 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerUsersPlannerGetTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_get_tasks';
    protected const DESCRIPTION = 'Get tasks from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/tasks/{plannerTask-id}.';
