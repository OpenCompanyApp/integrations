 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/plans.
 */
class MicrosoftPlannerUsersPlannerListPlans extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_list_plans';
    protected const DESCRIPTION = 'Get plans from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/plans.';
