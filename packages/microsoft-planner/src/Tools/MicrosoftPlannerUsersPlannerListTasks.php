 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/tasks.
 */
class MicrosoftPlannerUsersPlannerListTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_list_tasks';
    protected const DESCRIPTION = 'Get tasks from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/tasks.';
