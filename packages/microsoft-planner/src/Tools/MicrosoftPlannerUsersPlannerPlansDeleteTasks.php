 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerUsersPlannerPlansDeleteTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_delete_tasks';
    protected const DESCRIPTION = 'Delete navigation property tasks for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}.';
