 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/plans/$count.
 */
class MicrosoftPlannerUsersPlannerPlansGetCountB724 extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_get_count_b724';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/plans/$count.';
    ...
    protected const PATH = '/users/{user-id}/planner/plans/$count';
