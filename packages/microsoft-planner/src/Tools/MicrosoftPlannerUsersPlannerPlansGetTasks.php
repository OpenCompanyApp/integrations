 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerUsersPlannerPlansGetTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_get_tasks';
    protected const DESCRIPTION = 'Get tasks from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}.';
