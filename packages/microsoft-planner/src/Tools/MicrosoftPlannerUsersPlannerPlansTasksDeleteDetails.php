 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerUsersPlannerPlansTasksDeleteDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_delete_details';
    protected const DESCRIPTION = 'Delete navigation property details for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details.';
