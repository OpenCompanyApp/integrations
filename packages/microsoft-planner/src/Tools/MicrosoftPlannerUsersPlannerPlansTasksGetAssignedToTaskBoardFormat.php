 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerPlansTasksGetAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_get_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Get assignedToTaskBoardFormat from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
