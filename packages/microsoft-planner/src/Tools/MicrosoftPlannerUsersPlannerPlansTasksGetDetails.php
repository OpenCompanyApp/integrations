 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerUsersPlannerPlansTasksGetDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_get_details';
    protected const DESCRIPTION = 'Get details from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details.';
