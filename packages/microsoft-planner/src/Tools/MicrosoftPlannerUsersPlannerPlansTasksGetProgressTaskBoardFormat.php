 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerPlansTasksGetProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_get_progress_task_board_format';
    protected const DESCRIPTION = 'Get progressTaskBoardFormat from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/progressTaskBoardFormat.';
