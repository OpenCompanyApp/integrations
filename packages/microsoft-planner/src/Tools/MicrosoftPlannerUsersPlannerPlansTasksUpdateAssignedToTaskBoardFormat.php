 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerPlansTasksUpdateAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_update_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property assignedToTaskBoardFormat in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
