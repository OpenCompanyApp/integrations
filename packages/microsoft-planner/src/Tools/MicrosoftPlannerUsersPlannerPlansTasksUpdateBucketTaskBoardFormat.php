 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerPlansTasksUpdateBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_update_bucket_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property bucketTaskBoardFormat in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
    ...
    protected const PATH = '/users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/bucketTaskBoardFormat';
