 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerUsersPlannerPlansTasksUpdateDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_tasks_update_details';
    protected const DESCRIPTION = 'Update the navigation property details in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details.';
    ...
    protected const PATH = '/users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/details';
