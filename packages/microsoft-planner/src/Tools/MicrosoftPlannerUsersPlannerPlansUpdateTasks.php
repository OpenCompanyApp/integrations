 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerUsersPlannerPlansUpdateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_plans_update_tasks';
    protected const DESCRIPTION = 'Update the navigation property tasks in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}.';
    ...
    protected const PATH = '/users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}';
