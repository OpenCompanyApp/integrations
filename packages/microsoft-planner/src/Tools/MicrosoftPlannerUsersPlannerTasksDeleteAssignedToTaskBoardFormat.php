 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerTasksDeleteAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_delete_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property assignedToTaskBoardFormat for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
