 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerUsersPlannerTasksDeleteDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_delete_details';
    protected const DESCRIPTION = 'Delete navigation property details for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner/tasks/{plannerTask-id}/details.';
