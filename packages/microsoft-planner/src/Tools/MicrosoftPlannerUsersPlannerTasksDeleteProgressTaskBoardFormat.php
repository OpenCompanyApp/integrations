 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerTasksDeleteProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_delete_progress_task_board_format';
    protected const DESCRIPTION = 'Delete navigation property progressTaskBoardFormat for users\n\nOfficial Microsoft Graph v1.0 endpoint: DELETE /users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
