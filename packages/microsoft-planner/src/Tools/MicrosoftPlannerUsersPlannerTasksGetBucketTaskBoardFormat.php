 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerTasksGetBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_get_bucket_task_board_format';
    protected const DESCRIPTION = 'Get bucketTaskBoardFormat from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
