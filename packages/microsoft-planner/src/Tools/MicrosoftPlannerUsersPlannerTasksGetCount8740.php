 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/tasks/$count.
 */
class MicrosoftPlannerUsersPlannerTasksGetCount8740 extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_get_count_8740';
    protected const DESCRIPTION = 'Get the number of the resource\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/tasks/$count.';
    ...
    protected const PATH = '/users/{user-id}/planner/tasks/$count';
