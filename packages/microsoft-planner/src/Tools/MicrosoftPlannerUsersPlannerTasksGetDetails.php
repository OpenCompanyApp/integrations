 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /users/{user-id}/planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerUsersPlannerTasksGetDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_get_details';
    protected const DESCRIPTION = 'Get details from users\n\nOfficial Microsoft Graph v1.0 endpoint: GET /users/{user-id}/planner/tasks/{plannerTask-id}/details.';
