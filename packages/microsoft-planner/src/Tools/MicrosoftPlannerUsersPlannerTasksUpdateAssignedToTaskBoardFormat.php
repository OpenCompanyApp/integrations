 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerTasksUpdateAssignedToTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_update_assigned_to_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property assignedToTaskBoardFormat in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat.';
    ...
    protected const PATH = '/users/{user-id}/planner/tasks/{plannerTask-id}/assignedToTaskBoardFormat';
