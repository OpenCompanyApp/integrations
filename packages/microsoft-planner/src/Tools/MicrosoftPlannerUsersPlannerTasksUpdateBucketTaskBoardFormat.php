 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerTasksUpdateBucketTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_update_bucket_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property bucketTaskBoardFormat in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat.';
    ...
    protected const PATH = '/users/{user-id}/planner/tasks/{plannerTask-id}/bucketTaskBoardFormat';
