 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/details.
 */
class MicrosoftPlannerUsersPlannerTasksUpdateDetails extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_update_details';
    protected const DESCRIPTION = 'Update the navigation property details in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/details.';
    ...
    protected const PATH = '/users/{user-id}/planner/tasks/{plannerTask-id}/details';
