 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.
 */
class MicrosoftPlannerUsersPlannerTasksUpdateProgressTaskBoardFormat extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_tasks_update_progress_task_board_format';
    protected const DESCRIPTION = 'Update the navigation property progressTaskBoardFormat in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/tasks/{plannerTask-id}/progressTaskBoardFormat.';
