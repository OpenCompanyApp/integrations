 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner/tasks/{plannerTask-id}.
 */
class MicrosoftPlannerUsersPlannerUpdateTasks extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_planner_update_tasks';
    protected const DESCRIPTION = 'Update the navigation property tasks in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner/tasks/{plannerTask-id}.';
    ...
    protected const PATH = '/users/{user-id}/planner/tasks/{plannerTask-id}';
