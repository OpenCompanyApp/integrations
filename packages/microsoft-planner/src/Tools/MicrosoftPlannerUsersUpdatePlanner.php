 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /users/{user-id}/planner.
 */
class MicrosoftPlannerUsersUpdatePlanner extends AbstractMicrosoftPlannerTool
{
    protected const NAME = 'microsoft_planner_users_update_planner';
    protected const DESCRIPTION = 'Update the navigation property planner in users\n\nOfficial Microsoft Graph v1.0 endpoint: PATCH /users/{user-id}/planner.';
    ...
    protected const PATH = '/users/{user-id}/planner';
