 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/connectors/$count.
 */
class MicrosoftPrintPrintConnectorsGetCount1d73 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_connectors_get_count_1d73';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/connectors/$count.';
    ...
    protected const PATH = '/print/connectors/$count';
