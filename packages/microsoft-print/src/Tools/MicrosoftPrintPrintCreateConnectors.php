 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/connectors.
 */
class MicrosoftPrintPrintCreateConnectors extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_create_connectors';
    protected const DESCRIPTION = 'Create new navigation property to connectors for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/connectors.';
    ...
    protected const PATH = '/print/connectors';
