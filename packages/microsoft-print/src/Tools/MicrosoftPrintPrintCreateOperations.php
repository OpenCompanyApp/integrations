 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/operations.
 */
class MicrosoftPrintPrintCreateOperations extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/operations.';
    ...
    protected const PATH = '/print/operations';
