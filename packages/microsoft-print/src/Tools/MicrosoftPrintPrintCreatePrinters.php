 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/printers.
 */
class MicrosoftPrintPrintCreatePrinters extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_create_printers';
    protected const DESCRIPTION = 'Create new navigation property to printers for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/printers.';
    ...
    protected const PATH = '/print/printers';
