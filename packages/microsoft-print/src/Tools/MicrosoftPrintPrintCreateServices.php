 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/services.
 */
class MicrosoftPrintPrintCreateServices extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_create_services';
    protected const DESCRIPTION = 'Create new navigation property to services for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/services.';
    ...
    protected const PATH = '/print/services';
