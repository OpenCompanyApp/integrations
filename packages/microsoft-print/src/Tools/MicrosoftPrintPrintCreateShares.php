 ...
 * Create printerShare.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares.
 */
class MicrosoftPrintPrintCreateShares extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_create_shares';
    protected const DESCRIPTION = 'Create printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares.';
    ...
    protected const PATH = '/print/shares';
