 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/taskDefinitions.
 */
class MicrosoftPrintPrintCreateTaskDefinitions extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_create_task_definitions';
    protected const DESCRIPTION = 'Create printTaskDefinition\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/taskDefinitions.';
    ...
    protected const PATH = '/print/taskDefinitions';
