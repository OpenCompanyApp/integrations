 ...
 * Get printerShare.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}.
 */
class MicrosoftPrintPrintGetShares extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_get_shares';
    protected const DESCRIPTION = 'Get printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}.';
