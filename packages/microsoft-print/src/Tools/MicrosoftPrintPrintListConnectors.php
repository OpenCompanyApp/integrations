 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/connectors.
 */
class MicrosoftPrintPrintListConnectors extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_list_connectors';
    protected const DESCRIPTION = 'List printConnectors\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/connectors.';
