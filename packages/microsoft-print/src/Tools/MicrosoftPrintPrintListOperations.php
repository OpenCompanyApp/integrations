 ...
 * Get printOperation.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/operations.
 */
class MicrosoftPrintPrintListOperations extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_list_operations';
    protected const DESCRIPTION = 'Get printOperation\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/operations.';
