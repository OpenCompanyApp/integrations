 ...
 * List printers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/printers.
 */
class MicrosoftPrintPrintListPrinters extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_list_printers';
    protected const DESCRIPTION = 'List printers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/printers.';
