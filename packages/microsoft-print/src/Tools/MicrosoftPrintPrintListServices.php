 ...
 * List printServices.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/services.
 */
class MicrosoftPrintPrintListServices extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_list_services';
    protected const DESCRIPTION = 'List printServices\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/services.';
