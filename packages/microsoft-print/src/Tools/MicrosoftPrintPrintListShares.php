 ...
 * List shares.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares.
 */
class MicrosoftPrintPrintListShares extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_list_shares';
    protected const DESCRIPTION = 'List shares\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares.';
