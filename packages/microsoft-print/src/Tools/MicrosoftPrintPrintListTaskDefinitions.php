 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/taskDefinitions.
 */
class MicrosoftPrintPrintListTaskDefinitions extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_list_task_definitions';
    protected const DESCRIPTION = 'List taskDefinitions\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/taskDefinitions.';
