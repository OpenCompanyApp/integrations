 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/operations/$count.
 */
class MicrosoftPrintPrintOperationsGetCount8242 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_operations_get_count_8242';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/operations/$count.';
    ...
    protected const PATH = '/print/operations/$count';
