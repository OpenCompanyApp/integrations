 ...
 * Get print.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print.
 */
class MicrosoftPrintPrintPrintGetPrint extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_print_get_print';
    protected const DESCRIPTION = 'Get print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print.';
