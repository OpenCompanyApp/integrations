 ...
 * Update print.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /print.
 */
class MicrosoftPrintPrintPrintUpdatePrint extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_print_update_print';
    protected const DESCRIPTION = 'Update print\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /print.';
