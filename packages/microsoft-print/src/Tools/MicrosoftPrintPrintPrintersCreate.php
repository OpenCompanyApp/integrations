 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/printers/create.
 */
class MicrosoftPrintPrintPrintersCreate extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_printers_create';
    protected const DESCRIPTION = 'Invoke action create\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/printers/create.';
    ...
    protected const PATH = '/print/printers/create';
