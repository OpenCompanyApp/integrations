 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}.
 */
class MicrosoftPrintPrintPrintersDeleteTaskTriggers extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_printers_delete_task_triggers';
    protected const DESCRIPTION = 'Delete printTaskTrigger\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}.';
