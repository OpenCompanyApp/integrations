 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/printers/$count.
 */
class MicrosoftPrintPrintPrintersGetCountC43f extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_printers_get_count_c43f';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/printers/$count.';
    ...
    protected const PATH = '/print/printers/$count';
