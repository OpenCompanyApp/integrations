 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}.
 */
class MicrosoftPrintPrintPrintersGetTaskTriggers extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_printers_get_task_triggers';
    protected const DESCRIPTION = 'Get printTaskTrigger\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}.';
