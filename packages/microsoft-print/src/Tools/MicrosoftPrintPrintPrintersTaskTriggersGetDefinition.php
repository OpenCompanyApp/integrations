 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}/definition.
 */
class MicrosoftPrintPrintPrintersTaskTriggersGetDefinition extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_printers_task_triggers_get_definition';
    protected const DESCRIPTION = 'Get definition from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}/definition.';
    ...
    protected const PATH = '/print/printers/{printer-id}/taskTriggers/{printTaskTrigger-id}/definition';
