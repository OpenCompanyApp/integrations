 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/services/{printService-id}/endpoints/{printServiceEndpoint-id}.
 */
class MicrosoftPrintPrintServicesDeleteEndpoints extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_services_delete_endpoints';
    protected const DESCRIPTION = 'Delete navigation property endpoints for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/services/{printService-id}/endpoints/{printServiceEndpoint-id}.';
