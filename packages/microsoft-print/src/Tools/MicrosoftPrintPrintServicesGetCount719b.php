 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/services/$count.
 */
class MicrosoftPrintPrintServicesGetCount719b extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_services_get_count_719b';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/services/$count.';
    ...
    protected const PATH = '/print/services/$count';
