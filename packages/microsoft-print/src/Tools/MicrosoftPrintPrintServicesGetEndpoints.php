 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/services/{printService-id}/endpoints/{printServiceEndpoint-id}.
 */
class MicrosoftPrintPrintServicesGetEndpoints extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_services_get_endpoints';
    protected const DESCRIPTION = 'Get printServiceEndpoint\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/services/{printService-id}/endpoints/{printServiceEndpoint-id}.';
