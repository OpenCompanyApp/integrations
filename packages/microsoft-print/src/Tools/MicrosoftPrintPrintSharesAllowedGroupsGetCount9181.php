 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/allowedGroups/$count.
 */
class MicrosoftPrintPrintSharesAllowedGroupsGetCount9181 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_allowed_groups_get_count_9181';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/allowedGroups/$count.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/allowedGroups/$count';
