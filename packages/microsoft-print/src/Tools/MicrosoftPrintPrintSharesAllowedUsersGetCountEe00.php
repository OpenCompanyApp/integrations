 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/allowedUsers/$count.
 */
class MicrosoftPrintPrintSharesAllowedUsersGetCountEe00 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_allowed_users_get_count_ee00';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/allowedUsers/$count.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/allowedUsers/$count';
