 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs.
 */
class MicrosoftPrintPrintSharesCreateJobs extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_create_jobs';
    protected const DESCRIPTION = 'Create printJob for a printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs';
