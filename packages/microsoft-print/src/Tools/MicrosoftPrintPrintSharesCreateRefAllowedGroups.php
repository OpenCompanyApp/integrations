 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/allowedGroups/$ref.
 */
class MicrosoftPrintPrintSharesCreateRefAllowedGroups extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_create_ref_allowed_groups';
    protected const DESCRIPTION = 'Create allowedGroup for printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/allowedGroups/$ref.';
