 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/allowedUsers/$ref.
 */
class MicrosoftPrintPrintSharesCreateRefAllowedUsers extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_create_ref_allowed_users';
    protected const DESCRIPTION = 'Create allowedUser for printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/allowedUsers/$ref.';
