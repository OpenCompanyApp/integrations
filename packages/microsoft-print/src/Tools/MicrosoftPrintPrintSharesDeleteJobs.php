 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/shares/{printerShare-id}/jobs/{printJob-id}.
 */
class MicrosoftPrintPrintSharesDeleteJobs extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_delete_jobs';
    protected const DESCRIPTION = 'Delete navigation property jobs for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/shares/{printerShare-id}/jobs/{printJob-id}.';
