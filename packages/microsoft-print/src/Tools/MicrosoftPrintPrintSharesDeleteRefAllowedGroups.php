 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/shares/{printerShare-id}/allowedGroups/$ref.
 */
class MicrosoftPrintPrintSharesDeleteRefAllowedGroups extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_delete_ref_allowed_groups';
    protected const DESCRIPTION = 'Delete allowedGroup from printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/shares/{printerShare-id}/allowedGroups/$ref.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/allowedGroups/$ref';
