 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/shares/{printerShare-id}/allowedUsers/$ref.
 */
class MicrosoftPrintPrintSharesDeleteRefAllowedUsers extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_delete_ref_allowed_users';
    protected const DESCRIPTION = 'Delete allowedUser from printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/shares/{printerShare-id}/allowedUsers/$ref.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/allowedUsers/$ref';
