 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/$count.
 */
class MicrosoftPrintPrintSharesGetCount070b extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_get_count_070b';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/$count.';
    ...
    protected const PATH = '/print/shares/$count';
