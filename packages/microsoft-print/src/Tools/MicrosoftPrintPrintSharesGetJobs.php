 ...
 * Get jobs from print.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/jobs/{printJob-id}.
 */
class MicrosoftPrintPrintSharesGetJobs extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_get_jobs';
    protected const DESCRIPTION = 'Get jobs from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/jobs/{printJob-id}.';
