 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/printer.
 */
class MicrosoftPrintPrintSharesGetPrinter extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_get_printer';
    protected const DESCRIPTION = 'Get printer from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/printer.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/printer';
