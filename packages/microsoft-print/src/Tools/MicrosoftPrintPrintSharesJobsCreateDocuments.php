 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs/{printJob-id}/documents.
 */
class MicrosoftPrintPrintSharesJobsCreateDocuments extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_create_documents';
    protected const DESCRIPTION = 'Create new navigation property to documents for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs/{printJob-id}/documents.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/documents';
