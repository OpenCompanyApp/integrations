 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs/{printJob-id}/tasks.
 */
class MicrosoftPrintPrintSharesJobsCreateTasks extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_create_tasks';
    protected const DESCRIPTION = 'Create new navigation property to tasks for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs/{printJob-id}/tasks.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/tasks';
