 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}.
 */
class MicrosoftPrintPrintSharesJobsDeleteDocuments extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_delete_documents';
    protected const DESCRIPTION = 'Delete navigation property documents for print\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}.';
