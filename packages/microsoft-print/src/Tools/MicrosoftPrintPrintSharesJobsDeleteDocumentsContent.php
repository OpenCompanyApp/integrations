 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value.
 */
class MicrosoftPrintPrintSharesJobsDeleteDocumentsContent extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_delete_documents_content';
    protected const DESCRIPTION = 'Delete media content for the navigation property documents in print\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value';
