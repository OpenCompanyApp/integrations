 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/$count.
 */
class MicrosoftPrintPrintSharesJobsDocumentsGetCountAcc8 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_documents_get_count_acc8';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/$count.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/documents/$count';
