 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value.
 */
class MicrosoftPrintPrintSharesJobsGetDocumentsContent extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_get_documents_content';
    protected const DESCRIPTION = 'Get media content for the navigation property documents from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value.';
