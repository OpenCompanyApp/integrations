 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/jobs/{printJob-id}/tasks.
 */
class MicrosoftPrintPrintSharesJobsListTasks extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_list_tasks';
    protected const DESCRIPTION = 'Get tasks from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/jobs/{printJob-id}/tasks.';
