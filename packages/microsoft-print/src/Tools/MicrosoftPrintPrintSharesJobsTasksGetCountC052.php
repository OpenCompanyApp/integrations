 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/jobs/{printJob-id}/tasks/$count.
 */
class MicrosoftPrintPrintSharesJobsTasksGetCountC052 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_tasks_get_count_c052';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/jobs/{printJob-id}/tasks/$count.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/tasks/$count';
