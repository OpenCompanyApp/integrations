 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}.
 */
class MicrosoftPrintPrintSharesJobsUpdateDocuments extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_update_documents';
    protected const DESCRIPTION = 'Update the navigation property documents in print\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}.';
