 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value.
 */
class MicrosoftPrintPrintSharesJobsUpdateDocumentsContent extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_jobs_update_documents_content';
    protected const DESCRIPTION = 'Update media content for the navigation property documents in print\\n\\nOfficial Microsoft Graph v1.0 endpoint: PUT /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/$value.';
