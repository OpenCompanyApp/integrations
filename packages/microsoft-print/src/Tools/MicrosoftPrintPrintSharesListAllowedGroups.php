 ...
 * List allowedGroups.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/allowedGroups.
 */
class MicrosoftPrintPrintSharesListAllowedGroups extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_list_allowed_groups';
    protected const DESCRIPTION = 'List allowedGroups\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/allowedGroups.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/allowedGroups';
