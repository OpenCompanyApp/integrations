 ...
 * List allowedUsers.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/allowedUsers.
 */
class MicrosoftPrintPrintSharesListAllowedUsers extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_list_allowed_users';
    protected const DESCRIPTION = 'List allowedUsers\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/allowedUsers.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/allowedUsers';
