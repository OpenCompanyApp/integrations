 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/shares/{printerShare-id}/jobs.
 */
class MicrosoftPrintPrintSharesListJobs extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_list_jobs';
    protected const DESCRIPTION = 'List printJobs for a printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/shares/{printerShare-id}/jobs.';
