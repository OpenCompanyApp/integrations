 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs/{printJob-id}/cancel.
 */
class MicrosoftPrintPrintSharesPrinterShareJobsPrintJobCancel extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_printer_share_jobs_print_job_cancel';
    protected const DESCRIPTION = 'Invoke action cancel\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs/{printJob-id}/cancel.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/cancel';
