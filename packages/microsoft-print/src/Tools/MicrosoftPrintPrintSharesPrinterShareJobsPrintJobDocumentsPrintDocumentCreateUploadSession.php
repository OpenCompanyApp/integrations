 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/createUploadSession.
 */
class MicrosoftPrintPrintSharesPrinterShareJobsPrintJobDocumentsPrintDocumentCreateUploadSession extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_printer_share_jobs_print_job_documents_print_document_create_upload_session';
    protected const DESCRIPTION = 'Invoke action createUploadSession\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/createUploadSession.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}/createUploadSession';
