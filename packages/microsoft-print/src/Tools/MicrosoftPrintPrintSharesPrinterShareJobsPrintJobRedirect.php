 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs/{printJob-id}/redirect.
 */
class MicrosoftPrintPrintSharesPrinterShareJobsPrintJobRedirect extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_printer_share_jobs_print_job_redirect';
    protected const DESCRIPTION = 'Invoke action redirect\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs/{printJob-id}/redirect.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/redirect';
