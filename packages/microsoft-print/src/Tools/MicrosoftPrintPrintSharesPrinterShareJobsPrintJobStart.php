 ...
 * Invoke action start.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /print/shares/{printerShare-id}/jobs/{printJob-id}/start.
 */
class MicrosoftPrintPrintSharesPrinterShareJobsPrintJobStart extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_printer_share_jobs_print_job_start';
    protected const DESCRIPTION = 'Invoke action start\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /print/shares/{printerShare-id}/jobs/{printJob-id}/start.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}/start';
