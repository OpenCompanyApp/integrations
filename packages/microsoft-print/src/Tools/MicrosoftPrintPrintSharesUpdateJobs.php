 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /print/shares/{printerShare-id}/jobs/{printJob-id}.
 */
class MicrosoftPrintPrintSharesUpdateJobs extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_shares_update_jobs';
    protected const DESCRIPTION = 'Update the navigation property jobs in print\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /print/shares/{printerShare-id}/jobs/{printJob-id}.';
    ...
    protected const PATH = '/print/shares/{printerShare-id}/jobs/{printJob-id}';
