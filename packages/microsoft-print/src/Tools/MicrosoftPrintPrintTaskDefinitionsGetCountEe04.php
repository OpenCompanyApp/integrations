 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/taskDefinitions/$count.
 */
class MicrosoftPrintPrintTaskDefinitionsGetCountEe04 extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_task_definitions_get_count_ee04';
    protected const DESCRIPTION = 'Get the number of the resource\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/taskDefinitions/$count.';
    ...
    protected const PATH = '/print/taskDefinitions/$count';
