 ...
 * Get printTask.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}.
 */
class MicrosoftPrintPrintTaskDefinitionsGetTasks extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_task_definitions_get_tasks';
    protected const DESCRIPTION = 'Get printTask\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}.';
