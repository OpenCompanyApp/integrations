 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/definition.
 */
class MicrosoftPrintPrintTaskDefinitionsTasksGetDefinition extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_task_definitions_tasks_get_definition';
    protected const DESCRIPTION = 'Get definition from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/definition.';
    ...
    protected const PATH = '/print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/definition';
