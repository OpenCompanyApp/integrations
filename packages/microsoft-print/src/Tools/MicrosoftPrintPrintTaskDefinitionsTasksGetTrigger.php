 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/trigger.
 */
class MicrosoftPrintPrintTaskDefinitionsTasksGetTrigger extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_task_definitions_tasks_get_trigger';
    protected const DESCRIPTION = 'Get trigger from print\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/trigger.';
    ...
    protected const PATH = '/print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}/trigger';
