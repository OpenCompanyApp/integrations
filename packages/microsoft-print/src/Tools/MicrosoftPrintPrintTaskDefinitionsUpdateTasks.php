 ...
 * Update printTask.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}.
 */
class MicrosoftPrintPrintTaskDefinitionsUpdateTasks extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_task_definitions_update_tasks';
    protected const DESCRIPTION = 'Update printTask\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /print/taskDefinitions/{printTaskDefinition-id}/tasks/{printTask-id}.';
