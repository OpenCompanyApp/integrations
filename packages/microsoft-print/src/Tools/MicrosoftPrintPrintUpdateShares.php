 ...
 * Update printerShare.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /print/shares/{printerShare-id}.
 */
class MicrosoftPrintPrintUpdateShares extends AbstractMicrosoftPrintTool
{
    protected const NAME = 'microsoft_print_print_update_shares';
    protected const DESCRIPTION = 'Update printerShare\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /print/shares/{printerShare-id}.';
