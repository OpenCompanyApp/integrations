...
```ruby
registrations = app.call("integrations.microsoft-reports.list_userregistrationdetails", top: 10, select: "id,userPrincipalName,isMfaRegistered", consistency_level: "eventual")
```