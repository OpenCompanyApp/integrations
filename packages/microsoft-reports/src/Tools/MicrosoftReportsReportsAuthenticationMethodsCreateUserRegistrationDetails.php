 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/authenticationMethods/userRegistrationDetails.
 */
class MicrosoftReportsReportsAuthenticationMethodsCreateUserRegistrationDetails extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_create_user_registration_details';
    protected const DESCRIPTION = 'Create new navigation property to userRegistrationDetails for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/authenticationMethods/userRegistrationDetails.';
    ...
    protected const PATH = '/reports/authenticationMethods/userRegistrationDetails';
