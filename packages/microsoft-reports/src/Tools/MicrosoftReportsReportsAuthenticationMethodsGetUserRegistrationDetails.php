 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods/userRegistrationDetails/{userRegistrationDetails-id}.
 */
class MicrosoftReportsReportsAuthenticationMethodsGetUserRegistrationDetails extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_get_user_registration_details';
    protected const DESCRIPTION = 'Get userRegistrationDetails\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/authenticationMethods/userRegistrationDetails/{userRegistrationDetails-id}.';
