 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods/userRegistrationDetails.
 */
class MicrosoftReportsReportsAuthenticationMethodsListUserRegistrationDetails extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_list_user_registration_details';
    protected const DESCRIPTION = 'List userRegistrationDetails\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/authenticationMethods/userRegistrationDetails.';
