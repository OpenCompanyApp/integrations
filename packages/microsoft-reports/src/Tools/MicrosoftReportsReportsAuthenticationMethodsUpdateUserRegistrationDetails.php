 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/authenticationMethods/userRegistrationDetails/{userRegistrationDetails-id}.
 */
class MicrosoftReportsReportsAuthenticationMethodsUpdateUserRegistrationDetails extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_update_user_registration_details';
    protected const DESCRIPTION = 'Update the navigation property userRegistrationDetails in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/authenticationMethods/userRegistrationDetails/{userRegistrationDetails-id}.';
