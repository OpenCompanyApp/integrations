 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods/userRegistrationDetails/$count.
 */
class MicrosoftReportsReportsAuthenticationMethodsUserRegistrationDetailsGetCount0ab7 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_user_registration_details_get_count_0ab7';
    ...
    protected const PATH = '/reports/authenticationMethods/userRegistrationDetails/$count';
