 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods/usersRegisteredByFeature().
 */
class MicrosoftReportsReportsAuthenticationMethodsUsersRegisteredByFeature07f2 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_users_registered_by_feature_07f2';
    ...
    protected const PATH = '/reports/authenticationMethods/usersRegisteredByFeature()';
