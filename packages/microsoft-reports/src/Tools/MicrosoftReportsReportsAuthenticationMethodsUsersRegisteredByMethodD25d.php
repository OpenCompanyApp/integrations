 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods/usersRegisteredByMethod().
 */
class MicrosoftReportsReportsAuthenticationMethodsUsersRegisteredByMethodD25d extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_users_registered_by_method_d25d';
    ...
    protected const PATH = '/reports/authenticationMethods/usersRegisteredByMethod()';
