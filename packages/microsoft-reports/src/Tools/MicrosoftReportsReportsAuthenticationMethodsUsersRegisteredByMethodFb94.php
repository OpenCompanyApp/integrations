 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods/usersRegisteredByMethod(includedUserTypes='{includedUserTypes}',includedUserRoles='{includedUserRoles}').
 */
class MicrosoftReportsReportsAuthenticationMethodsUsersRegisteredByMethodFb94 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_authentication_methods_users_registered_by_method_fb94';
    protected const DESCRIPTION = 'Invoke function usersRegisteredByMethod\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/authenticationMethods/usersRegisteredByMethod(includedUserTypes=\'{includedUserTypes}\',includedUserRoles=\'{includedUserRoles}\').';
    ...
    protected const PATH = '/reports/authenticationMethods/usersRegisteredByMethod(includedUserTypes=\'{includedUserTypes}\',includedUserRoles=\'{includedUserRoles}\')';
