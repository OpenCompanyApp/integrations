 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/dailyPrintUsageByPrinter.
 */
class MicrosoftReportsReportsCreateDailyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_create_daily_print_usage_by_printer';
    protected const DESCRIPTION = 'Create new navigation property to dailyPrintUsageByPrinter for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/dailyPrintUsageByPrinter.';
    ...
    protected const PATH = '/reports/dailyPrintUsageByPrinter';
