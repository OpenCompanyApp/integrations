 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/dailyPrintUsageByUser.
 */
class MicrosoftReportsReportsCreateDailyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_create_daily_print_usage_by_user';
    protected const DESCRIPTION = 'Create new navigation property to dailyPrintUsageByUser for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/dailyPrintUsageByUser.';
    ...
    protected const PATH = '/reports/dailyPrintUsageByUser';
