 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/monthlyPrintUsageByPrinter.
 */
class MicrosoftReportsReportsCreateMonthlyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_create_monthly_print_usage_by_printer';
    protected const DESCRIPTION = 'Create new navigation property to monthlyPrintUsageByPrinter for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/monthlyPrintUsageByPrinter.';
    ...
    protected const PATH = '/reports/monthlyPrintUsageByPrinter';
