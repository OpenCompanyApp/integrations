 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/monthlyPrintUsageByUser.
 */
class MicrosoftReportsReportsCreateMonthlyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_create_monthly_print_usage_by_user';
    protected const DESCRIPTION = 'Create new navigation property to monthlyPrintUsageByUser for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/monthlyPrintUsageByUser.';
    ...
    protected const PATH = '/reports/monthlyPrintUsageByUser';
