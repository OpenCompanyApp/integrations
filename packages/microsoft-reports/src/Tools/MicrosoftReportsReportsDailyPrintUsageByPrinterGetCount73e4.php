 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/dailyPrintUsageByPrinter/$count.
 */
class MicrosoftReportsReportsDailyPrintUsageByPrinterGetCount73e4 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_daily_print_usage_by_printer_get_count_73e4';
    ...
    protected const PATH = '/reports/dailyPrintUsageByPrinter/$count';
