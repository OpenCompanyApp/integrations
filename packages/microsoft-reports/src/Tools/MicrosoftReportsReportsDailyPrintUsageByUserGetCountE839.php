 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/dailyPrintUsageByUser/$count.
 */
class MicrosoftReportsReportsDailyPrintUsageByUserGetCountE839 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_daily_print_usage_by_user_get_count_e839';
    ...
    protected const PATH = '/reports/dailyPrintUsageByUser/$count';
