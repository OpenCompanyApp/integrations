 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/authenticationMethods.
 */
class MicrosoftReportsReportsDeleteAuthenticationMethods extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_delete_authentication_methods';
    protected const DESCRIPTION = 'Delete navigation property authenticationMethods for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/authenticationMethods.';
