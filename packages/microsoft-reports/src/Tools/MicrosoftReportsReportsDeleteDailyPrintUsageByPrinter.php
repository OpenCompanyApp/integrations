 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}.
 */
class MicrosoftReportsReportsDeleteDailyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_delete_daily_print_usage_by_printer';
    protected const DESCRIPTION = 'Delete navigation property dailyPrintUsageByPrinter for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}.';
