 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/dailyPrintUsageByUser/{printUsageByUser-id}.
 */
class MicrosoftReportsReportsDeleteDailyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_delete_daily_print_usage_by_user';
    protected const DESCRIPTION = 'Delete navigation property dailyPrintUsageByUser for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/dailyPrintUsageByUser/{printUsageByUser-id}.';
