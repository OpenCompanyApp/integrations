 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/monthlyPrintUsageByUser/{printUsageByUser-id}.
 */
class MicrosoftReportsReportsDeleteMonthlyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_delete_monthly_print_usage_by_user';
    protected const DESCRIPTION = 'Delete navigation property monthlyPrintUsageByUser for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/monthlyPrintUsageByUser/{printUsageByUser-id}.';
