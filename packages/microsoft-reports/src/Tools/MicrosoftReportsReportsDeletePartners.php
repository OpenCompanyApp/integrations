 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners.
 */
class MicrosoftReportsReportsDeletePartners extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_delete_partners';
    protected const DESCRIPTION = 'Delete navigation property partners for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/partners.';
