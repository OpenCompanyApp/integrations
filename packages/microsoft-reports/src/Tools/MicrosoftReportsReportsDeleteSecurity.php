 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/security.
 */
class MicrosoftReportsReportsDeleteSecurity extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_delete_security';
    protected const DESCRIPTION = 'Delete navigation property security for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/security.';
