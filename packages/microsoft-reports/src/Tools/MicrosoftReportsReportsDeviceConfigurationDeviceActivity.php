 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/deviceConfigurationDeviceActivity().
 */
class MicrosoftReportsReportsDeviceConfigurationDeviceActivity extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_device_configuration_device_activity';
    protected const DESCRIPTION = 'Invoke function deviceConfigurationDeviceActivity\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/deviceConfigurationDeviceActivity().';
    ...
    protected const PATH = '/reports/deviceConfigurationDeviceActivity()';
