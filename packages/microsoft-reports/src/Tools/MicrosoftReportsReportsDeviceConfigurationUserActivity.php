 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/deviceConfigurationUserActivity().
 */
class MicrosoftReportsReportsDeviceConfigurationUserActivity extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_device_configuration_user_activity';
    protected const DESCRIPTION = 'Invoke function deviceConfigurationUserActivity\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/deviceConfigurationUserActivity().';
    ...
    protected const PATH = '/reports/deviceConfigurationUserActivity()';
