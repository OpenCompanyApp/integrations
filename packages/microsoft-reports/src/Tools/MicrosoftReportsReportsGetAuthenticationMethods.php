 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/authenticationMethods.
 */
class MicrosoftReportsReportsGetAuthenticationMethods extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_authentication_methods';
    protected const DESCRIPTION = 'Get authenticationMethods from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/authenticationMethods.';
