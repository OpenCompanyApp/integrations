 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}.
 */
class MicrosoftReportsReportsGetDailyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_daily_print_usage_by_printer';
    protected const DESCRIPTION = 'Get printUsageByPrinter\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}.';
