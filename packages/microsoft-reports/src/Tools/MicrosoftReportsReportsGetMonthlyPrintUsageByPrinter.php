 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/monthlyPrintUsageByPrinter/{printUsageByPrinter-id}.
 */
class MicrosoftReportsReportsGetMonthlyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_monthly_print_usage_by_printer';
    protected const DESCRIPTION = 'Get monthlyPrintUsageByPrinter from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/monthlyPrintUsageByPrinter/{printUsageByPrinter-id}.';
