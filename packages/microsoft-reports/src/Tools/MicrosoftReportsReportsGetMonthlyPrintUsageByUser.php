 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/monthlyPrintUsageByUser/{printUsageByUser-id}.
 */
class MicrosoftReportsReportsGetMonthlyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_monthly_print_usage_by_user';
    protected const DESCRIPTION = 'Get monthlyPrintUsageByUser from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/monthlyPrintUsageByUser/{printUsageByUser-id}.';
