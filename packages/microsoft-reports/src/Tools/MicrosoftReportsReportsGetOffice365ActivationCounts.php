 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/getOffice365ActivationCounts().
 */
class MicrosoftReportsReportsGetOffice365ActivationCounts extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_office365_activation_counts';
    protected const DESCRIPTION = 'Invoke function getOffice365ActivationCounts\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/getOffice365ActivationCounts().';
    ...
    protected const PATH = '/reports/getOffice365ActivationCounts()';
