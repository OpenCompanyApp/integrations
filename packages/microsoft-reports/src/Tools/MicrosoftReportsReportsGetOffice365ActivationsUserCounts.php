 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/getOffice365ActivationsUserCounts().
 */
class MicrosoftReportsReportsGetOffice365ActivationsUserCounts extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_office365_activations_user_counts';
    protected const DESCRIPTION = 'Invoke function getOffice365ActivationsUserCounts\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/getOffice365ActivationsUserCounts().';
    ...
    protected const PATH = '/reports/getOffice365ActivationsUserCounts()';
