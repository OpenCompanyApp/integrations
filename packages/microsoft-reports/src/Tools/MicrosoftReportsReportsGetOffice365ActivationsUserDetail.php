 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/getOffice365ActivationsUserDetail().
 */
class MicrosoftReportsReportsGetOffice365ActivationsUserDetail extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_office365_activations_user_detail';
    protected const DESCRIPTION = 'Invoke function getOffice365ActivationsUserDetail\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/getOffice365ActivationsUserDetail().';
    ...
    protected const PATH = '/reports/getOffice365ActivationsUserDetail()';
