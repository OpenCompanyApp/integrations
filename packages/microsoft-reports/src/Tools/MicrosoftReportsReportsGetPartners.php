 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners.
 */
class MicrosoftReportsReportsGetPartners extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_partners';
    protected const DESCRIPTION = 'Get partners from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/partners.';
