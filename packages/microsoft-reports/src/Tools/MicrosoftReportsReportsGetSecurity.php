 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/security.
 */
class MicrosoftReportsReportsGetSecurity extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_get_security';
    protected const DESCRIPTION = 'Get security from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/security.';
