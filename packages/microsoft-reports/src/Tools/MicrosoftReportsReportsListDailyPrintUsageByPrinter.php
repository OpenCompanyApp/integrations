 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/dailyPrintUsageByPrinter.
 */
class MicrosoftReportsReportsListDailyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_list_daily_print_usage_by_printer';
    protected const DESCRIPTION = 'List dailyPrintUsageByPrinter\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/dailyPrintUsageByPrinter.';
