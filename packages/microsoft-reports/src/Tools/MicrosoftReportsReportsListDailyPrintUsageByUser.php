 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/dailyPrintUsageByUser.
 */
class MicrosoftReportsReportsListDailyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_list_daily_print_usage_by_user';
    protected const DESCRIPTION = 'List dailyPrintUsageByUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/dailyPrintUsageByUser.';
