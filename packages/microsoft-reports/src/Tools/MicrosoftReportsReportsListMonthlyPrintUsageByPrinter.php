 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/monthlyPrintUsageByPrinter.
 */
class MicrosoftReportsReportsListMonthlyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_list_monthly_print_usage_by_printer';
    protected const DESCRIPTION = 'List monthlyPrintUsageByPrinter\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/monthlyPrintUsageByPrinter.';
