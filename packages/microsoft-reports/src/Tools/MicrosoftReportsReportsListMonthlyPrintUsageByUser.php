 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/monthlyPrintUsageByUser.
 */
class MicrosoftReportsReportsListMonthlyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_list_monthly_print_usage_by_user';
    protected const DESCRIPTION = 'List monthlyPrintUsageByUser\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/monthlyPrintUsageByUser.';
