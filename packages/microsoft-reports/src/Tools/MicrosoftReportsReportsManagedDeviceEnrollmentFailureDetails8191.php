 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/managedDeviceEnrollmentFailureDetails().
 */
class MicrosoftReportsReportsManagedDeviceEnrollmentFailureDetails8191 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_managed_device_enrollment_failure_details_8191';
    ...
    protected const PATH = '/reports/managedDeviceEnrollmentFailureDetails()';
