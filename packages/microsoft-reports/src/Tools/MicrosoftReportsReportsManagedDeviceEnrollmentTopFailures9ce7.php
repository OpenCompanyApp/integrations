 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/managedDeviceEnrollmentTopFailures().
 */
class MicrosoftReportsReportsManagedDeviceEnrollmentTopFailures9ce7 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_managed_device_enrollment_top_failures_9ce7';
    ...
    protected const PATH = '/reports/managedDeviceEnrollmentTopFailures()';
