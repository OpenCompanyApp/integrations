 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/monthlyPrintUsageByPrinter/$count.
 */
class MicrosoftReportsReportsMonthlyPrintUsageByPrinterGetCount18cc extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_monthly_print_usage_by_printer_get_count_18cc';
    ...
    protected const PATH = '/reports/monthlyPrintUsageByPrinter/$count';
