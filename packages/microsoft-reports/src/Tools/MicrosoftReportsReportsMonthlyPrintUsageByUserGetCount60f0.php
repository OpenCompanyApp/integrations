 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/monthlyPrintUsageByUser/$count.
 */
class MicrosoftReportsReportsMonthlyPrintUsageByUserGetCount60f0 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_monthly_print_usage_by_user_get_count_60f0';
    ...
    protected const PATH = '/reports/monthlyPrintUsageByUser/$count';
