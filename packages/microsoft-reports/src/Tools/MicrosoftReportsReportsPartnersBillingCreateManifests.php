 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/partners/billing/manifests.
 */
class MicrosoftReportsReportsPartnersBillingCreateManifests extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_create_manifests';
    protected const DESCRIPTION = 'Create new navigation property to manifests for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/partners/billing/manifests.';
    ...
    protected const PATH = '/reports/partners/billing/manifests';
