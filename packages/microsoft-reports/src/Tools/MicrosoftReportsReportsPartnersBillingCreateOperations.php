 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/partners/billing/operations.
 */
class MicrosoftReportsReportsPartnersBillingCreateOperations extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /reports/partners/billing/operations.';
    ...
    protected const PATH = '/reports/partners/billing/operations';
