 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners/billing/reconciliation.
 */
class MicrosoftReportsReportsPartnersBillingDeleteReconciliation extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_delete_reconciliation';
    protected const DESCRIPTION = 'Delete navigation property reconciliation for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/partners/billing/reconciliation.';
