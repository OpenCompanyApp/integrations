 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners/billing/usage.
 */
class MicrosoftReportsReportsPartnersBillingDeleteUsage extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_delete_usage';
    protected const DESCRIPTION = 'Delete navigation property usage for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/partners/billing/usage.';
