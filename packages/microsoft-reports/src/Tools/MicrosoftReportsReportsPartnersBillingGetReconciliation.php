 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/reconciliation.
 */
class MicrosoftReportsReportsPartnersBillingGetReconciliation extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_get_reconciliation';
    protected const DESCRIPTION = 'Get reconciliation from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/partners/billing/reconciliation.';
