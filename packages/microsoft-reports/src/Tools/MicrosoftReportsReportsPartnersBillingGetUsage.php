 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/usage.
 */
class MicrosoftReportsReportsPartnersBillingGetUsage extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_get_usage';
    protected const DESCRIPTION = 'Get usage from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/partners/billing/usage.';
