 ...
 * Get manifest.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/manifests.
 */
class MicrosoftReportsReportsPartnersBillingListManifests extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_list_manifests';
