 ...
 * Get operation.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/operations.
 */
class MicrosoftReportsReportsPartnersBillingListOperations extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_list_operations';
