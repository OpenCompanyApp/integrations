 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/manifests/$count.
 */
class MicrosoftReportsReportsPartnersBillingManifestsGetCountF888 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_manifests_get_count_f888';
    ...
    protected const PATH = '/reports/partners/billing/manifests/$count';
