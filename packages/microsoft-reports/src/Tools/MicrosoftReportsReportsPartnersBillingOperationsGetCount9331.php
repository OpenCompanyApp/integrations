 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/operations/$count.
 */
class MicrosoftReportsReportsPartnersBillingOperationsGetCount9331 extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_operations_get_count_9331';
    ...
    protected const PATH = '/reports/partners/billing/operations/$count';
