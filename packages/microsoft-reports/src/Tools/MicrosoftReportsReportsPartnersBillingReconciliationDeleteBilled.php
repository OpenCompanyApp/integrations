 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners/billing/reconciliation/billed.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationDeleteBilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_delete_billed';
    protected const DESCRIPTION = 'Delete navigation property billed for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/partners/billing/reconciliation/billed.';
