 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners/billing/reconciliation/unbilled.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationDeleteUnbilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_delete_unbilled';
    protected const DESCRIPTION = 'Delete navigation property unbilled for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/partners/billing/reconciliation/unbilled.';
