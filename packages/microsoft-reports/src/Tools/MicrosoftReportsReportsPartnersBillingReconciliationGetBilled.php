 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/reconciliation/billed.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationGetBilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_get_billed';
    protected const DESCRIPTION = 'Get billed from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/partners/billing/reconciliation/billed.';
