 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/reconciliation/unbilled.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationGetUnbilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_get_unbilled';
    protected const DESCRIPTION = 'Get unbilled from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/partners/billing/reconciliation/unbilled.';
