 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/partners/billing/reconciliation/unbilled/microsoft.graph.partners.billing.export.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationUnbilledExport extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_unbilled_export';
    ...
    protected const PATH = '/reports/partners/billing/reconciliation/unbilled/microsoft.graph.partners.billing.export';
