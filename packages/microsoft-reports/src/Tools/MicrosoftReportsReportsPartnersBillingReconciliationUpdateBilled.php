 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners/billing/reconciliation/billed.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationUpdateBilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_update_billed';
    protected const DESCRIPTION = 'Update the navigation property billed in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/partners/billing/reconciliation/billed.';
    ...
    protected const PATH = '/reports/partners/billing/reconciliation/billed';
