 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners/billing/reconciliation/unbilled.
 */
class MicrosoftReportsReportsPartnersBillingReconciliationUpdateUnbilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_reconciliation_update_unbilled';
    protected const DESCRIPTION = 'Update the navigation property unbilled in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/partners/billing/reconciliation/unbilled.';
    ...
    protected const PATH = '/reports/partners/billing/reconciliation/unbilled';
