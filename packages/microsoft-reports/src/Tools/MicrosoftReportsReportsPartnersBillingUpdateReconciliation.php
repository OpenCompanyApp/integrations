 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners/billing/reconciliation.
 */
class MicrosoftReportsReportsPartnersBillingUpdateReconciliation extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_update_reconciliation';
    protected const DESCRIPTION = 'Update the navigation property reconciliation in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/partners/billing/reconciliation.';
    ...
    protected const PATH = '/reports/partners/billing/reconciliation';
