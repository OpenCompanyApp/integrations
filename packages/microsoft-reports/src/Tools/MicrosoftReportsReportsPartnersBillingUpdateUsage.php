 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners/billing/usage.
 */
class MicrosoftReportsReportsPartnersBillingUpdateUsage extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_update_usage';
    protected const DESCRIPTION = 'Update the navigation property usage in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/partners/billing/usage.';
    ...
    protected const PATH = '/reports/partners/billing/usage';
