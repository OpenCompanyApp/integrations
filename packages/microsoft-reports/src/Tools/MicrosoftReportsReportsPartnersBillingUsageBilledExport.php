 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/partners/billing/usage/billed/microsoft.graph.partners.billing.export.
 */
class MicrosoftReportsReportsPartnersBillingUsageBilledExport extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_usage_billed_export';
    ...
    protected const PATH = '/reports/partners/billing/usage/billed/microsoft.graph.partners.billing.export';
