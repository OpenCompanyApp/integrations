 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners/billing/usage/billed.
 */
class MicrosoftReportsReportsPartnersBillingUsageDeleteBilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_usage_delete_billed';
