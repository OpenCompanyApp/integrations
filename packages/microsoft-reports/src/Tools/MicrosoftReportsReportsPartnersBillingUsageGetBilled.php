 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing/usage/billed.
 */
class MicrosoftReportsReportsPartnersBillingUsageGetBilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_usage_get_billed';
