 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /reports/partners/billing/usage/unbilled/microsoft.graph.partners.billing.export.
 */
class MicrosoftReportsReportsPartnersBillingUsageUnbilledExport extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_usage_unbilled_export';
    ...
    protected const PATH = '/reports/partners/billing/usage/unbilled/microsoft.graph.partners.billing.export';
