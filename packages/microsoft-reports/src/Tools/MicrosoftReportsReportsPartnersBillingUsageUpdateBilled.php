 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners/billing/usage/billed.
 */
class MicrosoftReportsReportsPartnersBillingUsageUpdateBilled extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_billing_usage_update_billed';
    ...
    protected const PATH = '/reports/partners/billing/usage/billed';
