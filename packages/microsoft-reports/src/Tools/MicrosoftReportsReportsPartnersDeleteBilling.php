 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /reports/partners/billing.
 */
class MicrosoftReportsReportsPartnersDeleteBilling extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_delete_billing';
    protected const DESCRIPTION = 'Delete navigation property billing for reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: DELETE /reports/partners/billing.';
