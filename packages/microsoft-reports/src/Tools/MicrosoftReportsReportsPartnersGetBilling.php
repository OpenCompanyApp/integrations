 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/partners/billing.
 */
class MicrosoftReportsReportsPartnersGetBilling extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_get_billing';
    protected const DESCRIPTION = 'Get billing from reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/partners/billing.';
