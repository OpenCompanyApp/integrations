 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners/billing.
 */
class MicrosoftReportsReportsPartnersUpdateBilling extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_partners_update_billing';
    protected const DESCRIPTION = 'Update the navigation property billing in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/partners/billing.';
    ...
    protected const PATH = '/reports/partners/billing';
