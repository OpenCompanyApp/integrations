 ...
 * Get reports.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports.
 */
class MicrosoftReportsReportsReportRootGetReportRoot extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_report_root_get_report_root';
