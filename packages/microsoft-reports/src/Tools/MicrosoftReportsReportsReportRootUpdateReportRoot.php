 ...
 * Update reports.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports.
 */
class MicrosoftReportsReportsReportRootUpdateReportRoot extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_report_root_update_report_root';
    protected const DESCRIPTION = 'Update reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports.';
