 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/security/getAttackSimulationRepeatOffenders().
 */
class MicrosoftReportsReportsSecurityGetAttackSimulationRepeatOffenders extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_security_get_attack_simulation_repeat_offenders';
    protected const DESCRIPTION = 'Invoke function getAttackSimulationRepeatOffenders\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/security/getAttackSimulationRepeatOffenders().';
    ...
    protected const PATH = '/reports/security/getAttackSimulationRepeatOffenders()';
