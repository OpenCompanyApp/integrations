 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/security/getAttackSimulationSimulationUserCoverage().
 */
class MicrosoftReportsReportsSecurityGetAttackSimulationSimulationUserCoverage extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_security_get_attack_simulation_simulation_user_coverage';
    protected const DESCRIPTION = 'Invoke function getAttackSimulationSimulationUserCoverage\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/security/getAttackSimulationSimulationUserCoverage().';
    ...
    protected const PATH = '/reports/security/getAttackSimulationSimulationUserCoverage()';
