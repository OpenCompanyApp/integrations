 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /reports/security/getAttackSimulationTrainingUserCoverage().
 */
class MicrosoftReportsReportsSecurityGetAttackSimulationTrainingUserCoverage extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_security_get_attack_simulation_training_user_coverage';
    protected const DESCRIPTION = 'Invoke function getAttackSimulationTrainingUserCoverage\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /reports/security/getAttackSimulationTrainingUserCoverage().';
    ...
    protected const PATH = '/reports/security/getAttackSimulationTrainingUserCoverage()';
