 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/authenticationMethods.
 */
class MicrosoftReportsReportsUpdateAuthenticationMethods extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_update_authentication_methods';
    protected const DESCRIPTION = 'Update the navigation property authenticationMethods in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/authenticationMethods.';
    ...
    protected const PATH = '/reports/authenticationMethods';
