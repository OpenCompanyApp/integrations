 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}.
 */
class MicrosoftReportsReportsUpdateDailyPrintUsageByPrinter extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_update_daily_print_usage_by_printer';
    protected const DESCRIPTION = 'Update the navigation property dailyPrintUsageByPrinter in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}.';
    ...
    protected const PATH = '/reports/dailyPrintUsageByPrinter/{printUsageByPrinter-id}';
