 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/dailyPrintUsageByUser/{printUsageByUser-id}.
 */
class MicrosoftReportsReportsUpdateDailyPrintUsageByUser extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_update_daily_print_usage_by_user';
    protected const DESCRIPTION = 'Update the navigation property dailyPrintUsageByUser in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/dailyPrintUsageByUser/{printUsageByUser-id}.';
