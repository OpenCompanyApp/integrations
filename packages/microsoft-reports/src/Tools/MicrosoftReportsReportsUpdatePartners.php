 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/partners.
 */
class MicrosoftReportsReportsUpdatePartners extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_update_partners';
    protected const DESCRIPTION = 'Update the navigation property partners in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/partners.';
    ...
    protected const PATH = '/reports/partners';
