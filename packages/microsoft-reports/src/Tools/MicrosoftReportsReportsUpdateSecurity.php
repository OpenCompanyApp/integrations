 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /reports/security.
 */
class MicrosoftReportsReportsUpdateSecurity extends AbstractMicrosoftReportsTool
{
    protected const NAME = 'microsoft_reports_reports_update_security';
    protected const DESCRIPTION = 'Update the navigation property security in reports\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /reports/security.';
    ...
    protected const PATH = '/reports/security';
