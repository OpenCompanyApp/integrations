 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/acronyms/$count.
 */
class MicrosoftSearchSearchAcronymsGetCountB41d extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_acronyms_get_count_b41d';
    ...
    protected const PATH = '/search/acronyms/$count';
