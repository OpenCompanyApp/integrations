 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/bookmarks/$count.
 */
class MicrosoftSearchSearchBookmarksGetCountB2b7 extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_bookmarks_get_count_b2b7';
    ...
    protected const PATH = '/search/bookmarks/$count';
