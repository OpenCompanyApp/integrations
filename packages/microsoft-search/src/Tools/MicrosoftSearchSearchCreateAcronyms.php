 ...
 * Create acronym.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /search/acronyms.
 */
class MicrosoftSearchSearchCreateAcronyms extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_create_acronyms';
    protected const DESCRIPTION = 'Create acronym\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /search/acronyms.';
    ...
    protected const PATH = '/search/acronyms';
