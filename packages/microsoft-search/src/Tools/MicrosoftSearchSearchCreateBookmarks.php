 ...
 * Create bookmark.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /search/bookmarks.
 */
class MicrosoftSearchSearchCreateBookmarks extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_create_bookmarks';
