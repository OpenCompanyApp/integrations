 ...
 * Create qna.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /search/qnas.
 */
class MicrosoftSearchSearchCreateQnas extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_create_qnas';
    protected const DESCRIPTION = 'Create qna\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /search/qnas.';
