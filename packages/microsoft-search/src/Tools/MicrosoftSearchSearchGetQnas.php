 ...
 * Get qna.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/qnas/{qna-id}.
 */
class MicrosoftSearchSearchGetQnas extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_get_qnas';
    protected const DESCRIPTION = 'Get qna\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /search/qnas/{qna-id}.';
