 ...
 * List acronyms.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/acronyms.
 */
class MicrosoftSearchSearchListAcronyms extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_list_acronyms';
    protected const DESCRIPTION = 'List acronyms\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /search/acronyms.';
