 ...
 * List bookmarks.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/bookmarks.
 */
class MicrosoftSearchSearchListBookmarks extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_list_bookmarks';
    protected const DESCRIPTION = 'List bookmarks\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /search/bookmarks.';
    ...
    protected const PATH = '/search/bookmarks';
