 ...
 * List qnas.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/qnas.
 */
class MicrosoftSearchSearchListQnas extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_list_qnas';
    protected const DESCRIPTION = 'List qnas\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /search/qnas.';
    ...
    protected const PATH = '/search/qnas';
