 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search/qnas/$count.
 */
class MicrosoftSearchSearchQnasGetCountEf94 extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_qnas_get_count_ef94';
    ...
    protected const PATH = '/search/qnas/$count';
