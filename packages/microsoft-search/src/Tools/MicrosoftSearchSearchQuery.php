 ...
 * Invoke action query.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /search/query.
 */
class MicrosoftSearchSearchQuery extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_query';
    protected const DESCRIPTION = 'Invoke action query\\n\\nOfficial Microsoft Graph v1.0 endpoint: POST /search/query.';
    ...
    protected const PATH = '/search/query';
