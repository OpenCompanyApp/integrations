 ...
 * Get search.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /search.
 */
class MicrosoftSearchSearchSearchEntityGetSearchEntity extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_search_entity_get_search_entity';
    protected const DESCRIPTION = 'Get search\\n\\nOfficial Microsoft Graph v1.0 endpoint: GET /search.';
