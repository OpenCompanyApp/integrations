 ...
 * Update search.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /search.
 */
class MicrosoftSearchSearchSearchEntityUpdateSearchEntity extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_search_entity_update_search_entity';
    protected const DESCRIPTION = 'Update search\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /search.';
