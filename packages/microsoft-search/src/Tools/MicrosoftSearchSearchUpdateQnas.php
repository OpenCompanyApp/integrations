 ...
 * Update qna.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /search/qnas/{qna-id}.
 */
class MicrosoftSearchSearchUpdateQnas extends AbstractMicrosoftSearchTool
{
    protected const NAME = 'microsoft_search_search_update_qnas';
    protected const DESCRIPTION = 'Update qna\\n\\nOfficial Microsoft Graph v1.0 endpoint: PATCH /search/qnas/{qna-id}.';
