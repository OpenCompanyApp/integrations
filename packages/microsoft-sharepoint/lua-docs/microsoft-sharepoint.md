...
```lua
local sites = microsoft_sharepoint_sites_site_list_site({ search = "Engineering" })
local lists = microsoft_sharepoint_sites_site_lists_list_list({ site_id = "contoso.sharepoint.com,site-id,web-id", top = 25 })
local items = microsoft_sharepoint_sites_site_lists_list_items_list_list_item({ site_id = "contoso.sharepoint.com,site-id,web-id", list_id = "list-id", expand = "fields" })
```
