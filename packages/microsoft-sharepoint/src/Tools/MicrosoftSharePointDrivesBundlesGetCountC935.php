 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/bundles/$count.
 */
class MicrosoftSharePointDrivesBundlesGetCountC935 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_bundles_get_count_c935';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/bundles/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/bundles/$count';
