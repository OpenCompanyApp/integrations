 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/bundles.
 */
class MicrosoftSharePointDrivesCreateBundles extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_create_bundles';
    protected const DESCRIPTION = 'Create new navigation property to bundles for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/bundles.';
    ...
    protected const PATH = '/drives/{drive-id}/bundles';
