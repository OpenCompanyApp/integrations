 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items.
 */
class MicrosoftSharePointDrivesCreateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_create_items';
    protected const DESCRIPTION = 'Create new navigation property to items for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items.';
    ...
    protected const PATH = '/drives/{drive-id}/items';
