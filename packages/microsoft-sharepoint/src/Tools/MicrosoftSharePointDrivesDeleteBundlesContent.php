 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/bundles/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesDeleteBundlesContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_delete_bundles_content';
    protected const DESCRIPTION = 'Delete content for the navigation property bundles in drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/bundles/{driveItem-id}/content.';
    ...
    protected const PATH = '/drives/{drive-id}/bundles/{driveItem-id}/content';
