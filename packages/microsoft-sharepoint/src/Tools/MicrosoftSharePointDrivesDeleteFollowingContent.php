 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/following/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesDeleteFollowingContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_delete_following_content';
    protected const DESCRIPTION = 'Delete content for the navigation property following in drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/following/{driveItem-id}/content.';
    ...
    protected const PATH = '/drives/{drive-id}/following/{driveItem-id}/content';
