 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesDeleteItemsContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_delete_items_content';
    protected const DESCRIPTION = 'Delete content for the navigation property items in drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/content.';
