 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/list.
 */
class MicrosoftSharePointDrivesDeleteList extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_delete_list';
    protected const DESCRIPTION = 'Delete navigation property list for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/list.';
