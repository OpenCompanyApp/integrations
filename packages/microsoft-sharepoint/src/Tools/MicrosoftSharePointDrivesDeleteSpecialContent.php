 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/special/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesDeleteSpecialContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_delete_special_content';
    protected const DESCRIPTION = 'Delete content for the navigation property special in drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/special/{driveItem-id}/content.';
    ...
    protected const PATH = '/drives/{drive-id}/special/{driveItem-id}/content';
