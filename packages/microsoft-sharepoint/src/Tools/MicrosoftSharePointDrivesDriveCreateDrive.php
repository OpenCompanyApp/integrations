 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives.
 */
class MicrosoftSharePointDrivesDriveCreateDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_create_drive';
    protected const DESCRIPTION = 'Add new entity to drives

Official Microsoft Graph v1.0 endpoint: POST /drives.';
