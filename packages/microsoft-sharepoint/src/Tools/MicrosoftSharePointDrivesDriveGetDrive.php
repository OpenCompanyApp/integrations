 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}.
 */
class MicrosoftSharePointDrivesDriveGetDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_get_drive';
    protected const DESCRIPTION = 'Get entity from drives by key

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}.';
