 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/assignSensitivityLabel.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemAssignSensitivityLabel extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_assign_sensitivity_label';
    protected const DESCRIPTION = 'Invoke action assignSensitivityLabel

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/assignSensitivityLabel.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/assignSensitivityLabel';
