 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/checkin.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemCheckin extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_checkin';
    protected const DESCRIPTION = 'Invoke action checkin

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/checkin.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/checkin';
