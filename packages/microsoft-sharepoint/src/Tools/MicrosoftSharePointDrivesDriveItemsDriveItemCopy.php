 ...
 * Invoke action copy.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/copy.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemCopy extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_copy';
    protected const DESCRIPTION = 'Invoke action copy

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/copy.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/copy';
