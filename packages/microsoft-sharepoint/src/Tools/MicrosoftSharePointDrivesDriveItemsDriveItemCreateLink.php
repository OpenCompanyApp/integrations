 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/createLink.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemCreateLink extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_create_link';
    protected const DESCRIPTION = 'Invoke action createLink

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/createLink.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/createLink';
