 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/createUploadSession.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemCreateUploadSession extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_create_upload_session';
    protected const DESCRIPTION = 'Invoke action createUploadSession

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/createUploadSession.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/createUploadSession';
