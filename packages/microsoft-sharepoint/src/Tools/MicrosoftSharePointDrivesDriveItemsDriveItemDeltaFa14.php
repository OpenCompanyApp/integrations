 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/delta().
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemDeltaFa14 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_delta_fa14';
    protected const DESCRIPTION = 'Invoke function delta

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/delta().';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/delta()';
