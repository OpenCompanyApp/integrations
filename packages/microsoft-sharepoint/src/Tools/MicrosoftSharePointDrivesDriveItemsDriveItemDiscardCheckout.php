 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/discardCheckout.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemDiscardCheckout extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_discard_checkout';
    protected const DESCRIPTION = 'Invoke action discardCheckout

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/discardCheckout.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/discardCheckout';
