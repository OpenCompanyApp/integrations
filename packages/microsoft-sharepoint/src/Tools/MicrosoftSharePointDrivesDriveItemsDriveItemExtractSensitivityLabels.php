 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/extractSensitivityLabels.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemExtractSensitivityLabels extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_extract_sensitivity_labels';
    protected const DESCRIPTION = 'Invoke action extractSensitivityLabels

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/extractSensitivityLabels.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/extractSensitivityLabels';
