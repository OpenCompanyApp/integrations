 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/follow.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemFollow extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_follow';
    protected const DESCRIPTION = 'Invoke action follow

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/follow.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/follow';
