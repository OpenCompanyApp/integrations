 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/invite.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemInvite extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_invite';
    protected const DESCRIPTION = 'Invoke action invite

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/invite.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/invite';
