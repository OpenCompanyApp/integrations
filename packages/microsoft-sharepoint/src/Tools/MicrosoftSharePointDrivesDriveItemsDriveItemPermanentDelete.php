 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/permanentDelete.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemPermanentDelete extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_permanent_delete';
    protected const DESCRIPTION = 'Invoke action permanentDelete

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/permanentDelete.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/permanentDelete';
