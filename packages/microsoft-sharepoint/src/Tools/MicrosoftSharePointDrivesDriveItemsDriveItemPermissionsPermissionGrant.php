 ...
 * Invoke action grant.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}/grant.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemPermissionsPermissionGrant extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_permissions_permission_grant';
    protected const DESCRIPTION = 'Invoke action grant

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}/grant.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}/grant';
