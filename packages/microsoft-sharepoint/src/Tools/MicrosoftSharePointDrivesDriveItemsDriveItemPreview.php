 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/preview.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemPreview extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_preview';
    protected const DESCRIPTION = 'Invoke action preview

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/preview.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/preview';
