 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/restore.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemRestore extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_restore';
    protected const DESCRIPTION = 'Invoke action restore

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/restore.';
