 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/restore.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemSearch extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_search';
    protected const DESCRIPTION = 'Invoke function search

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/restore.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/restore';
