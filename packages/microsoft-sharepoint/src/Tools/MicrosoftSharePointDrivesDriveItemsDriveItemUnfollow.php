 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/unfollow.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemUnfollow extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_unfollow';
    protected const DESCRIPTION = 'Invoke action unfollow

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/unfollow.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/unfollow';
