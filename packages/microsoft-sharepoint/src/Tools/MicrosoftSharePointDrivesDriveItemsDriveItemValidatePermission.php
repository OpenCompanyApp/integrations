 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/validatePermission.
 */
class MicrosoftSharePointDrivesDriveItemsDriveItemValidatePermission extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_items_drive_item_validate_permission';
    protected const DESCRIPTION = 'Invoke action validatePermission

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/validatePermission.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/validatePermission';
