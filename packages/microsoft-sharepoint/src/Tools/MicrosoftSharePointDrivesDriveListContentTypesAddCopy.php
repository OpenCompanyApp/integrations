 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/contentTypes/addCopy.
 */
class MicrosoftSharePointDrivesDriveListContentTypesAddCopy extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_content_types_add_copy';
    protected const DESCRIPTION = 'Invoke action addCopy

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/contentTypes/addCopy.';
    ...
    protected const PATH = '/drives/{drive-id}/list/contentTypes/addCopy';
