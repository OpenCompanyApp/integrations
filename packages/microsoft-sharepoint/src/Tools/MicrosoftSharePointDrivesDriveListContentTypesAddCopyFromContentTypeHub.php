 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/contentTypes/addCopyFromContentTypeHub.
 */
class MicrosoftSharePointDrivesDriveListContentTypesAddCopyFromContentTypeHub extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_content_types_add_copy_from_content_type_hub';
    protected const DESCRIPTION = 'Invoke action addCopyFromContentTypeHub

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/contentTypes/addCopyFromContentTypeHub.';
    ...
    protected const PATH = '/drives/{drive-id}/list/contentTypes/addCopyFromContentTypeHub';
