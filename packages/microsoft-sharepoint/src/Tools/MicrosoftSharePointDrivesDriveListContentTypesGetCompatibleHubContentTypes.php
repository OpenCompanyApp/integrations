 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/contentTypes/getCompatibleHubContentTypes().
 */
class MicrosoftSharePointDrivesDriveListContentTypesGetCompatibleHubContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_content_types_get_compatible_hub_content_types';
    protected const DESCRIPTION = 'Invoke function getCompatibleHubContentTypes

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/contentTypes/getCompatibleHubContentTypes().';
    ...
    protected const PATH = '/drives/{drive-id}/list/contentTypes/getCompatibleHubContentTypes()';
