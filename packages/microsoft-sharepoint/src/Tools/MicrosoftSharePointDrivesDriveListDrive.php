 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives.
 */
class MicrosoftSharePointDrivesDriveListDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_drive';
    protected const DESCRIPTION = 'Get entities from drives

Official Microsoft Graph v1.0 endpoint: GET /drives.';
