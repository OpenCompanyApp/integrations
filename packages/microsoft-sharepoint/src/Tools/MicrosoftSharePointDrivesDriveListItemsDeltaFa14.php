 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/delta().
 */
class MicrosoftSharePointDrivesDriveListItemsDeltaFa14 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_items_delta_fa14';
    protected const DESCRIPTION = 'Invoke function delta

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/delta().';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/delta()';
