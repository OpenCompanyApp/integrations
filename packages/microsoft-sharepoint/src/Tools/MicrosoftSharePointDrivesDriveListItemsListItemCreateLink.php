 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/items/{listItem-id}/createLink.
 */
class MicrosoftSharePointDrivesDriveListItemsListItemCreateLink extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_items_list_item_create_link';
    protected const DESCRIPTION = 'Invoke action createLink

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/items/{listItem-id}/createLink.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/createLink';
