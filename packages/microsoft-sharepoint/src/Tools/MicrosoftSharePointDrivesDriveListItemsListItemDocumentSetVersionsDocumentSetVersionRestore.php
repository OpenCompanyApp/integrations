 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}/restore.
 */
class MicrosoftSharePointDrivesDriveListItemsListItemDocumentSetVersionsDocumentSetVersionRestore extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_items_list_item_document_set_versions_document_set_version_restore';
    protected const DESCRIPTION = 'Invoke action restore

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}/restore.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}/restore';
