 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/{listItem-id}/getActivitiesByInterval().
 */
class MicrosoftSharePointDrivesDriveListItemsListItemGetActivitiesByInterval4c35 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_items_list_item_get_activities_by_interval_4c35';
    protected const DESCRIPTION = 'Invoke function getActivitiesByInterval

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/{listItem-id}/getActivitiesByInterval().';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/getActivitiesByInterval()';
