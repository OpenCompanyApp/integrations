 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/restoreVersion.
 */
class MicrosoftSharePointDrivesDriveListItemsListItemVersionsListItemVersionRestoreVersion extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_list_items_list_item_versions_list_item_version_restore_version';
    protected const DESCRIPTION = 'Invoke action restoreVersion

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/restoreVersion.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/restoreVersion';
