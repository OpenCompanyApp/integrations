 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/recent().
 */
class MicrosoftSharePointDrivesDriveRecent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_recent';
    protected const DESCRIPTION = 'Invoke function recent

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/recent().';
    ...
    protected const PATH = '/drives/{drive-id}/recent()';
