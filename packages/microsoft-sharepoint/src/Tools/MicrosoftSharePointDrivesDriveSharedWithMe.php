 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/sharedWithMe().
 */
class MicrosoftSharePointDrivesDriveSharedWithMe extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_shared_with_me';
    protected const DESCRIPTION = 'Invoke function sharedWithMe

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/sharedWithMe().';
    ...
    protected const PATH = '/drives/{drive-id}/sharedWithMe()';
