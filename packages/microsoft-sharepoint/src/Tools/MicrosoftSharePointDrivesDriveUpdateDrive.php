 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}.
 */
class MicrosoftSharePointDrivesDriveUpdateDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_drive_update_drive';
    protected const DESCRIPTION = 'Update entity in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}.';
