 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/following/$count.
 */
class MicrosoftSharePointDrivesFollowingGetCount16f3 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_following_get_count_16f3';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/following/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/following/$count';
