 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/bundles/{driveItem-id}.
 */
class MicrosoftSharePointDrivesGetBundles extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_bundles';
    protected const DESCRIPTION = 'Get bundles from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/bundles/{driveItem-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/bundles/{driveItem-id}';
