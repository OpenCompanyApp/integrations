 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/bundles/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesGetBundlesContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_bundles_content';
    protected const DESCRIPTION = 'Get content for the navigation property bundles from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/bundles/{driveItem-id}/content.';
