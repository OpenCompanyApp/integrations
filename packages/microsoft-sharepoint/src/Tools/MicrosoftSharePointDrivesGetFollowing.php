 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/following/{driveItem-id}.
 */
class MicrosoftSharePointDrivesGetFollowing extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_following';
    protected const DESCRIPTION = 'Get following from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/following/{driveItem-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/following/{driveItem-id}';
