 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/following/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesGetFollowingContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_following_content';
    protected const DESCRIPTION = 'Get content for the navigation property following from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/following/{driveItem-id}/content.';
