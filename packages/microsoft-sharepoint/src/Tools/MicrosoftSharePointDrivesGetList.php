 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list.
 */
class MicrosoftSharePointDrivesGetList extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_list';
    protected const DESCRIPTION = 'Get list from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list.';
