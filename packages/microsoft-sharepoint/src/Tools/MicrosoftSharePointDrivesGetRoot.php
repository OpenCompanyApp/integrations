 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/root.
 */
class MicrosoftSharePointDrivesGetRoot extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_root';
    protected const DESCRIPTION = 'Get root from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/root.';
    ...
    protected const PATH = '/drives/{drive-id}/root';
