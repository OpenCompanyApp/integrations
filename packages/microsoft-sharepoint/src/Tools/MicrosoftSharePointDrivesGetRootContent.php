 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/root/content.
 */
class MicrosoftSharePointDrivesGetRootContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_root_content';
    protected const DESCRIPTION = 'Get content for the navigation property root from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/root/content.';
