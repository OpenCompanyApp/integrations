 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/special/{driveItem-id}.
 */
class MicrosoftSharePointDrivesGetSpecial extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_special';
    protected const DESCRIPTION = 'Get special from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/special/{driveItem-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/special/{driveItem-id}';
