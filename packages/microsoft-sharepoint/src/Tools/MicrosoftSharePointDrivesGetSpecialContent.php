 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/special/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesGetSpecialContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_get_special_content';
    protected const DESCRIPTION = 'Get content for the navigation property special from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/special/{driveItem-id}/content.';
