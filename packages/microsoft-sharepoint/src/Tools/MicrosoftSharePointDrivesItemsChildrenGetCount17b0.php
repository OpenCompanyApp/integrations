 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/children/$count.
 */
class MicrosoftSharePointDrivesItemsChildrenGetCount17b0 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_children_get_count_17b0';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/children/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/children/$count';
