 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/children.
 */
class MicrosoftSharePointDrivesItemsCreateChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_create_children';
    protected const DESCRIPTION = 'Create new navigation property to children for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/children.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/children';
