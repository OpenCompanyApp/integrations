 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/permissions.
 */
class MicrosoftSharePointDrivesItemsCreatePermissions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_create_permissions';
    protected const DESCRIPTION = 'Create new navigation property to permissions for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/permissions.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/permissions';
