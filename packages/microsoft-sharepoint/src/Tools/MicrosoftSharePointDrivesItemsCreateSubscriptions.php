 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/subscriptions.
 */
class MicrosoftSharePointDrivesItemsCreateSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_create_subscriptions';
    protected const DESCRIPTION = 'Create new navigation property to subscriptions for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/subscriptions.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/subscriptions';
