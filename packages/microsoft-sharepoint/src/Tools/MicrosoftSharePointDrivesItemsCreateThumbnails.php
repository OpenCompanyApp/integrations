 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/thumbnails.
 */
class MicrosoftSharePointDrivesItemsCreateThumbnails extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_create_thumbnails';
    protected const DESCRIPTION = 'Create new navigation property to thumbnails for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/thumbnails.';
