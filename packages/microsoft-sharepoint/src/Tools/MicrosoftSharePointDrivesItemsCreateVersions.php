 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/items/{driveItem-id}/versions.
 */
class MicrosoftSharePointDrivesItemsCreateVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_create_versions';
    protected const DESCRIPTION = 'Create new navigation property to versions for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/items/{driveItem-id}/versions.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/versions';
