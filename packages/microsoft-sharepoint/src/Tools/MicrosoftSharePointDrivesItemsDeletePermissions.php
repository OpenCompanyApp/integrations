 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}.
 */
class MicrosoftSharePointDrivesItemsDeletePermissions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_delete_permissions';
    protected const DESCRIPTION = 'Delete navigation property permissions for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}.';
