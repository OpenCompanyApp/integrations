 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/retentionLabel.
 */
class MicrosoftSharePointDrivesItemsDeleteRetentionLabel extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_delete_retention_label';
    protected const DESCRIPTION = 'driveItem: removeRetentionLabel

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/retentionLabel.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/retentionLabel';
