 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/items/{driveItem-id}/thumbnails/{thumbnailSet-id}.
 */
class MicrosoftSharePointDrivesItemsDeleteThumbnails extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_delete_thumbnails';
    protected const DESCRIPTION = 'Delete navigation property thumbnails for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/items/{driveItem-id}/thumbnails/{thumbnailSet-id}.';
