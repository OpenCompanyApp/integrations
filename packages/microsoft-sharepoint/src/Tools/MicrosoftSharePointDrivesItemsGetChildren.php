 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}.
 */
class MicrosoftSharePointDrivesItemsGetChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_children';
    protected const DESCRIPTION = 'Get children from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}';
