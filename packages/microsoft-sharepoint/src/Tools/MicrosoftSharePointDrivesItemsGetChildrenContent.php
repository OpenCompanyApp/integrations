 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}/content.
 */
class MicrosoftSharePointDrivesItemsGetChildrenContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_children_content';
    protected const DESCRIPTION = 'Get content for the navigation property children from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}/content.';
