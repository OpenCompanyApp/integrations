 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/$count.
 */
class MicrosoftSharePointDrivesItemsGetCount9c16 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_count_9c16';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/items/$count';
