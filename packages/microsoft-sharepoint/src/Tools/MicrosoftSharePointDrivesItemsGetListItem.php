 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/listItem.
 */
class MicrosoftSharePointDrivesItemsGetListItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_list_item';
    protected const DESCRIPTION = 'Get listItem from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/listItem.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/listItem';
