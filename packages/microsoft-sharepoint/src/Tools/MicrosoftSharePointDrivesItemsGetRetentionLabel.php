 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/retentionLabel.
 */
class MicrosoftSharePointDrivesItemsGetRetentionLabel extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_retention_label';
    protected const DESCRIPTION = 'driveItem: getRetentionLabel

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/retentionLabel.';
