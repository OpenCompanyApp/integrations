 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/versions/{driveItemVersion-id}.
 */
class MicrosoftSharePointDrivesItemsGetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_versions';
    protected const DESCRIPTION = 'Get versions from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/versions/{driveItemVersion-id}.';
