 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/versions/{driveItemVersion-id}/content.
 */
class MicrosoftSharePointDrivesItemsGetVersionsContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_get_versions_content';
    protected const DESCRIPTION = 'Get content for the navigation property versions from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/versions/{driveItemVersion-id}/content.';
