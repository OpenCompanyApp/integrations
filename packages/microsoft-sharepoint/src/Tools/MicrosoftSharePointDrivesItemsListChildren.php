 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/children.
 */
class MicrosoftSharePointDrivesItemsListChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_list_children';
    protected const DESCRIPTION = 'List children of a driveItem

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/children.';
