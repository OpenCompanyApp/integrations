 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/subscriptions.
 */
class MicrosoftSharePointDrivesItemsListSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_list_subscriptions';
    protected const DESCRIPTION = 'Get subscriptions from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/subscriptions.';
