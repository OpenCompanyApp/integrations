 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/permissions/$count.
 */
class MicrosoftSharePointDrivesItemsPermissionsGetCountD367 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_permissions_get_count_d367';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/permissions/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/permissions/$count';
