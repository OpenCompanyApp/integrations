 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/subscriptions/$count.
 */
class MicrosoftSharePointDrivesItemsSubscriptionsGetCountF848 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_subscriptions_get_count_f848';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/subscriptions/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/subscriptions/$count';
