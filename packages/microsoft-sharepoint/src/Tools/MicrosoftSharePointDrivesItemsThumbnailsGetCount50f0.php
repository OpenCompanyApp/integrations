 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/thumbnails/$count.
 */
class MicrosoftSharePointDrivesItemsThumbnailsGetCount50f0 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_thumbnails_get_count_50f0';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/thumbnails/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/thumbnails/$count';
