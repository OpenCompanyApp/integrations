 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}/content.
 */
class MicrosoftSharePointDrivesItemsUpdateChildrenContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_update_children_content';
    protected const DESCRIPTION = 'Update content for the navigation property children in drives

Official Microsoft Graph v1.0 endpoint: PUT /drives/{drive-id}/items/{driveItem-id}/children/{driveItem-id1}/content.';
