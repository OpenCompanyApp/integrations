 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}.
 */
class MicrosoftSharePointDrivesItemsUpdatePermissions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_update_permissions';
    protected const DESCRIPTION = 'Update the navigation property permissions in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/permissions/{permission-id}.';
