 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/retentionLabel.
 */
class MicrosoftSharePointDrivesItemsUpdateRetentionLabel extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_update_retention_label';
    protected const DESCRIPTION = 'driveItem: lockOrUnlockRecord

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/retentionLabel.';
