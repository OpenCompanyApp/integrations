 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}/thumbnails/{thumbnailSet-id}.
 */
class MicrosoftSharePointDrivesItemsUpdateThumbnails extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_update_thumbnails';
    protected const DESCRIPTION = 'Update the navigation property thumbnails in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}/thumbnails/{thumbnailSet-id}.';
