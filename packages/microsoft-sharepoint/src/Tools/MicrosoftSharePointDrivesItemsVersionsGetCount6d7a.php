 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items/{driveItem-id}/versions/$count.
 */
class MicrosoftSharePointDrivesItemsVersionsGetCount6d7a extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_items_versions_get_count_6d7a';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items/{driveItem-id}/versions/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}/versions/$count';
