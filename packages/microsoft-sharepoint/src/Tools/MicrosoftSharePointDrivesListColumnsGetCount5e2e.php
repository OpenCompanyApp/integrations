 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/columns/$count.
 */
class MicrosoftSharePointDrivesListColumnsGetCount5e2e extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_columns_get_count_5e2e';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/columns/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/list/columns/$count';
