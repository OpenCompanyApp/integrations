 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/columns/{columnDefinition-id}/sourceColumn.
 */
class MicrosoftSharePointDrivesListColumnsGetSourceColumn extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_columns_get_source_column';
    protected const DESCRIPTION = 'Get sourceColumn from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/columns/{columnDefinition-id}/sourceColumn.';
    ...
    protected const PATH = '/drives/{drive-id}/list/columns/{columnDefinition-id}/sourceColumn';
