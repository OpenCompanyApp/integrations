 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/list/contentTypes/{contentType-id}/columnLinks/{columnLink-id}.
 */
class MicrosoftSharePointDrivesListContentTypesDeleteColumnLinks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_content_types_delete_column_links';
    protected const DESCRIPTION = 'Delete navigation property columnLinks for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/list/contentTypes/{contentType-id}/columnLinks/{columnLink-id}.';
