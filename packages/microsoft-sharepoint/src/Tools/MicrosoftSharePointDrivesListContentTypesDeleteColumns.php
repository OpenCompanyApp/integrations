 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointDrivesListContentTypesDeleteColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_content_types_delete_columns';
    protected const DESCRIPTION = 'Delete navigation property columns for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}.';
