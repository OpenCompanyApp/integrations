 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointDrivesListContentTypesGetColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_content_types_get_columns';
    protected const DESCRIPTION = 'Get columns from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}.';
