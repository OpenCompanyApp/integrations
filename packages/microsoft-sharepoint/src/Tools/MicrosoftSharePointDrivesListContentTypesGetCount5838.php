 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/contentTypes/$count.
 */
class MicrosoftSharePointDrivesListContentTypesGetCount5838 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_content_types_get_count_5838';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/contentTypes/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/list/contentTypes/$count';
