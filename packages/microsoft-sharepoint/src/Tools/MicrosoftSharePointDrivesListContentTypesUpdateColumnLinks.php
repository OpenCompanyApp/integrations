 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/contentTypes/{contentType-id}/columnLinks/{columnLink-id}.
 */
class MicrosoftSharePointDrivesListContentTypesUpdateColumnLinks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_content_types_update_column_links';
    protected const DESCRIPTION = 'Update the navigation property columnLinks in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/contentTypes/{contentType-id}/columnLinks/{columnLink-id}.';
