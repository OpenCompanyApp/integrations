 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointDrivesListContentTypesUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_content_types_update_columns';
    protected const DESCRIPTION = 'Update the navigation property columns in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}';
