 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/columns.
 */
class MicrosoftSharePointDrivesListCreateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_create_columns';
    protected const DESCRIPTION = 'Create new navigation property to columns for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/columns.';
    ...
    protected const PATH = '/drives/{drive-id}/list/columns';
