 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/contentTypes.
 */
class MicrosoftSharePointDrivesListCreateContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_create_content_types';
    protected const DESCRIPTION = 'Create new navigation property to contentTypes for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/contentTypes.';
    ...
    protected const PATH = '/drives/{drive-id}/list/contentTypes';
