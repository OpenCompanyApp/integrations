 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/items.
 */
class MicrosoftSharePointDrivesListCreateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_create_items';
    protected const DESCRIPTION = 'Create new navigation property to items for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/items.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items';
