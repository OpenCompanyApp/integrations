 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/operations.
 */
class MicrosoftSharePointDrivesListCreateOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/operations.';
    ...
    protected const PATH = '/drives/{drive-id}/list/operations';
