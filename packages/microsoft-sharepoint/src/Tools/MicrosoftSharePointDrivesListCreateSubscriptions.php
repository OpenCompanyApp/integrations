 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/subscriptions.
 */
class MicrosoftSharePointDrivesListCreateSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_create_subscriptions';
    protected const DESCRIPTION = 'Create new navigation property to subscriptions for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/subscriptions.';
    ...
    protected const PATH = '/drives/{drive-id}/list/subscriptions';
