 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/following.
 */
class MicrosoftSharePointDrivesListFollowing extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_following';
    protected const DESCRIPTION = 'Get following from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/following.';
    ...
    protected const PATH = '/drives/{drive-id}/following';
