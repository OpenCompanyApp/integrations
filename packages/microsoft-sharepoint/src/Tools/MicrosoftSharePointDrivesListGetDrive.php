 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/drive.
 */
class MicrosoftSharePointDrivesListGetDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_get_drive';
    protected const DESCRIPTION = 'Get drive from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/drive.';
    ...
    protected const PATH = '/drives/{drive-id}/list/drive';
