 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/operations/{richLongRunningOperation-id}.
 */
class MicrosoftSharePointDrivesListGetOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_get_operations';
    protected const DESCRIPTION = 'Get operations from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/operations/{richLongRunningOperation-id}.';
