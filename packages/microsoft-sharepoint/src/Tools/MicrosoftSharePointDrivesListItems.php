 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/items.
 */
class MicrosoftSharePointDrivesListItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items';
    protected const DESCRIPTION = 'drive: sharedWithMe (deprecated)

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/items.';
