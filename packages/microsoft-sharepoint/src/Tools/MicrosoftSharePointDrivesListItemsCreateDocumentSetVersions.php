 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions.
 */
class MicrosoftSharePointDrivesListItemsCreateDocumentSetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_create_document_set_versions';
    protected const DESCRIPTION = 'Create new navigation property to documentSetVersions for drives

Official Microsoft Graph v1.0 endpoint: POST /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/documentSetVersions';
