 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/list/items/{listItem-id}/driveItem/content.
 */
class MicrosoftSharePointDrivesListItemsDeleteDriveItemContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_delete_drive_item_content';
    protected const DESCRIPTION = 'Delete content for the navigation property driveItem in drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/list/items/{listItem-id}/driveItem/content.';
