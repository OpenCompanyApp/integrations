 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/list/items/{listItem-id}/fields.
 */
class MicrosoftSharePointDrivesListItemsDeleteFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_delete_fields';
    protected const DESCRIPTION = 'Delete navigation property fields for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/list/items/{listItem-id}/fields.';
