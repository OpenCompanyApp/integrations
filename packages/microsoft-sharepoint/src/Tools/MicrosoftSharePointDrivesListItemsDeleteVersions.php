 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}.
 */
class MicrosoftSharePointDrivesListItemsDeleteVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_delete_versions';
    protected const DESCRIPTION = 'Delete navigation property versions for drives

Official Microsoft Graph v1.0 endpoint: DELETE /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}.';
