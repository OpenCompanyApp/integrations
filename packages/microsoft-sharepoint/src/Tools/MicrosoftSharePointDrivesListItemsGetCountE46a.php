 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/$count.
 */
class MicrosoftSharePointDrivesListItemsGetCountE46a extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_get_count_e46a';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/$count';
