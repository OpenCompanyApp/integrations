 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}.
 */
class MicrosoftSharePointDrivesListItemsGetDocumentSetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_get_document_set_versions';
    protected const DESCRIPTION = 'Get documentSetVersions from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}.';
