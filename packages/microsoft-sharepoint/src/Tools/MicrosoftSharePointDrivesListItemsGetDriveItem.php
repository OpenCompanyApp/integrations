 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/{listItem-id}/driveItem.
 */
class MicrosoftSharePointDrivesListItemsGetDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_get_drive_item';
    protected const DESCRIPTION = 'Get driveItem from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/{listItem-id}/driveItem.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/driveItem';
