 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/{listItem-id}/driveItem/content.
 */
class MicrosoftSharePointDrivesListItemsGetDriveItemContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_get_drive_item_content';
    protected const DESCRIPTION = 'Get content for the navigation property driveItem from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/{listItem-id}/driveItem/content.';
