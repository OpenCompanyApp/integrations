 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/{listItem-id}/fields.
 */
class MicrosoftSharePointDrivesListItemsGetFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_get_fields';
    protected const DESCRIPTION = 'Get fields from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/{listItem-id}/fields.';
