 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}.
 */
class MicrosoftSharePointDrivesListItemsUpdateDocumentSetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_update_document_set_versions';
    protected const DESCRIPTION = 'Update the navigation property documentSetVersions in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}.';
