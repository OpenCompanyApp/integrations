 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/items/{listItem-id}/fields.
 */
class MicrosoftSharePointDrivesListItemsUpdateFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_update_fields';
    protected const DESCRIPTION = 'Update the navigation property fields in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/items/{listItem-id}/fields.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/fields';
