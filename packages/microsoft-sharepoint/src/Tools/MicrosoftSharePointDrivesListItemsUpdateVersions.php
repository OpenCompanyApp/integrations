 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}.
 */
class MicrosoftSharePointDrivesListItemsUpdateVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_update_versions';
    protected const DESCRIPTION = 'Update the navigation property versions in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}.';
