 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items/{listItem-id}/versions/$count.
 */
class MicrosoftSharePointDrivesListItemsVersionsGetCountC6e1 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_versions_get_count_c6e1';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items/{listItem-id}/versions/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}/versions/$count';
