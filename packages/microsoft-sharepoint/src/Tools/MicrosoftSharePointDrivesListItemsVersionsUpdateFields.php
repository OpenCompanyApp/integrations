 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/fields.
 */
class MicrosoftSharePointDrivesListItemsVersionsUpdateFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_items_versions_update_fields';
    protected const DESCRIPTION = 'Update the navigation property fields in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/items/{listItem-id}/versions/{listItemVersion-id}/fields.';
