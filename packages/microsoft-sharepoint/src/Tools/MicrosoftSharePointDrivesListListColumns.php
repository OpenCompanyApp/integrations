 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/columns.
 */
class MicrosoftSharePointDrivesListListColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_list_columns';
    protected const DESCRIPTION = 'Get columns from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/columns.';
