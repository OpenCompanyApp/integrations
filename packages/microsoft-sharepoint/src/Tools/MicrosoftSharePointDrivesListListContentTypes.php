 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/contentTypes.
 */
class MicrosoftSharePointDrivesListListContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_list_content_types';
    protected const DESCRIPTION = 'Get contentTypes from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/contentTypes.';
