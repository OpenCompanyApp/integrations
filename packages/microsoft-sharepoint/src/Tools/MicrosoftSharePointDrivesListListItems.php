 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/items.
 */
class MicrosoftSharePointDrivesListListItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_list_items';
    protected const DESCRIPTION = 'Get items from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/items.';
