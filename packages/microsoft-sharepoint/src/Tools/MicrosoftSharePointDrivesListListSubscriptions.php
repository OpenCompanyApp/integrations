 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/subscriptions.
 */
class MicrosoftSharePointDrivesListListSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_list_subscriptions';
    protected const DESCRIPTION = 'Get subscriptions from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/subscriptions.';
