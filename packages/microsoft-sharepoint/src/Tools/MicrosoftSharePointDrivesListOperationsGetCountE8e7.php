 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/operations/$count.
 */
class MicrosoftSharePointDrivesListOperationsGetCountE8e7 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_operations_get_count_e8e7';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/operations/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/list/operations/$count';
