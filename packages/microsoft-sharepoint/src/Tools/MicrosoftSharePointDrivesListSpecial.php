 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/special.
 */
class MicrosoftSharePointDrivesListSpecial extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_special';
    protected const DESCRIPTION = 'Get special from drives

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/special.';
    ...
    protected const PATH = '/drives/{drive-id}/special';
