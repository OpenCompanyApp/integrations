 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/list/subscriptions/$count.
 */
class MicrosoftSharePointDrivesListSubscriptionsGetCount59f5 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_subscriptions_get_count_59f5';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/list/subscriptions/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/list/subscriptions/$count';
