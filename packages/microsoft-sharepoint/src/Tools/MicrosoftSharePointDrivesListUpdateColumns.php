 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointDrivesListUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_update_columns';
    protected const DESCRIPTION = 'Update the navigation property columns in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/columns/{columnDefinition-id}.';
