 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/items/{listItem-id}.
 */
class MicrosoftSharePointDrivesListUpdateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_update_items';
    protected const DESCRIPTION = 'Update the navigation property items in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/items/{listItem-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/list/items/{listItem-id}';
