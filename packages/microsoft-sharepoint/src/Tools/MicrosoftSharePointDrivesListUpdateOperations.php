 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list/operations/{richLongRunningOperation-id}.
 */
class MicrosoftSharePointDrivesListUpdateOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_list_update_operations';
    protected const DESCRIPTION = 'Update the navigation property operations in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list/operations/{richLongRunningOperation-id}.';
