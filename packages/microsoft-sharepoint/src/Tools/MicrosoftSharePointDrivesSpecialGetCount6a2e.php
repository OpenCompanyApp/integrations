 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /drives/{drive-id}/special/$count.
 */
class MicrosoftSharePointDrivesSpecialGetCount6a2e extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_special_get_count_6a2e';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /drives/{drive-id}/special/$count.';
    ...
    protected const PATH = '/drives/{drive-id}/special/$count';
