 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /drives/{drive-id}/bundles/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesUpdateBundlesContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_update_bundles_content';
    protected const DESCRIPTION = 'Update content for the navigation property bundles in drives

Official Microsoft Graph v1.0 endpoint: PUT /drives/{drive-id}/bundles/{driveItem-id}/content.';
