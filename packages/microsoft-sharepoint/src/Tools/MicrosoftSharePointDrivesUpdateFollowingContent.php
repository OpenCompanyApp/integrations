 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /drives/{drive-id}/following/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesUpdateFollowingContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_update_following_content';
    protected const DESCRIPTION = 'Update content for the navigation property following in drives

Official Microsoft Graph v1.0 endpoint: PUT /drives/{drive-id}/following/{driveItem-id}/content.';
