 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/items/{driveItem-id}.
 */
class MicrosoftSharePointDrivesUpdateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_update_items';
    protected const DESCRIPTION = 'Update the navigation property items in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/items/{driveItem-id}.';
    ...
    protected const PATH = '/drives/{drive-id}/items/{driveItem-id}';
