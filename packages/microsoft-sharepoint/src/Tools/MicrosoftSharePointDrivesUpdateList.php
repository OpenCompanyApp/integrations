 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /drives/{drive-id}/list.
 */
class MicrosoftSharePointDrivesUpdateList extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_update_list';
    protected const DESCRIPTION = 'Update the navigation property list in drives

Official Microsoft Graph v1.0 endpoint: PATCH /drives/{drive-id}/list.';
    ...
    protected const PATH = '/drives/{drive-id}/list';
