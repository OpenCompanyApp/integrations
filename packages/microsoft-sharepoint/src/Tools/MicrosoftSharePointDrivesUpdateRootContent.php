 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /drives/{drive-id}/root/content.
 */
class MicrosoftSharePointDrivesUpdateRootContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_update_root_content';
    protected const DESCRIPTION = 'Update content for the navigation property root in drives

Official Microsoft Graph v1.0 endpoint: PUT /drives/{drive-id}/root/content.';
