 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /drives/{drive-id}/special/{driveItem-id}/content.
 */
class MicrosoftSharePointDrivesUpdateSpecialContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_drives_update_special_content';
    protected const DESCRIPTION = 'Update content for the navigation property special in drives

Official Microsoft Graph v1.0 endpoint: PUT /drives/{drive-id}/special/{driveItem-id}/content.';
