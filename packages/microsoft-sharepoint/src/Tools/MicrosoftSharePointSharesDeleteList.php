 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /shares/{sharedDriveItem-id}/list.
 */
class MicrosoftSharePointSharesDeleteList extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_delete_list';
    protected const DESCRIPTION = 'Delete navigation property list for shares

Official Microsoft Graph v1.0 endpoint: DELETE /shares/{sharedDriveItem-id}/list.';
