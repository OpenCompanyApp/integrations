 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /shares/{sharedDriveItem-id}/permission.
 */
class MicrosoftSharePointSharesDeletePermission extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_delete_permission';
    protected const DESCRIPTION = 'Delete navigation property permission for shares

Official Microsoft Graph v1.0 endpoint: DELETE /shares/{sharedDriveItem-id}/permission.';
