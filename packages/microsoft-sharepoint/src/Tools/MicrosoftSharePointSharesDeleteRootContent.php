 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /shares/{sharedDriveItem-id}/root/content.
 */
class MicrosoftSharePointSharesDeleteRootContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_delete_root_content';
    protected const DESCRIPTION = 'Delete content for the navigation property root in shares

Official Microsoft Graph v1.0 endpoint: DELETE /shares/{sharedDriveItem-id}/root/content.';
