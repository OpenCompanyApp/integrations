 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/$count.
 */
class MicrosoftSharePointSharesGetCount778c extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_count_778c';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /shares/$count.';
    ...
    protected const PATH = '/shares/$count';
