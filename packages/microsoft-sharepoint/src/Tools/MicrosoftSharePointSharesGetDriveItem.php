 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/driveItem.
 */
class MicrosoftSharePointSharesGetDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_drive_item';
    protected const DESCRIPTION = 'Accessing shared DriveItems

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/driveItem.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/driveItem';
