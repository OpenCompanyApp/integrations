 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/driveItem/content.
 */
class MicrosoftSharePointSharesGetDriveItemContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_drive_item_content';
    protected const DESCRIPTION = 'Get content for the navigation property driveItem from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/driveItem/content.';
