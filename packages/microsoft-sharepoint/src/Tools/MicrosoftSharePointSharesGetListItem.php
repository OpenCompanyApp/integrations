 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/listItem.
 */
class MicrosoftSharePointSharesGetListItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_list_item';
    protected const DESCRIPTION = 'Get listItem from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/listItem.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/listItem';
