 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/permission.
 */
class MicrosoftSharePointSharesGetPermission extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_permission';
    protected const DESCRIPTION = 'Get permission from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/permission.';
