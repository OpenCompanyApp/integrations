 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/root.
 */
class MicrosoftSharePointSharesGetRoot extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_root';
    protected const DESCRIPTION = 'Get root from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/root.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/root';
