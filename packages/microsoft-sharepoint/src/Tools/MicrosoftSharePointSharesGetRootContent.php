 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/root/content.
 */
class MicrosoftSharePointSharesGetRootContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_get_root_content';
    protected const DESCRIPTION = 'Get content for the navigation property root from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/root/content.';
