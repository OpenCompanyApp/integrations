 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/items/$count.
 */
class MicrosoftSharePointSharesItemsGetCount245c extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_items_get_count_245c';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/items/$count.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/items/$count';
