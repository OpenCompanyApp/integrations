 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/columns/$count.
 */
class MicrosoftSharePointSharesListColumnsGetCountB936 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_columns_get_count_b936';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/columns/$count.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/columns/$count';
