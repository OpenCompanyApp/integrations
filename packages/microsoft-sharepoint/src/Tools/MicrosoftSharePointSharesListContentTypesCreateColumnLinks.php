 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columnLinks.
 */
class MicrosoftSharePointSharesListContentTypesCreateColumnLinks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_content_types_create_column_links';
    protected const DESCRIPTION = 'Create new navigation property to columnLinks for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columnLinks.';
