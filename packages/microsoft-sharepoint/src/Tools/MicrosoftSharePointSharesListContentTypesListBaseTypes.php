 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/baseTypes.
 */
class MicrosoftSharePointSharesListContentTypesListBaseTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_content_types_list_base_types';
    protected const DESCRIPTION = 'Get baseTypes from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/baseTypes.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/baseTypes';
