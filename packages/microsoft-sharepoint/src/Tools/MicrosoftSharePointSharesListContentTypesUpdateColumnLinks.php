 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columnLinks/{columnLink-id}.
 */
class MicrosoftSharePointSharesListContentTypesUpdateColumnLinks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_content_types_update_column_links';
    protected const DESCRIPTION = 'Update the navigation property columnLinks in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columnLinks/{columnLink-id}.';
