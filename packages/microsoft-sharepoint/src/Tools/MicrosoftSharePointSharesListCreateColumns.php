 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/columns.
 */
class MicrosoftSharePointSharesListCreateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_create_columns';
    protected const DESCRIPTION = 'Create new navigation property to columns for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/columns.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/columns';
