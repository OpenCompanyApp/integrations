 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/contentTypes.
 */
class MicrosoftSharePointSharesListCreateContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_create_content_types';
    protected const DESCRIPTION = 'Create new navigation property to contentTypes for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/contentTypes.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes';
