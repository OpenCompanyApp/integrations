 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/items.
 */
class MicrosoftSharePointSharesListCreateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_create_items';
    protected const DESCRIPTION = 'Create new navigation property to items for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/items.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items';
