 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/operations.
 */
class MicrosoftSharePointSharesListCreateOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/operations.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/operations';
