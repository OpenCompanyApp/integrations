 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/subscriptions.
 */
class MicrosoftSharePointSharesListCreateSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_create_subscriptions';
    protected const DESCRIPTION = 'Create new navigation property to subscriptions for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/subscriptions.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/subscriptions';
