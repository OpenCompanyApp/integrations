 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSharesListDeleteColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_delete_columns';
    protected const DESCRIPTION = 'Delete navigation property columns for shares

Official Microsoft Graph v1.0 endpoint: DELETE /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}.';
