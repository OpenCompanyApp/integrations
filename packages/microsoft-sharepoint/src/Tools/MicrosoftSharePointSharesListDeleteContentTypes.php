 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}.
 */
class MicrosoftSharePointSharesListDeleteContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_delete_content_types';
    protected const DESCRIPTION = 'Delete navigation property contentTypes for shares

Official Microsoft Graph v1.0 endpoint: DELETE /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}.';
