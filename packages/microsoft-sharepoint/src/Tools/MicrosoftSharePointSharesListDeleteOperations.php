 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /shares/{sharedDriveItem-id}/list/operations/{richLongRunningOperation-id}.
 */
class MicrosoftSharePointSharesListDeleteOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_delete_operations';
    protected const DESCRIPTION = 'Delete navigation property operations for shares

Official Microsoft Graph v1.0 endpoint: DELETE /shares/{sharedDriveItem-id}/list/operations/{richLongRunningOperation-id}.';
