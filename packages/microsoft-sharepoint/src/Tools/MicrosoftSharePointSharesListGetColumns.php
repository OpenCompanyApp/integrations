 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSharesListGetColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_get_columns';
    protected const DESCRIPTION = 'Get columns from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}.';
