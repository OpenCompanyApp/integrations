 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/drive.
 */
class MicrosoftSharePointSharesListGetDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_get_drive';
    protected const DESCRIPTION = 'Get drive from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/drive.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/drive';
