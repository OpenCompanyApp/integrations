 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}.
 */
class MicrosoftSharePointSharesListGetItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_get_items';
    protected const DESCRIPTION = 'Get items from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}.';
