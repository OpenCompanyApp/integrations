 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/operations/{richLongRunningOperation-id}.
 */
class MicrosoftSharePointSharesListGetOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_get_operations';
    protected const DESCRIPTION = 'Get operations from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/operations/{richLongRunningOperation-id}.';
