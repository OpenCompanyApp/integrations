 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/subscriptions/{subscription-id}.
 */
class MicrosoftSharePointSharesListGetSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_get_subscriptions';
    protected const DESCRIPTION = 'Get subscriptions from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/subscriptions/{subscription-id}.';
