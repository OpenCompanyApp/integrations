 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/items.
 */
class MicrosoftSharePointSharesListItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items';
    protected const DESCRIPTION = 'Get items from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/items.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/items';
