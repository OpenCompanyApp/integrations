 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions.
 */
class MicrosoftSharePointSharesListItemsCreateDocumentSetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_create_document_set_versions';
    protected const DESCRIPTION = 'Create new navigation property to documentSetVersions for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions.';
