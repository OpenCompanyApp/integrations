 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions.
 */
class MicrosoftSharePointSharesListItemsCreateVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_create_versions';
    protected const DESCRIPTION = 'Create new navigation property to versions for shares

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions';
