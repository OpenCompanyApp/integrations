 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions/$count.
 */
class MicrosoftSharePointSharesListItemsDocumentSetVersionsGetCount172d extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_document_set_versions_get_count_172d';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions/$count.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions/$count';
