 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content.
 */
class MicrosoftSharePointSharesListItemsGetDriveItemContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_get_drive_item_content';
    protected const DESCRIPTION = 'Get content for the navigation property driveItem from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content.';
