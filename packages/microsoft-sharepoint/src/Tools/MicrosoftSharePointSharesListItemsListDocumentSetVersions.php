 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions.
 */
class MicrosoftSharePointSharesListItemsListDocumentSetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_list_document_set_versions';
    protected const DESCRIPTION = 'Get documentSetVersions from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions';
