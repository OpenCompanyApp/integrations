 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content.
 */
class MicrosoftSharePointSharesListItemsUpdateDriveItemContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_update_drive_item_content';
    protected const DESCRIPTION = 'Update content for the navigation property driveItem in shares

Official Microsoft Graph v1.0 endpoint: PUT /shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem/content';
