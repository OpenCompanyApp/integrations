 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields.
 */
class MicrosoftSharePointSharesListItemsUpdateFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_update_fields';
    protected const DESCRIPTION = 'Update the navigation property fields in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/fields';
