 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}.
 */
class MicrosoftSharePointSharesListItemsUpdateVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_items_update_versions';
    protected const DESCRIPTION = 'Update the navigation property versions in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions/{listItemVersion-id}.';
