 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/subscriptions.
 */
class MicrosoftSharePointSharesListListSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_list_subscriptions';
    protected const DESCRIPTION = 'Get subscriptions from shares

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/subscriptions.';
