 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/operations/$count.
 */
class MicrosoftSharePointSharesListOperationsGetCount5f90 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_operations_get_count_5f90';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/operations/$count.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/operations/$count';
