 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/subscriptions/$count.
 */
class MicrosoftSharePointSharesListSubscriptionsGetCount4363 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_subscriptions_get_count_4363';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/subscriptions/$count.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/subscriptions/$count';
