 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSharesListUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_update_columns';
    protected const DESCRIPTION = 'Update the navigation property columns in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}';
