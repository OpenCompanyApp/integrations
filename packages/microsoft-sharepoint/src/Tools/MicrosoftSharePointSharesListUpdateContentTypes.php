 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}.
 */
class MicrosoftSharePointSharesListUpdateContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_update_content_types';
    protected const DESCRIPTION = 'Update the navigation property contentTypes in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}';
