 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/list/items/{listItem-id}.
 */
class MicrosoftSharePointSharesListUpdateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_list_update_items';
    protected const DESCRIPTION = 'Update the navigation property items in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/list/items/{listItem-id}.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}';
