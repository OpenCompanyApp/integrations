 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares.
 */
class MicrosoftSharePointSharesSharedDriveItemCreateSharedDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_create_shared_drive_item';
    protected const DESCRIPTION = 'Add new entity to shares

Official Microsoft Graph v1.0 endpoint: POST /shares.';
