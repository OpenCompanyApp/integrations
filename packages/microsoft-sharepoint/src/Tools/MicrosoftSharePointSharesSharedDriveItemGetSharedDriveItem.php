 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}.
 */
class MicrosoftSharePointSharesSharedDriveItemGetSharedDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_get_shared_drive_item';
    protected const DESCRIPTION = 'Accessing shared DriveItems

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}.';
