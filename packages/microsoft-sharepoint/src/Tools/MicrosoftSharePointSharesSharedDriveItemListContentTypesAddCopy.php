 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/contentTypes/addCopy.
 */
class MicrosoftSharePointSharesSharedDriveItemListContentTypesAddCopy extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_content_types_add_copy';
    protected const DESCRIPTION = 'Invoke action addCopy

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/contentTypes/addCopy.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/addCopy';
