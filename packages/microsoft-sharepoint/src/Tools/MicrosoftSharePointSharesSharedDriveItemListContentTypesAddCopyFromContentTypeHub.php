 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/contentTypes/addCopyFromContentTypeHub.
 */
class MicrosoftSharePointSharesSharedDriveItemListContentTypesAddCopyFromContentTypeHub extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_content_types_add_copy_from_content_type_hub';
    protected const DESCRIPTION = 'Invoke action addCopyFromContentTypeHub

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/contentTypes/addCopyFromContentTypeHub.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/addCopyFromContentTypeHub';
