 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/isPublished().
 */
class MicrosoftSharePointSharesSharedDriveItemListContentTypesContentTypeIsPublished extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_content_types_content_type_is_published';
    protected const DESCRIPTION = 'Invoke function isPublished

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/isPublished().';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/isPublished()';
