 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/unpublish.
 */
class MicrosoftSharePointSharesSharedDriveItemListContentTypesContentTypeUnpublish extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_content_types_content_type_unpublish';
    protected const DESCRIPTION = 'Invoke action unpublish

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/unpublish.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/unpublish';
