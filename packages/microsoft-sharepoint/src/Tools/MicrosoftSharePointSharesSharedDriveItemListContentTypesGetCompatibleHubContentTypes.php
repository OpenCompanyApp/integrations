 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/contentTypes/getCompatibleHubContentTypes().
 */
class MicrosoftSharePointSharesSharedDriveItemListContentTypesGetCompatibleHubContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_content_types_get_compatible_hub_content_types';
    protected const DESCRIPTION = 'Invoke function getCompatibleHubContentTypes

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/contentTypes/getCompatibleHubContentTypes().';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/contentTypes/getCompatibleHubContentTypes()';
