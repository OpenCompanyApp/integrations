 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/items/delta().
 */
class MicrosoftSharePointSharesSharedDriveItemListItemsDeltaFa14 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_items_delta_fa14';
    protected const DESCRIPTION = 'Invoke function delta

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/items/delta().';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/delta()';
