 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/getActivitiesByInterval().
 */
class MicrosoftSharePointSharesSharedDriveItemListItemsListItemGetActivitiesByInterval4c35 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_items_list_item_get_activities_by_interval_4c35';
    protected const DESCRIPTION = 'Invoke function getActivitiesByInterval

Official Microsoft Graph v1.0 endpoint: GET /shares/{sharedDriveItem-id}/list/items/{listItem-id}/getActivitiesByInterval().';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/list/items/{listItem-id}/getActivitiesByInterval()';
