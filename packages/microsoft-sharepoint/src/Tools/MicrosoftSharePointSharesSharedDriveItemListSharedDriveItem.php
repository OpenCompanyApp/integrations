 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /shares.
 */
class MicrosoftSharePointSharesSharedDriveItemListSharedDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_list_shared_drive_item';
    protected const DESCRIPTION = 'Accessing shared DriveItems

Official Microsoft Graph v1.0 endpoint: GET /shares.';
