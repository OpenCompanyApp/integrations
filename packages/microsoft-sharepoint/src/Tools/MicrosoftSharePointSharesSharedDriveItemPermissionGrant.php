 ...
 * Invoke action grant.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /shares/{sharedDriveItem-id}/permission/grant.
 */
class MicrosoftSharePointSharesSharedDriveItemPermissionGrant extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_permission_grant';
    protected const DESCRIPTION = 'Invoke action grant

Official Microsoft Graph v1.0 endpoint: POST /shares/{sharedDriveItem-id}/permission/grant.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/permission/grant';
