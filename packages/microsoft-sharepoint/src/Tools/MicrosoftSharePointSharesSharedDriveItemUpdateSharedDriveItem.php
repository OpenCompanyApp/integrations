 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}.
 */
class MicrosoftSharePointSharesSharedDriveItemUpdateSharedDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_shared_drive_item_update_shared_drive_item';
    protected const DESCRIPTION = 'Update entity in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}.';
