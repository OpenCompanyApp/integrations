 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PUT /shares/{sharedDriveItem-id}/driveItem/content.
 */
class MicrosoftSharePointSharesUpdateDriveItemContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_update_drive_item_content';
    protected const DESCRIPTION = 'Update content for the navigation property driveItem in shares

Official Microsoft Graph v1.0 endpoint: PUT /shares/{sharedDriveItem-id}/driveItem/content.';
