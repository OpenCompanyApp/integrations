 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /shares/{sharedDriveItem-id}/permission.
 */
class MicrosoftSharePointSharesUpdatePermission extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_shares_update_permission';
    protected const DESCRIPTION = 'Update the navigation property permission in shares

Official Microsoft Graph v1.0 endpoint: PATCH /shares/{sharedDriveItem-id}/permission.';
    ...
    protected const PATH = '/shares/{sharedDriveItem-id}/permission';
