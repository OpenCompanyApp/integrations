 ...
 * Invoke action add.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/add.
 */
class MicrosoftSharePointSitesAdd extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_add';
    protected const DESCRIPTION = 'Invoke action add

Official Microsoft Graph v1.0 endpoint: POST /sites/add.';
    ...
    protected const PATH = '/sites/add';
