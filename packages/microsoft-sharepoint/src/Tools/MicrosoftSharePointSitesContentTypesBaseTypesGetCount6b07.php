 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/contentTypes/{contentType-id}/baseTypes/$count.
 */
class MicrosoftSharePointSitesContentTypesBaseTypesGetCount6b07 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_base_types_get_count_6b07';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/contentTypes/{contentType-id}/baseTypes/$count.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/baseTypes/$count';
