 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/contentTypes/{contentType-id}/columnLinks/$count.
 */
class MicrosoftSharePointSitesContentTypesColumnLinksGetCount7bc1 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_column_links_get_count_7bc1';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/contentTypes/{contentType-id}/columnLinks/$count.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks/$count';
