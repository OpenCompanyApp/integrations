 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/contentTypes/{contentType-id}/columnPositions/$count.
 */
class MicrosoftSharePointSitesContentTypesColumnPositionsGetCountDea9 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_column_positions_get_count_dea9';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/contentTypes/{contentType-id}/columnPositions/$count.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/columnPositions/$count';
