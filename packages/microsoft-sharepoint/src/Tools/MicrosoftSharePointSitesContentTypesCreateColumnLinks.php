 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/contentTypes/{contentType-id}/columnLinks.
 */
class MicrosoftSharePointSitesContentTypesCreateColumnLinks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_create_column_links';
    protected const DESCRIPTION = 'Create new navigation property to columnLinks for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/contentTypes/{contentType-id}/columnLinks.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/columnLinks';
