 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/contentTypes/{contentType-id}/columns.
 */
class MicrosoftSharePointSitesContentTypesCreateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_create_columns';
    protected const DESCRIPTION = 'Create a columnDefinition in a content type

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/contentTypes/{contentType-id}/columns.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/columns';
