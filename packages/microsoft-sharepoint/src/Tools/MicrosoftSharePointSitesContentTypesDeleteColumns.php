 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesContentTypesDeleteColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_delete_columns';
    protected const DESCRIPTION = 'Delete columnDefinition

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}';
