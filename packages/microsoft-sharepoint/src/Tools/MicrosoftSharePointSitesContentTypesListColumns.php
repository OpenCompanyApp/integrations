 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/contentTypes/{contentType-id}/columns.
 */
class MicrosoftSharePointSitesContentTypesListColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_list_columns';
    protected const DESCRIPTION = 'List columnDefinitions in a content type

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/contentTypes/{contentType-id}/columns.';
