 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesContentTypesUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_content_types_update_columns';
    protected const DESCRIPTION = 'Update columnDefinition

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}.';
