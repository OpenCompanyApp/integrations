 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesDeleteColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_delete_columns';
    protected const DESCRIPTION = 'Delete navigation property columns for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/columns/{columnDefinition-id}.';
    ...
    protected const PATH = '/sites/{site-id}/columns/{columnDefinition-id}';
