 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/operations/{richLongRunningOperation-id}.
 */
class MicrosoftSharePointSitesDeleteOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_delete_operations';
    protected const DESCRIPTION = 'Delete navigation property operations for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/operations/{richLongRunningOperation-id}.';
