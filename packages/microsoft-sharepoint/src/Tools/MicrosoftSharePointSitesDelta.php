 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/delta().
 */
class MicrosoftSharePointSitesDelta extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_delta';
    protected const DESCRIPTION = 'Invoke function delta

Official Microsoft Graph v1.0 endpoint: GET /sites/delta().';
    ...
    protected const PATH = '/sites/delta()';
