 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesGetColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_get_columns';
    protected const DESCRIPTION = 'Get columns from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/columns/{columnDefinition-id}.';
