 ...
 * Get contentType.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/contentTypes/{contentType-id}.
 */
class MicrosoftSharePointSitesGetContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_get_content_types';
    protected const DESCRIPTION = 'Get contentType

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/contentTypes/{contentType-id}.';
