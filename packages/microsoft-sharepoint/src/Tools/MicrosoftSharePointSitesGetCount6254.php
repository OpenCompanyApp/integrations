 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/$count.
 */
class MicrosoftSharePointSitesGetCount6254 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_get_count_6254';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/$count.';
    ...
    protected const PATH = '/sites/$count';
