 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/externalColumns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesGetExternalColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_get_external_columns';
    protected const DESCRIPTION = 'Get externalColumns from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/externalColumns/{columnDefinition-id}.';
    ...
    protected const PATH = '/sites/{site-id}/externalColumns/{columnDefinition-id}';
