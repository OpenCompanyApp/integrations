 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}.
 */
class MicrosoftSharePointSitesGetLists extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_get_lists';
    protected const DESCRIPTION = 'Get metadata for a list

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}.';
