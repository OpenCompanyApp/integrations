 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/operations/{richLongRunningOperation-id}.
 */
class MicrosoftSharePointSitesGetOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_get_operations';
    protected const DESCRIPTION = 'Get richLongRunningOperation

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/operations/{richLongRunningOperation-id}.';
