 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/columns/$count.
 */
class MicrosoftSharePointSitesListsColumnsGetCount77c0 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_columns_get_count_77c0';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/columns/$count.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/columns/$count';
