 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}/sourceColumn.
 */
class MicrosoftSharePointSitesListsColumnsGetSourceColumn extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_columns_get_source_column';
    protected const DESCRIPTION = 'Get sourceColumn from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}/sourceColumn.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}/sourceColumn';
