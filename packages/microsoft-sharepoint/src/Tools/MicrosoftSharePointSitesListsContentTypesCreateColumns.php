 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns.
 */
class MicrosoftSharePointSitesListsContentTypesCreateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_create_columns';
    protected const DESCRIPTION = 'Create new navigation property to columns for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns';
