 ...
 * Get base from sites.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/base.
 */
class MicrosoftSharePointSitesListsContentTypesGetBase extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_get_base';
    protected const DESCRIPTION = 'Get base from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/base.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/base';
