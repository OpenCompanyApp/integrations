 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesListsContentTypesGetColumnPositions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_get_column_positions';
    protected const DESCRIPTION = 'Get columnPositions from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}';
