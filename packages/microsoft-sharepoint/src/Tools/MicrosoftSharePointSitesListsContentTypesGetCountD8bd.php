 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/$count.
 */
class MicrosoftSharePointSitesListsContentTypesGetCountD8bd extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_get_count_d8bd';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/$count.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/$count';
