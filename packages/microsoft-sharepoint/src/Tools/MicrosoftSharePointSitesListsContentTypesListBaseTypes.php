 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/baseTypes.
 */
class MicrosoftSharePointSitesListsContentTypesListBaseTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_list_base_types';
    protected const DESCRIPTION = 'Get baseTypes from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/baseTypes.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/baseTypes';
