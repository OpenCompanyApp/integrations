 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnLinks.
 */
class MicrosoftSharePointSitesListsContentTypesListColumnLinks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_list_column_links';
    protected const DESCRIPTION = 'Get columnLinks from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnLinks.';
