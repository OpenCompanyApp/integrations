 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns.
 */
class MicrosoftSharePointSitesListsContentTypesListColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_list_columns';
    protected const DESCRIPTION = 'Get columns from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns.';
