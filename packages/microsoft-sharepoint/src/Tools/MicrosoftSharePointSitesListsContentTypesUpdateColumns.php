 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesListsContentTypesUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_content_types_update_columns';
    protected const DESCRIPTION = 'Update the navigation property columns in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}.';
