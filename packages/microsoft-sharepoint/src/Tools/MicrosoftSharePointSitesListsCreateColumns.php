 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/columns.
 */
class MicrosoftSharePointSitesListsCreateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_create_columns';
    protected const DESCRIPTION = 'Create a columnDefinition in a list

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/columns.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/columns';
