 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/operations.
 */
class MicrosoftSharePointSitesListsCreateOperations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_create_operations';
    protected const DESCRIPTION = 'Create new navigation property to operations for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/operations.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/operations';
