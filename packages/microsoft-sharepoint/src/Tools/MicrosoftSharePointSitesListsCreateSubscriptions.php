 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/subscriptions.
 */
class MicrosoftSharePointSitesListsCreateSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_create_subscriptions';
    protected const DESCRIPTION = 'Create new navigation property to subscriptions for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/subscriptions.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/subscriptions';
