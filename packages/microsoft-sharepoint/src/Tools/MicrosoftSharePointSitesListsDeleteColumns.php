 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesListsDeleteColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_delete_columns';
    protected const DESCRIPTION = 'Delete navigation property columns for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}.';
