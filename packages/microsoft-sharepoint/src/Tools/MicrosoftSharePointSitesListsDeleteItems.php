 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}.
 */
class MicrosoftSharePointSitesListsDeleteItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_delete_items';
    protected const DESCRIPTION = 'Delete an item from a list

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}.';
