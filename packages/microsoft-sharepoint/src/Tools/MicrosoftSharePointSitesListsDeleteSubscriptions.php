 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}.
 */
class MicrosoftSharePointSitesListsDeleteSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_delete_subscriptions';
    protected const DESCRIPTION = 'Delete navigation property subscriptions for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}.';
