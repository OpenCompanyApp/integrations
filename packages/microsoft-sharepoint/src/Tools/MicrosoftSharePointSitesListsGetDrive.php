 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/drive.
 */
class MicrosoftSharePointSitesListsGetDrive extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_get_drive';
    protected const DESCRIPTION = 'Get drive from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/drive.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/drive';
