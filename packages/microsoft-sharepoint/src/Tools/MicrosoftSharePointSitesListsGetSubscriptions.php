 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}.
 */
class MicrosoftSharePointSitesListsGetSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_get_subscriptions';
    protected const DESCRIPTION = 'Get subscriptions from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}.';
