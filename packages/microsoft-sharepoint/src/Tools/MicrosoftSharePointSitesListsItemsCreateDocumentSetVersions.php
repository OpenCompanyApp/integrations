 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions.
 */
class MicrosoftSharePointSitesListsItemsCreateDocumentSetVersions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_items_create_document_set_versions';
    protected const DESCRIPTION = 'Create documentSetVersion

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions.';
