 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields.
 */
class MicrosoftSharePointSitesListsItemsDeleteFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_items_delete_fields';
    protected const DESCRIPTION = 'Delete navigation property fields for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields';
