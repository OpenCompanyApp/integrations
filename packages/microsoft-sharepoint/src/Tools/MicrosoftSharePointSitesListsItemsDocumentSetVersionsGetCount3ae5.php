 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/$count.
 */
class MicrosoftSharePointSitesListsItemsDocumentSetVersionsGetCount3ae5 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_items_document_set_versions_get_count_3ae5';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/$count.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/$count';
