 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem.
 */
class MicrosoftSharePointSitesListsItemsGetDriveItem extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_items_get_drive_item';
    protected const DESCRIPTION = 'Get driveItem from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem';
