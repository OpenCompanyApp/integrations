 ...
 * Update listItem.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields.
 */
class MicrosoftSharePointSitesListsItemsUpdateFields extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_items_update_fields';
    protected const DESCRIPTION = 'Update listItem

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/lists/{list-id}/items/{listItem-id}/fields.';
