 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/columns.
 */
class MicrosoftSharePointSitesListsListColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_list_columns';
    protected const DESCRIPTION = 'List columnDefinitions in a list

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/columns.';
