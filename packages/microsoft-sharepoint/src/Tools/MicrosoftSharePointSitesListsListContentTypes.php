 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes.
 */
class MicrosoftSharePointSitesListsListContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_list_content_types';
    protected const DESCRIPTION = 'List contentTypes in a list

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes';
