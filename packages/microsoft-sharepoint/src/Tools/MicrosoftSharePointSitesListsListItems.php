 ...
 * List items.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/items.
 */
class MicrosoftSharePointSitesListsListItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_list_items';
    protected const DESCRIPTION = 'List items

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/items.';
