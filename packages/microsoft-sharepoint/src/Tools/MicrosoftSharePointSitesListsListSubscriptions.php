 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/subscriptions.
 */
class MicrosoftSharePointSitesListsListSubscriptions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_list_subscriptions';
    protected const DESCRIPTION = 'Get subscriptions from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/subscriptions.';
