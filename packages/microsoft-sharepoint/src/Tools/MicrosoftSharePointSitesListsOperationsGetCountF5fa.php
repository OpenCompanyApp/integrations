 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/operations/$count.
 */
class MicrosoftSharePointSitesListsOperationsGetCountF5fa extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_operations_get_count_f5fa';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/operations/$count.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/operations/$count';
