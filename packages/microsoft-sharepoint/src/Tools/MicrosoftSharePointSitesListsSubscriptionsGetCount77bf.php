 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/subscriptions/$count.
 */
class MicrosoftSharePointSitesListsSubscriptionsGetCount77bf extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_subscriptions_get_count_77bf';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/subscriptions/$count.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/subscriptions/$count';
