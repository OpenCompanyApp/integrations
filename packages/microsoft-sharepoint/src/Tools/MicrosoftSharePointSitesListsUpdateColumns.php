 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesListsUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_update_columns';
    protected const DESCRIPTION = 'Update the navigation property columns in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}.';
