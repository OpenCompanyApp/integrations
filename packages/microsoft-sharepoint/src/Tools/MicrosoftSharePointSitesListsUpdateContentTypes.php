 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}.
 */
class MicrosoftSharePointSitesListsUpdateContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_update_content_types';
    protected const DESCRIPTION = 'Update the navigation property contentTypes in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}.';
