 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/lists/{list-id}/items/{listItem-id}.
 */
class MicrosoftSharePointSitesListsUpdateItems extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_lists_update_items';
    protected const DESCRIPTION = 'Update the navigation property items in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/lists/{list-id}/items/{listItem-id}.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}';
