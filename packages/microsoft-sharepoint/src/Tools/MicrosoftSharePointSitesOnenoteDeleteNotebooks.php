 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/onenote/notebooks/{notebook-id}.
 */
class MicrosoftSharePointSitesOnenoteDeleteNotebooks extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_delete_notebooks';
    protected const DESCRIPTION = 'Delete navigation property notebooks for sites
