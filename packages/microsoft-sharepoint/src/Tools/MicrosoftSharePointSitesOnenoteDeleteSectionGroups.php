 ...
 */
class MicrosoftSharePointSitesOnenoteDeleteSectionGroups extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_delete_section_groups';
