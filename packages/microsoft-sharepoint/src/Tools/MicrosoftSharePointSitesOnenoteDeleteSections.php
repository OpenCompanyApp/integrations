 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/onenote/sections/{onenoteSection-id}.
 */
class MicrosoftSharePointSitesOnenoteDeleteSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_delete_sections';
