 ...
 */
class MicrosoftSharePointSitesOnenoteGetResources extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_get_resources';
