 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups.
 */
class MicrosoftSharePointSitesOnenoteNotebooksCreateSectionGroups extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_create_section_groups';
...
Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups';
