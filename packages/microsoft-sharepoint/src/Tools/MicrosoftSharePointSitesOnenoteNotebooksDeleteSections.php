 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.
 */
class MicrosoftSharePointSitesOnenoteNotebooksDeleteSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_delete_sections';
