 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sections.
 */
class MicrosoftSharePointSitesOnenoteNotebooksListSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_list_sections';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sections.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections';
