 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}.
 */
class MicrosoftSharePointSitesOnenoteNotebooksSectionGroupsDeleteSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_section_groups_delete_sections';
    protected const DESCRIPTION = 'Delete navigation property sections for sites
