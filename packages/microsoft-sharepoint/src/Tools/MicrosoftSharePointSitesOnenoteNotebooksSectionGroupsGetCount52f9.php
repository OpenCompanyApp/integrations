 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/$count.
 */
class MicrosoftSharePointSitesOnenoteNotebooksSectionGroupsGetCount52f9 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_section_groups_get_count_52f9';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/$count.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/$count';
