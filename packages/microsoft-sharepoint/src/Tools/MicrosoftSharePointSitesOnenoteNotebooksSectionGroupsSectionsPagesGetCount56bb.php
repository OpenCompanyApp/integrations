 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/$count.
 */
class MicrosoftSharePointSitesOnenoteNotebooksSectionGroupsSectionsPagesGetCount56bb extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_section_groups_sections_pages_get_count_56bb';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/$count.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/$count';
