 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/$count.
 */
class MicrosoftSharePointSitesOnenoteNotebooksSectionsGetCount6101 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_sections_get_count_6101';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/$count.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/$count';
