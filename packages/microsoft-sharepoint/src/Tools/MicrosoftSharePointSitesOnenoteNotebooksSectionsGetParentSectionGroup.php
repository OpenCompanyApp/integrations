 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup.
 */
class MicrosoftSharePointSitesOnenoteNotebooksSectionsGetParentSectionGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_sections_get_parent_section_group';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}/parentSectionGroup';
