 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.
 */
class MicrosoftSharePointSitesOnenoteNotebooksUpdateSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_notebooks_update_sections';
...
Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}';
