 ...
 */
class MicrosoftSharePointSitesOnenoteSectionGroupsCreateSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_section_groups_create_sections';
