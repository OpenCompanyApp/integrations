 ...
 */
class MicrosoftSharePointSitesOnenoteSectionGroupsSectionGroupsGetCount2fdb extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_section_groups_section_groups_get_count_2fdb';
