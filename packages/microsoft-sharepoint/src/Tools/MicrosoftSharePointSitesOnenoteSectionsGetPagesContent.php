 ...
 */
class MicrosoftSharePointSitesOnenoteSectionsGetPagesContent extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_sections_get_pages_content';
