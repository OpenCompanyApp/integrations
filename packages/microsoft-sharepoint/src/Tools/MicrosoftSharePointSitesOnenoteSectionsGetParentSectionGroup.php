 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup.
 */
class MicrosoftSharePointSitesOnenoteSectionsGetParentSectionGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_sections_get_parent_section_group';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/sections/{onenoteSection-id}/parentSectionGroup';
