 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/sections/{onenoteSection-id}/pages.
 */
class MicrosoftSharePointSitesOnenoteSectionsListPages extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_sections_list_pages';
