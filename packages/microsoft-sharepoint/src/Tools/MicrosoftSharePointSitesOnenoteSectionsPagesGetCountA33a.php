 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/$count.
 */
class MicrosoftSharePointSitesOnenoteSectionsPagesGetCountA33a extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_sections_pages_get_count_a33a';
...
Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/$count.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/sections/{onenoteSection-id}/pages/$count';
