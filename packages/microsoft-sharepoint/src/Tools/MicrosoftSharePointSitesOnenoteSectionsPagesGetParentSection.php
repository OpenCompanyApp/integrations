 ...
 */
class MicrosoftSharePointSitesOnenoteSectionsPagesGetParentSection extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_sections_pages_get_parent_section';
