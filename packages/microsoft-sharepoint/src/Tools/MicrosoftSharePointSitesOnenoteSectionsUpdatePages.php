 ...
 */
class MicrosoftSharePointSitesOnenoteSectionsUpdatePages extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_sections_update_pages';
