 ...
 */
class MicrosoftSharePointSitesOnenoteUpdateResources extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_update_resources';
