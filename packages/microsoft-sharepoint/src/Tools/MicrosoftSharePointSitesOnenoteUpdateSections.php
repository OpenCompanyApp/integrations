 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/onenote/sections/{onenoteSection-id}.
 */
class MicrosoftSharePointSitesOnenoteUpdateSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_onenote_update_sections';
...
Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/onenote/sections/{onenoteSection-id}.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/sections/{onenoteSection-id}';
