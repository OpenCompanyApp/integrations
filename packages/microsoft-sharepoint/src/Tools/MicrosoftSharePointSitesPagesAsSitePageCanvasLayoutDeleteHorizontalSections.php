 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/horizontalSections/{horizontalSection-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageCanvasLayoutDeleteHorizontalSections extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_canvas_layout_delete_horizontal_sections';
    protected const DESCRIPTION = 'Delete navigation property horizontalSections for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/horizontalSections/{horizontalSection-id}.';
