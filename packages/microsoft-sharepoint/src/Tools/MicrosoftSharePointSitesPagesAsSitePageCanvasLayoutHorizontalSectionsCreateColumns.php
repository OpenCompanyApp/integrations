 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/horizontalSections/{horizontalSection-id}/columns.
 */
class MicrosoftSharePointSitesPagesAsSitePageCanvasLayoutHorizontalSectionsCreateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_canvas_layout_horizontal_sections_create_columns';
    protected const DESCRIPTION = 'Create new navigation property to columns for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/horizontalSections/{horizontalSection-id}/columns.';
