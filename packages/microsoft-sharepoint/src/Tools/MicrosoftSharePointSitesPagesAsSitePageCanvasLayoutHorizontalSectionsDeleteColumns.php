 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/horizontalSections/{horizontalSection-id}/columns/{horizontalSectionColumn-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageCanvasLayoutHorizontalSectionsDeleteColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_canvas_layout_horizontal_sections_delete_columns';
    protected const DESCRIPTION = 'Delete navigation property columns for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/horizontalSections/{horizontalSection-id}/columns/{horizontalSectionColumn-id}.';
