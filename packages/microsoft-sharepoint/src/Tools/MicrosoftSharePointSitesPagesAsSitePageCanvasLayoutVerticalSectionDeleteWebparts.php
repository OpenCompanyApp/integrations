 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageCanvasLayoutVerticalSectionDeleteWebparts extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_canvas_layout_vertical_section_delete_webparts';
    protected const DESCRIPTION = 'Delete navigation property webparts for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}.';
    ...
    protected const PATH = '/sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}';
