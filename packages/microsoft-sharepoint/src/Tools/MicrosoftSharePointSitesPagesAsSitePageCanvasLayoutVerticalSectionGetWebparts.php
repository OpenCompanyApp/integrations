 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageCanvasLayoutVerticalSectionGetWebparts extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_canvas_layout_vertical_section_get_webparts';
    protected const DESCRIPTION = 'Get webparts from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}.';
