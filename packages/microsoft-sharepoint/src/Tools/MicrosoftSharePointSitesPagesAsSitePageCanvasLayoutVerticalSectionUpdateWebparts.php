 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageCanvasLayoutVerticalSectionUpdateWebparts extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_canvas_layout_vertical_section_update_webparts';
    protected const DESCRIPTION = 'Update the navigation property webparts in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart-id}.';
