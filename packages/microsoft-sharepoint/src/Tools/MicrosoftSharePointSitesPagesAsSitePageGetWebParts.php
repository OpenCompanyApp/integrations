 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageGetWebParts extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_get_web_parts';
    protected const DESCRIPTION = 'Get webParts from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}.';
