 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}.
 */
class MicrosoftSharePointSitesPagesAsSitePageUpdateWebParts extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_pages_as_site_page_update_web_parts';
    protected const DESCRIPTION = 'Update the navigation property webParts in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}.';
