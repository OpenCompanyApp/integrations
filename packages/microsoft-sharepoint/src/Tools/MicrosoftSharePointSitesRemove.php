 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/remove.
 */
class MicrosoftSharePointSitesRemove extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_remove';
    protected const DESCRIPTION = 'Invoke action remove

Official Microsoft Graph v1.0 endpoint: POST /sites/remove.';
    ...
    protected const PATH = '/sites/remove';
