 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/contentTypes/{contentType-id}/copyToDefaultContentLocation.
 */
class MicrosoftSharePointSitesSiteContentTypesContentTypeCopyToDefaultContentLocation extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_content_types_content_type_copy_to_default_content_location';
    protected const DESCRIPTION = 'Invoke action copyToDefaultContentLocation

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/contentTypes/{contentType-id}/copyToDefaultContentLocation.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/copyToDefaultContentLocation';
