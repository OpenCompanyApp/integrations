 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/contentTypes/{contentType-id}/isPublished().
 */
class MicrosoftSharePointSitesSiteContentTypesContentTypeIsPublished extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_content_types_content_type_is_published';
    protected const DESCRIPTION = 'Invoke function isPublished

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/contentTypes/{contentType-id}/isPublished().';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/isPublished()';
