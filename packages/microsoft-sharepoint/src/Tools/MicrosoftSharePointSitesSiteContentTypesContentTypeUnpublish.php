 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/contentTypes/{contentType-id}/unpublish.
 */
class MicrosoftSharePointSitesSiteContentTypesContentTypeUnpublish extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_content_types_content_type_unpublish';
    protected const DESCRIPTION = 'Invoke action unpublish

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/contentTypes/{contentType-id}/unpublish.';
    ...
    protected const PATH = '/sites/{site-id}/contentTypes/{contentType-id}/unpublish';
