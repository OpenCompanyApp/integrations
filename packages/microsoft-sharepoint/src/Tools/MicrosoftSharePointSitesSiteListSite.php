 ...
 * List sites.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites.
 */
class MicrosoftSharePointSitesSiteListSite extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_list_site';
    protected const DESCRIPTION = 'List sites

Official Microsoft Graph v1.0 endpoint: GET /sites.';
