 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/contentTypes/addCopy.
 */
class MicrosoftSharePointSitesSiteListsListContentTypesAddCopy extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_content_types_add_copy';
    protected const DESCRIPTION = 'Invoke action addCopy

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/contentTypes/addCopy.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/addCopy';
