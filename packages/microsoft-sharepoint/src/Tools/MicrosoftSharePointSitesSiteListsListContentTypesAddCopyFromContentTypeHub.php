 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/contentTypes/addCopyFromContentTypeHub.
 */
class MicrosoftSharePointSitesSiteListsListContentTypesAddCopyFromContentTypeHub extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_content_types_add_copy_from_content_type_hub';
    protected const DESCRIPTION = 'Invoke action addCopyFromContentTypeHub

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/contentTypes/addCopyFromContentTypeHub.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/addCopyFromContentTypeHub';
