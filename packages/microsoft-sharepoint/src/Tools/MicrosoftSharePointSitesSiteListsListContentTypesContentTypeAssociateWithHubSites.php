 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/associateWithHubSites.
 */
class MicrosoftSharePointSitesSiteListsListContentTypesContentTypeAssociateWithHubSites extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_content_types_content_type_associate_with_hub_sites';
    protected const DESCRIPTION = 'Invoke action associateWithHubSites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/associateWithHubSites.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/associateWithHubSites';
