 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/publish.
 */
class MicrosoftSharePointSitesSiteListsListContentTypesContentTypePublish extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_content_types_content_type_publish';
    protected const DESCRIPTION = 'Invoke action publish

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/publish.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/publish';
