 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/contentTypes/getCompatibleHubContentTypes().
 */
class MicrosoftSharePointSitesSiteListsListContentTypesGetCompatibleHubContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_content_types_get_compatible_hub_content_types';
    protected const DESCRIPTION = 'Invoke function getCompatibleHubContentTypes

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/contentTypes/getCompatibleHubContentTypes().';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/contentTypes/getCompatibleHubContentTypes()';
