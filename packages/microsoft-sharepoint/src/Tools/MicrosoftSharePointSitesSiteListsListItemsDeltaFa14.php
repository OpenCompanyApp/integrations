 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/lists/{list-id}/items/delta().
 */
class MicrosoftSharePointSitesSiteListsListItemsDeltaFa14 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_items_delta_fa14';
    protected const DESCRIPTION = 'Invoke function delta

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/lists/{list-id}/items/delta().';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/delta()';
