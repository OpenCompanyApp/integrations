 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/createLink.
 */
class MicrosoftSharePointSitesSiteListsListItemsListItemCreateLink extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_items_list_item_create_link';
    protected const DESCRIPTION = 'Invoke action createLink

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/createLink.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/createLink';
