 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}/restore.
 */
class MicrosoftSharePointSitesSiteListsListItemsListItemDocumentSetVersionsDocumentSetVersionRestore extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_items_list_item_document_set_versions_document_set_version_restore';
    protected const DESCRIPTION = 'Invoke action restore

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}/restore.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}/restore';
