 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}/reauthorize.
 */
class MicrosoftSharePointSitesSiteListsListSubscriptionsSubscriptionReauthorize extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_lists_list_subscriptions_subscription_reauthorize';
    protected const DESCRIPTION = 'Invoke action reauthorize

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}/reauthorize.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}/reauthorize';
