 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/onenote/notebooks/{notebook-id}/copyNotebook.
 */
class MicrosoftSharePointSitesSiteOnenoteNotebooksNotebookCopyNotebook extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_onenote_notebooks_notebook_copy_notebook';
...
Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/onenote/notebooks/{notebook-id}/copyNotebook.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/notebooks/{notebook-id}/copyNotebook';
