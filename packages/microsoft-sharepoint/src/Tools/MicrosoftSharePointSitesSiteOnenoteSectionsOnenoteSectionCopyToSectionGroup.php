 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/onenote/sections/{onenoteSection-id}/copyToSectionGroup.
 */
class MicrosoftSharePointSitesSiteOnenoteSectionsOnenoteSectionCopyToSectionGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_onenote_sections_onenote_section_copy_to_section_group';
...
Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/onenote/sections/{onenoteSection-id}/copyToSectionGroup.';
    ...
    protected const PATH = '/sites/{site-id}/onenote/sections/{onenoteSection-id}/copyToSectionGroup';
