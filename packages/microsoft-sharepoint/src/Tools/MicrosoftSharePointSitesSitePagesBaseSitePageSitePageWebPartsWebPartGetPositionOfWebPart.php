 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}/getPositionOfWebPart.
 */
class MicrosoftSharePointSitesSitePagesBaseSitePageSitePageWebPartsWebPartGetPositionOfWebPart extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_pages_base_site_page_site_page_web_parts_web_part_get_position_of_web_part';
    protected const DESCRIPTION = 'Invoke action getPositionOfWebPart

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}/getPositionOfWebPart.';
    ...
    protected const PATH = '/sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/webParts/{webPart-id}/getPositionOfWebPart';
