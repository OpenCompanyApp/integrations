 ...
 * Invoke action grant.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/permissions/{permission-id}/grant.
 */
class MicrosoftSharePointSitesSitePermissionsPermissionGrant extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_site_permissions_permission_grant';
    protected const DESCRIPTION = 'Invoke action grant

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/permissions/{permission-id}/grant.';
    ...
    protected const PATH = '/sites/{site-id}/permissions/{permission-id}/grant';
