 ...
 * Get set.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}.
 */
class MicrosoftSharePointSitesTermStoreGetSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_get_sets';
    protected const DESCRIPTION = 'Get set

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}.';
