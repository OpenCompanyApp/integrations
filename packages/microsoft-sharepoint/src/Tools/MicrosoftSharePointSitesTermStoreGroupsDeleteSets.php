 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}.
 */
class MicrosoftSharePointSitesTermStoreGroupsDeleteSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_delete_sets';
    protected const DESCRIPTION = 'Delete navigation property sets for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}.';
