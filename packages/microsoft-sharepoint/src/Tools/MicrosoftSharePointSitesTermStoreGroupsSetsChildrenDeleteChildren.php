 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children/{term-id1}.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsChildrenDeleteChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_children_delete_children';
    protected const DESCRIPTION = 'Delete navigation property children for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children/{term-id1}.';
