 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/relations/{relation-id}.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsChildrenDeleteRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_children_delete_relations';
    protected const DESCRIPTION = 'Delete navigation property relations for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/relations/{relation-id}.';
