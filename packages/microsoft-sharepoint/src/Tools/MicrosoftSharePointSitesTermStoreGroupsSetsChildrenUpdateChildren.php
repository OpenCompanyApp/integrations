 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children/{term-id1}.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsChildrenUpdateChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_children_update_children';
    protected const DESCRIPTION = 'Update the navigation property children in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children/{term-id1}.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children/{term-id1}';
