 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/relations.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsCreateRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_create_relations';
    protected const DESCRIPTION = 'Create new navigation property to relations for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/relations.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/relations';
