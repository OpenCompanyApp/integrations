 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/terms.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsCreateTerms extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_create_terms';
    protected const DESCRIPTION = 'Create new navigation property to terms for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/terms.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/terms';
