 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/parentGroup.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsDeleteParentGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_delete_parent_group';
    protected const DESCRIPTION = 'Delete navigation property parentGroup for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/parentGroup.';
