 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/parentGroup.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsGetParentGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_get_parent_group';
    protected const DESCRIPTION = 'Get parentGroup from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/parentGroup.';
