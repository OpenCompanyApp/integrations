 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/relations/$count.
 */
class MicrosoftSharePointSitesTermStoreGroupsSetsRelationsGetCountEfa1 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_sets_relations_get_count_efa1';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/relations/$count.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/relations/$count';
