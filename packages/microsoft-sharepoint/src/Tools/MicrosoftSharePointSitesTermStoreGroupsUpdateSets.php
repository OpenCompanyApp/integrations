 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}.
 */
class MicrosoftSharePointSitesTermStoreGroupsUpdateSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_groups_update_sets';
    protected const DESCRIPTION = 'Update the navigation property sets in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}.';
