 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/children/$count.
 */
class MicrosoftSharePointSitesTermStoreSetsChildrenChildrenGetCountCa80 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_children_children_get_count_ca80';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/children/$count.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/children/$count';
