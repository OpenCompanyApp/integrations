 ...
 * Create term.
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStore/sets/{set-id}/children.
 */
class MicrosoftSharePointSitesTermStoreSetsCreateChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_create_children';
    protected const DESCRIPTION = 'Create term

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStore/sets/{set-id}/children.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/children';
