 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup.
 */
class MicrosoftSharePointSitesTermStoreSetsDeleteParentGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_delete_parent_group';
    protected const DESCRIPTION = 'Delete navigation property parentGroup for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup.';
