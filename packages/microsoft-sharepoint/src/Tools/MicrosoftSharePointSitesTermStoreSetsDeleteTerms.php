 ...
 * Delete term.
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}.
 */
class MicrosoftSharePointSitesTermStoreSetsDeleteTerms extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_delete_terms';
    protected const DESCRIPTION = 'Delete term

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}.';
