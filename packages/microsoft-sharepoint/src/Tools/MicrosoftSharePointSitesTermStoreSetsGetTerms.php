 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}.
 */
class MicrosoftSharePointSitesTermStoreSetsGetTerms extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_get_terms';
    protected const DESCRIPTION = 'Get terms from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}.';
