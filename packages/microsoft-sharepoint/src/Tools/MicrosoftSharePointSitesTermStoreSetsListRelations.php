 ...
 * List relations.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/relations.
 */
class MicrosoftSharePointSitesTermStoreSetsListRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_list_relations';
    protected const DESCRIPTION = 'List relations

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/relations.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/relations';
