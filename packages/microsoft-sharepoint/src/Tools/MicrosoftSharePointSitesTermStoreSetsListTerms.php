 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/terms.
 */
class MicrosoftSharePointSitesTermStoreSetsListTerms extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_list_terms';
    protected const DESCRIPTION = 'Get terms from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/terms.';
