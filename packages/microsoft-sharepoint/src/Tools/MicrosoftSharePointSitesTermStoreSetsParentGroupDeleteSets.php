 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}.
 */
class MicrosoftSharePointSitesTermStoreSetsParentGroupDeleteSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_parent_group_delete_sets';
    protected const DESCRIPTION = 'Delete navigation property sets for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}.';
