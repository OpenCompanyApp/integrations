 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}/children.
 */
class MicrosoftSharePointSitesTermStoreSetsParentGroupSetsChildrenCreateChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_parent_group_sets_children_create_children';
    protected const DESCRIPTION = 'Create new navigation property to children for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}/children.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}/children';
