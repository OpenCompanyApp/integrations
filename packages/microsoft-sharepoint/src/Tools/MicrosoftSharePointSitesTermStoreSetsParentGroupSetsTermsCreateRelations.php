 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations.
 */
class MicrosoftSharePointSitesTermStoreSetsParentGroupSetsTermsCreateRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_parent_group_sets_terms_create_relations';
    protected const DESCRIPTION = 'Create new navigation property to relations for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations';
