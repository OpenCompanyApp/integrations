 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations/{relation-id}.
 */
class MicrosoftSharePointSitesTermStoreSetsParentGroupSetsTermsDeleteRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_parent_group_sets_terms_delete_relations';
    protected const DESCRIPTION = 'Delete navigation property relations for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations/{relation-id}.';
