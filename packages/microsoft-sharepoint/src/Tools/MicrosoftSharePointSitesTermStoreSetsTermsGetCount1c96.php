 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/terms/$count.
 */
class MicrosoftSharePointSitesTermStoreSetsTermsGetCount1c96 extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_terms_get_count_1c96';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/terms/$count.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/terms/$count';
