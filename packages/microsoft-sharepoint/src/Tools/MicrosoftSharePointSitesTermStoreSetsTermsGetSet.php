 ...
 * Get set from sites.
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/set.
 */
class MicrosoftSharePointSitesTermStoreSetsTermsGetSet extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_terms_get_set';
    protected const DESCRIPTION = 'Get set from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/set.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/set';
