 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations/$count.
 */
class MicrosoftSharePointSitesTermStoreSetsTermsRelationsGetCount017f extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_sets_terms_relations_get_count_017f';
    protected const DESCRIPTION = 'Get the number of the resource

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations/$count.';
    ...
    protected const PATH = '/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations/$count';
