 ...
 * Update set.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStore/sets/{set-id}.
 */
class MicrosoftSharePointSitesTermStoreUpdateSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_store_update_sets';
    protected const DESCRIPTION = 'Update set

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStore/sets/{set-id}.';
