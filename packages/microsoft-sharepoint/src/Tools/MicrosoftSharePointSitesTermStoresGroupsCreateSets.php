 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets.
 */
class MicrosoftSharePointSitesTermStoresGroupsCreateSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_groups_create_sets';
    protected const DESCRIPTION = 'Create new navigation property to sets for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets.';
    ...
    protected const PATH = '/sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets';
