 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}.
 */
class MicrosoftSharePointSitesTermStoresGroupsDeleteSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_groups_delete_sets';
    protected const DESCRIPTION = 'Delete navigation property sets for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}.';
