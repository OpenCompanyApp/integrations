 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations.
 */
class MicrosoftSharePointSitesTermStoresGroupsSetsCreateRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_groups_sets_create_relations';
    protected const DESCRIPTION = 'Create new navigation property to relations for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations.';
    ...
    protected const PATH = '/sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations';
