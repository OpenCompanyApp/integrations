 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint GET /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations/{relation-id}/fromTerm.
 */
class MicrosoftSharePointSitesTermStoresGroupsSetsRelationsGetFromTerm extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_groups_sets_relations_get_from_term';
    protected const DESCRIPTION = 'Get fromTerm from sites

Official Microsoft Graph v1.0 endpoint: GET /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations/{relation-id}/fromTerm.';
    ...
    protected const PATH = '/sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations/{relation-id}/fromTerm';
