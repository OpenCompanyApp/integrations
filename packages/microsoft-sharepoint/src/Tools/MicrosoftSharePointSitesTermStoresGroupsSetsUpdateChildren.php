 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/children/{term-id}.
 */
class MicrosoftSharePointSitesTermStoresGroupsSetsUpdateChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_groups_sets_update_children';
    protected const DESCRIPTION = 'Update the navigation property children in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/children/{term-id}.';
