 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations/{relation-id}.
 */
class MicrosoftSharePointSitesTermStoresGroupsSetsUpdateRelations extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_groups_sets_update_relations';
    protected const DESCRIPTION = 'Update the navigation property relations in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/relations/{relation-id}.';
