 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint POST /sites/{site-id}/termStores/{store-id}/sets/{set-id}/terms.
 */
class MicrosoftSharePointSitesTermStoresSetsCreateTerms extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_sets_create_terms';
    protected const DESCRIPTION = 'Create new navigation property to terms for sites

Official Microsoft Graph v1.0 endpoint: POST /sites/{site-id}/termStores/{store-id}/sets/{set-id}/terms.';
    ...
    protected const PATH = '/sites/{site-id}/termStores/{store-id}/sets/{set-id}/terms';
