 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup.
 */
class MicrosoftSharePointSitesTermStoresSetsDeleteParentGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_sets_delete_parent_group';
    protected const DESCRIPTION = 'Delete navigation property parentGroup for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup.';
