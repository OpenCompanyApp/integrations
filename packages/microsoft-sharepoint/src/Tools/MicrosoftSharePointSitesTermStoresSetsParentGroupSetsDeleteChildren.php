 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint DELETE /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}.
 */
class MicrosoftSharePointSitesTermStoresSetsParentGroupSetsDeleteChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_sets_parent_group_sets_delete_children';
    protected const DESCRIPTION = 'Delete navigation property children for sites

Official Microsoft Graph v1.0 endpoint: DELETE /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}.';
