 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}.
 */
class MicrosoftSharePointSitesTermStoresSetsParentGroupSetsUpdateChildren extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_sets_parent_group_sets_update_children';
    protected const DESCRIPTION = 'Update the navigation property children in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}.';
    ...
    protected const PATH = '/sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}';
