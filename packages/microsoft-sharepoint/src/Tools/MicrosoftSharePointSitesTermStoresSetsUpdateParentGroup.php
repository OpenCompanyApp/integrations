 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup.
 */
class MicrosoftSharePointSitesTermStoresSetsUpdateParentGroup extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_sets_update_parent_group';
    protected const DESCRIPTION = 'Update the navigation property parentGroup in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup.';
    ...
    protected const PATH = '/sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup';
