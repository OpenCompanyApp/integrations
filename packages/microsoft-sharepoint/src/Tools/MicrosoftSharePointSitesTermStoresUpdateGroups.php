 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStores/{store-id}/groups/{group-id}.
 */
class MicrosoftSharePointSitesTermStoresUpdateGroups extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_update_groups';
    protected const DESCRIPTION = 'Update the navigation property groups in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStores/{store-id}/groups/{group-id}.';
