 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/termStores/{store-id}/sets/{set-id}.
 */
class MicrosoftSharePointSitesTermStoresUpdateSets extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_term_stores_update_sets';
    protected const DESCRIPTION = 'Update the navigation property sets in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/termStores/{store-id}/sets/{set-id}.';
