 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/columns/{columnDefinition-id}.
 */
class MicrosoftSharePointSitesUpdateColumns extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_update_columns';
    protected const DESCRIPTION = 'Update the navigation property columns in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/columns/{columnDefinition-id}.';
