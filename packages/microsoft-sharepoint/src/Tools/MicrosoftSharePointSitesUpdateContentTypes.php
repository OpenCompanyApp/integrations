 ...
 * Update contentType.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/contentTypes/{contentType-id}.
 */
class MicrosoftSharePointSitesUpdateContentTypes extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_update_content_types';
    protected const DESCRIPTION = 'Update contentType

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/contentTypes/{contentType-id}.';
