 ...
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/lists/{list-id}.
 */
class MicrosoftSharePointSitesUpdateLists extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_update_lists';
    protected const DESCRIPTION = 'Update the navigation property lists in sites

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/lists/{list-id}.';
    ...
    protected const PATH = '/sites/{site-id}/lists/{list-id}';
