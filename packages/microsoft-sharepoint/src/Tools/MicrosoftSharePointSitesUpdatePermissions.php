 ...
 * Update permission.
 *
 * Maps to Microsoft Graph v1.0 endpoint PATCH /sites/{site-id}/permissions/{permission-id}.
 */
class MicrosoftSharePointSitesUpdatePermissions extends AbstractMicrosoftSharePointTool
{
    protected const NAME = 'microsoft_sharepoint_sites_update_permissions';
    protected const DESCRIPTION = 'Update permission

Official Microsoft Graph v1.0 endpoint: PATCH /sites/{site-id}/permissions/{permission-id}.';
