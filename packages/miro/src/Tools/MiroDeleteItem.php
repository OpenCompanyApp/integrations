 ...
 *
 * Maps to the official Miro endpoint DELETE /v2/boards/{board_id}/items/{item_id}.
 */
class MiroDeleteItem extends AbstractMiroTool
{
    protected const NAME = 'miro_delete_item';
    protected const DESCRIPTION = 'Deletes an item from a board. Required scope boards:write Rate limiting Level 3

Official Miro endpoint: DELETE /v2/boards/{board_id}/items/{item_id}.';
