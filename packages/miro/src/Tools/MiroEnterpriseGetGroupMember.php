 ...
 *
 * Maps to the official Miro endpoint GET /v2/orgs/{org_id}/groups/{group_id}/members/{member_id}.
 */
class MiroEnterpriseGetGroupMember extends AbstractMiroTool
{
    protected const NAME = 'miro_enterprise_get_group_member';
    protected const DESCRIPTION = 'Retrieves information about a user group member in an organization. Required scope organizations:groups:read Rate limiting Level 1 Enterprise only This API is available only for Enterprise plan users. You can only use this endpoint if you have the role of a Company Admin. You can request temporary access to Enterprise APIs using this form.

Official Miro endpoint: GET /v2/orgs/{org_id}/groups/{group_id}/members/{member_id}.';
