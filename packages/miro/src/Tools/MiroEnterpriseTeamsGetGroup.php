 ...
 *
 * Maps to the official Miro endpoint GET /v2/orgs/{org_id}/teams/{team_id}/groups/{group_id}.
 */
class MiroEnterpriseTeamsGetGroup extends AbstractMiroTool
{
    protected const NAME = 'miro_enterprise_teams_get_group';
    protected const DESCRIPTION = 'Retrieves information about a specific user group of a team. Required scope organizations:groups:read organizations:teams:read Rate limiting Level 1 Enterprise only This API is available only for Enterprise plan users. You can only use this endpoint if you have the role of a Company Admin. You can request temporary access to Enterprise APIs using this form.

Official Miro endpoint: GET /v2/orgs/{org_id}/teams/{team_id}/groups/{group_id}.';
