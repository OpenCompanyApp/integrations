 ...
 *
 * Maps to the official Miro endpoint GET /v2-experimental/boards/{board_id}/items.
 */
class MiroGetItemsExperimental extends AbstractMiroTool
{
    protected const NAME = 'miro_get_items_experimental';
...
Official Miro endpoint: GET /v2-experimental/boards/{board_id}/items.';
    ...
    protected const PATH = '/v2-experimental/boards/{board_id}/items';
