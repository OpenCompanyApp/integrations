 ...
 *
 * Maps to the official Miro endpoint GET /v2/orgs/{org_id}/cases/{case_id}/legal-holds/{legal_hold_id}.
 */
class MiroGetLegalHold extends AbstractMiroTool
{
    protected const NAME = 'miro_get_legal_hold';
    protected const DESCRIPTION = 'Retrieves information about a legal hold within a case for an organization. Required scope organization:cases:management Rate limiting Level 3 Enterprise Guard only This API is available only for Enterprise plan users with the Enterprise Guard add-on. You can only use this endpoint if you have both the Company Admin and eDiscovery Admin roles.

Official Miro endpoint: GET /v2/orgs/{org_id}/cases/{case_id}/legal-holds/{legal_hold_id}.';
