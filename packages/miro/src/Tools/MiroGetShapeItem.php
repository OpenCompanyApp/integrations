 ...
 *
 * Maps to the official Miro endpoint GET /v2/boards/{board_id}/shapes/{item_id}.
 */
class MiroGetShapeItem extends AbstractMiroTool
{
    protected const NAME = 'miro_get_shape_item';
...
Official Miro endpoint: GET /v2/boards/{board_id}/shapes/{item_id}.';
