# Modern Treasury JavaScript Docs
...
```js
var accounts = app.integrations["modern-treasury"].modern_treasury_list_ledger_accounts({ per_page: 25 })
var account = app.integrations["modern-treasury"].modern_treasury_get_ledger_account({ id: "ledger_account_123" })
```
## Coverage Notes
