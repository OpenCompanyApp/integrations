...
```ruby
accounts = app.call("integrations.modern-treasury.list_ledger_accounts", per_page: 25)
account = app.call("integrations.modern-treasury.get_ledger_account", id: "ledger_account_123")
```
## Coverage Notes
