 ...
 *
 * Maps to the official Modern Treasury endpoint post /api/{accounts_type}/{account_id}/routing_details.
 */
class ModernTreasuryCreateRoutingDetail extends AbstractModernTreasuryTool
{
    protected const NAME = 'modern_treasury_create_routing_detail';
    protected const DESCRIPTION = 'create routing_detail

Official Modern Treasury endpoint: POST /api/{accounts_type}/{account_id}/routing_details
