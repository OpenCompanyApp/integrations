 ...
 *
 * Maps to the official Modern Treasury endpoint get /api/{accounts_type}/{account_id}/account_details.
 */
class ModernTreasuryListAccountDetails extends AbstractModernTreasuryTool
{
    protected const NAME = 'modern_treasury_list_account_details';
    protected const DESCRIPTION = 'list account_details

Official Modern Treasury endpoint: GET /api/{accounts_type}/{account_id}/account_details
