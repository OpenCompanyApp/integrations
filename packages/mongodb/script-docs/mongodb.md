# MongoDB Atlas Data API JavaScript Reference
...
```js
var result = app.integrations.mongodb.find({
  database: "app",
...
```js
var result = app.integrations.mongodb.find_one({
  database: "app",
  collection: "customers",
...
```js
var result = app.integrations.mongodb.insert_one({
  database: "app",
  collection: "customers",
...
```js
var result = app.integrations.mongodb.insert_many({
  database: "app",
  collection: "events",
  documents: [
...
```js
var result = app.integrations.mongodb.update_one({
  database: "app",
  collection: "customers",
  filter: { email: "person@example.test" },
...
```js
var result = app.integrations.mongodb.update_many({
  database: "app",
  collection: "customers",
  filter: { status: "trial" },
...
```js
var result = app.integrations.mongodb.delete_one({
  database: "app",
  collection: "customers",
  filter: { email: "person@example.test" },
})
...
```js
var result = app.integrations.mongodb.delete_many({
  database: "app",
  collection: "sessions",
  filter: { expired: true },
})
...
```js
var result = app.integrations.mongodb.aggregate({
  database: "app",
  collection: "events",
  pipeline: [
    { ["$match"]: { type: "signup" } },
