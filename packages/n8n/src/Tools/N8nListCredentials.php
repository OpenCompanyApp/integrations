 ...
 */
class N8nListCredentials implements Tool
{
    ...
    {
        return 'List n8n credentials. Supports pagination with cursor and limit parameters.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'limit' => ['type' => 'integer', 'description' => 'Maximum number of credentials to return. Default: 100.'],
        ];
    }

    /**
     * Retrieve credentials with optional pagination.
     *
    ...
    public function execute(array $args): ToolResult
    {
        ...
        try {
            ...
            $result = $this->service->listCredentials($params);
