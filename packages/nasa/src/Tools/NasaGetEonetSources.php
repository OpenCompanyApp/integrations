...
/**
 * List EONET v3 natural event sources.
 */
class NasaGetEonetSources implements Tool
{
    /**
    ...
    {
        return 'nasa_get_eonet_sources';
    }

    public function description(): string
    {
        return 'List NASA EONET v3 natural event sources for filtering event searches.';
    }
    ...
    {
        try {
            return ToolResult::success($this->service->getEonetSources());
        } catch (\Throwable $e) {
