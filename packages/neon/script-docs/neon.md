...
```ruby
projects = app.integrations.neon.list_projects()
project = app.integrations.neon.retrieve_project_details(project_id: "example-project-id")
branches = app.integrations.neon.list_branches(project_id: "example-project-id")
```
