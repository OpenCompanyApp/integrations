...
```ruby
ai = app.integrations.newsapi.everything(q: "\"artificial intelligence\" OR LLM", language: "en", sort_by: "publishedAt", page_size: 20)
headlines = app.integrations.newsapi.top_headlines(country: "us", category: "technology", page_size: 10)
sources = app.integrations.newsapi.sources(language: "en", country: "us")
```