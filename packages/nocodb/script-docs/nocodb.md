# NocoDB — JavaScript API Reference
...
```js
var result = app.integrations.nocodb.nocodb_list_records({
  table_id: "tbxyz123",
...
```js
var result = app.integrations.nocodb.nocodb_create_record({
  table_id: "tbxyz123",
...
```js
var result = app.integrations.nocodb.nocodb_batch_create({
  table_id: "tbxyz123",
...
app.integrations.nocodb.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.nocodb.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.nocodb.work.function_name({ /* parameters */ })
app.integrations.nocodb.personal.function_name({ /* parameters */ })
```
