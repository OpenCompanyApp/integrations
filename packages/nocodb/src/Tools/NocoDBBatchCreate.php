 ...
 */
class NocoDBBatchCreate implements Tool
{
    /**
    ...
    {
        return 'nocodb_batch_create';
    }

    public function description(): string
    {
        return 'Create multiple records in a single NocoDB API request.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'records'  => ['type' => 'string', 'required' => true, 'description' => 'JSON array of record objects (e.g., [{"Name":"Alice"},{"Name":"Bob"}]).'],
        ];
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->batchCreate($tableId, $recordsArray);
