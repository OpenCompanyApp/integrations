...
class NotionListDatabases implements Tool
{
    ...
    public function name(): string { return 'notion2_list_databases'; }
    public function description(): string { return 'List databases in your Notion workspace.'; }

    public function parameters(): array
    {
        return [
            'query'        => ['type' => 'string',  'description' => 'Search query to filter databases by title.'],
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $databases = $this->service->listDatabases($params);
