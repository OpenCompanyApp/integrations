...
```ruby
kev = app.integrations.nvd.cves(has_kev: true, no_rejected: true, results_per_page: 20)
cve = app.integrations.nvd.cve_by_id(cve_id: "CVE-2024-12345")
cpe = app.integrations.nvd.cpes(keyword_search: "nginx", results_per_page: 10)
```
