...
/**
 * Call a relative Microsoft Graph PATCH endpoint.
 *
 * Intended for official OneDrive/Graph endpoints not yet wrapped as named tools.
 */
class OneDriveApiPatch implements Tool
{
    /**
    ...
    {
        return 'onedrive_api_patch';
    }

    public function description(): string
    {
        return 'Call a relative Microsoft Graph PATCH path with a JSON body. Absolute URLs are rejected.';
    }
    ...
    /**
     * Execute a relative PATCH request.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->apiPatch((string) $args['path'], is_array($args['payload'] ?? null) ? $args['payload'] : []));
        } catch (\Throwable $e) {
