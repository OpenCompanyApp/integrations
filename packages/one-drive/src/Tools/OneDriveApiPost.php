...
/**
 * Call a relative Microsoft Graph POST endpoint.
 *
 * Intended for official OneDrive/Graph endpoints not yet wrapped as named tools.
 */
class OneDriveApiPost implements Tool
{
    /**
    ...
    {
        return 'onedrive_api_post';
    }

    public function description(): string
    {
        return 'Call a relative Microsoft Graph POST path with a JSON body. Absolute URLs are rejected.';
    }
