...
```ruby
books = app.call("integrations.open-library.search_books", q: "the lord of the rings", fields: "key,title,author_name,first_publish_year,cover_i", limit: 5)
work = app.call("integrations.open-library.work", id: "OL27448W")
cover = app.call("integrations.open-library.cover_url", type: "isbn", value: "9780140328721", size: "L")
```