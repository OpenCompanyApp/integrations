...
```ruby
forecast = app.call("integrations.open-meteo.weather_forecast", latitude: 52.52, longitude: 13.41, hourly: ["temperature_2m", "precipitation"], daily: ["temperature_2m_max", "temperature_2m_min"], timezone: "Europe/Berlin")
berlin = app.call("integrations.open-meteo.geocoding_search", name: "Berlin", count: 5, language: "en")
air = app.call("integrations.open-meteo.air_quality", latitude: 52.52, longitude: 13.41, hourly: ["pm10", "pm2_5", "us_aqi"])
```
