...
```js
var forecast = app.integrations.open_meteo.open_meteo_forecast({
  latitude: 52.52,
  longitude: 13.41,
...
var berlin = app.integrations.open_meteo.open_meteo_geocoding_search({
  name: "Berlin",
  count: 5,
  language: "en",
})

var air = app.integrations.open_meteo.open_meteo_air_quality({
  latitude: 52.52,
  longitude: 13.41,
