...
```ruby
labels = app.integrations.openfda.drug_label(search: "openfda.generic_name:\"acetaminophen\"", limit: 5)
reactions = app.integrations.openfda.drug_event(search: "patient.drug.openfda.generic_name:\"metformin\"", count: "patient.reaction.reactionmeddrapt.exact", limit: 10)
recalls = app.integrations.openfda.food_enforcement(sort: "report_date:desc", limit: 10)
```
## Dataset Tools
