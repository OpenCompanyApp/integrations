...
```ruby
mapped = app.integrations.openfigi.mapping(jobs: [{idType: "TICKER", idValue: "IBM", exchCode: "US"}, {idType: "ID_ISIN", idValue: "US4592001014"}])
id_types = app.integrations.openfigi.mapping_values(key: "idType")
results = app.integrations.openfigi.filter(query: "IBM", exch_code: "US", market_sec_des: "Equity")
```
