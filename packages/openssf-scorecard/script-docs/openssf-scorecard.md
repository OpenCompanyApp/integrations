...
```ruby
result = app.call("integrations.openssf-scorecard.result", uri: "github.com/ossf/scorecard")
security_policy = app.call("integrations.openssf-scorecard.check", uri: "github.com/ossf/scorecard", check: "Security-Policy")
badge = app.call("integrations.openssf-scorecard.badge", uri: "github.com/ossf/scorecard", style: "flat")
```
