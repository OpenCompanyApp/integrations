...
```ruby
places = app.integrations.openstreetmap.nominatim_search(q: "Brandenburg Gate Berlin", limit: 3, addressdetails: true, extratags: true)
reverse = app.integrations.openstreetmap.nominatim_reverse(lat: 52.5163, lon: 13.3777, zoom: 18, addressdetails: true)
cafes = app.integrations.openstreetmap.overpass_query(query: "\n    [out:json][timeout:25];\n    node[\"amenity\"=\"cafe\"](52.51,13.37,52.52,13.39);\n    out center 20;\n  ")
```