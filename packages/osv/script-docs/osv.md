...
```ruby
vulns = app.integrations.osv.query(package_name: "jinja2", ecosystem: "PyPI", version: "3.1.4")
batch = app.integrations.osv.query_batch(queries: [{purl: "pkg:pypi/mlflow@0.4.0"}, {commit: "6879efc2c1596d11a6a6ad296f80063b558d5e0f"}, {package_name: "jinja2", ecosystem: "PyPI", version: "2.4.1"}])
record = app.integrations.osv.get_vulnerability(id: "GHSA-vp9c-fpxx-744v")
```
