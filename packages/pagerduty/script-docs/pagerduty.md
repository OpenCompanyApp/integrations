...
```ruby
incidents = app.integrations.pagerduty.list_incidents(statuses: ["triggered", "acknowledged"], limit: 10)
incident = app.integrations.pagerduty.get_incident(id: "Q0123456789ABC")
```
## Scope Notes
