# Client for the Payload CMS REST API covering collections, documents, and user management — JavaScript API Reference
...
```js
var result = app.integrations.payload_cms.payload_cms_list_collections({
})
```
...
```js
var result = app.integrations.payload_cms.payload_cms_get_collection({
  slug: "",
})
```
...
```js
var result = app.integrations.payload_cms.payload_cms_list_documents({
  collection: "",
  limit: 10,
  page: 1,
})
...
```js
var result = app.integrations.payload_cms.payload_cms_get_document({
  collection: "",
  document_id: "",
})
```
...
```js
var result = app.integrations.payload_cms.payload_cms_create_document({
  collection: "",
...
```js
var result = app.integrations.payload_cms.payload_cms_list_users({
  limit: 10,
  page: 1,
})
```
...
```js
var result = app.integrations.payload_cms.payload_cms_get_current_user({
})
```
---
...
app.integrations.payload_cms.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.payload_cms.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.payload_cms.production.function_name({ /* parameters */ })
app.integrations.payload_cms.staging.function_name({ /* parameters */ })
```
