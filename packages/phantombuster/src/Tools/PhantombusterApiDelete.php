...
/**
 * Call a relative Phantombuster API DELETE endpoint.
 */
class PhantombusterApiDelete extends AbstractPhantombusterTool implements Tool
{
    public function name(): string
    {
        return 'phantombuster_api_delete';
    }

    public function description(): string
    {
        return 'Call a relative Phantombuster API DELETE path. Absolute URLs are rejected.';
    }
