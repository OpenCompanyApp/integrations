...
/**
 * Call a relative Phantombuster API POST endpoint.
 */
class PhantombusterApiPost extends AbstractPhantombusterTool implements Tool
{
    public function name(): string
    {
        return 'phantombuster_api_post';
    }

    public function description(): string
    {
        return 'Call a relative Phantombuster API POST path. Absolute URLs are rejected.';
    }
