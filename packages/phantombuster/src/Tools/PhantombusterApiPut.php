...
/**
 * Call a relative Phantombuster API PUT endpoint.
 */
class PhantombusterApiPut extends AbstractPhantombusterTool implements Tool
{
    public function name(): string
    {
        return 'phantombuster_api_put';
    }

    public function description(): string
    {
        return 'Call a relative Phantombuster API PUT path. Absolute URLs are rejected.';
    }
