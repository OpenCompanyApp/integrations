# Client for the Phrase localization platform — Ruby API Reference
...
```ruby
result = app.integrations.phrase.list_projects(page: 1, per_page: 25)
```
## phrase_get_project
...
```ruby
result = app.integrations.phrase.get_project(project_id: "")
```
## phrase_list_keys
...
```ruby
result = app.integrations.phrase.list_keys(project_id: "", page: 1, per_page: 25, q: "")
```
## phrase_get_key
...
```ruby
result = app.integrations.phrase.get_key(project_id: "", key_id: "")
```
...
```ruby
result = app.integrations.phrase.list_translations(project_id: "", page: 1, per_page: 25, key_id: "", locale_id: "", q: "")
```
## phrase_list_locales
...
```ruby
result = app.integrations.phrase.list_locales(project_id: "", page: 1, per_page: 25)
```
...
```ruby
result = app.integrations.phrase.get_current_user()
```
---
