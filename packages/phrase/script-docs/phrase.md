# Client for the Phrase localization platform — JavaScript API Reference
...
```js
var result = app.integrations.phrase.phrase_list_projects({
  page: 1,
  per_page: 25,
})
```
...
```js
var result = app.integrations.phrase.phrase_get_project({
  project_id: "",
})
```
## phrase_list_keys
...
```js
var result = app.integrations.phrase.phrase_list_keys({
  project_id: "",
  page: 1,
  per_page: 25,
  q: "",
...
```js
var result = app.integrations.phrase.phrase_get_key({
  project_id: "",
  key_id: "",
})
```
...
```js
var result = app.integrations.phrase.phrase_list_translations({
  project_id: "",
  page: 1,
  per_page: 25,
  key_id: "",
...
```js
var result = app.integrations.phrase.phrase_list_locales({
  project_id: "",
  page: 1,
  per_page: 25,
})
...
```js
var result = app.integrations.phrase.phrase_get_current_user({
})
```
---
...
app.integrations.phrase.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.phrase.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.phrase.work.function_name({ /* parameters */ })
app.integrations.phrase.personal.function_name({ /* parameters */ })
```
