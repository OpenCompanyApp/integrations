...
```ruby
deals = app.integrations.pipedrive.get_all_deals(status: "open", limit: 10)
created = app.integrations.pipedrive.add_new_deal(body: {title: "Example opportunity", value: 12000, currency: "USD"})
```
