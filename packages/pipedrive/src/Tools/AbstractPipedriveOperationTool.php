...
/**
 * Base class for generated Pipedrive OpenAPI operation tools.
 *
 * Handles parameter declarations, configured-state checks, and execution
 * through the shared Pipedrive API client.
 */
abstract class AbstractPipedriveOperationTool implements Tool
{
    protected const TOOL_NAME = '';

    /**
     * @param  PipedriveService  $service  Pipedrive HTTP API client.
     */
    public function __construct(protected PipedriveService $service) {}
    ...
    public function parameters(): array
    {
        ...
        if (($this->operation()['request_body'] ?? null) !== null) {
            $parameters['body'] = [
                ...
                'description' => $this->operation()['request_body']['description'] ?: 'Request body for the Pipedrive API operation.',
            ];
        }
    ...
    /**
     * Execute the Pipedrive API operation.
     *
    ...
    {
        $operations = PipedriveOperations::all();
