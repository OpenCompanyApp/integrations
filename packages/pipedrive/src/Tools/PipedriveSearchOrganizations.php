...
/**
 * Search Pipedrive organizations by term.
 *
 * Returns matching organizations with their details.
 */
class PipedriveSearchOrganizations implements Tool
{
    /**
    ...
    {
        return 'pipedrive_search_organizations';
    }

    public function description(): string
    {
        return 'Search for organizations in Pipedrive by name or other searchable fields.';
    }

    public function parameters(): array
    {
        return [
            'term'  => ['type' => 'string', 'required' => true, 'description' => 'Search term (organization name, etc.).'],
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->searchOrganizations($params);
