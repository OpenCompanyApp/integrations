...
```ruby
result = app.integrations.plantuml.render(syntax: "@startuml\nclass Animal {\n  +name: string\n  +speak(): void\n}\nclass Dog extends Animal {\n  +fetch(): void\n}\n@enduml", title: "Class Diagram")
```
#### Render a sequence diagram

```ruby
result = app.integrations.plantuml.render(syntax: "@startuml\nAlice -> Bob: Hello\nBob // > Alice: Hi there!\n@enduml", title: "Sequence Diagram")
```
#### Render a component diagram

```ruby
result = app.integrations.plantuml.render(syntax: "@startuml\n[Web App] // > [API Gateway]\n[API Gateway] --> [Auth Service]\n[API Gateway] --> [Database]\n@enduml", title: "Architecture")
```