...
app.integrations.postmark.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.postmark.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.postmark.production.function_name({ /* parameters */ })
app.integrations.postmark.staging.function_name({ /* parameters */ })
```
