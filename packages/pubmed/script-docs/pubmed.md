...
```js
var spelling = pubmed.spell({
  term: "asthmaa",
})

var counts = pubmed.global_query({
  term: "CRISPR",
})
```
...
```js
var matches = pubmed.citation_match({
  citations: [
