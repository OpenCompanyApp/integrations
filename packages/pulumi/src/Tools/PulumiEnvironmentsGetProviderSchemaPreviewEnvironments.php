 ...
 * GetProviderSchema.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/preview/environments/providers/{providerName}/schema.
 */
class PulumiEnvironmentsGetProviderSchemaPreviewEnvironments extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_get_provider_schema_preview_environments';
    protected const DESCRIPTION = 'GetProviderSchema

Official Pulumi Cloud endpoint: GET /api/preview/environments/providers/{providerName}/schema
...
Returns the JSON schema for a Pulumi ESC provider. Providers are integrations that dynamically retrieve configuration and secrets from external sources such as AWS, Azure, Google Cloud, HashiCorp Vault, and others via fn::open. The schema describes the provider\'s input parameters, output structure, and configuration options. The provider is identified by name in the URL path.';
  ...
  array (
    ...
    protected const PATH = '/api/preview/environments/providers/{providerName}/schema';
