 ...
 * ListEnvironmentTags.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/esc/environments/{orgName}/{projectName}/{envName}/tags.
 */
class PulumiEnvironmentsListEnvironmentTagsEscEnvironments extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_list_environment_tags_esc_environments';
    protected const DESCRIPTION = 'ListEnvironmentTags

Official Pulumi Cloud endpoint: GET /api/esc/environments/{orgName}/{projectName}/{envName}/tags
