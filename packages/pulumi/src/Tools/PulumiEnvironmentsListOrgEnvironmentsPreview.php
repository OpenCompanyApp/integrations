 ...
 * ListOrgEnvironments.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/preview/environments/{orgName}.
 */
class PulumiEnvironmentsListOrgEnvironmentsPreview extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_list_org_environments_preview';
    protected const DESCRIPTION = 'ListOrgEnvironments

Official Pulumi Cloud endpoint: GET /api/preview/environments/{orgName}
...
Returns a paginated list of all Pulumi ESC environments within a specific organization. Each entry includes the project, environment name, and creation/modification timestamps. Results are scoped to the organization specified in the URL path. Use continuationToken for pagination through large result sets.';
  ...
  array (
    ...
    protected const PATH = '/api/preview/environments/{orgName}';
