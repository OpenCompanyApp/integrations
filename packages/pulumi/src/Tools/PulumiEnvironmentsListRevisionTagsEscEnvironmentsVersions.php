 ...
 * ListRevisionTags.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/esc/environments/{orgName}/{projectName}/{envName}/versions/tags.
 */
class PulumiEnvironmentsListRevisionTagsEscEnvironmentsVersions extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_list_revision_tags_esc_environments_versions';
    protected const DESCRIPTION = 'ListRevisionTags

Official Pulumi Cloud endpoint: GET /api/esc/environments/{orgName}/{projectName}/{envName}/versions/tags
