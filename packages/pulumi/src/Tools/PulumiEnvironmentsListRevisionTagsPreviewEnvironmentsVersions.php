 ...
 * ListRevisionTags.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/preview/environments/{orgName}/{envName}/versions/tags.
 */
class PulumiEnvironmentsListRevisionTagsPreviewEnvironmentsVersions extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_list_revision_tags_preview_environments_versions';
    protected const DESCRIPTION = 'ListRevisionTags

Official Pulumi Cloud endpoint: GET /api/preview/environments/{orgName}/{envName}/versions/tags
...
Returns a paginated list of revision tags for a Pulumi ESC environment. Revision tags are named references pointing to specific revision numbers (e.g., \'latest\', \'prod\', \'stable\'). They can be used in environment imports and Pulumi stack configuration to pin to a specific version. Use the after parameter for cursor-based pagination and count to limit results.';
  ...
  array (
    ...
    protected const PATH = '/api/preview/environments/{orgName}/{envName}/versions/tags';
