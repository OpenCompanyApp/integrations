 ...
 *
 * Maps to the official Pulumi Cloud endpoint get /api/esc/environments/{orgName}/{projectName}/{envName}/drafts/{changeRequestID}.
 */
class PulumiEnvironmentsReadEnvironmentDraft extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_read_environment_draft';
    protected const DESCRIPTION = 'ReadEnvironmentDraft

Official Pulumi Cloud endpoint: GET /api/esc/environments/{orgName}/{projectName}/{envName}/drafts/{changeRequestID}
