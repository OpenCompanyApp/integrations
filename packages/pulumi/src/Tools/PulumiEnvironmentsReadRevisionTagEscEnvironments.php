 ...
 * ReadRevisionTag.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/esc/environments/{orgName}/{projectName}/{envName}/versions/tags/{tagName}.
 */
class PulumiEnvironmentsReadRevisionTagEscEnvironments extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_read_revision_tag_esc_environments';
    protected const DESCRIPTION = 'ReadRevisionTag

Official Pulumi Cloud endpoint: GET /api/esc/environments/{orgName}/{projectName}/{envName}/versions/tags/{tagName}
