 ...
 *
 * Maps to the official Pulumi Cloud endpoint patch /api/preview/esc/environments/{orgName}/{projectName}/{envName}/drafts/{changeRequestID}.
 */
class PulumiEnvironmentsUpdateEnvironmentDraftPreview extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_update_environment_draft_preview';
    protected const DESCRIPTION = 'UpdateEnvironmentDraft

Official Pulumi Cloud endpoint: PATCH /api/preview/esc/environments/{orgName}/{projectName}/{envName}/drafts/{changeRequestID}
