 ...
 * UpdateRevisionTag.
 *
 * Maps to the official Pulumi Cloud endpoint patch /api/esc/environments/{orgName}/{projectName}/{envName}/versions/tags/{tagName}.
 */
class PulumiEnvironmentsUpdateRevisionTagEscEnvironments extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_update_revision_tag_esc_environments';
    protected const DESCRIPTION = 'UpdateRevisionTag

Official Pulumi Cloud endpoint: PATCH /api/esc/environments/{orgName}/{projectName}/{envName}/versions/tags/{tagName}
