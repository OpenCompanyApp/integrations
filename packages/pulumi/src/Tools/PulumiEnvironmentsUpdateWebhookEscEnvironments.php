 ...
 * UpdateWebhook.
 *
 * Maps to the official Pulumi Cloud endpoint patch /api/esc/environments/{orgName}/{projectName}/{envName}/hooks/{hookName}.
 */
class PulumiEnvironmentsUpdateWebhookEscEnvironments extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_environments_update_webhook_esc_environments';
    protected const DESCRIPTION = 'UpdateWebhook

Official Pulumi Cloud endpoint: PATCH /api/esc/environments/{orgName}/{projectName}/{envName}/hooks/{hookName}
