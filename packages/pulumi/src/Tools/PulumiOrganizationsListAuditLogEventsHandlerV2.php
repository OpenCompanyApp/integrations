 ...
 *
 * Maps to the official Pulumi Cloud endpoint get /api/orgs/{orgName}/auditlogs/v2.
 */
class PulumiOrganizationsListAuditLogEventsHandlerV2 extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_organizations_list_audit_log_events_handler_v2';
    protected const DESCRIPTION = 'ListAuditLogEventsHandlerV2

Official Pulumi Cloud endpoint: GET /api/orgs/{orgName}/auditlogs/v2
...
Lists audit log events for an organization. Uses startTime as the lower bound and endTime as the upper bound of the query range. Supports filtering by event type and user.';
  ...
  array (
    ...
    protected const PATH = '/api/orgs/{orgName}/auditlogs/v2';
