 ...
 *
 * Maps to the official Pulumi Cloud endpoint post /api/registry/templates/{source}/{publisher}/{name}/versions.
 */
class PulumiRegistryPostPublishTemplateVersion extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_registry_post_publish_template_version';
    protected const DESCRIPTION = 'PostPublishTemplateVersion

Official Pulumi Cloud endpoint: POST /api/registry/templates/{source}/{publisher}/{name}/versions
