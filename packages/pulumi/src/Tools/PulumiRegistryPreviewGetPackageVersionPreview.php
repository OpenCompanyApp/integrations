 ...
 * GetPackageVersion.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/preview/registry/packages/{source}/{publisher}/{name}/versions/{version}.
 */
class PulumiRegistryPreviewGetPackageVersionPreview extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_registry_preview_get_package_version_preview';
    protected const DESCRIPTION = 'GetPackageVersion

Official Pulumi Cloud endpoint: GET /api/preview/registry/packages/{source}/{publisher}/{name}/versions/{version}
