 ...
 * GetEngineEvents.
 *
 * Maps to the official Pulumi Cloud endpoint get /api/stacks/{orgName}/{projectName}/{stackName}/destroy/{updateID}/events.
 */
class PulumiStacksGetEngineEventsDestroy extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_stacks_get_engine_events_destroy';
    protected const DESCRIPTION = 'GetEngineEvents

Official Pulumi Cloud endpoint: GET /api/stacks/{orgName}/{projectName}/{stackName}/destroy/{updateID}/events
