 ...
 *
 * Maps to the official Pulumi Cloud endpoint get /api/stacks/{orgName}/{projectName}/{stackName}/preview/{updateID}.
 */
class PulumiStacksGetUpdateStatusForPreview extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_stacks_get_update_status_for_preview';
    protected const DESCRIPTION = 'GetUpdateStatusForPreview

Official Pulumi Cloud endpoint: GET /api/stacks/{orgName}/{projectName}/{stackName}/preview/{updateID}
