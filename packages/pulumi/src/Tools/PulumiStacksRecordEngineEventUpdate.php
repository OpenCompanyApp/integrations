 ...
 * RecordEngineEvent.
 *
 * Maps to the official Pulumi Cloud endpoint post /api/stacks/{orgName}/{projectName}/{stackName}/update/{updateID}/events.
 */
class PulumiStacksRecordEngineEventUpdate extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_stacks_record_engine_event_update';
    protected const DESCRIPTION = 'RecordEngineEvent

Official Pulumi Cloud endpoint: POST /api/stacks/{orgName}/{projectName}/{stackName}/update/{updateID}/events
