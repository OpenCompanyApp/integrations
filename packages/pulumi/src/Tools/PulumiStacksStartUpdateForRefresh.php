 ...
 *
 * Maps to the official Pulumi Cloud endpoint post /api/stacks/{orgName}/{projectName}/{stackName}/refresh/{updateID}.
 */
class PulumiStacksStartUpdateForRefresh extends AbstractPulumiTool
{
    protected const NAME = 'pulumi_stacks_start_update_for_refresh';
    protected const DESCRIPTION = 'StartUpdateForRefresh

Official Pulumi Cloud endpoint: POST /api/stacks/{orgName}/{projectName}/{stackName}/refresh/{updateID}
