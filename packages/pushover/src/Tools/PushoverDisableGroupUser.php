...
/**
 * Disable a Pushover delivery group member without deleting it.
 */
class PushoverDisableGroupUser implements Tool
{
    /**
    ...
    {
        return 'pushover_disable_group_user';
    }

    public function description(): string
    {
        return 'Temporarily disable a user key, optionally scoped to a device, in a Pushover delivery group.';
    }
    ...
    public function parameters(): array
    {
        return [
            ...
            'user_key' => ['type' => 'string', 'required' => true, 'description' => 'Pushover user key to disable.'],
            'device' => ['type' => 'string', 'description' => 'Optional device name to match.'],
        ];
    }

    /**
     * Disable a group user.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->disableGroupUser($groupKey, $userKey, $args['device'] ?? null));
        } catch (\Throwable $e) {
