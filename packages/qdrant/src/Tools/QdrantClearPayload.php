...
/**
 * Clear all payload from selected Qdrant points.
 */
class QdrantClearPayload implements Tool
{
    /**
    ...
    {
        return 'qdrant_clear_payload';
    }

    public function description(): string
    {
        return 'Clear all payload fields from points selected by IDs or filter.';
    }
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->clearPayload($collection, $args, $params));
        } catch (\Throwable $e) {
