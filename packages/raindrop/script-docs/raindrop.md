...
```js
var bookmarks = app.integrations.raindrop.raindrops_multiple_get_raindrops({ collection_id: 0, query: { perpage: 25 } })
var created = app.integrations.raindrop.raindrops_single_create_raindrop({ payload: { link: 'https://example.test', title: 'Example' } })
```