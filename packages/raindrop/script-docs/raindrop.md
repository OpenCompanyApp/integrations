...
```ruby
bookmarks = app.integrations.raindrop.raindrop_raindrops_multiple_get_raindrops(collection_id: 0, query: {perpage: 25})
created = app.integrations.raindrop.create(payload: {link: "https://example.test", title: "Example"})
```