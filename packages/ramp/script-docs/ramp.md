...
```js
var cards = app.integrations.ramp.ramp_get_card_list_resource({ limit: 25 })
var account = app.integrations.ramp.ramp_get_gl_account_resource({ gl_account_id: "acct_123" })
```
## Coverage Notes
