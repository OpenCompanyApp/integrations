...
```ruby
cards = app.call("integrations.ramp.ramp_get_card_list_with_pagination", page_size: 25)
account = app.call("integrations.ramp.ramp_get_gl_account_resource", gl_account_id: "acct_123")
```
## Coverage Notes
