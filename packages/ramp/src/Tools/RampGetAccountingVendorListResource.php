 ...
 * List vendors.
 *
 * Maps to the official Ramp endpoint get /developer/v1/accounting/vendors.
 */
class RampGetAccountingVendorListResource extends AbstractRampTool
{
    protected const NAME = 'ramp_get_accounting_vendor_list_resource';
    protected const DESCRIPTION = 'List vendors

Official Ramp endpoint: GET /developer/v1/accounting/vendors';
