 ...
 * Fetch a vendor.
 *
 * Maps to the official Ramp endpoint get /developer/v1/accounting/vendors/{vendor_id}.
 */
class RampGetAccountingVendorResource extends AbstractRampTool
{
    protected const NAME = 'ramp_get_accounting_vendor_resource';
    protected const DESCRIPTION = 'Fetch a vendor

Official Ramp endpoint: GET /developer/v1/accounting/vendors/{vendor_id}';
