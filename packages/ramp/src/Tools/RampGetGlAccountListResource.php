 ...
 *
 * Maps to the official Ramp endpoint get /developer/v1/accounting/accounts.
 */
class RampGetGlAccountListResource extends AbstractRampTool
{
    protected const NAME = 'ramp_get_gl_account_list_resource';
    protected const DESCRIPTION = 'List general ledger accounts

Official Ramp endpoint: GET /developer/v1/accounting/accounts';
