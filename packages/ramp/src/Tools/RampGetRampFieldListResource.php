 ...
 *
 * Maps to the official Ramp endpoint get /developer/v1/accounting/ramp-fields.
 */
class RampGetRampFieldListResource extends AbstractRampTool
{
    protected const NAME = 'ramp_get_ramp_field_list_resource';
    protected const DESCRIPTION = 'List Ramp-only accounting fields

Official Ramp endpoint: GET /developer/v1/accounting/ramp-fields';
