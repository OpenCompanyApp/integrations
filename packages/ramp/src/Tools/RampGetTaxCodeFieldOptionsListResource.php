 ...
 *
 * Maps to the official Ramp endpoint get /developer/v1/accounting/tax/code/options.
 */
class RampGetTaxCodeFieldOptionsListResource extends AbstractRampTool
{
    protected const NAME = 'ramp_get_tax_code_field_options_list_resource';
    protected const DESCRIPTION = 'List tax code options

Official Ramp endpoint: GET /developer/v1/accounting/tax/code/options';
