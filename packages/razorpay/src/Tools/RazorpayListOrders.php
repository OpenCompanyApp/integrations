...
/**
 * Tool to list orders from Razorpay.
 *
 * Retrieves a paginated list of orders with optional filters for
 * date range, count, and skip offset.
 */
class RazorpayListOrders implements Tool
{
    /**
     * Create a new RazorpayListOrders tool instance.
     */
    ...
    {
        return 'List orders from Razorpay. Supports pagination and date-range filters. Returns order IDs, amounts, currencies, and statuses.';
    }
    ...
    {
        return [
            'count' => ['type' => 'integer', 'description' => 'Number of orders to return (default: 10, max: 100).'],
    ...
    /**
     * Execute the tool and return the list of orders.
     *
