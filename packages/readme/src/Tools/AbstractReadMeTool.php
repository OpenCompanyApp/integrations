...
/**
 * Shared executor for ReadMe tools.
 *
 ...
 */
abstract class AbstractReadMeTool implements Tool
{
    ...
    /**
     * @param  ReadMeService  $service  ReadMe API client.
     */
    public function __construct(protected ReadMeService $service) {}
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            if (!method_exists($this->service, $method)) {
                throw new InvalidArgumentException('Unsupported ReadMe operation.');
            }
