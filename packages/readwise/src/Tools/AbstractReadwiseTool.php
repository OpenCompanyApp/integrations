...
/**
 * Shared executor for Readwise endpoint tools.
 *
 * Concrete tools define operation metadata while this class validates required
 * arguments, merges payload fields, and delegates API calls to ReadwiseService.
 */
abstract class AbstractReadwiseTool implements Tool
{
    ...
    /**
     * Execute the Readwise operation.
     *
