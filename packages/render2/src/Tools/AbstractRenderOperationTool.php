...
/**
 * Base class for generated Render OpenAPI operation tools.
 *
 * Handles parameter declarations, configured-state checks, and execution
 * through the shared Render API client.
 */
abstract class AbstractRenderOperationTool implements Tool
{
    protected const TOOL_NAME = '';

    /**
     * @param  RenderService  $service  Render HTTP API client.
     */
    public function __construct(protected RenderService $service) {}
    ...
    public function parameters(): array
    {
        ...
        if (($this->operation()['request_body'] ?? null) !== null) {
            $parameters['body'] = [
                ...
                'description' => 'Request body for the Render API operation.',
            ];
        }
    ...
    /**
     * Execute the Render API operation.
     *
    ...
    {
        $operations = RenderOperations::all();
