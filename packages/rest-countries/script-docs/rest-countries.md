...
```ruby
countries = app.call("integrations.rest-countries.all", fields: "name,cca2,cca3,capital,region,population")
germany = app.call("integrations.rest-countries.by_code", code: "DEU", fields: "name,capital,currencies,languages,flags")
eurozone = app.call("integrations.rest-countries.by_currency", currency: "eur", fields: "name,cca2,currencies")
```