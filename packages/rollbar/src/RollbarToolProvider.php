...
/**
 * Tool provider for the Rollbar error monitoring integration.
 *
 * Registers 7 tools for interacting with the Rollbar API:
 * projects, items (errors), deploys, teams, and the current user.
 */
class RollbarToolProvider implements ToolProvider, ConfigurableIntegration
{
    /**
