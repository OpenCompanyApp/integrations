...
```ruby
incidents = app.integrations.rootly.list_incidents(page_number: 1, page_size: 10)
incident = app.integrations.rootly.retrieves_incident(id: "00000000-0000-0000-0000-000000000000")
```
## Request Bodies
