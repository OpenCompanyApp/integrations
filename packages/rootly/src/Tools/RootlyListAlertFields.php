 ...
 * List alert fields.
 *
 * Maps to the official Rootly endpoint get /v1/alert_fields.
 */
class RootlyListAlertFields extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_alert_fields';
    protected const DESCRIPTION = 'List alert fields

Official Rootly endpoint: GET /v1/alert_fields
