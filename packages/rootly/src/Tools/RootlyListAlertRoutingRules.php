 ...
 *
 * Maps to the official Rootly endpoint get /v1/alert_routing_rules.
 */
class RootlyListAlertRoutingRules extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_alert_routing_rules';
    protected const DESCRIPTION = 'List alert routing rules

Official Rootly endpoint: GET /v1/alert_routing_rules
