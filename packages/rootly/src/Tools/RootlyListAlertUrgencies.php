 ...
 *
 * Maps to the official Rootly endpoint get /v1/alert_urgencies.
 */
class RootlyListAlertUrgencies extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_alert_urgencies';
    protected const DESCRIPTION = 'List alert urgencies

Official Rootly endpoint: GET /v1/alert_urgencies
