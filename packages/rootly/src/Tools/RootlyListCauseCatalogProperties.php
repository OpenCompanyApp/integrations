 ...
 *
 * Maps to the official Rootly endpoint get /v1/causes/properties.
 */
class RootlyListCauseCatalogProperties extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_cause_catalog_properties';
    protected const DESCRIPTION = 'List Catalog Properties

Official Rootly endpoint: GET /v1/causes/properties
