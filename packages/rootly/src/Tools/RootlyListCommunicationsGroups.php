 ...
 *
 * Maps to the official Rootly endpoint get /v1/communications/groups.
 */
class RootlyListCommunicationsGroups extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_communications_groups';
    protected const DESCRIPTION = 'Lists communications groups

Official Rootly endpoint: GET /v1/communications/groups
...
Lists communications groups';
  ...
  array (
    'type' => 'string',
    'description' => 'filter[is_private] parameter.',
  ),
  'filter_communication_type_id' =>
  array (
    'type' => 'string',
    'description' => 'filter[communication_type_id] parameter.',
  ),
  'filter_condition_type' =>
  array (
    'type' => 'string',
    'description' => 'filter[condition_type] parameter.',
  ),
  ...
  'filter[is_private]' => 'filter_is_private',
  'filter[communication_type_id]' => 'filter_communication_type_id',
  'filter[condition_type]' => 'filter_condition_type',
