 ...
 *
 * Maps to the official Rootly endpoint get /v1/communications/stages.
 */
class RootlyListCommunicationsStages extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_communications_stages';
    protected const DESCRIPTION = 'Lists communications stages

Official Rootly endpoint: GET /v1/communications/stages
