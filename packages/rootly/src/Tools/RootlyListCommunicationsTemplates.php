 ...
 *
 * Maps to the official Rootly endpoint get /v1/communications/templates.
 */
class RootlyListCommunicationsTemplates extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_communications_templates';
    protected const DESCRIPTION = 'Lists communications templates

Official Rootly endpoint: GET /v1/communications/templates
