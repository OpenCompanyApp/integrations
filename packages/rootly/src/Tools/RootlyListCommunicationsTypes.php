 ...
 *
 * Maps to the official Rootly endpoint get /v1/communications/types.
 */
class RootlyListCommunicationsTypes extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_communications_types';
    protected const DESCRIPTION = 'Lists communications types

Official Rootly endpoint: GET /v1/communications/types
