 ...
 *
 * Maps to the official Rootly endpoint get /v1/environments/properties.
 */
class RootlyListEnvironmentCatalogProperties extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_environment_catalog_properties';
    protected const DESCRIPTION = 'List Catalog Properties

Official Rootly endpoint: GET /v1/environments/properties
