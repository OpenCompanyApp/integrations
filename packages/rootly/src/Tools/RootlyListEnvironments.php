 ...
 * List environments.
 *
 * Maps to the official Rootly endpoint get /v1/environments.
 */
class RootlyListEnvironments extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_environments';
    protected const DESCRIPTION = 'List environments

Official Rootly endpoint: GET /v1/environments
