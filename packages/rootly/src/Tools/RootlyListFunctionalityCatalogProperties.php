 ...
 *
 * Maps to the official Rootly endpoint get /v1/functionalities/properties.
 */
class RootlyListFunctionalityCatalogProperties extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_functionality_catalog_properties';
    protected const DESCRIPTION = 'List Catalog Properties

Official Rootly endpoint: GET /v1/functionalities/properties
