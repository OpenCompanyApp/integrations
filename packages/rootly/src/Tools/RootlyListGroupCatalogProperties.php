 ...
 *
 * Maps to the official Rootly endpoint get /v1/teams/properties.
 */
class RootlyListGroupCatalogProperties extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_group_catalog_properties';
    protected const DESCRIPTION = 'List Catalog Properties

Official Rootly endpoint: GET /v1/teams/properties
