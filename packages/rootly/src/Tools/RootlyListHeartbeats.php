 ...
 * List heartbeats.
 *
 * Maps to the official Rootly endpoint get /v1/heartbeats.
 */
class RootlyListHeartbeats extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_heartbeats';
    protected const DESCRIPTION = 'List heartbeats

Official Rootly endpoint: GET /v1/heartbeats
