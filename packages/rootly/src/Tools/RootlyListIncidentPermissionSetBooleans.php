 ...
 *
 * Maps to the official Rootly endpoint get /v1/incident_permission_sets/{incident_permission_set_id}/booleans.
 */
class RootlyListIncidentPermissionSetBooleans extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_incident_permission_set_booleans';
    protected const DESCRIPTION = 'List incident_permission_set_booleans

Official Rootly endpoint: GET /v1/incident_permission_sets/{incident_permission_set_id}/booleans
