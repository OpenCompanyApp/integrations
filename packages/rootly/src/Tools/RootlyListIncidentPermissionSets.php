 ...
 *
 * Maps to the official Rootly endpoint get /v1/incident_permission_sets.
 */
class RootlyListIncidentPermissionSets extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_incident_permission_sets';
    protected const DESCRIPTION = 'List incident_permission_sets

Official Rootly endpoint: GET /v1/incident_permission_sets
