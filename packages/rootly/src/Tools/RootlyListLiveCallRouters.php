 ...
 *
 * Maps to the official Rootly endpoint get /v1/live_call_routers.
 */
class RootlyListLiveCallRouters extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_live_call_routers';
    protected const DESCRIPTION = 'List Live Call Routers

Official Rootly endpoint: GET /v1/live_call_routers
