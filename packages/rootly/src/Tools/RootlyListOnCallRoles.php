 ...
 * List On-Call Roles.
 *
 * Maps to the official Rootly endpoint get /v1/on_call_roles.
 */
class RootlyListOnCallRoles extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_on_call_roles';
    protected const DESCRIPTION = 'List On-Call Roles

Official Rootly endpoint: GET /v1/on_call_roles
