 ...
 * List roles.
 *
 * Maps to the official Rootly endpoint get /v1/roles.
 */
class RootlyListRoles extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_roles';
    protected const DESCRIPTION = 'List roles

Official Rootly endpoint: GET /v1/roles
