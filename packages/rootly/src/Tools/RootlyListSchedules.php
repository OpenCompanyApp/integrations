 ...
 * List schedules.
 *
 * Maps to the official Rootly endpoint get /v1/schedules.
 */
class RootlyListSchedules extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_schedules';
    protected const DESCRIPTION = 'List schedules

Official Rootly endpoint: GET /v1/schedules
