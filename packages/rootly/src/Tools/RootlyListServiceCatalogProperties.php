 ...
 *
 * Maps to the official Rootly endpoint get /v1/services/properties.
 */
class RootlyListServiceCatalogProperties extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_service_catalog_properties';
    protected const DESCRIPTION = 'List Catalog Properties

Official Rootly endpoint: GET /v1/services/properties
