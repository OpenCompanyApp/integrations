 ...
 * List services.
 *
 * Maps to the official Rootly endpoint get /v1/services.
 */
class RootlyListServices extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_services';
    protected const DESCRIPTION = 'List services

Official Rootly endpoint: GET /v1/services
