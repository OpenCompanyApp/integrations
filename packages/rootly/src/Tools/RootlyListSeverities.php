 ...
 * List severities.
 *
 * Maps to the official Rootly endpoint get /v1/severities.
 */
class RootlyListSeverities extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_severities';
    protected const DESCRIPTION = 'List severities

Official Rootly endpoint: GET /v1/severities
