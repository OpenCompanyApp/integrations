 ...
 * List SLAs.
 *
 * Maps to the official Rootly endpoint get /v1/slas.
 */
class RootlyListSlas extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_slas';
    protected const DESCRIPTION = 'List SLAs

Official Rootly endpoint: GET /v1/slas
