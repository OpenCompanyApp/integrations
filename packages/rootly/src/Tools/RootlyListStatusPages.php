 ...
 * List status pages.
 *
 * Maps to the official Rootly endpoint get /v1/status-pages.
 */
class RootlyListStatusPages extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_status_pages';
    protected const DESCRIPTION = 'List status pages

Official Rootly endpoint: GET /v1/status-pages
