 ...
 * List Statuses.
 *
 * Maps to the official Rootly endpoint get /v1/statuses.
 */
class RootlyListStatuses extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_statuses';
    protected const DESCRIPTION = 'List Statuses

Official Rootly endpoint: GET /v1/statuses
...
List Statuses';
  ...
  array (
    ...
    protected const PATH = '/v1/statuses';
