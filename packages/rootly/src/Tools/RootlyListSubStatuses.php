 ...
 * List Sub-Statuses.
 *
 * Maps to the official Rootly endpoint get /v1/sub_statuses.
 */
class RootlyListSubStatuses extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_sub_statuses';
    protected const DESCRIPTION = 'List Sub-Statuses

Official Rootly endpoint: GET /v1/sub_statuses
...
List Sub-Statuses';
  ...
  'filter_parent_status' =>
  array (
    'type' => 'string',
    'description' => 'filter[parent_status] parameter.',
  ),
  ...
  'filter[parent_status]' => 'filter_parent_status',
