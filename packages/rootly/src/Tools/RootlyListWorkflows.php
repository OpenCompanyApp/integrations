 ...
 * List workflows.
 *
 * Maps to the official Rootly endpoint get /v1/workflows.
 */
class RootlyListWorkflows extends AbstractRootlyTool
{
    protected const NAME = 'rootly_list_workflows';
    protected const DESCRIPTION = 'List workflows

Official Rootly endpoint: GET /v1/workflows
