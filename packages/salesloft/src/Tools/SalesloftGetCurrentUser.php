...
class SalesloftGetCurrentUser implements Tool
{
    ...
    {
        return 'salesloft_get_current_user';
    }

    public function description(): string
    {
        return 'Get the profile of the currently authenticated Salesloft user. Useful for verifying credentials and identifying the connected account.';
    }
