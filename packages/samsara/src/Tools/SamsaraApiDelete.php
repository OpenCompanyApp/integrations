 ...
 */
class SamsaraApiDelete extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_api_delete';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Samsara API path with DELETE. Official Samsara endpoint: DELETE {path}.';
