 ...
 */
class SamsaraApiPatch extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_api_patch';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Samsara API path with PATCH. Official Samsara endpoint: PATCH {path}.';
