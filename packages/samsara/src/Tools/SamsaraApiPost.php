 ...
 */
class SamsaraApiPost extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_api_post';
    protected const TOOL_DESCRIPTION = 'Call a safe relative Samsara API path with POST. Official Samsara endpoint: POST {path}.';
