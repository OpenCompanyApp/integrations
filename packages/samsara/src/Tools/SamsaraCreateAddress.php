 ...
 * Create an address.
 */
class SamsaraCreateAddress extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_create_address';
    protected const TOOL_DESCRIPTION = 'Create an address. Official Samsara endpoint: POST /addresses.';
