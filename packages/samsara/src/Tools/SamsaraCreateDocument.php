 ...
 * Create a document.
 */
class SamsaraCreateDocument extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_create_document';
    protected const TOOL_DESCRIPTION = 'Create a document. Official Samsara endpoint: POST /fleet/documents.';
    protected const METHOD = 'POST';
    protected const PATH = '/fleet/documents';
