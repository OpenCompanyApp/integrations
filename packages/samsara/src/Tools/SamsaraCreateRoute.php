 ...
 * Create a route.
 */
class SamsaraCreateRoute extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_create_route';
    protected const TOOL_DESCRIPTION = 'Create a route. Official Samsara endpoint: POST /fleet/routes.';
    protected const METHOD = 'POST';
    protected const PATH = '/fleet/routes';
