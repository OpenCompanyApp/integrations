 ...
 * Create a tag.
 */
class SamsaraCreateTag extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_create_tag';
    protected const TOOL_DESCRIPTION = 'Create a tag. Official Samsara endpoint: POST /tags.';
