 ...
 * Create a trailer.
 */
class SamsaraCreateTrailer extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_create_trailer';
    protected const TOOL_DESCRIPTION = 'Create a trailer. Official Samsara endpoint: POST /fleet/trailers.';
    protected const METHOD = 'POST';
    protected const PATH = '/fleet/trailers';
