 ...
 * Delete an address.
 */
class SamsaraDeleteAddress extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_delete_address';
    protected const TOOL_DESCRIPTION = 'Delete an address. Official Samsara endpoint: DELETE /addresses/{id}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/addresses/{id}';
