 ...
 * Delete a route.
 */
class SamsaraDeleteRoute extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_delete_route';
    protected const TOOL_DESCRIPTION = 'Delete a route. Official Samsara endpoint: DELETE /fleet/routes/{id}.';
