 ...
 * Delete a tag.
 */
class SamsaraDeleteTag extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_delete_tag';
    protected const TOOL_DESCRIPTION = 'Delete a tag. Official Samsara endpoint: DELETE /tags/{id}.';
