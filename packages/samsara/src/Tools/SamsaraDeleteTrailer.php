 ...
 * Delete a trailer.
 */
class SamsaraDeleteTrailer extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_delete_trailer';
    protected const TOOL_DESCRIPTION = 'Delete a trailer. Official Samsara endpoint: DELETE /fleet/trailers/{id}.';
    protected const METHOD = 'DELETE';
    protected const PATH = '/fleet/trailers/{id}';
