 ...
 * Retrieve an address.
 */
class SamsaraGetAddress extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_address';
    protected const TOOL_DESCRIPTION = 'Retrieve an address. Official Samsara endpoint: GET /addresses/{id}.';
