 ...
 */
class SamsaraGetDefectsHistory extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_defects_history';
    protected const TOOL_DESCRIPTION = 'Get historical DVIR defects. Official Samsara endpoint: GET /fleet/defects/history.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/defects/history';
