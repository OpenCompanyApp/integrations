 ...
 * Retrieve a document.
 */
class SamsaraGetDocument extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_document';
    protected const TOOL_DESCRIPTION = 'Retrieve a document. Official Samsara endpoint: GET /fleet/documents/{id}.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/documents/{id}';
