 ...
 */
class SamsaraGetDocumentType extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_document_type';
    protected const TOOL_DESCRIPTION = 'Retrieve a document type. Official Samsara endpoint: GET /fleet/document-types/{id}.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/document-types/{id}';
