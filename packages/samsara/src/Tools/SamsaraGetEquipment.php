 ...
 * Retrieve equipment.
 */
class SamsaraGetEquipment extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_equipment';
    protected const TOOL_DESCRIPTION = 'Retrieve equipment. Official Samsara endpoint: GET /fleet/equipment/{id}.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/equipment/{id}';
