 ...
 */
class SamsaraGetEquipmentStats extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_equipment_stats';
    protected const TOOL_DESCRIPTION = 'Get latest equipment stats. Official Samsara endpoint: GET /fleet/equipment/stats.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/equipment/stats';
