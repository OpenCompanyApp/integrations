 ...
 */
class SamsaraGetEquipmentStatsFeed extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_equipment_stats_feed';
    protected const TOOL_DESCRIPTION = 'Follow an equipment stats feed. Official Samsara endpoint: GET /fleet/equipment/stats/feed.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/equipment/stats/feed';
