 ...
 */
class SamsaraGetEquipmentStatsHistory extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_equipment_stats_history';
    protected const TOOL_DESCRIPTION = 'Get historical equipment stats. Official Samsara endpoint: GET /fleet/equipment/stats/history.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/equipment/stats/history';
