 ...
 * Retrieve a route.
 */
class SamsaraGetRoute extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_route';
    protected const TOOL_DESCRIPTION = 'Retrieve a route. Official Samsara endpoint: GET /fleet/routes/{id}.';
