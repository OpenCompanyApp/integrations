 ...
 * Retrieve a tag.
 */
class SamsaraGetTag extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_tag';
    protected const TOOL_DESCRIPTION = 'Retrieve a tag. Official Samsara endpoint: GET /tags/{id}.';
