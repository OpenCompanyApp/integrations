 ...
 * Retrieve a trailer.
 */
class SamsaraGetTrailer extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_trailer';
    protected const TOOL_DESCRIPTION = 'Retrieve a trailer. Official Samsara endpoint: GET /fleet/trailers/{id}.';
