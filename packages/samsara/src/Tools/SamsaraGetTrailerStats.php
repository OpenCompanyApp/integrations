 ...
 */
class SamsaraGetTrailerStats extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_trailer_stats';
    protected const TOOL_DESCRIPTION = 'Get latest trailer stats. Official Samsara endpoint: GET /fleet/trailers/stats.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/trailers/stats';
