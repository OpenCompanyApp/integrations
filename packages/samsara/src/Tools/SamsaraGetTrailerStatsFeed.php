 ...
 */
class SamsaraGetTrailerStatsFeed extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_trailer_stats_feed';
    protected const TOOL_DESCRIPTION = 'Follow a trailer stats feed. Official Samsara endpoint: GET /fleet/trailers/stats/feed.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/trailers/stats/feed';
