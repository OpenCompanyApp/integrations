 ...
 */
class SamsaraGetTrailerStatsHistory extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_trailer_stats_history';
    protected const TOOL_DESCRIPTION = 'Get historical trailer stats. Official Samsara endpoint: GET /fleet/trailers/stats/history.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/trailers/stats/history';
