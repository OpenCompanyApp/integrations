 ...
 * Retrieve a user.
 */
class SamsaraGetUser extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_user';
    protected const TOOL_DESCRIPTION = 'Retrieve a user. Official Samsara endpoint: GET /users/{id}.';
