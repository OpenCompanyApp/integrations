 ...
 */
class SamsaraGetVehicleStats extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_vehicle_stats';
    protected const TOOL_DESCRIPTION = 'Get latest vehicle stats. Official Samsara endpoint: GET /fleet/vehicles/stats.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/vehicles/stats';
