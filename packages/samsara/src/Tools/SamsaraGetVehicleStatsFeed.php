 ...
 */
class SamsaraGetVehicleStatsFeed extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_vehicle_stats_feed';
    protected const TOOL_DESCRIPTION = 'Follow a vehicle stats feed. Official Samsara endpoint: GET /fleet/vehicles/stats/feed.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/vehicles/stats/feed';
