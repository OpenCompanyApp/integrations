 ...
 */
class SamsaraGetVehicleStatsHistory extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_get_vehicle_stats_history';
    protected const TOOL_DESCRIPTION = 'Get historical vehicle stats. Official Samsara endpoint: GET /fleet/vehicles/stats/history.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/vehicles/stats/history';
