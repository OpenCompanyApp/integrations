 ...
 * List addresses.
 */
class SamsaraListAddresses extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_addresses';
    protected const TOOL_DESCRIPTION = 'List addresses. Official Samsara endpoint: GET /addresses.';
