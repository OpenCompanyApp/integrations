 ...
 * List defect types.
 */
class SamsaraListDefectTypes extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_defect_types';
    protected const TOOL_DESCRIPTION = 'List defect types. Official Samsara endpoint: GET /defect-types.';
    protected const METHOD = 'GET';
    protected const PATH = '/defect-types';
