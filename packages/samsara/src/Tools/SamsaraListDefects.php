 ...
 * List DVIR defects.
 */
class SamsaraListDefects extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_defects';
    protected const TOOL_DESCRIPTION = 'List DVIR defects. Official Samsara endpoint: GET /fleet/defects.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/defects';
