 ...
 * List document types.
 */
class SamsaraListDocumentTypes extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_document_types';
    protected const TOOL_DESCRIPTION = 'List document types. Official Samsara endpoint: GET /fleet/document-types.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/document-types';
