 ...
 * List documents.
 */
class SamsaraListDocuments extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_documents';
    protected const TOOL_DESCRIPTION = 'List documents. Official Samsara endpoint: GET /fleet/documents.';
