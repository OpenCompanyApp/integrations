 ...
 * List equipment.
 */
class SamsaraListEquipment extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_equipment';
    protected const TOOL_DESCRIPTION = 'List equipment. Official Samsara endpoint: GET /fleet/equipment.';
    protected const METHOD = 'GET';
    protected const PATH = '/fleet/equipment';
