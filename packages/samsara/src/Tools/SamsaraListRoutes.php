 ...
 * List routes.
 */
class SamsaraListRoutes extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_routes';
    protected const TOOL_DESCRIPTION = 'List routes. Official Samsara endpoint: GET /fleet/routes.';
