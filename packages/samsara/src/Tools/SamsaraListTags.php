 ...
 * List tags.
 */
class SamsaraListTags extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_tags';
    protected const TOOL_DESCRIPTION = 'List tags. Official Samsara endpoint: GET /tags.';
