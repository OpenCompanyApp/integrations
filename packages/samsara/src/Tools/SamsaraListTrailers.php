 ...
 * List trailers.
 */
class SamsaraListTrailers extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_trailers';
    protected const TOOL_DESCRIPTION = 'List trailers. Official Samsara endpoint: GET /fleet/trailers.';
