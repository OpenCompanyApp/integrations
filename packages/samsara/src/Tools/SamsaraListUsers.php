 ...
 * List users.
 */
class SamsaraListUsers extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_list_users';
    protected const TOOL_DESCRIPTION = 'List users. Official Samsara endpoint: GET /users.';
