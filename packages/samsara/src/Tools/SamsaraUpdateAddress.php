 ...
 * Update an address.
 */
class SamsaraUpdateAddress extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_update_address';
    protected const TOOL_DESCRIPTION = 'Update an address. Official Samsara endpoint: PATCH /addresses/{id}.';
