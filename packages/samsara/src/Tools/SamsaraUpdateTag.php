 ...
 * Update a tag.
 */
class SamsaraUpdateTag extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_update_tag';
    protected const TOOL_DESCRIPTION = 'Update a tag. Official Samsara endpoint: PATCH /tags/{id}.';
