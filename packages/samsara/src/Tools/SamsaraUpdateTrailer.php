 ...
 * Update a trailer.
 */
class SamsaraUpdateTrailer extends AbstractSamsaraEndpointTool
{
    protected const TOOL_NAME = 'samsara_update_trailer';
    protected const TOOL_DESCRIPTION = 'Update a trailer. Official Samsara endpoint: PATCH /fleet/trailers/{id}.';
