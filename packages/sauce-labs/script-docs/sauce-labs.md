...
```ruby
status = app.call("integrations.sauce-labs.get_status")
builds = app.call("integrations.sauce-labs.list_builds", build_source: "vdc", query: {limit: 20, sort: "desc"})
assets = app.call("integrations.sauce-labs.list_job_assets", username: "sauce-user", job_id: "job-id")
tunnel = app.call("integrations.sauce-labs.get_tunnel_jobs_count", username: "sauce-user", tunnel_id: "tunnel-id")
```
## Return Shapes
