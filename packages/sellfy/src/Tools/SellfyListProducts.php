...
class SellfyListProducts implements Tool
{
    ...
    {
        return 'sellfy_list_products';
    }

    public function description(): string
    {
        return 'List all products in your Sellfy store. Returns product names, prices, and status.';
    }

    public function parameters(): array
    {
        return [
            'page_size' => ['type' => 'integer', 'description' => 'Number of products per page (default: 10).'],
