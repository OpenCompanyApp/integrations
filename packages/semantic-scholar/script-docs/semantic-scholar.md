...
```ruby
papers = app.call("integrations.semantic-scholar.search_papers", query: "retrieval augmented generation", limit: 10, fields: ["title", "year", "authors", "citationCount", "openAccessPdf"])
paper = app.call("integrations.semantic-scholar.get_paper", paper_id: "CorpusId:216867622", fields: ["title", "abstract", "authors", "references", "citations"])
```
...
```ruby
recommendations = app.call("integrations.semantic-scholar.recommend_papers", payload: {positivePaperIds: ["CorpusId:216867622"], negativePaperIds: {}}, limit: 5, fields: ["title", "year", "authors"])
similar = app.call("integrations.semantic-scholar.recommend_paper", paper_id: "CorpusId:216867622", limit: 5)
```
## Datasets
...
```ruby
releases = app.call("integrations.semantic-scholar.list_dataset_releases")
dataset = app.call("integrations.semantic-scholar.get_dataset", release_id: "2026-01-01", dataset_name: "papers")
```
## Return Shape
