...
```ruby
ping = app.integrations.semgrep.ping()
findings = app.integrations.semgrep.list_code_supply_chain_or_ai_powered_scan_findings(deployment_slug: "example-deployment")
```
## Request Bodies
