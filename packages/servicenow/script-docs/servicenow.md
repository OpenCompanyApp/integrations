# ServiceNow — JavaScript API Reference
...
var result = app.integrations.servicenow.list_incidents({
  query: "active=true",
})
...
```js
var result = app.integrations.servicenow.get_incident({
...
```js
var result = app.integrations.servicenow.create_incident({
  short_description: "Email server !responding",
  description: "The mail server at mail.example.com has been unreachable since 09:00 UTC.",
  priority: "1",
})
console.log("Created incident: " + result.result.number)
```
---
...
```js
var result = app.integrations.servicenow.update_incident({
  id: "a9e4e1e14f3c41200bae4b8d0210c7d3",
  fields: {
    state: "6",
...
```js
var result = app.integrations.servicenow.list_tasks({
...
```js
var result = app.integrations.servicenow.get_task({
...
```js
var result = app.integrations.servicenow.create_task({
  short_description: "Provision new laptop for onboarding employee",
  description: "Order && configure a MacBook Pro for Jane Smith, starting March 1.",
  priority: "3",
})
```
---
...
var result = app.integrations.servicenow.list_users({
...
```js
var result = app.integrations.servicenow.get_user({
...
```js
var result = app.integrations.servicenow.get_current_user()
console.log("Logged in as: " + result.result.name)
```
---
