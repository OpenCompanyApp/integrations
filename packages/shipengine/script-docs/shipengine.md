...
```ruby
carriers = app.integrations.shipengine.list_carriers()
shipments = app.integrations.shipengine.list_shipments(shipment_status: "pending", page: 1, page_size: 25)
rates = app.integrations.shipengine.get_shipping_rates(body: {rate_options: {carrier_ids: ["se-123456"]}, shipment: {validate_address: "no_validation", ship_to: {name: "Receiver", address_line1: "123 Example St", city_locality: "Austin", state_province: "TX", postal_code: "78701", country_code: "US"}, ship_from: {name: "Sender", address_line1: "456 Example Ave", city_locality: "Austin", state_province: "TX", postal_code: "78702", country_code: "US"}, packages: [{weight: {value: 1, unit: "pound"}}]}})
```
