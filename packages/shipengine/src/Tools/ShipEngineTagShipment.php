 ...
 * Add Tag to Shipment.
 *
 * Maps to the official ShipEngine endpoint POST /v1/shipments/{shipment_id}/tags/{tag_name}.
 */
class ShipEngineTagShipment extends AbstractShipEngineTool
{
    protected const NAME = "shipengine_tag_shipment";
    protected const DESCRIPTION = "Add Tag to Shipment\n\nOfficial ShipEngine endpoint: POST /v1/shipments/{shipment_id}/tags/{tag_name}.";
