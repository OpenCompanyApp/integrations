 ...
 *
 * Maps to the official Shippo endpoint POST /customs/items.
 */
class ShippoCreateCustomsItem extends AbstractShippoTool
{
    protected const NAME = "shippo_create_customs_item";
    protected const DESCRIPTION = "Create a new customs item\n\nOfficial Shippo endpoint: POST /customs/items.";
