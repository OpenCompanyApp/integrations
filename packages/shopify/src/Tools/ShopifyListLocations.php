 ...
 */
class ShopifyListLocations extends AbstractShopifyRestTool
{
    protected string $toolName = 'shopify_list_locations';

    protected string $toolDescription = 'List Shopify Locations.';

    protected string $method = 'GET';

    protected string $path = '/locations.json';
