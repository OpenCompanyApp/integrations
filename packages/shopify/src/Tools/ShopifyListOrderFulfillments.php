 ...
 */
class ShopifyListOrderFulfillments extends AbstractShopifyRestTool
{
    protected string $toolName = 'shopify_list_order_fulfillments';

    protected string $toolDescription = 'List Fulfillments for a Shopify order.';
