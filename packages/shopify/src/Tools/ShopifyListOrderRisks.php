 ...
 */
class ShopifyListOrderRisks extends AbstractShopifyRestTool
{
    protected string $toolName = 'shopify_list_order_risks';

    protected string $toolDescription = 'List Risks for a Shopify order.';
