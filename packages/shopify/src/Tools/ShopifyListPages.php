 ...
 * List Shopify Pages.
 */
class ShopifyListPages extends AbstractShopifyRestTool
{
    protected string $toolName = 'shopify_list_pages';

    protected string $toolDescription = 'List Shopify Pages.';
    ...
    'handle' => [
        'type' => 'string',
        'required' => false,
        'description' => 'Shopify handle filter when supported.',
    ],
    'published_status' => [
        'type' => 'string',
        'required' => false,
