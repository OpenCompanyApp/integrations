 ...
 */
class ShopifyListSmartCollections extends AbstractShopifyRestTool
{
    protected string $toolName = 'shopify_list_smart_collections';

    protected string $toolDescription = 'List Shopify Smart Collections.';
