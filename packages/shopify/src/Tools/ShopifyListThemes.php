 ...
 * List Shopify Themes.
 */
class ShopifyListThemes extends AbstractShopifyRestTool
{
    protected string $toolName = 'shopify_list_themes';

    protected string $toolDescription = 'List Shopify Themes.';
    ...
    'role' => [
        'type' => 'string',
        'required' => false,
        'description' => 'Shopify role filter when supported.',
    ],
    'fields' => [
        'type' => 'string',
        'required' => false,
