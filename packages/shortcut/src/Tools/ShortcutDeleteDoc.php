 ...
 * Delete Doc.
 *
 * Maps to the official Shortcut endpoint DELETE /api/v3/documents/{doc-public-id}.
 */
class ShortcutDeleteDoc extends AbstractShortcutTool
{
    protected const NAME = 'shortcut_delete_doc';
    protected const DESCRIPTION = 'Delete Doc
