 ...
 * Search.
 *
 * Maps to the official Shortcut endpoint GET /api/v3/search.
 */
class ShortcutSearch extends AbstractShortcutTool
{
    protected const NAME = 'shortcut_search';
...
Official Shortcut endpoint: GET /api/v3/search.';
    ...
    protected const PATH = '/api/v3/search';
