 ...
 * Search Iterations.
 *
 * Maps to the official Shortcut endpoint GET /api/v3/search/iterations.
 */
class ShortcutSearchIterations extends AbstractShortcutTool
{
    protected const NAME = 'shortcut_search_iterations';
    protected const DESCRIPTION = 'Search Iterations
...
Official Shortcut endpoint: GET /api/v3/search/iterations.';
    ...
    protected const PATH = '/api/v3/search/iterations';
