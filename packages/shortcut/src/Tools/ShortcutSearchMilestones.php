 ...
 * Search Milestones.
 *
 * Maps to the official Shortcut endpoint GET /api/v3/search/milestones.
 */
class ShortcutSearchMilestones extends AbstractShortcutTool
{
    protected const NAME = 'shortcut_search_milestones';
    protected const DESCRIPTION = 'Search Milestones
...
Official Shortcut endpoint: GET /api/v3/search/milestones.';
    ...
    protected const PATH = '/api/v3/search/milestones';
