 ...
 * Search Objectives.
 *
 * Maps to the official Shortcut endpoint GET /api/v3/search/objectives.
 */
class ShortcutSearchObjectives extends AbstractShortcutTool
{
    protected const NAME = 'shortcut_search_objectives';
    protected const DESCRIPTION = 'Search Objectives
...
Official Shortcut endpoint: GET /api/v3/search/objectives.';
    ...
    protected const PATH = '/api/v3/search/objectives';
