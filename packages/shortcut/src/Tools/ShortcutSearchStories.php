 ...
 * Search Stories.
 *
 * Maps to the official Shortcut endpoint GET /api/v3/search/stories.
 */
class ShortcutSearchStories extends AbstractShortcutTool
{
    protected const NAME = 'shortcut_search_stories';
    protected const DESCRIPTION = 'Search Stories
...
Official Shortcut endpoint: GET /api/v3/search/stories.';
    ...
    protected const PATH = '/api/v3/search/stories';
