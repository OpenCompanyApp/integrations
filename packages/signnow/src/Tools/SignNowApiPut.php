...
/**
 * Call a relative SignNow API PUT endpoint.
 */
class SignNowApiPut extends AbstractSignNowTool implements Tool
{
    public function name(): string
    {
        return 'signnow_api_put';
    }

    public function description(): string
    {
        return 'Call a relative SignNow API PUT path. Absolute URLs are rejected.';
    }
