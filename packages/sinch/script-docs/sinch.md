# Client for the Sinch SMS API — Ruby API Reference
...
```ruby
result = app.integrations.sinch.list_messages(direction: "mt", page: 0, page_size: 30)
```
## sinch_send_sms
...
```ruby
result = app.integrations.sinch.send_sms(from: "+1234567890", to: ["+1987654321"], body: "Hello from Sinch!")
```
...
```ruby
result = app.integrations.sinch.list_phone_numbers(page: 0, page_size: 30)
```
...
```ruby
result = app.integrations.sinch.get_phone_number(phone_number: "+1234567890")
```
## sinch_list_groups
...
```ruby
result = app.integrations.sinch.list_groups(page: 0, page_size: 30)
```
## sinch_get_group
...
```ruby
result = app.integrations.sinch.get_group(group_id: "group_abc123")
```
## sinch_list_batches
...
```ruby
result = app.integrations.sinch.list_batches(page: 0, page_size: 30)
```
---
