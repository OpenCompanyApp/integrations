 ...
 *
 * Maps to configuration-api.json endpoint DELETE /configuration/job-properties/{id}/values/{valueId}.
 */
class SmartRecruitersConfigurationConfigurationJobPropertiesValuesDeprecatedArchive extends AbstractSmartRecruitersTool
{
    protected const NAME = "smartrecruiters_configuration_configuration_job_properties_values_deprecated_archive";
