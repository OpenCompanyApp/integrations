 ...
 *
 * Maps to configuration-api.json endpoint PUT /configuration/job-properties/{id}/values/{valueId}.
 */
class SmartRecruitersConfigurationConfigurationJobPropertiesValuesDeprecatedUnarchive extends AbstractSmartRecruitersTool
{
    protected const NAME = "smartrecruiters_configuration_configuration_job_properties_values_deprecated_unarchive";
