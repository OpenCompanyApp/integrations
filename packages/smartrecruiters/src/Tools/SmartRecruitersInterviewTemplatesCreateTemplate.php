...
/**
 * Create a interview template..
 *
 * Maps to interview-templates.json endpoint POST /templates.
 */
class SmartRecruitersInterviewTemplatesCreateTemplate extends AbstractSmartRecruitersTool
{
    protected const NAME = "smartrecruiters_interview_templates_create_template";
    protected const DESCRIPTION = "Create a interview template.\n\nOfficial SmartRecruiters endpoint: POST /templates from interview-templates.json.";
