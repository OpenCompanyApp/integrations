 ...
 *
 * Maps to jobs-api.json endpoint GET /jobs/{jobId}/jobads/{jobAdId}/postings.
 */
class SmartRecruitersJobsJobsJobadsPostingsAll extends AbstractSmartRecruitersTool
{
    protected const NAME = "smartrecruiters_jobs_jobs_jobads_postings_all";
    protected const DESCRIPTION = "List publications for a job ad\n\nOfficial SmartRecruiters endpoint: GET /jobs/{jobId}/jobads/{jobAdId}/postings from jobs-api.json.";
