 ...
 *
 * Maps to self-scheduling.json endpoint POST /self-schedules/{id}/application/{applicationUuid}/interview.
 */
class SmartRecruitersSelfSchedulingCreateSelfScheduleInterview extends AbstractSmartRecruitersTool
{
    protected const NAME = "smartrecruiters_self_scheduling_create_self_schedule_interview";
    protected const DESCRIPTION = "Create a self schedule interview\n\nOfficial SmartRecruiters endpoint: POST /self-schedules/{id}/application/{applicationUuid}/interview from self-scheduling.json.";
