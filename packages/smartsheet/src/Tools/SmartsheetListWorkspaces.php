 ...
 */
class SmartsheetListWorkspaces implements Tool
{
    /**
     * Create a new SmartsheetListWorkspaces tool instance.
     *
    ...
    {
        return 'smartsheet_list_workspaces';
    }
    ...
    {
        return 'List all workspaces accessible to the authenticated Smartsheet user.';
    }
    ...
    /**
     * Execute the list workspaces tool.
     *
     * @param array<string, mixed> $args Tool arguments containing optional 'limit' and 'page'.
     * @return ToolResult The result containing the list of workspaces or an error message.
     */
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listWorkspaces($limit, $page);
