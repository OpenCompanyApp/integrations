 ...
 *
 * Maps to the official Snyk endpoint post /orgs/{org_id}/learn/assignments/bulk_delete.
 */
class SnykDeleteOrgAssignmentsBulk extends AbstractSnykTool
{
    protected const NAME = 'snyk_delete_org_assignments_bulk';
    protected const DESCRIPTION = 'Bulk deletion of assignments in an organization (Early Access)

Official Snyk endpoint: POST /orgs/{org_id}/learn/assignments/bulk_delete
...
Allows an admin to delete multiple assignments within their organization. **Note**: Assignments that are part of a Learning Program cannot be deleted through this endpoint. #### Required permissions - `Delete assignments (org.learn_assignment.delete)`';
  ...
  array (
    ...
    protected const PATH = '/orgs/{org_id}/learn/assignments/bulk_delete';
