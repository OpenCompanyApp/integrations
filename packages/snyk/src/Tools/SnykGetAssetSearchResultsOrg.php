 ...
 *
 * Maps to the official Snyk endpoint get /orgs/{org_id}/inventory/assets/searches/{search_id}/results.
 */
class SnykGetAssetSearchResultsOrg extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_asset_search_results_org';
    protected const DESCRIPTION = 'Retrieve asset search results (asynchronous) - Org scope (Early Access)

Official Snyk endpoint: GET /orgs/{org_id}/inventory/assets/searches/{search_id}/results

Gets paginated results for a previously initiated asset search within an org context. #### Required permissions - `View Organization (org.read)`';
  ...
  array (
    ...
    protected const PATH = '/orgs/{org_id}/inventory/assets/searches/{search_id}/results';
