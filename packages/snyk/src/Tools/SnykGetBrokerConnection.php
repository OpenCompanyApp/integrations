 ...
 *
 * Maps to the official Snyk endpoint get /tenants/{tenant_id}/brokers/installs/{install_id}/deployments/{deployment_id}/connections/{connection_id}.
 */
class SnykGetBrokerConnection extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_broker_connection';
    protected const DESCRIPTION = 'Get Broker connection

Official Snyk endpoint: GET /tenants/{tenant_id}/brokers/installs/{install_id}/deployments/{deployment_id}/connections/{connection_id}

Get all Broker connection data for an deployment #### Required permissions - `View Tenant Details (tenant.read)`';
