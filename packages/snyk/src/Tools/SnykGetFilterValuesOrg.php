 ...
 *
 * Maps to the official Snyk endpoint get /orgs/{org_id}/inventory/assets/filters/{filter_id}/values.
 */
class SnykGetFilterValuesOrg extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_filter_values_org';
    protected const DESCRIPTION = 'Get filter value suggestions (autocomplete) - Org scope (Early Access)

Official Snyk endpoint: GET /orgs/{org_id}/inventory/assets/filters/{filter_id}/values

Returns a list of distinct values for a specific filter field. Useful for building autocomplete functionality in filter UIs. Use the UUID from the filter fields list endpoint to identify which field to query. For object filter values, both the keys and values are returned. #### Required permissions - `View Organization (org.read)`';
  ...
  array (
    ...
    protected const PATH = '/orgs/{org_id}/inventory/assets/filters/{filter_id}/values';
