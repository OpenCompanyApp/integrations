 ...
 *
 * Maps to the official Snyk endpoint get /groups/{group_id}/inventory/assets/groups/{group_field_id}/values.
 */
class SnykGetGroupValuesGroup extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_group_values_group';
    protected const DESCRIPTION = 'Get group value aggregation - Group scope (Early Access)

Official Snyk endpoint: GET /groups/{group_id}/inventory/assets/groups/{group_field_id}/values

Returns aggregated values for a specific group field id, showing the count of assets for each distinct value. Use the UUID from the group fields list endpoint to identify which field to query. #### Required permissions - `View Groups (group.read)`';
  ...
  array (
    ...
    protected const PATH = '/groups/{group_id}/inventory/assets/groups/{group_field_id}/values';
