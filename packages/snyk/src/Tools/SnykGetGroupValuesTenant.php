 ...
 *
 * Maps to the official Snyk endpoint get /tenants/{tenant_id}/inventory/assets/groups/{group_field_id}/values.
 */
class SnykGetGroupValuesTenant extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_group_values_tenant';
    protected const DESCRIPTION = 'Get group value aggregation (Early Access)

Official Snyk endpoint: GET /tenants/{tenant_id}/inventory/assets/groups/{group_field_id}/values

Returns aggregated values for a specific group field id, showing the count of assets for each distinct value. Use the UUID from the group fields list endpoint to identify which field to query. #### Required permissions - `View Tenant Details (tenant.read)`';
  ...
  array (
    ...
    protected const PATH = '/tenants/{tenant_id}/inventory/assets/groups/{group_field_id}/values';
