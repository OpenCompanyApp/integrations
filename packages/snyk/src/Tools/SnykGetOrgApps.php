 ...
 *
 * Maps to the official Snyk endpoint get /orgs/{org_id}/apps/creations.
 */
class SnykGetOrgApps extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_org_apps';
    protected const DESCRIPTION = 'Get a list of Snyk Apps created by an Organization

Official Snyk endpoint: GET /orgs/{org_id}/apps/creations

Get a list of Snyk Apps created by an Organization #### Required permissions - `View Apps (org.app.read)`';
