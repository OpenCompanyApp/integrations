 ...
 *
 * Maps to the official Snyk endpoint get /self/apps.
 */
class SnykGetUserInstalledApps extends AbstractSnykTool
{
    protected const NAME = 'snyk_get_user_installed_apps';
    protected const DESCRIPTION = 'Get a list of Snyk Apps that can act on your behalf

Official Snyk endpoint: GET /self/apps
...
Get a list of Snyk Apps that can act on your behalf';
  ...
  array (
    ...
    protected const PATH = '/self/apps';
