 ...
 *
 * Maps to the official Snyk endpoint get /orgs/{org_id}/inventory/assets/{asset_id}/relationships/projects.
 */
class SnykListAssetProjectsOrg extends AbstractSnykTool
{
    protected const NAME = 'snyk_list_asset_projects_org';
    protected const DESCRIPTION = 'List projects for an asset (org scope) (Early Access)

Official Snyk endpoint: GET /orgs/{org_id}/inventory/assets/{asset_id}/relationships/projects

Retrieves a paginated list of Snyk projects linked to this asset with full attributes. Returns the `id`, `type`, and `attributes` of each related project. Scoped to the specified organization. #### Required permissions - `View Organization (org.read)`';
  ...
  array (
    ...
    protected const PATH = '/orgs/{org_id}/inventory/assets/{asset_id}/relationships/projects';
