 ...
 *
 * Maps to the official Snyk endpoint get /tenants/{tenant_id}/brokers/installs/{install_id}/deployments/{deployment_id}/connections.
 */
class SnykListBrokerConnections extends AbstractSnykTool
{
    protected const NAME = 'snyk_list_broker_connections';
    protected const DESCRIPTION = 'List Broker connections

Official Snyk endpoint: GET /tenants/{tenant_id}/brokers/installs/{install_id}/deployments/{deployment_id}/connections

List all Broker connections for a given deployment #### Required permissions - `View Tenant Details (tenant.read)`';
