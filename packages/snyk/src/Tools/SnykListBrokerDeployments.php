 ...
 *
 * Maps to the official Snyk endpoint get /tenants/{tenant_id}/brokers/installs/{install_id}/deployments.
 */
class SnykListBrokerDeployments extends AbstractSnykTool
{
    protected const NAME = 'snyk_list_broker_deployments';
    protected const DESCRIPTION = 'List Broker deployments

Official Snyk endpoint: GET /tenants/{tenant_id}/brokers/installs/{install_id}/deployments

List Broker deployments for a given install ID #### Required permissions - `View Tenant Details (tenant.read)`';
