 ...
 *
 * Maps to the official Snyk endpoint get /tenants/{tenant_id}/brokers/deployments.
 */
class SnykListBrokerDeploymentsForTenant extends AbstractSnykTool
{
    protected const NAME = 'snyk_list_broker_deployments_for_tenant';
    protected const DESCRIPTION = 'List Broker deployments for tenant

Official Snyk endpoint: GET /tenants/{tenant_id}/brokers/deployments

List Broker deployments for the tenant #### Required permissions - `View Tenant Details (tenant.read)`';
  ...
  array (
    ...
    protected const PATH = '/tenants/{tenant_id}/brokers/deployments';
