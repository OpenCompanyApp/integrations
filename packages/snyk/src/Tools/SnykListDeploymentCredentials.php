 ...
 *
 * Maps to the official Snyk endpoint get /tenants/{tenant_id}/brokers/installs/{install_id}/deployments/{deployment_id}/credentials.
 */
class SnykListDeploymentCredentials extends AbstractSnykTool
{
    protected const NAME = 'snyk_list_deployment_credentials';
    protected const DESCRIPTION = 'List Deployment credentials

Official Snyk endpoint: GET /tenants/{tenant_id}/brokers/installs/{install_id}/deployments/{deployment_id}/credentials

List Deployment credentials for a given deployment ID #### Required permissions - `View Tenant Details (tenant.read)`';
