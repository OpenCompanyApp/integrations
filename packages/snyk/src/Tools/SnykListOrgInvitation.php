 ...
 *
 * Maps to the official Snyk endpoint get /orgs/{org_id}/invites.
 */
class SnykListOrgInvitation extends AbstractSnykTool
{
    protected const NAME = 'snyk_list_org_invitation';
    protected const DESCRIPTION = 'List pending user invitations to an organization.

Official Snyk endpoint: GET /orgs/{org_id}/invites

List pending user invitations to an organization. #### Required permissions - `View Organization (org.read)` - `View users (org.user.read)`';
