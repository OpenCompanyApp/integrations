...
```js
var projects = sonarcloud.sonarcloud_projects_search({ organization: "example-org" })
var measures = sonarcloud.sonarcloud_measures_component({ component: "example-key", metric_keys: "bugs,vulnerabilities,code_smells" })
```