...
```ruby
projects = app.integrations.sonarcloud.projects_search(organization: "example-org")
measures = app.integrations.sonarcloud.measures_component(component: "example-key", metric_keys: "bugs,vulnerabilities,code_smells")
```