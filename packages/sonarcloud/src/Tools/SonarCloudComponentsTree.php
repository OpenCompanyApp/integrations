 ...
 *
 * Maps to the official SonarCloud Web API endpoint GET /api/components/tree.
 */
class SonarCloudComponentsTree extends AbstractSonarCloudTool
{
    protected const NAME = 'sonarcloud_components_tree';
...
Official SonarCloud Web API endpoint: GET /api/components/tree.';
