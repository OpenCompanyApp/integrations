 ...
 *
 * Maps to the official SonarCloud Web API endpoint POST /api/notifications/add.
 */
class SonarCloudNotificationsAdd extends AbstractSonarCloudTool
{
    protected const NAME = 'sonarcloud_notifications_add';
...
Official SonarCloud Web API endpoint: POST /api/notifications/add.';
