 ...
 *
 * Maps to the official SonarCloud Web API endpoint POST /api/permissions/add_group.
 */
class SonarCloudPermissionsAddGroup extends AbstractSonarCloudTool
{
    protected const NAME = 'sonarcloud_permissions_add_group';
    protected const DESCRIPTION = 'Add permission to a group. This service defaults to global permissions, but can be limited to project permissions by providing project id or project key. The group name or group id must be provided. Requires the permission \'Administer\' on the specified project.

Official SonarCloud Web API endpoint: POST /api/permissions/add_group.';
