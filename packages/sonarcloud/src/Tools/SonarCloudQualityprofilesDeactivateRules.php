 ...
 *
 * Maps to the official SonarCloud Web API endpoint POST /api/qualityprofiles/deactivate_rules.
 */
class SonarCloudQualityprofilesDeactivateRules extends AbstractSonarCloudTool
{
    protected const NAME = 'sonarcloud_qualityprofiles_deactivate_rules';
...
Official SonarCloud Web API endpoint: POST /api/qualityprofiles/deactivate_rules.';
    protected const PARAMETERS = array (
      ...
      'rule_keys' => array (
        'type' => 'string',
        'description' => 'Comma-separated list of rule keys to deactivate. When provided, other search filter parameters are ignored.',
        'required' => false,
      ),
      's' => array (
        'type' => 'string',
