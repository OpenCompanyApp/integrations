 ...
 *
 * Maps to the official SonarCloud Web API endpoint GET /api/qualityprofiles/search.
 */
class SonarCloudQualityprofilesSearch extends AbstractSonarCloudTool
{
    protected const NAME = 'sonarcloud_qualityprofiles_search';
    protected const DESCRIPTION = 'Search quality profiles

Official SonarCloud Web API endpoint: GET /api/qualityprofiles/search.';
