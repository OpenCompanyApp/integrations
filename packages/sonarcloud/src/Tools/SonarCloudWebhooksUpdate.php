 ...
 *
 * Maps to the official SonarCloud Web API endpoint POST /api/webhooks/update.
 */
class SonarCloudWebhooksUpdate extends AbstractSonarCloudTool
{
    protected const NAME = 'sonarcloud_webhooks_update';
...
Official SonarCloud Web API endpoint: POST /api/webhooks/update.';
