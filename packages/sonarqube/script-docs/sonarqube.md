...
```js
var projects = sonarqube.sonarqube_projects_search({ q: "example" })
var measures = sonarqube.sonarqube_measures_component({ component: "example-key", metric_keys: "bugs,vulnerabilities,code_smells" })
```