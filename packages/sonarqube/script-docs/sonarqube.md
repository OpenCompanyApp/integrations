...
```ruby
projects = app.integrations.sonarqube.projects_search(q: "example")
measures = app.integrations.sonarqube.measures_component(component: "example-key", metric_keys: "bugs,vulnerabilities,code_smells")
```