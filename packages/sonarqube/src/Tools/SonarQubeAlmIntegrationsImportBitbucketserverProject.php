...
/**
 * Create a SonarQube project with the information from the provided BitbucketServer project. Autoconfigure pull request decoration mechanism. Requires the 'Create Projects' permission.
 *
 * Maps to the official SonarQube Web API endpoint POST /api/alm_integrations/import_bitbucketserver_project.
 */
class SonarQubeAlmIntegrationsImportBitbucketserverProject extends AbstractSonarQubeTool
{
    protected const NAME = 'sonarqube_alm_integrations_import_bitbucketserver_project';
    protected const DESCRIPTION = 'Create a SonarQube project with the information from the provided BitbucketServer project. Autoconfigure pull request decoration mechanism. Requires the \'Create Projects\' permission

Official SonarQube Web API endpoint: POST /api/alm_integrations/import_bitbucketserver_project.
...
Deprecated since SonarQube 10.5; kept for API parity with servers that still expose it.';
    ...
    protected const PATH = '/api/alm_integrations/import_bitbucketserver_project';
