 ...
 *
 * Maps to the official SonarQube Web API endpoint POST /api/qualityprofiles/activate_rules.
 */
class SonarQubeQualityprofilesActivateRules extends AbstractSonarQubeTool
{
    protected const NAME = 'sonarqube_qualityprofiles_activate_rules';
...
Official SonarQube Web API endpoint: POST /api/qualityprofiles/activate_rules.';
