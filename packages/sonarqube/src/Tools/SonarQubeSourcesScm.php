 ...
 *
 * Maps to the official SonarQube Web API endpoint GET /api/sources/scm.
 */
class SonarQubeSourcesScm extends AbstractSonarQubeTool
{
    protected const NAME = 'sonarqube_sources_scm';
...
Official SonarQube Web API endpoint: GET /api/sources/scm.';
