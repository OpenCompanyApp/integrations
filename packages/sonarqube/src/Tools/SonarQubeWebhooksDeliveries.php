 ...
 *
 * Maps to the official SonarQube Web API endpoint GET /api/webhooks/deliveries.
 */
class SonarQubeWebhooksDeliveries extends AbstractSonarQubeTool
{
    protected const NAME = 'sonarqube_webhooks_deliveries';
...
Official SonarQube Web API endpoint: GET /api/webhooks/deliveries.';
