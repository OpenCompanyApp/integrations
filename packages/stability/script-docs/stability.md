# Stability AI JavaScript API Reference
...
```js
var image = app.integrations.stability.generate_core({
...
```js
var result = app.integrations.stability.remove_background({
...
```js
var fast = app.integrations.stability.upscale_fast({
  image: "/tmp/small.png",
  output_format: "png",
})
```
...
```js
var job = app.integrations.stability.image_to_video({
  image: "/tmp/hero.png",
  motion_bucket_id: 127,
})

var video = app.integrations.stability.get_video_result({
  id: job.id,
})
```
