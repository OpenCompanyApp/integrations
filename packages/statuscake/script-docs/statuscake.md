...
```ruby
uptime = app.integrations.statuscake.list_uptime_tests(page: 1, limit: 25)
locations = app.integrations.statuscake.list_uptime_monitoring_locations()
```