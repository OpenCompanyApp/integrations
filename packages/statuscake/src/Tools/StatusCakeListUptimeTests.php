 ...
 *
 * Maps to the official StatusCake endpoint GET /uptime.
 */
class StatusCakeListUptimeTests extends AbstractStatusCakeTool
{
    protected const NAME = 'statuscake_list_uptime_tests';
    protected const DESCRIPTION = 'Returns a list of uptime checks for an account.

Official StatusCake endpoint: GET /uptime.';
