# Stripe — JavaScript API Reference
...
```js
var customer = app.integrations.stripe.create_customer({
    name: "Acme Corp",
...
```js
var customer = app.integrations.stripe.get_customer({
    id: "cus_abc123",
})
...
```js
var customer = app.integrations.stripe.update_customer({
    id: "cus_abc123",
...
var result = app.integrations.stripe.list_customers({
    limit: 25,
})
...
var page2 = app.integrations.stripe.list_customers({
    limit: 25,
...
```js
var result = app.integrations.stripe.delete_customer({
    id: "cus_abc123",
})
...
```js
var product = app.integrations.stripe.create_product({
    name: "Pro Plan",
...
```js
var product = app.integrations.stripe.get_product({
    id: "prod_xyz789",
})
...
```js
// List all products
var result = app.integrations.stripe.list_products({
    limit: 50,
})
...
// Paginate
var page2 = app.integrations.stripe.list_products({
    limit: 50,
...
var price = app.integrations.stripe.create_price({
    product: "prod_xyz789",
    unit_amount: 2999,
    currency: "usd",
...
var result = app.integrations.stripe.list_prices({
    product: "prod_xyz789",
})
...
// Paginate
var page2 = app.integrations.stripe.list_prices({
    limit: 50,
...
var intent = app.integrations.stripe.create_payment_intent({
    amount: 5000,
    currency: "usd",
    customer: "cus_abc123",
...
```js
var intent = app.integrations.stripe.get_payment_intent({
    id: "pi_ghi789",
})
...
```js
var intent = app.integrations.stripe.update_payment_intent({
    id: "pi_ghi789",
...
```js
var intent = app.integrations.stripe.confirm_payment_intent({
    id: "pi_ghi789",
...
```js
var intent = app.integrations.stripe.cancel_payment_intent({
    id: "pi_ghi789",
...
var intent = app.integrations.stripe.capture_payment_intent({
    id: "pi_ghi789",
})
...
```js
var invoice = app.integrations.stripe.create_invoice({
    customer: "cus_abc123",
...
```js
var invoice = app.integrations.stripe.get_invoice({
    id: "in_jkl012",
})
...
var result = app.integrations.stripe.list_invoices({
    customer: "cus_abc123",
    limit: 25,
})
...
// Paginate
var page2 = app.integrations.stripe.list_invoices({
    customer: "cus_abc123",
    limit: 25,
...
```js
var result = app.integrations.stripe.pay_invoice({
    id: "in_jkl012",
})
...
```js
var result = app.integrations.stripe.void_invoice({
    id: "in_jkl012",
})
...
var subscription = app.integrations.stripe.create_subscription({
    customer: "cus_abc123",
    price: "price_def456",
})
...
```js
var subscription = app.integrations.stripe.get_subscription({
    id: "sub_mno345",
})
// Returns: { id: "sub_mno345", customer: "cus_abc123", status: "active", plan: { /* parameters */ }}
```
...
var result = app.integrations.stripe.cancel_subscription({
    id: "sub_mno345",
    prorate: true,
    invoice_now: true,
})
...
```js
var balance = app.integrations.stripe.get_balance({})
...
do {
    ...
    var result = app.integrations.stripe.list_customers(args)
...
var confirmed = app.integrations.stripe.confirm_payment_intent({
    id: intent.id,
    payment_method: "pm_card_visa",
})
```
...
var captured = app.integrations.stripe.capture_payment_intent({
    id: intent.id,
...
var paid = app.integrations.stripe.pay_invoice({
    id: invoice.id,
})
```
...
app.integrations.stripe.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.stripe.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.stripe.work.function_name({ /* parameters */ })
app.integrations.stripe.personal.function_name({ /* parameters */ })
```
