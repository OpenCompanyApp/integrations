 ...
 * Create user invites.
 *
 * Maps to the official Tailscale endpoint post /tailnet/{tailnet}/user-invites.
 */
class TailscaleCreateUserInvites extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_create_user_invites';
    protected const DESCRIPTION = 'Create user invites

Official Tailscale endpoint: POST /tailnet/{tailnet}/user-invites
