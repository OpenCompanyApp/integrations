 ...
 * Create a webhook.
 *
 * Maps to the official Tailscale endpoint post /tailnet/{tailnet}/webhooks.
 */
class TailscaleCreateWebhook extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_create_webhook';
    protected const DESCRIPTION = 'Create a webhook

Official Tailscale endpoint: POST /tailnet/{tailnet}/webhooks
