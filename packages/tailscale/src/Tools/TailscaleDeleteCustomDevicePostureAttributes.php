 ...
 *
 * Maps to the official Tailscale endpoint delete /device/{deviceId}/attributes/{attributeKey}.
 */
class TailscaleDeleteCustomDevicePostureAttributes extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_delete_custom_device_posture_attributes';
    protected const DESCRIPTION = 'Delete custom device posture attributes

Official Tailscale endpoint: DELETE /device/{deviceId}/attributes/{attributeKey}
