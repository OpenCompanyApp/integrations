 ...
 * Delete a Service.
 *
 * Maps to the official Tailscale endpoint delete /tailnet/{tailnet}/services/{serviceName}.
 */
class TailscaleDeleteService extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_delete_service';
    protected const DESCRIPTION = 'Delete a Service

Official Tailscale endpoint: DELETE /tailnet/{tailnet}/services/{serviceName}
