 ...
 * Get contacts.
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/contacts.
 */
class TailscaleGetContacts extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_get_contacts';
    protected const DESCRIPTION = 'Get contacts

Official Tailscale endpoint: GET /tailnet/{tailnet}/contacts
...
- Provide the **tailnet ID** found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**
  ...
  Learn more about [tailnet ID](https://tailscale.com/kb/1217/tailnet-name#tailnet-id).',
    ...
    protected const PATH = '/tailnet/{tailnet}/contacts';
