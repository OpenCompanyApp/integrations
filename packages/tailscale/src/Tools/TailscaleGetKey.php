 ...
 * Get key.
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/keys/{keyId}.
 */
class TailscaleGetKey extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_get_key';
    protected const DESCRIPTION = 'Get key

Official Tailscale endpoint: GET /tailnet/{tailnet}/keys/{keyId}
