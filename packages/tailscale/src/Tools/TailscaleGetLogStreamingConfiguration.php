 ...
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/logging/{logType}/stream.
 */
class TailscaleGetLogStreamingConfiguration extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_get_log_streaming_configuration';
    protected const DESCRIPTION = 'Get log streaming configuration

Official Tailscale endpoint: GET /tailnet/{tailnet}/logging/{logType}/stream
