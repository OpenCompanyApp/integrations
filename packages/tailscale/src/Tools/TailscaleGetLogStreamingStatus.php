 ...
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/logging/{logType}/stream/status.
 */
class TailscaleGetLogStreamingStatus extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_get_log_streaming_status';
    protected const DESCRIPTION = 'Get log streaming status

Official Tailscale endpoint: GET /tailnet/{tailnet}/logging/{logType}/stream/status
...
- Provide the **tailnet ID** found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**
  ...
  array (
    ...
    protected const PATH = '/tailnet/{tailnet}/logging/{logType}/stream/status';
