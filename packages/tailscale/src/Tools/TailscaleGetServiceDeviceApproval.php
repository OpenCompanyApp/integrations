 ...
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/services/{serviceName}/device/{deviceId}/approved.
 */
class TailscaleGetServiceDeviceApproval extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_get_service_device_approval';
    protected const DESCRIPTION = 'Get approval status of Service on a device

Official Tailscale endpoint: GET /tailnet/{tailnet}/services/{serviceName}/device/{deviceId}/approved
