 ...
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/dns/nameservers.
 */
class TailscaleListDnsNameservers extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_list_dns_nameservers';
    protected const DESCRIPTION = 'List DNS nameservers

Official Tailscale endpoint: GET /tailnet/{tailnet}/dns/nameservers
...
- Provide the **tailnet ID** found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**
  ...
  Learn more about [tailnet ID](https://tailscale.com/kb/1217/tailnet-name#tailnet-id).',
    ...
    protected const PATH = '/tailnet/{tailnet}/dns/nameservers';
