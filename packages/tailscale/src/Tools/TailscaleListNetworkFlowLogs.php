 ...
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/logging/network.
 */
class TailscaleListNetworkFlowLogs extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_list_network_flow_logs';
    protected const DESCRIPTION = 'List network flow logs

Official Tailscale endpoint: GET /tailnet/{tailnet}/logging/network
...
- Provide the **tailnet ID** found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**
  ...
  array (
    ...
    protected const PATH = '/tailnet/{tailnet}/logging/network';
