 ...
 *
 * Maps to the official Tailscale endpoint get /tailnet/{tailnet}/services/{serviceName}/devices.
 */
class TailscaleListServiceHosts extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_list_service_hosts';
    protected const DESCRIPTION = 'List devices hosting a Service

Official Tailscale endpoint: GET /tailnet/{tailnet}/services/{serviceName}/devices
...
across the tailnet, so names already used for a machine cannot be reused for a Service.',
    ...
    protected const PATH = '/tailnet/{tailnet}/services/{serviceName}/devices';
