 ...
 * Set DNS nameservers.
 *
 * Maps to the official Tailscale endpoint post /tailnet/{tailnet}/dns/nameservers.
 */
class TailscaleSetDnsNameservers extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_set_dns_nameservers';
    protected const DESCRIPTION = 'Set DNS nameservers

Official Tailscale endpoint: POST /tailnet/{tailnet}/dns/nameservers
