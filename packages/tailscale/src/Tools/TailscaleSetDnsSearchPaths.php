 ...
 *
 * Maps to the official Tailscale endpoint post /tailnet/{tailnet}/dns/searchpaths.
 */
class TailscaleSetDnsSearchPaths extends AbstractTailscaleTool
{
    protected const NAME = 'tailscale_set_dns_search_paths';
    protected const DESCRIPTION = 'Set DNS search paths

Official Tailscale endpoint: POST /tailnet/{tailnet}/dns/searchpaths
