...
/**
 * Tool to list refund transactions from TaxJar with optional filtering and pagination.
 *
 * Returns refund details including transaction ID, amount, tax, and date.
 */
class TaxjarListRefunds implements Tool
{
    /**
     * Create a new TaxjarListRefunds tool instance.
     *
    ...
    {
        return 'List refund transactions from TaxJar with optional date filtering and pagination. Returns refund details including transaction ID, amount, tax, and date.';
    }
    ...
    /**
     * Execute the list refunds request.
     *
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            $result = $this->service->listRefunds(
