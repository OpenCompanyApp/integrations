...
```ruby
namespaces = app.integrations.temporal.temporal_list_namespaces()
workflows = app.integrations.temporal.temporal_list_workflow_executions(namespace: "default", query: "WorkflowType = \"OrderWorkflow\"")
```
## Request Bodies
