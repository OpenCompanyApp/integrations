 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/worker-deployments/{deploymentName}.
 */
class TemporalCreateWorkerDeployment2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_create_worker_deployment_2';
    protected const DESCRIPTION = 'Create worker deployment

Official Temporal endpoint: POST /namespaces/{namespace}/worker-deployments/{deploymentName}
