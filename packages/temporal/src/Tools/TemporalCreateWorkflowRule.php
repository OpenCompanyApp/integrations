 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/workflow-rules.
 */
class TemporalCreateWorkflowRule extends AbstractTemporalTool
{
    protected const NAME = 'temporal_create_workflow_rule';
    protected const DESCRIPTION = 'Create workflow rule

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/workflow-rules
