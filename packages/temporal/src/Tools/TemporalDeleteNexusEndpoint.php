 ...
 *
 * Maps to the official Temporal endpoint delete /api/v1/nexus/endpoints/{id}.
 */
class TemporalDeleteNexusEndpoint extends AbstractTemporalTool
{
    protected const NAME = 'temporal_delete_nexus_endpoint';
    protected const DESCRIPTION = 'Delete nexus endpoint

Official Temporal endpoint: DELETE /api/v1/nexus/endpoints/{id}
