 ...
 *
 * Maps to the official Temporal endpoint delete /namespaces/{namespace}/worker-deployment-versions/{deployment_version.deployment_name}/{deployment_version.build_id}.
 */
class TemporalDeleteWorkerDeploymentVersion2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_delete_worker_deployment_version_2';
    protected const DESCRIPTION = 'Delete worker deployment version

Official Temporal endpoint: DELETE /namespaces/{namespace}/worker-deployment-versions/{deployment_version.deployment_name}/{deployment_version.build_id}
...
Used for manual deletion of Versions. User can delete a Version only when all the
 ...
 workflows will be stuck until manually moved to another version by UpdateWorkflowExecutionOptions.',
  ...
  'description' => 'Optional. The identity of the client who initiated this request.',
    ...
    protected const PATH = '/namespaces/{namespace}/worker-deployment-versions/{deployment_version.deployment_name}/{deployment_version.build_id}';
