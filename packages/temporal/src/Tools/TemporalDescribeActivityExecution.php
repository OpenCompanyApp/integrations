 ...
 *
 * Maps to the official Temporal endpoint get /api/v1/namespaces/{namespace}/activities/{activityId}.
 */
class TemporalDescribeActivityExecution extends AbstractTemporalTool
{
    protected const NAME = 'temporal_describe_activity_execution';
    protected const DESCRIPTION = 'Describe activity execution

Official Temporal endpoint: GET /api/v1/namespaces/{namespace}/activities/{activityId}
