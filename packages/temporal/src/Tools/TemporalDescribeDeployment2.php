 ...
 * Describe deployment.
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/deployments/{deployment.series_name}/{deployment.build_id}.
 */
class TemporalDescribeDeployment2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_describe_deployment_2';
    protected const DESCRIPTION = 'Describe deployment

Official Temporal endpoint: GET /namespaces/{namespace}/deployments/{deployment.series_name}/{deployment.build_id}
...
Describes a worker deployment.
 ...
 changes.',
    ...
    protected const PATH = '/namespaces/{namespace}/deployments/{deployment.series_name}/{deployment.build_id}';
