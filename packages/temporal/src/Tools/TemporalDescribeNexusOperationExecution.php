 ...
 *
 * Maps to the official Temporal endpoint get /api/v1/namespaces/{namespace}/nexus-operations/{operationId}.
 */
class TemporalDescribeNexusOperationExecution extends AbstractTemporalTool
{
    protected const NAME = 'temporal_describe_nexus_operation_execution';
    protected const DESCRIPTION = 'Describe nexus operation execution

Official Temporal endpoint: GET /api/v1/namespaces/{namespace}/nexus-operations/{operationId}
