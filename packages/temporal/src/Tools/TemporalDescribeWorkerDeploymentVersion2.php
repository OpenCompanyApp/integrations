 ...
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/worker-deployment-versions/{deployment_version.deployment_name}/{deployment_version.build_id}.
 */
class TemporalDescribeWorkerDeploymentVersion2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_describe_worker_deployment_version_2';
    protected const DESCRIPTION = 'Describe worker deployment version

Official Temporal endpoint: GET /namespaces/{namespace}/worker-deployment-versions/{deployment_version.deployment_name}/{deployment_version.build_id}
