 ...
 *
 * Maps to the official Temporal endpoint get /api/v1/namespaces/{namespace}/deployments/{deployment.series_name}/{deployment.build_id}/reachability.
 */
class TemporalGetDeploymentReachability extends AbstractTemporalTool
{
    protected const NAME = 'temporal_get_deployment_reachability';
    protected const DESCRIPTION = 'Get deployment reachability

Official Temporal endpoint: GET /api/v1/namespaces/{namespace}/deployments/{deployment.series_name}/{deployment.build_id}/reachability
...
Returns the reachability level of a worker deployment to help users decide when it is time
 ...
 changes.',
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/deployments/{deployment.series_name}/{deployment.build_id}/reachability';
