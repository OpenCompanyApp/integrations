 ...
 *
 * Maps to the official Temporal endpoint get /api/v1/namespaces/{namespace}/worker-task-reachability.
 */
class TemporalGetWorkerTaskReachability extends AbstractTemporalTool
{
    protected const NAME = 'temporal_get_worker_task_reachability';
    protected const DESCRIPTION = 'Get worker task reachability

Official Temporal endpoint: GET /api/v1/namespaces/{namespace}/worker-task-reachability
...
Deprecated. Use `DescribeTaskQueue`.
 ...
 See the TaskReachability docstring for information about each enum variant.',
  ...
  'TASK_REACHABILITY_CLOSED_WORKFLOWS',
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/worker-task-reachability';
