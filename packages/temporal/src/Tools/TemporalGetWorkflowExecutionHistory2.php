 ...
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/workflows/{execution.workflow_id}/history.
 */
class TemporalGetWorkflowExecutionHistory2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_get_workflow_execution_history_2';
    protected const DESCRIPTION = 'Get workflow execution history

Official Temporal endpoint: GET /namespaces/{namespace}/workflows/{execution.workflow_id}/history
...
GetWorkflowExecutionHistory returns the history of specified workflow execution. Fails with
 ...
 Default: HISTORY_EVENT_FILTER_TYPE_ALL_EVENT.',
  ...
  'description' => 'skipArchival parameter.',
    ...
    protected const PATH = '/namespaces/{namespace}/workflows/{execution.workflow_id}/history';
