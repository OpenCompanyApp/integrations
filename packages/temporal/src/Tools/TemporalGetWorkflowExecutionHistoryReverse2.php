 ...
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/workflows/{execution.workflow_id}/history-reverse.
 */
class TemporalGetWorkflowExecutionHistoryReverse2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_get_workflow_execution_history_reverse_2';
    protected const DESCRIPTION = 'Get workflow execution history reverse

Official Temporal endpoint: GET /namespaces/{namespace}/workflows/{execution.workflow_id}/history-reverse
...
GetWorkflowExecutionHistoryReverse returns the history of specified workflow execution in reverse
 ...
 unknown to the service.';
  ...
  'description' => 'nextPageToken parameter.',
    ...
    protected const PATH = '/namespaces/{namespace}/workflows/{execution.workflow_id}/history-reverse';
