 ...
 * List deployments.
 *
 * Maps to the official Temporal endpoint get /api/v1/namespaces/{namespace}/deployments.
 */
class TemporalListDeployments extends AbstractTemporalTool
{
    protected const NAME = 'temporal_list_deployments';
    protected const DESCRIPTION = 'List deployments

Official Temporal endpoint: GET /api/v1/namespaces/{namespace}/deployments
...
Lists worker deployments in the namespace. Optionally can filter based on deployment series
 ...
 Deprecated. Replaced with `ListWorkerDeployments`.';
  ...
  'description' => 'Optional. Use to filter based on exact series name match.',
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/deployments';
