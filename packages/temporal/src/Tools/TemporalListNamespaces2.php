 ...
 * List namespaces.
 *
 * Maps to the official Temporal endpoint get /cluster/namespaces.
 */
class TemporalListNamespaces2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_list_namespaces_2';
    protected const DESCRIPTION = 'List namespaces

Official Temporal endpoint: GET /cluster/namespaces
