 ...
 *
 * Maps to the official Temporal endpoint get /api/v1/nexus/endpoints.
 */
class TemporalListNexusEndpoints extends AbstractTemporalTool
{
    protected const NAME = 'temporal_list_nexus_endpoints';
    protected const DESCRIPTION = 'List nexus endpoints

Official Temporal endpoint: GET /api/v1/nexus/endpoints
