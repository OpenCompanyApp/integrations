 ...
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/nexus-operations.
 */
class TemporalListNexusOperationExecutions2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_list_nexus_operation_executions_2';
    protected const DESCRIPTION = 'List nexus operation executions

Official Temporal endpoint: GET /namespaces/{namespace}/nexus-operations
...
ListNexusOperationExecutions is a visibility API to list Nexus operations in a specific namespace.';
 ...
 - StateTransitionCount',
    ...
    protected const PATH = '/namespaces/{namespace}/nexus-operations';
