 ...
 * List workers.
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/workers.
 */
class TemporalListWorkers2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_list_workers_2';
    protected const DESCRIPTION = 'List workers

Official Temporal endpoint: GET /namespaces/{namespace}/workers
...
* Status',
 ...
 by the server and not by the user. By default, system workers are excluded.',
    ...
    protected const PATH = '/namespaces/{namespace}/workers';
