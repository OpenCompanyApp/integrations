 ...
 * Pause activity.
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/activities-deprecated/pause.
 */
class TemporalPauseActivity extends AbstractTemporalTool
{
    protected const NAME = 'temporal_pause_activity';
    protected const DESCRIPTION = 'Pause activity

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/activities-deprecated/pause
...
PauseActivity pauses the execution of an activity specified by its ID or type.
 ...
 structured to work well for standalone activities.';
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/activities-deprecated/pause';
