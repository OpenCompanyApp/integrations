 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/activities/{activityId}/pause.
 */
class TemporalPauseActivityExecution3 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_pause_activity_execution_3';
    protected const DESCRIPTION = 'Pause activity execution

Official Temporal endpoint: POST /namespaces/{namespace}/activities/{activityId}/pause
...
PauseActivityExecution pauses the execution of an activity specified by its ID.
 ...
 Returns a `NotFound` error if there is no pending activity with the provided ID';
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/activities/{activityId}/pause';
