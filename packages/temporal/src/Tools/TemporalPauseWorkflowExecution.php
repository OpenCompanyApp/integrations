 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/workflows/{workflowId}/pause.
 */
class TemporalPauseWorkflowExecution extends AbstractTemporalTool
{
    protected const NAME = 'temporal_pause_workflow_execution';
    protected const DESCRIPTION = 'Pause workflow execution

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/workflows/{workflowId}/pause
...
Note: This is an experimental API and the behavior may change in a future release.
 ...
 - Queries & Updates on a paused workflow will be rejected.';
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/workflows/{workflowId}/pause';
