 ...
 *
 * Maps to the official Temporal endpoint get /namespaces/{namespace}/nexus-operations/{operationId}/poll.
 */
class TemporalPollNexusOperationExecution2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_poll_nexus_operation_execution_2';
    protected const DESCRIPTION = 'Poll nexus operation execution

Official Temporal endpoint: GET /namespaces/{namespace}/nexus-operations/{operationId}/poll
...
PollNexusOperationExecution long-polls for a Nexus operation for a given wait stage to complete and returns
 the outcome (result or failure).';
  ...
  'NEXUS_OPERATION_WAIT_STAGE_CLOSED',
    ...
    protected const PATH = '/namespaces/{namespace}/nexus-operations/{operationId}/poll';
