 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/activity-heartbeat.
 */
class TemporalRecordActivityTaskHeartbeat extends AbstractTemporalTool
{
    protected const NAME = 'temporal_record_activity_task_heartbeat';
    protected const DESCRIPTION = 'Record activity task heartbeat

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/activity-heartbeat
...
RecordActivityTaskHeartbeat is optionally called by workers while they execute activities.
 ...
 indicates whether cancellation has been requested for the activity.';
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/activity-heartbeat';
