 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/activities/{activityId}/cancel.
 */
class TemporalRequestCancelActivityExecution2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_request_cancel_activity_execution_2';
    protected const DESCRIPTION = 'Request cancel activity execution

Official Temporal endpoint: POST /namespaces/{namespace}/activities/{activityId}/cancel
...
RequestCancelActivityExecution requests cancellation of an activity execution.
 ...
 language-idiomatic mechanisms (context cancellation, exceptions, abort signals).';
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/activities/{activityId}/cancel';
