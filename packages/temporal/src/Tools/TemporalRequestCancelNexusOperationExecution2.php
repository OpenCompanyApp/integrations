 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/nexus-operations/{operationId}/cancel.
 */
class TemporalRequestCancelNexusOperationExecution2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_request_cancel_nexus_operation_execution_2';
    protected const DESCRIPTION = 'Request cancel nexus operation execution

Official Temporal endpoint: POST /namespaces/{namespace}/nexus-operations/{operationId}/cancel
...
RequestCancelNexusOperationExecution requests cancellation of a Nexus operation.
 ...
 processes the cancellation request.';
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/nexus-operations/{operationId}/cancel';
