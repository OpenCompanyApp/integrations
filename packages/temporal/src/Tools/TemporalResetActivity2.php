 ...
 * Reset activity.
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/activities-deprecated/reset.
 */
class TemporalResetActivity2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_reset_activity_2';
    protected const DESCRIPTION = 'Reset activity

Official Temporal endpoint: POST /namespaces/{namespace}/activities-deprecated/reset
 ...
 * if the activity is waiting for retry, and it is not paused or \'keep_paused\' is not provided:
 ...
 structured to work well for standalone activities.';
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/activities-deprecated/reset';
