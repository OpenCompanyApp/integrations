 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/reset.
 */
class TemporalResetActivityExecution4 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_reset_activity_execution_4';
    protected const DESCRIPTION = 'Reset activity execution

Official Temporal endpoint: POST /namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/reset
 ...
 * if the activity is waiting for retry, and it is not paused or \'keep_paused\' is not provided:
 ...
 If empty, targets a standalone activity.',
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/reset';
