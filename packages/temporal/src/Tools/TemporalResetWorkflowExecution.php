 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/workflows/{workflow_execution.workflow_id}/reset.
 */
class TemporalResetWorkflowExecution extends AbstractTemporalTool
{
    protected const NAME = 'temporal_reset_workflow_execution';
    protected const DESCRIPTION = 'Reset workflow execution

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/workflows/{workflow_execution.workflow_id}/reset
...
ResetWorkflowExecution will reset an existing workflow execution to a specified
 ...
 immediately, and a new workflow task will be scheduled to retry it.';
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/workflows/{workflow_execution.workflow_id}/reset';
