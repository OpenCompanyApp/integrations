 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/activities/{activityId}.
 */
class TemporalStartActivityExecution2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_start_activity_execution_2';
    protected const DESCRIPTION = 'Start activity execution

Official Temporal endpoint: POST /namespaces/{namespace}/activities/{activityId}
