 ...
 * Unpause activity.
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/activities-deprecated/unpause.
 */
class TemporalUnpauseActivity extends AbstractTemporalTool
{
    protected const NAME = 'temporal_unpause_activity';
    protected const DESCRIPTION = 'Unpause activity

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/activities-deprecated/unpause
...
UnpauseActivity unpauses the execution of an activity specified by its ID or type.
 ...
 structured to work well for standalone activities.';
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/activities-deprecated/unpause';
