 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/unpause.
 */
class TemporalUnpauseActivityExecution2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_unpause_activity_execution_2';
    protected const DESCRIPTION = 'Unpause activity execution

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/unpause
...
UnpauseActivityExecution unpauses the execution of an activity specified by its ID.
 ...
 If empty, targets a standalone activity.',
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/unpause';
