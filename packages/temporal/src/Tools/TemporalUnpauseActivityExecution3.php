 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/activities/{activityId}/unpause.
 */
class TemporalUnpauseActivityExecution3 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_unpause_activity_execution_3';
    protected const DESCRIPTION = 'Unpause activity execution

Official Temporal endpoint: POST /namespaces/{namespace}/activities/{activityId}/unpause
...
UnpauseActivityExecution unpauses the execution of an activity specified by its ID.
 ...
 Returns a `NotFound` error if there is no pending activity with the provided ID';
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/activities/{activityId}/unpause';
