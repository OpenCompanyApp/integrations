 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/unpause.
 */
class TemporalUnpauseActivityExecution4 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_unpause_activity_execution_4';
    protected const DESCRIPTION = 'Unpause activity execution

Official Temporal endpoint: POST /namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/unpause
...
UnpauseActivityExecution unpauses the execution of an activity specified by its ID.
 ...
 If empty, targets a standalone activity.',
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/unpause';
