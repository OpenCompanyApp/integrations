 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/workflows/{workflowId}/unpause.
 */
class TemporalUnpauseWorkflowExecution extends AbstractTemporalTool
{
    protected const NAME = 'temporal_unpause_workflow_execution';
    protected const DESCRIPTION = 'Unpause workflow execution

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/workflows/{workflowId}/unpause
...
Note: This is an experimental API and the behavior may change in a future release.
 ...
 - Workflow tasks and activity tasks are resumed.';
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/workflows/{workflowId}/unpause';
