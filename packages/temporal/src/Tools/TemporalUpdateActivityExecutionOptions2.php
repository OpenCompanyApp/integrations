 ...
 *
 * Maps to the official Temporal endpoint post /api/v1/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/update-options.
 */
class TemporalUpdateActivityExecutionOptions2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_update_activity_execution_options_2';
    protected const DESCRIPTION = 'Update activity execution options

Official Temporal endpoint: POST /api/v1/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/update-options
...
UpdateActivityExecutionOptions is called by the client to update the options of an activity by its ID.
 ...
 If empty, targets a standalone activity.',
  ...
  'required' => true,
    ...
    protected const PATH = '/api/v1/namespaces/{namespace}/workflows/{workflowId}/activities/{activityId}/update-options';
