 ...
 *
 * Maps to the official Temporal endpoint post /namespaces/{namespace}/activities-deprecated/update-options.
 */
class TemporalUpdateActivityOptions2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_update_activity_options_2';
    protected const DESCRIPTION = 'Update activity options

Official Temporal endpoint: POST /namespaces/{namespace}/activities-deprecated/update-options
...
UpdateActivityOptions is called by the client to update the options of an activity by its ID or type.
 ...
 structured to work well for standalone activities.';
  ...
  'required' => true,
    ...
    protected const PATH = '/namespaces/{namespace}/activities-deprecated/update-options';
