 ...
 *
 * Maps to the official Temporal endpoint post /cluster/nexus/endpoints/{id}/update.
 */
class TemporalUpdateNexusEndpoint2 extends AbstractTemporalTool
{
    protected const NAME = 'temporal_update_nexus_endpoint_2';
    protected const DESCRIPTION = 'Update nexus endpoint

Official Temporal endpoint: POST /cluster/nexus/endpoints/{id}/update
...
Optimistically update a Nexus endpoint based on provided version as obtained via the `GetNexusEndpoint` or
 ...
 need to increment the version yourself. The server will increment the version for you after each update.';
  ...
  'required' => true,
    ...
    protected const PATH = '/cluster/nexus/endpoints/{id}/update';
