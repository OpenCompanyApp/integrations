...
/**
    ...
    public function createTool(string $class, array $context = []): Tool
    {
        ...
        if ($account !== null) {
            ...
            $service = new TickTickService(
                accessToken: $creds->get('ticktick', 'access_token', '', $account),
                baseUrl: $creds->get('ticktick', 'base_url', 'https://api.ticktick.com', $account),
            );

            return new $class($service);
        }

        return new $class(app(TickTickService::class));
    }
}
