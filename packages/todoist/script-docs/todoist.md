# Client for the Todoist REST API — JavaScript API Reference
...
```js
var result = app.integrations.todoist.todoist_list_tasks({
  project_id: "",
  filter: "",
})
```
...
```js
var result = app.integrations.todoist.todoist_get_task({
  id: "",
})
```
## todoist_create_task
...
```js
var result = app.integrations.todoist.todoist_create_task({
  content: "",
  description: "",
  project_id: "",
})
...
```js
var result = app.integrations.todoist.todoist_list_projects()
```
## todoist_get_project
...
```js
var result = app.integrations.todoist.todoist_get_project({
  id: "",
})
```
## todoist_list_labels
...
```js
var result = app.integrations.todoist.todoist_list_labels()
```
...
```js
var result = app.integrations.todoist.todoist_get_current_user()
```
---
...
app.integrations.todoist.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.todoist.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.todoist.work.function_name({ /* parameters */ })
app.integrations.todoist.personal.function_name({ /* parameters */ })
```
