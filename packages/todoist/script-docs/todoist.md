# Client for the Todoist REST API — Ruby API Reference
...
```ruby
result = app.integrations.todoist.list_tasks(project_id: "", filter: "")
```
## todoist_get_task
...
```ruby
result = app.integrations.todoist.get_task(id: "")
```
## todoist_create_task
...
```ruby
result = app.integrations.todoist.create_task(content: "", description: "", project_id: "")
```
...
```ruby
result = app.integrations.todoist.list_projects()
```
## todoist_get_project
...
```ruby
result = app.integrations.todoist.get_project(id: "")
```
## todoist_list_labels
...
```ruby
result = app.integrations.todoist.list_labels()
```
...
```ruby
result = app.integrations.todoist.get_current_user()
```
---
