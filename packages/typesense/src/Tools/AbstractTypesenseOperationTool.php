...
/**
 * Base class for generated Typesense OpenAPI operation tools.
 *
 * Handles parameter declarations, configured-state checks, and execution
 * through the shared Typesense API client.
 */
abstract class AbstractTypesenseOperationTool implements Tool
{
    protected const TOOL_NAME = '';

    /**
     * @param  TypesenseService  $service  Typesense HTTP API client.
     */
    public function __construct(protected TypesenseService $service) {}
    ...
    public function parameters(): array
    {
        ...
        if (($this->operation()['request_body'] ?? null) !== null) {
            $parameters['body'] = [
                ...
                'description' => $this->operation()['request_body']['description'] ?: 'Request body for the Typesense API operation.',
            ];
        }
    ...
    /**
     * Execute the Typesense API operation.
     *
    ...
    {
        $operations = TypesenseOperations::all();
