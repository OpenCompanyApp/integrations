...
```ruby
variables = app.call("integrations.us-census.variables", dataset: "2023/acs/acs5", q: "median household income", limit: 10)
rows = app.call("integrations.us-census.data_query", {dataset: "2023/acs/acs5", get: "NAME,B19013_001E", "for" => "state:*"})
counties = app.call("integrations.us-census.data_query", {dataset: "2023/acs/acs5", get: "NAME,B01001_001E", "for" => "county:*", "in" => "state:06"})
```