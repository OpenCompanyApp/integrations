...
```ruby
result = app.integrations.vbout.get_current_user()
```
...
```ruby
result = app.integrations.vbout.social_media_channels()
```
...
```ruby
result = app.integrations.vbout.social_media_calendar(from: "example", to: "example")
```
## social_media_stats
...
```ruby
result = app.integrations.vbout.social_media_stats()
```
...
```ruby
result = app.integrations.vbout.social_media_post(id: 123, channel: "example")
```
...
```ruby
result = app.integrations.vbout.social_media_add_post(message: "example", channel: "example", channel_id: 123)
```
...
```ruby
result = app.integrations.vbout.social_media_edit_post(id: 123, channel: "example")
```
...
```ruby
result = app.integrations.vbout.social_media_delete_post(id: 123)
```
## list_campaigns
...
```ruby
result = app.integrations.vbout.list_campaigns(filter: "example")
```
## get_campaign
...
```ruby
result = app.integrations.vbout.get_campaign(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_stats(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_add_campaign(name: "example", subject: "example", from_email: "example", from_name: "example", reply_to: "example", body: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_edit_campaign(id: 123, name: "example", subject: "example", body: "example", from_email: "example", from_name: "example", reply_to: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_delete_campaign(id: 123)
```
## list_contacts
...
```ruby
result = app.integrations.vbout.list_contacts(list_id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_contacts_by_phone_number(list_id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_contact_by_email(email: "example")
```
## get_contact
...
```ruby
result = app.integrations.vbout.get_contact(id: 123)
```
## create_contact
...
```ruby
result = app.integrations.vbout.create_contact(status: "example", list_id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_edit_contact(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_sync_contact(email: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_delete_contact(id: 123, list_id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_move_contact(id: 123, list_id: 123, sourceid: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_contact_timeline(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_contact_timeline_by_email_address(email: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_audiences()
```
...
```ruby
result = app.integrations.vbout.email_marketing_lists()
```
...
```ruby
result = app.integrations.vbout.email_marketing_list(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_add_list(name: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_edit_list(id: 123, name: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_delete_list(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_add_activity(id: 123, description: "example", datetime: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_add_tag(email: "example", tagname: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_remove_tag(email: "example", tagname: "example")
```
...
```ruby
result = app.integrations.vbout.email_marketing_coupon(email: "example")
```
## user_lists
...
```ruby
result = app.integrations.vbout.user_lists()
```
## user_managers
...
```ruby
result = app.integrations.vbout.user_managers()
```
## user_status
...
```ruby
result = app.integrations.vbout.user_status(id: 123, type: "example", status: "example")
```
## user_add
...
```ruby
result = app.integrations.vbout.user_add(fullname: "example", username: "example", password: "example", type: "example")
```
## user_edit
...
```ruby
result = app.integrations.vbout.user_edit(id: 123, fullname: "example", username: "example")
```
## user_delete
...
```ruby
result = app.integrations.vbout.user_delete(id: "example", type: "example")
```
## user_groups
...
```ruby
result = app.integrations.vbout.user_groups()
```
## user_group_delete
...
```ruby
result = app.integrations.vbout.user_group_delete(id: "example")
```
## user_group_status
...
```ruby
result = app.integrations.vbout.user_group_status(id: "example", status: "example")
```
## goal_lists
...
```ruby
result = app.integrations.vbout.goal_lists()
```
## goal_list_by_domain
...
```ruby
result = app.integrations.vbout.goal_list_by_domain(domain_id: "example")
```
## goal_show
...
```ruby
result = app.integrations.vbout.goal_show(id: "example")
```
## goal_add
...
```ruby
result = app.integrations.vbout.goal_add(domain_id: 123, name: "example", type: "example")
```
## goal_edit
...
```ruby
result = app.integrations.vbout.goal_edit(id: 123, name: "example", type: "example")
```
## goal_delete
...
```ruby
result = app.integrations.vbout.goal_delete()
```
## web_hook_lists
...
```ruby
result = app.integrations.vbout.web_hook_lists()
```
## webhook_show
...
```ruby
result = app.integrations.vbout.webhook_show(id: "example")
```
## webhook_add
...
```ruby
result = app.integrations.vbout.webhook_add(name: "example", type: "example")
```
## webhook_edit
...
```ruby
result = app.integrations.vbout.webhook_edit(name: "example", type: "example", id: "example")
```
## webhook_delete
...
```ruby
result = app.integrations.vbout.webhook_delete(id: "example")
```
...
```ruby
result = app.integrations.vbout.register_create_account(contact_name: "example", business_name: "example", business_email: "example", business_phone: "example", business_vbout_name: "example", plan_id: 123)
```
...
```ruby
result = app.integrations.vbout.account_subscriber_account_auto_login(id: 123)
```
...
```ruby
result = app.integrations.vbout.settings_custom_short_codes()
```
...
```ruby
result = app.integrations.vbout.settings_add_custom_short_code(content: "example", name: "example", title: "example")
```
...
```ruby
result = app.integrations.vbout.settings_edit_custom_short_code(id: 123, title: "example", name: "example", content: "example")
```
...
```ruby
result = app.integrations.vbout.settings_delete_custom_short_code(id: 123)
```
...
```ruby
result = app.integrations.vbout.email_marketing_get_email_templates()
```
...
```ruby
result = app.integrations.vbout.automation_get_guides()
```
...
```ruby
result = app.integrations.vbout.automation_create_automation_from_guide()
```
...
```ruby
result = app.integrations.vbout.pipeline_get_board_guide_categories()
```
...
```ruby
result = app.integrations.vbout.pipeline_get_board_guides()
```
...
```ruby
result = app.integrations.vbout.pipeline_create_board_from_guide(guide_id: 123, title: "example")
```
...
```ruby
result = app.integrations.vbout.aichatbot_aichatbottemplates()
```
...
```ruby
result = app.integrations.vbout.aichatbot_categories()
```
## aichatbot_tags
...
```ruby
result = app.integrations.vbout.aichatbot_tags()
```
## aichatbot_copy
...
```ruby
result = app.integrations.vbout.aichatbot_copy(template_id: 123)
```
## Multi-Account Usage
