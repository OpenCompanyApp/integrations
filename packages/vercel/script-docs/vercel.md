...
```ruby
projects = app.integrations.vercel.list_projects(limit: 20, team_id: "team_xxx")
```
...
```ruby
project = app.integrations.vercel.get_project(id: "prj_xxx")
```
| Parameter | Type   | Required | Description                       |
|-----------|--------|----------|-----------------------------------|
...
```ruby
deployment = app.integrations.vercel.create_deployment(name: "my-project", git_source: {type: "github", ref: "main", repoId: 12345}, target: "preview", team_id: "team_xxx")
```
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
...
```ruby
deployments = app.integrations.vercel.list_deployments(project_id: "prj_xxx", state: "READY", target: "production", limit: 20, team_id: "team_xxx")
```
| Parameter    | Type    | Required | Description                                              |
|--------------|---------|----------|----------------------------------------------------------|
...
```ruby
deployment = app.integrations.vercel.get_deployment(id: "dpl_xxx")
```
| Parameter | Type   | Required | Description                            |
|-----------|--------|----------|----------------------------------------|
...
```ruby
domains = app.integrations.vercel.list_domains(limit: 20, team_id: "team_xxx")
```
| Parameter | Type     | Required | Description                                |
|-----------|----------|----------|--------------------------------------------|
...
```ruby
teams = app.integrations.vercel.list_teams(limit: 20)
```
| Parameter | Type     | Required | Description                             |
|-----------|----------|----------|-----------------------------------------|
...
```ruby
user = app.integrations.vercel.get_current_user()
```
...
```ruby
# Default account
projects = app.integrations.vercel.list_projects()
# Named account
projects = app.integrations.vercel.list_projects(account: "my-team")
```