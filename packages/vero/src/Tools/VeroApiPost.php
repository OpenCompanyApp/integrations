 ...
 */
class VeroApiPost implements Tool
{
    /**
    ...
    {
        return 'vero_api_post';
    }

    public function description(): string
    {
        return 'Call a relative Vero API POST path. Use for documented endpoints not yet exposed as first-class tools.';
    }

    public function parameters(): array
    {
        return [
            'path' => ['type' => 'string', 'required' => true, 'description' => 'Relative Vero API path such as /users/track. Absolute URLs are rejected.'],
    ...
    public function execute(array $args): ToolResult
    {
        try {
            ...
            return ToolResult::success($this->service->apiPost($path, $args['payload'] ?? []));
        } catch (\Throwable $e) {
