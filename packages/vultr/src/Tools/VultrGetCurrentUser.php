...
class VultrGetCurrentUser implements Tool
{
    ...
    {
        return 'vultr_get_current_user';
    }

    public function description(): string
    {
        return 'Get information about the current authenticated Vultr account, including email, name, and balance.';
    }
