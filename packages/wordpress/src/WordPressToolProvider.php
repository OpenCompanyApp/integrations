 ...
 */
class WordPressToolProvider implements ToolProvider, ConfigurableIntegration, HasIntegrationCapabilities
{
...
/**
    ...
    /**
     * Get the path to the Ruby script documentation file for this integration.
     *
     * @return string|null Absolute path to the Ruby script docs markdown file.
     */
