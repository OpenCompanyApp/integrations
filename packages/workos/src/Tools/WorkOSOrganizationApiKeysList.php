 ...
 *
 * Maps to the official WorkOS endpoint get /organizations/{organizationId}/api_keys.
 */
class WorkOSOrganizationApiKeysList extends AbstractWorkOSTool
{
    protected const NAME = 'workos_organization_api_keys_list';
    protected const DESCRIPTION = 'List API keys for an organization

Official WorkOS endpoint: GET /organizations/{organizationId}/api_keys
