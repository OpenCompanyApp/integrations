 ...
 * List users.
 *
 * Maps to the official WorkOS endpoint get /user_management/users.
 */
class WorkOSUserlandUsersList0 extends AbstractWorkOSTool
{
    protected const NAME = 'workos_userland_users_list_0';
    protected const DESCRIPTION = 'List users

Official WorkOS endpoint: GET /user_management/users
