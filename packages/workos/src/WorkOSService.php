 ...
 * dispatch, response parsing, and WorkOS API error normalization.
 */
class WorkOSService
{
    /**
     * @param  string  $apiKey  WorkOS API key or access token sent as a bearer token.
     * @param  string  $baseUrl  WorkOS API base URL.
     */
    public function __construct(private string $apiKey = '', private string $baseUrl = 'https://api.workos.com') { $this->baseUrl = rtrim($this->baseUrl, '/'); }
