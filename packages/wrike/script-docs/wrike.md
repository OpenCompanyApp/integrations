# Client for the Wrike REST API — JavaScript API Reference
...
```js
var result = app.integrations.wrike.wrike_add_comment({
  task_id: "",
  text: "",
})
```
...
```js
var result = app.integrations.wrike.wrike_create_folder({
  title: "",
  description: "",
})
```
...
```js
var result = app.integrations.wrike.wrike_create_task({
  folderId: "",
  title: "",
  description: "",
})
...
```js
var result = app.integrations.wrike.wrike_get_current_user({
})
```
## wrike_get_folder
...
```js
var result = app.integrations.wrike.wrike_get_folder({
  folder_id: "",
})
```
## wrike_get_project
...
```js
var result = app.integrations.wrike.wrike_get_project({
  id: "",
})
```
## wrike_get_space
...
```js
var result = app.integrations.wrike.wrike_get_space({
  space_id: "",
})
```
## wrike_get_task
...
```js
var result = app.integrations.wrike.wrike_get_task({
  id: "",
})
```
## wrike_list_contacts
...
```js
var result = app.integrations.wrike.wrike_list_contacts({
})
```
## wrike_list_folders
...
```js
var result = app.integrations.wrike.wrike_list_folders({
})
```
## wrike_list_projects
...
```js
var result = app.integrations.wrike.wrike_list_projects({
  status: "",
})
```
## wrike_list_spaces
...
```js
var result = app.integrations.wrike.wrike_list_spaces({
})
```
## wrike_list_tasks
...
```js
var result = app.integrations.wrike.wrike_list_tasks({
  folderId: "",
  status: "",
})
```
...
```js
var result = app.integrations.wrike.wrike_update_task({
  task_id: "",
  title: "",
  description: "",
})
...
app.integrations.wrike.function_name({ /* parameters */ })

// Explicit default (portable across setups)
app.integrations.wrike.default.function_name({ /* parameters */ })

// Named accounts
app.integrations.wrike.work.function_name({ /* parameters */ })
app.integrations.wrike.personal.function_name({ /* parameters */ })
```
