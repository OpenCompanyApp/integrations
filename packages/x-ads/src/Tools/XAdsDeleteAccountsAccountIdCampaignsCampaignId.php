 ...
 */
class XAdsDeleteAccountsAccountIdCampaignsCampaignId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_delete_accounts_account_id_campaigns_campaign_id';
    ...
    protected const OPERATION = [
        'id' => 'delete_accounts_account_id_campaigns_campaign_id',
        'method' => 'DELETE',
