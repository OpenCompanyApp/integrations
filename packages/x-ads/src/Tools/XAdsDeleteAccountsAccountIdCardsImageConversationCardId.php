 ...
 */
class XAdsDeleteAccountsAccountIdCardsImageConversationCardId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_delete_accounts_account_id_cards_image_conversation_card_id';
    ...
    protected const OPERATION = [
        'id' => 'delete_accounts_account_id_cards_image_conversation_card_id',
        'method' => 'DELETE',
