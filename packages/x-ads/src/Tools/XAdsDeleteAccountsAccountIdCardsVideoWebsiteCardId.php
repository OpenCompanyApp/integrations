 ...
 */
class XAdsDeleteAccountsAccountIdCardsVideoWebsiteCardId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_delete_accounts_account_id_cards_video_website_card_id';
    ...
    protected const OPERATION = [
        'id' => 'delete_accounts_account_id_cards_video_website_card_id',
        'method' => 'DELETE',
