 ...
 */
class XAdsDeleteAccountsAccountIdDraftTweetsDraftTweetId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_delete_accounts_account_id_draft_tweets_draft_tweet_id';
    ...
    protected const OPERATION = [
        'id' => 'delete_accounts_account_id_draft_tweets_draft_tweet_id',
        'method' => 'DELETE',
