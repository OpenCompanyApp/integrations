 ...
 */
class XAdsDeleteAccountsAccountIdTargetingCriteriaTargetingCriterionId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_delete_accounts_account_id_targeting_criteria_targeting_criterion_id';
    ...
    protected const OPERATION = [
        'id' => 'delete_accounts_account_id_targeting_criteria_targeting_criterion_id',
        'method' => 'DELETE',
