 ...
 */
class XAdsDeleteAccountsAccountIdWebEventTagsWebEventTagId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_delete_accounts_account_id_web_event_tags_web_event_tag_id';
    ...
    protected const OPERATION = [
        'id' => 'delete_accounts_account_id_web_event_tags_web_event_tag_id',
        'method' => 'DELETE',
