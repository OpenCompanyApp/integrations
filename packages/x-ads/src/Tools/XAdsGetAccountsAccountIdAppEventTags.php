 ...
 */
class XAdsGetAccountsAccountIdAppEventTags extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_app_event_tags';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_app_event_tags',
        'method' => 'GET',
