 ...
 */
class XAdsGetAccountsAccountIdCampaigns extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_campaigns';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_campaigns',
        'method' => 'GET',
