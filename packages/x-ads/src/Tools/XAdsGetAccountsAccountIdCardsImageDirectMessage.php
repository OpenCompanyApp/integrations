 ...
 */
class XAdsGetAccountsAccountIdCardsImageDirectMessage extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_cards_image_direct_message';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_cards_image_direct_message',
        'method' => 'GET',
