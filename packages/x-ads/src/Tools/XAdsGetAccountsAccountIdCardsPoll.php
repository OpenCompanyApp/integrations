 ...
 */
class XAdsGetAccountsAccountIdCardsPoll extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_cards_poll';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_cards_poll',
        'method' => 'GET',
