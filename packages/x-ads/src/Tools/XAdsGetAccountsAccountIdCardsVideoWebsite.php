 ...
 */
class XAdsGetAccountsAccountIdCardsVideoWebsite extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_cards_video_website';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_cards_video_website',
        'method' => 'GET',
