 ...
 */
class XAdsGetAccountsAccountIdCardsVideoWebsiteCardId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_cards_video_website_card_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_cards_video_website_card_id',
        'method' => 'GET',
