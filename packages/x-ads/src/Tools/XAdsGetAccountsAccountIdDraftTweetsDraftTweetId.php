 ...
 */
class XAdsGetAccountsAccountIdDraftTweetsDraftTweetId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_draft_tweets_draft_tweet_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_draft_tweets_draft_tweet_id',
        'method' => 'GET',
