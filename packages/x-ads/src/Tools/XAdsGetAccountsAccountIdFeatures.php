 ...
 */
class XAdsGetAccountsAccountIdFeatures extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_features';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_features',
        'method' => 'GET',
