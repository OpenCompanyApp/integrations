 ...
 */
class XAdsGetAccountsAccountIdFundingInstruments extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_funding_instruments';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_funding_instruments',
        'method' => 'GET',
