 ...
 */
class XAdsGetAccountsAccountIdLineItemApps extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_line_item_apps';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_line_item_apps',
        'method' => 'GET',
