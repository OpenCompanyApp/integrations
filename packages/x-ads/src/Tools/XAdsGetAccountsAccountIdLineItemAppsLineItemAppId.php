 ...
 */
class XAdsGetAccountsAccountIdLineItemAppsLineItemAppId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_line_item_apps_line_item_app_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_line_item_apps_line_item_app_id',
        'method' => 'GET',
