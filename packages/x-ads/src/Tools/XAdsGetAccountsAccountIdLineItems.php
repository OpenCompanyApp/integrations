 ...
 */
class XAdsGetAccountsAccountIdLineItems extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_line_items';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_line_items',
        'method' => 'GET',
