 ...
 */
class XAdsGetAccountsAccountIdLineItemsLineItemId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_line_items_line_item_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_line_items_line_item_id',
        'method' => 'GET',
