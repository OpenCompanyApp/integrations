 ...
 */
class XAdsGetAccountsAccountIdPrerollCallToActionsPrerollCallToActionId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_preroll_call_to_actions_preroll_call_to_action_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_preroll_call_to_actions_preroll_call_to_action_id',
        'method' => 'GET',
