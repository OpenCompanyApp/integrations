 ...
 */
class XAdsGetAccountsAccountIdScheduledPromotedTweetsScheduledPromotedTweetId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_scheduled_promoted_tweets_scheduled_promoted_tweet_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_scheduled_promoted_tweets_scheduled_promoted_tweet_id',
        'method' => 'GET',
