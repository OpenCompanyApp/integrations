 ...
 */
class XAdsGetAccountsAccountIdTailoredAudiencesTailoredAudienceId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_tailored_audiences_tailored_audience_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_tailored_audiences_tailored_audience_id',
        'method' => 'GET',
