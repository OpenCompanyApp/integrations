 ...
 */
class XAdsGetAccountsAccountIdTargetingCriteria extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_targeting_criteria';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_targeting_criteria',
        'method' => 'GET',
