 ...
 */
class XAdsGetAccountsAccountIdTaxSettings extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_tax_settings';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_tax_settings',
        'method' => 'GET',
