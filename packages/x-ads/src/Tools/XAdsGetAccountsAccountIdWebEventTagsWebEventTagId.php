 ...
 */
class XAdsGetAccountsAccountIdWebEventTagsWebEventTagId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_accounts_account_id_web_event_tags_web_event_tag_id';
    ...
    protected const OPERATION = [
        'id' => 'get_accounts_account_id_web_event_tags_web_event_tag_id',
        'method' => 'GET',
