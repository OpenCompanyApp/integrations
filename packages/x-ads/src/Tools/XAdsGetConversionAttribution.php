 ...
 */
class XAdsGetConversionAttribution extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_conversion_attribution';

    protected const DESCRIPTION = 'X Ads API operation: Measurement / Conversion Attribution conversion_attribution.';
