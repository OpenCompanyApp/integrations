 ...
 */
class XAdsGetStatsJobsAccountsAccountId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_get_stats_jobs_accounts_account_id';
    ...
    protected const OPERATION = [
        'id' => 'get_stats_jobs_accounts_account_id',
        'method' => 'GET',
