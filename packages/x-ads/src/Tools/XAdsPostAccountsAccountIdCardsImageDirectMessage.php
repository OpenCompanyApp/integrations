 ...
 */
class XAdsPostAccountsAccountIdCardsImageDirectMessage extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_post_accounts_account_id_cards_image_direct_message';
    ...
    protected const OPERATION = [
        'id' => 'post_accounts_account_id_cards_image_direct_message',
        'method' => 'POST',
