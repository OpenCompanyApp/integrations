 ...
 */
class XAdsPostAccountsAccountIdFeatures extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_post_accounts_account_id_features';
    ...
    protected const OPERATION = [
        'id' => 'post_accounts_account_id_features',
        'method' => 'POST',
