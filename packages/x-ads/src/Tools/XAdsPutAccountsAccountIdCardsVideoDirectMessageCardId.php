 ...
 */
class XAdsPutAccountsAccountIdCardsVideoDirectMessageCardId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_put_accounts_account_id_cards_video_direct_message_card_id';
    ...
    protected const OPERATION = [
        'id' => 'put_accounts_account_id_cards_video_direct_message_card_id',
        'method' => 'PUT',
