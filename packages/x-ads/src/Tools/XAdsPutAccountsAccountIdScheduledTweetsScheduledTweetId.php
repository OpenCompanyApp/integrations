 ...
 */
class XAdsPutAccountsAccountIdScheduledTweetsScheduledTweetId extends XAdsGeneratedTool
{
    protected const SLUG = 'x_ads_put_accounts_account_id_scheduled_tweets_scheduled_tweet_id';
    ...
    protected const OPERATION = [
        'id' => 'put_accounts_account_id_scheduled_tweets_scheduled_tweet_id',
        'method' => 'PUT',
