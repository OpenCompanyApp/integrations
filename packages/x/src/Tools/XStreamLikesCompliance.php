 ...
 */
class XStreamLikesCompliance extends XGeneratedTool
{
    protected const SLUG = 'x_stream_likes_compliance';

    protected const DESCRIPTION = 'Stream Likes compliance data';
