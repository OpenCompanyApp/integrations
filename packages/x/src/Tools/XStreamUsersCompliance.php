 ...
 */
class XStreamUsersCompliance extends XGeneratedTool
{
    protected const SLUG = 'x_stream_users_compliance';

    protected const DESCRIPTION = 'Stream Users compliance data';
