...
```ruby
videos = app.integrations.youtube.videos_list(part: "snippet,statistics", id: "dQw4w9WgXcQ")
search = app.integrations.youtube.search_list(part: "snippet", q: "open source laravel", max_results: 5)
```
