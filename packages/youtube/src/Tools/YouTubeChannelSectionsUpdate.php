 ...
 *
 * Maps to the official YouTube Data API endpoint PUT /youtube/v3/channelSections.
 */
class YouTubeChannelSectionsUpdate extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_channel_sections_update';
    protected const DESCRIPTION = 'Channel Sections Update

Official YouTube Data API endpoint: PUT /youtube/v3/channelSections
