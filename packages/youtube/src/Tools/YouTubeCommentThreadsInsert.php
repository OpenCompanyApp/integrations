 ...
 *
 * Maps to the official YouTube Data API endpoint POST /youtube/v3/commentThreads.
 */
class YouTubeCommentThreadsInsert extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_comment_threads_insert';
    protected const DESCRIPTION = 'Comment Threads Insert

Official YouTube Data API endpoint: POST /youtube/v3/commentThreads
