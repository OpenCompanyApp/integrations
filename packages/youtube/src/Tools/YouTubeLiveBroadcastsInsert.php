 ...
 *
 * Maps to the official YouTube Data API endpoint POST /youtube/v3/liveBroadcasts.
 */
class YouTubeLiveBroadcastsInsert extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_live_broadcasts_insert';
    protected const DESCRIPTION = 'Live Broadcasts Insert

Official YouTube Data API endpoint: POST /youtube/v3/liveBroadcasts
