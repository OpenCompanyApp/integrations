 ...
 * Live Streams Delete.
 *
 * Maps to the official YouTube Data API endpoint DELETE /youtube/v3/liveStreams.
 */
class YouTubeLiveStreamsDelete extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_live_streams_delete';
    protected const DESCRIPTION = 'Live Streams Delete

Official YouTube Data API endpoint: DELETE /youtube/v3/liveStreams
