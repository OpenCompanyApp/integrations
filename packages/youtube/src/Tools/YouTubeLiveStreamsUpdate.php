 ...
 * Live Streams Update.
 *
 * Maps to the official YouTube Data API endpoint PUT /youtube/v3/liveStreams.
 */
class YouTubeLiveStreamsUpdate extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_live_streams_update';
    protected const DESCRIPTION = 'Live Streams Update

Official YouTube Data API endpoint: PUT /youtube/v3/liveStreams
