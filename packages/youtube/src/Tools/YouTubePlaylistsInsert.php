 ...
 * Playlists Insert.
 *
 * Maps to the official YouTube Data API endpoint POST /youtube/v3/playlists.
 */
class YouTubePlaylistsInsert extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_playlists_insert';
    protected const DESCRIPTION = 'Playlists Insert

Official YouTube Data API endpoint: POST /youtube/v3/playlists
Inserts a new resource into this collection.';
  ...
  array (
    'type' => 'object',
    'required' => true,
    'description' => 'JSON request body matching the official YouTube Data API `Playlist` schema.',
  ),
);
