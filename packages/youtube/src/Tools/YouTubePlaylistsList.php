 ...
 * Playlists List.
 *
 * Maps to the official YouTube Data API endpoint GET /youtube/v3/playlists.
 */
class YouTubePlaylistsList extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_playlists_list';
    protected const DESCRIPTION = 'Playlists List

Official YouTube Data API endpoint: GET /youtube/v3/playlists
Retrieves a list of resources, possibly filtered.';
  ...
  array (
    'type' => 'object',
    'required' => false,
    'description' => 'Query string parameters accepted by the official YouTube method. Known keys: id, onBehalfOfContentOwner, onBehalfOfContentOwnerChannel, pageToken, maxResults, channelId, hl, mine, part.',
  ),
  'id' =>
  array (
    'type' => 'array',
  ...
  array (
    ...
    protected const PATH = '/youtube/v3/playlists';
