 ...
 * Watermarks Set.
 *
 * Maps to the official YouTube Data API endpoint POST /youtube/v3/watermarks/set.
 */
class YouTubeWatermarksSet extends AbstractYouTubeTool
{
    protected const NAME = 'youtube_watermarks_set';
    protected const DESCRIPTION = 'Watermarks Set

Official YouTube Data API endpoint: POST /youtube/v3/watermarks/set
Allows upload of watermark image and setting it for a channel.';
  ...
  array (
    ...
    protected const PATH = '/youtube/v3/watermarks/set';
  ...
  1 => 'onBehalfOfContentOwner',
    ...
    protected const MEDIA_UPLOAD_PATH = '/upload/youtube/v3/watermarks/set';
}
