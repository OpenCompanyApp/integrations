# Zendesk Sell JavaScript Reference
...
```js
var contact = app.integrations["zendesk-sell"].create_contact({
  first_name: "Ada",
  last_name: "Example",
...
var deal = app.integrations["zendesk-sell"].create_deal({
...
```js
var lead = app.integrations["zendesk-sell"].upsert_lead({
  email: "ada@example.test",
  first_name: "Ada",
  last_name: "Example",
  custom_fields: {
