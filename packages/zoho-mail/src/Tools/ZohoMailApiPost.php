 ...
 */
class ZohoMailApiPost extends AbstractZohoMailTool
{
    public function name(): string { return 'zohomail_api_post'; }

    public function description(): string { return 'Call a safe relative Zoho Mail API path with POST.'; }
