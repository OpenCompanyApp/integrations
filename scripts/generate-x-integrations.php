...
```ruby
me = app.call("integrations.x.x_get_users_me")
user = app.call("integrations.x.x_get_users_by_username", username: "XDevelopers")
```

For multi-account hosts:

```ruby
app.call("integrations.x.default.x_get_users_me")
app.call("integrations.x.work.x_get_users_me")
```
MD);
...
```ruby
accounts = app.call("integrations.x-ads.x_ads_get_accounts")
campaigns = app.call("integrations.x-ads.x_ads_get_accounts_account_id_campaigns", account_id: "account-id", count: "25")
```
MD);
